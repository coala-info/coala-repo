...
### Metadata
- **Docker Image**: quay.io/biocontainers/sgdemux:1.2.0--h3ab6199_4
- **Homepage**: https://github.com/Singular-Genomics/singular-demux
- **Package**: https://anaconda.org/channels/bioconda/packages/sgdemux/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/sgdemux/overview
- **Total Downloads**: 11.3K
- **Last updated**: 2025-04-22
- **GitHub**: https://github.com/Singular-Genomics/singular-demux
- **Stars**: N/A
### Original Help Text
```text
sgdemux 1.2.0
