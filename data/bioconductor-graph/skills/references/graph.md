...
Robert Gentleman, Seth Falcon, Jeff Gentry, Paul Shannon and Aliyu Atiku Mustapha1
...
* [2 Getting Started](#getting-started)
  + [2.1 Some Algebraic Manipulations](#some-algebraic-manipulations)
* [3 Random Graphs](#random-graphs)
* [4 Some Graph Algorithms](#some-graph-algorithms)
* [5 Special Types of Graphs](#special-types-of-graphs)
* [6 Coercion](#coercion)
  + [6.1 Classes](#classes)
...
The *[graph](https://bioconductor.org/packages/3.22/graph)* package provides an implementation of graphs (the kind
with nodes and edges) in R. Software infrastructure is provided by three
different, but related packages,

*[graph](https://bioconductor.org/packages/3.22/graph)* Provides the basic class definitions and functionality.

*[RBGL](https://bioconductor.org/packages/3.22/RBGL)* Provides an interface to graph algorithms (such as shortest
path, connectivity etc).

*[Rgraphviz](https://bioconductor.org/packages/3.22/Rgraphviz)* Provides rendering functionality. Different layout
...
The reader will benefit greatly from also having the *[Rgraphviz](https://bioconductor.org/packages/3.22/Rgraphviz)*
...
of this graph until Section [3](#random-graphs).

First we attach the *[graph](https://bioconductor.org/packages/3.22/graph)* package and create a random graph (this
...
modified in places as the *[graph](https://bioconductor.org/packages/3.22/graph)* package has evolved. In the code
...
algorithms provided in the *[RBGL](https://bioconductor.org/packages/3.22/RBGL)*.
...
For the *[graph](https://bioconductor.org/packages/3.22/graph)* package we have implemented the depth first
searching algorithm as described in Algorithm 4.2.1 of Gross and Yellen ([2005](#ref-Algorithm_4_2_1)). More
efficient and comprehensive algorithms are available through the
*[RBGL](https://bioconductor.org/packages/3.22/RBGL)* package. The returned value is a named vector. The names
...
*[SparseM](https://CRAN.R-project.org/package%3DSparseM)* of Koncker and Ng for the sparse matrix implementation.
...
next and will use the *[SparseM](https://CRAN.R-project.org/package%3DSparseM)* package if it is available.
