# rmblast CWL Generation Report

## rmblast_rmblastn

### Tool Description
Nucleotide-Nucleotide BLAST with RepeatMasker Extensions 2.14.1+

### Metadata
- **Docker Image**: quay.io/biocontainers/rmblast:2.14.1--hdb21ba3_2
- **Homepage**: https://www.repeatmasker.org/rmblast/
- **Package**: https://anaconda.org/channels/bioconda/packages/rmblast/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/rmblast/overview
- **Total Downloads**: 107.1K
...
```text
USAGE
  rmblastn [-h] [-help] [-import_search_strategy filename]
    ...
    [-matrix matrix_name] [-complexity_adjust] [-mask_level int_value]
    [-ungapped] [-culling_limit int_value] [-best_hit_overhang float_value]
    [-best_hit_score_edge float_value] [-subject_besthit]
    [-window_size int_value] [-use_index boolean] [-index_name string]
    [-lcase_masking] [-query_loc range] [-strand strand] [-parse_deflines]
    [-outfmt format] [-show_gis] [-num_descriptions int_value]
    [-num_alignments int_value] [-line_length line_length] [-html]
    [-sorthits sort_hits] [-sorthsps sort_hsps]
    [-max_target_seqs num_sequences] [-num_threads int_value]
    [-mt_mode int_value] [-remote] [-version]
 ...
 *** General search options
 ...
 -mask_level <Integer, <=101>
   Masklevel - percentage overlap allowed per query domain [0-101]
   Default = `-1'
 -use_index <Boolean>
   ...
   The supported format specifiers are:
   	 ...
   	 sallseqid means All subject Seq-id(s), separated by a ';'
   	  ...
   	  mismatch means Number of mismatches
   	      kdiv means Kimura divergence
   	  cpg_kdiv means Kimura divergence adjusted for CpG sites
   	 cpg_sites means Count of CpG sites in alignment
   	    transi means Count of transition substitutions
   	    transv means Count of transversion substitutions
   	  perc_sub means Percent substitutions
   	perc_query_gap means Percent gaps in query sequence
   	perc_db_gap means Percent gaps in db sequence
