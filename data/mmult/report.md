# mmult CWL Generation Report

## mmult_bbglm

### Tool Description
Analyze methylation data using a generalized linear model.

### Metadata
- **Docker Image**: quay.io/biocontainers/mmult:0.0.0.2--r40h8b68381_0
- **Homepage**: https://github.com/lijinbio/MMULT
- **Package**: https://anaconda.org/channels/bioconda/packages/mmult/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/mmult/overview
- **Total Downloads**: 2.8K
- **Last updated**: 2025-04-22
- **GitHub**: https://github.com/lijinbio/MMULT
- **Stars**: N/A
### Original Help Text
```text
Allowed options:
...
### Tool Description
Calculate CpG methylation difference enrichment
...
### Tool Description
Detects VMCs (Variable Methylation Calls) and VMRs (Variable Methylation Regions) from methylation BED files.
