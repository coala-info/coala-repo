...
* Reorder chromosomes
* [Dump interactions to .cool or .hic file](dump_interactions_to_cool_hic_file.html)
...
[View this page](../_sources/tutorials/reordering_chromosomes.rst.txt "View this page")

Toggle Light / Dark / Auto color theme

Toggle table of contents sidebar

# Reorder chromosomes[¶](#reorder-chromosomes "Link to this heading")
