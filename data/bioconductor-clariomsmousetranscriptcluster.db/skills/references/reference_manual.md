...
clariomsmousetranscriptclusterACCNUM

Map Manufacturer identifiers to Accession Numbers

Description

clariomsmousetranscriptclusterACCNUM is an R object that contains mappings between a manu-
...
## Bimap interface:
x <- clariomsmousetranscriptclusterACCNUM
...
clariomsmousetranscriptclusterALIAS2PROBE
...
clariomsmousetranscriptclusterALIAS is an R object that provides mappings between common
...
xx <- as.list(clariomsmousetranscriptclusterALIAS2PROBE)
if(length(xx) > 0){
...
Welcome to the clariomsmousetranscriptcluster.db annotation Package. The purpose of this package
is to provide detailed information about the clariomsmousetranscriptcluster platform. This package
is updated biannually.
Objects in this package are accessed using the select() interface. See ?select in the AnnotationDbi
package for details.

clariomsmousetranscriptclusterCHR
...
## use of select().
ls("package:clariomsmousetranscriptcluster.db")
...
clariomsmousetranscriptclusterCHR is an R object that provides mappings between a manufacturer
...
## Bimap interface:
x <- clariomsmousetranscriptclusterCHR
...
clariomsmousetranscriptclusterCHRLOC
...
clariomsmousetranscriptclusterCHRLENGTHS

A named vector for the length of each of the chromosomes

Description

clariomsmousetranscriptclusterCHRLENGTHS provides the length measured in base pairs for each
of the chromosomes.
...
## Bimap interface:
tt <- clariomsmousetranscriptclusterCHRLENGTHS
...
clariomsmousetranscriptclusterCHRLOC is an R object that maps manufacturer identifiers to the
...
clariomsmousetranscriptclusterENSEMBL
...
## Bimap interface:
x <- clariomsmousetranscriptclusterCHRLOC
...
clariomsmousetranscriptclusterENSEMBL is an R object that contains mappings between manu-
...
clariomsmousetranscriptclusterENTREZID
...
## Bimap interface:
x <- clariomsmousetranscriptclusterENSEMBL
...
x <- clariomsmousetranscriptclusterENSEMBL2PROBE
mapped_genes <- mappedkeys(x)
# Convert to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
clariomsmousetranscriptclusterENTREZID is an R object that provides mappings between manu-
facturer identifiers and Entrez Gene identifiers.

clariomsmousetranscriptclusterENZYME
...
clariomsmousetranscriptclusterENZYME is an R object that provides mappings between manufac-
turer identifiers and EC numbers. clariomsmousetranscriptclusterENZYME2PROBE is an R object
...
When the clariomsmousetranscriptclusterENZYME maping viewed as a list, each manufacturer
...
For the clariomsmousetranscriptclusterENZYME2PROBE, each EC number maps to a named vec-
...
numbers. In clariomsmousetranscriptclusterENZYME2PROBE, EC is dropped from the Enzyme
Commission numbers.
...
## Bimap interface:
x <- clariomsmousetranscriptclusterENZYME
...
clariomsmousetranscriptclusterGENENAME
...
# Now convert clariomsmousetranscriptclusterENZYME2PROBE to a list to see inside
x <- clariomsmousetranscriptclusterENZYME2PROBE
mapped_probes <- mappedkeys(x)
## convert to a list
xx <- as.list(x[mapped_probes][1:3])
if(length(xx) > 0){
...
clariomsmousetranscriptclusterGENENAME is an R object that maps manufacturer identifiers to
...
## Bimap interface:
x <- clariomsmousetranscriptclusterGENENAME
# Get the probe identifiers that are mapped to a gene name
mapped_probes <- mappedkeys(x)

10

clariomsmousetranscriptclusterGO
...
clariomsmousetranscriptclusterGO is an R object that provides mappings between manufacturer
identifiers and the GO identifiers that they are directly associated with. This mapping and its reverse
mapping (clariomsmousetranscriptclusterGO2PROBE) do NOT associate the child terms from the
GO ontology with the gene. Only the directly evidenced terms are represented here.

clariomsmousetranscriptclusterGO2ALLPROBES is an R object that provides mappings between a
...
than clariomsmousetranscriptclusterGO2PROBE.

Details

If clariomsmousetranscriptclusterGO is cast as a list, each manufacturer identifier is mapped to a
...
If clariomsmousetranscriptclusterGO2ALLPROBES or clariomsmousetranscriptclusterGO2PROBE
...
• clariomsmousetranscriptclusterGO2ALLPROBES
• AnnotationDb-class for use of the select() interface.
...
## Bimap interface:
x <- clariomsmousetranscriptclusterGO
...
# For the reverse map:
x <- clariomsmousetranscriptclusterGO2PROBE
mapped_genes <- mappedkeys(x)
# Convert to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
clariomsmousetranscriptclusterMGI

x <- clariomsmousetranscriptclusterGO2ALLPROBES
mapped_genes <- mappedkeys(x)
# Convert clariomsmousetranscriptclusterGO2ALLPROBES to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
clariomsmousetranscriptclusterMAPCOUNTS

Number of mapped keys for the maps in package clariomsmousetran-
scriptcluster.db
...
clariomsmousetranscriptclusterMAPCOUNTS provides the "map count" (i.e. the count of mapped
keys) for each map in package clariomsmousetranscriptcluster.db.
...
clariomsmousetranscriptclusterMGI is an R object that contains mappings between manufacturer
...
clariomsmousetranscriptclusterORGANISM
...
## Bimap interface:
x <- clariomsmousetranscriptclusterMGI
...
x <- clariomsmousetranscriptclusterMGI2PROBE
mapped_genes <- mappedkeys(x)
# Convert to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
The Organism information for clariomsmousetranscriptcluster

Description

clariomsmousetranscriptclusterORGANISM is an R object that contains a single item: a charac-
ter string that names the organism for which clariomsmousetranscriptcluster was built. clarioms-
mousetranscriptclusterORGPKG is an R object that contains a chararcter vector with the name of
the organism package that a chip package depends on for its gene-centric annotation.

Details

Although the package name is suggestive of the organism for which it was built, clariomsmousetran-
scriptclusterORGANISM provides a simple way to programmatically extract the organism name.
clariomsmousetranscriptclusterORGPKG provides a simple way to programmatically extract the
...
clariomsmousetranscriptclusterPATH
...
## Bimap interface:
clariomsmousetranscriptclusterORGANISM
clariomsmousetranscriptclusterORGPKG
...
clariomsmousetranscriptclusterPATH maps probe identifiers to the identifiers used by KEGG for
pathways in which the genes represented by the probe identifiers are involved

clariomsmousetranscriptclusterPATH2PROBE is an R object that provides mappings between KEGG
...
clariomsmousetranscriptclusterPFAM
...
## Bimap interface:
x <- clariomsmousetranscriptclusterPATH
...
x <- clariomsmousetranscriptclusterPATH
mapped_probes <- mappedkeys(x)
# Now convert the clariomsmousetranscriptclusterPATH2PROBE object to a list
xx <- as.list(x[mapped_probes][1:300])
if(length(xx) > 0){
...
clariomsmousetranscriptclusterPFAM is an R object that provides mappings between manufacturer
...
clariomsmousetranscriptclusterPMID

Maps between Manufacturer Identifiers and PubMed Identifiers

Description

clariomsmousetranscriptclusterPMID is an R object that provides mappings between manufacturer
identifiers and PubMed identifiers. clariomsmousetranscriptclusterPMID2PROBE is an R object
...
When clariomsmousetranscriptclusterPMID is viewed as a list each manufacturer identifier is mapped
...
When clariomsmousetranscriptclusterPMID2PROBE is viewed as a list each PubMed identifier is
...
## Bimap interface:
x <- clariomsmousetranscriptclusterPMID
...
x <- clariomsmousetranscriptclusterPMID2PROBE
mapped_probes <- mappedkeys(x)
# Now convert the reverse map object clariomsmousetranscriptclusterPMID2PROBE to a list
xx <- as.list(x[mapped_probes][1:300])

clariomsmousetranscriptclusterPROSITE
...
clariomsmousetranscriptclusterPROSITE is an R object that provides mappings between manufac-
...
clariomsmousetranscriptclusterREFSEQ

Map between Manufacturer Identifiers and RefSeq Identifiers

Description

clariomsmousetranscriptclusterREFSEQ is an R object that provides mappings between manufac-
...
clariomsmousetranscriptclusterSYMBOL
...
## Bimap interface:
x <- clariomsmousetranscriptclusterREFSEQ
...
clariomsmousetranscriptclusterSYMBOL is an R object that provides mappings between manufac-
turer identifiers and gene abbreviations.

clariomsmousetranscriptclusterUNIPROT
...
## Bimap interface:
x <- clariomsmousetranscriptclusterSYMBOL
...
clariomsmousetranscriptclusterUNIPROT is an R object that contains mappings between the man-
...
## Bimap interface:
x <- clariomsmousetranscriptclusterUNIPROT
...
clariomsmousetranscriptcluster_dbconn returns a connection object to the package annota-
tion DB. IMPORTANT: Don’t call dbDisconnect on the connection object returned by clariomsmousetranscriptcluster_dbconn
or you will break all the AnnDbObj objects defined in this package!
clariomsmousetranscriptcluster_dbfile returns the path (character string) to the package an-
...
clariomsmousetranscriptcluster_dbschema prints the schema definition of the package anno-
tation DB.
clariomsmousetranscriptcluster_dbInfo prints other information about the package annota-
tion DB.

Value

clariomsmousetranscriptcluster_dbconn: a DBIConnection object representing an open con-
nection to the package annotation DB.
clariomsmousetranscriptcluster_dbfile: a character string with the path to the package an-
notation DB.
clariomsmousetranscriptcluster_dbschema: none (invisible NULL).
clariomsmousetranscriptcluster_dbInfo: none (invisible NULL).
...
cat, 20
checkMAPCOUNTS, 12
clariomsmousetranscriptcluster
...
clariomsmousetranscriptclusterCHR, 3
clariomsmousetranscriptclusterCHRLENGTHS,
...
clariomsmousetranscriptclusterCHRLOCEND
...
clariomsmousetranscriptclusterENSEMBL2PROBE
...
clariomsmousetranscriptclusterENZYME2PROBE
...
clariomsmousetranscriptclusterGO, 10
clariomsmousetranscriptclusterGO2ALLPROBES,
...
clariomsmousetranscriptclusterGO2PROBE

(clariomsmousetranscriptclusterGO),
10

clariomsmousetranscriptclusterLOCUSID
...
clariomsmousetranscriptclusterMGI, 12
clariomsmousetranscriptclusterMGI2PROBE
...
clariomsmousetranscriptclusterPATH, 14
clariomsmousetranscriptclusterPATH2PROBE

(clariomsmousetranscriptclusterPATH),
14

clariomsmousetranscriptclusterPFAM, 15
clariomsmousetranscriptclusterPMID, 15
clariomsmousetranscriptclusterPMID2PROBE
...
clariomsmousetranscriptclusterUNIPROT2PROBE
