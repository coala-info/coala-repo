...
[View this page](_sources/format_conversion.rst.txt "View this page")

Toggle Light / Dark / Auto color theme

Toggle table of contents sidebar

# Format conversion[¶](#format-conversion "Link to this heading")

`hictk` supports conversion between .hic and .[m]cool file formats (including .hic v9 files).

## Converting from .hic to .[m]cool[¶](#converting-from-hic-to-m-cool "Link to this heading")
...
2. For each resolution to be converted:
   ...
   1. Copy all raw interactions present in the .hic file
   2. Copy all normalization vectors
...
## Converting from .[m]cool to .hic[¶](#converting-from-m-cool-to-hic "Link to this heading")
...
* Format conversion
  + [Converting from .hic to .[m]cool](#converting-from-hic-to-m-cool)
  + [Converting from .[m]cool to .hic](#converting-from-m-cool-to-hic)