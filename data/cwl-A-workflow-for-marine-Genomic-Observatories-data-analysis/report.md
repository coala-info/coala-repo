# A workflow for marine Genomic Observatories data analysis CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://www.embrc.eu/emo-bon
- **Package**: https://workflowhub.eu/workflows/384
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/384/ro_crate?version=3
- **Source repository (git):** https://github.com/hariszaf/pipeline-v5
- **Conda**: N/A
- **Total Downloads**: 1.8K
- **Last updated**: 2023-05-16
- **GitHub**: https://github.com/hariszaf/pipeline-v5/tree/pipeline_5.1
- **Stars**: N/A
- **Version**: 3
- **License**: Apache-2.0
- **Workflow type**: Common Workflow Language
- **Main workflow (WorkflowHub):** `run_wf.sh` (Main Workflow)
- **Project**: emo-bon
- **Views**: 7924
