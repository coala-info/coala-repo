...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Ftomdstanton%2Fbart%2Fblob%2Fmaster%2FREADME.md)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fblob%2Fshow&source=header-repo&source_repo=tomdstanton%2Fbart)
...
1. [bart](/tomdstanton/bart/tree/master)
...
[History](/tomdstanton/bart/commits/master/README.md)
...
[Raw](https://github.com/tomdstanton/bart/raw/refs/heads/master/README.md)
...
[![Image](https://github.com/tomdstanton/bart/raw/master/bart_logo.png)](https://github.com/tomdstanton/bart/blob/master/bart_logo.png)

*By Tom Stanton* (he/him) 🧑‍🔬
[![alt text](https://camo.githubusercontent.com/402b38d0fa76b816466b74f23c57d07080b5a34bdfc7d0e8ad6e6b774fa68d84/687474703a2f2f692e696d6775722e636f6d2f7458536f5468462e706e67 "twitter icon with padding")](http://twitter.com/tomstantonmicro) [![alt text](https://camo.githubusercontent.com/d31f55a61fc12ba6c238941bbb57eccc724d844f1a90a225f90abccf8054eca8/687474703a2f2f692e696d6775722e636f6d2f306f3438556f522e706e67 "github icon with padding")](http://www.github.com/tomdstanton)
...
* [refseq\_masher](https://anaconda.org/bioconda/refseq_masher) (use conda)
...
| SRR14224855 | Staphylococcus\_aureus | 9 | arcC(3) | aroE(3) | glpF(1) | gmk(1) | pta(1) | tpi(1) | yqiL(10) | clonal\_complex(CC1) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SRR14224855 | Staphylococcus\_aureus | 9 | arcC(3)346,616 | aroE(3)260,415 | glpF(1) | gmk(1)85 | pta(1)777 | tpi(1)269 | yqiL(10)816 | clonal\_complex(CC1) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SRR14224855 | Staphylococcus\_aureus | 9 | arcC(3: 100.00 100.00 40.52)346,616 | aroE(3: 100.00 100.00 27.58)260,415 | glpF(1: 100.00 100.00 27.84) | gmk(1: 100.00 100.00 24.42)85 | pta(1: 100.00 100.00 36.66)777 | tpi(1: 100.00 100.00 52.26)269 | yqiL(10: 100.00 100.00 44.92)816 | clonal\_complex(CC1) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

The `-amr` option screens your reads for genes from
the NCBI AMRFinderPlus database.
This is performed *instead* of MLST.
...
| SRR14224855 | arsR\_pI258 | As(III)-sensing metalloregulatory transcriptional repressor ArsR | 315 | 99.68 | 100.00 | 40.15 |
| SRR14224855 | arsB\_pI258 | arsenite efflux transporter membrane subunit ArsB | 1290 | 99.84 | 100.00 | 53.85 |
| SRR14224855 | arsC\_thio | thioredoxin-dependent arsenate reductase | 396 | 98.74 | 100.00 | 58.92 |
