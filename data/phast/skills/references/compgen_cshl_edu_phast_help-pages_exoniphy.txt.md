PROGRAM: exoniphy
USAGE: exoniphy  > predictions.gff
Required argument  must be a multiple alignment
...
be in /exoniphy/. Default is set at compile time.
(Input and output)
...
"start\_codon,stop\_codon,5'splice,3'splice,prestart,cds5'ss,cds3'ss").
