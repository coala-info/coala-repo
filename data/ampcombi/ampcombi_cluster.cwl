...
inputs:
  - id: ampcombi_summary
    type:
      - 'null'
      - File
    doc: Enter a file path corresponding to the Ampcombi_summary.tsv that can be
      generated by running --ampcombi complete.
    inputBinding:
      position: 101
  ...
  - id: cluster_cov_mode
    type:
      - 'null'
      - int
    doc: This assigns the cov. mode to the mmseqs2 cluster module. More 
  ...
  - id: cluster_coverage
    type:
      - 'null'
      - float
    doc: This assigns the coverage to the mmseqs2 cluster module. More 
      information can be obtained in mmseqs2 docs.
    inputBinding:
      position: 101
  ...
  - id: cluster_mode
    type:
      - 'null'
      - string
    doc: This assigns the cluster mode to the mmseqs2 cluster module. More 
      information can be obtained in mmseqs2 docs.
    inputBinding:
      position: 101
      prefix: --cluster_mode
  ...
  - id: cluster_retain_label
    type:
      - 'null'
      - string
    doc: This removes any cluster that only has a certain label in the sample 
      name. For example if you have samples labels with 'S1_metaspades' and 
      'S1_megahit', you can retain clusters that have samples with suffix 
      '_megahit' by running '--retain_clusters_label megahit'
    inputBinding:
      position: 101
  ...
  - id: cluster_sensitivity
    type:
      - 'null'
      - float
    doc: This assigns sensitivity of alignment to the mmseqs2 cluster module. 
      More information can be obtained in mmseqs2 docs.
    inputBinding:
      position: 101
  ...
  - id: cluster_seq_id
    type:
      - 'null'
      - float
    doc: This assigns the seqsid to the mmseqs2 cluster module. More information
