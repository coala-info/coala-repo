# Galaxy Molecular Structure Checking CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://mmb.irbbarcelona.org/biobb/
- **Package**: https://workflowhub.eu/workflows/778
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/778/ro_crate?version=1
- **Conda**: N/A
...
- **Main workflow (WorkflowHub):** `biobb_wf_structure_checking.ga` (Main Workflow)
...
- **Discussion / source**: https://biobb.usegalaxy.es/u/gbayarri/w/molecular-structure-checking
