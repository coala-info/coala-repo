...
* [2 Overview of the dada2 pipeline](#overview-of-the-dada2-pipeline)
* [3 Filter and Trim](#filter-and-trim)
* [4 Dereplicate](#dereplicate)
* [5 Learn the error rates](#learn-the-error-rates)
* [6 Infer sample composition](#infer-sample-composition)
* [7 Merge forward/reverse reads](#merge-forwardreverse-reads)
* [8 Remove chimeras](#remove-chimeras)
* [9 A second sample](#a-second-sample)
* [10 Create sequence table](#create-sequence-table)
...
```
## Dereplicating sequence entries in Fastq file: /tmp/Rtmp52KmWM/file3e33b1460e09e8.fastq.gz
```
...
```
## Dereplicating sequence entries in Fastq file: /tmp/Rtmp52KmWM/file3e33b12ca826f2.fastq.gz
```
...
```
## 204700 total bases in 890 reads from 1 samples will be used for learning the error rates.
```
...
## 8 sequence variants were inferred from 332 input unique sequences.
## Key parameters: OMEGA_A = 1e-40, OMEGA_C = 1e-40, BAND_SIZE = 16
```

The `dada(...)` algorithm inferred 8 sequence variants from the forward reads.
...
```
## Dereplicating sequence entries in Fastq file: /tmp/Rtmp52KmWM/file3e33b16af6e652.fastq.gz
```
...
```
## Dereplicating sequence entries in Fastq file: /tmp/Rtmp52KmWM/file3e33b13fb3a1cb.fastq.gz
```
