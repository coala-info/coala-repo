...
* [Docs](index.html) »
* Quickstart - Detection of differential RNA modifications
* [Edit on GitHub](https://github.com/GoekeLab/xpore/blob/master/docs/source/quickstart.rst)

---

# Quickstart - Detection of differential RNA modifications[¶](#quickstart-detection-of-differential-rna-modifications "Permalink to this headline")

Download and extract the demo dataset from our [zenodo](https://zenodo.org/record/5162402/files/demo.tar.gz):
...
Note that the FAST5, FASTQ and BAM files are required to obtain the eventalign file with Nanopolish, xPore only requires the eventalign file. See our [Data preparation page](preparation.html#preparation) for details to obtain the eventalign file from raw reads.
...
Run `xpore dataprep -h` or visit our [Command line arguments](cmd.html#cmd) to explore the full usage description.
...
See the [Configuration file page](configuration.html#configuration) for more details.
...
Run `xpore diffmod -h` or visit our [Command line arguments](cmd.html#cmd) to explore the full usage description.
...
Run `xpore postprocessing -h` or visit our [Command line arguments](cmd.html#cmd) to explore the full usage description.

[Next](outputtable.html "Output table description")
