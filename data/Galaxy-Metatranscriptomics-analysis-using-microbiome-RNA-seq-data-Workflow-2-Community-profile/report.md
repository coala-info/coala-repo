# Metatranscriptomics analysis using microbiome RNA-seq data - Workflow 2: Community profile CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://training.galaxyproject.org
- **Package**: https://workflowhub.eu/workflows/1451
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1451/ro_crate?version=2
- **Conda**: N/A
- **Total Downloads**: 486
...
- **Main workflow (WorkflowHub):** `workflow2-community-profile.ga` (Main Workflow)
