...
* [Using Augur](../usage.html)
* [Augur subcommands](cli.html)
* [View page source](../../_sources/usage/cli/translate.rst.txt)

---

# augur translate[](#augur-translate "Link to this heading")

* [Named Arguments](#augur-make_parser-named-arguments)
* [VCF specific](#augur-make_parser-vcf-specific)
...
`--alignment-output`
:   write out translated gene alignments. If a VCF-input, a .vcf or .vcf.gz will be output here (depending on file ending). If fasta-input, specify the file name like so: ‘my\_alignment\_%GENE.fasta’, where ‘%GENE’ will be replaced by the name of the gene
...
## [VCF specific](#id2)[](#augur-make_parser-vcf-specific "Link to this heading")
...
## [Example Node Data JSON](#id3)[](#example-node-data-json "Link to this heading")
...
[Previous](ancestral.html "augur ancestral")
[Next](reconstruct-sequences.html "augur reconstruct-sequences")
...
Ivan Aksamentov](https://neherlab.org/