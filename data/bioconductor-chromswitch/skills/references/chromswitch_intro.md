...
Load *[chromswitch](https://bioconductor.org/packages/3.8/chromswitch)*:

```
library(chromswitch)
```

We will use the package *[rtracklayer](https://bioconductor.org/packages/3.8/rtracklayer)* to import data from BED files:
...
Each of these inputs can be imported from TSV or BED files. Learn more about `GRanges` objects by checking out *[GenomicRanges](https://bioconductor.org/packages/3.8/GenomicRanges)*.

Here we use the `import()` function from *[rtracklayer](https://bioconductor.org/packages/3.8/rtracklayer)* to import
...
Chromswitch outputs a measure of cluster quality (*Average\_Silhouette*), the score predicting a chromatin state switch (*Consensus*), and the cluster assignment for each sample.
...
# 4 Walkthrough of a basic chromswitch analysis

## 4.1 The H3K4me3 dataset
...
in *[GenomicRanges](https://bioconductor.org/packages/3.8/GenomicRanges)*. An introduction to these objects can be obtained by running `??GenomicRanges::GRanges_and_GRangesList_slides` in the console.
...
from a BED file using the `import()` function from *[rtracklayer](https://bioconductor.org/packages/3.8/rtracklayer)*.
...
in using `read.delim()` and passed to the `makeGRangesFromDataFrame()` function from *[GenomicRanges](https://bioconductor.org/packages/3.8/GenomicRanges)*, which converts query regions stored in a dataframe with at least 3 columns, *chr*, *start*, and *end*, into a `GRanges`
...
*start*, and *end*, use *[rtracklayer](https://bioconductor.org/packages/3.8/rtracklayer)* and specify the identity and
...
## 4.3 Applying the summary strategy to detect brain-specific switches
...
## 4.4 Applying the binary strategy to detect brain-specific switches
...
## 4.6 Saving chromswitch heatmaps
...
# 5 Step-by-step analysis for finer control
...
from *[magrittr](https://CRAN.R-project.org/package%3Dmagrittr)* is helpful here.
...
functions, so we load the data manipulation package, *[dplyr](https://CRAN.R-project.org/package%3Ddplyr)*.
...
## 5.2 Summary approach for constructing feature matrices
...
### 5.2.2 Retrieve peaks in the query region
...
##   [1]    chr19 54874978-54876577      * |  Rank_22081       194
##              signalValue    pValue             qValue      peak    length
##                <numeric> <numeric>          <numeric> <numeric> <integer>
##   [1] 0.0297359877292203   19.4892 0.0214862770028193       354      1600
##   -------
##   seqinfo: 1 sequence from an unspecified genome; no seqlengths
##
## $E074
...
##       seqnames            ranges strand |        name     score
##          <Rle>         <IRanges>  <Rle> | <character> <numeric>
##   [1]    chr19 54875142-54876835      * |  Rank_19868       256
##             signalValue    pValue             qValue      peak    length
##               <numeric> <numeric>          <numeric> <numeric> <integer>
##   [1] 0.107093935207638  25.60248 0.0573553119880893      1242      1694
##   -------
##   seqinfo: 1 sequence from an unspecified genome; no seqlengths
##
## $E102
...
##       seqnames            ranges strand |        name     score
##          <Rle>         <IRanges>  <Rle> | <character> <numeric>
##   [1]    chr19 54875950-54876551      * |  Rank_18632       194
##            signalValue    pValue             qValue      peak    length
##              <numeric> <numeric>          <numeric> <numeric> <integer>
##   [1] 0.11033891322287  19.45267 0.0408516004507152       467       602
##   -------
##   seqinfo: 1 sequence from an unspecified genome; no seqlengths
##
## $E110
...
##
## Slot "samples":
## [1] "E068" "E071" "E074" "E101" "E102" "E110"
```

### 5.2.3 Selecting features for the feature matrix in the summary approach
...
```
##      H3K4me3_qValue_mean H3K4me3_signalValue_mean H3K4me3_qValue_median
...
### 5.3.2 Construct feature matrix
...
##  [1] dplyr_0.7.8          magrittr_1.5         bigmemory_4.5.33
##  [4] Biobase_2.42.0       bindrcpp_0.2.2       rtracklayer_1.42.1
##  [7] chromswitch_1.4.1    GenomicRanges_1.34.0 GenomeInfoDb_1.18.1
## [10] IRanges_2.16.0       S4Vectors_0.20.1     BiocGenerics_0.28.0
## [13] BiocParallel_1.16.5  BiocStyle_2.10.0
##
## loaded via a namespace (and not attached):
##  [1] tidyr_0.8.2                 jsonlite_1.6
##  [3] foreach_1.4.4               gtools_3.8.1
##  [5] assertthat_0.2.0            expm_0.999-3
##  [7] BiocManager_1.30.4          GenomeInfoDbData_1.2.0
##  [9] Rsamtools_1.34.0            yaml_2.2.0
## [11] pillar_1.3.1                lattice_0.20-38
...
## [23] bibtex_0.4.2                bookdown_0.9
## [25] zlibbioc_1.28.0             mvtnorm_1.0-8
## [27] purrr_0.2.5                 xtable_1.8-3
## [29] scales_1.0.0                gdata_2.18.0
## [31] manipulate_1.0.1            tibble_2.0.0
## [33] pkgmaker_0.27               ggplot2_3.1.0
## [35] withr_2.1.2                 SummarizedExperiment_1.12.0
## [37] lazyeval_0.2.1              mclust_5.4.2
## [39] crayon_1.3.4                evaluate_0.12
## [41] gplots_3.0.1                MASS_7.3-51.1
## [43] doParallel_1.0.14           foreign_0.8-71
## [45] NMF_0.21.0                  tools_3.5.2
## [47] registry_0.5                matrixStats_0.54.0
## [49] gridBase_0.4-7              stringr_1.3.1
## [51] munsell_0.5.0               cluster_2.0.7-1
## [53] rngtools_1.3.1              DelayedArray_0.8.0
## [55] Biostrings_2.50.2           compiler_3.5.2
## [57] caTools_1.17.1.1            rlang_0.3.0.1
## [59] grid_3.5.2                  RCurl_1.95-4.11
## [61] iterators_1.0.10            bigmemory.sri_0.1.3
## [63] bitops_1.0-6                rmarkdown_1.11
## [65] boot_1.3-20                 DescTools_0.99.26
## [67] gtable_0.2.0                codetools_0.2-16
## [69] reshape2_1.4.3              R6_2.3.0
## [71] GenomicAlignments_1.18.1    knitr_1.21
## [73] bindr_0.1.1                 KernSmooth_2.23-15
## [75] stringi_1.2.4               Rcpp_1.0.0
## [77] tidyselect_0.2.5            xfun_0.4
```