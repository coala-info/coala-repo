...
## How to run the motif finder[#](#how-to-run-the-motif-finder "Direct link to this section")

1. Select ***Tools > Find Motif*** to bring up the motif finder dialog.
...
## Example[#](#example "Direct link to this section")
