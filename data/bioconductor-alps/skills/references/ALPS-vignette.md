...
* [1 ALPS-Introduction](#alps-introduction)
  + [1.1 Bigwig files](#bigwig-files)
  + [1.2 Generate bigwig files](#generate-bigwig-files)
  + [1.3 ALPS - workflow](#alps---workflow)
* [2 Installation](#installation)
* [3 Example usecases with ALPS](#example-usecases-with-alps)
  + [3.1 Calculate enrichments at genomic regions](#calculate-enrichments-at-genomic-regions)
  + [3.2 Perform correlation among replicates/groups](#perform-correlation-among-replicatesgroups)
  + [3.3 Plot enrichments across groups](#plot-enrichments-across-groups)
  + [3.4 Plot UCSC genome browser like plots](#plot-ucsc-genome-browser-like-plots)
  + [3.5 Annotate genomic regions](#annotate-genomic-regions)
  + [3.6 Plot genomic annotations](#plot-genomic-annotations)
  + [3.7 Plot motif representations](#plot-motif-representations)
...
#>                                                                 bw_path
#> 1 /tmp/RtmpoCzcKz/Rinst6f6761445bdb/ALPS/extdata/bw/ACCx_025FE5F8_T1.bw
#> 2 /tmp/RtmpoCzcKz/Rinst6f6761445bdb/ALPS/extdata/bw/ACCx_025FE5F8_T2.bw
#> 3 /tmp/RtmpoCzcKz/Rinst6f6761445bdb/ALPS/extdata/bw/BRCA_000CFD9F_T2.bw
#> 4 /tmp/RtmpoCzcKz/Rinst6f6761445bdb/ALPS/extdata/bw/BRCA_01112370_T1.bw
#> 5 /tmp/RtmpoCzcKz/Rinst6f6761445bdb/ALPS/extdata/bw/GBMx_09C0DCE7_T1.bw
#> 6 /tmp/RtmpoCzcKz/Rinst6f6761445bdb/ALPS/extdata/bw/GBMx_09C0DCE7_T2.bw
#>                                                       bed_path
#> 1 /tmp/RtmpoCzcKz/Rinst6f6761445bdb/ALPS/extdata/bw/ACCx_1.bed
#> 2 /tmp/RtmpoCzcKz/Rinst6f6761445bdb/ALPS/extdata/bw/ACCx_2.bed
#> 3 /tmp/RtmpoCzcKz/Rinst6f6761445bdb/ALPS/extdata/bw/BRCA_1.bed
#> 4 /tmp/RtmpoCzcKz/Rinst6f6761445bdb/ALPS/extdata/bw/BRCA_2.bed
#> 5 /tmp/RtmpoCzcKz/Rinst6f6761445bdb/ALPS/extdata/bw/GBMx_1.bed
#> 6 /tmp/RtmpoCzcKz/Rinst6f6761445bdb/ALPS/extdata/bw/GBMx_2.bed
```
...
#> Warning in data.table::dcast(., Feature ~ .id, value.var = "Frequency"):
...
#> redirection yourself like reshape2::dcast(.). In the next version, this
...
#> [1] circlize_0.4.8       ComplexHeatmap_2.2.0 ALPS_1.0.0
#>
...
#>  [21] vctrs_0.2.0
#>  [22] xfun_0.10
#>  [23] biovizBase_1.34.0
#>  [24] BiocFileCache_1.10.0
#>  [25] ggseqlogo_0.1
#>  [26] R6_2.4.0
#>  [27] GenomeInfoDb_1.22.0
#>  [28] clue_0.3-57
#>  [29] graphlayouts_0.5.0
#>  [30] AnnotationFilter_1.10.0
#>  [31] bitops_1.0-6
#>  [32] reshape_0.8.8
#>  [33] fgsea_1.12.0
#>  [34] gridGraphics_0.4-1
#>  [35] DelayedArray_0.12.0
#>  [36] assertthat_0.2.1
#>  [37] scales_1.0.0
#>  [38] ggraph_2.0.0
#>  [39] nnet_7.3-12
...
#>  [44] rlang_0.4.1
#>  [45] zeallot_0.1.0
#>  [46] genefilter_1.68.0
#>  [47] GlobalOptions_0.1.1
#>  [48] splines_3.6.1
#>  [49] rtracklayer_1.46.0
#>  [50] lazyeval_0.2.2
#>  [51] acepack_1.4.1
#>  [52] dichromat_2.0-0
#>  [53] europepmc_0.3
#>  [54] checkmate_1.9.4
#>  [55] BiocManager_1.30.9
#>  [56] yaml_2.2.0
#>  [57] reshape2_1.4.3
#>  [58] GenomicFeatures_1.38.0
#>  [59] backports_1.1.5
#>  [60] gghalves_0.0.1
#>  [61] qvalue_2.18.0
#>  [62] Hmisc_4.2-0
...
#>  [83] cowplot_1.0.0
#>  [84] S4Vectors_0.24.0
#>  [85] SummarizedExperiment_1.16.0
#>  [86] ggrepel_0.8.1
#>  [87] cluster_2.1.0
#>  [88] magrittr_1.5
#>  [89] data.table_1.12.6
#>  [90] DO.db_2.9
#>  [91] triebeard_0.3.0
#>  [92] ProtGenerics_1.18.0
#>  [93] matrixStats_0.55.0
#>  [94] hms_0.5.1
#>  [95] evaluate_0.14
#>  [96] xtable_1.8-4
#>  [97] XML_3.98-1.20
...
#> [120] Gviz_1.30.0
#> [121] igraph_1.2.4.1
#> [122] GenomicRanges_1.38.0
#> [123] pkgconfig_2.0.3
#> [124] TxDb.Hsapiens.UCSC.hg19.knownGene_3.2.2
#> [125] rvcheck_0.1.5
#> [126] GenomicAlignments_1.22.0
#> [127] foreign_0.8-72
#> [128] xml2_1.2.2
#> [129] annotate_1.64.0
#> [130] XVector_0.26.0
#> [131] stringr_1.4.0
#> [132] VariantAnnotation_1.32.0
#> [133] digest_0.6.22
#> [134] Biostrings_2.54.0
#> [135] rmarkdown_1.16
#> [136] fastmatch_1.1-0
#> [137] htmlTable_1.13.2
#> [138] curl_4.2
#> [139] Rsamtools_2.2.0
#> [140] gtools_3.8.1
#> [141] rjson_0.2.20
...
#> [158] stringi_1.4.3
#> [159] blob_1.2.0
#> [160] org.Hs.eg.db_3.10.0
#> [161] latticeExtra_0.6-28
#> [162] caTools_1.17.1.2
#> [163] memoise_1.1.0
#> [164] dplyr_0.8.3
```
