...
*Visit the [Tools Reference main page](/tsv-utils/docs/ToolReference.html)*
*Visit the [TSV Utilities main page](/tsv-utils/)*

# tsv-filter reference

*Note: See the [tsv-filter](/tsv-utils/#tsv-filter) description in the project [README](/tsv-utils/) for a tutorial style introduction.*
...
***Tip:*** Bash completion is very helpful when using commands like `tsv-filter` that have many options. See [Enable bash-completion](/tsv-utils/docs/TipsAndTricks.html#enable-bash-completion) for details.
...
See [Field syntax](/tsv-utils/docs/tool_reference/common-options-and-behavior.html#field-syntax) for more information on field lists and specifying fields by name.
