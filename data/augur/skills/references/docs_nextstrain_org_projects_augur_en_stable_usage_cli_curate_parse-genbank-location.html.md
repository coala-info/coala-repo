...
* [Augur subcommands](../cli.html)
* [augur curate](index.html)
* [View page source](../../../_sources/usage/cli/curate/parse-genbank-location.rst.txt)

---

# parse-genbank-location[](#parse-genbank-location "Link to this heading")
...
`--location-field`
:   The field containing the location, in the format <geo\_loc\_name>[:<region>][, <locality>]
...
[Previous](abbreviate-authors.html "abbreviate-authors")
[Next](transform-strain-name.html "transform-strain-name")
