...
baseCommand:
  - apptainer
  - exec
label: apptainer_exec
doc: "Run a command within a container\n\nTool homepage: https://github.com/apptainer/apptainer"
inputs:
  - id: container
    type: string
    doc: Path to the container image (SIF, SquashFS, img, directory, or URI like docker://)
    inputBinding:
      position: 1
  - id: command
    type:
      type: array
      items: string
    doc: Command to run inside the container
    inputBinding:
      position: 2
  - id: add_caps
    type:
  ...
  - id: compat
    type:
      - 'null'
      - boolean
    doc: apply settings for increased OCI/Docker compatibility
    inputBinding:
      position: 103
      prefix: --compat
  - id: contain
    type:
      - 'null'
      - boolean
    doc: use minimal /dev and empty other directories instead of sharing filesystems
    inputBinding:
      position: 103
      prefix: --contain
  - id: containall
  ...
  - id: no_mount
    type:
      ...
      - type: array
        items: string
    doc: disable one or more 'mount xxx' options
    inputBinding:
      position: 103
      prefix: --no-mount
  - id: no_pid
  ...
  - id: overlay
    type:
      ...
      - type: array
        items: string
    doc: use an overlayFS image for persistent data storage
    inputBinding:
      position: 103
      prefix: --overlay
  - id: passphrase
  ...
  - id: scratch
    type:
      ...
      - type: array
        items: string
    doc: include a scratch directory within the container
    inputBinding:
      position: 103
      prefix: --scratch
  - id: security
  ...
  - id: writable
    type:
      - 'null'
      - boolean
    doc: makes the file system accessible as read/write
    inputBinding:
      position: 103
      prefix: --writable
  - id: writable_tmpfs
    type:
      - 'null'
      - boolean
    doc: makes the file system accessible as read-write with non persistent data
    inputBinding:
      position: 103
