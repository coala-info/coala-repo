# Code example from 'ChemmineR' vignette. See references/ for full tutorial.
...
## ----pubchemCidToSDF, eval=FALSE, tidy=FALSE------------------------------------------------------
#  compounds <- pubchemCidToSDF(c(111,123))
#  compounds

## ----pubchemInchikey2sdf, eval=FALSE, tidy=FALSE--------------------------------------------------
# inchikeys <- c(
...
## ----pubchemInchi2cid, eval=FALSE, tidy=FALSE-----------------------------------------------------
