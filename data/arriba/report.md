...
- **Conda**: https://anaconda.org/channels/bioconda/packages/arriba/overview
...
## arriba_download_references.sh

### Tool Description
A script to download reference files for the Arriba fusion detection tool.
