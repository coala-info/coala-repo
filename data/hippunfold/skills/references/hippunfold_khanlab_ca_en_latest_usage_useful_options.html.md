...
* Running HippUnfold on your data
  + [Selecting the modality to use](#selecting-the-modality-to-use)
  + [Selecting and excluding subjects to process](#selecting-and-excluding-subjects-to-process)
  + [Known limitations for BIDS parsing](#known-limitations-for-bids-parsing)
  + [Parsing Non-BIDS datasets with custom paths](#parsing-non-bids-datasets-with-custom-paths)
    - [Prerequisities for using custom path parsing:](#prerequisities-for-using-custom-path-parsing)
...
* Running HippUnfold on your data
* [View page source](../_sources/usage/useful_options.md.txt)

---

# Running HippUnfold on your data[](#running-hippunfold-on-your-data "Permalink to this heading")
...
## Selecting the modality to use[](#selecting-the-modality-to-use "Permalink to this heading")
...
## Selecting and excluding subjects to process[](#selecting-and-excluding-subjects-to-process "Permalink to this heading")
...
## Known limitations for BIDS parsing[](#known-limitations-for-bids-parsing "Permalink to this heading")
...
## Parsing Non-BIDS datasets with custom paths[](#parsing-non-bids-datasets-with-custom-paths "Permalink to this heading")
...
### Prerequisities for using custom path parsing:[](#prerequisities-for-using-custom-path-parsing "Permalink to this heading")
...
[Next](specializedScans.html "Specialized scans")
