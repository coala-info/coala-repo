...
[View this page](../_sources/cpp_api/index.rst.txt "View this page")

Toggle Light / Dark / Auto color theme

Toggle table of contents sidebar

# C++ API Reference[¶](#c-api-reference "Link to this heading")

hictk C++ API is structured as follows:

* [Generic API](generic.html)
* [Cooler API](cooler.html)
* [Hi-C API](hic.html)
* [Shared Types](shared.html)
* [Pixel transformers](transformers.html)
