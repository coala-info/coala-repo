...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fedgraham%2FBinSanity%2Fwiki%2FBin-Evaluation)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fwiki%2Fshow&source=header-repo&source_repo=edgraham%2FBinSanity)
...
[edgraham](/edgraham)
/
**[BinSanity](/edgraham/BinSanity)**
Public

* [Notifications](/login?return_to=%2Fedgraham%2FBinSanity) You must be signed in to change notification settings
* [Fork
  14](/login?return_to=%2Fedgraham%2FBinSanity)
* [Star
   31](/login?return_to=%2Fedgraham%2FBinSanity)

* [Code](/edgraham/BinSanity)
* [Issues
  13](/edgraham/BinSanity/issues)
* [Pull requests
  0](/edgraham/BinSanity/pulls)
* [Actions](/edgraham/BinSanity/actions)
* [Projects](/edgraham/BinSanity/projects)
* [Wiki](/edgraham/BinSanity/wiki)
* [Security
  0](/edgraham/BinSanity/security)
* [Insights](/edgraham/BinSanity/pulse)

Additional navigation options

* [Code](/edgraham/BinSanity)
* [Issues](/edgraham/BinSanity/issues)
* [Pull requests](/edgraham/BinSanity/pulls)
* [Actions](/edgraham/BinSanity/actions)
* [Projects](/edgraham/BinSanity/projects)
* [Wiki](/edgraham/BinSanity/wiki)
* [Security](/edgraham/BinSanity/security)
* [Insights](/edgraham/BinSanity/pulse)
...
Elaina edited this page Dec 12, 2019
·
[5 revisions](/edgraham/BinSanity/wiki/Bin-Evaluation/_history)
...
4. Adjusted-Rand Index (ARI)
   ...
   * The ARI considers similarity between predicted and true cluster labels similar to the V-measure. But it also adds another layer and this similarity is then adjusted for chance using a probability heuristic.
   ...
   See [this paper by Hirschberg and Rosenberg](https://doi.org/10.7916/D80V8N84) for more information on recall, precision, and the V-measure. See this paper by [Hubert and Arabie](https://doi.org/10.1007/BF01908075) for more information on the Adjusted Rand Index.
...
* `checkm_analysis` takes the output generated from the `checkm qa` [using default output parameters] and parses out the completion, contamination and redundancy values. These values are used to classify genomes into four categories defined below.
...
* Loading
  ...
  [Bin Evaluation](/edgraham/BinSanity/wiki/Bin-Evaluation)

  + [bin\_evaluation](/edgraham/BinSanity/wiki/Bin-Evaluation#bin_evaluation)
  + [checkm\_analysis](/edgraham/BinSanity/wiki/Bin-Evaluation#checkm_analysis)
* Loading

  [FAQ](/edgraham/BinSanity/wiki/FAQ)
...
* Loading
  ...
  [Installation](/edgraham/BinSanity/wiki/Installation)
...
* Loading
  ...
  [Issues](/edgraham/BinSanity/wiki/Issues)
...
* Loading
  ...
  [Usage](/edgraham/BinSanity/wiki/Usage)
...
* Loading
  ...
  [Utilities](/edgraham/BinSanity/wiki/Utilities)
