...
### Tool Description
A tool for alignment-based quantification statistics within the Proteomiqon ecosystem.
...
FATAL:   Unable to handle docker://quay.io/biocontainers/proteomiqon-alignmentbasedquantstatistics:0.0.3--hdfd78af_0 uri: while building SIF from layers: conveyor failed to get: invalid character '}' after top-level value
```
