...
*List environments* are environments that have list-like properties. They are implemented by the [listenv](https://cran.r-project.org/package%3Dlistenv) package. The main features of a list environment are summarized in the below table:
