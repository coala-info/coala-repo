...
The executable files only support a 64-bit operating system on the x86\_64 CPU platform and require AVX2 support. The files are released under the MIT license.

If your system does not support the provided binaries, please look at the [docker package provided with GLIMPSE2](/docs/installation/docker)
...
[Edit this page on GitHub](https://github.com/srubinacci/ideal-barnacle/tree/main/docs/docs/installation/static_binaries.md)