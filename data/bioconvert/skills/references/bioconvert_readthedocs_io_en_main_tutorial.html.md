...
* 3. Tutorial
* [View page source](_sources/tutorial.rst.txt)

---

# 3. Tutorial[](#tutorial "Link to this heading")
...
## 3.1. Data[](#data "Link to this heading")

For this tutorial, we will work with 6 sequencing samples of the *Staphylococcus aureus* genome :

1. [ERR043367](https://www.ncbi.nlm.nih.gov/sra/?term=ERR043367)
2. [ERR043371](https://www.ncbi.nlm.nih.gov/sra/?term=ERR043371)
3. [ERR043375](https://www.ncbi.nlm.nih.gov/sra/?term=ERR043375)
4. [ERR043379](https://www.ncbi.nlm.nih.gov/sra/?term=ERR043379)
5. [ERR142616](https://www.ncbi.nlm.nih.gov/sra/?term=ERR142616)
6. [ERR316404](https://www.ncbi.nlm.nih.gov/sra/?term=ERR316404)

But these files are compressed in SRA format while we want fastq files.

### 3.1.1. Downloading[](#downloading "Link to this heading")
...
* ERR043367\_1.fastq (contains the reads 1)
* ERR043367\_2.fastq (contains the reads 2)
...
### 3.1.2. Compression[](#compression "Link to this heading")
...
## 3.2. Mapping[](#mapping "Link to this heading")
...
**Find the reference genome of staphylococcus aureus with the accession FN433596 on** [NCBI](https://www.ncbi.nlm.nih.gov/nuccore/FN433596) :
...
## 3.3. Visualization[](#visualization "Link to this heading")
...
![_images/coverage_igv.png](_images/coverage_igv.png)
...
[Previous](user_guide.html "2. User Guide")
[Next](developer_guide.html "4. Developer guide")
