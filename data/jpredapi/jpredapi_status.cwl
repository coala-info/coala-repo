...
label: jpredapi_status
doc: "The JPred API allows users to submit jobs from the command-line.\n\nTool homepage:
  https://github.com/MoseleyBioinformaticsLab/jpredapi"
inputs:
  - id: command
    type: string
    doc: The subcommand to execute (submit, status, get_results, quota, 
      check_rest_version)
    inputBinding:
      position: 1
  - id: attempts
