# WF8102 Workflow Files

This directory contains workflow files generated from the spreadsheet description of WF8102 using a [custom tool](https://github.com/Marco-Salvi/dt-geo-converter). These files provide an initial starting point, **manual verification and updates are required** to ensure accuracy.
...
``` log
[WARNING] [Step ST810206 has no inputs or outputs]
[WARNING] [Step ST810207 has no inputs or outputs]
[WARNING] [Step ST810208 has no inputs or outputs]
[WARNING] [Step ST810211 has no inputs or outputs]
[WARNING] [Step ST810210 has no inputs or outputs]
[WARNING] [Step ST810209 has no inputs or outputs]
[WARNING] [Step ST810205 has no inputs or outputs]
```



For complete details, please refer to the [log file](./workflows/WF8102)
