...
ftp://ftp.sanger.ac.uk/pub/gencode/Gencode\_human/release\_19/gencode.v19.annotation.gff3.gz.
...
**Important note**: before you continue with another example, please move the output files generated in your working directory to a separate, dedicated folder.
...
The annotation file is available from the TAIR10 database: ftp://ftp.arabidopsis.org/home/tair/Genes/TAIR10\_genome\_release/TAIR10\_gff3/TAIR10\_GFF3\_genes.gff. Please move it into the downloads/ folder you have created, e.g.
