...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fdkoslicki%2FCMash)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E&source=header-repo&source_repo=dkoslicki%2FCMash)
...
[Branches](/dkoslicki/CMash/branches)[Tags](/dkoslicki/CMash/tags)
...
| --- | --- | --- | --- | --- |
| Latest commit   History[318 Commits](/dkoslicki/CMash/commits/master/)   318 Commits | | |
| [CMash](/dkoslicki/CMash/tree/master/CMash "CMash") | | [CMash](/dkoslicki/CMash/tree/master/CMash "CMash") |  |  |
| [dev](/dkoslicki/CMash/tree/master/dev "dev") | | [dev](/dkoslicki/CMash/tree/master/dev "dev") |  |  |
| [ideas](/dkoslicki/CMash/tree/master/ideas "ideas") | | [ideas](/dkoslicki/CMash/tree/master/ideas "ideas") |  |  |
| [scripts](/dkoslicki/CMash/tree/master/scripts "scripts") | | [scripts](/dkoslicki/CMash/tree/master/scripts "scripts") |  |  |
| [tests](/dkoslicki/CMash/tree/master/tests "tests") | | [tests](/dkoslicki/CMash/tree/master/tests "tests") |  |  |
| [tutorials/retraining](/dkoslicki/CMash/tree/master/tutorials/retraining "This path skips through empty directories") | | [tutorials/retraining](/dkoslicki/CMash/tree/master/tutorials/retraining "This path skips through empty directories") |  |  |
| [LICENSE](/dkoslicki/CMash/blob/master/LICENSE "LICENSE") | | [LICENSE](/dkoslicki/CMash/blob/master/LICENSE "LICENSE") |  |  |
| [MANIFEST.in](/dkoslicki/CMash/blob/master/MANIFEST.in "MANIFEST.in") | | [MANIFEST.in](/dkoslicki/CMash/blob/master/MANIFEST.in "MANIFEST.in") |  |  |
| [README.md](/dkoslicki/CMash/blob/master/README.md "README.md") | | [README.md](/dkoslicki/CMash/blob/master/README.md "README.md") |  |  |
| [requirements.txt](/dkoslicki/CMash/blob/master/requirements.txt "requirements.txt") | | [requirements.txt](/dkoslicki/CMash/blob/master/requirements.txt "requirements.txt") |  |  |
| [setup.py](/dkoslicki/CMash/blob/master/setup.py "setup.py") | | [setup.py](/dkoslicki/CMash/blob/master/setup.py "setup.py") |  |  |
| View all files | | |
...
[Activity](/dkoslicki/CMash/activity)

### Stars

[**42**
stars](/dkoslicki/CMash/stargazers)

### Watchers

[**7**
watching](/dkoslicki/CMash/watchers)

### Forks

[**9**
forks](/dkoslicki/CMash/forks)

[Report repository](/contact/report-content?content_url=https%3A%2F%2Fgithub.com%2Fdkoslicki%2FCMash&report=dkoslicki+%28user%29)

## [Releases 5](/dkoslicki/CMash/releases)

[v0.5.2 bump for Zenodo

Latest

May 31, 2021](/dkoslicki/CMash/releases/tag/v0.5.2)

[+ 4 releases](/dkoslicki/CMash/releases)

## [Packages 0](/users/dkoslicki/packages?repo_name=CMash)
...
## [Contributors](/dkoslicki/CMash/graphs/contributors)
...
* [Python
  94.2%](/dkoslicki/CMash/search?l=python)
* [Shell
  5.8%](/dkoslicki/CMash/search?l=shell)
...
* [Privacy](https://docs.github.com/si