# AnnData to Seurat conversion CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://training.galaxyproject.org
- **Package**: https://workflowhub.eu/workflows/1527
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1527/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 278
...
- **Main workflow (WorkflowHub):** `anndata-to-seurat-conversion.ga` (Main Workflow)
