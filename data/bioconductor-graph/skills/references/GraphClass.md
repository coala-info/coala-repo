...
R. Gentleman, Elizabeth Whalen, W. Huber, S. Falcon and Halimat C. Atanda1
...
* [2 The *graph* class](#the-graph-class)
  + [2.1 Methods of graphs](#methods-of-graphs)
  + [2.2 Some Details](#some-details)
    - [2.2.1 Representation of Edges](#representation-of-edges)
* [3 Multi-graphs](#multi-graphs)
  + [3.1 Methods](#methods)
...
*This raises the question of whether we should use the AnnotatedDataFrame class from* *[Biobase](https://bioconductor.org/packages/3.22/Biobase)* *here as a way to implement general node and edge attributes.*
...
A bipartite graph graph is a graph where the nodes can be divided into two sets, say \(V\_1\) and \(V\_2\), such that all edges are between members of \(V\_1\) and members of \(V\_2\), and there are no edges between any two elements of \(V\_1\), nor of \(V\_2\).