...
3. [Command line options](#command-line-options)
   ...
   4. [Selection parameters](#selection-parameters)
   5. [BAM/CRAM options and filters](#bamcram-options-and-filters)
...
[Edit this page on GitHub](https://github.com/srubinacci/ideal-barnacle/tree/main/docs/docs/documentation/phase.md)