...
* [1 The MIRA Bioconductor package](#the-mira-bioconductor-package)
  + [1.1 Required inputs](#required-inputs)
    - [1.1.1 DNA methylation data](#dna-methylation-data)
    - [1.1.2 Region sets](#region-sets)
  + [1.2 Analysis workflow](#analysis-workflow)
    - [1.2.1 The input](#the-input)
    - [1.2.2 Expand your regions](#expand-your-regions)
    - [1.2.3 Aggregating methylation across regions](#aggregating-methylation-across-regions)
    - [1.2.4 Calculating the MIRA score](#calculating-the-mira-score)
  + [1.3 Interpreting the results](#interpreting-the-results)
  + [1.4 Bonus: Loading region sets with LOLA](#bonus-loading-region-sets-with-lola)

# 1 The MIRA Bioconductor package
...
### 1.2.3 Aggregating methylation across regions
...
### 1.2.4 Calculating the MIRA score
...
## 1.4 Bonus: Loading region sets with LOLA
