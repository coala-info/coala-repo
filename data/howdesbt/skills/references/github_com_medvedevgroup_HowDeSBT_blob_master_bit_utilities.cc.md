...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fmedvedevgroup%2FHowDeSBT%2Fblob%2Fmaster%2Fbit_utilities.cc)
...
[History](/medvedevgroup/HowDeSBT/commits/master/bit_utilities.cc)
...
[Raw](https://github.com/medvedevgroup/HowDeSBT/raw/refs/heads/master/bit_utilities.cc)
...
// bit\_utilities.cc-- bit-related utility functions.
...
#define least\_significant(type,numBits) ((((type)1)<<(numBits))-1)
...
// bitwise\_is\_all\_zeros, bitwise\_is\_all\_ones --
...
// True if every bit in the array is zero (or, for bitwise\_all\_ones, one);
...
u8 mask = least\_significant(u8,n);

return (((\*scanb) & mask) == 0);

}

bool bitwise\_is\_all\_ones
