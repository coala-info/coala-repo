...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2FhuangnengCSU%2Fcompleasm)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E&source=header-repo&source_repo=huangnengCSU%2Fcompleasm)
...
[Branches](/huangnengCSU/compleasm/branches)[Tags](/huangnengCSU/compleasm/tags)
...
| --- | --- | --- | --- | --- |
| Latest commit   History[245 Commits](/huangnengCSU/compleasm/commits/0.2.7/)   245 Commits | | |
| [Dockerfile](/huangnengCSU/compleasm/blob/0.2.7/Dockerfile "Dockerfile") | | [Dockerfile](/huangnengCSU/compleasm/blob/0.2.7/Dockerfile "Dockerfile") |  |  |
| [LICENSE](/huangnengCSU/compleasm/blob/0.2.7/LICENSE "LICENSE") | | [LICENSE](/huangnengCSU/compleasm/blob/0.2.7/LICENSE "LICENSE") |  |  |
| [LICENSE-BUSCO](/huangnengCSU/compleasm/blob/0.2.7/LICENSE-BUSCO "LICENSE-BUSCO") | | [LICENSE-BUSCO](/huangnengCSU/compleasm/blob/0.2.7/LICENSE-BUSCO "LICENSE-BUSCO") |  |  |
| [README.md](/huangnengCSU/compleasm/blob/0.2.7/README.md "README.md") | | [README.md](/huangnengCSU/compleasm/blob/0.2.7/README.md "README.md") |  |  |
| [\_version.py](/huangnengCSU/compleasm/blob/0.2.7/_version.py "_version.py") | | [\_version.py](/huangnengCSU/compleasm/blob/0.2.7/_version.py "_version.py") |  |  |
| [compleasm.py](/huangnengCSU/compleasm/blob/0.2.7/compleasm.py "compleasm.py") | | [compleasm.py](/huangnengCSU/compleasm/blob/0.2.7/compleasm.py "compleasm.py") |  |  |
| [setup.py](/huangnengCSU/compleasm/blob/0.2.7/setup.py "setup.py") | | [setup.py](/huangnengCSU/compleasm/blob/0.2.7/setup.py "setup.py") |  |  |
| View all files | | |
...
```
  ...
  --specified_contigs        Specify the contigs to be evaluated, e.