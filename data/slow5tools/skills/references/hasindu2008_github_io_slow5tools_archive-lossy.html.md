...
* mean >= 0.93,
* median >= 0.97,
* read count >= NUM\_SLOW5\_READS, and
* read count <= 1.2 \* NUM\_SLOW5\_READS.
...
> Jayasooriya K, Jenner SP, Marasinghe P, Senanayake U, Saadat H, Taubman D, Ragel R, Gamaarachchi H, Deveson IW. A new compression strategy to reduce the size of nanopore sequencing data. Genome Research. 2025 Jul 1;35(7):1574-82. <http://doi.org/10.1101/gr.280090.124>
