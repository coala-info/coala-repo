...
enhance its functionality via packages. *[iSEEde](https://bioconductor.org/packages/3.22/iSEEde)* is an  package
available via the [Bioconductor](http://bioconductor.org) repository for
packages.  can be installed on any operating system from
[CRAN](https://cran.r-project.org/) after which you can install
*[iSEEde](https://bioconductor.org/packages/3.22/iSEEde)* by using the following commands in your  session:
...
*[iSEEde](https://bioconductor.org/packages/3.22/iSEEde)* is based on many other packages and in particular on
...
*[SingleCellExperiment](https://bioconductor.org/packages/3.22/SingleCellExperiment)*, *[iSEE](https://bioconductor.org/packages/3.22/iSEE)*
and *[shiny](https://bioconductor.org/packages/3.22/shiny)*.
...
which order to use the functions. But  and `Bioconductor` have a steep
...
We hope that *[iSEEde](https://bioconductor.org/packages/3.22/iSEEde)* will be useful for your research. Please use
...
#>
#>   Rue-Albrecht K (2025). _iSEEde: iSEE extension for panels related to differential
#>   expression analysis_. doi:10.18129/B9.bioc.iSEEde
#>   <https://doi.org/10.18129/B9.bioc.iSEEde>, R package version 1.8.0,
...
The example below demonstrates how to use *[iSEEde](https://bioconductor.org/packages/3.22/iSEEde)* functionality in a simple differential expression workflow.

Specifically, the *[DESeq2](https://bioconductor.org/packages/3.22/DESeq2)* package is used to perform a simple differential expression analysis.
Then, the results of one contrast – extracted using the function `DESeq2::results()` function – are embedded into the *[SummarizedExperiment](https://bioconductor.org/packages/3.22/SummarizedExperiment)* object `airway` using the function `iSEEde::embedContrastResults()`.
This ensures that the differential expression results for that contrast are accessible to specialised interactive panels in *[iSEE](https://bioconductor.org/packages/3.22/iSEE)* applications.
...
```
#> [1] "2025-10-30 00:39:05 EDT"
```

Wallclock time spent generating the vignette.

```
#> Time difference of 21.267 secs
```
