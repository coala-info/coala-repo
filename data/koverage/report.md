...
- **Conda**: https://anaconda.org/channels/bioconda/packages/koverage/overview
- **Total Downloads**: 7.7K
- **Last updated**: 2025-04-22
- **GitHub**: https://github.com/beardymcjohnface/Koverage
- **Stars**: N/A
### Original Help Text
```text

...
Usage: koverage run [OPTIONS] [SNAKE_ARGS]...

  Run Koverage

Options:
  --reads TEXT                    Input file/directory  [required]
  --ref TEXT                      Input reference fasta file  [required]
  --output PATH                   Output directory  [default: koverage.out]
  --configfile TEXT               Custom config file [default:
                                  (outputDir)/koverage.config.yaml]
  --threads INTEGER               Number of threads to use  [default: 8]
  --minimap [map-pb|map-ont|map-hifi|sr]
                                  Minimap preset  [default: sr]
  --pafs                          Save the (compressed) PAF files
  --bin-width INTEGER             Bin width for estimating read depth variance
                                  [default: 100]
  --kmer-size INTEGER             Size of kmers to use  [default: 25]
  --kmer-sample INTEGER           Sample every [INT]th kmer  [default: 100]
  --kmer-min INTEGER              Min kmers to try to sample per contig
                                  [default: 50]
  --kmer-max INTEGER              Max kmers to sample per contig  [default:
                                  5000]
  --report-max-ctg INTEGER        Only include the top N contigs by coverage
                                  in the summary HMTL report (use -1 for all
                                  contigs)  [default: 1000]
  --report / --no-report          Generate HTML summary report of coverage
                                  [default: report]
...
Usage: koverage config [OPTIONS] [SNAKE_ARGS]...
