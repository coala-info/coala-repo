...
inputs:
  ...
  - id: read_type
    type:
      - 'null'
      - string
    doc: read type (pacbio, ont2d, or intractg)
    inputBinding:
      position: 104
      prefix: -x
  ...
  - id: xa_output_threshold
    type:
      - 'null'
      - string
    doc: output all in XA if there are <INT hits with score >80% of max
    default: 5,200
    inputBinding:
      position: 104
      prefix: -h
