...
inputs:
  ...
  - id: custom
    type:
      - 'null'
      - File
    doc: Association custom analysis with covariate table
    inputBinding:
      position: 101
      prefix: --custom
  - id: data_file
  ...
  - id: one
    type:
      - 'null'
      - boolean
    doc: Recombination one recombination
    inputBinding:
      position: 101
      prefix: --one
  - id: pairs
  ...
  - id: singlepoint
    type:
      - 'null'
      - boolean
    doc: Recombination singlepoint recombination
    inputBinding:
      position: 101
      prefix: --singlepoint
  - id: small_swap
  ...
  - id: three
    type:
      - 'null'
      - boolean
    doc: Recombination three recombination
    inputBinding:
      position: 101
      prefix: --three
  - id: trait
  ...
  - id: two
    type:
      - 'null'
      - boolean
    doc: Recombination two recombination
    inputBinding:
      position: 101
      prefix: --two
  - id: unlinked
  ...
  - id: zero
    type:
      - 'null'
      - boolean
    doc: Recombination zero recombination
    inputBinding:
      position: 101
      prefix: --zero
outputs:
