...
FATAL:   Unable to handle docker://quay.io/biocontainers/rattle:1.0--h5ca1c30_0 uri: while building SIF from layers: conveyor failed to get: invalid character '}' after top-level value
```
