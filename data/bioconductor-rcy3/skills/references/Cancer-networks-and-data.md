...
### 4.2.1 List of layout algorithms available

```
getLayoutNames()
```

### 4.2.2 Layout with parameters!
...
## 4.3 Get table data from network
...
### 4.3.2 Plot distribution and pick threshold
...
# 5 Visualizing data on networks
...
#### 5.2.1.1 Visualize expression data
...
### 5.2.3 Subnetwork based on diffusion from heavily mutated nodes
...
# 6 Saving, sharing and publishing

## 6.1 Saving a Cytoscape session file
...
## 6.2 Saving high resolution image files
