...
baseCommand:
  - apptainer
  - shell
label: apptainer_shell
doc: "Run a shell within a container\n\nTool homepage: https://github.com/apptainer/apptainer"
inputs:
  - id: container
    type: string
    doc: Path to the container image (SIF, SquashFS, img, directory) or a URI (instance://,
      library://, docker://, shub://, oras://)
    inputBinding:
      position: 1
  - id: add_caps
    type:
  ...
  - id: shell
    type:
      - 'null'
      - string
    doc: path to program to use for interactive shell
    inputBinding:
      position: 102
      prefix: --shell
  - id: unsquash
