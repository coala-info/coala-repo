# Code example from 'GSAR' vignette. See references/ for full tutorial.

### R code from vignette source 'GSAR.Rnw'

###################################################
### code chunk number 1: GSAR.Rnw:117-118
###################################################
library(GSAR)


###################################################
### code chunk number 2: GSAR.Rnw:166-167
###################################################
options(width=80, digits=3)


###################################################
### code chunk number 3: GSAR.Rnw:170-181
###################################################
library(MASS)
set.seed(123)
nf <- 20
...
###################################################
### code chunk number 4: GSAR.Rnw:211-216
###################################################
...
###################################################
### code chunk number 5: GSAR.Rnw:316-317
###################################################
HDP.ranking(MST)


###################################################
### code chunk number 6: GSAR.Rnw:320-321
###################################################
radial.ranking(MST)
...
###################################################
### code chunk number 8: GSAR.Rnw:573-576
###################################################
library(GSVAdata)
data(p53DataSet)
data(c2BroadSets)
...
###################################################
### code chunk number 9: GSAR.Rnw:590-627
###################################################
...
###################################################
### code chunk number 10: GSAR.Rnw:636-660
###################################################
...
###################################################
### code chunk number 12: GSAR.Rnw:708-711
###################################################
...
###################################################
### code chunk number 13: GSAR.Rnw:738-773
###################################################
library(Biobase)
library(genefilter)
library(annotate)
...
###################################################
### code chunk number 14: GSAR.Rnw:787-822
###################################################
C2 <- as.list(geneIds(c2BroadSets))
len <- length(C2)
genes.entrez <- unique(unlist(C2))
...
###################################################
### code chunk number 15: GSAR.Rnw:829-847
###################################################
...
###################################################
### code chunk number 17: GSAR.Rnw:900-911
###################################################
...
###################################################
### code chunk number 18: GSAR.Rnw:918-921
###################################################
...
###################################################
### code chunk number 19: GSAR.Rnw:937-950
###################################################
library(edgeR)
...
###################################################
### code chunk number 20: GSAR.Rnw:961-968
###################################################
...
###################################################
### code chunk number 21: GSAR.Rnw:974-980
###################################################
...
###################################################
### code chunk number 22: GSAR.Rnw:985-990
###################################################
...
###################################################
### code chunk number 23: GSAR.Rnw:996-1013
###################################################
nrow(XYpathway)
nrow(Xipathway)
...
###################################################
### code chunk number 24: GSAR.Rnw:1036-1037
###################################################
sessionInfo()
