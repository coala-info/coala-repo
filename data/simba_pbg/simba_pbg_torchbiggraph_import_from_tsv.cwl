...
baseCommand: torchbiggraph_import_from_tsv
label: simba_pbg_torchbiggraph_import_from_tsv
doc: "Imports edges from TSV files into a format suitable for TorchBigGraph.\n\nTool
...
inputs:
  ...
  - id: bucket_order
    ...
    inputBinding:
      position: 103
  - id: checkpoint_preservation_interval
    type:
      - 'null'
      - int
  ...
  - id: distributed_init_method
    ...
    inputBinding:
      position: 103
  - id: distributed_tree_init_order
    type:
      - 'null'
      - boolean
  ...
  - id: entity_min_count
    type:
      - 'null'
      - int
    doc: Min count for entities
    inputBinding:
      position: 103
      prefix: --entity-min-count
  - id: entity_path
    type:
      - 'null'
      - Directory
  ...
  - id: lhs_col
    type: int
    doc: Column index for source entity
    inputBinding:
      position: 103
      prefix: --lhs-col
  - id: loss_fn
  ...
  - id: num_gpus
    ...
    inputBinding:
      position: 103
  - id: num_groups_for_partition_server
    type:
      - 'null'
      - int
  ...
  - id: rel_col
    type:
      - 'null'
      - int
    doc: Column index for relation entity
    inputBinding:
      position: 103
      prefix: --rel-col
  ...
  - id: relation_rhs
    ...
    inputBinding:
      position: 103
  - id: relation_type_min_count
    type:
      - 'null'
      - int
    doc: Min count for relation types
    inputBinding:
      position: 103
      prefix: --relation-type-min-count
  - id: relation_weight
    type:
      - 'null'
      - float
  ...
  - id: rhs_col
    type: int
    doc: Column index for target entity
    inputBinding:
      position: 103
      prefix: --rhs-col
  - id: verbose
  ...
  - id: weight_col
    type:
      - 'null'
      - int
    doc: (Optional) Column index for edge weight
    inputBinding:
      position: 103
      prefix: --weight-col
  - id: workers
