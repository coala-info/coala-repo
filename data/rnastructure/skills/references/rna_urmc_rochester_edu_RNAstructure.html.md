...
* [RNAstructure Software](RNAstructure.html)
* [RNAstructure Web Servers](RNAstructureWeb/)
* [Group](members.html)

# RNAstructure, Version 6.5:

## Updated June 12, 2024 ([change log](Overview/Updates.html))
...
* [![](images/gears.png) List of All Package
  Components](Overview/Components.html)
* [![](images/history.png) List of Package
  Versions, Changes, and Bugfixes](Overview/Updates.html)
* [![](images/info.png) Online Help &
  Documentation](RNAstructureHelp.html)

# Download/Use:

* [**Download RNAstructure**](register.html) to run software locally.
  ...
  or
* [**Use the Online Tools (RNAstructure Webservers)**](RNAstructureWeb/)
...
RNAstructure is made possible by the support of the National Institutes of Health grant R35GM145283.

© 2012-2025 **Mathews group**
[Contributors](/RNAstructureWeb/Information/Contributors.html) |
[Contact Us](/RNAstructureWeb/feedback.php)