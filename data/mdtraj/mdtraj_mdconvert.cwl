...
doc: "Convert molecular dynamics trajectories between formats. The DCD, XTC, TRR,
  PDB, binpos, NetCDF, binpos, LH5, and HDF5 formats are supported (.dcd, .xtc, .trr,
...
inputs:
  ...
  - id: index
    ...
    doc: load a *specific* set of frames. flexible, but inefficient for a large 
      ...
      N:M to load frames N to M, etc. see http://bit.ly/143kloq for details on 
      the notation
    inputBinding:
      position: 102
      prefix: --index
  ...
  - id: topology
    ...
    doc: path to a PDB/prmtop file. this will be used to parse the topology of 
      ...
      output the coordinates of your dcd/xtc/trr/netcdf/binpos as a PDB file. If
      you're converting *to* .h5, the topology will be stored inside the h5 
      file.
    inputBinding:
      position: 102
      prefix: --topology
