...
[Skip to content](#detecting-contaminated-sequences-in-a-bacteria-assembly)
...
* [x]
  ...
  + [ ]
    ...
    - [Hardware](#hardware)
    - [Steps](#steps)
    - [Results of other genomes](#results-of-other-genomes)
...
* KMCP database v2023.05: please choose files below to download from [here](https://1drv.ms/f/s%21Ag89cZ8NYcqtlhYlyHuaKweYNu93?e=9NOxqg).
