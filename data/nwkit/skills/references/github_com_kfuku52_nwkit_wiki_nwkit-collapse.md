...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fkfuku52%2Fnwkit%2Fwiki%2Fnwkit-collapse)
...
·
[2 revisions](/kfuku52/nwkit/wiki/nwkit-collapse/_history)

## Overview

`nwkit collapse` removes internal branches that fail a support threshold and/or are shorter than a branch-length threshold.

This is useful for simplifying weakly supported regions before plotting or downstream comparison.
...
```
nwkit collapse -i tree.nwk -o collapsed.nwk \
  --format 0 \
  --min_support 70
```

Internal branches with support smaller than `70` are deleted.

### Example input (`tree.nwk`)

```
((A:1,B:1)40:1,(C:1,D:1)90:1);
```

### Example output (`collapsed.nwk`)

```
((C:1,D:1)90:1,A:2,B:2);
```

In this example, the weakly supported `A+B` clade is collapsed and its deleted branch length is added to the descendant branches.
...
Internal branches with branch length less than or equal to the threshold are deleted.

## Other options

* `--preserve_branch_length yes|no`: when `yes`, the deleted branch length is added to descendant branches
...
* Loading
  ...
  + [Overview](/kfuku52/nwkit/wiki/nwkit-collapse#overview)
  + [Collapse by support](/kfuku52/nwkit/wiki/nwkit-collapse#collapse-by-support)
  + [Command](/kfuku52/nwkit/wiki/nwkit-collapse#command)
  + [Example input (tree.nwk)](/kfuku52/nwkit/wiki/nwkit-collapse#example-input-treenwk)
  + [Example output (collapsed.nwk)](/kfuku52/nwkit/wiki/nwkit-collapse#example-output-collapsednwk)
  + [Collapse by branch length](/kfuku52/nwkit/wiki/nwkit-collapse#collapse-by-branch-length)
  + [Command](/kfuku52/nwkit/wiki/nwkit-collapse#command-1)
  + [Other options](/kfuku52/nwkit/wiki/nwkit-collapse#other-options)
* Loading
