...
baseCommand:
  - phykit
  - cophylo
label: phykit_cophylo
doc: Cophylogenetic (tanglegram) plot of two phylogenies. Draws two trees facing
  each other with connecting lines between matching taxa, analogous to R's 
  phytools::cophylo().
inputs:
  - id: tree1
    type: File
  ...
  - id: mapping
    type:
      - 'null'
      - File
    doc: optional tab-delimited mapping file (taxon1<tab>taxon2)
    inputBinding:
      position: 101
      prefix: --mapping
  - id: fig_width
