---
name: rna-star
description: STAR (Spliced Transcripts Alignment to a Reference) is a specialized bioinformatics tool designed to align RNA-seq reads to a reference genome.
