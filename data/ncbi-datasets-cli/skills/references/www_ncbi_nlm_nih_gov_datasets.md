[Skip to main page content](#maincontent)
...
A one-stop shop for finding, browsing, and downloading genomic sequences, annotations, and metadata

Examples:

## [NIH Comparative Genomics Resource (CGR)](https://www.ncbi.nlm.nih.gov/comparative-genomics-resource)

This resource is part of the NIH Comparative Genomics Resource (CGR) Toolkit

* [About CGR](https://www.ncbi.nlm.nih.gov/comparative-genomics-resource/about/)
* [Data resources](https://www.ncbi.nlm.nih.gov/comparative-genomics-resource/data-resources/)
* [Analysis tools](https://www.ncbi.nlm.nih.gov/comparative-genomics-resource/analysis-tools/)
* [Data quality tools](https://www.ncbi.nlm.nih.gov/comparative-genomics-resource/data-quality-tools/)
