...
FATAL:   Unable to handle docker://quay.io/biocontainers/ppanggolin:2.2.6--py310h1fe012e_0 uri: while building SIF from layers: conveyor failed to get: invalid character '}' after top-level value
```
