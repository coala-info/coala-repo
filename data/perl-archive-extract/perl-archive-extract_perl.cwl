...
baseCommand: perl
label: perl-archive-extract_perl
doc: "The Perl 5 language interpreter\n\nTool homepage: http://metacpan.org/pod/Archive::Extract"
inputs:
  - id: program_file
    type:
      - 'null'
...
hints:
  - class: DockerRequirement
    dockerPull: quay.io/biocontainers/perl-archive-extract:0.88--pl5321hdfd78af_0
stdout: perl-archive-extract_perl.out
