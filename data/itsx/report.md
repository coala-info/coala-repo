...
### Tool Description
ITSx - ITSx is a tool for the automated identification of eukaryotic Internal Transcribed Spacer (ITS) sequences.

### Metadata
- **Docker Image**: quay.io/biocontainers/itsx:1.1.3--hdfd78af_1
- **Homepage**: http://microbiology.se/software/itsx/
- **Package**: https://anaconda.org/channels/bioconda/packages/itsx/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/itsx/overview
