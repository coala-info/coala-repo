...
## Formatting input data[¶](#formatting-input-data "Link to this heading")
...
It is important that your samples file has at least three columns: `sample_name` with the unique identifier of each sample, `R1` with the file path to the **forward reads** and `R2` with the file path to the **reverse reads**. You may also want to include a `group` column to perform different strategies for assembly and binning. Please see the [Assembly and Binning section](advanced.html#assembly-and-binning) for a description of how to choose your strategy.

### Creating your samples table[¶](#creating-your-samples-table "Link to this heading")
...
## Finding logs[¶](#finding-logs "Link to this heading")
...
## Conda environment problems[¶](#conda-environment-problems "Link to this heading")
...
### Environment errors when starting Metaphor[¶](#environment-errors-when-starting-metaphor "Link to this heading")
...
## Adding additional flags to Snakemake[¶](#adding-additional-flags-to-snakemake "Link to this heading")
...
## Unlocking directories[¶](#unlocking-directories "Link to this heading")
...
## Misc problems[¶](#misc-problems "Link to this heading")
...
* Troubleshooting
  ...
  + [Conda environment problems](#conda-environment-problems)
  + [Adding additional flags to Snakemake](#adding-additional-flags-to-snakemake)
  + [Unlocking directories](#unlocking-directories)
...
* [Documentation overview](../index.html)
  + Previous: [Configuration](configuration.html "previous chapter")
  + Next: [Contributing](contributing.html "next chapter")

### Quick search

© The University of Melbourne 2023 — This documentation is pub