...
#### Modified: Jan 2025. Compiled: 30 Oct 2025

# Contents

* [1 Overview](#overview)
* [2 Setting up a package to use a Hub](#setting-up-a-package-to-use-a-hub)
  + [2.1 New Hub package](#new-hub-package)
    - [2.1.1 Notify `Bioconductor` team member](#notify-bioconductor-team-member)
    - [2.1.2 Building the package](#building-the-package)
    - [2.1.3 Data objects](#data-objects)
    - [2.1.4 Confirm Valid Metadata](#confirm-valid-metadata)
    - [2.1.5 Package review](#package-review)
  + [2.2 Additional resources to existing Hub package](#additional-resources-to-existing-hub-package)
  + [2.3 Converting a non AnnotationHub annotation package or non ExperimentHub](#converting-a-non-annotationhub-annotation-package-or-non-experimenthub)
* [3 Bug fixes](#bug-fixes)
  + [3.1 Update the resource](#update-the-resource)
  + [3.2 Update the metadata](#update-the-metadata)
* [4 Remove resources](#remove-resources)
* [5 Versioning](#versioning)
* [6 Visibility](#visibility)
* [7 Storage of Data Files](#storage-of-data-files)
  + [7.1 Hosting Data on a Publicly Accessible Site](#hosting-data-on-a-publicly-accessible-site)
  + [7.2 Uploading Data to Microsoft Azure Genomic Data Lake](#uploading-data-to-microsoft-azure-genomic-data-lake)
    - [7.2.1 R Interface with R package](#r-interface-with-r-package)
    - [7.2.2 Command Line via AWS S3 CLI](#command-line-via-aws-s3-cli)
    - [7.2.3 Utilizing the Bioconductor Docker container](#utilizing-the-bioconductor-docker-container)
* [8 Validating](#validating)
* [9 Example metadata.csv file and more information](#example-metadata.csv-file-and-more-information)
...
* package man page:
  ...
  all resources associated with the package. There should be an
...
* Generate a new metadata.csv file. The package should contain
  ...
  write a new csv file named by version, e.g., metadata\_v84.csv, metadata\_85.csv
...
### 7.2.1 R Interface with R package
...
### 7.2.2 Command Line via AWS S3 CLI
...
### 7.2.3 Utilizing the Bioconductor Docker container
...
* Coordinate\_1\_based: ‘logical’. TRUE if data are 1-based. Can be NA.
...
* Location\_Prefix: ‘character(1)’. **Do not** include this field if data are stored
...
* RDataPath: ‘character(1)’.This field should be the remainder of the path to
  the resource. The ‘Location\_Prefix’ will be prepended to ‘RDataPath’ for the
...
More on Location\_Prefix and RDataPath. These two fields make up the complete
file path url for downloading the data file. If using the Bioconductor Microsoft
Azure Genomic Data Lake the Location\_Prefix should not be included in the metadata file[s] as this field
...
| Title | Description | BiocVersion | Genome | SourceType | SourceUrl | SourceVersion | Species | TaxonomyId | Coordinate\_1\_based | DataProvider | Maintainer | RDataClass | DispatchClass | RDataPath |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Dog Annotation | Gene Annotation for Canis lupus from ensembl | 3.9 | Canis lupus | GTF | ftp://ftp.ensembl.org/pub/release-95/gtf/canis\_lupus\_dingo/Canis\_lupus\_dingo.ASM325472v1.95.gtf.gz | release-95 | Canis lupus | 9612 | true | ensembl | Bioconductor Maintainer maintainer@bioconductor.org | character | FilePath | myAnnotations/canis\_lupus\_dingo.ASM325472v1.95.gtf.gz |
| Cow Annotation | Gene Annotation for Bos taurus from ensemble | 3.9 | Bos taurus | GTF | ftp://ftp.ensembl.org/pub/release-74/gtf/bos\_taurus/Bos\_taurus.UMD3.1.74.gtf.gz | release-74 | Bos taurus | 9913 | true | ensembl | Bioconductor Maintainer maintainer@bioconductor.org | character | FilePath | myAnnotations/Bos\_taurus.UMD3.1.74.gtf.gz |
