...
### Tool Description
an ultra-fast tool for fast identification of SARS-CoV-2 and other microbes from sequencing data.

### Metadata
- **Docker Image**: quay.io/biocontainers/fastv:0.10.0--h077b44d_1
- **Homepage**: https://github.com/OpenGene/fastv
- **Package**: https://anaconda.org/channels/bioconda/packages/fastv/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/fastv/overview
...
### Original Help Text
```text
fastv: an ultra-fast tool for fast identification of SARS-CoV-2 and other microbes from sequencing data.
version 0.10.0
usage: fastv [options] ... 
options:
