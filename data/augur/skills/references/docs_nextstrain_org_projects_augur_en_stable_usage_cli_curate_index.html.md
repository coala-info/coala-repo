...
* [Using Augur](../../usage.html)
* [Augur subcommands](../cli.html)
* [View page source](../../../_sources/usage/cli/curate/index.rst.txt)

---

# augur curate[](#augur-curate "Link to this heading")
...
If you need to parse metadata from a FASTA headers, please continue to use [augur parse](../parse.html).
...
[Previous](../parse.html "augur parse")
[Next](passthru.html "passthru")
