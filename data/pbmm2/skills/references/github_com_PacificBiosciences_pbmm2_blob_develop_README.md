...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2FPacificBiosciences%2Fpbmm2%2Fblob%2Fdevelop%2FREADME.md)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fblob%2Fshow&source=header-repo&source_repo=PacificBiosciences%2Fpbmm2)
...
[History](/PacificBiosciences/pbmm2/commits/develop/README.md)

History

560 lines (442 loc) · 23 KB
...
[Raw](https://github.com/PacificBiosciences/pbmm2/raw/refs/heads/develop/README.md)
...
# [![](/PacificBiosciences/pbmm2/raw/develop/img/pbmm2.png)](/PacificBiosciences/pbmm2/blob/develop/img/pbmm2.png)
...
*pbmm2* is a SMRT C++ wrapper for [minimap2](https://github.com/lh3/minimap2)'s C API.
...
*pbmm2* supports the `.fofn` file type (File Of File Names), containing the same
...
For `ISOSEQ`, you can override additional 