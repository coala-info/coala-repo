...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fczc%2Fnb_distribution%2Fblob%2Fmaster%2Frun_ssake.pl)
...
[History](/czc/nb_distribution/commits/master/run_ssake.pl)
...
[Raw](https://github.com/czc/nb_distribution/raw/refs/heads/master/run_ssake.pl)
...
my $file = shift or die "$0 <bp\_reads.txt>\n";

open RD, $file or die $!;

open OUT, ">$file.localreads.fa" or die $!;

my $old\_fh = select(OUT);
