# Galaxy Protein Conformational Transitions calculations tutorial CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://mmb.irbbarcelona.org/biobb/
- **Package**: https://workflowhub.eu/workflows/558
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/558/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 924
...
- **Main workflow (WorkflowHub):** `biobb_wf_godmd.ga` (Main Workflow)
...
- **Discussion / source**: https://biobb.usegalaxy.es/u/gbayarri/w/protein-conformational-transitions-calculations
- **Discussion / source**: https://biobb-wf-godmd.readthedocs.io/en/latest/tutorial.html
