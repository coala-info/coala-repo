...
* [cath-ssap](./)
  + [Preparing to run SSAP](#preparing-to-run-ssap)
  + [Running SSAP](#running-ssap)
  + [Usage](#usage)
  + [DSSP, WOLF and sec](#dssp-wolf-and-sec)
  + [Feedback](#feedback)
...
[Previous](../cath-resolve-hits/ "cath-resolve-hits")
[Next](../cath-superpose/ "cath-superpose")
