...
* Quality Control
  ...
  + [Catch-all failures](#catch-all-failures)
  + [Registration/cropping failures](#registration-cropping-failures)
  + [Checking the automated check](#checking-the-automated-check)
...
* Quality Control
* [View page source](../_sources/outputs/QC.md.txt)
...
## Automated checks[](#automated-checks "Permalink to this heading")
...
## Catch-all failures[](#catch-all-failures "Permalink to this heading")

A good way to be sure that nothing has failed is also to look at the final results, as in the following snapshot images.

`sub-001_hemi-L_space-cropT1w_desc-subfields_atlas-histologyReference2023_dseg.png`:

![image](../_images/sub-001_hemi-L_space-cropT1w_desc-subfields_atlas-histologyReference2023_dseg.png)
...
![image](../_images/sub-001_hemi-L_space-T1w_den-0p5mm_label-hipp_desc-subfields_midthickness.surf.png)

`sub-001_hemi-L_space-T1w_den-0p5mm_label-dentate_desc-subfields_midthickness.surf.png`:

![image](../_images/sub-001_hemi-L_space-T1w_den-0p5mm_label-dentate_desc-subfields_midthickness.surf.png)
...
## Registration/cropping failures[](#registration-cropping-failures "Permalink to this heading")
...
![image](../_images/sub-001_from-T1w_to-CITI168_regqc.png)
...
## Checking the automated check[](#checking-the-automated-check "Permalink to this heading")
...
[Previous](visualization.html "Visualization")
[Next](../contributing/references.html "References")
