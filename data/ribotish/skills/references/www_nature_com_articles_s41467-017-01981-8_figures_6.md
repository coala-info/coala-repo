...
* [Search](#search-menu)
* [Log in](https://idp.nature.com/auth/personal/springernature?redirect_uri=https://www.nature.com/articles/s41467-017-01981-8/figures/6)
...
![Fig. 6](//media.springernature.com/full/springer-static/image/art%3A10.1038%2Fs41467-017-01981-8/MediaObjects/41467_2017_1981_Fig6_HTML.jpg)

Experimental validations of the computationally predicted smORFs. **a** rRibo-seq and LTM-based TI-seq RPF count profiles in HEK293 cell line for a predicted uORF in 5′UTR of *EIF5*. **b** FLAG-tagged uORF within the context of the host mRNA was ectopically expressed and translation of the predicted polypeptide was detected by western blot with an anti-FLAG antibody. β-actin protein was used as internal control for western blot analysis. **c** rRibo-seq and LTM-based TI-seq RPF count profiles for a predicted ORF encoded by lncRNA *DANCR*. **d** FLAG-tagged smORF within the context of host lncRNA was ectopically expressed and translation of the predicted polypeptide was detected by western blot with an anti-FLAG antibody. **e** rRibo-seq and LTM-based TI-seq RPF count profiles for a predicted ORF encoded by an intron of *BLOC1S3*. **f** FLAG-tagged intronic smORF within the context of the host mRNA was ectopically expressed and translation of predicted polypeptide was detected by western blot with an anti-FLAG antibody

[Back to article page](/articles/s41467-017-01981-8#Fig6)
