...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fmmb-irb%2Fpcasuite%2Fblob%2Fmaster%2Fbinpos_io.c)
...
[History](/mmb-irb/pcasuite/commits/master/binpos_io.c)
...
[Raw](https://github.com/mmb-irb/pcasuite/raw/refs/heads/master/binpos_io.c)
...
fseek (xf->file, 4, SEEK\_SET);

fread (&xf->natoms, 4, 1, xf->file);

fseek (xf->file, 0, SEEK\_END);
...
fseek (xf->file, 8+((is-1)\*(((xf->natoms\*3)+1)\*4)), SEEK\_SET);
