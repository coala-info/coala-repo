...
* Tutorial
  ...
  + [Usage](#usage)
    - [Genotype](#genotype)
    - [View VNTRs](#view-vntrs)
    - [Add Custom VNTR](#add-custom-vntr)
    - [Delete a VNTR](#delete-a-vntr)

[adVNTR](index.html)

* [Docs](index.html) »
* Tutorial
* [Edit on GitHub](https://github.com/mehrdadbakhtiari/adVNTR/blob/master/docs/tutorial.rst)
...
|  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| #CHROM | Start | End | VNTR\_ID | Gene | Motif | RefCopy | R1 | R2 |
| chr21 | 45196324 | 45196360 | 301645 | CSTB | CGCGGGGCGGGG | 3 | 2 | 3 |

* VCF
  :   Please see [VCF\_specification](http://samtools.github.io/hts-specs/VCFv4.2.pdf) for detailed information on VCF file format. The followings are the
...
### Genotype[¶](#genotype "Permalink to this headline")

Use `advntr genotype [options]` to genotype a VNTR using sequencing data.
...
| `-m, --models <file>` | |
|  | file containing VNTRs information [vntr\_data/hg19\_VNTRs.db] |
| `-t, --threads <int>` | |
|  | number of threads [4] |
...
### View VNTRs[¶](#view-vntrs "Permalink to this headline")

Under construction …

### Add Custom VNTR[¶](#add-custom-vntr "Permalink to this headline")

Use `advntr addmodel [options]` to add a VNTR to the database.
...
-m/–models <file> VNTR models file [vntr\_data/hg19\_selected\_VNTRs\_Illumina.db]
-h, –help show this help message and exit

You can use `--update` in genotyping step to iteratively update the model using real data.

### Delete a VNTR[¶](#delete-a-vntr "Permalink to this headline")

Use `advntr delmodel --vntr_id <ID>` to remove a VNTR from database.

Required arguments:
-vid/–vntr\_id <text> VNTR ID
