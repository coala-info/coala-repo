...
FATAL:   Unable to handle docker://quay.io/biocontainers/somalier:0.3.1--hc78c8e0_0 uri: while building SIF from layers: conveyor failed to get: invalid character '}' after top-level value
```
