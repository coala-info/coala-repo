...
The *s5curl\_t* structure stores the url and the metadata of the remote BLOW5 file. This structure has the following form:
...
The *s5curl\_mt\_t* is a struct intended to be used by multi-threaded fetches. This structure has the following form:
...
* [s5curl\_global\_init](/slow5curl/slow5curl_api/s5curl_global_init.html)
      global initialisation for slow5curl
* [s5curl\_global\_cleanup](/slow5curl/slow5curl_api/s5curl_global_cleanup.html)
      releases resources acquired by s5curl\_global\_init

#### Accessing a File

* [s5curl\_open](/slow5curl/slow5curl_api/s5curl_open.html)
      opens a remote BLOW5 file
* [s5curl\_close](/slow5curl/slow5curl_api/s5curl_close.html)
      closes a remote BLOW5 file
* [s5curl\_idx\_load](/slow5curl/slow5curl_api/s5curl_idx_load.html)
      fetches and loads the index file for a remote BLOW5 file
* [s5curl\_idx\_load\_with](/slow5curl/slow5curl_api/s5curl_idx_load_with.html)
      loads a custom index (remote or local) for a remote BLOW5 file
* [s5curl\_idx\_unload](/slow5curl/slow5curl_api/s5curl_idx_unload.html)
      unloads a BLOW5 index from the memory

#### Connection Handle Initialisation

* [s5curl\_conn\_init](/slow5curl/slow5curl_api/s5curl_conn_init.html)
      opens a new connection handle for single fetches
* [s5curl\_conn\_cleanup](/slow5curl/slow5curl_api/s5curl_conn_cleanup.html)
      closes an existing connection handle
* [s5curl\_init\_mt](/slow5curl/slow5curl_api/s5curl_init_mt.html)
      initialises a multithread struct for batch fetches
* [s5curl\_free\_mt](/slow5curl/slow5curl_api/s5curl_free_mt.html)
      frees a multithread struct from memory

#### Fetching

* [s5curl\_get](/slow5curl/slow5curl_api/s5curl_get.html)
      fetches a record corresponding to a given read ID
* [s5curl\_get\_batch](/slow5curl/slow5curl_api/s5curl_get_batch.html)
...
This site is open source. [Improve this page](https://github.com/BonsonW/slow5curl/edit/main/docs/slow5curl_api/slow5curl.md).