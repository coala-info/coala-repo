...
* [Assemble](../assemble/)
* Usage
  + [Run options explained](#run-options-explained)
  + [Example usage](#example-usage)
    - [Using short reads](#using-short-reads)
    - [Using long reads](#using-long-reads)
  + [Output](#output)
    - [1. preprocess - preprocessing results](#1-preprocess-preprocessing-results)
    - [2. phables - genome resolution results](#2-phables-genome-resolution-results)
    - [3. postprocess - postprocessing results](#3-postprocess-postprocessing-results)
  + [Step-wise usage](#step-wise-usage)
    - [Preprocessing only](#preprocessing-only)
    - [Genome resolution only](#genome-resolution-only)
    - [Postprocessing only](#postprocessing-only)
* [FAQ](../faq/)
...
* RUNNING
* Usage
* [Edit on GitHub](https://github.com/Vini2/phables/edit/master/docs/usage.md)
