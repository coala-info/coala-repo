---
name: argo
description: Argo is a specialized bioinformatics profiler that provides species-level resolution for antibiotic resistance genes (ARGs) within complex metagenomes.
