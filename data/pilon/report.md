# pilon CWL Generation Report

## pilon

### Tool Description
Pilon is a tool for genome assembly improvement and variant calling using read alignments.

### Metadata
- **Docker Image**: quay.io/biocontainers/pilon:1.24--hdfd78af_0
- **Homepage**: https://github.com/broadinstitute/pilon/
- **Package**: https://anaconda.org/channels/bioconda/packages/pilon/overview
- **Validation**: PASS
