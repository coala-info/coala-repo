...
* [Workflows](../workflows.html)
  ...
  + scRNA-seq
    ...
    - [Filling out the config.yaml](#filling-out-the-config-yaml)
      ...
      * [Quantification with kallistobus](#quantification-with-kallistobus)
      * [scRNA-seq pre-processing and quality control](#scrna-seq-pre-processing-and-quality-control)
      * [Advanced settings](#advanced-settings)
      * [Alternative experiments](#alternative-experiments)
...
* [Workflows](../workflows.html)
* scRNA-seq
* [Edit on GitHub](https://github.com/vanheeringen-lab/seq2science/blob/master/docs/content/workflows/scrna_seq.md)

---

# scRNA-seq[](#scrna-seq "Link to this heading")
...
### Quantification[](#quantification "Link to this heading")
...
The descriptive\_name column is used for the multiqc report.
...
### Quantification with kallistobus[](#quantification-with-kallistobus "Link to this heading")
...
#### BUS (Barcode/UMI/Set) format[](#bus-barcode-umi-set-format "Link to this heading")
...
#### Input preparations for KITE workflow[](#input-preparations-for-kite-workflow "Link to this heading")
...
##### Quantification with CITE-seq-Count[](#quantification-with-cite-seq-count "Link to this heading")
...
### scRNA-seq pre-processing and quality control[](#scrna-seq-pre-processing-and-quality-control "Link to this heading")
...
To enable the sctk\_qc workflow, set `run_sctk_qc=True`. Alternatively, one can skip quality control and export the UMI count matrix to a SingleCellExperiment object by setting `export_sce_objects=True`. However, there is no need to set `export_sce_objects` manually when `run_sctk_qc` is enabled.
...
* `sctk_detect_cell` (*default*: `True`)
  Perform cell-calling for droplet based experiments. Empty droplets will not be removed if set to `False`.
* `sctk_cell_calling` (*default*: `Knee`)
  Method used for cell calling with [DropletUtils