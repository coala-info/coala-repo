...
### Tool Description
FLASH (Fast Length Adjustment of SHort reads) is an accurate and fast tool to merge paired-end reads that were generated from DNA fragments whose lengths are shorter than twice the length of reads.

### Metadata
- **Docker Image**: quay.io/biocontainers/flash2:2.2.00--h577a1d6_9
- **Homepage**: https://github.com/dstreett/FLASH2
- **Package**: https://anaconda.org/channels/bioconda/packages/flash2/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/flash2/overview
