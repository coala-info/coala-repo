...
inputs:
  ...
  - id: chim_junction_overhang_min
    type:
      - 'null'
      - int
    doc: minimum overhang for a chimeric junction
    default: 20
    inputBinding:
      position: 101
  ...
  - id: chim_main_segment_mult_nmax
    type:
      - 'null'
      - int
    doc: maximum number of multi-alignments for the main chimeric segment. =1 
  ...
  - id: chim_multimap_nmax
    type:
      - 'null'
      - int
    doc: "maximum number of chimeric multi-alignments\n                          \
  ...
  - id: chim_multimap_score_range
    type:
      - 'null'
      - int
    doc: the score range for multi-mapping chimeras below the best chimeric 
  ...
  - id: chim_nonchim_score_drop_min
    type:
      - 'null'
      - int
    doc: to trigger chimeric detection, the drop in the best non-chimeric 
      alignment score with respect to the read length has to be smaller than 
      this value
    default: 20
    inputBinding:
      position: 101
  ...
  - id: chim_score_drop_max
    type:
      - 'null'
      - int
    doc: max drop (difference) of chimeric score (the sum of scores of all 
  ...
  - id: chim_score_min
    type:
      - 'null'
      - int
    doc: minimum total (summed) score of the chimeric segments
    default: 0
    inputBinding:
      position: 101
      prefix: --chimScoreMin
  - id: chim_score_separation
    type:
      - 'null'
      - int
    doc: minimum difference (separation) between the best chimeric score and the
      next one
    default: 10
    inputBinding:
      position: 101
  ...
  - id: chim_segment_min
    type:
      - 'null'
      - int
    doc: minimum length of chimeric segment length, if ==0, no chimeric output
    default: 0
    inputBinding:
      position: 101
  ...
  - id: chim_segment_read_gap_max
    type:
      - 'null'
      - int
    doc: maximum gap in the read sequence between chimeric segments
    default: 0
    inputBinding:
      position: 101
      prefix: --chimSegmentReadGapMax
  - id: clip_3p_adapter_mmp
    type:
      - 'null'
      - type: array
        items: float
  ...
  - id: clip_3p_after_adapter_nbases
    type:
      - 'null'
      - type: array
        items: int
  ...
  - id: solo_out_file_names
    ...
    default: Solo.out/ genes.tsv barcodes.tsv matrix.mtx matrixSJ.mtx
    inputBinding:
      position: 101
