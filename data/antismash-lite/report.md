...
### Metadata
- **Docker Image**: quay.io/biocontainers/antismash-lite:8.0.1--pyhdfd78af_0
- **Homepage**: https://docs.antismash.secondarymetabolites.org/intro/
- **Package**: https://anaconda.org/channels/bioconda/packages/antismash-lite/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/antismash-lite/overview
...
## antismash-lite_download-antismash-databases

### Tool Description
Base directory for the antiSMASH databases
...
### Original Help Text
```text
usage: download-antismash-databases [-h] [--database-dir DIR]

options:
  -h, --help          show this help message and exit
  --database-dir DIR  Base directory for the antiSMASH databases (default:
                      /usr/local/lib/python3.11/site-
                      packages/antismash/databases).
```
