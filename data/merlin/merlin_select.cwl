...
inputs:
  ...
  - id: custom
    type:
      - 'null'
      - File
    doc: Association custom parameter table
    inputBinding:
      position: 101
      prefix: --custom
  - id: data_file
  ...
  - id: megabytes
    type:
      - 'null'
      - int
    doc: Limits megabytes parameter
    inputBinding:
      position: 101
      prefix: --megabytes
  - id: min_step
  ...
  - id: trait
    type:
      ...
      - type: array
        items: string
    doc: Simulation trait parameter
    inputBinding:
      position: 101
      prefix: --trait
  - id: trim
