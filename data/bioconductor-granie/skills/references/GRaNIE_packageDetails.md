...
* [1 Motivation and Necessity](#motivation)
* [2 Installation](#installation)
  + [2.1 `GRaNIE` package and required dependency packages](#granie-package-and-required-dependency-packages)
  + [2.2 Additional packages](#additional-packages)
  + [2.3 Detailed information about the scope of the optional packages](#detailed-information-about-the-scope-of-the-optional-packages)
* [3 Example Workflow](#workflow)
* [4 Example GRN object](#example-grn-object)
* [5 Input](#input)
  + [5.1 Open chromatin and RNA-seq data](#input_peaks)
  + [5.2 TF and TFBS data](#input_TF)
    - [5.2.1 HOCOMOCO-derived TFBS and download links](#hocomoco-derived-tfbs-and-download-links)
    - [5.2.2 Other TFBS sources](#other-tfbs-sources)
    - [5.2.3 Importing TF and TFBS from the JASPAR databases directly in R](#importing-tf-and-tfbs-from-the-jaspar-databases-directly-in-r)
  + [5.3 Sample metadata (optional but highly recommended)](#input_metadata)
  + [5.4 Hi-C data (optional)](#input_HiC)
  + [5.5 Capture Hi-C data / known promoter-enhancer links (optional)](#input_HiC_capture)
  + [5.6 SNP data (optional)](#input_SNP)
  + [5.7 TF activity data (optional, coming soon)](#tf-activity-data-optional-coming-soon)
* [6 Methodological Details and Basic Mode of Action](#methods)
  + [6.1 Data normalization](#methods_dataNorm)
    - [6.1.1 Normalization methods common for peaks and RNA data](#normalization-methods-common-for-peaks-and-rna-data)
    - [6.1.2 Normalization methods specific for peaks data](#normalization-methods-specific-for-peaks-data)
    - [6.1.3 Raw vs pre.normalized data](#raw-vs-pre.normalized-data)
  + [6.2 TF-peak connections](#methods_TF_peak)
    - [6.2.1 TF-peak connection types](#methods_TF_peak_connectionTypes)
    - [6.2.2 GC correction](#methods_TF_peak_GC)
    - [6.2.3 TF Activity connections](#methods_TF_peak_TFActivity)
  + [6.3 Peak-gene associations](#methods_peakGene)
  + [6.4 Building eGRNs: Linking TF-peak and peak-gene links and filtering](#methods_TF_peak_gene_links)
  + [6.5 Background eGRN](#methods_background)
    - [6.5.1 Methods](#methods-1)
    - [6.5.2 Object and output details related to the background links](#methods_background_objectDetails)
  + [6.6 Constructing the *eGRN* graph](#constructing-the-egrn-graph)
  + [6.7 Enrichment analyses](#enrichment-analyses)
  + [6.8 Network visualization and visualization filtering](#network-visualization)
    - [6.8.1 General comments](#general-comments)
    - [6.8.2 Changing the visualization parameters and layout](#changing-the-visualization-parameters-and-layout)
    - [6.8.3 Filtering the network for visualization purposes](#filtering-the-network-for-visualization-purposes)
  + [6.9 Feature variation quantification](#feature-variation-quantification)
* [7 Output](#output)
  + [7.1 GRN object and results stored within](#output_GRN)
    - [7.1.1 Object details](#object-details)
    - [7.1.2 Results in the object](#results-in-the-object)
    - [7.1.3 Object summary](#object-summary)
  + [7.2 Original and normalized data, annotations and provided metadata](#original-and-normalized-data-annotations-and-provided-metadata)
    - [7.2.1 Object data](#object-data)
    - [7.2.2 Plots](#plots)
  + [7.3 PCA plots and results](#output_PCA)
    - [7.3.1 Object data](#object-data-1)
    - [7.3.2 Plots](#plots-1)
  + [7.4 TF-peak results and diagnostic plots](#output_TF_peak)
    - [7.4.1 Object data](#object-data-2)
    - [7.4.2 Plots](#plots-2)
    - [7.4.3 Extra plots for the GC correction](#extra-plots-for-the-gc-correction)
  + [7.5 Activator-repressor classification results and diagnostic plots](#output_AR)
    - [7.5.1 Object data](#object-data-3)
    - [7.5.2 Plots](#plots-3)
  + [7.6 Peak-gene results and diagnostic plots](#output_peak_gene)
    - [7.6.1 Object data](#object-data-4)
    - [7.6.2 Plots](#plots-4)
  + [7.7 Filtered TF-peak-gene connections (*eGRN* table)](#filtered-tf-peak-gene-connections-egrn-table)
    - [7.7.1 Object data](#object-data-5)
    - [7.7.2 Plots](#plots-5)
  + [7.8 TF-gene connections](#tf-gene-connections)
    - [7.8.1 Object data](#object-data-6)
    - [7.8.2 Plots](#plots-6)
  + [7.9 Connection summary plots](#output_connectionSummary)
    - [7.9.1 Object data](#object-data-7)
    - [7.9.2 Plots](#plots-7)
  + [7.10 eGRN graph](#egrn-graph)
    - [7.10.1 Object data](#object-data-8)
    - [7.10.2 Plots](#plots-8)
  + [7.11 Community information](#community-information)
    - [7.11.1 Object data](#object-data-9)
    - [7.11.2 Plots](#plots-9)
  + [7.12 Enrichment results and plots](#output_enrichment)
    - [7.12.1 Object data](#object-data-10)
    - [7.12.2 Plots](#plots-10)
  + [7.13 Feature variation quantification](#output_featureVariation)
    - [7.13.1 Object data](#object-data-11)
    - [7.13.2 Plots](#plots-11)
  + [7.14 SNP data](#output_SNP)
    - [7.14.1 Object data](#object-data-12)
    - [7.14.2 Plots](#plots-12)
* [8 Guidelines, Recommendations, Limitations, Scope](#guidelines)
  + [8.1 Package scope](#guidelines_scope)
  + [8.2 Number of samples](#guidelines_noSamples)
  + [8.3 Peaks](#guidelines_peaks)
  + [8.4 RNA-Seq](#guidelines_RNA)
  + [8.5 Transcription factor binding sites (TFBS)](#guidelines_TFBS)
  + [8.6 Choice of correlation methods for TF-peak, peak-gene, TF-gene connections and outlier robustness](#choice-of-correlation-methods-for-tf-peak-peak-gene-tf-gene-connections-and-outlier-robustness)
  + [8.7 Peak-gene p-values accuracy and violations](#guidelines_peakGene)
  + [8.8 eGRNs from single-cell data](#guidelines_singleCell)
  + [8.9 Recapitulating object history, function parameters etc](#guidelines_objectHistory)
* [9 Memory footprint and execution time, feasibility with large datasets](#resources)
  + [9.1 CPU time](#resources_cpu)
  + [9.2 Memory footprint](#resources_memory)
* [10 References](#refs)
* **Appendix**
...
3. We currently offer two different modes of how to create a GC-matched
   background.
   1. When `percBackground_resample` is set to a value > 0 (default
   ...
   2. When `percBackground_resample = 0`, an automatic iterative
