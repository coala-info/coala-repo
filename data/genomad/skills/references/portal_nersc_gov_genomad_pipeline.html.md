...
# The geNomad pipeline[#](#the-genomad-pipeline "Permalink to this heading")
...
![_images/pipeline_overview.svg](_images/pipeline_overview.svg)
...
![_images/annotate.svg](_images/annotate.svg)
...
The `annotate` module generates two primary outputs: taxonomic assignments of the input sequences (you can find an explanation of how geNomad assigns sequences to viral taxa [here](taxonomic_assignment.html)), and gene-level annotations (as shown in the [Quickstart](quickstart.html#understanding-the-outputs) example). These outputs are utilized by the `find-proviruses`, `marker-classification`, and `summary` modules.

## `find-proviruses`[#](#find-proviruses "Permalink to this heading")

![_images/find_proviruses.svg](_images/find_proviruses.svg)

The `find-proviruses` module is designed to identify proviral regions within host sequences. To achieve this, it uses a conditional random field (CRF) model that takes gene annotations generated by the `annotate` module and demarcates regions that are enriched in viral-specific markers, surrounded by host-specific markers. To refine the boundaries of proviruses, geNomad leverages the fact that phages often integrate next to tRNAs and that integrases are typically found at the edges of integrated phages. This is achieved by extending the edges until neighboring tRNAs (identified with [`ARAGORN`](http://www.ansikte.se/ARAGORN/)) and/or integrases (identified with `MMseqs2`) are reached. For a detailed explanation of geNomad’s provirus identification algorithm, please refer to our [provirus identification documentation](provirus_identification.html).

## `marker-classification`[#](#marker-classification "Permalink to this heading")

![_images/marker_classification.svg](_images/marker_classification.svg)
...
Below is an example of the features that are computed for five input sequences. You can learn more about how each feature is calculated by visiting our [marker features documentation](marker_features.html).

| seq\_name | strand\_switch\_rate | coding\_density | no\_rbs\_freq | sd\_bacteroidetes\_rbs\_freq | sd\_canonical\_rbs\_freq | tatata\_rbs\_freq | cc\_marker\_freq | cp\_marker\_freq | cv\_marker\_freq | pc\_marker\_freq | pp\_marker\_freq | pv\_marker\_freq | vc\_marker\_freq | vp\_marker\_freq | vv\_marker\_freq | c\_marker\_freq | p\_marker\_freq | v\_marker\_freq | median\_c\_spm | median\_p\_spm | median\_v\_spm | v\_vs\_c\_score\_logistic | v\_vs\_p\_score\_logistic | p\_vs\_c\_score\_logistic | gv\_marker\_freq |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| sequence\_1 | 0.0000 | 0.9049 | 1.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.5000 | 0.5000 | 0.5000 | 0.0000 |
| sequence\_2 | 0.0000 | 0.7845 | 0.5000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.5000 | 0.0000 | 0.0000 | 0.0000 | 0.5000 | 0.0278 | 0.4961 | 0.8678 | 0.6630 | 0.5914 | 0.5762 | 0.0000 |
| sequence\_3 | 1.0000 | 0.8704 | 1.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.5000 | 0.0000 | 0.0000 | 0.0000 | 0.5000 | 0.0086 | 0.2801 | 0.9599 | 0.6903 | 0.6557 | 0.5392 | 0.0000 |
| sequence\_4 | 0.0000 | 0.8087 | 0.0000 | 0.0000 | 1.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 1.0000 | 0.0000 | 0.0000 | 0.0000 | 1.0000 | 0.0027 | 0.2087 | 0.9780 | 0.8398 | 0.8064 | 0.5571 | 0.0000 |
| sequence\_5 | 0.0000 | 0.9861 | 0.5000 | 0.0000 | 0.5000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 1.0000 | 0.0000 | 0.0000 | 1.0000 | 0.0043 | 0.0000 | 1.0000 | 0.8474 | 0.8479 | 0.4989 | 0.0000 |
...
| seq\_name | chromosome\_score | plasmid\_score | virus\_score |
| --- | --- | --- | --- |
| sequence\_1 | 0.5420 | 0.1397 | 0.3183 |
| sequence\_2 | 0.2172 | 0.2148 | 0.5680 |
| sequence\_3 | 0.2937 | 0.1957 | 0.5106 |
| sequence\_4 | 0.0524 | 0.0718 | 0.8758 |
| sequence\_5 | 0.1621 | 0.0168 | 0.8211 |
...
## `nn-classification`[#](#nn-classification "Permalink to this heading")

![_images/nn_classification.svg](_images/nn_classification.svg)
...
| seq\_name | chromosome\_score | plasmid\_score | virus\_score |
| --- | --- | --- | --- |
| sequence\_1 | 0.3307 | 0.5597 | 0.1096 |
| sequence\_2 | 0.0669 | 0.1411 | 0.7920 |
| sequence\_3 | 0.6720 | 0.1340 | 0.1940 |
| sequence\_4 | 0.2923 | 0.2830 | 0.4247 |
| sequence\_5 | 0.0591 | 0.1545 | 0.7864 |

If you’re interested in learning more about how the neural network processes and classifies nucleotide sequences, check out the [detailed explanation](nn_classification.html).

## `aggregated-classification`[#](#aggregated-classification "Permalink to this heading")

![_images/aggregated_classification.svg](_images/aggregated_classification.svg)
...
`score-calibration` is an optional module that transforms the raw scores produced by the previous modules into estimated probabilities. This ensures that a sequence with a calibrated virus score of 0.87 will have a probability close to 87% probability of being a virus. If you want to understand how the `score-calibration` module works, refer to [its documentation](score_calibration.html). To enable score calibration when using the `end-to-end` command, use the `--enable-score-calibration` parameter.

## `summary`[#](#summary "Permalink to this heading")

![_images/summary.svg](_images/summary.svg)

The `summary` module serves three main functions: (1) filtering sequences based on various criteria to present users with the most reliable predictions (read more about the filtering process [here](post_classification_filtering.html)), (2) summarizing the data generated by all previous modules for identified plasmids and viruses, and (3) writing FASTA files containing nucleotide and protein sequences for the identified plasmids and viruses, accompanied by gene annotation files. For examples of the plasmid and virus summary tables, refer to the [Quickstart](quickstart.html#understanding-the-outputs) guide.
...
* The geNomad pipeline
  + [`annotate`](#annotate)
  + [`find-proviruses`](#find-proviruses)
  + [`marker-classification`](#marker-classification)
  + [`nn-classification`](#nn-classification)
  + [`aggregated-classification`](#aggregated-classification)
