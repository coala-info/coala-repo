...
* Installation
  ...
  + [Stable release via Bioconda (recommended)](#stable-release-via-bioconda-recommended)
  + [Developmental verision](#developmental-verision)
  + [Docker](#docker)
...
* Installation
* [Edit on cmmr/EsViritu](https://github.com/cmmr/EsViritu/blob/main/docs/installation.md)
...
* I believe you can save environmental variables like ESVIRITU\_DB in `Docker` containers
...
[Previous](.. "Home")
[Next](../pipeline-description/ "Pipeline Description")
