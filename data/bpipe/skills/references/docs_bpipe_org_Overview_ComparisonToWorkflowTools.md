...
* [Edit on GitHub](https://github.com/ssadedin/bpipe/edit/master/docs/Overview/ComparisonToWorkflowTools.md)

* [How Bpipe Compares to other Tools](#how-bpipe-compares-to-other-tools)
  + [Key Comparison Tools](#key-comparison-tools)
