...
```
##           TP53        YY1      CTCF      ESR1
## TP53 0.0000000 0.70695317 0.3134796 0.2233030
## YY1  0.2489532 0.00000000 0.8341057 0.2961592
## CTCF 0.7318823 0.13638188 0.0000000 0.9744355
## MDM2 0.1015824 0.07558653 0.8424138 1.0000000
## ESR1 0.2615945 0.17136856 0.8594304 0.0000000
```
...
### KBoost(X, TFs, prior\_weights, g, v, ite)
...
### KBoost\_human\_symbol(X, gen\_names, g, v, ite, pos\_weight, neg\_weight)
...
### AUPR\_AUROC\_matrix(Net, G\_mat, auto\_remove, TFs, upper\_limit)
...
### grid\_search\_kboost(dataset, vs, gs, ite)
...
### net\_summary\_bin(GRN,TFs,thr,a,b)
...
### write\_GRN\_D4(GRN,TFs, filename)
...
#### D4\_multi\_1, D4\_multi\_2, D4\_multi\_3, D4\_multi\_4 and D4\_multi\_5
...
#### G\_D4\_multi\_1, G\_D4\_multi\_2, G\_D4\_multi\_3, G\_D4\_multi\_4 and G\_D4\_multi\_5
