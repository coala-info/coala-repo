# Assemblosis CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://cromwell.readthedocs.io/en/stable
- **Package**: https://workflowhub.eu/workflows/334
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/334/ro_crate?version=1
...
- **Main workflow (WorkflowHub):** `Run/assembly.cwl` (Main Workflow)
- **Project**: Workflows Australia
- **Views**: 3868
- **Creators**: Pasi Korhonen
