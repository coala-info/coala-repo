...
label: gatk_MeanQualityByCycleSpark
doc: Program to generate a data table and pdf chart of mean base quality by 
  cycle from a SAM/BAM file. Works best on a single lane/run of data, but can be
  applied to merged BAMs. Uses R to generate chart output.
inputs:
