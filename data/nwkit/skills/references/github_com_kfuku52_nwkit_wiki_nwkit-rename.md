...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fkfuku52%2Fnwkit%2Fwiki%2Fnwkit-rename)
...
·
[2 revisions](/kfuku52/nwkit/wiki/nwkit-rename/_history)

## Overview

`nwkit rename` renames node labels either from an exact-match TSV mapping or with a regular expression.

The default target is leaf labels.

## Rename from a TSV mapping

### Command

```
nwkit rename -i tree.nwk -o renamed.nwk \
  --name_tsv names.tsv
```

The mapping table must contain `old_name` and `new_name` columns.

### Example input (`tree.nwk`)

```
((A:1,B:1):1,(C:1,D:1):1);
```

### Example input (`names.tsv`)
...
### Example output (`renamed.nwk`)

```
((Alpha:1,B:1):1,(Charlie:1,D:1):1);
```
...
* `--require_all_old_names yes|no`: in TSV mode, require every `old_name` to match a target node
* `--require_match yes|no`: in regex mode, require at least one target name to match
* `--check_leaf_uniqueness yes|no`: fail if the renamed tree contains duplicated or empty leaf labels
...
* Loading
  ...
  + [Overview](/kfuku52/nwkit/wiki/nwkit-rename#overview)
  + [Rename from a TSV mapping](/kfuku52/nwkit/wiki/nwkit-rename#rename-from-a-tsv-mapping)
  + [Command](/kfuku52/nwkit/wiki/nwkit-rename#command)
  + [Example input (tree.nwk)](/kfuku52/nwkit/wiki/nwkit-rename#example-input-treenwk)
  + [Example input (names.tsv)](/kfuku52/nwkit/wiki/nwkit-rename#example-input-namestsv)
  + [Example output (renamed.nwk)](/kfuku52/nwkit/wiki/nwkit-rename#example-output-renamednwk)
  + [Rename internal nodes](/kfuku52/nwkit/wiki/nwkit-rename#rename-internal-nodes)
  + [Command](/kfuku52/nwkit/wiki/nwkit-rename#command-1)
  + [Regex-based renaming](/kfuku52/nwkit/wiki/nwkit-rename#regex-based-renaming)
  + [Command](/kfuku52/nwkit/wiki/nwkit-rename#command-2)
  + [Other options](/kfuku52/nwkit/wiki/nwkit-rename#other-options)
* Loading
