...
baseCommand: sparseassembler_SparseAssembler
label: sparseassembler_SparseAssembler
...
inputs:
  - id: build_contigs
    ...
    inputBinding:
      position: 101
      prefix: BC
  - id: correct_kmer_coverage_threshold
    type:
      - 'null'
      - int
...
stdout: sparseassembler_SparseAssembler.out
