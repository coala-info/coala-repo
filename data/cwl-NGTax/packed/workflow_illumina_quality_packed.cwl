            ...
            "steps": [
                {
                    ...
                    "in": [
                        ...
                        {
                            "source": "#main/workflow_merge_pe_reads/forward_reads_out",
                        ...
                        {
                            "source": "#main/workflow_merge_pe_reads/reverse_reads_out",
                    ...
                    "in": [
                        {
                            ...
                            "id": "#main/human_filter/forward_reads"
                        },
                        {
                            "source": "#main/humandb",
                            "id": "#main/human_filter/indexfolder"
                        },
                        {
                            "source": "#main/identifier",
                            "valueFrom": "$(self+\"_human-filter\")",
                            "id": "#main/human_filter/output_filename_prefix"
                        },
                        {
                            "source": [
                            ...
                            "pickValue": "first_non_null",
                            "id": "#main/human_filter/reverse_reads"
                        },
                        {
                            "source": "#main/threads",
                            "id": "#main/human_filter/threads"
                        }
                    ],
                    "out": [
                        "#main/human_filter/out_forward_reads",
                        "#main/human_filter/out_reverse_reads",
                        "#main/human_filter/summary"
                    ],
                    "id": "#main/human_filter"
                },
                {
                ...
                },
                {
                    ...
                    "in": [
                        {
                            "source": [
                                "#main/reference_filter/out_forward_reads",
                                "#main/human_filter/out_forward_reads",
                                "#main/rrna_filter/out_forward_reads",
                                "#main/fastp/out_forward_reads"
                            ],
                        ...
                        {
                            "source": [
                                "#main/reference_filter/out_reverse_reads",
                                "#main/human_filter/out_reverse_reads",
                                "#main/rrna_filter/out_reverse_reads",
                                "#main/fastp/out_reverse_reads"
                            ],
                    ...
                    "in": [
                        {
                            ...
                            "pickValue": "first_non_null",
                            "id": "#main/reference_filter/forward_reads"
                        },
                        {
                            "source": "#main/identifier",
                            "id": "#main/reference_filter/identifier"
                        },
                        {
                            "source": "#main/reference_filter_db",
                            "id": "#main/reference_filter/indexfolder"
                        },
                        {
                            "source": "#main/keep_reference_mapped_reads",
                            "id": "#main/reference_filter/invert"
                        },
                        {
                            "source": "#main/identifier",
                            "valueFrom": "$(self+\"_ref-filter\")",
                            "id": "#main/reference_filter/output_filename_prefix"
                        },
                        {
                            "source": [
                                "#main/human_filter/out_reverse_reads",
                            ...
                            "pickValue": "first_non_null",
                            "id": "#main/reference_filter/reverse_reads"
                        }
                    ],
                    "out": [
                        "#main/reference_filter/out_forward_reads",
                        "#main/reference_filter/out_reverse_reads",
                        "#main/reference_filter/summary"
                    ],
                    "id": "#main/reference_filter"
                },
                {
                    ...
                    "in": [
                        ...
                        {
                            "source": [
                                "#main/sequali_illumina_before/report_html",
                                "#main/sequali_illumina_before/report_json",
                                "#main/sequali_illumina_after/report_html",
                                "#main/sequali_illumina_after/report_json",
                                "#main/fastp/html_report",
                                "#main/fastp/json_report",
                                "#main/human_filter/summary",
                                "#main/reference_filter/summary",
                ...
                },
                {
                    ...
                    "in": [
                        {
                            "source": "#main/phix_filter/out_forward_reads",
                            "id": "#main/sequali_illumina_after/input_file"
                        },
                        {
                            "source": "#main/phix_filter/out_reverse_reads",
                            "id": "#main/sequali_illumina_after/paired_input"
                        },
                        {
                            "source": "#main/skip_qc_filtered",
                            "id": "#main/sequali_illumina_after/skip_qc_filtered"
                        },
                        {
                            "source": "#main/threads",
                            "id": "#main/sequali_illumina_after/threads"
                        }
                    ],
                    "out": [
                        "#main/sequali_illumina_after/report_html",
                    ...
                    "id": "#main/sequali_illumina_after"
                },
                {
                    ...
                    "in": [
                        {
                            "source": "#main/workflow_merge_pe_reads/forward_reads_out",
                            "id": "#main/sequali_illumina_before/input_file"
                        },
                        {
                            "source": "#main/workflow_merge_pe_reads/reverse_reads_out",
                            "id": "#main/sequali_illumina_before/paired_input"
                        },
                        {
                            "source": "#main/skip_qc_unfiltered",
                            "id": "#main/sequali_illumina_before/skip_qc_unfiltered"
                        },
                        {
                            "source": "#main/threads",
                            "id": "#main/sequali_illumina_before/threads"
                        }
                    ],
                    "out": [
                        "#main/sequali_illumina_before/report_html",
                    ...
                    "id": "#main/sequali_illumina_before"
                },
                {
                    ...
                    "in": [
                        {
                            ...
                            "id": "#main/workflow_merge_pe_reads/filename"
                        },
                        {
                            "source": "#main/forward_reads",
                            "id": "#main/workflow_merge_pe_reads/forward_reads"
                        },
                        {
                            "source": "#main/identifier",
                            "id": "#main/workflow_merge_pe_reads/identifier"
                        },
                        {
                            "source": "#main/reverse_reads",
                            "id": "#main/workflow_merge_pe_reads/reverse_reads"
                        }
                    ],
                    "out": [
                        "#main/workflow_merge_pe_reads/forward_reads_out",
                        "#main/workflow_merge_pe_reads/reverse_reads_out"
                    ],
                    "id": "#main/workflow_merge_pe_reads"
                }
            ],
            "id": "#main",
            "https://schema.org/author": [
