...
1. [Home](../../)
2. Workflows
3. [Metassembly](../../workflows/metassembly/)
...
example | create a prokaryote metassembly with designated kmer lengths
...
[Edit this page](https://github.com/pdimens/harpy/edit/docs/Workflows/metassembly.md)
