...
* [Usage](usage.html)
  + [Webtool (beta)](#webtool-beta)
  + [scaden process](#scaden-process)
  + [scaden train](#scaden-train)
  + [scaden predict](#scaden-predict)
  + [scaden simulate](#scaden-simulate)
...
Scaden will then generate a file called 'scaden\_predictions.txt' in your current directory. If the models were saved elsewhere,
...
Which will generate the files "example\_counts.txt", "example\_celltypes.txt" and "example\_bulk\_data.txt". If you want to try out Scaden, you can directly use those files for simulation, processing, training and prediction.
