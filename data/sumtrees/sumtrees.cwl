...
doc: "Summarizations collections of trees, e.g., MCMC samples from a posterior distribution,
  ...
  tree.\n\nTool homepage: https://github.com/brmassa/SumTree"
inputs:
  - id: tree_filepaths
    type:
      type: array
