...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fhildebra%2Frtk2%2Fblob%2Fmain%2FRare.cpp)
...
[History](/hildebra/rtk2/commits/main/Rare.cpp)

History

997 lines (868 loc) · 34.6 KB
...
[Raw](https://github.com/hildebra/rtk2/raw/refs/heads/main/Rare.cpp)
...
vector<vector<rare\_map>> cntsMap(opts->depth.size());
...
if( remove( fileNames[i].c\_str() ) != 0 ){

cerr2("Swap Mode: Error deleting file: " + fileNames[i] +"\n");
...
std::cout << "compiled on: " << \_\_DATE\_\_ << " at " << \_\_TIME\_\_ << endl;
