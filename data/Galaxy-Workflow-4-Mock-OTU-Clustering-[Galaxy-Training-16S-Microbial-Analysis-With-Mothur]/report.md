# Workflow 4: Mock OTU Clustering [Galaxy Training: 16S Microbial Analysis With Mothur] CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://training.galaxyproject.org
- **Package**: https://workflowhub.eu/workflows/1408
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1408/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 266
...
- **Main workflow (WorkflowHub):** `workflow4-mock-otu-clustering.ga` (Main Workflow)
