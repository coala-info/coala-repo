...
Probe sequence for microarrays of type ecoli.
...
The probe sequence data was obtained from http://www.affymetrix.com. The file name was E\_coli\_probe\_tab.

Examples

ecoliprobe
as.data.frame(ecoliprobe[1:3,])
