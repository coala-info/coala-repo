...
### Metadata
- **Docker Image**: quay.io/biocontainers/bwa-aln-interactive:0.7.18--h577a1d6_2
- **Homepage**: https://github.com/fulcrumgenomics/bwa-aln-interactive
- **Package**: https://anaconda.org/channels/bioconda/packages/bwa-aln-interactive/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/bwa-aln-interactive/overview
- **Total Downloads**: 3.2K
- **Last updated**: 2025-04-22
- **GitHub**: https://github.com/fulcrumgenomics/bwa-aln-interactive
- **Stars**: N/A
### Original Help Text
```text
...
## bwa-aln-interactive_mem

### Tool Description
Burrows-Wheeler Alignment Tool, MEM algorithm for long-read alignment
...
## bwa-aln-interactive_fastmap

### Tool Description
Fastmap identifies Super Maximal Exact Matches (SMEMs) in sequences using a BWA index.
...
## bwa-aln-interactive_aln

### Tool Description
Align sequences using BWA (Burrows-Wheeler Aligner) aln algorithm.
...
Options for SAM output (bwase SE mode):
         -S        output SAM (run samse)
         -r STR    read group line for SAM output
         -X INT    maximum # of hits to report (SAM output only, equivalent to -n in samse)
         -Z        interactive mode (no input buffer and empty lines between records force processing)
         -D        output the MD to each alignment in the XA tag, otherwise use "."
```


## bwa-aln-interactive_samse

### Tool Description
Generate alignments in the SAM format for single-end reads
...
## bwa-aln-interactive_sampe

### Tool Description
Generate alignments in the SAM format given single-end alignments for paired-end reads.
...
## bwa-aln-interactive_bwasw

### Tool Description
BWA-SW algorithm for long-read alignment
...
## bwa-aln-interactive_fa2pac

### Tool Description
Convert FASTA to PAC format for BWA indexing
...
## bwa-aln-interactive_pac2bwt

### Tool Description
Convert a PAC file to a BWT file.
...
## bwa-aln-interactive_pac2bwtgen

### Tool Description
Generate a BWT (Burrows-Wheeler Transform) from a PAC file.
...
## bwa-aln-interactive_bwtupdate

### Tool Description
Update or regenerate the BWT (Burrows-Wheeler Transform) file.
...
## bwa-aln-interactive_bwt2sa

### Tool Description
Generate suffix array (SA) from BWT
