...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fshenlab-sinai%2Fngsplot%2Fwiki%2FProgramArguments101)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fwiki%2Fshow&source=header-repo&source_repo=shenlab-sinai%2Fngsplot)
...
[shenlab-sinai](/shenlab-sinai)
/
**[ngsplot](/shenlab-sinai/ngsplot)**
Public

* [Notifications](/login?return_to=%2Fshenlab-sinai%2Fngsplot) You must be signed in to change notification settings
* [Fork
  66](/login?return_to=%2Fshenlab-sinai%2Fngsplot)
* [Star
   268](/login?return_to=%2Fshenlab-sinai%2Fngsplot)

* [Code](/shenlab-sinai/ngsplot)
* [Issues
  55](/shenlab-sinai/ngsplot/issues)
* [Pull requests
  1](/shenlab-sinai/ngsplot/pulls)
* [Actions](/shenlab-sinai/ngsplot/actions)
* [Projects
  0](/shenlab-sinai/ngsplot/projects)
* [Wiki](/shenlab-sinai/ngsplot/wiki)
* [Security
  0](/shenlab-sinai/ngsplot/security)
* [Insights](/shenlab-sinai/ngsplot/pulse)

Additional navigation options

* [Code](/shenlab-sinai/ngsplot)
* [Issues](/shenlab-sinai/ngsplot/issues)
* [Pull requests](/shenlab-sinai/ngsplot/pulls)
* [Actions](/shenlab-sinai/ngsplot/actions)
* [Projects](/shenlab-sinai/ngsplot/projects)
* [Wiki](/shenlab-sinai/ngsplot/wiki)
* [Security](/shenlab-sinai/ngsplot/security)
* [Insights](/shenlab-sinai/ngsplot/pulse)
...
Li Shen edited this page Nov 8, 2017
·
[5 revisions](/shenlab-sinai/ngsplot/wiki/ProgramArguments101/_history)
...
| --- | --- | --- |
| **-G** | Genome name | currently supported: see wiki page ("ID" column) [SupportedGenomes](https://github.com/shenlab-sinai/ngsplot/wiki/SupportedGenomes) |
| **-R** | Genomic regions to plot | tss, tes, genebody, exon, cgi, enhancer, dhs or bed(custom regions) |
| **-C** | Bam file or a configuration file for multiple plot | For an example, see `config.example.txt`. For details, refer to the wiki: [HowToUseConfiguration](https://github.com/shenlab-sinai/ngsplot/wiki/HowToUseConfiguration) |
...
| **-FL** | Fragment(insert) length used to calculate physical coverage | Default=150. ngs.plot calculates physical instead of read coverage. This will produce figures that contain more accurate representation of ChIP enrichment. You should set this value equal to the average fragment length in your sequencing library. **Note: for paired-end data the insert size of properly paired reads will be used as the fragment length instead.** |
...
* Loading
  ...
  [Home](/shenlab-sinai/ngsplot/wiki)
...
* Loading
  ...
  [HowAreYaxisValsCalculated](/shenlab-sinai/ngsplot/wiki/HowAreYaxisValsCalculated)
...
* Loading
  ...
  [HowToCreateBed](/shenlab-sinai/ngsplot/wiki/HowToCreateBed)
...
* Loading
  ...
  [HowtoMakeThingsRight](/shenlab-sinai/ngsplot/wiki/HowtoMakeThingsRight)
...
* Loading
  ...
  [HowToRunGalaxyNGSPlot](/shenlab-sinai/ngsplot/wiki/HowToRunGalaxyNGSPlot)
...
* Loading
  ...
  [HowToUseConfiguration](/shenlab-sinai/ngsplot/wiki/HowToUseConfiguration)
...
* Loading
  ...
  [ProgramArguments101](/shenlab-sinai/ngsplot/wiki/ProgramArguments101)

  + [Arguments specific to ngs.plot.r](/shenlab-sinai/ngsplot/wiki/ProgramArguments101#arguments-specific-to-ngsplotr)
  + [Mandatory arguments](/shenlab-sinai/ngsplot/wiki/ProgramArguments101#mandatory-arguments)
  + [Parameters that can be provided here or in configuration file for multiplot](/shenlab-sinai/ngsplot/wiki/ProgramArguments101#parameters-that-can-be-provided-here-or-in-configuration-file-for-multiplot)
  + [Coverage-generation parameters](/shenlab-sinai/ngsplot/wiki/ProgramArguments101#coverage-generation-parameters)
  + [Arguments common to both ngs.plot.r and replot.r](/shenlab-sinai/ngsplot/wiki/ProgramArguments101#arguments-common-to-both-ngsplotr-and-replotr)
  + [Miscellaneous parameters](/shenlab-sinai/ngsplot/wiki/ProgramArguments101#miscellaneous-parameters)
  + [Avg. profile parameters](/shenlab-sinai/ngsplot/wiki/ProgramArguments101#avg-profile-parameters)
  + [Heatmap parameters](/shenlab-sinai/ngsplot/wiki/ProgramArguments101#heatmap-parameters)
* Loading

  [RunItABitFaster](/shenlab-sinai/ngsplot/wiki/RunItABitFaster)
...
* Loading
  ...
  [SupportedGenomes](/shenlab-sinai/ngsplot/wiki/SupportedGenomes)
...
* Loading
  ...
  [UseFurtherInfo](/shenlab-sinai/ngsplot/wiki/UseFurtherInfo)
