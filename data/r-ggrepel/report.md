...
### Metadata
- **Conda**: https://anaconda.org/channels/r/packages/r-ggrepel/overview
- **R-project (CRAN)**: https://cloud.r-project.org/web/packages/ggrepel/index.html
- **Home (project)**: https://github.com/slowkow/ggrepel
- **Package**: ggrepel
- **Version**: 0.9.6
