...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fmpieva%2FmapAD)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E&source=header-repo&source_repo=mpieva%2FmapAD)
...
* [Notifications](/login?return_to=%2Fmpieva%2FmapAD) You must be signed in to change notification settings
* [Fork
  0](/login?return_to=%2Fmpieva%2FmapAD)
* [Star
   22](/login?return_to=%2Fmpieva%2FmapAD)

* [Code](/mpieva/mapAD)
* [Issues
  0](/mpieva/mapAD/issues)
* [Pull requests
  0](/mpieva/mapAD/pulls)
* [Actions](/mpieva/mapAD/actions)
* [Security
  0](/mpieva/mapAD/security)
* [Insights](/mpieva/mapAD/pulse)

Additional navigation options

* [Code](/mpieva/mapAD)
* [Issues](/mpieva/mapAD/issues)
* [Pull requests](/mpieva/mapAD/pulls)
* [Actions](/mpieva/mapAD/actions)
* [Security](/mpieva/mapAD/security)
* [Insights](/mpieva/mapAD/pulse)
...
[Branches](/mpieva/mapAD/branches)[Tags](/mpieva/mapAD/tags)
...
| --- | --- | --- | --- | --- |
| Latest commit   History[1,065 Commits](/mpieva/mapAD/commits/main/)   1,065 Commits | | |
| [.github/workflows](/mpieva/mapAD/tree/main/.github/workflows "This path skips through empty directories") | | [.github/workflows](/mpieva/mapAD/tree/main/.github/workflows "This path skips through empty directories") |  |  |
| [benches](/mpieva/mapAD/tree/main/benches "benches") | | [benches](/mpieva/mapAD/tree/main/benches "benches") |  |  |
| [src](/mpieva/mapAD/tree/main/src "src") | | [src](/mpieva/mapAD/tree/main/src "src") |  |  |
| [tests](/mpieva/mapAD/tree/main/tests "tests") | | [tests](/mpieva/mapAD/tree/main/tests "tests") |  |  |
| [.gitignore](/mpieva/mapAD/blob/main/.gitignore ".gitignore") | | [.gitignore](/mpieva/mapAD/blob/main/.gitignore ".gitignore") |  |  |
| [.gitlab-ci.yml](/mpieva/mapAD/blob/main/.gitlab-ci.yml ".gitlab-ci.yml") | | [.gitlab-ci.yml](/mpieva/mapAD/blob/main/.gitlab-ci.yml ".gitlab-ci.yml") |  |  |
| [Cargo.lock](/mpieva/mapAD/blob/main/Cargo.lock "Cargo.lock") | | [Cargo.lock](/mpieva/mapAD/blob/main/Cargo.lock "Cargo.lock") |  |  |
| [Cargo.toml](/mpieva/mapAD/blob/main/Cargo.toml "Cargo.toml") | | [Cargo.toml](/mpieva/mapAD/blob/main/Cargo.toml "Cargo.toml") |  |  |
| [LICENSE](/mpieva/mapAD/blob/main/LICENSE "LICENSE") | | [LICENSE](/mpieva/mapAD/blob/main/LICENSE "LICENSE") |  |  |
| [Readme.md](/mpieva/mapAD/blob/main/Readme.md "Readme.md") | | [Readme.md](/mpieva/mapAD/blob/main/Readme.md "Readme.md") |  |  |
| [build.rs](/mpieva/mapAD/blob/main/build.rs "build.rs") | | [build.rs](/mpieva/mapAD/blob/main/build.rs "build.rs") |  |  |
| View all files | | |
...
[![install with bioconda](https://camo.githubusercontent.com/9940610b859f8e4dd2daade6d2f4fb4c45d56afedc37ae98d8617daf79c1f836/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f696e7374616c6c253230776974682d62696f636f6e64612d627269676874677265656e2e7376673f7374796c653d666c6174)](http://bioconda.github.io/recipes/mapad/README.html)
[![DOI](https://camo.githubusercontent.com/401b7e723e594e122d7d8ed489d43d99fe2cc9ff754f0ebb21f0c5593030cd47/68747470733a2f2f7a656e6f646f2e6f72672f62616467652f444f492f31302e353238312f7a656e6f646f2e31353236383239352e737667)](https://doi.org/10.5281/zenodo.15268295)

# mapAD

This is another attempt to write a *fast enough* experimental ancient DNA damage aware short read mapper.
...
* `mapAD` can be built as a fully static binary with `musl` libc:
  ...
  2. Install `musl-gcc` on the building system (Ubuntu: `sudo apt install musl-tools`)Build: `RUSTFLAGS="-C target-feature=+crt-static -C link-self-contained=yes" cargo build --release --target x86_64-unknown-linux-musl`
...
$p\_{\text{fwd}} = f^{i + 1}$ and
$p\_{\text{rev}} = t^{l - i}$, respectively.
Single-stranded library
preparation: $p\_{\text{fwd}} = f^{i + 1} + t^{l - 1} - f^{i + 1} t^{l - 1}$
,
$p\_{\text{rev}} = 0$.

Effective deamination
probabilities: $p\_C = s p\_{\text{fwd}} + d(1 - p\_{\text{fwd}})$
,
$p\_G = s p\_{\text{rev}} + d(1 - p\_{\text{rev}})$
...
|  | A | C | G | T |
| --- | --- | --- | --- | --- |
| A | $1 - 3 \epsilon$ | $\epsilon$ | $\epsilon + p\_G - 4 \epsilon p\_G$ | $\epsilon$ |
| C | $\epsilon$ | $1 - 3 \epsilon - p\_C + 4 \epsilon p\_C$ | $\epsilon$ | $\epsilon$ |
| G | $\epsilon$ | $\epsilon$ | $1 - 3 \epsilon - p\_G + 4 \epsilon p\_G$ | $\epsilon$ |
| T | $\epsilon$ | $\epsilon + p\_C - 4 \epsilon p\_C$ | $\epsilon$ | $1 - 3 \epsilon$ |

All of the above probabilities are $\log\_2$ transformed.
...
opening penalty of
$\log\_2(i)$ (InDel rate). The gap extension penalty is
