...
label: gatk_MergeAnnotatedRegions
doc: Merge annotated genomic regions based entirely on contig and annotation 
  value. Column header order is not guaranteed to be preserved. Reference is 
  required and will superseded any sequence dictionary in the given seg/region 
  files. Sequence dictionary is optional on the input file, but will be included
  on the output. Conflicts of annotations is resolved by sorting the values and 
...
inputs:
  ...
  - id: segments
    type:
      - 'null'
      - File
    doc: Input segment file or annotated segment file -- touching segments will 
      be merged in the output.
    inputBinding:
      position: 101
      prefix: --segments
