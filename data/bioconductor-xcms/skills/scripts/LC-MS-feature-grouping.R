# Code example from 'LC-MS-feature-grouping' vignette. See references/ for full tutorial.
...
## ----abundance-correlation-heatmap, fig.cap = "Heatmap representing pairwise correlation of features based on abundances across samples. Features are grouped on rows and columns."----
library(pheatmap)
