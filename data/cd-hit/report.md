...
### Tool Description
Compare two nucleotide datasets (db1 and db2) and identify sequences in db2 that are similar to db1.
...
INFO:    Fetching OCI image...
INFO:    Extracting OCI image...
FATAL:   Unable to handle docker://quay.io/biocontainers/cd-hit:4.8.1--h5ca1c30_13 uri: while building SIF from layers: packer failed to pack: while unpacking rootfs: while unpacking layer sha256:15b862e7da93f8f1e54cf68d1707236bf44861d53b60b4411651b75a3769577b: unpack entry: usr/local/lib/libstdc++.so.6.0.33: unpack to regular file: short write: write /tmp/build-temp-2383085011/rootfs/usr/local/lib/libstdc++.so.6.0.33: no space left on device
```
