...
label: snakedeploy_Scaffold
doc: "A tool for managing Snakemake workflows and their dependencies.\n\nTool homepage:
...
inputs:
  ...
  - id: log_disable_color
    type:
      - 'null'
      - boolean
    doc: Disable color in log output.
    inputBinding:
      position: 102
...
stdout: snakedeploy_Scaffold.out
