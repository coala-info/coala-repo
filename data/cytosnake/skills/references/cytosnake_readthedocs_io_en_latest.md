...
[Edit this page](https://github.com/WayScience/CytoSnake/edit/master/docs/index.md "Edit this page")

Toggle Light / Dark / Auto color theme

Toggle table of contents sidebar

# Welcome to CytoSnake[#](#welcome-to-cytosnake "Permalink to this heading")

![](https://raw.githubusercontent.com/WayScience/CytoSnake/main/logo/with-text-for-light-bg.png?raw=true)
