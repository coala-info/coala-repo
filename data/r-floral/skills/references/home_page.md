...
To view selected compositional features, use `fit$selected.feature`, where features are sorted by their names. Features under `min` and `1se` correspond to penalty parameter λmin\lambda\_{\min} and λ1se\lambda\_{\text{1se}}, respectively. Features under `min.2stage` and `1se.2stage` are obtained after applying 2-stage filtering based on features under `min` and `1se`, respectively.
...
* [View on CRAN](https://cloud.r-project.org/package%3DFLORAL)
* [Browse source code](https://github.com/vdblab/FLORAL/)
* [Report a bug](https://github.com/vdblab/FLORAL/issues)
...
* [Citing FLORAL](authors.html#citation)
...
* [![CRAN status](https://www.r-pkg.org/badges/version/FLORAL)](https://cran.r-project.org/package%3DFLORAL)
* [![](https://cranlogs.r-pkg.org/badges/FLORAL)](https://cran.r-project.org/package%3DFLORAL)
* [![](https://cranlogs.r-pkg.org/badges/grand-total/FLORAL)](https://cran.r-project.org/package%3DFLORAL)
