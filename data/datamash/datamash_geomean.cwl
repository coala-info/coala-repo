...
inputs:
  - id: operations
    type:
      type: array
      items: string
    doc: Operations to perform. Can be a primary operation, followed by other 
      operations. 'fld' is the input field to use. 'fld' can be a number 
      (1=first field), or a field name when using the -H or --header-in options.
      Multiple fields can be listed with a comma (e.g. 1,6,8). A range of fields
