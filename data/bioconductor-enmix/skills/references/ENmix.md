...
Zongli Xu1, Liang Niu2 and Jack Taylor3

1Biostatistics & Computational Biology Branch, National Institute of Environmental Health Sciences
2Division of Biostatistics and Bioinformatics, University of Cincinnati
3Epidemiology Branch, National Institute of Environmental Health Sciences
...
The *[ENmix](https://bioconductor.org/packages/3.22/ENmix)* package provides a set of quality control,
...
*[ENmix](https://bioconductor.org/packages/3.22/ENmix)* functions
...
customized manner. In addition the *[ENmix](https://bioconductor.org/packages/3.22/ENmix)* package has selectable
...
Most *[ENmix](https://bioconductor.org/packages/3.22/ENmix)* package can also support the data structure used by
several other related R packages, such as *[minfi](https://bioconductor.org/packages/3.22/minfi)*,
*[wateRmelon](https://bioconductor.org/packages/3.22/wateRmelon)* and *[ChAMP](https://bioconductor.org/packages/3.22/ChAMP)*,
providing straightforward integration of
ENmix-corrected datasets for subsequent data analysis.

*[ENmix](https://bioconductor.org/packages/3.22/ENmix)* readidat function does not depend on array annotation R packages.
...
This example is a brief demonstration of major functions in *[ENmix](https://bioconductor.org/packages/3.22/ENmix)*.
...
Bisulfite conversion controls for type I probes
...
freqpolygon\_beta\_beforeQC.jpg
...
argument in the function can be
...
generated using 450K methylation data from a published study (not the data in above code)
...
Most functions in the *[ENmix](https://bioconductor.org/packages/3.22/ENmix)* support the data structure provided
by *[minfi](https://bioconductor.org/packages/3.22/minfi)* package.
The same data structures were also used by several other R packages,
such as *[ChAMP](https://bioconductor.org/packages/3.22/ChAMP)* and *[wateRmelon](https://bioconductor.org/packages/3.22/wateRmelon)*, so the output from ENmix
