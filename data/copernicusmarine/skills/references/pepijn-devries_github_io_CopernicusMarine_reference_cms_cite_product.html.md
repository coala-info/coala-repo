...
Source: [`R/cms_cite_product.r`](https://github.com/pepijn-devries/CopernicusMarine/blob/master/R/cms_cite_product.r)

`cms_cite_product.Rd`

[![[Stable]](figures/lifecycle-stable.svg)](https://lifecycle.r-lib.org/articles/stages.html#stable) Get details for properly citing a Copernicus product.
...
`[cms_product_details()](cms_product_details.html)`,
`[cms_product_services()](cms_product_services.html)`,
`[cms_products_list()](cms_products_list.html)`
