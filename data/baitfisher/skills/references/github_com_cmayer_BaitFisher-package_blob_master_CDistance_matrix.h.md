...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fcmayer%2FBaitFisher-package%2Fblob%2Fmaster%2FCDistance_matrix.h)
...
[History](/cmayer/BaitFisher-package/commits/master/CDistance_matrix.h)

History

811 lines (641 loc) · 24.2 KB
...
[Raw](https://github.com/cmayer/BaitFisher-package/raw/refs/heads/master/CDistance_matrix.h)
...
#ifndef CDISTANCE\_MATRIX\_H

#define CDISTANCE\_MATRIX\_H
...
typedef unsigned long index\_distance\_map;
...
// CDistance\_Cluster: Number of objects > 1. 2 Objects: remains to be tested.
...
// first\_index and second\_index extract the first and the second index of a pair.
...
// cluster\_node is the main data structure in the clustering method.

// The hierachy of clustering steps are stored in the cluster\_hierarchy,

// a vector of cluster nodes.

// The cluster\_hierarchy has a very special form:

// The index of each node coincides with the this\_nodes\_index.
...
// We start by adding all pairwise distances to the dist\_map.

// The indices of the pairwise distanc