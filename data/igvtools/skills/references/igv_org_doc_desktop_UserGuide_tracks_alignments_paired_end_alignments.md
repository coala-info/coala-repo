...
# Viewing paired-end alignments[#](#viewing-paired-end-alignments "Direct link to this section")

## View as pairs[#](#view-as-pairs "Direct link to this section")

By default, IGV displays paired-end alignments individually because they pack compactly. Select *View as pairs* from the right-click menu to display pairs together with a line joining the ends.
...
## Split screen view[#](#split-screen-view "Direct link to this section")

Split screen views can be invoked on the fly from paired-end alignment tracks. Right-click over an alignment and select *View mate region in split screen* from the pop-up menu. If the alignment does not have a mapped mate this option will be grayed out. Both alignments will be highlighted in color so you can more easily see the mate in the second panel.
...
# Detecting structural variants[#](#detecting-structural-variants "Direct link to this section")
...
## Insert size[#](#insert-size "Direct link to this section")
...
### Deletions[#](#deletions "Direct link to this section")
...
### Insertions[#](#insertions "Direct link to this section")
...
### Inter-chromosomal fusions[#](#inter-chromosomal-fusions "Direct link to this section")
...
![](../../../img/interchromosomal-refvssubject.png)
...
## Pair orientation[#](#pair-orientation "Direct link to this section")
...
### Inversions[#](#inversions "Direct link to this section")
...
### Inverted duplication[#](#inverted-duplication "Direct link to this section")
...
### Tandem duplication[#](#tandem-duplication "Direct link to this section")
...
### Translocation on the same chromosome[#](#translocation-on-the-same-chromosome "Direct link to this section")
