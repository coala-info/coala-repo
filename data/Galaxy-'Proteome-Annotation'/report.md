# 'Proteome Annotation' CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://training.galaxyproject.org
- **Package**: https://workflowhub.eu/workflows/1414
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1414/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 248
...
- **Main workflow (WorkflowHub):** `galaxy-workflow--proteome-annotation-.ga` (Main Workflow)
