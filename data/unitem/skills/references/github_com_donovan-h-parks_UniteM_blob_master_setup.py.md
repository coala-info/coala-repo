...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fdonovan-h-parks%2FUniteM%2Fblob%2Fmaster%2Fsetup.py)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fblob%2Fshow&source=header-repo&source_repo=donovan-h-parks%2FUniteM)
...
[History](/donovan-h-parks/UniteM/commits/master/setup.py)
...
[Raw](https://github.com/donovan-h-parks/UniteM/raw/refs/heads/master/setup.py)
...
setup\_dir = os.path.dirname(os.path.realpath(\_\_file\_\_))

version\_file = open(os.path.join(setup\_dir, 'unitem', 'VERSION'))

return version\_file.readline().strip()

if \_\_name\_\_ == '\_\_main\_\_':

dirName = os.path.dirname(\_\_file\_\_)
...
author\_email='donovan.parks@gmail.com',

maintainer='Donovan Parks',

maintainer\_email='donovan.parks@gmail.com',

packages=find\_packages(),

scripts=['bin/unitem'],

package\_data={'unitem': ['VERSION', '../markers/\*']},
...
install\_requires=["numpy>=1.24", "svgwrite>=1.1.9"],
