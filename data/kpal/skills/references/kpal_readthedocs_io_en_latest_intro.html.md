...
* [Docs](index.html) »
* Introduction
* [Edit on GitHub](https://github.com/LUMC/kPAL/blob/master/doc/intro.rst)
...
After following [Installation](install.html#install), kPAL can be started by typing:
...
[Methodology](method.html#method). Some examples of working with the toolkit are shown in
[Tutorial](tutorial.html#tutorial).

[Next](install.html "Installation")
 [Previous](index.html "Welcome to kPAL (k-mer profile analysis library)!")
