...
alternativeSplicingEvents.hg38_V2.rda
...
tification tools MISO, VAST-TOOLS, SUPPA and rMATS, followed by a lift-over of the Human
annotation hg19 coordinates to hg38 (see details).
...
The coordinates from the combined annotation were lifted-over from Human annotation hg19 to
hg38 using rtracklayer::liftOver based on an UCSC chain file.
