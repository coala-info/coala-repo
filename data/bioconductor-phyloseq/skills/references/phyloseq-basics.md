...
* [0.1 Other resources](#other-resources)
* [1 Introduction](#introduction)
* [2 About this vignette](#about-this-vignette)
  + [2.1 Typesetting Legend](#typesetting-legend)
  + [2.2 Other links and tutorials](#other-links-and-tutorials)
* [3 phyloseq classes](#phyloseq-classes)
* [4 Load *phyloseq* and import data](#load-phyloseq-and-import-data)
  + [4.1 Load *phyloseq*](#load-phyloseq)
  + [4.2 Import data](#import-data)
  + [4.3 Import from biom-format](#import-from-biom-format)
  + [4.4 Import from QIIME (Modern)](#import-from-qiime-modern)
  + [4.5 Import from QIIME Legacy](#import-from-qiime-legacy)
  + [4.6 Import from mothur](#import-from-mothur)
  + [4.7 Import from PyroTagger](#import-from-pyrotagger)
  + [4.8 Import from RDP pipeline](#import-from-rdp-pipeline)
  + [4.9 Example Data (included)](#example-data-included)
  + [4.10 phyloseq Object Summaries](#phyloseq-object-summaries)
  + [4.11 Convert raw data to phyloseq components](#convert-raw-data-to-phyloseq-components)
  + [4.12 phyloseq() function: building complex phyloseq objects](#phyloseq-function-building-complex-phyloseq-objects)
  + [4.13 Merge](#merge)
* [5 Accessor functions](#accessor-functions)
* [6 Trimming, subsetting, filtering phyloseq data](#trimming-subsetting-filtering-phyloseq-data)
  + [6.1 Trimming: prune\_taxa()](#trimming-prune_taxa)
  + [6.2 Simple filtering example](#simple-filtering-example)
  + [6.3 Arbitrarily complex abundance filtering](#arbitrarily-complex-abundance-filtering)
  + [6.4 subset\_samples(): Subset by Sample Variables](#subset_samples-subset-by-sample-variables)
  + [6.5 subset\_taxa(): subset by taxonomic categories](#subset_taxa-subset-by-taxonomic-categories)
  + [6.6 random subsample abundance data](#random-subsample-abundance-data)
* [7 Transform abundance data](#transform-abundance-data)
* [8 Phylogenetic smoothing](#phylogenetic-smoothing)
  + [8.1 tax\_glom()](#tax_glom)
  + [8.2 tip\_glom()](#tip_glom)
* [9 Installation](#installation)
  + [9.1 Installation](#installation-1)
  + [9.2 Installing Parallel Backend](#installing-parallel-backend)
...
![phyloseq class structure](data:image/png;base64...)
...
* BIOM file, originally at:
  moving\_pictures\_tutorial-1.9.0/illumina/precomputed-output/otus/otu\_table\_mc2\_w\_tax\_no\_pynast\_failures.biom
* Tree file, originally at:
  moving\_pictures\_tutorial-1.9.0/illumina/precomputed-output/otus/rep\_set.tre
* Map File, originally at:
  moving\_pictures\_tutorial-1.9.0/illumina/map.tsv
...
![QIIME directory structure](data:image/jpeg;base64...)
...
### 6.3.1 genefilter\_sample(): Filter by Within-Sample Criteria
...
### 6.3.2 filter\_taxa(): Filter by Across-Sample Criteria
...
## 6.4 subset\_samples(): Subset by Sample Variables
...
## 6.5 subset\_taxa(): subset by taxonomic categories
