...
### Metadata
- **Docker Image**: quay.io/biocontainers/xsv:0.10.3--0
- **Homepage**: https://github.com/BurntSushi/xsv
- **Package**: Not found
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/xsv/overview
...
### Tool Description
Transforms CSV data so that all records have the same length. The length is the length of the longest record in the data. Records with smaller lengths are padded with empty fields.
...
### Tool Description
Creates an index of the given CSV data, which can make other operations like slicing, splitting and gathering statistics much faster.
