...
- **Package**: https://workflowhub.eu/workflows/390
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/390/ro_crate?version=2
- **Source repository (git):** https://gitlab.inria.fr/capsid.public_codes/CroMaSt.git
- **Conda**: N/A
...
- **Main workflow (WorkflowHub):** `CroMaSt.cwl` (Main Workflow)
- **Project**: CAPSID
- **Views**: 8309
