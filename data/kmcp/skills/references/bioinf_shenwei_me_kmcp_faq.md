...
* [ ]
  ...
  + [General](#general)
    ...
    - [Does KMCP support long read metagenomic profiling?](#does-kmcp-support-long-read-metagenomic-profiling)
    - [How can I run KMCP on a computer without enough main memory?](#how-can-i-run-kmcp-on-a-computer-without-enough-main-memory)
  + [Database building](#database-building)

    - [Can I create a database with custom genome collections for profiling?](#can-i-create-a-database-with-custom-genome-collections-for-profiling)
    - [What k-mer size should I use to build the database?](#what-k-mer-size-should-i-use-to-build-the-database)
    - [How to add new genomes to the database?](#how-to-add-new-genomes-to-the-database)
    - [Unexpected EOF error](#unexpected-eof-error)
    - [Are the elements in the bloom filters uniformly distributed?](#are-the-elements-in-the-bloom-filters-uniformly-distributed)
  + [Some other useful genome catalogs](#some-other-useful-genome-catalogs)
  + [Searching](#searching)

    - [Why are the CPU usages are very low, not 100%?](#why-are-the-cpu-usages-are-very-low-not-100)
    - [Can I run multiple KMCP processes in a machine?](#can-i-run-multiple-kmcp-processes-in-a-machine)
  + [Profiling](#profiling)

    - [Where is the taxid.map?](#where-is-the-taxidmap)
    - [Unknown taxid?](#unknown-taxid)
    - [How to tune parts of options when using preset profiling modes?](#how-to-tune-parts-of-options-when-using-preset-profiling-modes)
...
1. v2023.05-genbank-viral-\_block001.uniki (FPR of bloom filter: 0.3), only a part of image is shown.
   ...
   | --- | --- | --- | --- | --- | --- |
   | \_block001.uniki | GCA\_008766775.1 | 0 | 1 | 145 | 0.022419 |
   | \_block001.uniki | GCA\_003330005.1 | 8 | 10 | 150 | 0.023183 |
   | \_block001.uniki | GCA\_002814895.1 | 0 | 1 | 154 | 0.023794 |
   | \_block001.uniki | GCA\_001967255.1 | 9 | 10 | 165 | 0.025471 |
   | \_block001.uniki | GCA\_002219745.1 | 4 | 10 | 197 | 0.030336 |
   | \_block001.uniki | GCA\_000839085.1 | 0 | 1 | 200 | 0.030790 |
   | \_block001.uniki | GCA\_000919055.1 | 9 | 10 | 207 | 0.031851 |
   | \_block001.uniki | GCA\_000848385.1 | 6 | 10 | 207 | 0.031851 |
   | \_block001.uniki | GCA\_002820565.1 | 9 | 10 | 208 | 0.032002 |
   | \_block001.uniki | GCA\_002820505.1 | 9 | 10 | 208 | 0.032002 |
...
2. v2023.05-refseq-fungi-\_block001.uniki (FPR of bloom filter: 0.3)
   ...
   | file | target | chunkIdx | chunks | kmers | fpr |
   | --- | --- | --- | --- | --- | --- |
   | \_block001.uniki | GCF\_000277815.2 | 0 | 10 | 207084 | 0.094334 |
   | \_block001.uniki | GCF\_000146465.1 | 0 | 10 | 209422 | 0.095346 |
   | \_block001.uniki | GCF\_000091225.2 | 0 | 10 | 209787 | 0.095504 |
   | \_block001.uniki | GCF\_000280035.1 | 8 | 10 | 216972 | 0.098608 |
   | \_block001.uniki | GCF\_000280035.1 | 9 | 10 | 217529 | 0.098849 |
   | \_block001.uniki | GCF\_000280035.1 | 3 | 10 | 217631 | 0.098892 |
   | \_block001.uniki | GCF\_000280035.1 | 6 | 10 | 218560 | 0.099293 |
   | \_block001.uniki | GCF\_000280035.1 | 7 | 10 | 218763 | 0.099380 |
   | \_block001.uniki | GCF\_000280035.1 | 4 | 10 | 218830 | 0.099409 |
   | \_block001.uniki | GCF\_000280035.1 | 0 | 10 | 218860 | 0.099422 |
...
3. v2023.05-refseq-fungi-\_block002.uniki (FPR of bloom filter: 0.3)

   ![](../v2023.05-refseq-fungi-_block002.uniki.jpg)

   | file | target | chunkIdx | chunks | kmers | fpr |
   | --- | --- | --- | --- | --- | --- |
   | \_block002.uniki | GCF\_000349005.2 | 5 | 10 | 745638 | 0.249355 |
   | \_block002.uniki | GCF\_000349005.2 | 2 | 10 | 746237 | 0.249528 |
   | \_block002.uniki | GCF\_000349005.2 | 9 | 10 | 747586 | 0.249917 |
   | \_block002.uniki | GCF\_000349005.2 | 0 | 10 | 748331 | 0.250132 |
   | \_block002.uniki | GCF\_000349005.2 | 7 | 10 | 749497 | 0.250469 |
   | \_block002.uniki | GCF\_001477545.1 | 5 | 10 | 751685 | 0.251099 |
   | \_block002.uniki | GCF\_002251995.1 | 3 | 10 | 753439 | 0.251604 |
   | \_block002.uniki | GCF\_001477545.1 | 4 | 10 | 755317 | 0.252145 |
   | \_block002.uniki | GCF\_001477545.1 | 0 | 10 | 758418 | 0.253036 |
   | \_block002.uniki | GCF\_001477545.1 | 8 | 10 | 760460 | 0.253623 |
...
```
$ cat gtdb.kmcp/taxid.map refseq-viral.kmcp/taxid.map refseq-fungi.kmcp/taxid.map > taxi