...
### Tool Description
A tool for converting VCF (Variant Call Format) files into a format suitable for Circos plots.
...
FATAL:   Unable to handle docker://quay.io/biocontainers/vcf2circos:1.2.0--pyhdfd78af_0 uri: while building SIF from layers: conveyor failed to get: invalid character '}' after top-level value
```
