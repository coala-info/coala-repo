...
denoting modification type and likelihood respectively [(*see SAM/BAM format tag specifications*)](https://samtools.github.io/hts-specs/SAMtags.pdf).
...
### Display conventions[#](#display-conventions "Direct link to this section")
...
with visualization of methylation from [bisulfite sequencing](../bisulfite_sequencing/), making experiments from the
...
### Example screenshots[#](#example-screenshots "Direct link to this section")
