...
--background-mods  [--background-hmm ] \
--feature-mods  [--feature-hmm ] \
( --features  | --window  ) \
Arguments  and  should be comma-delimited lists of
phylogenetic models in .mod format (as produced by phyloFit),
may be in GFF, BED, or genepred format, and  may be in FASTA
