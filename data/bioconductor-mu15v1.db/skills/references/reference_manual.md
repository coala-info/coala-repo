...
Mu15v1ACCNUM is an R object that contains mappings between a manufacturer’s identifiers and
...
Mu15v1ALIAS is an R object that provides mappings between common gene symbol identifiers
...
Welcome to the Mu15v1.db annotation Package. The purpose of this package is to provide detailed
information about the Mu15v1 platform. This package is updated biannually.
...
Mu15v1CHR is an R object that provides mappings between a manufacturer identifier and the
...
Mu15v1CHRLENGTHS provides the length measured in base pairs for each of the chromosomes.
...
Mu15v1CHRLOC is an R object that maps manufacturer identifiers to the starting position of the
...
Mu15v1ENSEMBL is an R object that contains mappings between manufacturer identifiers and
...
# Convert to a list
xx <- as.list(Mu15v1ENSEMBL2PROBE)
if(length(xx) > 0){
...
Mu15v1ENTREZID is an R object that provides mappings between manufacturer identifiers and
...
Mu15v1ENZYME is an R object that provides mappings between manufacturer identifiers and EC
numbers. Mu15v1ENZYME2PROBE is an R object that maps Enzyme Commission (EC) numbers
to manufacturer identifiers.

Details

When the Mu15v1ENZYME maping viewed as a list, each manufacturer identifier maps to a named
...
For the Mu15v1ENZYME2PROBE, each EC number maps to a named vector containing all of the
...
numbers. In Mu15v1ENZYME2PROBE, EC is dropped from the Enzyme Commission numbers.
...
# Now convert Mu15v1ENZYME2PROBE to a list to see inside
xx <- as.list(Mu15v1ENZYME2PROBE)
if(length(xx) > 0){
...
Mu15v1GENENAME is an R object that maps manufacturer identifiers to the corresponding gene
name.
...
Mu15v1GO is an R object that provides mappings between manufacturer identifiers and the GO
identifiers that they are directly associated with. This mapping and its reverse mapping (Mu15v1GO2PROBE)
...
Mu15v1GO2ALLPROBES is an R object that provides mappings between a given GO identifier and
all of the manufacturer identifiers annotated at that GO term OR TO ONE OF IT’S CHILD NODES
in the GO ontology. Thus, this mapping is much larger and more inclusive than Mu15v1GO2PROBE.

Details

If Mu15v1GO is cast as a list, each manufacturer identifier is mapped to a list of lists. The names on
...
If Mu15v1GO2ALLPROBES or Mu15v1GO2PROBE is cast as a list, each GO term maps to a
...
# Convert Mu15v1GO2ALLPROBES to a list
xx <- as.list(Mu15v1GO2ALLPROBES)
if(length(xx) > 0){
...
Number of mapped keys for the maps in package Mu15v1.db

Description

DEPRECATED. Counts in the MAPCOUNT table are out of sync and should not be used.

Mu15v1MAPCOUNTS provides the "map count" (i.e. the count of mapped keys) for each map in
package Mu15v1.db.
...
Mu15v1MGI is an R object that contains mappings between manufacturer identifiers and Jackson
...
The Organism information for Mu15v1

Description

Mu15v1ORGANISM is an R object that contains a single item: a character string that names the
organism for which Mu15v1 was built. Mu15v1ORGPKG is an R object that contains a chararcter
vector with the name of the organism package that a chip package depends on for its gene-centric
annotation.

Details

Although the package name is suggestive of the organism for which it was built, Mu15v1ORGANISM
provides a simple way to programmatically extract the organism name. Mu15v1ORGPKG provides
...
Mu15v1PATH maps probe identifiers to the identifiers used by KEGG for pathways in which the
genes represented by the probe identifiers are involved

Mu15v1PATH2PROBE is an R object that provides mappings between KEGG identifiers and man-
...
# Now convert the Mu15v1PATH2PROBE object to a list
xx <- as.list(Mu15v1PATH2PROBE)
if(length(xx) > 0){
...
Mu15v1PFAM is an R object that provides mappings between manufacturer identifiers and PFAM
identifiers.
...
Mu15v1PMID is an R object that provides mappings between manufacturer identifiers and PubMed
identifiers. Mu15v1PMID2PROBE is an R object that provides mappings between PubMed identi-
fiers and manufacturer identifiers.

Details

When Mu15v1PMID is viewed as a list each manufacturer identifier is mapped to a named vector
...
When Mu15v1PMID2PROBE is viewed as a list each PubMed identifier is mapped to a named vec-
...
# Now convert the reverse map object Mu15v1PMID2PROBE to a list
xx <- as.list(Mu15v1PMID2PROBE)
if(length(xx) > 0){
...
Mu15v1PROSITE is an R object that provides mappings between manufacturer identifiers and
PROSITE identifiers.
...
Mu15v1REFSEQ is an R object that provides mappings between manufacturer identifiers and Ref-
Seq identifiers.
...
Mu15v1SYMBOL is an R object that provides mappings between manufacturer identifiers and gene
abbreviations.
...
Mu15v1UNIGENE is an R object that provides mappings between manufacturer identifiers and
UniGene identifiers.
...
Mu15v1UNIPROT is an R object that contains mappings between the manufacturer identifiers and
...
Mu15v1_dbconn()
Mu15v1_dbfile()
Mu15v1_dbschema(file="", show.indices=FALSE)
Mu15v1_dbInfo()
...
Mu15v1_dbconn returns a connection object to the package annotation DB. IMPORTANT: Don’t
call dbDisconnect on the connection object returned by Mu15v1_dbconn or you will break all the
AnnDbObj objects defined in this package!
Mu15v1_dbfile returns the path (character string) to the package annotation DB (this is an SQLite
file).
Mu15v1_dbschema prints the schema definition of the package annotation DB.
Mu15v1_dbInfo prints other information about the package annotation DB.

Value

Mu15v1_dbconn: a DBIConnection object representing an open connection to the package annota-
tion DB.
Mu15v1_dbfile: a character string with the path to the package annotation DB.
Mu15v1_dbschema: none (invisible NULL).
Mu15v1_dbInfo: none (invisible NULL).
...
dbGetQuery(Mu15v1_dbconn(), "SELECT COUNT(*) FROM probes")
...
Mu15v1.db, 2
Mu15v1_dbconn, 20
Mu15v1_dbfile (Mu15v1_dbconn), 20

22

Mu15v1_dbInfo (Mu15v1_dbconn), 20
Mu15v1_dbschema (Mu15v1_dbconn), 20
Mu15v1ACCNUM, 1
Mu15v1ALIAS2PROBE, 2
Mu15v1CHR, 3
Mu15v1CHRLENGTHS, 4
Mu15v1CHRLOC, 4
Mu15v1CHRLOCEND (Mu15v1CHRLOC), 4
Mu15v1ENSEMBL, 5
Mu15v1ENSEMBL2PROBE (Mu15v1ENSEMBL), 5
Mu15v1ENTREZID, 6
Mu15v1ENZYME, 7
Mu15v1ENZYME2PROBE (Mu15v1ENZYME), 7
Mu15v1GENENAME, 9
Mu15v1GO, 10
Mu15v1GO2ALLPROBES, 11
Mu15v1GO2ALLPROBES (Mu15v1GO), 10
Mu15v1GO2PROBE (Mu15v1GO), 10
Mu15v1LOCUSID (Mu15v1ENTREZID), 6
Mu15v1MAPCOUNTS, 12
Mu15v1MGI, 12
Mu15v1MGI2PROBE (Mu15v1MGI), 12
Mu15v1ORGANISM, 13
Mu15v1ORGPKG (Mu15v1ORGANISM), 13
Mu15v1PATH, 14
Mu15v1PATH2PROBE (Mu15v1PATH), 14
Mu15v1PFAM, 15
Mu15v1PMID, 15
Mu15v1PMID2PROBE (Mu15v1PMID), 15
Mu15v1PROSITE, 16
Mu15v1REFSEQ, 17
Mu15v1SYMBOL, 18
Mu15v1UNIGENE, 19
Mu15v1UNIPROT, 20
Mu15v1UNIPROT2PROBE (Mu15v1UNIPROT), 20
