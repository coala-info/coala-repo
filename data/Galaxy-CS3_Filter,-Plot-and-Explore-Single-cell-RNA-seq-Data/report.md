# CS3_Filter, Plot and Explore Single-cell RNA-seq Data CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://training.galaxyproject.org
- **Package**: https://workflowhub.eu/workflows/1490
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1490/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 266
...
- **Main workflow (WorkflowHub):** `cs3-filter--plot-and-explore-single-cell-rna-seq-data.ga` (Main Workflow)
