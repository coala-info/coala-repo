...
[Journals in NCBI Databases](/nlmcatalog/journals)
...
[NCBI Help Manual](/books/NBK3831/)
...
[National Library of Medicine (NLM) Catalog](/nlmcatalog)
...
[NCBI Data Specifications](/data_specs)
:   Specifications for NCBI data in ASN.1 or DTD format are available on the Index of data\_specs page. The "NCBI\_data\_conversion.html" links to the conversion tool.
...
[PubMed Central (PMC) Open-Access Subset](/pmc/about/openftlist.html)
...
* [Find articles about a topic similar to that in a given article](/guide/howto/find-articles-similar)
* [Obtain the full text of an article](/guide/howto/obtain-full-text)
...
![](/stat?jsdisabled=true&ncbi_app=guide&ncbi_db=&ncbi_pdid=ResourceListPage&ncbi_phid=CE8BFC2B9FBE76A100000000002F002B)
