...
baseCommand:
  - gatk
  - SplitIntervals
label: gatk_SplitIntervals
doc: Split intervals into sub-interval files.
inputs:
  - id: output
    type: string
    doc: The directory into which to write the scattered interval 
      sub-directories.
    inputBinding:
      position: 101
      prefix: --output
  ...
  - id: dont_mix_contigs
    type:
      - 'null'
      - boolean
    doc: Scattered interval files do not contain intervals from multiple 
      contigs.
    inputBinding:
      position: 101
      prefix: --dont-mix-contigs
  ...
  - id: interval_file_num_digits
    ...
    inputBinding:
      position: 101
      prefix: --interval-file-num-digits
  - id: interval_file_prefix
    type:
      - 'null'
      - string
...
outputs:
  - id: output_output
    ...
    outputBinding:
      glob: $(inputs.output)
  - id: output_interval_file_prefix
    type:
      - 'null'
      - File[]
    doc: Prefix to use when writing interval files
    outputBinding:
      glob: $(inputs.interval_file_prefix)*
requirements:
