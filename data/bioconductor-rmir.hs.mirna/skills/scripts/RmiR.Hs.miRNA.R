# Code example from 'RmiR.Hs.miRNA' vignette. See references/ for full tutorial.

### R code from vignette source 'RmiR.Hs.miRNA.Rnw'
...
###################################################
dbGetQuery(
RmiR.Hs.miRNA_dbconn(), "SELECT * FROM tarbase WHERE mature_miRNA='hsa-miR-21'")
