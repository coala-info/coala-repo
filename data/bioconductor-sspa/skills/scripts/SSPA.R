# Code example from 'SSPA' vignette. See references/ for full tutorial.
...
###################################################
### code chunk number 2: SSPA.Rnw:45-46
###################################################
options(width=60)


###################################################
### code chunk number 3: simulated-data-generation
###################################################
library(SSPA)
library(genefilter)
set.seed(12345)
...
###################################################
### code chunk number 4: simulated-data-plotting
###################################################
...
###################################################
### code chunk number 5: simulated-data-deconvolution
###################################################
...
###################################################
### code chunk number 6: simulated-data-power
###################################################
...
###################################################
### code chunk number 7: simulated-data-effectsize
###################################################
...
###################################################
### code chunk number 9: nutrigenomics-effectsize
###################################################
library(lattice)
data(Nutrigenomics)
str(Nutrigenomics)
...
###################################################
### code chunk number 10: nutrigenomics-power
###################################################
samplesize <- seq(2, 8)
...
###################################################
### code chunk number 11: obtain-teststatistics (eval = FALSE)
###################################################
...
###################################################
### code chunk number 12: deepsage-effectsize
###################################################
library(lattice)
data(deepSAGE)
str(deepSAGE)
