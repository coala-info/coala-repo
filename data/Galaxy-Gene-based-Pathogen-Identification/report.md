# Gene-based Pathogen Identification CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://training.galaxyproject.org
- **Package**: https://workflowhub.eu/workflows/1495
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1495/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 296
...
- **Main workflow (WorkflowHub):** `gene-based-pathogen-identification.ga` (Main Workflow)
