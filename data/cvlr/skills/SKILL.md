---
name: cvlr
description: cvlr (Clustering and Visualization of Long Reads) is a specialized bioinformatics tool used to group long-read sequencing data into clusters based on shared features, most commonly CpG methylation patterns or single nucleotide variants (SNVs).
