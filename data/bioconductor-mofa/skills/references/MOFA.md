...
* [1 What is MOFA?](#what-is-mofa)
* [2 Installation](#installation)
* [3 Reticulate configuration](#reticulate-configuration)
* [4 Using MOFA](#using-mofa)
  + [4.1 General MOFA workflow](#general-mofa-workflow)
    - [4.1.1 Step 1: Fitting the model](#step-1-fitting-the-model)
    - [4.1.2 Step 2: Downstream analysis: disentangle the variability between omics](#step-2-downstream-analysis-disentangle-the-variability-between-omics)
    - [4.1.3 Step 3: Annotation of factors](#step-3-annotation-of-factors)
    - [4.1.4 Step 4: Using the factors to get biological insights in downstream analysis](#step-4-using-the-factors-to-get-biological-insights-in-downstream-analysis)
  + [4.2 Vignettes illustrating the use of MOFA on example data sets](#vignettes-illustrating-the-use-of-mofa-on-example-data-sets)
* [5 Frequently asked questions](#frequently-asked-questions)
* [6 List of relevant functions and classes](#list-of-relevant-functions-and-classes)
  + [6.1 MOFAmodel object](#mofamodel-object)
  + [6.2 Prepare and run MOFA](#prepare-and-run-mofa)
  + [6.3 get functions](#get-functions)
  + [6.4 Disentangle sources of variation](#disentangle-sources-of-variation)
  + [6.5 Inspect loadings](#inspect-loadings)
  + [6.6 Inspect factors](#inspect-factors)
  + [6.7 Inspect the data](#inspect-the-data)
  + [6.8 Feature set enrichment analysis](#feature-set-enrichment-analysis)
  + [6.9 Clustering](#clustering)
  + [6.10 Compare and select models](#compare-and-select-models)
  + [6.11 Predictions and imputation](#predictions-and-imputation)
  + [6.12 Subset (after training the model)](#subset-after-training-the-model)
  + [6.13 Examples](#examples)
...
##  [4] bookdown_0.9       htmltools_0.3.6    tools_3.6.0
