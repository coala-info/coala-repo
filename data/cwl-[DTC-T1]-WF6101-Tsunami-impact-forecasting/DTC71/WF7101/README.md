# WF7101 Workflow Files

This directory contains workflow files generated from the spreadsheet description of WF7101 using a [custom tool](https://github.com/Marco-Salvi/dt-geo-converter). These files provide an initial starting point, **manual verification and updates are required** to ensure accuracy.
...
``` log
[WARNING] [Inner step ST710103 has no inputs or outputs; please verify its configuration]
[WARNING] [Step ST710104 has no inputs or outputs]
[WARNING] [Step ST710105 has no inputs or outputs]
[WARNING] [Step ST710106 has no inputs or outputs]
[WARNING] [Step ST710101 has no inputs or outputs]
[WARNING] [Step ST710102 has no inputs or outputs]
[WARNING] [Step ST710103 has no inputs or outputs]
```



For complete details, please refer to the [log file](./workflows/WF7101)
