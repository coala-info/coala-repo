...
* create with [harpy template groupings](../template/#groupings) or manually
* if created with [harpy template groupings](../template/#groupings), all the samples will be assigned to group `pop1`, so make sure to edit the second column to reflect your data correctly.
...
After reads have been aligned, *e.g.*, with [harpy align](../align/), you can use those alignment files
(`.bam`) to call variants in your data. Harpy can call SNPs and small indels using
bcftools mpileup or with freebayes.
You can call SNPs with the
snp
 module:
...
examples | calling variants with default settings
...
| --- | --- | --- |
| `REFERENCE` |  | required  Reference genome used for variant calling |
...
| `--regions` `-r` | `50000` | Regions to call variants on (see below) |
...
Impute genotypes for haplotagged data with Harpy](/harpy/workflows/impute/)
[Phase SNPs into Haplotypes

Phase haplotypes for haplotagged data with Harpy](/harpy/workflows/phase/)
[Template

Generate extra files for analysis with Harpy](/harpy/workflows/template/)

[linked-read](../../tags/linked-read/)
[wgs](../../tags/wgs/)

[Edit this page](https://github.com/pdimens/harpy/edit/docs/Workflows/snp.md)

[Previous
Variants](../../workflows/simulate/simulate-variants/)
