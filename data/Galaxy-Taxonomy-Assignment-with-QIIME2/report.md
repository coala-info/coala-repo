# Taxonomy Assignment with QIIME2 CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://mdhs.unimelb.edu.au/melbournebioinformatics
- **Package**: https://workflowhub.eu/workflows/2098
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/2098/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 30
...
- **Main workflow (WorkflowHub):** `Taxonomy-Assignment-with-QIIME2.ga` (Main Workflow)
- **Project**: Melbourne Bioinformatics
- **Views**: 296
- **Creators**: Tristan Reynolds, Amy Loughman
