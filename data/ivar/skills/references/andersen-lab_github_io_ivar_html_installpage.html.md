...
* [Installing via conda](#autotoc_md0)
  + [Installing via homebrew](#autotoc_md1)
* [Installing on Mac](#autotoc_md2)
  + [Installing build tools](#autotoc_md3)
  + [HTSlib installed using conda](#autotoc_md4)
  + [HTSlib installed from source](#autotoc_md5)
  + [Installing iVar](#autotoc_md6)
* [Installing on Linux](#autotoc_md7)
  + [Installing build tools](#autotoc_md8)
  + [HTSlib installed using conda](#autotoc_md9)
  + [HTSlib installed from source](#autotoc_md10)
  + [Installing iVar](#autotoc_md11)
* [Running from Docker](#autotoc_md12)
* [Contact](#autotoc_md13)
...
If the output is for example, /opt/conda/bin/conda, then you can add the path to the lib folder to $LD\_LIBRARY\_PATH using the command below. You can add this to your ~/.bash\_profile or ~/.bashrc to avoid rerunning the command everytime a new bash session starts.
...
If HTSlib is installed in a non standard location, please add the following to your .bash\_profile so that iVar can find HTSlib dynamic libraries during runtime.
...
This docker image contains all the required dependencies to run iVar and the [pipelines](cookbookpage.html) developed using iVar. You will have to attach a docker volume to get data into the docker container. Instructions to do so are in the [Docker docs](https://docs.docker.com/storage/volumes/).
...
Generated by  [![doxygen](doxygen.png)](http://www.doxygen.org/index.html) 1.10.0