...
baseCommand:
  - expam
  - make_reads
label: expam_make_reads
doc: "Uniformly sample reads of length l from some input sequence. This is for testing
  purposes only, and is not a replacement for actual read generating software.\n\n\
