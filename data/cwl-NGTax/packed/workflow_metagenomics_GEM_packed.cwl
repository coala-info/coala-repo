        ...
        },
        {
            ...
            "steps": [
                    ...
                    "in": [
                        {
                            ...
                            "id": "#main/carveme/carveme_solver"
                        },
                        {
                            "source": "#main/gapfill",
                ...
                },
                {
                    ...
                    "scatter": [
                        "#main/carveme_base/protein_file"
                    ],
                    "in": [
                        {
                            "source": "#main/carveme_solver",
                            "id": "#main/carveme_base/carveme_solver"
                        },
                        {
                            "source": "#main/gapfill",
                            "id": "#main/carveme_base/gapfill"
                        },
                        {
                            "source": "#main/mediadb",
                            "id": "#main/carveme_base/mediadb"
                        },
                        {
                            "source": "#main/prodigal/predicted_proteins_faa",
                            "id": "#main/carveme_base/protein_file"
                        }
                    ],
                    "out": [
                        "#main/carveme_base/carveme_gem"
                    ],
                    "id": "#main/carveme_base"
                },
                {
                    ...
                    "in": [
                        ...
                        },
                        {
                            "source": [
                                ...
                                "#main/memote_report_snapshot_base/report_html",
                                "#main/memote_run_base/run_json"
                            ],
                            "linkMerge": "merge_flattened",
                            "pickValue": "all_non_null",
                ...
                },
                {
                    ...
                    "in": [
                        ...
                        },
                        {
                            ...
                            "id": "#main/memote_report_snapshot/solver"
                        }
                    ],
                    "out": [
                        "#main/memote_report_snapshot/report_html"
                ...
                },
                {
                    ...
                    "scatter": [
                        "#main/memote_report_snapshot_base/GEM"
                    ],
                    "in": [
                        {
                            "source": [
                            ...
                            "linkMerge": "merge_flattened",
                            "pickValue": "all_non_null",
                            "id": "#main/memote_report_snapshot_base/GEM"
                        },
                        {
                            "default": true,
                            "id": "#main/memote_report_snapshot_base/report_snapshot"
                        },
                        {
                            "default": true,
                            "id": "#main/memote_report_snapshot_base/skip_test_find_metabolites_consumed_with_closed_bounds"
                        },
                        {
                            "default": true,
                            "id": "#main/memote_report_snapshot_base/skip_test_find_metabolites_not_consumed_with_open_bounds"
                        },
                        {
                            "default": true,
                            "id": "#main/memote_report_snapshot_base/skip_test_find_metabolites_not_produced_with_open_bounds"
                        },
                        {
                            "default": true,
                            "id": "#main/memote_report_snapshot_base/skip_test_find_metabolites_produced_with_closed_bounds"
                        },
                        {
                            "source": "#main/memote_solver",
                            "id": "#main/memote_report_snapshot_base/solver"
                        }
                    ],
                    "out": [
                        "#main/memote_report_snapshot_base/report_html"
                    ],
                    "id": "#main/memote_report_snapshot_base"
                },
                {
                    ...
                    "in": [
                        {
                            ...
                            "linkMerge": "merge_flattened",
                            "pickValue": "all_non_null",
                            "id": "#main/memote_run_base/GEM"
                        },
                        {
                            "default": true,
                            "id": "#main/memote_run_base/run"
                        },
                        {
                            "default": true,
                            "id": "#main/memote_run_base/skip_test_find_metabolites_consumed_with_closed_bounds"
                        },
                        {
                            "default": true,
                            "id": "#main/memote_run_base/skip_test_find_metabolites_not_consumed_with_open_bounds"
                        },
                        {
                            "default": true,
                            "id": "#main/memote_run_base/skip_test_find_metabolites_not_produced_with_open_bounds"
                        },
                        {
                            "default": true,
                            "id": "#main/memote_run_base/skip_test_find_metabolites_produced_with_closed_bounds"
                        },
                        {
                            "source": "#main/memote_solver",
                            "id": "#main/memote_run_base/solver"
                        }
                    ],
                    "out": [
                        "#main/memote_run_base/run_json"
                    ],
                    "id": "#main/memote_run_base"
                },
                {
                    "label": "prodigal",
