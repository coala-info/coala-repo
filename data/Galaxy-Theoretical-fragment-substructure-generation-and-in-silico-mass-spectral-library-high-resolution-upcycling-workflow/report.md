# Theoretical fragment substructure generation and in silico mass spectral library high-resolution upcycling workflow CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://www.recetox.muni.cz/en/services/data-services-2/spectrometric-data-processing-and-analysis
- **Package**: https://workflowhub.eu/workflows/888
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/888/ro_crate?version=2
- **Conda**: N/A
...
- **Main workflow (WorkflowHub):** `Galaxy_Workflow_MsFinder_Workflow_GOLM_V2.ga` (Main Workflow)
- **Project**: RECETOX SpecDatRI
- **Views**: 6459
- **Creators**: Zargham Ahmad, Helge Hecht, Elliott J. Price
