...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fthegenemyers%2FDAMASKER%2Fblob%2Fmaster%2FDB.h)
...
[History](/thegenemyers/DAMASKER/commits/master/DB.h)
...
[Raw](https://github.com/thegenemyers/DAMASKER/raw/refs/heads/master/DB.h)
...
#define HIDE\_FILES // Auxiliary DB files start with a . so they are "hidden"
...
#define LAST\_READ\_SYMBOL '$'

#define BLOCK\_SYMBOL '@'
...
extern char \*Prog\_Name; // Name of program
...
#define ARG\_INIT(name) \

Prog\_Name = Strdup(name,""); \

for (i = 0; i < 128; i++) \

flags[i] = 0;

#define ARG\_FLAGS(set) \
...
#define ARG\_NON\_NEGATIVE(var,name) \
