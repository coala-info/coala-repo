...
#. Curated reference :ref:`databases ` of surface polysaccharide gene clusters (loci).
...
\* On `GitHub `\_ alongside the reference :ref:`databases `.
\* On `PathogenWatch `\_ where it is used to serotype \*Klebsiella\* and \*Acinetobacter baumannii\* isolates.
\* As a GUI in `Kaptive Web `\_ (`source code `\_),
which includes a `third-party database `\_ for
...
\* If you use `Kaptive Web `\_, please cite [#kaptiveweb]\_.
\* If you use the \*A. baumannii\* K or OC locus database(s) in your research please cite [#aci]\_ and [#aciupdate]\_.
\* Lists of papers describing each of the individual \*A. baumannii\* reference loci can be found `here `\_.
Tutorial
==========
Step-by-step `video `\_ and
`documented `\_
...
- `Dr. Tom Stanton `\_
- `Dr. Kelly L. Wyres `\_
- `Prof. Kathryn E. Holt `\_
- `Dr. Ryan R. Wick `\_
- `A/Prof. Johanna Kenyon `\_
`Contact Kelly and Tom `\_ for help with Kaptive, or to report bugs or request features.
References
=============
