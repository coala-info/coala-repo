...
[Edit this page](https://github.com/WayScience/CytoSnake/edit/master/docs/tutorial.md "Edit this page")

Toggle Light / Dark / Auto color theme

Toggle table of contents sidebar

# CytoSnake Tutorial[#](#cytosnake-tutorial "Permalink to this heading")
...
![_images/CytoSnake-cli_0.drawio.png](_images/CytoSnake-cli_0.drawio.png)

### Modes[#](#modes "Permalink to this heading")
...
### Configurations[#](#configurations "Permalink to this heading")
...
#### **cp\_process workflow docs**[#](#cp-process-workflow-docs "Permalink to this heading")

| workflow name | Path to config | Documentation |
| --- | --- | --- |
| cp\_process | ./CytoSnake/configs/analysis\_configs/wf\_configfs/cp\_process.yaml | [Workflow Docs](workflows.html#cp_process) |

**modules used:**

| Steps | Path to config | Module Documentation |
| --- | --- | --- |
| aggregate | ./CytoSnake/configs/analysis\_configs/aggregate\_configs.yaml | [aggregate docs](workflow-modules.html#aggregate) |
| annotate | ./CytoSnake/configs/analysis\_configs/aggregate\_configs.yaml | [annotate docs](workflow-modules.html#annotate) |
| normalize | ./CytoSnake/configs/analysis\_configs/normalize\_configs.yaml | [normalize docs](workflow-modules.html#normalize) |
| feature\_select | ./CytoSnake/configs/analysis\_configs/feature\_select\_configs.yaml | [feature select docs](workflow-modules.html#feature-select) |
| consensus | ./CytoSnake/configs/analysis\_configs/consensus\_configs.yaml | [consensus docs](workflow-modules.html#generate-consensus) |

#### **cp\_process\_singlecells workflow docs**[#](#cp-process-singlecells-workflow-docs "Permalink to this heading")

| workflow name | Path to config | Documentation |
| --- | --- | --- |
| cp\_process\_singlecells | ./CytoSnake/configs/analysis\_configs/wf\_configfs/cp\_process\_singlecells.yaml | [Workflow Docs](workflows.html#cp_process_singlecells) |

**modules used**:

| Steps | Path to config | Module Documentation |
| --- | --- | --- |
| convert | ./CytoSnake/configs/analysis\_configs/cytotable\_convert.yaml | [convert docs](workflow-modules.html#cytotable-convert) |
| annotate | ./CytoSnake/configs/analysis\_configs/aggregate\_configs.yaml | [annotate docs](workflow-modules.html#annotate) |
| normalize | ./CytoSnake/configs/analysis\_configs/normalize\_configs.yaml | [normalize docs](workflow-modules.html#normalize) |
| feature\_select | ./CytoSnake/configs/analysis\_configs/feature\_select\_configs.yaml | [feature select docs](workflow-modules.html#feature-select) |
...
### `init` mode documentation[#](#init-mode-documentation "Permalink to this heading")
...
| `--datatype` | Datatype flag helps CytoSnake in how to setup the input files for processing. [Choices = “cell\_profiler” “deep\_profiler”] [Default=”cell\_profiler”] |

### `run` mode documentation[#](#run-mode-documentation "Permalink to this heading")
...
* [plate\_data\_1](https://nih.figshare.com/ndownloader/files/18506036): (10GB download)
* [plate\_data\_2](https://nih.figshare.com/ndownloader/files/18031619): (11GB download)
* [metadata\_folder](https://minhaskamal.github.io/DownGit/#/home?url=https://github.com/broadinstitute/cell-health/tree/master/1.generate-profiles/data/metadata): Contains all associated perturbations per well
...
### Setting up files[#](#setting-up-files "Permalink to this heading")
...
### Running the workflow[#](#running-the-workflow "Permalink to this heading")
...
### Accessing data[#](#accessing-data "Permalink to this heading")
...
* CytoSnake Tutorial
  ...
  + [Concepts](#concepts)
    ...
    - [Configurations](#configurations)
      * [**cp\_process workflow docs**](#cp-process-workflow-docs)
      * [**cp\_process\_singlecells workflow docs**](#cp-process-singlecells-workflow-docs)
  + [Documentation](#documentation)
    - [`init` mode documentation](#init-mode-documentation)
    - [`run` mode documentation](#run-mode-documentation)
  + [Usage](#usage)
