...
### Tool Description
Splits a tree file into several smaller tree files, one for each tree in the original file.
...
- **Conda**: https://anaconda.org/channels/bioconda/packages/ete3/overview
