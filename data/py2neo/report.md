...
### Metadata
- **Docker Image**: quay.io/biocontainers/py2neo:3.1.2--py34_0
...
FATAL:   Unable to handle docker://quay.io/biocontainers/py2neo:3.1.2--py34_0 uri: while building SIF from layers: conveyor failed to get: invalid character '}' after top-level value
```
