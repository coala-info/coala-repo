...
label: gatk_CollectMultipleMetricsSpark
doc: Instantiates and executes multiple metrics collection tasks for a given 
  SAM/BAM/CRAM file. The tool leverages the Spark framework for faster 
  operation.
inputs:
  - id: output
    type: string
