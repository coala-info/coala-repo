...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fpybel%2Fpybel%2Fblob%2Fmaster%2FCONTRIBUTING.md)
...
[History](/pybel/pybel/commits/master/CONTRIBUTING.md)

History

106 lines (80 loc) · 4.8 KB
...
[Raw](https://github.com/pybel/pybel/raw/refs/heads/master/CONTRIBUTING.md)
...
see [`tox.ini`](/pybel/pybel/blob/master/tox.ini) for a list of flake8 plugins). You can check if your
...
qualifiers in the [`setup.cfg`](/pybel/pybel/blob/master/setup.cfg) and from the GitHub Actions testing
configuration.
