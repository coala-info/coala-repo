...
inputs:
  ...
  - id: mix_taxid
    type:
      - 'null'
      - boolean
    doc: allow part of files being whithout taxids
    inputBinding:
      position: 101
      prefix: --mix-taxid
  - id: no_compress
  ...
  - id: number
    type:
      - 'null'
      - int
    doc: minimum number of files that share a k-mer (overides -p/--proportion)
    inputBinding:
      position: 101
      prefix: --number
  - id: out_prefix
  ...
  - id: proportion
    type:
      - 'null'
      - float
    doc: minimum proportion of files that share a k-mer
    default: 1.0
    inputBinding:
      position: 101
      prefix: --proportion
