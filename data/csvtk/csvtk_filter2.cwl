...
baseCommand:
  ...
  - filter2
label: csvtk_filter2
doc: "filter rows by awk-like arithmetic/string expressions\n\nTool homepage: https://github.com/shenwei356/csvtk"
inputs:
  - id: comment_char
    type:
      - 'null'
  ...
  - id: filter
    type:
      - 'null'
      - string
    doc: awk-like filter condition. e.g. '$age>12' or '$1 > $3' or '$name=="abc"'
      or '$1 % 2 == 0'
    inputBinding:
      position: 101
      prefix: --filter
  ...
  - id: num_cpus
    ...
    inputBinding:
      position: 101
      prefix: --num-cpus
  - id: numeric_as_string
    type:
      - 'null'
      - boolean
    doc: treat even numeric fields as strings to avoid converting big numbers into
      scientific notation
    inputBinding:
      position: 101
      prefix: --numeric-as-string
  - id: out_delimiter
    type:
      - 'null'
      - string
