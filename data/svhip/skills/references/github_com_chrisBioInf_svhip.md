...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2FchrisBioInf%2Fsvhip)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E&source=header-repo&source_repo=chrisBioInf%2Fsvhip)
...
[Branches](/chrisBioInf/svhip/branches)[Tags](/chrisBioInf/svhip/tags)
...
| --- | --- | --- | --- | --- |
| Latest commit   History[40 Commits](/chrisBioInf/svhip/commits/main/)   40 Commits | | |
| [Example](/chrisBioInf/svhip/tree/main/Example "Example") | | [Example](/chrisBioInf/svhip/tree/main/Example "Example") |  |  |
| [hexamer\_models](/chrisBioInf/svhip/tree/main/hexamer_models "hexamer_models") | | [hexamer\_models](/chrisBioInf/svhip/tree/main/hexamer_models "hexamer_models") |  |  |
| [z\_score\_model\_SVR](/chrisBioInf/svhip/tree/main/z_score_model_SVR "z_score_model_SVR") | | [z\_score\_model\_SVR](/chrisBioInf/svhip/tree/main/z_score_model_SVR "z_score_model_SVR") |  |  |
| [LICENSE](/chrisBioInf/svhip/blob/main/LICENSE "LICENSE") | | [LICENSE](/chrisBioInf/svhip/blob/main/LICENSE "LICENSE") |  |  |
| [README.md](/chrisBioInf/svhip/blob/main/README.md "README.md") | | [README.md](/chrisBioInf/svhip/blob/main/README.md "README.md") |  |  |
| [requirements.txt](/chrisBioInf/svhip/blob/main/requirements.txt "requirements.txt") | | [requirements.txt](/chrisBioInf/svhip/blob/main/requirements.txt "requirements.txt") |  |  |
| [svhip.py](/chrisBioInf/svhip/blob/main/svhip.py "svhip.py") | | [svhip.py](/chrisBioInf/svhip/blob/main/svhip.py "svhip.py") |  |  |
| View all files | | |
...
* --threads (int, default: max(CPU\_COUNT-1, 1)): Number of threads to allocate.
...
* -c, --shuffle-control (store\_true, default: False): Use simpler column-based shuffling instead of SISSIz.
* -H, --hexamer-model (string, default: hexamer\_models/Human\_hexamer.tsv): Path to the statistical hexamer model to use.
...
* --optimize-hyperparameters (store\_true, default: False): Perform hyperparameter optimization.
...
* --logscale (store\_true, default: False): Use logarithmic scaling for the parameter grid.
...
* --min-trees (int, default: 100): Minimum number of trees (n\_estimators) to consider.
* --max-trees (int, default: 500): Maximum number of trees (n\_estimators) to consider.
...
* -o, --outfile (string): Output TSV file (Require