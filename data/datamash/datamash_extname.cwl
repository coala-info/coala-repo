...
inputs:
  ...
  - id: fields
    type:
      ...
      - type: array
        items: string
    doc: Input field to use. Can be a number (1=first field), or a field name 
      when using the -H or --header-in options. Multiple fields can be listed 
