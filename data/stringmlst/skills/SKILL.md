---
name: stringmlst
description: stringMLST is a lightweight, k-mer based tool designed to predict the sequence type (ST) of a bacterial isolate directly from genome sequencing reads.
