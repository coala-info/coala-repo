...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fcbbzhang%2FJCcirc%2Fblob%2Fmaster%2FJCcirc.pl)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fblob%2Fshow&source=header-repo&source_repo=cbbzhang%2FJCcirc)
...
[History](/cbbzhang/JCcirc/commits/master/JCcirc.pl)

History

1231 lines (1159 loc) · 56.8 KB
...
[Raw](https://github.com/cbbzhang/JCcirc/raw/refs/heads/master/JCcirc.pl)
...
Usage: perl cFLSeq.pl -C circ -G genome -F annotation -O circ\_contig -P 8 --read1 read\_1.fq --read2 read\_2.fq --contig contig.fa -D 0
...
RNA-Seq data, read\_1 (paired end, fastq format).
...
mkdir( $output ) or die "can not make a new output dir