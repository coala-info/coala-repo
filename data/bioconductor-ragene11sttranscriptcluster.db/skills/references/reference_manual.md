...
ragene11sttranscriptclusterACCNUM

Map Manufacturer identifiers to Accession Numbers

Description

ragene11sttranscriptclusterACCNUM is an R object that contains mappings between a manufac-
...
## Bimap interface:
x <- ragene11sttranscriptclusterACCNUM
...
ragene11sttranscriptclusterALIAS2PROBE
...
ragene11sttranscriptclusterALIAS is an R object that provides mappings between common gene
...
xx <- as.list(ragene11sttranscriptclusterALIAS2PROBE)
if(length(xx) > 0){
...
Welcome to the ragene11sttranscriptcluster.db annotation Package. The purpose of this package
is to provide detailed information about the ragene11sttranscriptcluster platform. This package is
updated biannually.
Objects in this package are accessed using the select() interface. See ?select in the AnnotationDbi
package for details.

ragene11sttranscriptclusterCHR
...
## use of select().
ls("package:ragene11sttranscriptcluster.db")
...
ragene11sttranscriptclusterCHR is an R object that provides mappings between a manufacturer
...
## Bimap interface:
x <- ragene11sttranscriptclusterCHR
...
ragene11sttranscriptclusterCHRLOC
...
ragene11sttranscriptclusterCHRLENGTHS

A named vector for the length of each of the chromosomes

Description

ragene11sttranscriptclusterCHRLENGTHS provides the length measured in base pairs for each of
the chromosomes.
...
## Bimap interface:
tt <- ragene11sttranscriptclusterCHRLENGTHS
...
ragene11sttranscriptclusterCHRLOC is an R object that maps manufacturer identifiers to the start-
...
ragene11sttranscriptclusterENSEMBL
...
## Bimap interface:
x <- ragene11sttranscriptclusterCHRLOC
...
ragene11sttranscriptclusterENSEMBL is an R object that contains mappings between manufacturer
...
ragene11sttranscriptclusterENTREZID
...
## Bimap interface:
x <- ragene11sttranscriptclusterENSEMBL
...
x <- ragene11sttranscriptclusterENSEMBL2PROBE
mapped_genes <- mappedkeys(x)
# Convert to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
ragene11sttranscriptclusterENTREZID is an R object that provides mappings between manufac-
turer identifiers and Entrez Gene identifiers.

ragene11sttranscriptclusterENZYME
...
## Bimap interface:
x <- ragene11sttranscriptclusterENTREZID
...
ragene11sttranscriptclusterENZYME is an R object that provides mappings between manufacturer
identifiers and EC numbers. ragene11sttranscriptclusterENZYME2PROBE is an R object that maps
...
When the ragene11sttranscriptclusterENZYME maping viewed as a list, each manufacturer identi-
...
For the ragene11sttranscriptclusterENZYME2PROBE, each EC number maps to a named vector
...
numbers. In ragene11sttranscriptclusterENZYME2PROBE, EC is dropped from the Enzyme Com-
mission numbers.
...
## Bimap interface:
x <- ragene11sttranscriptclusterENZYME
...
ragene11sttranscriptclusterGENENAME
...
# Now convert ragene11sttranscriptclusterENZYME2PROBE to a list to see inside
x <- ragene11sttranscriptclusterENZYME2PROBE
mapped_probes <- mappedkeys(x)
## convert to a list
xx <- as.list(x[mapped_probes][1:3])
if(length(xx) > 0){
...
ragene11sttranscriptclusterGENENAME is an R object that maps manufacturer identifiers to the
...
## Bimap interface:
x <- ragene11sttranscriptclusterGENENAME
# Get the probe identifiers that are mapped to a gene name
mapped_probes <- mappedkeys(x)

10

ragene11sttranscriptclusterGO
...
ragene11sttranscriptclusterGO is an R object that provides mappings between manufacturer iden-
tifiers and the GO identifiers that they are directly associated with. This mapping and its reverse
mapping (ragene11sttranscriptclusterGO2PROBE) do NOT associate the child terms from the GO
ontology with the gene. Only the directly evidenced terms are represented here.

ragene11sttranscriptclusterGO2ALLPROBES is an R object that provides mappings between a
...
than ragene11sttranscriptclusterGO2PROBE.

Details

If ragene11sttranscriptclusterGO is cast as a list, each manufacturer identifier is mapped to a list
...
If ragene11sttranscriptclusterGO2ALLPROBES or ragene11sttranscriptclusterGO2PROBE is cast
...
• ragene11sttranscriptclusterGO2ALLPROBES
• AnnotationDb-class for use of the select() interface.
...
## Bimap interface:
x <- ragene11sttranscriptclusterGO
...
# For the reverse map:
x <- ragene11sttranscriptclusterGO2PROBE
mapped_genes <- mappedkeys(x)
# Convert to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
ragene11sttranscriptclusterORGANISM

x <- ragene11sttranscriptclusterGO2ALLPROBES
mapped_genes <- mappedkeys(x)
# Convert ragene11sttranscriptclusterGO2ALLPROBES to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
ragene11sttranscriptclusterMAPCOUNTS
...
ragene11sttranscriptclusterMAPCOUNTS provides the "map count" (i.e. the count of mapped keys)
for each map in package ragene11sttranscriptcluster.db.
...
The Organism information for ragene11sttranscriptcluster

Description

ragene11sttranscriptclusterORGANISM is an R object that contains a single item: a character string
that names the organism for which ragene11sttranscriptcluster was built. ragene11sttranscriptclusterORGPKG
...
ragene11sttranscriptclusterPATH

13

Details

Although the package name is suggestive of the organism for which it was built, ragene11sttranscriptclusterORGANISM
provides a simple way to programmatically extract the organism name. ragene11sttranscriptclusterORGPKG
...
## Bimap interface:
ragene11sttranscriptclusterORGANISM
ragene11sttranscriptclusterORGPKG
...
ragene11sttranscriptclusterPATH maps probe identifiers to the identifiers used by KEGG for path-
ways in which the genes represented by the probe identifiers are involved

ragene11sttranscriptclusterPATH2PROBE is an R object that provides mappings between KEGG
...
ragene11sttranscriptclusterPFAM
...
## Bimap interface:
x <- ragene11sttranscriptclusterPATH
...
x <- ragene11sttranscriptclusterPATH
mapped_probes <- mappedkeys(x)
# Now convert the ragene11sttranscriptclusterPATH2PROBE object to a list
xx <- as.list(x[mapped_probes][1:300])
if(length(xx) > 0){
...
ragene11sttranscriptclusterPFAM is an R object that provides mappings between manufacturer
...
ragene11sttranscriptclusterPMID
...
ragene11sttranscriptclusterPMID is an R object that provides mappings between manufacturer iden-
tifiers and PubMed identifiers. ragene11sttranscriptclusterPMID2PROBE is an R object that pro-
vides mappings between PubMed identifiers and manufacturer identifiers.

Details

When ragene11sttranscriptclusterPMID is viewed as a list each manufacturer identifier is mapped
...
When ragene11sttranscriptclusterPMID2PROBE is viewed as a list each PubMed identifier is mapped
...
## Bimap interface:
x <- ragene11sttranscriptclusterPMID
...
ragene11sttranscriptclusterREFSEQ
...
x <- ragene11sttranscriptclusterPMID2PROBE
mapped_probes <- mappedkeys(x)
# Now convert the reverse map object ragene11sttranscriptclusterPMID2PROBE to a list
xx <- as.list(x[mapped_probes][1:300])
if(length(xx) > 0){
...
ragene11sttranscriptclusterPROSITE

Maps between Manufacturer Identifiers and PROSITE Identifiers

Description

ragene11sttranscriptclusterPROSITE is an R object that provides mappings between manufacturer
...
ragene11sttranscriptclusterREFSEQ is an R object that provides mappings between manufacturer
...
## Bimap interface:
x <- ragene11sttranscriptclusterREFSEQ
...
ragene11sttranscriptclusterSYMBOL
...
ragene11sttranscriptclusterSYMBOL is an R object that provides mappings between manufacturer
...
ragene11sttranscriptclusterUNIPROT
...
ragene11sttranscriptclusterUNIPROT is an R object that contains mappings between the manufac-
...
## Bimap interface:
x <- ragene11sttranscriptclusterUNIPROT
...
ragene11sttranscriptcluster_dbconn
...
ragene11sttranscriptcluster_dbconn()
ragene11sttranscriptcluster_dbfile()
ragene11sttranscriptcluster_dbschema(file="", show.indices=FALSE)
...
ragene11sttranscriptcluster_dbconn returns a connection object to the package annotation
DB. IMPORTANT: Don’t call dbDisconnect on the connection object returned by ragene11sttranscriptcluster_dbconn
or you will break all the AnnDbObj objects defined in this package!
ragene11sttranscriptcluster_dbfile returns the path (character string) to the package anno-
tation DB (this is an SQLite file).
ragene11sttranscriptcluster_dbschema prints the schema definition of the package annotation
DB.
ragene11sttranscriptcluster_dbInfo prints other information about the package annotation
DB.

Value

ragene11sttranscriptcluster_dbconn: a DBIConnection object representing an open connec-
tion to the package annotation DB.
ragene11sttranscriptcluster_dbfile: a character string with the path to the package annota-
tion DB.
ragene11sttranscriptcluster_dbschema: none (invisible NULL).
ragene11sttranscriptcluster_dbInfo: none (invisible NULL).
...
dbGetQuery(ragene11sttranscriptcluster_dbconn(), "SELECT COUNT(*) FROM probes")
...
ragene11sttranscriptcluster.db, 2
ragene11sttranscriptcluster_dbconn,
...
ragene11sttranscriptclusterCHR, 3
ragene11sttranscriptclusterCHRLENGTHS,
...
ragene11sttranscriptclusterGO, 10
ragene11sttranscriptclusterMAPCOUNTS,
...
ragene11sttranscriptcluster.db, 2
ragene11sttranscriptcluster_dbconn, 19
ragene11sttranscriptcluster_dbfile
...
ragene11sttranscriptclusterACCNUM, 1
ragene11sttranscriptclusterALIAS2PROBE,
...
ragene11sttranscriptclusterCHRLOC, 4
ragene11sttranscriptclusterCHRLOCEND

(ragene11sttranscriptclusterCHRLOC),
4

ragene11sttranscriptclusterENSEMBL, 5
ragene11sttranscriptclusterENSEMBL2PROBE

(ragene11sttranscriptclusterENSEMBL),
5

ragene11sttranscriptclusterENTREZID, 6
ragene11sttranscriptclusterENZYME, 7

22

INDEX

ragene11sttranscriptclusterENZYME2PROBE

(ragene11sttranscriptclusterENZYME),
7

ragene11sttranscriptclusterGENENAME, 9
ragene11sttranscriptclusterGO, 10
ragene11sttranscriptclusterGO2ALLPROBES,
...
ragene11sttranscriptclusterGO2PROBE

(ragene11sttranscriptclusterGO),
10

ragene11sttranscriptclusterLOCUSID
...
ragene11sttranscriptclusterPATH, 13
ragene11sttranscriptclusterPATH2PROBE

(ragene11sttranscriptclusterPATH),
13

ragene11sttranscriptclusterPFAM, 14
ragene11sttranscriptclusterPMID, 15
ragene11sttranscriptclusterPMID2PROBE

(ragene11sttranscriptclusterPMID),
15

ragene11sttranscriptclusterPROSITE, 16
ragene11sttranscriptclusterREFSEQ, 16
ragene11sttranscriptclusterSYMBOL, 18
ragene11sttranscriptclusterUNIPROT, 19
ragene11sttranscriptclusterUNIPROT2PROBE
