...
baseCommand: [ /unlock/infrastructure/binaries/guppy/ont-guppy-cpu/bin/guppy_basecaller ]
...
doc: |
  ...
  Direct download from:
    CPU: wget https://mirror.oxfordnanoportal.com/software/analysis/ont-guppy-cpu_6.0.1_linux64.tar.gz
    GPU: wget https://mirror.oxfordnanoportal.com/software/analysis/ont-guppy_6.0.1_linux64.tar.gz
