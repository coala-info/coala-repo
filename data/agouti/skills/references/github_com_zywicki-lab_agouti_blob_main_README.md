...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fzywicki-lab%2Fagouti%2Fblob%2Fmain%2FREADME.md)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fblob%2Fshow&source=header-repo&source_repo=zywicki-lab%2Fagouti)
...
[zywicki-lab](/zywicki-lab)
/
**[agouti](/zywicki-lab/agouti)**
Public

* [Notifications](/login?return_to=%2Fzywicki-lab%2Fagouti) You must be signed in to change notification settings
* [Fork
  0](/login?return_to=%2Fzywicki-lab%2Fagouti)
* [Star
   3](/login?return_to=%2Fzywicki-lab%2Fagouti)

* [Code](/zywicki-lab/agouti)
* [Issues
  0](/zywicki-lab/agouti/issues)
* [Pull requests
  0](/zywicki-lab/agouti/pulls)
* [Actions](/zywicki-lab/agouti/actions)
* [Projects](/zywicki-lab/agouti/projects)
* [Security
  0](/zywicki-lab/agouti/security)
* [Insights](/zywicki-lab/agouti/pulse)

Additional navigation options

* [Code](/zywicki-lab/agouti)
* [Issues](/zywicki-lab/agouti/issues)
* [Pull requests](/zywicki-lab/agouti/pulls)
* [Actions](/zywicki-lab/agouti/actions)
* [Projects](/zywicki-lab/agouti/projects)
* [Security](/zywicki-lab/agouti/security)
* [Insights](/zywicki-lab/agouti/pulse)
...
1. [agouti](/zywicki-lab/agouti/tree/main)
...
[History](/zywicki-lab/agouti/commits/main/README.md)

History

275 lines (166 loc) · 15.1 KB
...
[Raw](https://github.com/zywicki-lab/agouti/raw/refs/heads/main/README.md)
...
[![DOI](https://camo.githubusercontent.com/bddd4be4d36eef7b2cfa7293810f51c3123c8509b74a6d9a2d0eab798d9af47f/68747470733a2f2f7a656e6f646f2e6f72672f62616467652f3530373935353837342e737667)](https://zenodo.org/badge/latestdoi/507955874)
...
You can now access **AGouTI** as follows:
...
**-a**, **--annotation** : Input file containing gene annotations in GTF or GFF3 format.

**-f**, **--format** : Input file format (GTF or GFF3), can be gzip-compressed.

**-d**, **--db** : Name for the output database.
...
**-i**, **--infer\_genes** : Infer genes. Use only with GTF files that do not contain separate lines describing genes. This step might be very time-consuming.

**-j**, **--infer\_transcripts** : Infer transcripts. Use only with GTF files that do not contain separate lines describing transcripts. This step might be very time-consuming.

##### Output

The output files include:

1. **database\_name** - the SQLite database file
2. **database\_name.relations** - text file storing relations between feature types. This file is required for annotation with AGouTI. Therefore it must be stored in the same directory as the database file.
3. **database\_name.attributes\_and\_features.pickle** - python dictionary stored as a pickle file. This file is required for annotation with AGouTI. Therefore it must be stored in the same directory as the database file.
4. **database\_name.database.structure.txt** - additional text file listing all the features and attributes present in the GTF/GFF3 file and showing relations between them in a tree-like structure
...
**-i**, **--input** : Input file in BED or another column-based format (see --custom).

**-d**, **--database** : Database created by agouti create\_db.

##### Additional options

**-m**, **--custom** : Specify that the input text file is in custom format, besides BED. It should contain columns with information about feature id (id), chromosome (chr), start (s), and end (e) coordinates. Users can optionally specify a column with strand information (stra