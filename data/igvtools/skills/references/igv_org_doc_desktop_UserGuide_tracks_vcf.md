...
# Variant calls and genotypes[#](#variant-calls-and-genotypes "Direct link to this section")
...
# Sorting and grouping samples[#](#sorting-and-grouping-samples "Direct link to this section")
...
Loading a [**sample attribute file**](../../../FileFormats/SampleInfo/) alongside the VCF file, provides further options to sort and group the sample rows:
...
* When a sample attribute file is loaded, the VCF track's pop-up menu includes a *Group By...* option. Clicking on it will bring up dialog window where you can select the attribute to group by in a dropdown menu.
  ...
  ![](../../img/vcf-groupby-options.png)

# Display mode[#](#display-mode "Direct link to this section")
...
# Color schemes[#](#color-schemes "Direct link to this section")
