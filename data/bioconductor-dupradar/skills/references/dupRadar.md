...
* [1 Introduction to dupRadar](#introduction-to-dupradar)
* [2 Getting started using dupRadar](#getting-started-using-dupradar)
  + [2.1 Preparing your data](#preparing-your-data)
  + [2.2 A GTF file](#a-gtf-file)
  + [2.3 AnnotationHub as a source of GTF files](#annotationhub-as-a-source-of-gtf-files)
* [3 dupRate demo data](#duprate-demo-data)
* [4 The duplication rate analysis](#the-duplication-rate-analysis)
* [5 Plotting and interpretation](#plotting-and-interpretation)
  + [5.1 Fitting a model into the data](#fitting-a-model-into-the-data)
  + [5.2 Comparing the fitted parameters to other datasets](#comparing-the-fitted-parameters-to-other-datasets)
  + [5.3 Other plots](#other-plots)
* [6 Other information deduced from the data](#other-information-deduced-from-the-data)
  + [6.1 Fraction of multimappers per gene](#fraction-of-multimappers-per-gene)
  + [6.2 Connection between possible PCR artefacts and GC content](#connection-between-possible-pcr-artefacts-and-gc-content)
* [7 Conclusion](#conclusion)
* [8 Including dupRadar into pipelines](#including-dupradar-into-pipelines)
  + [8.1 Citing dupRadar](#citing-dupradar)
  + [8.2 Reporting problems or bugs](#reporting-problems-or-bugs)
...
question, we set out to develop a new tool. The *dupRadar*
...
The *dupRadar* package only works with duplicate marked BAM files.

If you do not have/want a duplication marking step in your default pipeline,
the *dupRadar* package includes, for your convenience,
...
The Bioconductor *AnnotationHub* package provides an alternative
...
```
##                                                      AH47101
## "/home/biocbuild/.cache/R/AnnotationHub/4a4177fdd2908_52579"
```
...
function from the Bioconductor *[Rsubread](https://bioconductor.org/packages/3.22/Rsubread)* package, which also
...
The *dupRadar* offers several functions to assess this
...
are mixed up. *dupRadar*’s main focus are PCR duplicates in RNA-Seq.
...
*dupRadar* package provides some other useful plots to extract
...
easy way to check using our *dupRadar* package in conjunction
with *biomaRt* is demonstrated in the following. For simplicity
...
The *dupRadar* package provides a framework for the analysis of
...
## [4] BiocGenerics_0.56.0 generics_0.1.4      dupRadar_1.40.0
## [7] knitr_1.50          BiocStyle_2.38.0
##
## loaded via a namespace (and not attached):
##  [1] rappdirs_0.3.3       sass_0.4.10          BiocVersion_3.22.0
##  [4] KernSmooth_2.23-26   RSQLite_2.4.3        lattice_0.22-7
...
## [22] Biostrings_2.78.0    codetools_0.2-20     httr2_1.2.1
## [25] jquerylib_0.1.4      cli_3.6.5            crayon_1.5.3
## [28] rlang_1.1.6          XVector_0.50.0       Biobase_2.70.0
## [31] bit64_4.6.0-1        withr_3.0.2          cachem_1.1.0
## [34] yaml_2.3.10          tools_4.5.1          memoise_2.0.1
## [37] dplyr_1.1.4          filelock_1.0.3       curl_7.0.0
## [40] png_0.1-8            vctrs_0.6.5          R6_2.6.1
## [43] magick_2.9.0         stats4_4.5.1         lifecycle_1.0.4
## [46] Seqinfo_1.0.0        KEGGREST_1.50.0      IRanges_2.44.0
## [49] S4Vectors_0.48.0     bit_4.6.0            pkgconfig_2.0.3
## [52] Rsubread_2.24.0      pillar_1.11.1        bslib_0.9.0
## [55] Rcpp_1.1.0           glue_1.8.0           xfun_0.53
## [58] tibble_3.3.0         tidyselect_1.2.1     htmltools_0.5.8.1
