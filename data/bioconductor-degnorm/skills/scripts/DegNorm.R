# Code example from 'DegNorm' vignette. See references/ for full tutorial.
...
## ----fig.width=5,fig.height=4,message=FALSE,eval=TRUE-------------------------
##gene named "SOD1"
...
## ----fig.width=5,fig.height=4,message=FALSE,warning=FALSE,eval=TRUE-----------
