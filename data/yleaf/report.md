...
### Tool Description
software tool for human Y-chromosomal phylogenetic analysis and haplogroup inference v3.2.1
...
Yleaf: software tool for human Y-chromosomal phylogenetic analysis and haplogroup inference v3.2.1
...
usage: Yleaf [-h] [-fastq PATH] [-bam PATH] [-cram PATH] [-cr PATH]
             [-vcf PATH] [-ra] [-force] -rg {hg19,hg38} -o STRING [-r INT]
             [-q INT] [-b INT] [-t INT] [-pq FLOAT] [-old] [-dh] [-hc] [-aDNA]
             [-p] [-maf FLOAT]
