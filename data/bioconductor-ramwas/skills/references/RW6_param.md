...
* [1 Initializing RaMWAS parameters](#initializing-ramwas-parameters)
* [2 Explanation of all parameters](#explanation-of-all-parameters)
  + [2.1 Parameters pointing to directories](#parameters-pointing-to-directories)
  + [2.2 Parameters pointing to files](#parameters-pointing-to-files)
    - [2.2.1 BAM names](#bam-names)
    - [2.2.2 BAM to sample matching](#bam2sample)
    - [2.2.3 CpG locations](#cpg-locations)
    - [2.2.4 File with covariates](#file-with-covariates)
  + [2.3 Multithreading](#multithreading)
  + [2.4 Read filtering](#read-filtering)
  + [2.5 Coverage matrix](#coverage-matrix)
  + [2.6 PCA and MWAS](#pca-and-mwas)
  + [2.7 Annotation of top findings](#biomart)
  + [2.8 Methylation risk score](#methylation-risk-score)
    - [2.8.1 Choosing the number of folds `cvnfolds` in the cross validation](#choosing-the-number-of-folds-cvnfolds-in-the-cross-validation)
  + [2.9 Joint analysis with genotype data](#joint-analysis-with-genotype-data)

# 1 Initializing RaMWAS parameters
...
# 2 Explanation of all parameters

## 2.1 Parameters pointing to directories
...
It is “coverage\_norm\_123” by default (123 is the number of samples)
...
It is “PCA\_12\_cvrts\_0b0a0c” by default
...
It is “Testing\_age\_7\_PCs” by default
...
## 2.7 Annotation of top findings
...
### 2.8.1 Choosing the number of folds `cvnfolds` in the cross validation
...
## 2.9 Joint analysis with genotype data
