...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2FDiltheyLab%2FMetaMaps%2Fblob%2Fmaster%2FMakefile)
...
[History](/DiltheyLab/MetaMaps/commits/master/Makefile)
...
[Raw](https://github.com/DiltheyLab/MetaMaps/raw/refs/heads/master/Makefile)
...
CXXFLAGS += -O2 -ggdb -fopenmp -std=c++11 -Isrc -L /usr/lib/x86\_64-linux-gnu//lib -I /usr/lib/x86\_64-linux-gnu//include

CPPFLAGS += -DUSE\_BOOST
...
$(CXX) $(CXXFLAGS) $(CPPFLAGS) $(OBJECTS) -o metamaps -lstdc++ -fopenmp -lz -lm -lpthread -lboost\_system -lboost\_filesystem -lboost\_serialization -lboost\_regex -lboost\_math\_c99
