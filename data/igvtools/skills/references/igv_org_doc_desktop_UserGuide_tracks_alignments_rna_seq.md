...
This section covers unique features of RNA-seq alignment tracks. See [Alignments basics](../viewing_alignments_basics/) for general features that also apply to RNA-seq tracks.

# RNA-seq alignments[#](#rna-seq-alignments "Direct link to this section")
...
# Splice junction track[#](#splice-junction-track "Direct link to this section")
...
* The height and thickness of the arc are proportional to the **depth of read coverage** up to 50 reads. To display a more proportionate representation, select *Autoscale* from the right-click menu.
...
# Junction files[#](#junction-files "Direct link to this section")
...
# Sashimi plots[#](#sashimi-plots "Direct link to this section")
