# Workflow 6: Alpha Diversity [Galaxy Training: 16S Microbial Analysis With Mothur] CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://training.galaxyproject.org
- **Package**: https://workflowhub.eu/workflows/1412
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1412/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 270
...
- **Main workflow (WorkflowHub):** `workflow6-alpha-diversity.ga` (Main Workflow)
