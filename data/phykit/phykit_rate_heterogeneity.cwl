...
baseCommand:
  - phykit
  - rate_heterogeneity
label: phykit_rate_heterogeneity
doc: Test for rate heterogeneity across phylogenetic regimes using multi-rate 
  Brownian motion. Fits single-rate vs. multi-rate BM models and performs a 
...
inputs:
  ...
  - id: nsim
    type:
      - 'null'
      - int
    doc: 'number of parametric bootstrap simulations (default: 0, no bootstrap)'
    inputBinding:
      position: 101
      prefix: --nsim
  - id: seed
