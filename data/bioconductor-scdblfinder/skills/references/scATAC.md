...
```
## iter=1, 27 cells excluded from training.
```

```
## iter=2, 31 cells excluded from training.
```
...
```
## 02:18:04 - Splitting and subsetting barcodes...
```

```
## 02:18:04 - Obtaining overlaps...
```
...
```
## 02:18:09 - Reading full fragments...
```

```
## 02:18:09 - Splitting and subsetting barcodes...
```

```
## 02:18:09 - Computing coverages
```

```
## 02:18:10 - Obtaining windows
```

```
## 02:18:11 - Obtaining window counts
```

```
## 02:18:11 - Aggregating features
```
...
```
## 02:18:11 - Computing features for artificial doublets
```

```
## 02:18:11 - Counting overlaps for real cells
```

```
## 02:18:12 - Counting overlaps for artificial doublets
```

```
## 02:18:13 - Scoring network
```

```
## 02:18:13 - Iterative training
```
...
## barcode1    26       1             1 0.90744804      0.5                TRUE
## barcode2    21       0             0        NaN      1.0                TRUE
## barcode3    15       1             1 0.06427441      0.5                TRUE
## barcode4     6       0             0        NaN      0.5                TRUE
## barcode5    27       6             6 1.00000000      1.0                TRUE
##              score
## barcode1 0.2476638
## barcode2 0.2476638
## barcode3 0.2476638
