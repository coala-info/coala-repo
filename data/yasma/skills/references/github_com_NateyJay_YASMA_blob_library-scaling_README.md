...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2FNateyJay%2FYASMA%2Fblob%2Flibrary-scaling%2FREADME.md)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fblob%2Fshow&source=header-repo&source_repo=NateyJay%2FYASMA)
...
[History](/NateyJay/YASMA/commits/library-scaling/README.md)

History

296 lines (185 loc) · 13.9 KB
...
[Raw](https://github.com/NateyJay/YASMA/raw/refs/heads/library-scaling/README.md)
...
[![main logo](/NateyJay/YASMA/raw/library-scaling/images/logo2.png)](/NateyJay/YASMA/blob/library-scaling/images/logo2.png)
...
[Installation](/NateyJay/YASMA/blob/library-scaling/doc/installation.md)
...
* `coverage.bw` and `kernel.bw` - track files associated with the sRNA alignment coverage and padded\_coverage by max() (kernel).
* `regions.gff3` and `revised_regions.gff3` - annotation files of distinct sRNA regions based off the padded\_coverage, and the revision of those r