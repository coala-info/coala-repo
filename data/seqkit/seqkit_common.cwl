...
inputs:
  ...
  - id: by_seq
    ...
    inputBinding:
      position: 101
      prefix: --by-seq
  - id: check_embedded_seqs
    type:
      - 'null'
      - boolean
    doc: check embedded sequences, e.g., if a sequence is part of another one, 
      we'll keep the shorter one
    inputBinding:
      position: 101
      prefix: --check-embedded-seqs
  - id: compress_level
    type:
      - 'null'
      - int
  ...
  - id: only_positive_strand
    type:
      - 'null'
      - boolean
    doc: only considering the positive strand when comparing by sequence
    inputBinding:
      position: 101
