# Data QC - upgraded CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://training.galaxyproject.org
- **Package**: https://workflowhub.eu/workflows/1585
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1585/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 305
...
- **Main workflow (WorkflowHub):** `galaxy-workflow-data-qc.ga` (Main Workflow)
