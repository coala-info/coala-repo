...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fmacs3-project%2FMACS%2Fwiki%2FInstall-macs2)
...
Tao Liu (τν) edited this page May 5, 2015
·
[32 revisions](/macs3-project/MACS/wiki/Install-macs2/_history)
...
|  |
| --- |
| Table of Contents     + [Typical Installation Instructions](#user-content-Typical_Installation_Instructions)   - [Platform](#user-content-Platform)   - [Requirements](#user-content-Requirements)   - [Compile from source code](#user-content-Compile_from_source_code)   - [Easy installation through PyPI](#user-content-Easy_installation_through_PyPI) + [Install MACS2/any Python software into your user space](#user-content-Install_MACS2any_Python_software_into_your_user_space)   - [Manually install Python software to your home directory](#user-content-Manually_install_Python_software_to_your_home_directory)   - [The virtual environment](#user-content-The_virtual_environment) |
...
* Python 2.7 (*Note that Python 2.7.4 has a bug which causes error while reading compressed BAM file'. Fix it according to [this report in MACS user group](https://groups.google.com/d/msg/macs-announcement/ZUPtwaP1xVU/uVUD_xs93sEJ). This bug has been fixed in Python 2.7.5 which was released on 5/12/2013.')*
* [Numpy](http://www.numpy.org) (I recommend you install your own through rpm for Redhat variants or dpkg for Debian variant linux, or install from source code. Although if you are lucky, you can let pip to fix the dependancies.) Note, you need numpy header files to compile MACS2 and some Linux distribution has numpy-dev package separately.
...
* Normally, you need to have root permission to install software. If you want to install MACS2 to your user space, check the section "[Manually install Python software to your home directory](/macs3-project/MACS/wiki/Install-macs2#manually-install-python-software-to-your-home-directory)" for detail.
* Download source code package from [MACS2 page on PyPI](https://pypi.python.org/pypi/MACS2/) then type
