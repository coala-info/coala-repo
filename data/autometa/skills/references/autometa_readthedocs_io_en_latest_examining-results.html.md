...
* Examining Results
* [Edit on GitHub](https://github.com/KwanLab/Autometa/blob/main/docs/source/examining-results.rst)

---

# Examining Results[](#examining-results "Permalink to this heading")

## Automappa[](#automappa "Permalink to this heading")
...
## Visualize bins[](#visualize-bins "Permalink to this heading")
...
![78Mbp_col_contigs](_images/78Mbp_col_contigs.svg)
...
![78Mbp_col_phylum](_images/78Mbp_col_phylum.svg)
...
![78Mbp_col_coverage](_images/78Mbp_col_coverage.svg)
...
[Previous](databases.html "Databases")
[Next](benchmarking.html "Benchmarking")
