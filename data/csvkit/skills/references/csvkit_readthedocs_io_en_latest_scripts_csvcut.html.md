...
[View this page](../_sources/scripts/csvcut.rst.txt "View this page")

# csvcut[¶](#csvcut "Link to this heading")
...
csvcut does not implement row filtering, for this you should pipe data to [csvgrep](csvgrep.html).
...
### Print columns[¶](#print-columns "Link to this heading")
...
### Extract columns[¶](#extract-columns "Link to this heading")
