...
baseCommand:
  - gatk
  - AnnotateIntervals
label: gatk_AnnotateIntervals
doc: Annotates intervals with GC content, mappability, and segmental-duplication
  content
inputs:
  - id: intervals
    type:
  ...
  - id: mappability_track
    type:
      - 'null'
      - File
    doc: Path to Umap single-read mappability track in .bed or .bed.gz format
    inputBinding:
      position: 101
