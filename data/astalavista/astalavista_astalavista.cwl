...
baseCommand: astalavista
label: astalavista_astalavista
doc: "The Barna library comes with a set of tools for alternative splicing analysis.
  AStalavista is the default tool for event retrieval.\n\nTool homepage: https://github.com/divyavewall/astalavista-frontend"
inputs:
  - id: force
    type:
      - 'null'
...
stdout: astalavista_astalavista.out
