...
[Skip to content](#explanation-the-spectrumdataframe)
...
* [x]
  ...
  + [ ]
    ...
    - [Key Features](#key-features)
      ...
      * [Glob Notation Support](#glob-notation-support)
      * [Lazy Loading and Asynchronous Prefetching](#lazy-loading-and-asynchronous-prefetching)
      * [Efficient Shuffling](#efficient-shuffling)
      * [On-the-fly Filtering and Sampling](#on-the-fly-filtering-and-sampling)
