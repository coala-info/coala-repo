...
* [iCNV Vignette](#icnv-vignette)
  + [Maintainer](#maintainer)
  + [1. Website and online forum](#website-and-online-forum)
  + [2. iCNV workflow](#icnv-workflow)
    - [2.1 Install iCNV.](#install-icnv.)
    - [2.2 .bam file normalization using CODEX](#bam-file-normalization-using-codex)
    - [2.3 sequence variants BAF calling](#sequence-variants-baf-calling)
    - [2.4 SNP array LRR normalization and BAF](#snp-array-lrr-normalization-and-baf)
    - [2.5 Mutiple platform CNV detection using **iCNV**](#mutiple-platform-cnv-detection-using-icnv)
    - [2.6 Single platform CNV detection using **iCNV**](#single-platform-cnv-detection-using-icnv)
...
For researchers work on WGS data, you need to generate your own BED file for CODEX normalization. We made a function [bed\_generator](https://github.com/zhouzilu/iCNV/blob/master/R/bed_generator.R) to help you with this.
...
We could further extract variants BAF info from vcf file by function [bambaf\_from\_vcf](https://github.com/zhouzilu/iCNV/blob/master/R/bambaf_from_vcf.R).
...
First row is the rsid (Name), followed by chromosome (Chr) and position (POS), then the log R ratio (sample1.Log R Ratio) and BAF (sample1.B Allele Freq). We could use function [get\_array\_input](https://github.com/zhouzilu/iCNV/blob/master/iCNV_rdoc.pdf) to convert into iCNV input. For example, in demo:
...
##  [1] iCNV_1.30.0                       WES.1KG.WUGSC_1.41.0
##  [3] CODEX_1.42.0                      BSgenome.Hsapiens.UCSC.hg19_1.4.3
...
## [17] data.table_1.17.8           RColorBrewer_1.1-3
## [19] cigarillo_1.0.0             truncnorm_1.0-9
## [21] lifecycle_1.0.4             compiler_4.5.1
## [23] fields_17.1                 codetools_0.2-20
## [25] maps_3.4.3                  htmltools_0.5.8.1
## [27] sass_0.4.10                 RCurl_1.98-1.17
## [29] yaml_2.3.10                 pillar_1.11.1
## [31] crayon_1.5.3                jquerylib_0.1.4
## [33] tidyr_1.3.1                 BiocParallel_1.44.0
## [35] DelayedArray_0.36.0         cachem_1.1.0
## [37] abind_1.4-8                 tidyselect_1.2.1
## [39] digest_0.6.37               purrr_1.1.0
...
## [49] XML_3.99-0.19               withr_3.0.2
## [51] UCSC.utils_1.6.0            rmarkdown_2.30
