...
chromFa.tar.gz from http://hgdownload.cse.ucsc.edu/goldenPath/galGal3/bigZips/
...
txdb <- makeTranscriptDbFromUCSC("galGal3", "refGene")
gn <- sort(genes(txdb))
...
BSgenome.Ggallus.UCSC.galGal3, 1
...
BSgenome, 1
BSgenome.Ggallus.UCSC.galGal3, 1
BSgenome.Ggallus.UCSC.galGal3-package
