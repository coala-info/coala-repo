...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fbaoxingsong%2FAnchorWave%2Fblob%2Fmaster%2Fconfigure)
...
[History](/baoxingsong/AnchorWave/commits/master/configure)
...
[Raw](https://github.com/baoxingsong/AnchorWave/raw/refs/heads/master/configure)
...
transcript\_to\_gene\_regex\_reference\_gff [\s\S]\*?CDS[\s\S]\*?Parent=((\S\*?)\.\d+)

#regular to parse additional gff file. Get the map from transcript id to gene id

transcript\_to\_gene\_regex\_novo\_gff transcript[\s\S]\*?ID=(\S\*?);Parent=(\S+)
