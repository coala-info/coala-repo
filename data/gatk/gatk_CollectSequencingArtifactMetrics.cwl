...
label: gatk_CollectSequencingArtifactMetrics
...
inputs:
  ...
  - id: output
    type: string
    doc: The file to write the output to. This tool produces four files (summary
      and detail metrics for both pre-adapter and bait-bias) using this as a 
      base name.
    inputBinding:
      position: 101
      prefix: --OUTPUT
