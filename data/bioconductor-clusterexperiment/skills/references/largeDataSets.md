...
* [1 Avoid NxN matrices](#avoid-nxn-matrices)
  + [1.1 Choice of Clustering Routine](#choice-of-clustering-routine)
  + [1.2 Subsampling and Consensus clustering](#subsampling-and-consensus-clustering)
    - [1.2.1 Technical details](#technical-details)
* [2 Data in Memory versus HDF5](#data-in-memory-versus-hdf5)

# 1 Avoid NxN matrices
...
## 1.1 Choice of Clustering Routine
...
## 1.2 Subsampling and Consensus clustering
