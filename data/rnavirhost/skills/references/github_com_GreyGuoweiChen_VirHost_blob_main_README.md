...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2FGreyGuoweiChen%2FVirHost%2Fblob%2Fmain%2FREADME.md)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fblob%2Fshow&source=header-repo&source_repo=GreyGuoweiChen%2FVirHost)
...
1. [VirHost](/GreyGuoweiChen/VirHost/tree/main)
...
[History](/GreyGuoweiChen/VirHost/commits/main/README.md)

History

110 lines (81 loc) · 6.11 KB
...
[Raw](https://github.com/GreyGuoweiChen/VirHost/raw/refs/heads/main/README.md)
...
|  | y|virus order |
| --- | --- |
| NC\_000858.1 | Ortervirales |
| NC\_019922.1 | Norzivirales |
| ... | ... |
...
| --- | --- | --- | --- | --- |
| NC\_000858.1 | Ortervirales | Chordata | Primates | pred\_high\_confidence |
| NC\_001426.1 | Norzivirales | Bacteria |  | assign |
| ... | ... | ... | ... | ... |

The evidence list has 5 labels, including **pred\_high\_confidence**, **pred\_low\_confidence**, **assign**, **BLASTn**, and **unclassified**. The "pred" prefix represent that the prediction is made by the learning model. If the prediction score is higher than the built-in score cutoff, we regard it as a high-confidence prediction and thus give "pred\_high\_confidence"; otherwise, we will give "pred\_low\_confidence". The "assign" evidence means that the reference viruses in the same order with the query virus infect a specific host group. So we assign the host group to the virus order without prediction.
