...
* [Help and citations](#help-and-citations)
  + [How to get help](#how-to-get-help)
  + [How to cite ICETEA](#how-to-cite-icetea)
* [The CapSet object](#the-capset-object)
* [Analysis workflow](#analysis-workflow)
  + [De-multiplexing the fastq](#de-multiplexing-the-fastq)
  + [Mapping the fastqs](#mapping-the-fastqs)
  + [(optional) Post mapping de-multiplexing](#optional-post-mapping-de-multiplexing)
  + [Filtering PCR duplicates](#filtering-pcr-duplicates)
  + [Detection of TSS](#detection-of-tss)
* [Plotting and QC](#plotting-and-qc)
* [Differential TSS expression analysis](#differential-tss-expression-analysis)
  + [Using spike-In controls](#using-spike-in-controls)
* [Additional useful functions](#additional-useful-functions)
  + [Getting the gene counts](#getting-the-gene-counts)
  + [Annotating the TSS distribution](#annotating-the-tss-distribution)
...
dir.create("removedup")
cs <- filterDuplicates(cs, outdir = "removedup")
#> Removing PCR duplicates : /tmp/RtmpnjaPL5/Rinstec9b92896c4ed/icetea/extdata/bam/embryo1.bam
#> Removing PCR duplicates : /tmp/RtmpnjaPL5/Rinstec9b92896c4ed/icetea/extdata/bam/embryo2.bam
#> Removing PCR duplicates : /tmp/RtmpnjaPL5/Rinstec9b92896c4ed/icetea/extdata/bam/embryo3.bam
#> Removing PCR duplicates : /tmp/RtmpnjaPL5/Rinstec9b92896c4ed/icetea/extdata/bam/embryo4.bam
```

Tagging of read IDs using the random barcodes and subsequent removal of PCR duplicates can also be performed using the command line tools, like [UMItools](https://github.com/CGATOxford/UMI-tools).
...
#> ℹ The deprecated feature was likely used in the icetea package.
#>   Please report the issue at <https://github.com/vivekbhr/icetea/issues>.
...
The functions `fitDiffTSS` and `detectDiffTSS` utilize [edgeR](http://bioconductor.org/packages/release/bioc/html/edgeR.html) (Robinson, McCarthy, and Smyth 2010) to perform differential TSS expression analysis.
...
Batut, Philippe, Alexander Dobin, Charles Plessy, Piero Carninci, and Thomas R Gingeras. 2013. “High-Fidelity Promoter Profiling Reveals Widespread Alternative Promoter Usage and Transposon-Driven Developmental Gene Expression.” *Genome Research* 23 (1): 169–80.

Kodzius, Rimantas, Miki Kojima, Hiromi Nishiyori, Mari Nakamura, Shiro Fukuda, Michihira Tagami, Daisuke Sasaki, et al. 2006. “CAGE: Cap Analysis of Gene Expression.” *Nature Methods* 3 (3): 211.

Liao, Yang, Gordon K Smyth, and Wei Shi. 2013. “The Subread Aligner: Fast, Accurate and Scalable Read Mapping by Seed-and-Vote.” *Nucleic Acids Research* 41 (10): e108–e108.
