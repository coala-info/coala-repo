...
baseCommand:
  ...
  - seqvars
label: varfish-server-worker_seqvars
doc: "Sequence variant related commands\n\nTool homepage: https://github.com/bihealth/varfish-server-worker"
inputs:
  - id: command
    type: string
    doc: Command to run (aggregate, ingest, prefilter, query, help)
    inputBinding:
      position: 1
  - id: quiet
    type:
...
stdout: varfish-server-worker_seqvars.out
