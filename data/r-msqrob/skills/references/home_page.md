...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2FstatOmics%2FMSqRob)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E&source=header-repo&source_repo=statOmics%2FMSqRob)
...
[statOmics](/statOmics)
/
**[MSqRob](/statOmics/MSqRob)**
Public

* [Notifications](/login?return_to=%2FstatOmics%2FMSqRob) You must be signed in to change notification settings
* [Fork
  10](/login?return_to=%2FstatOmics%2FMSqRob)
* [Star
   33](/login?return_to=%2FstatOmics%2FMSqRob)

Robust statistical inference for quantitative LC-MS proteomics

### License

[View license](/statOmics/MSqRob/blob/master/LICENSE)

[33
stars](/statOmics/MSqRob/stargazers) [10
forks](/statOmics/MSqRob/forks) [Branches](/statOmics/MSqRob/branches) [Tags](/statOmics/MSqRob/tags) [Activity](/statOmics/MSqRob/activity)

[Star](/login?return_to=%2FstatOmics%2FMSqRob)

[Notifications](/login?return_to=%2FstatOmics%2FMSqRob) You must be signed in to change notification settings

* [Code](/statOmics/MSqRob)
* [Issues
  3](/statOmics/MSqRob/issues)
* [Pull requests
  0](/statOmics/MSqRob/pulls)
* [Actions](/statOmics/MSqRob/actions)
* [Projects
  0](/statOmics/MSqRob/projects)
* [Security
  0](/statOmics/MSqRob/security)
* [Insights](/statOmics/MSqRob/pulse)

Additional navigation options

* [Code](/statOmics/MSqRob)
* [Issues](/statOmics/MSqRob/issues)
* [Pull requests](/statOmics/MSqRob/pulls)
* [Actions](/statOmics/MSqRob/actions)
* [Projects](/statOmics/MSqRob/projects)
* [Security](/statOmics/MSqRob/security)
* [Insights](/statOmics/MSqRob/pulse)
...
[Branches](/statOmics/MSqRob/branches)[Tags](/statOmics/MSqRob/tags)
...
| --- | --- | --- | --- | --- |
| Latest commit   History[516 Commits](/statOmics/MSqRob/commits/master/)   516 Commits | | |
| [R](/statOmics/MSqRob/tree/master/R "R") | | [R](/statOmics/MSqRob/tree/master/R "R") |  |  |
| [inst/App-MSqRob](/statOmics/MSqRob/tree/master/inst/App-MSqRob "This path skips through empty directories") | | [inst/App-MSqRob](/statOmics/MSqRob/tree/master/inst/App-MSqRob "This path skips through empty directories") |  |  |
| [man](/statOmics/MSqRob/tree/master/man "man") | | [man](/statOmics/MSqRob/tree/master/man "man") |  |  |
| [vignettes](/statOmics/MSqRob/tree/master/vignettes "vignettes") | | [vignettes](/statOmics/MSqRob/tree/master/vignettes "vignettes") |  |  |
| [CHANGELOG.md](/statOmics/MSqRob/blob/master/CHANGELOG.md "CHANGELOG.md") | | [CHANGELOG.md](/statOmics/MSqRob/blob/master/CHANGELOG.md "CHANGELOG.md") |  |  |
| [DESCRIPTION](/statOmics/MSqRob/blob/master/DESCRIPTION "DESCRIPTION") | | [DESCRIPTION](/statOmics/MSqRob/blob/master/DESCRIPTION "DESCRIPTION") |  |  |
| [LICENSE](/statOmics/MSqRob/blob/master/LICENSE "LICENSE") | | [LICENSE](/statOmics/MSqRob/blob/master/LICENSE "LICENSE") |  |  |
| [MSqRob.Rproj](/statOmics/MSqRob/blob/master/MSqRob.Rproj "MSqRob.Rproj") | | [MSqRob.Rproj](/statOmics/MSqRob/blob/master/MSqRob.Rproj "MSqRob.Rproj") |  |  |
| [NAMESPACE](/statOmics/MSqRob/blob/master/NAMESPACE "NAMESPACE") | | [NAMESPACE](/statOmics/MSqRob/blob/master/NAMESPACE "NAMESPACE") |  |  |
| [README.md](/statOmics/MSqRob/blob/master/README.md "README.md") | | [README.md](/statOmics/MSqRob/blob/master/README.md "README.md") |  |  |
| View all files | | |
...
To start MSqRob, first unzip the zip file and then doubleclick the file "run\_MSqRob.vbs" in the "dist" folder.
...
If you encounter any issues in installing MSqRob, please let us know at [#1](https://github.com/statOmics/MSqRob/issues/1)!
...
A tutorial on using the MSqRob Shiny App can be found in Goeminne et al. (2017). For the *Francisella* example, one finds the peptides.txt file, the experimental annotation file (label-free\_Francisella\_annotation.xlsx) and the proteinGroups.txt file under <https://github.com/statOmics/MSqRobData/blob/master/inst/extdata/Francisella/>. For the CPTAC example, these files can be found under <https://github.com/statOmics/MSqRobData/tree/master/inst/extdata/CPTAC> (use label-free\_CPTAC\_annotation.xlsx as the experimental annotation file).
...
[Activity](/statOmics/MSqRob/activity)

[Custom properties](/statOmics/MSqRob/custom-properties)

### Stars

[**33**
stars](/statOmics/MSqRob/stargazers)

### Watchers

[**2**
watching](/statOmics/MSqRob/watchers)

### Forks

[**10**
forks](/statOmics/MSqRob/forks)

[Report repository](/contact/report-content?content_url=https%3A%2F%2Fgithub.com%2FstatOmics%2FMSqRob&report=statOmics+%28user%29)

## [Releases 7](/statOmics/MSqRob/releases)

[MSqRob 0.7.7 standalone for Windows

Latest

May 11, 2021](/statOmics/MSqRob/releases/tag/MSqRob_standalone_Win_0.7.7)

[+ 6 releases](/statOmics/MSqRob/releases)

## [Packages 0](/orgs/statOmics/packages?repo_name=MSqRob)

No packages published

## [Contributors 4](/statOmics/MSqRob/graphs/contributors)
...
* [HTML
  52.6%](/statOmics/MSqRob/search?l=html)
* [R
  36.3%](/statOmics/MSqRob/search?l=r)
* [CSS
  11.0%](/statOmics/MSqRob/search?l=css)
* [JavaScript
  0.1%](/statOmics/MSqRob/search?l=javascript)
