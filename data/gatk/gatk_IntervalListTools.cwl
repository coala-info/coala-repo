...
inputs:
  ...
  - id: action
    type:
      - 'null'
      - string
    doc: 'Action to take on inputs. Options: CONCAT, UNION, INTERSECT, SUBTRACT, SYMDIFF,
      OVERLAPS.'
    inputBinding:
      position: 101
      prefix: --ACTION
  ...
  - id: output_value
    type:
      - 'null'
      - string
    doc: What value to output to COUNT_OUTPUT file or stdout (for scripting).
    inputBinding:
      position: 101
      prefix: --OUTPUT_VALUE
  - id: padding
