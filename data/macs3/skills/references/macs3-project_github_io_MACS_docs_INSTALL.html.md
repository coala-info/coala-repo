...
* INSTALL Guide For MACS3
  + [Prerequisites](#prerequisites)
    - [Python3](#python3)
    - [NumPy, hmmlearn, Scipy, scikit-learn](#numpy-hmmlearn-scipy-scikit-learn)
    - [Cython](#cython)
    - [cykhash](#cykhash)
    - [fermi-lite and simde](#fermi-lite-and-simde)
    - [GCC, Python-dev, meson …](#gcc-python-dev-meson)
  + [Prepare a virtual Python environment](#prepare-a-virtual-python-environment)
  + [Install through PyPI](#install-through-pypi)
  + [Install through conda](#install-through-conda)
  + [Install from source through pip](#install-from-source-through-pip)
...
* INSTALL Guide For MACS3
* [View page source](../_sources/docs/INSTALL.md.txt)

---

# INSTALL Guide For MACS3[](#install-guide-for-macs3 "Link to this heading")
...
### Python3[](#python3 "Link to this heading")

MACS v3 requires Python3. We have tested MACS in Python3.9 to 3.12.

### NumPy, hmmlearn, Scipy, scikit-learn[](#numpy-hmmlearn-scipy-scikit-learn "Link to this heading")
...
### cykhash[](#cykhash "Link to this heading")
...
### fermi-lite and simde[](#fermi-lite-and-simde "Link to this heading")
...
### GCC, Python-dev, meson …[](#gcc-python-dev-meson "Link to this heading")
...
## Prepare a virtual Python environment[](#prepare-a-virtual-python-environment "Link to this heading")
...
## Install through PyPI[](#install-through-pypi "Link to this heading")
...
## Install through conda[](#install-through-conda "Link to this heading")

To install MACS3 using ‘conda’, simply execute `conda install -c bioconda macs3` in your conda environment. This command installs MACS3
...
## Install from source through pip[](#install-from-source-through-pip "Link to this heading")
...
repository with `git clone --recurse-submodules  https://github.com/macs3-project/MACS.git`. Go to the directory where you
...
[Previous](../index.html "MACS: Model-based Analysis for ChIP-Seq")
[Next](subcommands_index.html "Subcommands")
