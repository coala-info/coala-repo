...
* ←
  [4.1. Visualizing the relationship of SNPs and generic genomic features](snp-visualization.html "Previous document")
* [4.3. Measuring the frequency of signed distances between SNPs and nearest DHSes](distance-frequencies.html "Next document")
  →

* [Home](../../index.html)
* [4. Usage examples](../usage-examples.html)

# 4.2. Collapsing multiple BED files into a master list by signal[¶](#collapsing-multiple-bed-files-into-a-master-list-by-signal "Permalink to this headline")
...
## 4.2.1. BEDOPS tools in use[¶](#bedops-tools-in-use "Permalink to this headline")

In the following example, we want to merge hotspot peaks for five fetal adrenal tissues, picking the highest scoring element where there are overlapping peaks. We’ll use a mix of [bedmap](../reference/statistics/bedmap.html#bedmap) and its `--max-element` operation with [bedops](../reference/set-operations/bedops.html#bedops) set operations to accomplish this.

## 4.2.2. Script[¶](#script "Permalink to this headline")
...
## 4.2.3. Discussion[¶](#discussion "Permalink to this headline")
...
* 4.2. Collapsing multiple BED files into a master list by signal
  + [4.2.1. BEDOPS tools in use](#bedops-tools-in-use)
  + [4.2.2. Script](#script)
  + [4.2.3. Discussion](#discussion)
