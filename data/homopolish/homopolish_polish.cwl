...
baseCommand:
  - homopolish
  - polish
label: homopolish_polish
doc: "Homopolish is a tool for polishing genome assemblies using homologous sequences.\n\
...
inputs:
  ...
  - id: model_path
    type: File
    doc: Path to a trained model (pkl file). Please see our github page to see 
      options.
    inputBinding:
      position: 101
      prefix: --model_path
