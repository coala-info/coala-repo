...
inputs:
  - id: analysis_directory
    type:
      - 'null'
      - Directory
    doc: Directory to scan for analysis results
    inputBinding:
      position: 1
  - id: affix_type
    type:
  ...
  - id: condition
    type:
      - 'null'
      - string
    doc: Create conditions from provided (e.g., factor) columns.
    inputBinding:
      position: 102
      prefix: --condition
  - id: config
  ...
  - id: dirs_depth
    ...
    inputBinding:
      position: 102
      prefix: --dirs-depth
  - id: disable_hoverinfo
    type:
      - 'null'
      - boolean
    doc: Disable hoverinfo
    inputBinding:
      position: 102
      prefix: --disable-hoverinfo
  - id: disable_table
    type:
      - 'null'
      - boolean
    doc: disable protein/peptide table plots for large dataset
    inputBinding:
      position: 102
      prefix: --disable-table
  - id: exclude
    type:
      - 'null'
      - type: array
  ...
  - id: fragpipe_plugin
    type:
      - 'null'
      - boolean
    doc: Enable FragPipe plugin
    inputBinding:
      position: 102
      prefix: --fragpipe-plugin
  - id: fullnames
    type:
      - 'null'
      - boolean
  ...
  - id: ignored_idxml
    type:
      - 'null'
      - boolean
    doc: ignored idxml files for faster running
    inputBinding:
      position: 102
      prefix: --ignored-idxml
  - id: interactive
    type:
      - 'null'
      - boolean
  ...
  - id: maxquant_plugin
    type:
      - 'null'
      - boolean
    doc: Enable MaxQuant plugin
    inputBinding:
      position: 102
      prefix: --maxquant-plugin
  - id: module
    type:
      - 'null'
      - type: array
  ...
  - id: proteobench_plugin
    type:
      - 'null'
      - boolean
    doc: Enable ProteoBench plugin
    inputBinding:
      position: 102
      prefix: --proteobench-plugin
  - id: quantification_method
    type:
      - 'null'
      - string
  ...
  - id: quantms_plugin
    type:
      - 'null'
      - boolean
    doc: Enable quantms plugin
    inputBinding:
      position: 102
      prefix: --quantms-plugin
  - id: quiet
    type:
      - 'null'
      - boolean
