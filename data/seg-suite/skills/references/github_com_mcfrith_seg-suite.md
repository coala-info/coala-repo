...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fmcfrith%2Fseg-suite)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E&source=header-repo&source_repo=mcfrith%2Fseg-suite)
...
[Branches](/mcfrith/seg-suite/branches)[Tags](/mcfrith/seg-suite/tags)
...
| --- | --- | --- | --- | --- |
| Latest commit   History[99 Commits](/mcfrith/seg-suite/commits/master/)   99 Commits | | |
| [bin](/mcfrith/seg-suite/tree/master/bin "bin") | | [bin](/mcfrith/seg-suite/tree/master/bin "bin") |  |  |
| [test](/mcfrith/seg-suite/tree/master/test "test") | | [test](/mcfrith/seg-suite/tree/master/test "test") |  |  |
| [.gitattributes](/mcfrith/seg-suite/blob/master/.gitattributes ".gitattributes") | | [.gitattributes](/mcfrith/seg-suite/blob/master/.gitattributes ".gitattributes") |  |  |
| [.gitignore](/mcfrith/seg-suite/blob/master/.gitignore ".gitignore") | | [.gitignore](/mcfrith/seg-suite/blob/master/.gitignore ".gitignore") |  |  |
| [COPYING.txt](/mcfrith/seg-suite/blob/master/COPYING.txt "COPYING.txt") | | [COPYING.txt](/mcfrith/seg-suite/blob/master/COPYING.txt "COPYING.txt") |  |  |
| [Makefile](/mcfrith/seg-suite/blob/master/Makefile "Makefile") | | [Makefile](/mcfrith/seg-suite/blob/master/Makefile "Makefile") |  |  |
| [README.rst](/mcfrith/seg-suite/blob/master/README.rst "README.rst") | | [README.rst](/mcfrith/seg-suite/blob/master/README.rst "README.rst") |  |  |
| [mcf\_string\_view.hh](/mcfrith/seg-suite/blob/master/mcf_string_view.hh "mcf_string_view.hh") | | [mcf\_string\_view.hh](/mcfrith/seg-suite/blob/master/mcf_string_view.hh "mcf_string_view.hh") |  |  |
| [seg-import.cc](/mcfrith/seg-suite/blob/master/seg-import.cc "seg-import.cc") | | [seg-import.cc](/mcfrith/seg-suite/blob/master/seg-import.cc "seg-import.cc") |  |  |
| [seg-join.cc](/mcfrith/seg-suite/blob/master/seg-join.cc "seg-join.cc") | | [seg-join.cc](/mcfrith/seg-suite/blob/master/seg-join.cc "seg-join.cc") |  |  |
| View all files | | |
...
| `-x PERCENT` | This tells seg-join to output each