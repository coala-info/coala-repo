...
baseCommand:
  - binchicken
  - coassemble
label: binchicken_coassemble
doc: "Perform co-assembly of multiple samples.\n\nTool homepage: https://github.com/aroneys/binchicken"
inputs:
  - id: abundance_weighted
    type:
      - 'null'
      - boolean
    doc: Perform abundance-weighted co-assembly.
    inputBinding:
      position: 101
  ...
  - id: abundance_weighted_samples
    type:
      ...
      - type: array
        items: string
    doc: List of samples to use for abundance weighting.
    inputBinding:
      position: 101
  ...
  - id: abundance_weighted_samples_list
    type:
      - 'null'
      - File
    doc: File containing a list of samples for abundance weighting.
    inputBinding:
      position: 101
  ...
  - id: anchor_samples
    type:
      ...
      - type: array
        items: string
    doc: List of sample names to use as anchors for co-assembly.
    inputBinding:
      position: 101
  ...
  - id: anchor_samples_list
    type:
      - 'null'
      - File
    doc: File containing a list of anchor sample names for co-assembly.
    inputBinding:
      position: 101
  ...
  - id: appraise_sequence_identity
    type:
      - 'null'
      - float
    doc: Minimum sequence identity for appraising.
    inputBinding:
      position: 101
  ...
  - id: coassembly_samples
    type:
      ...
      - type: array
        items: string
    doc: List of sample names to include in the co-assembly.
    inputBinding:
      position: 101
  ...
  - id: coassembly_samples_list
    type:
      - 'null'
      - File
    doc: File containing a list of sample names for co-assembly.
    inputBinding:
      position: 101
  ...
  - id: download_limit
    type:
      - 'null'
      - int
    doc: Limit for downloading data.
    inputBinding:
      position: 101
  ...
  - id: exclude_coassemblies
    type:
      ...
      - type: array
        items: string
    doc: List of coassemblies to exclude.
    inputBinding:
      position: 101
  ...
  - id: exclude_coassemblies_list
    type:
      - 'null'
      - File
    doc: File containing a list of coassemblies to exclude.
    inputBinding:
      position: 101
  ...
  - id: max_coassembly_samples
    type:
      - 'null'
      - int
    doc: Maximum number of samples to include in any coassembly.
    inputBinding:
      position: 101
  ...
  - id: max_coassembly_size
    type:
      - 'null'
      - int
    doc: Maximum size of a coassembly.
    inputBinding:
      position: 101
  ...
  - id: max_recovery_samples
    type:
      - 'null'
      - int
    doc: Maximum number of samples to consider for recovery.
    inputBinding:
      position: 101
  ...
  - id: max_sample_combinations
    type:
      - 'null'
      - int
    doc: Maximum number of sample combinations to test.
    inputBinding:
      position: 101
  ...
  - id: num_coassembly_samples
    type:
      - 'null'
      - int
    doc: Number of samples to include in each coassembly.
    inputBinding:
      position: 101
  ...
  - id: precluster_distances
    type:
      - 'null'
      - float
    doc: Distances for k-mer preclustering.
    inputBinding:
      position: 101
  ...
  - id: precluster_size
    type:
      - 'null'
      - int
    doc: Size for k-mer preclustering.
    inputBinding:
      position: 101
  ...
  - id: prodigal_meta
    type:
      - 'null'
      - boolean
    doc: Use Prodigal for metagenomic gene prediction.
    inputBinding:
      position: 101
  ...
  - id: sample_query
    type:
      ...
      - type: array
        items: string
    doc: List of sample names to query.
    inputBinding:
      position: 101
      prefix: --sample-query
  - id: sample_query_dir
    type:
      - 'null'
      - Directory
    doc: Directory containing query sample data.
    inputBinding:
      position: 101
  ...
  - id: sample_query_list
    type:
      - 'null'
      - File
    doc: File containing a list of sample names to query.
    inputBinding:
      position: 101
  ...
  - id: sample_read_size
    type:
      - 'null'
      - int
    doc: Size of reads to sample for each sample.
    inputBinding:
      position: 101
  ...
  - id: sample_singlem
    type:
      ...
      - type: array
        items: string
    doc: List of sample names for SingleM analysis.
    inputBinding:
      position: 101
  ...
  - id: sample_singlem_list
    type:
      - 'null'
      - File
    doc: File containing a list of sample names for SingleM analysis.
    inputBinding:
      position: 101
  ...
  - id: single_assembly
    type:
      - 'null'
      - boolean
    doc: Perform a single assembly instead of multiple.
    inputBinding:
      position: 101
  ...
  - id: unmapping_max_alignment
    type:
      - 'null'
      - float
    doc: Maximum alignment score for unmapped reads.
    inputBinding:
      position: 101
  ...
  - id: unmapping_max_identity
    type:
      - 'null'
      - float
    doc: Maximum identity for unmapped read alignment.
    inputBinding:
      position: 101
  ...
  - id: unmapping_min_appraised
    type:
      - 'null'
      - float
    doc: Minimum appraised value for unmapped reads.
    inputBinding:
      position: 101
