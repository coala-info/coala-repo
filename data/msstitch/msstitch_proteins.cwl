...
baseCommand: msstitch proteins
label: msstitch_proteins
doc: "Processes protein quantification data, including isobaric labeling and FDR calculation.\n\
...
inputs:
  ...
  - id: fdr_type
    type:
      - 'null'
      - string
    doc: FDR strategy type used. Can be one of [picked, classic]. Picked FDR is 
  ...
  - id: input_file
    ...
    inputBinding:
      position: 101
      prefix: -i
  - id: isobaric_quant_column_pattern
    type:
      - 'null'
      - string
