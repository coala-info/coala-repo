...
* [cath-resolve-hits](./)
  ...
  + [Warning](#warning)
  + [How Fast?](#how-fast)
  + [CATH Rules invoked by option --apply-cath-rules](#cath-rules-invoked-by-option-apply-cath-rules)
    - [Discontinuous domains](#discontinuous-domains)
    - [Bitscore reductions](#bitscore-reductions)
  + [Feedback](#feedback)
* [cath-ssap](../cath-ssap/)
...
1. **query\_protein\_id** : An identifier for the query protein sequence
2. **match\_id** : An identifier for the match
3. **score** : A (strictly positive) score indicating how good it would be to have that hit in the final result
4. **starts\_stops** : The starts/stops on the query sequence, given in the format: 37–124,239–331
...
* ignore gaps when parsing an alignment from a hmmsearch\_outfile (ie keep the hit as one continuous segment).
...
[Previous](../cath-map-clusters/ "cath-map-clusters")
[Next](../cath-ssap/ "cath-ssap")
