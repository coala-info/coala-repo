...
Package on Bioconductor: *[excluderanges](https://bioconductor.org/packages/3.22/excluderanges)*.
...
[Blacklist](https://github.com/Boyle-Lab/Blacklist/tree/master/lists) (Amemiya, Kundaje, and Boyle [2019](#ref-Amemiya:2019aa)),
[Peakpass](https://github.com/ewimberley/peakPass/tree/main/excludedlists) (Wimberley and Heber [2019](#ref-Wimberley:2019ub)),
[Greenscreen](https://github.com/sklasfeld/GreenscreenProject/tree/main/data) (Klasfeld and Wagner [2022](#ref-Klasfeld2022-nn)).
...
## 2.1 Compare the number of excludable regions
...
## 2.2 Compare the width of excludable regions
...
## 2.3 Compare overlaps among sets
...
# 3 Mitochondrial DNA sequences, NUMTs
...
It can be retrieved from *[AnnotationHub](https://bioconductor.org/packages/3.22/AnnotationHub)*, but lacks
...
# 5 CUT&RUN excludable sets

Nordin et al. 2022 (Nordin et al. [2022](#ref-nordin2022cut)) generated excludable regions for the CUT&RUN
...
| hg38.Kundaje.GRCh38\_unified\_Excludable | AH107305 | Defined as a combination of hg38.Lareau.hg38\_peaks, hg38.Boyle.hg38-Excludable.v2, and hg38.Wimberley.peakPass60Perc\_sorted, followed by manual curation. Supersedes hg38.Kundaje.GRCh38.Excludable. | 910 |
| hg38.Bernstein.Mint\_Excludable\_GRCh38 | AH107306 | Defined from Mint-ChIP (low input, multiplexed ChIP-seq) data | 12052 |
...
| hg38.Wimberley.peakPass60Perc\_sorted | AH107311 | Defined by the ewimberley/peakPass software | 5078 |
| hg38.Wold.hg38mitoExcludable | AH107312 | Definition method unknown | 299 |
| hg38.Yeo.eCLIP\_Excludableregions.hg38liftover.bed.fixed | AH107313 | Defined from eCLIP data | 56 |
| hg38.Nordin.CandRblacklist\_hg38 | NA | Defined from CUT&RUN negative controls as 0.1% top significant SEACR peaks in over 30% of samples | 885 |
...
| hg19.Bernstein.Mint\_Excludable\_hg19 | AH107315 | Defined from Mint-ChIP (low input, multiplexed ChIP-seq) data | 9035 |
...
| hg19.Crawford.wgEncodeDukeMapabilityRegionsExcludable | AH107317 | Defined by the ENCODE consortium, includes satellite repeats (CATTC, GAATG, GAGTG, ACRO1), RepeatMasker repeats (ALR/Alpha, BSR/Beta), human satellite repeat HSATII, chrM, ribosomal subunit consensus sequences LSU-rRNA\_Hsa, SSU-rRNA\_Hsa. Has extra chromosomes, use keepStandardChromosomes() filtering | 1566 |
...
| hg19.Yeo.eCLIP\_Excludableregions.hg19 | AH107320 | Defined from eCLIP data, includes skyscraper, rRNA pseudogene, unreliably mapped satellite repeat, and low complexity skyscraper peak regions | 57 |
...
| mm10.Nordin.CandRblacklist\_mm10 | NA | Defined from CUT&RUN negative controls as 0.1% top significant SEACR peaks in over 30% of samples | 559 |
...
| danRer10.Yang.Supplemental\_Table\_19.ChIP-seq\_black\_list\_in\_the\_zebrafish\_genome | AH107335 | Defined via MACS2 peak calling using ChIP-seq (PMID: 33239788) | 853 |
...
| TAIR10.Wimberley.predicted\_excluded\_list\_sorted\_0.6 | AH107339 | Defined by the ewimberley/peakPass software | 887 |
| TAIR10.Klasfeld.arabidopsis\_Excludable\_20inputs | AH107340 | Defined by the Boyle-Lab/Blacklist software, High Signal and Low Mappability regions (DOI: 10.1101/2022.02.27.482177) | 83 |
| TAIR10.Klasfeld.arabidopsis\_greenscreen\_20inputs | AH107341 | Defined by the green screen pipeline (DOI: 10.1101/2022.02.27.482177) | 36 |
| T2T.Lareau.chm13v2.0\_peaks | AH107342 | Regions of high homology to mtDNA (NUMT regions) defined by caleblareau/mitoblacklist | 817 |
| hg38.Lareau.hg38\_peaks | AH107343 | Regions of high homology to mtDNA (NUMT regions) defined by caleblareau/mitoblacklist | 784 |
| hg19.Lareau.hg19\_peaks | AH107344 | Regions of high homology to mtDNA (NUMT regions) defined by caleblareau/mitoblacklist | 779 |
| mm10.Lareau.mm10\_peaks | AH107345 | Regions of high homology to mtDNA (NUMT regions) defined by caleblareau/mitoblacklist | 387 |
| mm9.Lareau.mm9\_peaks | AH107346 | Regions of high homology to mtDNA (NUMT regions) defined by caleblareau/mitoblacklist | 395 |
...
| T2T.CHM13.chm13.draft\_v2.0.cen\_mask | AH107349 | Centromeric satellite masking bed file (v2.0) | 23 |
| T2T.CHM13.chm13.draft\_v1.1.telomere | AH107350 | Telomere identified by the VGP pipeline (v1.1) | 48 |
...
| hg38.UCSC.short\_arm | AH107356 | Gaps on the short arm of the chromosome | 5 |
...
| hg19.UCSC.short\_arm | AH107362 | Gaps on the short arm of the chromosome | 5 |
...
| mm39.UCSC.short\_arm | AH107369 | Gaps on the short arm of the chromosome | 21 |
...
| mm10.UCSC.short\_arm | AH107374 | Gaps on the short arm of the chromosome | 21 |
...
| mm10.UCSC.fragment | AH107379 | A single gap of 31 bases in chrX\_GL456233\_random | 0 |
...
run this yourself to check for any updates on how to cite **excluderanges**.
...
#>     note = {https://github.com/dozmorovlab/excluderanges/excluderanges - R package version 0.99.10},
#>   }
```
...
#>  [7] GenomeInfoDb_1.45.10 AnnotationHub_3.99.6 BiocFileCache_2.99.6
...
#>  [9] GenomicAlignments_1.45.2    XML_3.99-0.19
...
#> [21] knitr_1.50                  S4Arrays_1.9.1
#> [23] labeling_0.4.3              bit_4.6.0
#> [25] curl_7.0.0                  DelayedArray_0.35.2
#> [27] RColorBrewer_1.1-3          abind_1.4-8
#> [29] BiocParallel_1.43.4         withr_3.0.2
#> [31] purrr_1.1.0                 grid_4.5.1
#> [33] scales_1.4.0                SummarizedExperiment_1.39.1
...
#> [45] AnnotationDbi_1.71.1        BiocManager_1.30.26
#> [47] XVector_0.49.0              restfulr_0.0.16
#> [49] matrixStats_1.5.0           vctrs_0.6.5
#> [51] Matrix_1.7-3                jsonlite_2.0.0
#> [53] bookdown_0.44               bit64_4.6.0-1
#> [55] excluderanges_0.99.10       magick_2.8.7
#> [57] jquerylib_0.1.4             glue_1.8.0
#> [59] codetools_0.2-20            stringi_1.8.7
#> [61] gtable_0.3.6                BiocVersion_3.22.0
#> [63] BiocIO_1.19.0               UCSC.utils_1.5.0
#> [65] tibble_3.3.0                pillar_1.11.0
#> [67] rappdirs_0.3.3              htmltools_0.5.8.1
#> [69] R6_2.6.1                    httr2_1.2.1
#> [71] lattice_0.22-7              evaluate_1.0.4
#> [73] Biobase_2.69.0              png_0.1-8
#> [75] Rsamtools_2.25.2            memoise_2.0.1
#> [77] bslib_0.9.0                 Rcpp_1.1.0
#> [79] SparseArray_1.9.1           xfun_0.53
#> [81] MatrixGenerics_1.21.0       pkgconfig_2.0.3
```
