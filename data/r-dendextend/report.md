...
### Metadata
- **Conda**: https://anaconda.org/channels/r/packages/r-dendextend/overview
- **R-project (CRAN)**: https://cloud.r-project.org/web/packages/dendextend/index.html
- **Home (project)**: http://talgalili.github.io/dendextend/, https://github.com/talgalili/dendextend/, https://cran.r-project.org/package=dendextend, https://www.r-statistics.com/tag/dendextend/, https://academic.oup.com/bioinformatics/article/31/22/3718/240978/dendextend-an-R-package-for-visualizing-adjusting
- **Package**: dendextend
- **Version**: 1.19.1
...
- **Docker Image**: quay.io/biocontainers/r-dendextend:1.1.2--r3.3.2_0
- **Skill**: generated
- **Total Downloads**: 248
