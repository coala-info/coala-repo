...
FATAL:   Unable to handle docker://quay.io/biocontainers/porfast:0.8.0--hbeb723e_0 uri: while building SIF from layers: conveyor failed to get: invalid character '}' after top-level value
```
