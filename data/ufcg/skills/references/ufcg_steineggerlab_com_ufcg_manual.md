...
* **meta\_\*.tsv** is a sample of TSV formatted metadata, which can be provided to the pipeline for annotating genomes.
...
#### Genome assembly  [![](image/ncbi_link.png)](https://www.ncbi.nlm.nih.gov/assembly/)
...
* **sample/meta\_full.tsv** contains fully constructed metadata of genomes in sample/seq/ directory.
* **sample/meta\_simple.tsv** contains minumum data of the genomes.
...
| ``` align/aligned_[GENE].fasta ``` | Aligned sequences of each single gene |
| Misc | ``` [run_id].log ``` | Log file containing information about this run |
| ``` [run_id].trm ``` | JSON file containing entire trees and their metadata |
...
To replace the **RPB2 gene tree** by using **accessions and taxonomic relationships** as leaves from the run **Lorem\_ipsum**, execute:
...
##### Q. UFCG emits error "AUGUSTUS\_CONFIG\_PATH undefined or improperly defined". How can I solve it?
...
* [**Input files**](manual#input)
* [**Running profile**](manual#uucgf)
* [**Running tree**](manual#uucgtree)
* [**Troubleshooting**](manual#trouble)
* [**About us**](manual#about)
