...
### Enabling bisulfite sequencing coloring[#](#enabling-bisulfite-sequencing-coloring "Direct link to this section")
...
| **CHH** and **CHG** | H represents any nucleotide but guanine (H comes after G).  * CHH = CAA, CAT, CAC; CTT, CTA, CTC; CCC, CCA, CCT * CHG = CAG, CTG, CCG | Additional methylation sites:  * For mammals in a cell-type dependent manner. Pervasive in human embryonic stem cells (Lister 2009). For example, in H1 stem cells comprises almost 25% of all cytosines at which DNA methylation is identified compared to 99.98% mCG in IMR90 cells. * In plants serve as additional canonical methylation target sites. |
...
### Display convention[#](#display-convention "Direct link to this section")
...
the tumor sample in the **screenshot** below which visualizes data from Berman *et al* (2012).

![](../../../img/BermanNatGenet2011%202015-02-11%2014.31.21.png)

### BS-Seq[#](#bs-seq "Direct link to this section")
...
bisulfite conversion, only 5-hmeC site cytosines remain unchanged in reads (Yu, *Nature Protocols* 2012).
...
### NOMe-Seq[#](#nome-seq "Direct link to this section")
...
information based on the GpC methyltransferase *M.CviPI* accessibility to GpC sites, and at the same time obtains
