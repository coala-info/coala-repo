...
baseCommand:
  - gatk
  - CalcMetadataSpark
label: gatk_CalcMetadataSpark
doc: 'This tool takes a SAM/BAM/CRAM as input and calculates metrics about the reads:
  fragment length statistics by read group, mean length, coverage, partition statistics,
  etc.'
inputs:
  - id: input
    type:
  ...
  - id: write_as_binary
    type:
      - 'null'
      - boolean
    doc: write metadata as serialized binary data, rather than as human-readable
      text
    inputBinding:
      position: 101
      prefix: --write-as-binary
