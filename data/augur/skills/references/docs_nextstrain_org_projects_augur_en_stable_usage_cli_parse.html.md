...
* [Using Augur](../usage.html)
* [Augur subcommands](cli.html)
* [View page source](../../_sources/usage/cli/parse.rst.txt)

---

# augur parse[](#augur-parse "Link to this heading")

Table of Contents

* [Named Arguments](#augur-make_parser-named-arguments)
* [Example: how to parse metadata from fasta-headers](#example-how-to-parse-metadata-from-fasta-headers)
...
`--output-id-field`
:   The record field to use as the sequence identifier in the FASTA output. If not provided, this will use the first available of (‘strain’, ‘name’). If none of those are available, this will use the first field in the fasta header.
...
## [Example: how to parse metadata from fasta-headers](#id2)[](#example-how-to-parse-metadata-from-fasta-headers "Link to this heading")
...
> >A/Canoas/LACENRS\_1793/2015|A|H3N2|07/17/2015||Brazil|Human|KY925125
> ATG…
> >A/Canoas/LACENRS\_773/2015|A|H3N2|05/06/2015||Brazil|Human|KY925599
> ATG…
> […]
...
[Previous](cli.html "Augur subcommands")
[Next](curate/index.html "augur curate")
...
Cornelius Roemer](https://neherlab.org/cornelius-roemer.ht