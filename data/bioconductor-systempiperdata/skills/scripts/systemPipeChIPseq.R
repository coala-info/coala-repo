# Code example from 'systemPipeChIPseq' vignette. See references/ for full tutorial.
...
## ----chipseq-toplogy, eval=TRUE, warning= FALSE, echo=FALSE, out.width="100%", fig.align = "center", fig.cap= "Toplogy graph of ChIP-Seq workflow.", warning=FALSE----
