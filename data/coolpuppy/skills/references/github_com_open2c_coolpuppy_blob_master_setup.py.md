...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fopen2c%2Fcoolpuppy%2Fblob%2Fmaster%2Fsetup.py)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fblob%2Fshow&source=header-repo&source_repo=open2c%2Fcoolpuppy)
...
[History](/open2c/coolpuppy/commits/master/setup.py)
...
[Raw](https://github.com/open2c/coolpuppy/raw/refs/heads/master/setup.py)
...
filepath = os.path.join(os.path.dirname(\_\_file\_\_), \*parts)
...
on\_rtd = os.environ.get("READTHEDOCS") == "True"
...
"plotpup.py = coolpuppy.plotpuppy\_CLI:main",

"dividepups.py = coolpuppy.divide\_pups\_CLI:main",

]

},

setup\_requires=setup\_requires,
...
author\_email="flyamer@gmail.com",
