        ...
        },
        {
            ...
            "inputs": [
                ...
                },
                {
                    ...
                    "doc": "Number of rejected ASVs to be annotated",
                    "label": "Number rejected ASV annotation",
                    "id": "#main/rejected_asv_annotation"
                },
                {
                    "type": [
                        "null",
            ...
            "steps": [
                ...
                },
                {
                    ...
                    "in": [
                        ...
                        {
                            "source": "#main/reference_db_lookup",
                            "id": "#main/ngtax/reference_db_lookup"
                        },
                        {
                            "source": "#main/rejected_asv_annotation",
                            "id": "#main/ngtax/rejected_asv_annotation"
                        },
                        {
