...
* Practical information
  ...
  + [Required computing resources](#required-computing-resources)
  + [Usage and basic options](#usage-and-basic-options)
  + [Configuration file](#configuration-file)
  + [Issues, Questions, Remarks](#issues-questions-remarks)
  + [Citation](#citation)
...
* Practical information
* [View page source](../_sources/user/practicalInformation.md.txt)

---

# Practical information[](#practical-information "Permalink to this heading")

## Pangenome file[](#pangenome-file "Permalink to this heading")
...
Once the pangenome is established, including gene clustering, partitioning, optional prediction of Regions of Genome Plasticity (RGP), Spots of insertions, and functional modules, it becomes a versatile input for various PPanGGOLiN commands. For instance, the [`msa` command](MSA.html) generates multiple sequence alignments of genes, the [`projection` command](projection.html) annotates external genomes with the pangenome content, and the [`context` command](genomicContext.html) identifies genomic contexts of proteins of interest.
...
## Required computing resources[](#required-computing-resources "Permalink to this heading")
...
![../_images/runtimes.png](../_images/runtimes.png)

This data was collected using PPanGGOLiN v1.1.72.

## Usage and basic options[](#usage-and-basic-options "Permalink to this heading")
...
## Issues, Questions, Remarks[](#issues-questions-remarks "Permalink to this heading")
...
Bazin et al., panRGP: a pangenome-based method to predict genomic islands and explore their diversity, Bioinformatics, Volume 36, Issue Supplement\_2, December 2020, Pages i651–i658, <https://doi.org/10.1093/bioinformatics/btaa792>
...
[Previous](QuickUsage/quickAnalyses.html "Quick usage")
[Next](PangenomeAnalyses/pangenomeAnalyses.html "Pangenome analyses")
