...
## How Snakemake works[¶](#how-snakemake-works "Link to this heading")
...
## Running manually[¶](#running-manually "Link to this heading")
...
## Input and config files[¶](#input-and-config-files "Link to this heading")
...
## Cores and memory[¶](#cores-and-memory "Link to this heading")
...
## Assembly and binning[¶](#assembly-and-binning "Link to this heading")
...
config YAML file](configuration.html)). These mean the same thing for both assembly and binning (**“AB”** hereafter).
...
## Package structure[¶](#package-structure "Link to this heading")
