...
org.Xl.egACCNUM is an R object that contains mappings between Entrez Gene identifiers and
...
org.Xl.egALIAS is an R object that provides mappings between common gene symbol identifiers
...
Welcome to the org.Xl.eg.db annotation Package. This is an organism specific package. The pur-
pose is to provide detailed information about the species abbreviated in the second part of the
package name org.Xl.eg.db. This package is updated biannually.
...
org.Xl.egCHR is an R object that provides mappings between entrez gene identifiers and the chro-
...
org.Xl.egENZYME is an R object that provides mappings between entrez gene identifiers and EC
numbers.
...
numbers. In org.Xl.egENZYME2EG, EC is dropped from the Enzyme Commission numbers.
...
org.Xl.egGENENAME is an R object that maps entrez gene identifiers to the corresponding gene
name.
...
org.Xl.egGENETYPE is an R object that provides mappings between entrez gene identifiers and
gene types.
...
org.Xl.egGO is an R object that provides mappings between entrez gene identifiers and the GO
...
org.Xl.egGO2ALLEGS is an R object that provides mappings between a given GO identifier and
all of the Entrez Gene identifiers annotated at that GO term OR TO ONE OF IT’S CHILD NODES
in the GO ontology. Thus, this mapping is much larger and more inclusive than org.Xl.egGO2EG.

Details

If org.Xl.egGO is cast as a list, each Entrez Gene identifier is mapped to a list of lists. The names on
...
If org.Xl.egGO2ALLEGS or org.Xl.egGO2EG is cast as a list, each GO term maps to a named vec-
...
# For org.Xl.egGO2ALLEGS
xx <- as.list(org.Xl.egGO2ALLEGS)
if(length(xx) > 0){
...
Number of mapped keys for the maps in package org.Xl.eg.db

Description

org.Xl.egMAPCOUNTS provides the "map count" (i.e. the count of mapped keys) for each map in
package org.Xl.eg.db.
...
## Bimap interface:
org.Xl.egMAPCOUNTS
mapnames <- names(org.Xl.egMAPCOUNTS)
org.Xl.egMAPCOUNTS[mapnames[1]]
x <- get(mapnames[1])
sum(!is.na(as.list(x)))
count.mappedkeys(x)
...
## Check the "map count" of all the maps in package org.Xl.eg.db
checkMAPCOUNTS("org.Xl.eg.db")

org.Xl.egORGANISM

The Organism for org.Xl.eg

Description

org.Xl.egORGANISM is an R object that contains a single item: a character string that names the
organism for which org.Xl.eg was built.

Details

Although the package name is suggestive of the organism for which it was built, org.Xl.egORGANISM
...
isms. org.Xl.egPATH maps entrez gene identifiers to the identifiers used by KEGG for pathways
...
org.Xl.egPMID is an R object that provides mappings between entrez gene identifiers and PubMed
identifiers.
...
org.Xl.egREFSEQ is an R object that provides mappings between entrez gene identifiers and Ref-
Seq identifiers.
...
org.Xl.egSYMBOL is an R object that provides mappings between entrez gene identifiers and gene
abbreviations.
...
org.Xl.egUNIPROT is an R object that contains mappings between Entrez Gene identifiers and
...
org.Xl.eg_dbconn()
org.Xl.eg_dbfile()
org.Xl.eg_dbschema(file="", show.indices=FALSE)
org.Xl.eg_dbInfo()
...
org.Xl.eg_dbconn returns a connection object to the package annotation DB. IMPORTANT: Don’t
call dbDisconnect on the connection object returned by org.Xl.eg_dbconn or you will break all
the AnnDbObj objects defined in this package!
org.Xl.eg_dbfile returns the path (character string) to the package annotation DB (this is an
SQLite file).
org.Xl.eg_dbschema prints the schema definition of the package annotation DB.
org.Xl.eg_dbInfo prints other information about the package annotation DB.

Value

org.Xl.eg_dbconn: a DBIConnection object representing an open connection to the package an-
notation DB.
org.Xl.eg_dbfile: a character string with the path to the package annotation DB.
org.Xl.eg_dbschema: none (invisible NULL).
org.Xl.eg_dbInfo: none (invisible NULL).
...
dbGetQuery(org.Xl.eg_dbconn(), "SELECT COUNT(*) FROM genes")
...
org.Xl.egCHR, 3
org.Xl.egENZYME, 4
org.Xl.egENZYME2EG (org.Xl.egENZYME), 4
org.Xl.egGENENAME, 5
org.Xl.egGENETYPE, 6
org.Xl.egGO, 7
org.Xl.egGO2ALLEGS, 8
org.Xl.egGO2ALLEGS (org.Xl.egGO), 7
org.Xl.egGO2EG (org.Xl.egGO), 7
org.Xl.egMAPCOUNTS, 9
org.Xl.egORGANISM, 10
org.Xl.egPATH, 11
org.Xl.egPATH2EG (org.Xl.egPATH), 11
org.Xl.egPMID, 12
org.Xl.egPMID2EG (org.Xl.egPMID), 12
org.Xl.egREFSEQ, 13
org.Xl.egREFSEQ2EG (org.Xl.egREFSEQ), 13
org.Xl.egSYMBOL, 14
org.Xl.egSYMBOL2EG (org.Xl.egSYMBOL), 14
org.Xl.egUNIPROT, 15
...
org.Xl.eg (org.Xl.eg.db), 3
org.Xl.eg.db, 3
org.Xl.eg_dbconn, 16
org.Xl.eg_dbfile (org.Xl.eg_dbconn), 16
org.Xl.eg_dbInfo (org.Xl.eg_dbconn), 16
org.Xl.eg_dbschema (org.Xl.eg_dbconn),

16
org.Xl.egACCNUM, 1
org.Xl.egACCNUM2EG (org.Xl.egACCNUM), 1
