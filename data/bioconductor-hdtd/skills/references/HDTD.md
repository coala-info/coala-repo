...
Note that the output preserves the order of the genes and the columns. For example, \(0.8399\) is the average \(\log\_2\) intensity for gene “Akt1” in the adrenal gland based on \(40\) mice. The mean matrix for the first 10 genes across the \(9\) tissues is
...
#> use
#>
#>   Touloumis, A., Marioni, J.C. and Tavar\'{e}, S. (2021). Hypothesis
