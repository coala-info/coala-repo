...
inputs:
  ...
  - id: maximum_population_allele_frequency
    type:
      - 'null'
      - float
    doc: Maximum population allele frequency of sites to consider.
    inputBinding:
      position: 101
      prefix: --maximum-population-allele-frequency
  - id: minimum_population_allele_frequency
    type:
      - 'null'
      - float
    doc: Minimum population allele frequency of sites to consider.
    inputBinding:
      position: 101
      prefix: --minimum-population-allele-frequency
  - id: quiet
    type:
      - 'null'
      - boolean
