...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Ffungs%2Ftaxator-tk%2Fblob%2Fmaster%2FREADME.md)
...
[History](/fungs/taxator-tk/commits/master/README.md)

History

140 lines (80 loc) · 12.7 KB
...
[Raw](https://github.com/fungs/taxator-tk/raw/refs/heads/master/README.md)
...
* [changelog](/fungs/taxator-tk/blob/master/CHANGELOG.md)
* [core compilation guide](/fungs/taxator-tk/blob/master/core/BUILD.md)
* [core detailed usage instructions](/fungs/taxator-tk/blob/master/core/USAGE.md)
* [core dependencies](/fungs/taxator-tk/blob/master/core/DEPENDENCIES.md)
* [extended pipeline description](/fungs/taxator-tk/blob/master/extended/README.md)
* [extended pipeline dependencies](/fungs/taxator-tk/blob/master/extended/DEPENDENCIES.md)

## FAQ

> 1: Help, the majority of assigned taxa are unspecific, like phylum or (super)kingdom, what can I do?

Your input sequences are likely too short or too novel, which means that they lack relative sequences in your refpack. Check that you are using a comprehensive, recent and suitable refpack for classification. For short sequences, you can still find the associated taxonomic information in the [intermediate GFF3](/fungs/taxator-tk/blob/master/doc/fileformats.md) file, just not at the confidence level which is required for the final consensus assignment.
