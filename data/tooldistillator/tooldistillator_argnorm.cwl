...
baseCommand:
  - tooldistillator.py
  - argnorm
label: tooldistillator_argnorm
doc: "Extract information from output(s) of argnorm (output.tsv)\n\nTool homepage:
...
inputs:
  ...
  - id: analysis_software_version
    type:
      - 'null'
      - string
    doc: argnorm version number for argnorm
    inputBinding:
      position: 102
  ...
  - id: hid
    type:
      - 'null'
      - string
    doc: historic ID for argnorm file from galaxy for argnorm
    inputBinding:
      position: 102
      prefix: --hid
