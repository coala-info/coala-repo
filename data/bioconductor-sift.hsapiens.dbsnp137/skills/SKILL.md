...
Use the Bioconductor R package **SIFT.Hsapiens.dbSNP137** for: the package is available on all platforms; click for details.
...
BiocManager::install("SIFT.Hsapiens.dbSNP137")
```
