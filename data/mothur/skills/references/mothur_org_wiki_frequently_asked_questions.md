...
[Edit this page](https://github.com/mothur/mothur.github.io/edit/master/_wiki/frequently_asked_questions.md)
[Ask question about or comment on this page](https://github.com/mothur/mothur.github.io/issues/new?labels=question&title=Question on: Frequently Asked Questions)
...
similarity in community [membership](/wiki/calculators#similarity-in-community-membership)
or [structure](/wiki/calculators#similarity-in-community-structure).

## How do I know “who” is in an OTU in a shared file?

You can run the [get.otulist](/wiki/get.otulist) command on the [list](/wiki/List_file) file you used to generate the [shared](/wiki/Shared_file) file. You want to be sure you are
