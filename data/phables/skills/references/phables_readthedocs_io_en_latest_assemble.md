...
* [Install](../install/)
* Assemble
  + [Paired-end read files for short read assembly](#paired-end-read-files-for-short-read-assembly)
  + [Long read assemblies](#long-read-assemblies)
  + [Assemble the samples](#assemble-the-samples)
  + [Recommended assemblers and tools](#recommended-assemblers-and-tools)
    - [MEGAHIT](#megahit)
...
* RUNNING
* Assemble
* [Edit on GitHub](https://github.com/Vini2/phables/edit/master/docs/assemble.md)
