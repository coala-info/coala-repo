# metawrap-mg CWL Generation Report

## metawrap-mg_metawrap

### Tool Description
Please select a proper module of metaWRAP.

### Metadata
- **Docker Image**: quay.io/biocontainers/metawrap-mg:1.3.0--hdfd78af_3
- **Homepage**: https://github.com/bxlab/metaWRAP
- **Package**: https://anaconda.org/channels/bioconda/packages/metawrap-mg/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/metawrap-mg/overview
