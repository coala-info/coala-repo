...
* [Prerequisites](#prerequisites)
  + [GLPK](#glpk)
    - [Install GLPK on Linux](#install-glpk-on-linux)
      * [Installing GLPK on Ubuntu or other Debian systems](#installing-glpk-on-ubuntu-or-other-debian-systems)
      * [Installing GLPK on CentOS](#installing-glpk-on-centos)
    - [Installing GLPK on Mac OSX 10.10 Yosemite](#installing-glpk-on-mac-osx-10-10-yosemite)
    - [Installing GLPK on Windows](#installing-glpk-on-windows)
  + [Install PyGLPK](#install-pyglpk)
  + [Install the ModelSEEDDatabase](#install-the-modelseeddatabase)
  + [Python modules](#python-modules)
    - [libSBML and lxml](#libsbml-and-lxml)
    - [Beautiful Soup 4](#beautiful-soup-4)
* [Install PyFBA](#install-pyfba)
* [Set the environment variables](#set-the-environment-variables)
* [Tests](#tests)

[Show page source](sources/installation.txt)
...
## GLPK[¶](#glpk "Permalink to this headline")
...
Precision](https://gmplib.org/) arithmetic library. Finally, we
install PyGLPK, a Python wrapper around GLPK.

### Install GLPK on Linux[¶](#install-glpk-on-linux "Permalink to this headline")

#### Installing GLPK on Ubuntu or other Debian systems[¶](#installing-glpk-on-ubuntu-or-other-debian-systems "Permalink to this headline")
...
#### Installing GLPK on CentOS[¶](#installing-glpk-on-centos "Permalink to this headline")
...
### Installing GLPK on Mac OSX 10.10 Yosemite[¶](#installing-glpk-on-mac-osx-10-10-yosemite "Permalink to this headline")
...
### Installing GLPK on Windows[¶](#installing-glpk-on-windows "Permalink to this headline")

You will need to install [WinGLPK](http://winglpk.sourceforge.net/)
but their installation instructions are not very clear. We will have
detailed installation instructions shortly.

## Install PyGLPK[¶](#install-pyglpk "Permalink to this headline")

You need to install
[PyGLPK](https://github.com/bradfordboyle/pyglpk). Make sure that you
install [this fork of
PyGLPK](https://github.com/bradfordboyle/pyglpk) as the original has
not worked for quite some time!

## Install the ModelSEEDDatabase[¶](#install-the-modelseeddatabase "Permalink to this headline")

We rely on the [Model SEED](http://www.theseed.org/models) to provide
...
variable](#set_the_environment_variables) as explained below.
...
As noted [above](#install_pyglpk), you should install PyGLPK from
[GitHub](https://github.com/bradfordboyle/pyglpk). However,
`setup.py` will try and do the right thing for you.

### libSBML and lxml[¶](#libsbml-and-lxml "Permalink to this headline")

One or two of the scripts (notably
<scripts/run_fba_sbml.py>) require that
...
### Beautiful Soup 4[¶](#beautiful-soup-4 "Permalink to this headline")

XML parsing is a pain in the butt, and so we use [Beautiful Soup
4](http://www.crummy.com/software/BeautifulSoup) to make life easy!
...
# Install PyFBA[¶](#install-pyfba "Permalink to this headline")

You should be able to install PyFBA from
[PyPI](https://pypi.python.org) using `pip install`:
...
directory](https://docs.python.org/2/install/#alternate-installation):

```
python setup.py install --user
```

# Set the environment variables[¶](#set-the-environment-variables "Permalink to this headline")
...
There are many more tests in the [tests](PyFBA/tests/) folder and you
