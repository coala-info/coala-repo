...
LACE 2.0 automatically recognizes if the selected path is a LACE project and proposes the user to load it (![](data:image/png;base64...))

### 0.5.2 Sidebar and Demos
...
### 0.5.3 Processing interface

#### 0.5.3.1 Single Cell Metadata
...
#### 0.5.3.4 Single cell sampling depth
...
### 0.5.4 Selection of relevant variants
...
Hence, the user can press “Select variants” (![](data:image/png;base64...)) to perform the aforementioned computations on VCF and BAM files to derive all the necessary aggregated information on the sampled cells.
...
### 0.5.6 Longitudinal display and outputs interface
