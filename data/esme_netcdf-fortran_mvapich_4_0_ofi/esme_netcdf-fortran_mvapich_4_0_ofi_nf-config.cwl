...
label: esme_netcdf-fortran_mvapich_4_0_ofi_nf-config
doc: "NetCDF-Fortran configuration utility to retrieve settings used during compilation
...
stdout: esme_netcdf-fortran_mvapich_4_0_ofi_nf-config.out
