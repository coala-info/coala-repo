# Code example from 'Integrative_analysis_of_metabolome_and_microbiome' vignette. See references/ for full tutorial.
...
## ---- fig.align='center', fig.width= 6, fig.height= 5, dpi=150----------------
