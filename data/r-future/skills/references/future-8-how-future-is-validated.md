...
**[future](https://future.futureverse.org)**, **[parallelly](https://parallelly.futureverse.org)**, **[globals](https://globals.futureverse.org)**, and **[listenv](https://listenv.futureverse.org)**, implement a
...
(GitHub Actions), an on [R-hub](https://r-hub.github.io/rhub/). The core packages are also tested with
...
dependency checks using **[revdepcheck](https://github.com/r-lib/revdepcheck)**.
...
**[future.tests](https://future.tests.futureverse.org)** package validates the
correctness of all future backends. Any new future backend developed, must
pass these tests to comply with the *Future API*.
...
new future backend conforms to the *Future API*, we relieve other
...
Fourth, since **[foreach](https://CRAN.R-Project.org/package%3Dforeach)** is used by a large number of essential
...
**[foreach](https://CRAN.R-Project.org/package%3Dforeach)** and popular CRAN packages **[caret](https://CRAN.R-Project.org/package%3Dcaret)**, **[glmnet](https://CRAN.R-Project.org/package%3Dglmnet)**, **[NMF](https://CRAN.R-Project.org/package%3DNMF)**,
**[plyr](https://CRAN.R-Project.org/package%3Dplyr)**, and **[TSP](https://CRAN.R-Project.org/package%3DTSP)** to use the **[doFuture](https://doFuture.futureverse.org)** adaptor.
...
validates the backends as well as the *Future API*.
...
*doSEQ* adaptor (default), fork-based ones such as **[doMC](https://CRAN.R-Project.org/package%3DdoMC)**, or
the generic **[doFuture](https://doFuture.futureverse.org)**, which supports any future backend and
...
of the *Future API* and the future ecosystem at large.

(\*) There is a plan to update **[foreach](https://CRAN.R-Project.org/package%3Dforeach)** to use the exact same static-code-analysis method as the **[future](https://future.futureverse.org)** package use for identifying globals. As the maintainer of the future framework, I collaborate with the maintainer of the **[foreach](https://CRAN.R-Project.org/package%3Dforeach)** package to implement this.