# Code example from 'LRBase.Rno.eg.db' vignette. See references/ for full tutorial.

### R code from vignette source 'LRBase.Rno.eg.db.Rnw'
### Encoding: UTF-8
...
###################################################
### code chunk number 2: LRBase.Rno.eg.db.Rnw:45-49
###################################################
...
###################################################
### code chunk number 3: LRBase.Rno.eg.db.Rnw:55-60
###################################################
if(interactive()){
...
###################################################
### code chunk number 4: LRBase.Rno.eg.db.Rnw:67-74
###################################################
if(interactive()){
...
###################################################
### code chunk number 5: LRBase.Rno.eg.db.Rnw:80-89
###################################################
if(interactive()){
...
###################################################
### code chunk number 6: LRBase.Rno.eg.db.Rnw:106-114
###################################################
if(interactive()){
