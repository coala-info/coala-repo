...
### Line Plots with column encoding color[¶](#Line-Plots-with-column-encoding-color)
...
### Line charts in Dash[¶](#Line-charts-in-Dash)
...
### Data Order in Line Charts[¶](#Data-Order-in-Line-Charts)
...
### Line charts with markers[¶](#Line-charts-with-markers)
...
### Sparklines with Plotly Express[¶](#Sparklines-with-Plotly-Express)
...
### Line Plot with go.Scatter[¶](#Line-Plot-with-go.Scatter)
...
#### Style Line Plots[¶](#Style-Line-Plots)
...
#### Interpolation with Line Plots[¶](#Interpolation-with-Line-Plots)
...
#### Label Lines with Annotations[¶](#Label-Lines-with-Annotations)
