# About GROMACS[¶](#about-gromacs "Permalink to this heading")
...
documentation, patches to fix bugs, advice on the forums, bug reports that let us reproduce the issue, and new functionality. See [Development](development.html) page and [Report an issue](report_issue.html).
...
GROMACS is Free Software, available under the GNU Lesser General Public
License (LGPL), version 2.1. You can redistribute it and/or modify it
under the terms of the LGPL as published by the Free Software
Foundation; either version 2.1 of the License, or (at your option) any
later version.

![_images/gmx_logo_blue.png](_images/gmx_logo_blue.png)

[![Logo](_static/gmx_logo_blue.png)](index.html)
...
* [Tutorials and Webinars](tutorial_webinar.html)
* [Downloads](https://manual.gromacs.org)
* [GROMACS forum](http://forum.gromacs.org)
* [Report an issue](report_issue.html)
* [Development](development.html)
* [User contributions](user_contributions.html)
* [User Survey](user_survey.html)
* [GROMACS workshop](workshop.html)

### Related Topics

* [Documentation overview](index.html)
  + Previous: [Welcome to GROMACS](index.html "previous chapter")
  + Next: [Highlights](highlights.html "next chapter")

### Quick search

©2022-2024, GROMACS development team.
|
Powered by [Sphinx 5.3.0](http://sphinx-doc.org/)
& [Alabaster 0.7.13](https://github.com/bitprophet/alabaster)
|
[Page source](_sources/about.rst.txt)