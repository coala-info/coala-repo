...
* [Subcommands](subcommands_index.html)
  ...
  + bdgdiff
    ...
    - [Step-by-step Instruction for calling differential peaks](#step-by-step-instruction-for-calling-differential-peaks)
      * [Step 1: Generate pileup tracks using callpeak module](#step-1-generate-pileup-tracks-using-callpeak-module)
      * [Step 2: Call differential regions](#step-2-call-differential-regions)
  + [bdgopt](bdgopt.html)
...
* [Subcommands](subcommands_index.html)
* bdgdiff
* [View page source](../_sources/docs/bdgdiff.md.txt)

---

# bdgdiff[](#bdgdiff "Link to this heading")
...
* `--o-prefix`: Output file prefix. Actual files will be named as
  PREFIX\_cond1.bed, PREFIX\_cond2.bed, and PREFIX\_common.bed. Mutually
...
## Step-by-step Instruction for calling differential peaks[](#step-by-step-instruction-for-calling-differential-peaks "Link to this heading")
...
cond1\_ChIP.bam and cond1\_Control.bam for condition 1; cond2\_ChIP.bam
and cond2\_Control.bam for condition 2.

### Step 1: Generate pileup tracks using callpeak module[](#step-1-generate-pileup-tracks-using-callpeak-module "Link to this heading")
...
‘’cond1\_treat\_pileup.bdg’’, ‘’cond1\_control\_lambda.bdg’’,
‘’cond2\_treat\_pileup.bdg’’, and ‘’cond2\_control\_lambda.bdg’’ in the
working directory.

### Step 2: Call differential regions[](#step-2-call-differential-regions "Link to this heading")
...
condition 2 ( cond1\_ChIP > cond1\_Control and cond1\_ChIP > cond2\_ChIP
); 2. those having more enrichment in condition 2 over condition 1 (
cond2\_ChIP > cond2\_Control and cond2\_ChIP > cond1\_ChIP ); those having
similar enrichment in both conditions ( cond1\_ChIP > cond1\_Control and
cond2\_ChIP > cond2\_Control and cond1\_ChIP ≈ cond1\_ChIP ).
...
[Previous](bdgcmp.html "bdgcmp")
[Next](bdgopt.html "bdgopt")
