...
baseCommand:
  - gatk
  - CollectOxoGMetrics
label: gatk_CollectOxoGMetrics
doc: Collect metrics to assess oxidative artifacts. This tool calculates the 
  Phred-scaled probability that an alternate base call results from an oxidation
  artifact based on base context, sequencing read orientation, and the 
