...
FATAL:   Unable to handle docker://quay.io/biocontainers/pypgx:0.26.0--pyh7e72e81_0 uri: while building SIF from layers: conveyor failed to get: invalid character '}' after top-level value
```
