...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fthegenemyers%2FDAMASKER%2Fblob%2Fmaster%2FREADME.md)
...
[History](/thegenemyers/DAMASKER/commits/master/README.md)

History

141 lines (110 loc) · 12.7 KB
...
[Raw](https://github.com/thegenemyers/DAMASKER/raw/refs/heads/master/README.md)
...
For a database divided into N sub-blocks, the calls to daligner will produce a total of gN .las files, g2 for each of the N/g block groups. These are then merged so that there is 1 file per block. So at the end one has N sorted .las files, one per block.
...
If the -f option is set, then each command block is written to a file with a na