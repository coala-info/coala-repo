...
description: The mgnify-pipelines-toolkit is a curated collection of Python-based utilities designed to support the EBI-Metagenomics (MGnify) production pipelines.
