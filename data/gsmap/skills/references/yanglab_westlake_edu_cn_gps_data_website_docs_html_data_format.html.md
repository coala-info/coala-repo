...
[View this page](_sources/data_format.md.txt "View this page")
...
## ST Data[¶](#st-data "Link to this heading")
...
## GWAS Data[¶](#gwas-data "Link to this heading")
...
### How to format the GWAS data[¶](#how-to-format-the-gwas-data "Link to this heading")
...
* Data Format
  + [ST Data](#st-data)
  + [GWAS Data](#gwas-data)
    - [How to format the GWAS data](#how-to-format-the-gwas-data)