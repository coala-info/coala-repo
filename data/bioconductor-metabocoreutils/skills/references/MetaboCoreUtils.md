...
MetaboCoreUtils 1.18.1

**Package**: *[MetaboCoreUtils](https://bioconductor.org/packages/3.22/MetaboCoreUtils)*
...
**Last modified:** 2025-10-29 20:10:56.814004
**Compiled**: Thu Nov 20 19:22:26 2025

# 1 Introduction

The *[MetaboCoreUtils](https://bioconductor.org/packages/3.22/MetaboCoreUtils)* package defines metabolomics-related core
functionality provided as low-level functions to allow a data
structure-independent usage across various R packages
(Rainer et al. [2022](#ref-rainer_modular_2022)). This includes functions to calculate between ion
...
## [19] "isRkmd"                     "isotopicSubstitutionMatrix"
## [21] "isotopologues"              "mass2mz"
...
approach is similar to the one described by (Wehrens et al. [2016](#ref-wehrens_improved_2016)).
...
![Abundance of an example feature along injection index. Open circles represent measurements in study samples, filled circles in QC samples. The black solid line represents the estimated signal drift.](data:image/png;base64...)

Figure 1: Abundance of an example feature along injection index
Open circles represent measurements in study samples, filled circles in QC samples. The black solid line represents the estimated signal drift.
...
Figure 2: Abundance of an example feature along injection index
Open circles represent measurements in study samples, filled circles in QC samples. The black solid line represents the estimated signal drift.
...
![Feature abundances before (open circles) and after adjustment (filled circles). The grey dashed line represents the injection index dependent signal drift estimated on the raw data and the solid grey line the same model estimated on the adjusted data.](data:image/png;base64...)

Figure 3: Feature abundances before (open circles) and after adjustment (filled circles)
The grey dashed line represents the injection index dependent signal drift estimated on the raw data and the solid grey line the same model estimated on the adjusted data.
...
![Correlation between abundances and injection index for QC samples before (black) and after adjustment (red). Filled circles represent the features for which the drift was adjusted for. Correlation coefficients are sorted.](data:image/png;base64...)

Figure 4: Correlation between abundances and injection index for QC samples before (black) and after adjustment (red)
Filled circles represent the features for which the drift was adjusted for. Correlation coefficients are sorted.
...
## 3.6 Basic quality assessment and pre-filtering of metabolomics data
...
Next, we will compute the D-ratio (Broadhurst et al. [2018](#ref-broadhurst_guidelines_2018)), a measure of
...
## [1] MetaboCoreUtils_1.18.1 BiocStyle_2.38.0
##
## loaded via a namespace (and not attached):
##  [1] cli_3.6.5           knitr_1.50          magick_2.9.0
##  [4] rlang_1.1.6         xfun_0.54           generics_0.1.4
##  [7] jsonlite_2.0.0      clue_0.3-66         S4Vectors_0.48.0
## [10] htmltools_0.5.8.1   tinytex_0.58        stats4_4.5.2
...
## [22] BiocManager_1.30.27 MsCoreUtils_1.22.0  cluster_2.1.8.1
## [25] compiler_4.5.2      codetools_0.2-20    Rcpp_1.1.0
## [28] BiocParallel_1.44.0 digest_0.6.39       R6_2.6.1
## [31] parallel_4.5.2      magrittr_2.0.4      bslib_0.9.0
## [34] tools_4.5.2         BiocGenerics_0.56.0 cachem_1.1.0
```
...
Wehrens, Ron, Jos A. Hageman, Fred van Eeuwijk, Rik Kooke, Pádraic J. Flood, Erik Wijnker, Joost J. B. Keurentjes, et al. 2016. “Improved Batch Correction in Untargeted MS-Based Metabolomics.” *Metabolomics : Official Journal of the Metabolomic Society* 12 (5): 88. <https://doi.org/10.1007/s11306-016-1015-8>.