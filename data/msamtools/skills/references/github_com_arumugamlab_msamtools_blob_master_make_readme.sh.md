...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Farumugamlab%2Fmsamtools%2Fblob%2Fmaster%2Fmake_readme.sh)
...
[History](/arumugamlab/msamtools/commits/master/make_readme.sh)
...
[Raw](https://github.com/arumugamlab/msamtools/raw/refs/heads/master/make_readme.sh)
...
# BIOCONDA\_DOCKER="quay.io/biocontainers/msamtools:1.1.2--h7132678\_0"

# OWN\_DOCKER="quay.io/arumugamlab/msamtools:1.1.2\_0"

# ./make\_readme.sh | sed 's^BIOCONDA\_DOCKER^quay.io/biocontainers/msamtools:1.1.2--h7132678\_0^; s^OWN\_DOCKER^quay.io/arumugamlab/msamtools:1.1.2\_0^' > README.md
...
singularity: 'docker://BIOCONDA\_DOCKER'
...
rule profile\_sample:

input: "{sample}.db.coord-sorted.bam"

output: "{sample}.db.profi