...
baseCommand:
  - phykit
  - phenogram
label: phykit_phenogram
doc: Plot a phenogram (traitgram) showing continuous trait evolution across a 
  phylogeny. X-axis shows distance from root (time), Y-axis shows trait values. 
  Tips are plotted at observed values, internal nodes at ML ancestral estimates.
