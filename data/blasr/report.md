...
### Tool Description
A read mapping program that maps reads to positions in a genome by clustering short exact matches between the read and the genome, and scoring clusters using alignment.

### Metadata
- **Docker Image**: quay.io/biocontainers/blasr:5.3.5--0
- **Homepage**: https://github.com/PacificBiosciences/blasr
- **Package**: https://anaconda.org/channels/bioconda/packages/blasr/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/blasr/overview
- **Total Downloads**: 42.3K
- **Last updated**: 2025-04-22
- **GitHub**: https://github.com/PacificBiosciences/blasr
- **Stars**: N/A
### Original Help Text
```text
Options for blasr 
