...
[Skip to content](#snk-configuration-file)
...
* [ ]
  ...
  Table of contents
  + [Modifying the snk.yaml File](#modifying-the-snkyaml-file)
  + [Available Configuration Options](#available-configuration-options)
  + [Example snk.yaml File](#example-snkyaml-file)
  + [CLI](#cli)

    - [Example snk.yaml File with CLI Annotations](#example-snkyaml-file-with-cli-annotations)
    - [Nested Annotations in the snk.yaml File](#nested-annotations-in-the-snkyaml-file)
    - [Using snk.yaml without a config.yaml file](#using-snkyaml-without-a-configyaml-file)
    - [Validating Config with the snk.yaml File](#validating-config-with-the-snkyaml-file)
  + [Resources](#resources)

    - [Example snk.yaml File with Resources](#example-snkyaml-file-with-resources)
