...
baseCommand: prove
label: perl-test-harness_prove
doc: "Run tests through a TAP harness\n\nTool homepage: http://testanything.org/"
inputs:
  - id: files_or_directories
    type:
      ...
      - type: array
        items: string
    doc: Files or directories containing tests
    inputBinding:
      position: 1
  - id: QUIET_summary
    type:
...
hints:
  - class: DockerRequirement
    dockerPull: quay.io/biocontainers/perl-test-harness:3.44--pl5321hdfd78af_0
