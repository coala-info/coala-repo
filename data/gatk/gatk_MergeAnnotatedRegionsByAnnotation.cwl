...
label: gatk_MergeAnnotatedRegionsByAnnotation
doc: This simple tool will merge genomic regions (specified in a tsv) when given
  annotations (columns) contain exact values in neighboring segments and the 
  segments are within a specified maximum genomic distance.
inputs:
  - id: annotations_to_match
    type:
      type: array
      items: string
    doc: Annotation(s) to merge on. This argument must be specified at least 
      once.
    inputBinding:
      position: 101
      prefix: --annotations-to-match
  - id: output
    type: string
    doc: Output TSV file
    inputBinding:
  ...
  - id: output_contig_column
    ...
    inputBinding:
      position: 101
      prefix: --output-contig-column
  - id: output_end_column
    type:
      - 'null'
      - string
    ...
    inputBinding:
      position: 101
      prefix: --output-end-column
  - id: output_start_column
    type:
      - 'null'
      - string
