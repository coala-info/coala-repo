...
These shortcomings motivated the `Nextstrain `\_ project, for which Auspice was initially devloped.
Auspice can be run on your computer or integrated into websites.
It allows easy customisation of aesthetics and functionality, and powers the visualisations on `nextstrain.org `\_.
For a more formal introduction to auspice & the wider nextstrain project, please see `Hadfield et al., Nextstrain: real-time tracking of pathogen evolution, Bioinformatics (2018) `\_.
