---
name: rop
description: The Read Origin Protocol (ROP) is a specialized bioinformatics pipeline designed to characterize the "unmapped" portion of sequencing datasets.
