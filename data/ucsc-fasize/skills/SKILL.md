---
name: ucsc-fasize
description: The `faSize` utility (distributed via the `ucsc-fasize` package) is a specialized tool from the UCSC Genome Browser "Kent" toolkit designed for rapid sequence statistics.
