...
This page includes a video tutorial for installing [HEASoft from Source Code on a Mac](/docs/software/lheasoft/macos.html#source).

[

Your browser does not support the video tag.
](videos/install-heasoft-mac.mp4)

A [transcript](videos/install-heasoft-mac.vtt) is available.
