...
baseCommand:
  ...
  - run
label: apptainer_run
doc: "Run the user-defined default command within a container. This command will launch
  an Apptainer container and execute a runscript if one is defined for that container.\n
...
inputs:
  ...
  - id: args
    type:
      ...
      - type: array
        items: string
    doc: Arguments passed directly to the runscript
    inputBinding:
      position: 2
  - id: add_caps
    type:
  ...
  - id: net
    type:
      - 'null'
      - boolean
    doc: run container in a new network namespace (sets up a bridge network interface
      by default)
    inputBinding:
      position: 103
      prefix: --net
