...
[View on GitHub](https://github.com/sanger-pathogens/Artemis)

[Home](/Artemis/) |
[Artemis](/Artemis/Artemis/) |
[ACT](/Artemis/ACT/) |
[BamView](/Artemis/BamView/) |
[DNAPlotter](/Artemis/DNAPlotter/) |
...
For MacOSX users, an artemis-macosx-release-{version}.dmg.gz disk image is provided. Double-click on this file in your Downloads folder to unzip it. Then double-click the unzipped artemis-macosx-release-{version}.dmg to mount the “Artemis\_Tools” image and display its contents - the Artemis, ACT, BamView and DNAPlotter applications. These apps can then be dragged to any desired location, for example, your dock or desktop. The download file can be unzipped from the command line using gunzip, if necessary:
...
2. Create an ARTEMIS\_JVM\_FLAGS environment variable set to “-mx2g -ms100m”, adjusting the mx value as required. No script change is required for this, but it would need to be added to your environment.
...
[Artemis](https://github.com/sanger-pathogens/Artemis) is maintained by [sanger-pathogens](https://github.com/sanger-pathogens).
