...
FATAL:   Unable to handle docker://quay.io/biocontainers/te-aid:1.0.0--hdfd78af_0 uri: while building SIF from layers: conveyor failed to get: invalid character '}' after top-level value
```
