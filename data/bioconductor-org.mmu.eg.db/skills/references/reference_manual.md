...
org.Mmu.egACCNUM is an R object that contains mappings between Entrez Gene identifiers and
...
# Convert to a list
xx <- as.list(org.Mmu.egACCNUM2EG)
...
org.Mmu.egALIAS is an R object that provides mappings between common gene symbol identifiers
...
Welcome to the org.Mmu.eg.db annotation Package. This is an organism specific package. The
purpose is to provide detailed information about the species abbreviated in the second part of the
package name org.Mmu.eg.db. This package is updated biannually.
...
org.Mmu.egCHR is an R object that provides mappings between entrez gene identifiers and the
...
org.Mmu.egCHRLENGTHS provides the length measured in base pairs for each of the chromo-
somes.
...
org.Mmu.egCHRLOC is an R object that maps entrez gene identifiers to the starting position of the
...
Mappings were based on data provided by: UCSC Genome Bioinformatics (Macaca mulatta)
ftp://hgdownload.cse.ucsc.edu/goldenPath/rheMac10/database With a date stamp from the source
of: UTC-Sep26
...
org.Mmu.egENSEMBL is an R object that contains mappings between Entrez Gene identifiers and
...
# Convert to a list
xx <- as.list(org.Mmu.egENSEMBL2EG)
if(length(xx) > 0){
...
org.Mmu.egENSEMBLPROT Map Ensembl protein acession numbers with Entrez Gene identifiers
...
org.Mmu.egENSEMBLTRANS

org.Mmu.egENSEMBLTRANS

Map Ensembl transcript acession numbers with Entrez Gene identi-
fiers
...
# Convert to a list
xx <- as.list(org.Mmu.egENSEMBLTRANS2EG)
if(length(xx) > 0){
...
org.Mmu.egENZYME is an R object that provides mappings between entrez gene identifiers and
EC numbers.
...
numbers. In org.Mmu.egENZYME2EG, EC is dropped from the Enzyme Commission numbers.
...
# For the reverse map:
# Convert to a list
xx <- as.list(org.Mmu.egENZYME2EG)
if(length(xx) > 0){
...
org.Mmu.egGENENAME is an R object that maps entrez gene identifiers to the corresponding gene
name.
...
org.Mmu.egGENETYPE is an R object that provides mappings between entrez gene identifiers and
gene types.
...
org.Mmu.egGO is an R object that provides mappings between entrez gene identifiers and the GO
...
org.Mmu.egGO2ALLEGS is an R object that provides mappings between a given GO identifier and
all of the Entrez Gene identifiers annotated at that GO term OR TO ONE OF IT’S CHILD NODES
in the GO ontology. Thus, this mapping is much larger and more inclusive than org.Mmu.egGO2EG.

Details

If org.Mmu.egGO is cast as a list, each Entrez Gene identifier is mapped to a list of lists. The
...
If org.Mmu.egGO2ALLEGS or org.Mmu.egGO2EG is cast as a list, each GO term maps to a named
...
# For org.Mmu.egGO2ALLEGS
xx <- as.list(org.Mmu.egGO2ALLEGS)
if(length(xx) > 0){
...
Number of mapped keys for the maps in package org.Mmu.eg.db

Description

org.Mmu.egMAPCOUNTS provides the "map count" (i.e. the count of mapped keys) for each map
in package org.Mmu.eg.db.
...
mapnames <- names(org.Mmu.egMAPCOUNTS)
org.Mmu.egMAPCOUNTS[mapnames[1]]
x <- get(mapnames[1])
sum(!is.na(as.list(x)))
count.mappedkeys(x)
...
## Check the "map count" of all the maps in package org.Mmu.eg.db
checkMAPCOUNTS("org.Mmu.eg.db")

org.Mmu.egORGANISM

The Organism for org.Mmu.eg

Description

org.Mmu.egORGANISM is an R object that contains a single item: a character string that names
the organism for which org.Mmu.eg was built.

Details

Although the package name is suggestive of the organism for which it was built, org.Mmu.egORGANISM
...
isms. org.Mmu.egPATH maps entrez gene identifiers to the identifiers used by KEGG for pathways
...
org.Mmu.egPMID is an R object that provides mappings between entrez gene identifiers and PubMed
identifiers.
...
org.Mmu.egREFSEQ is an R object that provides mappings between entrez gene identifiers and
RefSeq identifiers.
...
org.Mmu.egSYMBOL is an R object that provides mappings between entrez gene identifiers and
gene abbreviations.
...
org.Mmu.egUNIPROT is an R object that contains mappings between Entrez Gene identifiers and
...
org.Mmu.eg_dbconn()
org.Mmu.eg_dbfile()
org.Mmu.eg_dbschema(file="", show.indices=FALSE)
org.Mmu.eg_dbInfo()
...
org.Mmu.eg_dbconn returns a connection object to the package annotation DB. IMPORTANT:
Don’t call dbDisconnect on the connection object returned by org.Mmu.eg_dbconn or you will
break all the AnnDbObj objects defined in this package!
org.Mmu.eg_dbfile returns the path (character string) to the package annotation DB (this is an
SQLite file).
org.Mmu.eg_dbschema prints the schema definition of the package annotation DB.
org.Mmu.eg_dbInfo prints other information about the package annotation DB.
...
org.Mmu.eg_dbconn: a DBIConnection object representing an open connection to the package
annotation DB.
org.Mmu.eg_dbfile: a character string with the path to the package annotation DB.
org.Mmu.eg_dbschema: none (invisible NULL).
org.Mmu.eg_dbInfo: none (invisible NULL).
...
dbGetQuery(org.Mmu.eg_dbconn(), "SELECT COUNT(*) FROM genes")
...
org.Mmu.eg.db, 3
org.Mmu.eg_dbconn, 21
org.Mmu.egACCNUM, 1
org.Mmu.egALIAS2EG, 2
org.Mmu.egCHR, 3
org.Mmu.egCHRLENGTHS, 4
org.Mmu.egCHRLOC, 5
org.Mmu.egENSEMBL, 6
org.Mmu.egENSEMBLPROT, 7
org.Mmu.egENSEMBLTRANS, 8
org.Mmu.egENZYME, 9
org.Mmu.egGENENAME, 10
org.Mmu.egGENETYPE, 11
org.Mmu.egGO, 12
org.Mmu.egMAPCOUNTS, 14
org.Mmu.egORGANISM, 15
org.Mmu.egPATH, 15
org.Mmu.egPMID, 16
org.Mmu.egREFSEQ, 18
org.Mmu.egSYMBOL, 19
org.Mmu.egUNIPROT, 20
...
org.Mmu.eg (org.Mmu.eg.db), 3
org.Mmu.eg.db, 3
org.Mmu.eg_dbconn, 21

org.Mmu.eg_dbfile (org.Mmu.eg_dbconn),

21

org.Mmu.eg_dbInfo (org.Mmu.eg_dbconn),
...
org.Mmu.egACCNUM, 1
org.Mmu.egACCNUM2EG (org.Mmu.egACCNUM),
...
org.Mmu.egCHRLENGTHS, 4
org.Mmu.egCHRLOC, 5
org.Mmu.egCHRLOCEND (org.Mmu.egCHRLOC),

5
org.Mmu.egENSEMBL, 6
org.Mmu.egENSEMBL2EG

(org.Mmu.egENSEMBL), 6

org.Mmu.egENSEMBLPROT, 7
org.Mmu.egENSEMBLPROT2EG

(org.Mmu.egENSEMBLPROT), 7

org.Mmu.egENSEMBLTRANS, 8
org.Mmu.egENSEMBLTRANS2EG

(org.Mmu.egENSEMBLTRANS), 8

org.Mmu.egENZYME, 9
org.Mmu.egENZYME2EG (org.Mmu.egENZYME),
...
org.Mmu.egGENETYPE, 11
org.Mmu.egGO, 12
org.Mmu.egGO2ALLEGS, 13
org.Mmu.egGO2ALLEGS (org.Mmu.egGO), 12
org.Mmu.egGO2EG (org.Mmu.egGO), 12
org.Mmu.egMAPCOUNTS, 14
org.Mmu.egORGANISM, 15
org.Mmu.egPATH, 15
org.Mmu.egPATH2EG (org.Mmu.egPATH), 15
org.Mmu.egPMID, 16
org.Mmu.egPMID2EG (org.Mmu.egPMID), 16
org.Mmu.egREFSEQ, 18
org.Mmu.egREFSEQ2EG (org.Mmu.egREFSEQ),
...
org.Mmu.egSYMBOL2EG (org.Mmu.egSYMBOL),
