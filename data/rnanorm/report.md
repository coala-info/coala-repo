...
FATAL:   Unable to handle docker://quay.io/biocontainers/rnanorm:2.2.0--pyhdfd78af_1 uri: while building SIF from layers: conveyor failed to get: invalid character '}' after top-level value
```
