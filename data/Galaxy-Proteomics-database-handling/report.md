# Proteomics: database handling CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://training.galaxyproject.org
- **Package**: https://workflowhub.eu/workflows/1434
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1434/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 273
...
- **Main workflow (WorkflowHub):** `wf-database-handling.ga` (Main Workflow)
