# pbwt CWL Generation Report

## pbwt

### Tool Description
Positional Burrows-Wheeler Transform (PBWT) for genetic data analysis, including reading/writing various formats, phasing, and imputation.

### Metadata
- **Docker Image**: quay.io/biocontainers/pbwt:3.0--hed50d52_1
- **Homepage**: https://github.com/richarddurbin/pbwt
- **Package**: https://anaconda.org/channels/bioconda/packages/pbwt/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/pbwt/overview
- **Total Downloads**: 10.8K
- **Last updated**: 2025-04-22
- **GitHub**: https://github.com/richarddurbin/pbwt
- **Stars**: N/A
### Original Help Text
```text
