...
*Earth Mover’s Distance (EMD)* (Orlova et al. [2016](#ref-Orlova2016-jm)), a.k.a. *Wasserstein metric*
and, on the other hand, the metric *Multi Dimensional Scaling (MDS)* algorithm
for the low dimensional projection (Leeuw and Mair [2009](#ref-De_Leeuw2009-aw)).
...
cytometry (*CyTOF*) dataset from (Bodenmiller et al. [2012](#ref-Bodenmiller2012-re)), and provided in the
Bioconductor *HDCytoData* data package (Weber and Soneson ([2019](#ref-Weber2019-qp))).
...
recent work to benchmark differential analysis algorithms ((Weber et al. [2019](#ref-Weber2019-pz)))
and to design mass cytometry data analysis pipelines ((Nowicka et al. [2017](#ref-Nowicka2017-dh))).

In the `CytoMDS`package, as in the current vignette,
matrices of cytometry events intensities, corresponding to one sample,
are stored as `flowCore::flowFrame` (Ellis et al. [2023](#ref-flowCore)) objects.
...
Cell\_length, etc. In total, these mass cytometry samples contain intensities
...
((Nowicka et al. [2017](#ref-Nowicka2017-dh))).
...
Note that the *Smacof* algorithm (Leeuw and Mair [2009](#ref-De_Leeuw2009-aw)),
...
in the calculated pairwise distance matrix. **Of these 98.15%**,
...
## 5.4 Additional options for the MDS projection
...
# 7 Expression matrices as input instead of flowFrames
...
## Nb of points:  10
## Stress:  0.069832
## Pseudo RSquare:  0.968418
## Goodness of fit:  0.995123
```
...
##  [3] CytoMDS_1.6.1               HDCytoData_1.30.0
##  [5] flowCore_2.22.0             SummarizedExperiment_1.40.0
...
##   [1] splines_4.5.2        filelock_1.0.3       tibble_3.3.0
##   [4] polyclip_1.10-7      graph_1.88.0         XML_3.99-0.20
##   [7] rpart_4.1.24         lifecycle_1.0.4      httr2_1.2.1
##  [10] Rdpack_2.6.4         doParallel_1.0.17    flowWorkspace_4.22.0
...
##  [25] RColorBrewer_1.1-3   abind_1.4-8          ggcyto_1.38.0
...
##  [37] codetools_0.2-20     DelayedArray_0.36.0  ggforce_0.5.0
##  [40] tidyselect_1.2.1     shape_1.4.6.1        farver_2.1.2
##  [43] lme4_1.1-38          base64enc_0.1-3      jsonlite_2.0.0
##  [46] e1071_1.7-16         mitml_0.4-5          Formula_1.2-5
##  [49] survival_3.8-3       iterators_1.0.14     foreach_1.5.2
##  [52] tools_4.5.2          snow_0.4-4           Rcpp_1.1.0
##  [55] glue_1.8.0           gridExtra_2.3        pan_1.9
##  [58] SparseArray_1.10.6   xfun_0.54            dplyr_1.1.4
##  [61] withr_3.0.2          BiocManager_1.30.27  fastmap_1.2.0
##  [64] boot_1.3-32          digest_0.6.39        R6_2.6.1
##  [67] mice_3.18.0          colorspace_2.1-2     gtools_3.9.5
##  [70] dichromat_2.0-0.1    RSQLite_2.4.5        weights_1.1.2
##  [73] tidyr_1.3.1          hexbin_1.28.5        data.table_1.17.8
##  [76] class_7.3-23         httr_1.4.7           htmlwidgets_1.6.4
##  [79] S4Arrays_1.10.1      pkgconfig_2.0.3      gtable_0.3.6
##  [82] blob_1.2.4           RProtoBufLib_2.22.0  S7_0.2.1
##  [85] XVector_0.50.0       htmltools_0.5.9      bookdown_0.45
##  [88] scales_1.4.0         png_0.1-8            wordcloud_2.6
##  [91] reformulas_0.4.2     knitr_1.50           rstudioapi_0.17.1
##  [94] reshape2_1.4.5       checkmate_2.3.3      nlme_3.1-168
##  [97] curl_7.0.0           nloptr_2.2.1         proxy_0.4-27
## [100] cachem_1.1.0         stringr_1.6.0        BiocVersion_3.22.0
## [103] parallel_4.5.2       foreign_0.8-90       AnnotationDbi_1.72.0
## [106] pillar_1.11.1        grid_4.5.2           vctrs_0.6.5
## [109] cytolib_2.22.0       jomo_2.7-6           cluster_2.1.8.1
## [112] htmlTable_2.4.3      Rgraphviz_2.54.0     evaluate_1.0.5
## [115] tinytex_0.58         magick_2.9.0         cli_3.6.5
## [118] compiler_4.5.2       rlang_1.1.6          crayon_1.5.3
## [121] smacof_2.1-7         ncdfFlow_2.56.0      labeling_0.4.3
## [124] plyr_1.8.9           stringi_1.8.7        BiocParallel_1.44.0
## [127] nnls_1.6             Biostrings_2.78.0    glmnet_4.1-10
## [130] Matrix_1.7-4         bit64_4.6.0-1        CytoPipeline_1.10.0
## [133] KEGGREST_1.50.0      rbibutils_2.4        broom_1.0.11
...
Nowicka, Malgorzata, Carsten Krieg, Helena L Crowell, Lukas M Weber, Felix J Hartmann, Silvia Guglietta, Burkhard Becher, Mitchell P Levesque, and Mark D Robinson. 2017. “CyTOF Workflow: Differential Discovery in High-Throughput High-Dimensional Cytometry Datasets.” *F1000Res.* 6 (May): 748.
...
Weber, Lukas M, Malgorzata Nowicka, Charlotte Soneson, and Mark D Robinson. 2019. “Diffcyt: Differential Discovery in High-Dimensional Cytometry via High-Resolution Clustering.” *Commun Biol* 2 (May): 183.

Weber, Lukas M, and Charlotte Soneson. 2019. “HDCytoData: Collection of High-Dimensional Cytometry Benchmark Datasets in Bioconductor Object Formats.” *F1000Res.* 8 (August): 1459.