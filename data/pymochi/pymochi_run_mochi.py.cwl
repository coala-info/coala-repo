...
inputs:
  ...
  - id: downsample_observations
    ...
    doc: "number (if integer) or proportion (if float) of\n                      \
      \  observations to retain including WT"
    inputBinding:
      position: 101
  ...
  - id: fix_weights
    type:
      - 'null'
      - File
    doc: path to file of layer names to fix weights
    inputBinding:
      position: 101
      prefix: --fix_weights
  - id: holdout_minobs
  ...
  - id: holdout_orders
    ...
    doc: "comma-separated list of integer mutation orders\n                      \
      \  corresponding to retained variants"
    inputBinding:
      position: 101
