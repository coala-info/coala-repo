...
ragene20sttranscriptclusterACCNUM

Map Manufacturer identifiers to Accession Numbers

Description

ragene20sttranscriptclusterACCNUM is an R object that contains mappings between a manufac-
...
## Bimap interface:
x <- ragene20sttranscriptclusterACCNUM
...
ragene20sttranscriptclusterALIAS2PROBE
...
ragene20sttranscriptclusterALIAS is an R object that provides mappings between common gene
...
xx <- as.list(ragene20sttranscriptclusterALIAS2PROBE)
if(length(xx) > 0){
...
Welcome to the ragene20sttranscriptcluster.db annotation Package. The purpose of this package
is to provide detailed information about the ragene20sttranscriptcluster platform. This package is
updated biannually.
Objects in this package are accessed using the select() interface. See ?select in the AnnotationDbi
package for details.

ragene20sttranscriptclusterCHR
...
## use of select().
ls("package:ragene20sttranscriptcluster.db")
...
ragene20sttranscriptclusterCHR is an R object that provides mappings between a manufacturer
...
## Bimap interface:
x <- ragene20sttranscriptclusterCHR
...
ragene20sttranscriptclusterCHRLOC
...
ragene20sttranscriptclusterCHRLENGTHS

A named vector for the length of each of the chromosomes

Description

ragene20sttranscriptclusterCHRLENGTHS provides the length measured in base pairs for each of
the chromosomes.
...
## Bimap interface:
tt <- ragene20sttranscriptclusterCHRLENGTHS
...
ragene20sttranscriptclusterCHRLOC is an R object that maps manufacturer identifiers to the start-
...
ragene20sttranscriptclusterENSEMBL
...
## Bimap interface:
x <- ragene20sttranscriptclusterCHRLOC
...
ragene20sttranscriptclusterENSEMBL is an R object that contains mappings between manufacturer
...
ragene20sttranscriptclusterENTREZID
...
## Bimap interface:
x <- ragene20sttranscriptclusterENSEMBL
...
x <- ragene20sttranscriptclusterENSEMBL2PROBE
mapped_genes <- mappedkeys(x)
# Convert to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
ragene20sttranscriptclusterENTREZID is an R object that provides mappings between manufac-
turer identifiers and Entrez Gene identifiers.

ragene20sttranscriptclusterENZYME
...
## Bimap interface:
x <- ragene20sttranscriptclusterENTREZID
...
ragene20sttranscriptclusterENZYME is an R object that provides mappings between manufacturer
identifiers and EC numbers. ragene20sttranscriptclusterENZYME2PROBE is an R object that maps
...
When the ragene20sttranscriptclusterENZYME maping viewed as a list, each manufacturer identi-
...
For the ragene20sttranscriptclusterENZYME2PROBE, each EC number maps to a named vector
...
numbers. In ragene20sttranscriptclusterENZYME2PROBE, EC is dropped from the Enzyme Com-
mission numbers.
...
## Bimap interface:
x <- ragene20sttranscriptclusterENZYME
...
ragene20sttranscriptclusterGENENAME
...
# Now convert ragene20sttranscriptclusterENZYME2PROBE to a list to see inside
x <- ragene20sttranscriptclusterENZYME2PROBE
mapped_probes <- mappedkeys(x)
## convert to a list
xx <- as.list(x[mapped_probes][1:3])
if(length(xx) > 0){
...
ragene20sttranscriptclusterGENENAME is an R object that maps manufacturer identifiers to the
...
## Bimap interface:
x <- ragene20sttranscriptclusterGENENAME
# Get the probe identifiers that are mapped to a gene name
mapped_probes <- mappedkeys(x)

10

ragene20sttranscriptclusterGO
...
ragene20sttranscriptclusterGO is an R object that provides mappings between manufacturer iden-
tifiers and the GO identifiers that they are directly associated with. This mapping and its reverse
mapping (ragene20sttranscriptclusterGO2PROBE) do NOT associate the child terms from the GO
ontology with the gene. Only the directly evidenced terms are represented here.

ragene20sttranscriptclusterGO2ALLPROBES is an R object that provides mappings between a
...
than ragene20sttranscriptclusterGO2PROBE.

Details

If ragene20sttranscriptclusterGO is cast as a list, each manufacturer identifier is mapped to a list
...
If ragene20sttranscriptclusterGO2ALLPROBES or ragene20sttranscriptclusterGO2PROBE is cast
...
• ragene20sttranscriptclusterGO2ALLPROBES
• AnnotationDb-class for use of the select() interface.
...
## Bimap interface:
x <- ragene20sttranscriptclusterGO
...
# For the reverse map:
x <- ragene20sttranscriptclusterGO2PROBE
mapped_genes <- mappedkeys(x)
# Convert to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
ragene20sttranscriptclusterORGANISM

x <- ragene20sttranscriptclusterGO2ALLPROBES
mapped_genes <- mappedkeys(x)
# Convert ragene20sttranscriptclusterGO2ALLPROBES to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
ragene20sttranscriptclusterMAPCOUNTS
...
ragene20sttranscriptclusterMAPCOUNTS provides the "map count" (i.e. the count of mapped keys)
for each map in package ragene20sttranscriptcluster.db.
...
The Organism information for ragene20sttranscriptcluster

Description

ragene20sttranscriptclusterORGANISM is an R object that contains a single item: a character string
that names the organism for which ragene20sttranscriptcluster was built. ragene20sttranscriptclusterORGPKG
...
ragene20sttranscriptclusterPATH

13

Details

Although the package name is suggestive of the organism for which it was built, ragene20sttranscriptclusterORGANISM
provides a simple way to programmatically extract the organism name. ragene20sttranscriptclusterORGPKG
...
## Bimap interface:
ragene20sttranscriptclusterORGANISM
ragene20sttranscriptclusterORGPKG
...
ragene20sttranscriptclusterPATH maps probe identifiers to the identifiers used by KEGG for path-
ways in which the genes represented by the probe identifiers are involved

ragene20sttranscriptclusterPATH2PROBE is an R object that provides mappings between KEGG
...
ragene20sttranscriptclusterPFAM
...
## Bimap interface:
x <- ragene20sttranscriptclusterPATH
...
x <- ragene20sttranscriptclusterPATH
mapped_probes <- mappedkeys(x)
# Now convert the ragene20sttranscriptclusterPATH2PROBE object to a list
xx <- as.list(x[mapped_probes][1:300])
if(length(xx) > 0){
...
ragene20sttranscriptclusterPFAM is an R object that provides mappings between manufacturer
...
ragene20sttranscriptclusterPMID
...
ragene20sttranscriptclusterPMID is an R object that provides mappings between manufacturer iden-
tifiers and PubMed identifiers. ragene20sttranscriptclusterPMID2PROBE is an R object that pro-
vides mappings between PubMed identifiers and manufacturer identifiers.

Details

When ragene20sttranscriptclusterPMID is viewed as a list each manufacturer identifier is mapped
...
When ragene20sttranscriptclusterPMID2PROBE is viewed as a list each PubMed identifier is mapped
...
## Bimap interface:
x <- ragene20sttranscriptclusterPMID
...
ragene20sttranscriptclusterREFSEQ
...
x <- ragene20sttranscriptclusterPMID2PROBE
mapped_probes <- mappedkeys(x)
# Now convert the reverse map object ragene20sttranscriptclusterPMID2PROBE to a list
xx <- as.list(x[mapped_probes][1:300])
if(length(xx) > 0){
...
ragene20sttranscriptclusterPROSITE

Maps between Manufacturer Identifiers and PROSITE Identifiers

Description

ragene20sttranscriptclusterPROSITE is an R object that provides mappings between manufacturer
...
ragene20sttranscriptclusterREFSEQ is an R object that provides mappings between manufacturer
...
## Bimap interface:
x <- ragene20sttranscriptclusterREFSEQ
...
ragene20sttranscriptclusterSYMBOL
...
ragene20sttranscriptclusterSYMBOL is an R object that provides mappings between manufacturer
...
ragene20sttranscriptclusterUNIPROT
...
ragene20sttranscriptclusterUNIPROT is an R object that contains mappings between the manufac-
...
## Bimap interface:
x <- ragene20sttranscriptclusterUNIPROT
...
ragene20sttranscriptcluster_dbconn
...
ragene20sttranscriptcluster_dbconn()
ragene20sttranscriptcluster_dbfile()
ragene20sttranscriptcluster_dbschema(file="", show.indices=FALSE)
...
ragene20sttranscriptcluster_dbconn returns a connection object to the package annotation
DB. IMPORTANT: Don’t call dbDisconnect on the connection object returned by ragene20sttranscriptcluster_dbconn
or you will break all the AnnDbObj objects defined in this package!
ragene20sttranscriptcluster_dbfile returns the path (character string) to the package anno-
tation DB (this is an SQLite file).
ragene20sttranscriptcluster_dbschema prints the schema definition of the package annotation
DB.
ragene20sttranscriptcluster_dbInfo prints other information about the package annotation
DB.

Value

ragene20sttranscriptcluster_dbconn: a DBIConnection object representing an open connec-
tion to the package annotation DB.
ragene20sttranscriptcluster_dbfile: a character string with the path to the package annota-
tion DB.
ragene20sttranscriptcluster_dbschema: none (invisible NULL).
ragene20sttranscriptcluster_dbInfo: none (invisible NULL).
...
dbGetQuery(ragene20sttranscriptcluster_dbconn(), "SELECT COUNT(*) FROM probes")
...
ragene20sttranscriptcluster.db, 2
ragene20sttranscriptcluster_dbconn,
...
ragene20sttranscriptclusterCHR, 3
ragene20sttranscriptclusterCHRLENGTHS,
...
ragene20sttranscriptclusterGO, 10
ragene20sttranscriptclusterMAPCOUNTS,
...
ragene20sttranscriptcluster.db, 2
ragene20sttranscriptcluster_dbconn, 19
ragene20sttranscriptcluster_dbfile
...
ragene20sttranscriptclusterACCNUM, 1
ragene20sttranscriptclusterALIAS2PROBE,
...
ragene20sttranscriptclusterCHRLOC, 4
ragene20sttranscriptclusterCHRLOCEND

(ragene20sttranscriptclusterCHRLOC),
4

ragene20sttranscriptclusterENSEMBL, 5
ragene20sttranscriptclusterENSEMBL2PROBE

(ragene20sttranscriptclusterENSEMBL),
5

ragene20sttranscriptclusterENTREZID, 6
ragene20sttranscriptclusterENZYME, 7

22

INDEX

ragene20sttranscriptclusterENZYME2PROBE

(ragene20sttranscriptclusterENZYME),
7

ragene20sttranscriptclusterGENENAME, 9
ragene20sttranscriptclusterGO, 10
ragene20sttranscriptclusterGO2ALLPROBES,
...
ragene20sttranscriptclusterGO2PROBE

(ragene20sttranscriptclusterGO),
10

ragene20sttranscriptclusterLOCUSID
...
ragene20sttranscriptclusterPATH, 13
ragene20sttranscriptclusterPATH2PROBE

(ragene20sttranscriptclusterPATH),
13

ragene20sttranscriptclusterPFAM, 14
ragene20sttranscriptclusterPMID, 15
ragene20sttranscriptclusterPMID2PROBE

(ragene20sttranscriptclusterPMID),
15

ragene20sttranscriptclusterPROSITE, 16
ragene20sttranscriptclusterREFSEQ, 16
ragene20sttranscriptclusterSYMBOL, 18
ragene20sttranscriptclusterUNIPROT, 19
ragene20sttranscriptclusterUNIPROT2PROBE
