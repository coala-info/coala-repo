...
inputs:
  ...
  - id: all_alignments
    type:
      - 'null'
      - boolean
    doc: report all alignments per read
    inputBinding:
      position: 103
      prefix: --all
  - id: best
  ...
  - id: ff_mates
    type:
      - 'null'
      - boolean
    doc: mates align forward/forward
    inputBinding:
      position: 103
      prefix: --ff
  - id: fr_mates
    type:
      - 'null'
      - boolean
    doc: mates align forward/reverse
    inputBinding:
      position: 103
      prefix: --fr
  - id: fullref
  ...
  - id: max_mismatches_end_to_end
    type:
      - 'null'
      - int
    doc: report end-to-end hits with <=v mismatches; ignore qualities
    inputBinding:
      position: 103
      prefix: -v
  ...
  - id: rf_mates
    type:
      - 'null'
      - boolean
    doc: mates align reverse/forward
    inputBinding:
      position: 103
      prefix: --rf
  - id: sam_RG
