...
* AMPtk OTU Table Filtering
* [Edit on GitHub](https://github.com/nextgenusfs/amptk/blob/master/docs/filtering.rst)

---

# AMPtk OTU Table Filtering[¶](#amptk-otu-table-filtering "Link to this heading")
...
[Previous](clustering.html "AMPtk Clustering")
[Next](taxonomy.html "AMPtk Taxonomy")
