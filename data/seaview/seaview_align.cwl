...
baseCommand: seaview
label: seaview_align
doc: "seaview [options] [alignment-or-tree-file]\nwhere alignment-or-tree-file is
  an optional sequence alignment or tree file to be read (always the last argument)
...
inputs:
  ...
  - id: concatenate_output_format
    ...
    inputBinding:
      position: 102
      prefix: -output_format
  - id: concatenate_record_partition
    type:
      - 'null'
      - boolean
  ...
  - id: convert_bootstrap
    ...
    inputBinding:
      position: 102
      prefix: -bootstrap
  - id: convert_def_site_selection
    type:
      - 'null'
      - string
    doc: "create a selection of sites of given name and endpoints\n              \
      \    (site selection endpoints are expressed as in this example: 10-200,305,310-342)"
    inputBinding:
      position: 102
      prefix: -def_site_selection
  - id: convert_def_species_group
    type:
      - 'null'
      - string
    doc: "create a species group of given name and members\n                  (species
      group members are expressed with their ranks as in this example: 3-8,12,19)"
    inputBinding:
      position: 102
      prefix: -def_species_group
  - id: convert_del_gap_only_sites
    type:
      - 'null'
      - boolean
  ...
  - id: convert_gblocks_allow_gaps
    ...
    inputBinding:
      position: 102
      prefix: -b5
  - id: convert_gblocks_allow_smaller_blocks
    type:
      - 'null'
      - boolean
    ...
    inputBinding:
      position: 102
      prefix: -b4
  - id: convert_gblocks_less_strict_flanking
    type:
      - 'null'
      - boolean
    ...
    inputBinding:
      position: 102
      prefix: -b2
  - id: convert_gblocks_no_contiguous_nonconserved
    type:
      - 'null'
      - boolean
