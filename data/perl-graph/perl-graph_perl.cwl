...
baseCommand: perl
label: perl-graph_perl
doc: "The Perl 5 language interpreter\n\nTool homepage: http://metacpan.org/pod/Graph"
inputs:
  - id: program_file
    type:
      - 'null'
...
hints:
  - class: DockerRequirement
    dockerPull: quay.io/biocontainers/perl-graph:0.9735--pl5321hdfd78af_0
stdout: perl-graph_perl.out
