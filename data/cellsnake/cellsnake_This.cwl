...
inputs:
  ...
  - id: doublet_filter
    type:
      - 'null'
      - boolean
    doc: 'Doublet filtering. [default: True] #this may fail on some samples and on
      low memory. If you have a problem, try False.'
    inputBinding:
      position: 103
