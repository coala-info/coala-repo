...
baseCommand: epydoc
label: epydoc_html
doc: "epydoc is a tool for automatically generating API documentation for Python modules.\n\
...
inputs:
  - id: action
    type:
      - 'null'
      - string
    doc: The action to perform (e.g., --html, --text, --latex)
    inputBinding:
      position: 1
  - id: names
    type:
      type: array
      items: string
    doc: The Python modules, classes, or functions to document
    inputBinding:
      position: 2
  - id: check
    type:
  ...
  - id: graph
    type:
      ...
      - type: array
        items: string
    doc: 'Include graphs of type GRAPHTYPE in the generated output. GRAPHTYPE should
      be one of: all, classtree, callgraph, umlclasstree.'
    inputBinding:
      position: 103
      prefix: --graph
  - id: graph_font
