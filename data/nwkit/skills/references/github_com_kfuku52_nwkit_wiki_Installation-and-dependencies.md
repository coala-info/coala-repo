...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fkfuku52%2Fnwkit%2Fwiki%2FInstallation-and-dependencies)
...
Kenji Fukushima edited this page Mar 13, 2026
·
[3 revisions](/kfuku52/nwkit/wiki/Installation-and-dependencies/_history)

## Installation

NWKIT runs on [python 3](https://www.python.org/) and uses [pip](https://pypi.org/project/pip/) for installation.
...
* [ete4](https://github.com/etetoolkit/ete) (v4.4.0 or later)
* [biopython](https://biopython.org/)
* [pandas](https://pandas.pydata.org/)
* [requests](https://requests.readthedocs.io/)
* [numpy](https://numpy.org/)

## Optional dependencies for `nwkit image`

Image post-processing options such as `--output_format`, `--max_edge`, `--canvas`, and `--trim` require the optional image extras:
...
* Loading
  ...
  + [Installation](/kfuku52/nwkit/wiki/Installation-and-dependencies#installation)
  + [Dependencies](/kfuku52/nwkit/wiki/Installation-and-dependencies#dependencies)
  + [Optional dependencies for nwkit image](/kfuku52/nwkit/wiki/Installation-and-dependencies#optional-dependencies-for-nwkit-image)
* Loading
