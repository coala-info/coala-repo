...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2FUSDA-VS%2FvSNP%2Fblob%2Fmaster%2FREADME.md)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fblob%2Fshow&source=header-repo&source_repo=USDA-VS%2FvSNP)
...
[History](/USDA-VS/vSNP/commits/master/README.md)

History

113 lines (66 loc) · 4.61 KB
...
[Raw](https://github.com/USDA-VS/vSNP/raw/refs/heads/master/README.md)
...
1. `vSNP_step1.py` takes as input single or paired FASTQ files and either a reference FASTA or directory name containing the reference FASTA (see vsnp\_path\_adder.py below). For Mycobacterium tuberculosis complex and Brucella species, if no FASTA file or directory name is provided a "best reference" is automatically selected
...
macOS users may need to follow these [special instructions for Samtools](/USDA-VS/vSNP/blob/master/docs/macOS_special_instructions.md).
...
[![](/USDA-VS/vSNP/raw/master/dependencies/directory_screen_shot.png)](/USDA-VS/vSNP/blob/master/dependencies/directory_screen_shot.png)
...
See [help](/USDA-VS/vSNP/blob/master/docs/run_guidance.md) running multiple samples at once.
...
[![](/USDA-VS/vSNP/raw/master/dependencies/step1_screenshot.png)](/USDA-VS/vSNP/blob/master/dependencies/step1_screenshot.png)

[![](/USDA-VS/vSNP/raw/master/dependencies/step2_screenshot.png)](/USDA-VS/vSNP/blob/master/dependencies/step2_screenshot.png)

# Procedure Detail:

Procedure detail is [here](/USDA-VS/vSNP/blob/master/docs/detailed_usage.md).

# Utility Scripts:

vSNP [utility scripts](/USDA-VS/vSNP/blob/master/docs/utilities.md).
