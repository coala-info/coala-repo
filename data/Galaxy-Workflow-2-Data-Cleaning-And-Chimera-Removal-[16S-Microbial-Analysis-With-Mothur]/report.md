# Workflow 2: Data Cleaning And Chimera Removal [16S Microbial Analysis With Mothur] CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://www.qcif.edu.au/
- **Package**: https://workflowhub.eu/workflows/649
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/649/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 743
...
- **Main workflow (WorkflowHub):** `Galaxy-Workflow-Workflow_2_[gucfg2galaxy]__Data_Cleaning_And_Chimera_Removal_[16S_Microbial_Analysis_With_Mothur].ga` (Main Workflow)
- **Project**: QCIF Bioinformatics
- **Views**: 7234
