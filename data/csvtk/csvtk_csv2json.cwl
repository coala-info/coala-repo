...
inputs:
  ...
  - id: indent
    type:
      - 'null'
      - string
    doc: indent. if given blank, output json in one line.
    default: '  '
    inputBinding:
      position: 101
      prefix: --indent
  ...
  - id: key
    type:
      - 'null'
      - string
    doc: output json as an array of objects keyed by a given field rather than as
      a list. e.g -k 1 or -k columnA
    inputBinding:
      position: 101
      prefix: --key
  - id: lazy_quotes
  ...
  - id: parse_num
    type:
      ...
      - type: array
        items: string
    doc: parse numeric values for nth column, multiple values are supported and "a"/"all"
      for all columns
    inputBinding:
      position: 101
      prefix: --parse-num
