...
The majority of NCBI data are available for downloading, either directly from the NCBI FTP site or
by using software tools to download custom datasets.

![](../pageimg/download.jpg)
...
* [How to download custom data sets](/guide/howto/dwn-records/)
* [Large Data Download Best Practices](/books/NBK51061/)
* [SRA Download Reference](/books/NBK56556/)
