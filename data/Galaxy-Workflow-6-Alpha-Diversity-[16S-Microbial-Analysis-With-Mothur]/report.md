# Workflow 6: Alpha Diversity [16S Microbial Analysis With Mothur] CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://www.qcif.edu.au/
- **Package**: https://workflowhub.eu/workflows/652
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/652/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 740
...
- **Main workflow (WorkflowHub):** `Galaxy-Workflow-Workflow_6_[gucfg2galaxy]__Alpha_Diversity_[16S_Microbial_Analysis_With_Mothur].ga` (Main Workflow)
