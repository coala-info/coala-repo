...
* [.rst](_sources/configs.rst "Download source file")
* .pdf
...
* [Changing the organism to mouse](#changing-the-organism-to-mouse)

# Config Files (Parameter Files)[#](#config-files-parameter-files "Permalink to this headline")
...
## Changing the organism to mouse[#](#changing-the-organism-to-mouse "Permalink to this headline")
...
How to draw marker plots](markers.html "previous page")
[next

Options and Arguments](options.html "next page")
