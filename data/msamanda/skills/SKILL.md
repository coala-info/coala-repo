---
name: msamanda
description: MS Amanda is a high-performance scoring system designed to identify peptides from tandem mass spectrometry data by searching against known protein databases.
