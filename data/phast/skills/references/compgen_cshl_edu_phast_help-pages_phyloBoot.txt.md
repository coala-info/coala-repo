...
If a model is given in the form of a .mod file (), then
...
phyloBoot --nreps 500 --nsites 10000 mymodel.mod > par\_errors
...
alignments and estimating parameters. fname\_list can be comma-
...
to the program (|) will be ignored.
--output-average, -A
...
three columns: numSite,scale,subtree\_scale. For each row in the
