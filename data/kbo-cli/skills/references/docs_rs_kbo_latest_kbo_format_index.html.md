...
* kbo-0.5.1
  ...
  + kbo 0.5.1
  + [Permalink](/kbo/0.5.1/kbo/format/ "Get a link to this specific version")
...
* Platform
  + [aarch64-apple-darwin](/crate/kbo/latest/target-redirect/aarch64-apple-darwin/kbo/format/)
  + [aarch64-unknown-linux-gnu](/crate/kbo/latest/target-redirect/aarch64-unknown-linux-gnu/kbo/format/)
  + [x86\_64-unknown-linux-gnu](/crate/kbo/latest/target-redirect/kbo/format/)
...
[Source](../../src/kbo/format.rs.html#14-331)
...
[RLE](struct.RLE.html "struct kbo::format::RLE")
:   Run length encoding for an alignment segment

## Functions[§](#functions)

[relative\_to\_ref](fn.relative_to_ref.html "fn kbo::format::relative_to_ref")
:   Format an alignment relative to the reference sequence.

[run\_lengths](fn.run_lengths.html "fn kbo::format::run_lengths")
:   Extracts run length encodings from a translated alignment.

[run\_lengths\_gapped](fn.run_lengths_gapped.html "fn kbo::format::run_lengths_gapped")
