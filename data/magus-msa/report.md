...
FATAL:   Unable to handle docker://quay.io/biocontainers/magus-msa:0.2.0--pyhdfd78af_0 uri: while building SIF from layers: unable to create new build: failed to create build parent dir: mkdir /tmp/build-temp-1980011401: no space left on device
```
