...
doc: "Cerberus is a pipeline for the identification of viral sequences in metagenomic
...
inputs:
  ...
  - id: db_path
    type:
      - 'null'
      - Directory
    doc: 'Path to folder of databases [Default: under the library path of Cerberus]'
    inputBinding:
      position: 101
      prefix: --db-path
  - id: dir_out
