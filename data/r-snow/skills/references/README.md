...
and each such host should define the variable R\_SNOW\_LIB as the
...
setenv R\_SNOW\_LIB $HOME/SNOW/R/lib
...
define the environment variable R\_SNOW\_RSCRIPT\_CMD to the path for
