...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fneherlab%2Ftreetime%2Fblob%2Fmaster%2FMakefile)
...
[History](/neherlab/treetime/commits/master/Makefile)
...
[Raw](https://github.com/neherlab/treetime/raw/refs/heads/master/Makefile)
...
MAKE\_NOPRINT := $(MAKE) --no-print-directory
...
@parallel --jobs=0 --line-buffer --tag "$(MAKE\_NOPRINT) {}" ::: \
...
$(call RUN\_COLOR, PYTHONPATH=. pylint --fail-under=10.0 --output-format=pylint\_source\_reporter.SourceCodeReporter treetime)

lint-ruff-check:

$(call RUN\_COLOR, ruff check -q treetime)

lint-ruff-format:

$(call RUN\_COLOR, ruff format -q --check treetime)

lint-pyright:

$(call RUN\_COLOR, pyright)
...
export DOCS\_CONTAINER\_NAME=treetime-docs

export UID=$(shell id -u)

export GID=$(shell id -g)

docker build -t $${DOCS\_CONTAINER\_NAME} \
...
--name=$${DOCS\_CONTAINER\_NAME}-$(shell date +%s) \
