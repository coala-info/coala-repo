...
FATAL:   Unable to handle docker://quay.io/biocontainers/umitools:0.3.4--py36_0 uri: while building SIF from layers: conveyor failed to get: invalid character '}' after top-level value
```
