...
The pull-down menus in affylmGUI are defined in `affylmGUI-menus.txt` in the `etc`
subdirectory of the `affylmGUI` package installation. To find out exactly where this directory
...
Try uncommenting (i.e. removing the # from) the histogram menu item in `affylmGUI-menus.txt`
