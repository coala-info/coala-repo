...
The only prerequisite is that Bin Chicken is fully installed and setup as per the [installation](/binchicken/installation) and [setup](/binchicken/setup) instructions.
...
The taxa of interest can be specified using the `--taxa-of-interest` option, and must match GTDB taxonomy (e.g. p\_\_Planctomycetota, or 'p\_\_Bacillota|p\_\_Bacteroidota').
...
* [Demo](#demo)
* [Single-sample assembly with co-binning](#single-sample-assembly-with-co-binning)
* [Iterative coassembly with co-binning](#iterative-coassembly-with-co-binning)
* [Taxonomy targeting](#taxonomy-targeting)
* [Coassembly with co-binning](#coassembly-with-co-binning)
* [Testing](#testing)
