...
baseCommand:
  - gatk
  - LocalAssembler
label: gatk_LocalAssembler
doc: Performs local assembly of small regions to discover structural variants.
inputs:
  - id: assembly_name
    type: string
    doc: Name of assembly used as a prefix for traversal names.
    inputBinding:
      position: 101
  ...
  - id: fasta_file
    type:
      - 'null'
      - File
    doc: Path to scaffolds in fasta format.
    inputBinding:
      position: 101
      prefix: --fasta-file
  - id: gatk_config_file
  ...
  - id: gfa_file
    type: string
    doc: Path to assembly output in gfa format.
    inputBinding:
      position: 101
      prefix: --gfa-file
  ...
  - id: min_gapfill_count
    type:
      - 'null'
      - int
    doc: Minimum number of observations of a sequence that patches a gap.
    inputBinding:
      position: 101
      prefix: --min-gapfill-count
  - id: min_sv_size
    type:
      - 'null'
      - int
    doc: Smallest variation size to count as a structural variant.
    inputBinding:
      position: 101
      prefix: --min-sv-size
  - id: min_thin_observations
    type:
      - 'null'
      - int
    doc: Minimum number of observations of some kmer within the contig required 
      to retain the contig.
    inputBinding:
      position: 101
      prefix: --min-thin-observations
  - id: no_scaffolding
    type:
      - 'null'
      - boolean
    doc: turn off scaffolding -- write traversals instead
    inputBinding:
      position: 101
      prefix: --no-scaffolding
  - id: pair_padding
    type:
      - 'null'
      - int
    doc: Amount of extra padding (in bp) to add to pick up mates near your 
      intervals.
    inputBinding:
      position: 101
      prefix: --pair-padding
  - id: q_min
    type:
      - 'null'
      - int
    doc: Minimum base quality when kmerizing reads.
    inputBinding:
      position: 101
      prefix: --q-min
  - id: quiet
  ...
  - id: tmp_dir
    ...
    inputBinding:
      position: 101
      prefix: --tmp-dir
  - id: too_many_scaffolds
    type:
      - 'null'
      - int
    doc: If the assembly graph produces this many scaffolds, just emit 
      traversals instead.
    inputBinding:
      position: 101
      prefix: --too-many-scaffolds
  - id: too_many_traversals
    type:
      - 'null'
      - int
    doc: If the assembly graph produces this many traversals, just emit contigs 
      instead.
    inputBinding:
      position: 101
      prefix: --too-many-traversals
  - id: use_jdk_deflater
    type:
      - 'null'
      - boolean
