...
* [Testing Framework](testing.html)[x]
...
[Edit this page](https://github.com/WayScience/CytoSnake/edit/master/docs/func-tests.md "Edit this page")

Toggle Light / Dark / Auto color theme

Toggle table of contents sidebar

# Functional Tests[#](#functional-tests "Permalink to this heading")
...
## Rational[#](#rational "Permalink to this heading")
...
## Functional Testing Environment[#](#functional-testing-environment "Permalink to this heading")
...
This illustration introduces four fundamental components: the `CytoSnake` module(shown in blue-green), prepare\_data function (shown in light-green), functional test module (shown in yellow), and fixture (shown in red) working together.
...
## Submitting Tests[#](#submitting-tests "Permalink to this heading")
...
### Understanding the main steps of CytoSnake’s Functional Tests[#](#understanding-the-main-steps-of-cytosnake-s-functional-tests "Permalink to this heading")
...
#### Execution[#](#execution "Permalink to this heading")
...
### Output Check[#](#output-check "Permalink to this heading")
...
## Ending Remarks[#](#ending-remarks "Permalink to this heading")
