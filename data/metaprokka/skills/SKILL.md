---
name: metaprokka
description: Metaprokka is a specialized version of the Prokka annotation pipeline designed to handle the unique challenges of viral and metagenomic data.
