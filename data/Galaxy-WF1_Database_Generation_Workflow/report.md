# WF1_Database_Generation_Workflow CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://training.galaxyproject.org
- **Package**: https://workflowhub.eu/workflows/1474
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1474/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 256
...
- **Main workflow (WorkflowHub):** `wf1-database-generation-workflow.ga` (Main Workflow)
...
Generating a large database and then reducing it to a compact database using Metanovo
