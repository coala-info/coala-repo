...
label: gatk_CollectJumpingLibraryMetrics
doc: Collect jumping library metrics. This tool collects high-level metrics 
  about the presence of outward-facing (jumping) and inward-facing (non-jumping)
  read pairs within a SAM/BAM/CRAM file.
inputs:
  - id: input
    type:
      type: array
