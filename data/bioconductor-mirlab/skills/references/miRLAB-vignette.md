...
1. collecting matched miRNA and mRNA expression profiles in a specific condition, e.g. a cancer dataset from TCGA,
2. applying the new computational method to the selected dataset,
3. validating the predictions against knowledge from literature and third-party databases, and
4. comparing the performance of the method with some existing methods.
