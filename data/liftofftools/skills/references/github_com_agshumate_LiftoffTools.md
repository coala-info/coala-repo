...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fagshumate%2FLiftoffTools)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E&source=header-repo&source_repo=agshumate%2FLiftoffTools)
...
[Branches](/agshumate/LiftoffTools/branches)[Tags](/agshumate/LiftoffTools/tags)
...
| --- | --- | --- | --- | --- |
| Latest commit   History[41 Commits](/agshumate/LiftoffTools/commits/master/)   41 Commits | | |
| [liftofftools](/agshumate/LiftoffTools/tree/master/liftofftools "liftofftools") | | [liftofftools](/agshumate/LiftoffTools/tree/master/liftofftools "liftofftools") |  |  |
| [LICENSE.md](/agshumate/LiftoffTools/blob/master/LICENSE.md "LICENSE.md") | | [LICENSE.md](/agshumate/LiftoffTools/blob/master/LICENSE.md "LICENSE.md") |  |  |
| [README.md](/agshumate/LiftoffTools/blob/master/README.md "README.md") | | [README.md](/agshumate/LiftoffTools/blob/master/README.md "README.md") |  |  |
| [setup.py](/agshumate/LiftoffTools/blob/master/setup.py "setup.py") | | [setup.py](/agshumate/LiftoffTools/blob/master/setup.py "setup.py") |  |  |
| View all files | | |
...
By default, all output files will be written to a directory within the current working directory called liftofftools\_output. This can be changed with the -dir parameter. By default LiftoffTools will not overwrite files in the output directory. To enable overwrite, use the -force option.
...
The output of the variants module is a file called 'variant\_effects' located in the output directory (liftofftools\_output by default). This is a tab separated file with the following fields.
...
The first output of the synteny module is a dot plot called gene\_order\_plot.pdf located in the output directory (liftofftools\_output by default).
...
The second output of the synteny module is a tab separated file called 'gene\_order' located in the output directory. If the -edit\_distance option is used,