...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Flczech%2Fgrenedalf%2Fwiki%2FSubcommand%3A-frequency)
...
·
[40 revisions](/lczech/grenedalf/wiki/Subcommand%3A-frequency/_history)

|  |  |
| --- | --- |
| **Synopsis:** Create a table with per-sample and/or total base counts and/or frequencies at positions in the genome.  **Usage:** `grenedalf frequency [options]`  Documentation for grenedalf v0.6.3 | **Table of contents:**   * [Options](#options)   + [Input SAM/BAM/CRAM](#input-sambamcram)   + [Input (m)pileup](#input-mpileup)   + [Input sync](#input-sync)   + [Input VCF/BCF](#input-vcfbcf)   + [Input frequency table](#input-frequency-table)   + [Input Settings](#input-settings)   + [Sample Names, Groups, and Filters](#sample-names-groups-and-filters)   + [Region Filters](#region-filters)   + [Masking Filters](#masking-filters)   + [Settings](#settings)   + [Formatting](#formatting)   + [Output](#output)   + [Global Options](#global-options) * [Citation](#citation) |
...
:   `TEXT Needs: --frequency-table-path`
    Specify the name of the chromosome column in the header, case sensitive. By default, we look for columns named "chromosome", "chrom", "chr", or 