...
[Skip to content](#set-up-a-snakemake-profile)
...
* [ ]
  ...
  Table of contents
  + [For SLURM based clusters:](#for-slurm-based-clusters)
  + [For SGE based clusters:](#for-sge-based-clusters)
  + [Example SLURM profile:](#example-slurm-profile)
* [Hints and Tips](../tips/)
...
# Set-up a Snakemake profile[¶](#set-up-a-snakemake-profile "Permanent link")
...
### For SLURM based clusters:[¶](#for-slurm-based-clusters "Permanent link")
...
### For SGE based clusters:[¶](#for-sge-based-clusters "Permanent link")
...
### Example SLURM profile:[¶](#example-slurm-profile "Permanent link")
