...
Version 1.0 of `RTCGA.mRNA` package contains mRNA datasets which were released `2015-11-01`. They were downloaded in the following way (which is mainly copied from <http://rtcga.github.io/RTCGA/>:
