...
inputs:
  ...
  - id: N
    type:
      - 'null'
      - int
    doc: Threshold value for commands like less-than, greater-than, equal-to, 
      not-equal-to
    inputBinding:
      position: 2
  - id: X
    type:
      - 'null'
      - float
    doc: Value for arithmetic operations like increase, decrease, multiply, 
      divide, modulo
    inputBinding:
      position: 3
  - id: input_files
    type:
      ...
      - type: array
        items: File
    doc: Input files for the command. The number and type of input files depend 
      on the command.
    inputBinding:
      position: 4
  - id: compress
