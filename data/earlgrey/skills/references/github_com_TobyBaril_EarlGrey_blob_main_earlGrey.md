...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2FTobyBaril%2FEarlGrey%2Fblob%2Fmain%2FearlGrey)
...
[History](/TobyBaril/EarlGrey/commits/main/earlGrey)
...
[Raw](https://github.com/TobyBaril/EarlGrey/raw/refs/heads/main/earlGrey)
...
famdb.py -i $libpath families -f fasta\_name --include-class-in-name -a -d --curated $RepSpec > ${OUTDIR}/${species}\_Curated\_Library/${RepSpec}.RepeatMasker.lib

RepSub=${OUTDIR}/${species}\_Curated\_Library/${RepSpec}.RepeatMasker.lib
...
RepeatMasker -species $RepSpec -no\_is -lcambig -s -a -pa $rmthreads -dir $OUTDIR/${species}\_RepeatMasker $genome
