...
mogene10sttranscriptclusterACCNUM

Map Manufacturer identifiers to Accession Numbers

Description

mogene10sttranscriptclusterACCNUM is an R object that contains mappings between a manufac-
...
mogene10sttranscriptclusterALIAS2PROBE
...
mogene10sttranscriptclusterALIAS is an R object that provides mappings between common gene
...
xx <- as.list(mogene10sttranscriptclusterALIAS2PROBE)
if(length(xx) > 0){
...
Welcome to the mogene10sttranscriptcluster.db annotation Package. The purpose of this package
is to provide detailed information about the mogene10sttranscriptcluster platform. This package is
updated biannually.
Objects in this package are accessed using the select() interface. See ?select in the AnnotationDbi
package for details.

mogene10sttranscriptclusterCHR
...
mogene10sttranscriptclusterCHR is an R object that provides mappings between a manufacturer
...
## Bimap interface:
x <- mogene10sttranscriptclusterCHR
...
mogene10sttranscriptclusterCHRLOC
...
mogene10sttranscriptclusterCHRLENGTHS

A named vector for the length of each of the chromosomes

Description

mogene10sttranscriptclusterCHRLENGTHS provides the length measured in base pairs for each of
the chromosomes.
...
## Bimap interface:
tt <- mogene10sttranscriptclusterCHRLENGTHS
...
mogene10sttranscriptclusterCHRLOC is an R object that maps manufacturer identifiers to the start-
...
mogene10sttranscriptclusterENSEMBL
...
## Bimap interface:
x <- mogene10sttranscriptclusterCHRLOC
...
mogene10sttranscriptclusterENSEMBL is an R object that contains mappings between manufac-
...
mogene10sttranscriptclusterENTREZID
...
x <- mogene10sttranscriptclusterENSEMBL2PROBE
mapped_genes <- mappedkeys(x)
# Convert to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
mogene10sttranscriptclusterENTREZID is an R object that provides mappings between manufac-
turer identifiers and Entrez Gene identifiers.

mogene10sttranscriptclusterENZYME
...
mogene10sttranscriptclusterENZYME is an R object that provides mappings between manufacturer
identifiers and EC numbers. mogene10sttranscriptclusterENZYME2PROBE is an R object that
...
When the mogene10sttranscriptclusterENZYME maping viewed as a list, each manufacturer identi-
...
For the mogene10sttranscriptclusterENZYME2PROBE, each EC number maps to a named vector
...
bers. In mogene10sttranscriptclusterENZYME2PROBE, EC is dropped from the Enzyme Commis-
sion numbers.
...
## Bimap interface:
x <- mogene10sttranscriptclusterENZYME
...
mogene10sttranscriptclusterGENENAME
...
# Now convert mogene10sttranscriptclusterENZYME2PROBE to a list to see inside
x <- mogene10sttranscriptclusterENZYME2PROBE
mapped_probes <- mappedkeys(x)
## convert to a list
xx <- as.list(x[mapped_probes][1:3])
if(length(xx) > 0){
...
mogene10sttranscriptclusterGENENAME is an R object that maps manufacturer identifiers to the
...
## Bimap interface:
x <- mogene10sttranscriptclusterGENENAME
# Get the probe identifiers that are mapped to a gene name
mapped_probes <- mappedkeys(x)

10

mogene10sttranscriptclusterGO
...
mogene10sttranscriptclusterGO is an R object that provides mappings between manufacturer iden-
tifiers and the GO identifiers that they are directly associated with. This mapping and its reverse
mapping (mogene10sttranscriptclusterGO2PROBE) do NOT associate the child terms from the GO
ontology with the gene. Only the directly evidenced terms are represented here.

mogene10sttranscriptclusterGO2ALLPROBES is an R object that provides mappings between a
...
than mogene10sttranscriptclusterGO2PROBE.

Details

If mogene10sttranscriptclusterGO is cast as a list, each manufacturer identifier is mapped to a list
...
If mogene10sttranscriptclusterGO2ALLPROBES or mogene10sttranscriptclusterGO2PROBE is cast
...
• mogene10sttranscriptclusterGO2ALLPROBES
• AnnotationDb-class for use of the select() interface.
...
## Bimap interface:
x <- mogene10sttranscriptclusterGO
...
# For the reverse map:
x <- mogene10sttranscriptclusterGO2PROBE
mapped_genes <- mappedkeys(x)
# Convert to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
mogene10sttranscriptclusterMGI

x <- mogene10sttranscriptclusterGO2ALLPROBES
mapped_genes <- mappedkeys(x)
# Convert mogene10sttranscriptclusterGO2ALLPROBES to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
mogene10sttranscriptclusterMAPCOUNTS provides the "map count" (i.e.
keys) for each map in package mogene10sttranscriptcluster.db.
...
mogene10sttranscriptclusterMGI is an R object that contains mappings between manufacturer iden-
...
mogene10sttranscriptclusterORGANISM
...
## Bimap interface:
x <- mogene10sttranscriptclusterMGI
...
x <- mogene10sttranscriptclusterMGI2PROBE
mapped_genes <- mappedkeys(x)
# Convert to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
The Organism information for mogene10sttranscriptcluster

Description

mogene10sttranscriptclusterORGANISM is an R object that contains a single item: a character
string that names the organism for which mogene10sttranscriptcluster was built. mogene10sttranscriptclusterORGPKG
...
Although the package name is suggestive of the organism for which it was built, mogene10sttranscriptclusterORGANISM
provides a simple way to programmatically extract the organism name. mogene10sttranscriptclusterORGPKG
...
mogene10sttranscriptclusterPATH
...
## Bimap interface:
mogene10sttranscriptclusterORGANISM
mogene10sttranscriptclusterORGPKG
...
mogene10sttranscriptclusterPATH maps probe identifiers to the identifiers used by KEGG for path-
ways in which the genes represented by the probe identifiers are involved

mogene10sttranscriptclusterPATH2PROBE is an R object that provides mappings between KEGG
...
mogene10sttranscriptclusterPFAM
...
## Bimap interface:
x <- mogene10sttranscriptclusterPATH
...
x <- mogene10sttranscriptclusterPATH
mapped_probes <- mappedkeys(x)
# Now convert the mogene10sttranscriptclusterPATH2PROBE object to a list
xx <- as.list(x[mapped_probes][1:300])
if(length(xx) > 0){
...
mogene10sttranscriptclusterPFAM is an R object that provides mappings between manufacturer
...
mogene10sttranscriptclusterPMID

Maps between Manufacturer Identifiers and PubMed Identifiers

Description

mogene10sttranscriptclusterPMID is an R object that provides mappings between manufacturer
identifiers and PubMed identifiers. mogene10sttranscriptclusterPMID2PROBE is an R object that
...
When mogene10sttranscriptclusterPMID is viewed as a list each manufacturer identifier is mapped
...
When mogene10sttranscriptclusterPMID2PROBE is viewed as a list each PubMed identifier is
...
## Bimap interface:
x <- mogene10sttranscriptclusterPMID
...
x <- mogene10sttranscriptclusterPMID2PROBE
mapped_probes <- mappedkeys(x)
# Now convert the reverse map object mogene10sttranscriptclusterPMID2PROBE to a list
xx <- as.list(x[mapped_probes][1:300])

mogene10sttranscriptclusterPROSITE
...
mogene10sttranscriptclusterPROSITE is an R object that provides mappings between manufacturer
...
mogene10sttranscriptclusterREFSEQ

Map between Manufacturer Identifiers and RefSeq Identifiers

Description

mogene10sttranscriptclusterREFSEQ is an R object that provides mappings between manufacturer
...
mogene10sttranscriptclusterSYMBOL
...
## Bimap interface:
x <- mogene10sttranscriptclusterREFSEQ
...
mogene10sttranscriptclusterSYMBOL is an R object that provides mappings between manufacturer
identifiers and gene abbreviations.

mogene10sttranscriptclusterUNIPROT
...
mogene10sttranscriptclusterUNIPROT is an R object that contains mappings between the manufac-
...
mogene10sttranscriptcluster_dbconn
...
## Bimap interface:
x <- mogene10sttranscriptclusterUNIPROT
...
mogene10sttranscriptcluster_dbschema(file="", show.indices=FALSE)
mogene10sttranscriptcluster_dbInfo()
...
mogene10sttranscriptcluster_dbconn returns a connection object to the package annotation
DB. IMPORTANT: Don’t call dbDisconnect on the connection object returned by mogene10sttranscriptcluster_dbconn
or you will break all the AnnDbObj objects defined in this package!
mogene10sttranscriptcluster_dbfile returns the path (character string) to the package anno-
...
mogene10sttranscriptcluster_dbschema prints the schema definition of the package annotation
DB.
mogene10sttranscriptcluster_dbInfo prints other information about the package annotation
DB.

Value

mogene10sttranscriptcluster_dbconn: a DBIConnection object representing an open connec-
tion to the package annotation DB.
mogene10sttranscriptcluster_dbfile: a character string with the path to the package annota-
tion DB.
mogene10sttranscriptcluster_dbschema: none (invisible NULL).
mogene10sttranscriptcluster_dbInfo: none (invisible NULL).
...
dbGetQuery(mogene10sttranscriptcluster_dbconn(), "SELECT COUNT(*) FROM probes")
...
mogene10sttranscriptcluster.db, 2
mogene10sttranscriptcluster_dbconn,
...
mogene10sttranscriptclusterCHR, 3
mogene10sttranscriptclusterCHRLENGTHS,
...
mogene10sttranscriptclusterGO, 10
mogene10sttranscriptclusterMAPCOUNTS,

12

mogene10sttranscriptclusterMGI, 12
mogene10sttranscriptclusterORGANISM,
...
mogene10sttranscriptcluster.db, 2
mogene10sttranscriptcluster_dbconn, 20
mogene10sttranscriptcluster_dbfile
...
mogene10sttranscriptclusterACCNUM, 1
mogene10sttranscriptclusterALIAS2PROBE,
...
mogene10sttranscriptclusterCHRLOC, 4
mogene10sttranscriptclusterCHRLOCEND

(mogene10sttranscriptclusterCHRLOC),
4

mogene10sttranscriptclusterENSEMBL, 5
mogene10sttranscriptclusterENSEMBL2PROBE

(mogene10sttranscriptclusterENSEMBL),
5

mogene10sttranscriptclusterENTREZID, 6

INDEX

23

mogene10sttranscriptclusterENZYME, 7
mogene10sttranscriptclusterENZYME2PROBE

(mogene10sttranscriptclusterENZYME),
7

mogene10sttranscriptclusterGENENAME, 9
mogene10sttranscriptclusterGO, 10
mogene10sttranscriptclusterGO2ALLPROBES,
...
mogene10sttranscriptclusterGO2PROBE

(mogene10sttranscriptclusterGO),
10

mogene10sttranscriptclusterLOCUSID
...
mogene10sttranscriptclusterMGI, 12
mogene10sttranscriptclusterMGI2PROBE
...
mogene10sttranscriptclusterPATH, 14
mogene10sttranscriptclusterPATH2PROBE

(mogene10sttranscriptclusterPATH),
14

mogene10sttranscriptclusterPFAM, 15
mogene10sttranscriptclusterPMID, 15
mogene10sttranscriptclusterPMID2PROBE

(mogene10sttranscriptclusterPMID),
15

mogene10sttranscriptclusterPROSITE, 17
mogene10sttranscriptclusterREFSEQ, 17
mogene10sttranscriptclusterSYMBOL, 18
mogene10sttranscriptclusterUNIPROT, 19
mogene10sttranscriptclusterUNIPROT2PROBE
