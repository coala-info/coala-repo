...
* Output Files
  ...
  + [surf](#surf)
    ...
    - [surface labels](#surface-labels)
    - [cifti files](#cifti-files)
    - [spec files](#spec-files)
    - [New: label-dentate](#new-label-dentate)
    - [New: myelin maps](#new-myelin-maps)
  + [coords](#coords)
  + [warps](#warps)
...
* Output Files
* [View page source](../_sources/outputs/output_files.md.txt)
...
## anat[](#anat "Permalink to this heading")
...
![image](../_images/T1-T2-subfields_sag.png)

## surf[](#surf "Permalink to this heading")

### surface meshes[](#surface-meshes "Permalink to this heading")
...
![image](../_images/inner-mid-outer_sag.png)

### surface densities[](#surface-densities "Permalink to this heading")
...
![image](../_images/mesh-foldedunfolded2k.png)
...
### surface metrics[](#surface-metrics "Permalink to this heading")
...
![image](../_images/metrics.png)

### surface labels[](#surface-labels "Permalink to this heading")
...
### cifti files[](#cifti-files "Permalink to this heading")
...
### spec files[](#spec-files "Permalink to this heading")
...
### New: label-dentate[](#new-label-dentate "Permalink to this heading")
...
### New: myelin maps[](#new-myelin-maps "Permalink to this heading")
...
## coords[](#coords "Permalink to this heading")
...
## warps[](#warps "Permalink to this heading")
...
## Additional Files[](#additional-files "Permalink to this heading")
...
[Previous](../pipeline/algorithms.html "Algorithmic details")
[Next](visualization.html "Visualization")
