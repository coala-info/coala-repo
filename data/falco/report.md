...
### Metadata
- **Docker Image**: quay.io/biocontainers/falco:1.2.5--h077b44d_0
- **Homepage**: https://github.com/smithlabcode/falco
- **Package**: https://anaconda.org/channels/bioconda/packages/falco/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/falco/overview
...
Options:
  ...
  -c, --contaminants       Specifies a non-default file which contains 
                           ...
                           /usr/local/opt/falco/Configuration/contaminant_list.txt 
  -a, --adapters           Specifies a non-default file which contains 
                           ...
                           the form name[tab]sequence. Lines prefixed 
                           with a hash will be ignored. Default: 
                           /usr/local/opt/falco/Configuration/adapter_list.txt 
  -l, --limits             Specifies a non-default file which contains 
                           ...
                           /usr/local/opt/falco/Configuration/limits.txt 
