...
baseCommand:
  - nextclade
  - dataset
label: nextclade_js_nextclade dataset
doc: "List and download available Nextclade datasets (pathogens)\n\nTool homepage:
  https://github.com/nextstrain/nextclade"
inputs:
  - id: command
    type: string
    doc: Command to execute (list, get, help)
    inputBinding:
      position: 1
  - id: color
    type:
...
stdout: nextclade_js_nextclade dataset.out
