# `index`: Build a *de novo* splicing annotation index of events custom to **your** data[¶](#index-build-a-de-novo-splicing-annotation-index-of-events-custom-to-your-data "Permalink to this headline")
...
[![OutriggerIndex](../_images/outrigger_index-300ppi.png)](../_static/outrigger_index-300ppi.png)

## Inputs[¶](#inputs "Permalink to this headline")

This section will describe all possible inputs to `outrigger index`.

### Example command using `SJ.out.tab` files[¶](#example-command-using-sj-out-tab-files "Permalink to this headline")
...
(2016)](http://www.ncbi.nlm.nih.gov/pubmed/26727548). There splice
junction output files from the [STAR
aligner](https://github.com/alexdobin/STAR) from the 43
“`CAV_LP_Ipsi_tdTpos`” cells, plus a subset of the [GENCODE
M10](http://www.gencodegenes.org/mouse_releases/10.html) (Version M10
...
### Example command with `.bam` files[¶](#example-command-with-bam-files "Permalink to this headline")
...
### Example command with pre-compiled junction reads `.csv`[¶](#example-command-with-pre-compiled-junction-reads-csv "Permalink to this headline")

::
:   outrigger index
    :   –compiled-junction-reads /projects/ps-yeolab/obotvinnik/singlecell\_pnms/csvs\_for\_paper/junction\_reads\_use\_multimapping.csv –output /home/obotvinnik/projects/singlecell\_pnms/analysis/outrigger\_v2 –gtf-filename /projects/ps-yeolab/genomes/hg19/gencode/v19/gencode.v19.annotation.gtf

### Full `--help` output[¶](#full-help-output "Permalink to this headline")
