...
hugene11sttranscriptclusterACCNUM

Map Manufacturer identifiers to Accession Numbers

Description

hugene11sttranscriptclusterACCNUM is an R object that contains mappings between a manufac-
...
## Bimap interface:
x <- hugene11sttranscriptclusterACCNUM
...
hugene11sttranscriptclusterALIAS2PROBE
...
hugene11sttranscriptclusterALIAS is an R object that provides mappings between common gene
...
xx <- as.list(hugene11sttranscriptclusterALIAS2PROBE)
if(length(xx) > 0){
...
Welcome to the hugene11sttranscriptcluster.db annotation Package. The purpose of this package
is to provide detailed information about the hugene11sttranscriptcluster platform. This package is
updated biannually.
Objects in this package are accessed using the select() interface. See ?select in the AnnotationDbi
package for details.

hugene11sttranscriptclusterCHR
...
hugene11sttranscriptclusterCHR is an R object that provides mappings between a manufacturer
...
## Bimap interface:
x <- hugene11sttranscriptclusterCHR
...
hugene11sttranscriptclusterCHRLOC
...
hugene11sttranscriptclusterCHRLENGTHS

A named vector for the length of each of the chromosomes

Description

hugene11sttranscriptclusterCHRLENGTHS provides the length measured in base pairs for each of
the chromosomes.
...
## Bimap interface:
tt <- hugene11sttranscriptclusterCHRLENGTHS
...
hugene11sttranscriptclusterCHRLOC is an R object that maps manufacturer identifiers to the start-
...
hugene11sttranscriptclusterENSEMBL
...
## Bimap interface:
x <- hugene11sttranscriptclusterCHRLOC
...
hugene11sttranscriptclusterENSEMBL is an R object that contains mappings between manufacturer
...
hugene11sttranscriptclusterENTREZID
...
## Bimap interface:
x <- hugene11sttranscriptclusterENSEMBL
...
x <- hugene11sttranscriptclusterENSEMBL2PROBE
mapped_genes <- mappedkeys(x)
# Convert to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
hugene11sttranscriptclusterENTREZID is an R object that provides mappings between manufac-
turer identifiers and Entrez Gene identifiers.

hugene11sttranscriptclusterENZYME
...
hugene11sttranscriptclusterENZYME is an R object that provides mappings between manufacturer
identifiers and EC numbers. hugene11sttranscriptclusterENZYME2PROBE is an R object that
...
When the hugene11sttranscriptclusterENZYME maping viewed as a list, each manufacturer identi-
...
For the hugene11sttranscriptclusterENZYME2PROBE, each EC number maps to a named vector
...
numbers. In hugene11sttranscriptclusterENZYME2PROBE, EC is dropped from the Enzyme Com-
mission numbers.
...
## Bimap interface:
x <- hugene11sttranscriptclusterENZYME
...
hugene11sttranscriptclusterGENENAME
...
# Now convert hugene11sttranscriptclusterENZYME2PROBE to a list to see inside
x <- hugene11sttranscriptclusterENZYME2PROBE
mapped_probes <- mappedkeys(x)
## convert to a list
xx <- as.list(x[mapped_probes][1:3])
if(length(xx) > 0){
...
hugene11sttranscriptclusterGENENAME is an R object that maps manufacturer identifiers to the
...
hugene11sttranscriptclusterGO is an R object that provides mappings between manufacturer iden-
tifiers and the GO identifiers that they are directly associated with. This mapping and its reverse
mapping (hugene11sttranscriptclusterGO2PROBE) do NOT associate the child terms from the GO
ontology with the gene. Only the directly evidenced terms are represented here.

hugene11sttranscriptclusterGO2ALLPROBES is an R object that provides mappings between a
...
than hugene11sttranscriptclusterGO2PROBE.

Details

If hugene11sttranscriptclusterGO is cast as a list, each manufacturer identifier is mapped to a list
...
If hugene11sttranscriptclusterGO2ALLPROBES or hugene11sttranscriptclusterGO2PROBE is cast
...
• hugene11sttranscriptclusterGO2ALLPROBES
• AnnotationDb-class for use of the select() interface.
...
# For the reverse map:
x <- hugene11sttranscriptclusterGO2PROBE
mapped_genes <- mappedkeys(x)
# Convert to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
hugene11sttranscriptclusterMAP

x <- hugene11sttranscriptclusterGO2ALLPROBES
mapped_genes <- mappedkeys(x)
# Convert hugene11sttranscriptclusterGO2ALLPROBES to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
hugene11sttranscriptclusterMAP is an R object that provides mappings between manufacturer iden-
...
hugene11sttranscriptclusterMAPCOUNTS
...
## Bimap interface:
x <- hugene11sttranscriptclusterMAP
...
hugene11sttranscriptclusterMAPCOUNTS provides the "map count" (i.e.
keys) for each map in package hugene11sttranscriptcluster.db.
...
hugene11sttranscriptclusterOMIM
...
hugene11sttranscriptclusterOMIM is an R object that provides mappings between manufacturer
...
hugene11sttranscriptclusterORGANISM
...
## Bimap interface:
x <- hugene11sttranscriptclusterOMIM
...
The Organism information for hugene11sttranscriptcluster

Description

hugene11sttranscriptclusterORGANISM is an R object that contains a single item: a character
string that names the organism for which hugene11sttranscriptcluster was built. hugene11sttranscriptclusterORGPKG
...
hugene11sttranscriptclusterPATH

15

Details

Although the package name is suggestive of the organism for which it was built, hugene11sttranscriptclusterORGANISM
provides a simple way to programmatically extract the organism name. hugene11sttranscriptclusterORGPKG
...
## Bimap interface:
hugene11sttranscriptclusterORGANISM
hugene11sttranscriptclusterORGPKG
...
hugene11sttranscriptclusterPATH maps probe identifiers to the identifiers used by KEGG for path-
ways in which the genes represented by the probe identifiers are involved

hugene11sttranscriptclusterPATH2PROBE is an R object that provides mappings between KEGG
...
hugene11sttranscriptclusterPFAM
...
## Bimap interface:
x <- hugene11sttranscriptclusterPATH
...
x <- hugene11sttranscriptclusterPATH
mapped_probes <- mappedkeys(x)
# Now convert the hugene11sttranscriptclusterPATH2PROBE object to a list
xx <- as.list(x[mapped_probes][1:300])
if(length(xx) > 0){
...
hugene11sttranscriptclusterPFAM is an R object that provides mappings between manufacturer
...
hugene11sttranscriptclusterPMID
...
hugene11sttranscriptclusterPMID is an R object that provides mappings between manufacturer
identifiers and PubMed identifiers. hugene11sttranscriptclusterPMID2PROBE is an R object that
provides mappings between PubMed identifiers and manufacturer identifiers.

Details

When hugene11sttranscriptclusterPMID is viewed as a list each manufacturer identifier is mapped
...
When hugene11sttranscriptclusterPMID2PROBE is viewed as a list each PubMed identifier is mapped
...
## Bimap interface:
x <- hugene11sttranscriptclusterPMID
...
hugene11sttranscriptclusterREFSEQ
...
x <- hugene11sttranscriptclusterPMID2PROBE
mapped_probes <- mappedkeys(x)
# Now convert the reverse map object hugene11sttranscriptclusterPMID2PROBE to a list
xx <- as.list(x[mapped_probes][1:300])
if(length(xx) > 0){
...
hugene11sttranscriptclusterPROSITE

Maps between Manufacturer Identifiers and PROSITE Identifiers

Description

hugene11sttranscriptclusterPROSITE is an R object that provides mappings between manufacturer
...
hugene11sttranscriptclusterREFSEQ is an R object that provides mappings between manufacturer
...
## Bimap interface:
x <- hugene11sttranscriptclusterREFSEQ
...
hugene11sttranscriptclusterSYMBOL
...
hugene11sttranscriptclusterSYMBOL is an R object that provides mappings between manufacturer
...
hugene11sttranscriptclusterUNIPROT
...
hugene11sttranscriptclusterUNIPROT is an R object that contains mappings between the manufac-
...
## Bimap interface:
x <- hugene11sttranscriptclusterUNIPROT
...
hugene11sttranscriptcluster_dbconn
...
hugene11sttranscriptcluster_dbconn()
hugene11sttranscriptcluster_dbfile()
hugene11sttranscriptcluster_dbschema(file="", show.indices=FALSE)
hugene11sttranscriptcluster_dbInfo()
...
hugene11sttranscriptcluster_dbconn returns a connection object to the package annotation
DB. IMPORTANT: Don’t call dbDisconnect on the connection object returned by hugene11sttranscriptcluster_dbconn
or you will break all the AnnDbObj objects defined in this package!
hugene11sttranscriptcluster_dbfile returns the path (character string) to the package anno-
tation DB (this is an SQLite file).
hugene11sttranscriptcluster_dbschema prints the schema definition of the package annotation
DB.
hugene11sttranscriptcluster_dbInfo prints other information about the package annotation
DB.

Value

hugene11sttranscriptcluster_dbconn: a DBIConnection object representing an open connec-
tion to the package annotation DB.
hugene11sttranscriptcluster_dbfile: a character string with the path to the package annota-
tion DB.
hugene11sttranscriptcluster_dbschema: none (invisible NULL).
hugene11sttranscriptcluster_dbInfo: none (invisible NULL).
...
dbGetQuery(hugene11sttranscriptcluster_dbconn(), "SELECT COUNT(*) FROM probes")

hugene11sttranscriptcluster_dbschema()
...
hugene11sttranscriptcluster.db, 2
hugene11sttranscriptcluster_dbconn,
...
hugene11sttranscriptclusterCHR, 3
hugene11sttranscriptclusterCHRLENGTHS,
...
hugene11sttranscriptclusterGO, 10
hugene11sttranscriptclusterMAP, 12
hugene11sttranscriptclusterMAPCOUNTS,
...
hugene11sttranscriptcluster.db, 2
hugene11sttranscriptcluster_dbconn, 21
hugene11sttranscriptcluster_dbfile
...
hugene11sttranscriptclusterACCNUM, 1
hugene11sttranscriptclusterALIAS2PROBE,
...
hugene11sttranscriptclusterCHRLOC, 4
hugene11sttranscriptclusterCHRLOCEND

(hugene11sttranscriptclusterCHRLOC),
4

hugene11sttranscriptclusterENSEMBL, 5
hugene11sttranscriptclusterENSEMBL2PROBE
...
hugene11sttranscriptclusterENTREZID, 6
hugene11sttranscriptclusterENZYME, 7
hugene11sttranscriptclusterENZYME2PROBE

(hugene11sttranscriptclusterENZYME),
7

hugene11sttranscriptclusterGENENAME, 9
hugene11sttranscriptclusterGO, 10
hugene11sttranscriptclusterGO2ALLPROBES,
...
hugene11sttranscriptclusterGO2PROBE

(hugene11sttranscriptclusterGO),
10

hugene11sttranscriptclusterLOCUSID
...
hugene11sttranscriptclusterOMIM, 13
hugene11sttranscriptclusterORGANISM,
...
hugene11sttranscriptclusterPATH, 15
hugene11sttranscriptclusterPATH2PROBE

(hugene11sttranscriptclusterPATH),
15

hugene11sttranscriptclusterPFAM, 16
hugene11sttranscriptclusterPMID, 17
hugene11sttranscriptclusterPMID2PROBE

(hugene11sttranscriptclusterPMID),
17

hugene11sttranscriptclusterPROSITE, 18
hugene11sttranscriptclusterREFSEQ, 18
hugene11sttranscriptclusterSYMBOL, 20
hugene11sttranscriptclusterUNIPROT, 21
hugene11sttranscriptclusterUNIPROT2PROBE
