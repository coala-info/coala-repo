...
baseCommand: meme
label: meme
doc: Motif-based sequence analysis tool for discovering motifs in a set of 
  sequences.
inputs:
  - id: dataset
    type: File
  ...
  - id: search_size
    type:
      - 'null'
      - int
    doc: maximum portion of primary dataset to use for motif search (in 
      characters)
    inputBinding:
      position: 102
      prefix: -searchsize
  ...
  - id: brief_output
    type:
      - 'null'
      - int
    doc: omit sites and sequence tables in output if more than <n> primary 
      sequences
    inputBinding:
      position: 102
      prefix: -brief
