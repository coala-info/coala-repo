...
baseCommand: fastq-trim
label: fastq-tools_fastq-trim
doc: "A tool for trimming FASTQ files (Note: The provided help text contains only
...
stdout: fastq-tools_fastq-trim.out
