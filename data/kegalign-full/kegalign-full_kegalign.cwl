...
inputs:
  ...
  - id: query_prefix
    type:
      - 'null'
      - string
    doc: prefix the query sequence names with argument string
    inputBinding:
      position: 103
      prefix: --query_prefix
  - id: scoring
  ...
  - id: seed
    ...
    default: "12of19(1110100110010101111)/14of22(1110101\n                       \
      \ 100110010101111)/an arbitrary pattern of 1s, 0s, and Ts"
    inputBinding:
      position: 103
      prefix: --seed
  ...
  - id: target_prefix
    type:
      - 'null'
      - string
    doc: prefix the target sequence names with argument string
    inputBinding:
      position: 103
