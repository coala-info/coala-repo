...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fmourisl%2FT1K%2Fblob%2Fmaster%2FKmerCode.hpp)
...
[History](/mourisl/T1K/commits/master/KmerCode.hpp)
...
[Raw](https://github.com/mourisl/T1K/raw/refs/heads/master/KmerCode.hpp)
...
#ifndef \_MOURISL\_KMERCODE\_HEADER

#define \_MOURISL\_KMERCODE\_HEADER
...
uint64\_t GetCode() { return code ; }

void SetCode( uint64\_t in )
...
uint64\_t GetCanonicalKmerCode()

{

int i ;

uint64\_t crCode = 0ull ; // complementary code

for ( i = 0 ; i < kmerLength ; ++i )

{

//uint64\_t tmp = ( code >> ( 2ull \* (k - i - 1) ) ) & 3ull ;

//crCode = ( crCode << 2ull ) | ( 3 - tmp ) ;

uint64\_t tmp = ( code >> ( 2ull \* i ) ) & 3ull ;
...
uint64\_t GetReverseComplementCode()
...
code = ( code | ( (uint64\_t)( nucToNum[c - 'A'] & 3 ) << ( 2ull \* ( kmerLength - 1 ) ) ) ) & mask ;
