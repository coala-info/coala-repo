# plant2human workflow CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://bonohu.hiroshima-u.ac.jp/index_en.html
- **Package**: https://workflowhub.eu/workflows/1206
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1206/ro_crate?version=10
...
- **Main workflow (WorkflowHub):** `Workflow/plant2human_v3_stringent.cwl` (Main Workflow)
- **Project**: bonohulab
- **Views**: 9448
- **Creators**: Sora Yonezawa
- **Discussion / source**: https://github.com/yonesora56/plant2human/issues
...
- ✔ 2025-12-13: Add *Arabidopsis thaliana* 100 genes (Ensembl plants release 62) test example ([details](https://github.com/yonesora56/plant2human/blob/main/test/arabidopsis_test_100genes_202512/README.md))
- ✔ 2025-12-13: Add *Zea mays* 100 genes (Ensembl plants release 62) test example ([details](https://github.com/yonesora56/plant2human/blob/main/test/zea_mays_test_100genes_202512/README.md))
- ✔ 2025-12-13: Add *Solanum lycopersicum* 100 genes (Ensembl plants release 62) test example ([details](https://github.com/yonesora56/plant2human/blob/main/test/solanum_lycopersicum_test_100genes_202512/README.md))
- ✔ 2025-12-13: Add *Glycine max* 100 genes (Ensembl plants release 62) test example ([details](https://github.com/yonesora56/plant2human/blob/main/test/glycine_max_test_100genes_202512/README.md))
...
First, you need the following [gene list tsv file](https://github.com/yonesora56/plant2human/blob/main/test/oryza_sativa_test_100genes_202512/oryza_sativa_random_100genes_list.tsv). 
...
The following [TSV file](https://github.com/yonesora56/plant2human/tree/main/) is required to execute the following workflow. 
...
In this execution, [mmcif files](https://github.com/yonesora56/plant2human/tree/main/test/oryza_sativa_test_100genes_202512/os_100_genes_mmcif) are also retrieved from AlphaFold Database (version 6).
The execution results are output with the [jupyter notebook](https://github.com/yonesora56/plant2human/blob/main/test/oryza_sativa_test_100genes_202512/oryza_sativa_100_genes_uniprot_idmapping.ipynb).
...
I'm sorry, but the [main workflow](https://github.com/yonesora56/plant2human/blob/main/Workflow/plant2human_v2.cwl) does not currently include the creation of an index process (both for protein structure (foldseek index) and protein sequence (BLAST index)).
...
**Example file:** [`job/plant2human_v3_stringent_example_os100.yml`](https://github.com/yonesora56/plant2human/blob/main/job/plant2human_v3_stringent_example_os100.yml)
...
The execution results are output with the [jupyter notebook](https://github.com/yonesora56/plant2human/blob/main/test/oryza_sativa_test_100genes_202512/plant2human_v3_stringent_result/os_100_genes_plant2human_report_stringent.ipynb).
...
![image](https://raw.githubusercontent.com/yonesora56/plant2human/main/image/os_100_stringent_needle.png)
...
![image](https://raw.githubusercontent.com/yonesora56/plant2human/main/image/os_100_stringent_water.png)
...
![image](https://raw.githubusercontent.com/yonesora56/plant2human/main/image/os_100_stringent_needle_filter.png)

&nbsp;

## local alignment (x-axis)

![image](https://raw.githubusercontent.com/yonesora56/plant2human/main/image/os_100_stringent_water_filter.png)
...
|---------|----------------|------------|
| *Arabidopsis thaliana* | [`test/arabidopsis_test_100genes_202512/`](https://github.com/yonesora56/plant2human/blob/main/test/arabidopsis_test_100genes_202512/README.md) | [`job/at_100genes_*.yml`](https://github.com/yonesora56/plant2human/tree/main/job/) |
| *Zea mays* | [`test/zea_mays_test_100genes_202512/`](https://github.com/yonesora56/plant2human/blob/main/test/zea_mays_test_100genes_202512/README.md) | [`job/zm_100genes_*.yml`](https://github.com/yonesora56/plant2human/tree/main/job/) |
| *Solanum lycopersicum* | [`test/solanum_lycopersicum_test_100genes_202512/`](https://github.com/yonesora56/plant2human/blob/main/test/solanum_lycopersicum_test_100genes_202512/README.md) | [`job/sl_100genes_*.yml`](https://github.com/yonesora56/plant2human/tree/main/job/) |
| *Glycine max* | [`test/glycine_max_test_100genes_202512/`](https://github.com/yonesora56/plant2human/blob/main/test/glycine_max_test_100genes_202512/README.md) | [`job/gm_100genes_*.yml`](https://github.com/yonesora56/plant2human/tree/main/job/) |
