...
baseCommand: perl
label: perl-statistics-distributions_perl
doc: "The Perl 5 language interpreter\n\nTool homepage: https://github.com/shlomif/perl-Statistics-Descriptive"
inputs:
  - id: program_file
    type:
      - 'null'
...
stdout: perl-statistics-distributions_perl.out
