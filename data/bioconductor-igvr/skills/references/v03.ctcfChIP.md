...
* [1 Overview](#overview)
* [2 Initialize igvR](#initialize-igvr)
* [3 Load alignments for the currently displayed genomic region](#load-alignments-for-the-currently-displayed-genomic-region)
* [4 Display the alignment](#display-the-alignment)
* [5 Narrow Peaks from MACS](#narrow-peaks-from-macs)
* [6 Motif Matching](#motif-matching)
* [7 Display the Matches](#display-the-matches)
* [8 H3K4Me3 Histone Marks](#h3k4me3-histone-marks)
* [9 Zoom in to one interesting, and possibly functional CTCF binding site](#zoom-in-to-one-interesting-and-possibly-functional-ctcf-binding-site)
...
# 3 Load alignments for the currently displayed genomic region
...
# 9 Zoom in to one interesting, and possibly functional CTCF binding site
