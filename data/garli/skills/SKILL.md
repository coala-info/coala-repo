---
name: garli
description: Garlic.js is a client-side persistence library that automatically saves the state of HTML form fields (text inputs and select boxes) to the browser's local storage.
