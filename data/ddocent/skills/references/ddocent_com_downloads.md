...
# Download Current Release and Manual Install
...
Click here to download:  [dDocent-2.9.4](https://github.com/jpuritz/dDocent/archive/v2.9.4.tar.gz)
...
Once $PATH is setup, there is a VERY simplistic installation script located in the GitHub Repository called install\_dDocent\_requirements. To run it, simply type:
