...
< [IPython: Beyond Normal Python](01.00-ipython-beyond-normal-python.html) | [Contents](index.html) | [Keyboard Shortcuts in the IPython Shell](01.02-shell-keyboard-shortcuts.html) >
...
## Exploring Modules with Tab-Completion[¶](#Exploring-Modules-with-Tab-Completion)
...
### Tab-completion of object contents[¶](#Tab-completion-of-object-contents)
...
### Tab completion when importing[¶](#Tab-completion-when-importing)
...
### Beyond tab completion: wildcard matching[¶](#Beyond-tab-completion:-wildcard-matching)
