...
### Tool Description
AA Conservation calculates conservation of amino acids in multiple sequence alignments using 17 different conservation scores and the SMERFS scoring algorithm.

### Metadata
- **Docker Image**: quay.io/biocontainers/aacon:1.1--hdfd78af_0
- **Homepage**: https://www.compbio.dundee.ac.uk/aacon/
- **Package**: https://anaconda.org/channels/bioconda/packages/aacon/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/aacon/overview
- **Total Downloads**: 1.1K
- **Last updated**: 2025-04-22
- **GitHub**: https://github.com/bartongroup/aacon
- **Stars**: 2
### Original Help Text
```text
Method names, input file paths are required. Application will not run until these 2 arguments are provided.
If you want results printed, both format an input file path have to be provided
