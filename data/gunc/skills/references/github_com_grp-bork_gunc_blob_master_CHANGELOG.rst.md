...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fgrp-bork%2Fgunc%2Fblob%2Fmaster%2FCHANGELOG.rst)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fblob%2Fshow&source=header-repo&source_repo=grp-bork%2Fgunc)
...
[History](/grp-bork/gunc/commits/master/CHANGELOG.rst)
...
[Raw](https://github.com/grp-bork/gunc/raw/refs/heads/master/CHANGELOG.rst)
...
`gunc summarise`. In addition a test\_data database type has been added, which comprised of a minimal test set (sample, db, taxonomy) which can be used in CI/CD pipeline.
...
> * Added support for progenomes\_3 and gtdb\_214 reference databases.
> * Added support for test\_data set, a minimal set of data that can be used in CI/CD pipelines).
...
> * Added check if temp\_dir exists before starting analysis.
...
> * Added contig\_taxonomy\_output option to output detailed taxonomy assignment count per contig.
...
> * GUNC plot contig\_display\_num displayed a defined number of genes instead of contigs
