...
* Usage
  + [STR identification](#str-identification)
  + [GTR identification](#gtr-identification)
  + [Exact tandem repeat](#exact-tandem-repeat)
  + [ATR identification](#atr-identification)
  + [Approximate tandem repeat](#approximate-tandem-repeat)
...
`Pytrf` is only responsible for finding tandem repeats from given DNA sequence. It can not directly extract TRs from Fasta files. So we used [pyfastx](https://github.com/lmdu/pyfastx) to parse Fasta file and feed the sequence to `pytrf`.

## STR identification[](#str-identification "Link to this heading")
...
## GTR identification[](#gtr-identification "Link to this heading")
...
## Exact tandem repeat[](#exact-tandem-repeat "Link to this heading")
...
## ATR identification[](#atr-identification "Link to this heading")
...
## Approximate tandem repeat[](#approximate-tandem-repeat "Link to this heading")
