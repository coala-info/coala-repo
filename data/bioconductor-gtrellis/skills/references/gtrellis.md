...
short scaffolds before making the plot. Also non-normal chromosomes (e.g. “chr1\_xxxxxx”) will also be removed.
...
![plot of chunk unnamed-chunk-40](data:image/png;base64...)
...
![plot of chunk unnamed-chunk-41](data:image/png;base64...)
...
![plot of chunk unnamed-chunk-42](data:image/png;base64...)
...
![plot of chunk unnamed-chunk-44](data:image/png;base64...)
...
![plot of chunk unnamed-chunk-45](data:image/png;base64...)
...
![plot of chunk unnamed-chunk-46](data:image/png;base64...)
...
![plot of chunk unnamed-chunk-47](data:image/png;base64...)
...
![plot of chunk unnamed-chunk-49](data:image/png;base64...)
...
![plot of chunk unnamed-chunk-50](data:image/png;base64...)
...
```
## Error in `gtrellis_layout()`:
## ! Start base in a same column should be the same.
```
...
![plot of chunk unnamed-chunk-52](data:image/png;base64...)
...
##  [1] GetoptLong_1.1.0      RColorBrewer_1.1-3    circlize_0.4.17       gtrellis_1.42.1
##  [5] GenomicRanges_1.62.1  Seqinfo_1.0.0         IRanges_2.44.0        S4Vectors_0.48.0
##  [9] BiocGenerics_0.56.0   generics_0.1.4        ComplexHeatmap_2.26.1 knitr_1.51
## [13] markdown_2.0
##
## loaded via a namespace (and not attached):
##  [1] vctrs_0.7.1         crayon_1.5.3        doParallel_1.0.17   cli_3.6.5
##  [5] rlang_1.1.7         xfun_0.56           otel_0.2.0          png_0.1-8
##  [9] clue_0.3-66         glue_1.8.0          rjson_0.2.23        colorspace_2.1-2
## [13] GlobalOptions_0.1.3 evaluate_1.0.5      lifecycle_1.0.5     foreach_1.5.2
## [17] cluster_2.1.8.1     compiler_4.5.2      codetools_0.2-20    digest_0.6.39
## [21] pillar_1.11.1       shape_1.4.6.1       parallel_4.5.2      tools_4.5.2
## [25] iterators_1.0.14    matrixStats_1.5.0
```