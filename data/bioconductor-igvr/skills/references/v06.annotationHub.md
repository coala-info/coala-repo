...
* [3 Query the AnnotationHub](#query-the-annotationhub)
* [4 Select Two Resources: boadPeaks and fc bigwig](#select-two-resources-boadpeaks-and-fc-bigwig)
* [5 broadPeaks: subset and display](#broadpeaks-subset-and-display)
* [6 bigWig: subset and display](#bigwig-subset-and-display)
...
# 4 Select Two Resources: boadPeaks and fc bigwig
...
# 5 broadPeaks: subset and display
