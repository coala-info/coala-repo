...
## voronota_get-balls-from-atoms-file

### Tool Description
Reads atoms from a PDB or mmCIF file and computes Voronoi tessellation balls.
...
## voronota_calculate-vertices

### Tool Description
Calculates Voronoi vertices from a list of balls.
...
## voronota_calculate-vertices-in-parallel

### Tool Description
Calculates Voronoi vertices in parallel.
...
## voronota_calculate-contacts

### Tool Description
Calculates contacts between balls.
...
## voronota_query-balls

### Tool Description
Query a list of balls based on various criteria and modify them.
...
## voronota_query-contacts

### Tool Description
Query contacts based on various criteria and modify them.
...
## voronota_draw-contacts

### Tool Description
Draws contacts in various formats.
...
## voronota_score-contacts-energy

### Tool Description
Calculates contact energies based on Voronota analysis.
...
## voronota_score-contacts-quality

### Tool Description
Calculates weighted average local score based on atom energy descriptors.
...
## voronota_score-contacts-potential

### Tool Description
Calculates potential values for contacts based on various input files and outputs summary statistics.
...
## voronota_compare-contacts

### Tool Description
Compares contacts from two Voronota models.
...
## voronota_write-balls-to-atoms-file

### Tool Description
Writes balls to an atoms file.
...
## voronota_query-balls-clashes

### Tool Description
Query Voronota output for ball clashes.
...
## voronota_expand-descriptors

### Tool Description
Expand atom descriptors to 'chainID resSeq iCode serial altLoc resName name'
