...
label: liftofftools_to
doc: "liftofftools: error: argument subcommand: invalid choice: 'to' (choose from
...
inputs:
  ...
  - id: reference_genome
    ...
    inputBinding:
      position: 102
      prefix: -r
  - id: reference_genome_type
    type: string
    doc: Reference genome type (GFF/GTF or DB)
    inputBinding:
      position: 102
      prefix: -tg
  - id: reference_sort
  ...
  - id: target_genome
    ...
    inputBinding:
      position: 102
      prefix: -t
  - id: target_genome_type
    type: string
    doc: Target genome type (GFF/GTF or DB)
    inputBinding:
      position: 102
      prefix: -rg
  - id: target_sort
