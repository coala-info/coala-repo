...
* [ ]
  ...
  Table of contents
  + [TOML file based configuration](#toml-file-based-configuration)

    - [General Structure of the config TOML file](#general-structure-of-the-config-toml-file)

      * [Servers](#servers)
      * [Profiles](#profiles)
  + [Python API based configuration](#python-api-based-configuration)
* [ ]
...
blast2galaxy uses the [TOML file format](https://toml.io/) for configuration of one or multiple Galaxy servers and one or multiple profiles.
...
How you can obtain an API key is described in the [Tutorial](../tutorial/#1-obtaining-api-key-from-usegalaxyeu)
...
#### Example of a complete configuration file with two servers and multiple profiles
