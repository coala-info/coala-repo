...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Ftwolinin%2Flongphase%2Fblob%2Fmain%2FModCallParsingBam.h)
...
[History](/twolinin/longphase/commits/main/ModCallParsingBam.h)
...
[Raw](https://github.com/twolinin/longphase/raw/refs/heads/main/ModCallParsingBam.h)
...
#ifndef MODCALLPARSINGBAM\_H

#define MODCALLPARSINGBAM\_H
...
MethSnpParser(ModCallParameters &in\_params); // New constructor
...
std::string get\_aux\_tag(const bam1\_t \*aln, const char tag[2]);

void parse\_CIGAR(const bam\_hdr\_t &bamHdr,const bam1\_t &aln, std::vector<ReadVariant> &readVariantVec);
...
MethBamParser(std::string inputChrName, ModCallParameters &in\_params, MethSnpParser &snpMap, std::string &ref\_string);
...
void addEdge(std::vector<ReadVariant> &in\_readVariant, std::string chrName);
