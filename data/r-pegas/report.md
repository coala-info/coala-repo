...
### Metadata
- **Conda**: https://anaconda.org/channels/r/packages/r-pegas/overview
- **R-project (CRAN)**: https://cloud.r-project.org/web/packages/pegas/index.html
- **Home (project)**: http://ape-package.ird.fr/pegas.html
- **Package**: pegas
- **Version**: 1.4
