...
The dar package provides convenient wrappers for the step\_filter\_taxa function, designed to filter Operational Taxonomic Units (OTUs) based on specific criteria: prevalence, variance, abundance, and rarity.
