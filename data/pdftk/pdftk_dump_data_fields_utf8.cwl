...
baseCommand:
  - pdftk
label: pdftk_dump_data_fields_utf8
doc: "Reads a single input PDF file and reports form field statistics to the given
  output filename or stdout, encoded as UTF-8. Does not create a new PDF.\n\nTool
...
inputs:
  ...
  - id: encrypt_128bit
    type:
      - 'null'
      - boolean
    doc: Use 128-bit encryption (default)
    inputBinding:
      position: 103
  ...
  - id: owner_pw
    type:
      - 'null'
      - string
    doc: Set the owner password for the output
    inputBinding:
      position: 103
      prefix: owner_pw
  - id: uncompress
  ...
  - id: user_pw
    type:
      - 'null'
      - string
    doc: Set the user password for the output
    inputBinding:
      position: 103
      prefix: user_pw
  - id: verbose
...
outputs:
  - id: output
    type:
      - 'null'
      - File
    doc: Output filename for the data report
    outputBinding:
      glob: $(inputs.output)
