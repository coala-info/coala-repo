...
* [next](convert_mogrify.html "convert and mogrify") |
* [previous](index.html "seqmagick") |
...
[seqmagick](index.html "previous chapter")

#### Next topic

[`convert` and `mogrify`](convert_mogrify.html "next chapter")

### This Page

* [Show Source](_sources/changelog.rst.txt)

### Quick search

# Changes for seqmagick[¶](#changes-for-seqmagick "Permalink to this headline")

## 0.8.0[¶](#id1 "Permalink to this headline")
...
## 0.7.0[¶](#id2 "Permalink to this headline")
...
## 0.6.2[¶](#id3 "Permalink to this headline")
...
## 0.6.1[¶](#id4 "Permalink to this headline")
...
## 0.6.0[¶](#id5 "Permalink to this headline")
...
## 0.5.0[¶](#id6 "Permalink to this headline")
...
## 0.4.0[¶](#id7 "Permalink to this headline")
...
## 0.3.1[¶](#id8 "Permalink to this headline")

* Fix bug in `quality-filter` MinLengthFilter
* Case consistency in seqmagick

## 0.3.0[¶](#id9 "Permalink to this headline")
...
## 0.2.0[¶](#id10 "Permalink to this headline")
...
## 0.1.0[¶](#id11 "Permalink to this headline")
