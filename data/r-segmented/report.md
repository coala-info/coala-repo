...
### Metadata
- **Conda**: https://anaconda.org/channels/r/packages/r-segmented/overview
- **R-project (CRAN)**: https://cloud.r-project.org/web/packages/segmented/index.html
- **Home (project)**: https://CRAN.R-project.org/package=segmented
- **Package**: segmented
- **Version**: 2.2-1
