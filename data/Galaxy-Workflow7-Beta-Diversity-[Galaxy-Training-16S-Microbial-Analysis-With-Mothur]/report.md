# Workflow7: Beta Diversity [Galaxy Training: 16S Microbial Analysis With Mothur] CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://training.galaxyproject.org
- **Package**: https://workflowhub.eu/workflows/1418
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1418/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 256
...
- **Main workflow (WorkflowHub):** `workflow7-beta-diversity.ga` (Main Workflow)
