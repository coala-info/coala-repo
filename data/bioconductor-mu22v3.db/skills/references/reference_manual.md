...
Mu22v3ACCNUM is an R object that contains mappings between a manufacturer’s identifiers and
...
Mu22v3ALIAS is an R object that provides mappings between common gene symbol identifiers
...
Welcome to the Mu22v3.db annotation Package. The purpose of this package is to provide detailed
information about the Mu22v3 platform. This package is updated biannually.
...
Mu22v3CHR is an R object that provides mappings between a manufacturer identifier and the
...
Mu22v3CHRLENGTHS provides the length measured in base pairs for each of the chromosomes.
...
Mu22v3CHRLOC is an R object that maps manufacturer identifiers to the starting position of the
...
Mu22v3ENSEMBL is an R object that contains mappings between manufacturer identifiers and
...
# Convert to a list
xx <- as.list(Mu22v3ENSEMBL2PROBE)
if(length(xx) > 0){
...
Mu22v3ENTREZID is an R object that provides mappings between manufacturer identifiers and
...
Mu22v3ENZYME is an R object that provides mappings between manufacturer identifiers and EC
numbers. Mu22v3ENZYME2PROBE is an R object that maps Enzyme Commission (EC) numbers
to manufacturer identifiers.

Details

When the Mu22v3ENZYME maping viewed as a list, each manufacturer identifier maps to a named
...
For the Mu22v3ENZYME2PROBE, each EC number maps to a named vector containing all of the
...
numbers. In Mu22v3ENZYME2PROBE, EC is dropped from the Enzyme Commission numbers.
...
# Now convert Mu22v3ENZYME2PROBE to a list to see inside
xx <- as.list(Mu22v3ENZYME2PROBE)
if(length(xx) > 0){
...
Mu22v3GENENAME is an R object that maps manufacturer identifiers to the corresponding gene
name.
...
Mu22v3GO is an R object that provides mappings between manufacturer identifiers and the GO
identifiers that they are directly associated with. This mapping and its reverse mapping (Mu22v3GO2PROBE)
...
Mu22v3GO2ALLPROBES is an R object that provides mappings between a given GO identifier and
all of the manufacturer identifiers annotated at that GO term OR TO ONE OF IT’S CHILD NODES
in the GO ontology. Thus, this mapping is much larger and more inclusive than Mu22v3GO2PROBE.

Details

If Mu22v3GO is cast as a list, each manufacturer identifier is mapped to a list of lists. The names on
...
If Mu22v3GO2ALLPROBES or Mu22v3GO2PROBE is cast as a list, each GO term maps to a
...
# Convert Mu22v3GO2ALLPROBES to a list
xx <- as.list(Mu22v3GO2ALLPROBES)
if(length(xx) > 0){
...
Number of mapped keys for the maps in package Mu22v3.db

Description

DEPRECATED. Counts in the MAPCOUNT table are out of sync and should not be used.

Mu22v3MAPCOUNTS provides the "map count" (i.e. the count of mapped keys) for each map in
package Mu22v3.db.
...
Mu22v3MGI is an R object that contains mappings between manufacturer identifiers and Jackson
...
The Organism information for Mu22v3

Description

Mu22v3ORGANISM is an R object that contains a single item: a character string that names the
organism for which Mu22v3 was built. Mu22v3ORGPKG is an R object that contains a chararcter
vector with the name of the organism package that a chip package depends on for its gene-centric
annotation.

Details

Although the package name is suggestive of the organism for which it was built, Mu22v3ORGANISM
provides a simple way to programmatically extract the organism name. Mu22v3ORGPKG provides
...
Mu22v3PATH maps probe identifiers to the identifiers used by KEGG for pathways in which the
genes represented by the probe identifiers are involved

Mu22v3PATH2PROBE is an R object that provides mappings between KEGG identifiers and man-
...
# Now convert the Mu22v3PATH2PROBE object to a list
xx <- as.list(Mu22v3PATH2PROBE)
if(length(xx) > 0){
...
Mu22v3PFAM is an R object that provides mappings between manufacturer identifiers and PFAM
identifiers.
...
Mu22v3PMID is an R object that provides mappings between manufacturer identifiers and PubMed
identifiers. Mu22v3PMID2PROBE is an R object that provides mappings between PubMed identi-
fiers and manufacturer identifiers.

Details

When Mu22v3PMID is viewed as a list each manufacturer identifier is mapped to a named vector
...
When Mu22v3PMID2PROBE is viewed as a list each PubMed identifier is mapped to a named vec-
...
# Now convert the reverse map object Mu22v3PMID2PROBE to a list
...
Mu22v3PROSITE is an R object that provides mappings between manufacturer identifiers and
PROSITE identifiers.
...
Mu22v3REFSEQ is an R object that provides mappings between manufacturer identifiers and Ref-
Seq identifiers.
...
Mu22v3SYMBOL is an R object that provides mappings between manufacturer identifiers and gene
abbreviations.
...
Mu22v3UNIGENE is an R object that provides mappings between manufacturer identifiers and
UniGene identifiers.
...
Mu22v3UNIPROT is an R object that contains mappings between the manufacturer identifiers and
...
Mu22v3_dbconn()
Mu22v3_dbfile()
Mu22v3_dbschema(file="", show.indices=FALSE)
Mu22v3_dbInfo()
...
Mu22v3_dbconn returns a connection object to the package annotation DB. IMPORTANT: Don’t
call dbDisconnect on the connection object returned by Mu22v3_dbconn or you will break all the
AnnDbObj objects defined in this package!
Mu22v3_dbfile returns the path (character string) to the package annotation DB (this is an SQLite
file).
Mu22v3_dbschema prints the schema definition of the package annotation DB.
Mu22v3_dbInfo prints other information about the package annotation DB.

Value

Mu22v3_dbconn: a DBIConnection object representing an open connection to the package annota-
tion DB.
Mu22v3_dbfile: a character string with the path to the package annotation DB.
Mu22v3_dbschema: none (invisible NULL).
Mu22v3_dbInfo: none (invisible NULL).
...
dbGetQuery(Mu22v3_dbconn(), "SELECT COUNT(*) FROM probes")
...
Mu22v3.db, 2
Mu22v3_dbconn, 20
Mu22v3_dbfile (Mu22v3_dbconn), 20

22

Mu22v3_dbInfo (Mu22v3_dbconn), 20
Mu22v3_dbschema (Mu22v3_dbconn), 20
Mu22v3ACCNUM, 1
Mu22v3ALIAS2PROBE, 2
Mu22v3CHR, 3
Mu22v3CHRLENGTHS, 4
Mu22v3CHRLOC, 4
Mu22v3CHRLOCEND (Mu22v3CHRLOC), 4
Mu22v3ENSEMBL, 5
Mu22v3ENSEMBL2PROBE (Mu22v3ENSEMBL), 5
Mu22v3ENTREZID, 6
Mu22v3ENZYME, 7
Mu22v3ENZYME2PROBE (Mu22v3ENZYME), 7
Mu22v3GENENAME, 9
Mu22v3GO, 10
Mu22v3GO2ALLPROBES, 11
Mu22v3GO2ALLPROBES (Mu22v3GO), 10
Mu22v3GO2PROBE (Mu22v3GO), 10
Mu22v3LOCUSID (Mu22v3ENTREZID), 6
Mu22v3MAPCOUNTS, 12
Mu22v3MGI, 12
Mu22v3MGI2PROBE (Mu22v3MGI), 12
Mu22v3ORGANISM, 13
Mu22v3ORGPKG (Mu22v3ORGANISM), 13
Mu22v3PATH, 14
Mu22v3PATH2PROBE (Mu22v3PATH), 14
Mu22v3PFAM, 15
Mu22v3PMID, 15
Mu22v3PMID2PROBE (Mu22v3PMID), 15
Mu22v3PROSITE, 16
Mu22v3REFSEQ, 17
Mu22v3SYMBOL, 18
Mu22v3UNIGENE, 19
Mu22v3UNIPROT, 20
Mu22v3UNIPROT2PROBE (Mu22v3UNIPROT), 20
