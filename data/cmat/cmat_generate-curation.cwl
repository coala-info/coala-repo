...
inputs:
  ...
  - id: with_conda
    type:
      - 'null'
      - File
    doc: Use the specified Conda environment package or file
    inputBinding:
      position: 102
      prefix: -with-conda
  - id: with_dag
  ...
  - id: with_spack
    type:
      - 'null'
      - File
    doc: Use the specified Spack environment package or file
    inputBinding:
      position: 102
      prefix: -with-spack
  - id: with_timeline
  ...
  - id: with_tower
    type:
      - 'null'
      - boolean
    doc: Monitor workflow execution with Seqera Platform
    inputBinding:
      position: 102
      prefix: -with-tower
  - id: with_trace
