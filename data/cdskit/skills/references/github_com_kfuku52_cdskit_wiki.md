...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fkfuku52%2Fcdskit%2Fwiki)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fwiki%2Findex&source=header-repo&source_repo=kfuku52%2Fcdskit)
...
·
[13 revisions](/kfuku52/cdskit/wiki/Home/_history)

## Setting up

* [Installation and dependencies](https://github.com/kfuku52/cdskit/wiki/Installation-and-dependencies)

## Note on Localization Commands

`localize` and `localize-learn` were removed from `master` in `v0.20.0`.

The localization implementation and benchmarks are maintained on the `codex/localize` branch:

* <https://github.com/kfuku52/cdskit/tree/codex/localize>
...
* [`plot`](https://github.com/kfuku52/cdskit/wiki/cdskit-plot): Plotting aligned CDS summaries, codon-state maps, and nucleotide alignment views with consensus codon/AA and AA frequency logos
...
* Loading
  ...
  + [Setting up](/kfuku52/cdskit/wiki#setting-up)
  + [Note on Localization Commands](/kfuku52/cdskit/wiki#note-on-localization-commands)
  + [CDSKIT commands](/kfuku52/cdskit/wiki#cdskit-commands)
* Loading
