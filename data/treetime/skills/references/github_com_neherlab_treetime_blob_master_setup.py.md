...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fneherlab%2Ftreetime%2Fblob%2Fmaster%2Fsetup.py)
...
[History](/neherlab/treetime/commits/master/setup.py)
...
[Raw](https://github.com/neherlab/treetime/raw/refs/heads/master/setup.py)
...
with open('treetime/\_\_init\_\_.py') as ifile:
...
author\_email='richard.neher@unibas.ch',
...
install\_requires=['biopython>=1.67,!=1.77,!=1.78', 'numpy>=1.10.4', 'pandas>=0.17.1', 'scipy>=0.16.1'],

extras\_require={

':python\_version >= "3.6"': ['matplotlib>=2.0'],
...
'treetime = treetime.\_\_main\_\_:main',
