...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fpirovc%2Fganon%2Fblob%2Fmain%2Fpyproject.toml)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fblob%2Fshow&source=header-repo&source_repo=pirovc%2Fganon)
...
[History](/pirovc/ganon/commits/main/pyproject.toml)
...
[Raw](https://github.com/pirovc/ganon/raw/refs/heads/main/pyproject.toml)
...
dependencies = [ "pandas>=1.2.0", "multitax>=1.4.0" ]
...
ganon = "ganon.ganon:main\_cli"

[build-system]

requires = [ "setuptools>=80", "setuptools\_scm>=8" ]

build-backend = "setuptools.build\_meta"

[tool.setuptools]

script-files = ["scripts/ganon-get-seq-info.sh", "libs/genome\_updater/genome\_updater.sh"]
