...
inputs:
  ...
  - id: print_version
    type:
      - 'null'
      - boolean
    doc: print the Python version number and exit (also --version) when given 
  ...
  - id: verbose_import
    type:
      ...
      - type: array
        items: boolean
    doc: verbose (trace import statements); also PYTHONVERBOSE=x can be supplied
