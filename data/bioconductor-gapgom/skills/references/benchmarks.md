# Benchmarks and other GO similarity methods
...
* [Introduction](#introduction)
  + [Neccesary libraries](#neccesary-libraries)
  + [Background](#background)
* [lncRNA2GOA `expression_prediction`](#lncrna2goa-expression_prediction)
* [TopoICSim](#topoicsim)
  + [TopoICSim - Term level](#topoicsim---term-level)
  + [TopoICSim - Gene level](#topoicsim---gene-level)
  + [TopoICSim - Geneset level (and scalability)](#topoicsim---geneset-level-and-scalability)
...
#>  [1] reshape2_1.4.3       ggplot2_3.1.1        graph_1.62.0
#>  [4] GO.db_3.8.2          profvis_0.3.5        org.Hs.eg.db_3.8.2
#>  [7] AnnotationDbi_1.46.0 IRanges_2.18.0       S4Vectors_0.22.0
#> [10] Biobase_2.44.0       BiocGenerics_0.30.0  GAPGOM_1.0.0
#> [13] kableExtra_1.1.0     knitr_1.22
#>
#> loaded via a namespace (and not attached):
#>  [1] httr_1.4.0          tidyr_0.8.3         bit64_0.9-7
#>  [4] viridisLite_0.3.0   prettydoc_0.2.1     assertthat_0.2.1
#>  [7] highr_0.8           BiocFileCache_1.8.0 RBGL_1.60.0
#> [10] blob_1.1.1          yaml_2.2.0          pillar_1.3.1
#> [13] RSQLite_2.1.1       lattice_0.20-38     glue_1.3.1
#> [16] limma_3.40.0        digest_0.6.18       rvest_0.3.3
#> [19] colorspace_1.4-1    htmltools_0.3.6     Matrix_1.2-17
#> [22] plyr_1.8.4          GEOquery_2.52.0     pkgconfig_2.0.2
#> [25] org.Mm.eg.db_3.8.2  purrr_0.3.2         scales_1.0.0
#> [28] webshot_0.5.1       tibble_2.1.1        withr_2.1.2
#> [31] lazyeval_0.2.2      magrittr_1.5        crayon_1.3.4
#> [34] memoise_1.1.0       evaluate_0.13       xml2_1.2.0
#> [37] tools_3.6.0         data.table_1.12.2   hms_0.4.2
#> [40] matrixStats_0.54.0  stringr_1.4.0       munsell_0.5.0
#> [43] compiler_3.6.0      rlang_0.3.4         grid_3.6.0
#> [46] rstudioapi_0.10     rappdirs_0.3.1      htmlwidgets_1.3
#> [49] igraph_1.2.4.1      labeling_0.3        rmarkdown_1.12
#> [52] gtable_0.3.0        DBI_1.0.0           curl_3.3
#> [55] R6_2.4.0            dplyr_0.8.0.1       bit_1.1-14
#> [58] fastmatch_1.1-0     readr_1.3.1         GOSemSim_2.10.0
#> [61] stringi_1.4.3       Rcpp_1.0.1          dbplyr_1.4.0
