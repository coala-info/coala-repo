...
* [ ]
  ...
  + [TUI Keyboard Shortcuts](#tui-keyboard-shortcuts)
    ...
    - [Layout](#layout)
    - [Filtering](#filtering)
    - [Log History Navigation](#log-history-navigation)
    - [Table Sorting](#table-sorting)
    - [Modal Navigation (vim-style)](#modal-navigation-vim-style)
  + [Time Estimation](#time-estimation)

    - [Weighting Strategies](#weighting-strategies)
    - [Wildcard Conditioning](#wildcard-conditioning)
  + [How It Works](#how-it-works)
  + [Enhanced Monitoring with Logger Plugin](#enhanced-monitoring-with-logger-plugin)
...
## CLI Commands[¶](#cli-commands "Permanent link")
...
## TUI Keyboard Shortcuts[¶](#tui-keyboard-shortcuts "Permanent link")
...
### Refresh Rate[¶](#refresh-rate "Permanent link")
...
### Filtering[¶](#filtering "Permanent link")
...
### Log History Navigation[¶](#log-history-navigation "Permanent link")
...
### Table Sorting[¶](#table-sorting "Permanent link")
...
### Modal Navigation (vim-style)[¶](#modal-navigation-vim-style "Permanent link")
...
### Weighting Strategies[¶](#weighting-strategies "Permanent link")
...
### Wildcard Conditioning[¶](#wildcard-conditioning "Permanent link")
...
## Enhanced Monitoring with Logger Plugin[¶](#enhanced-monitoring-with-logger-plugin "Permanent link")
