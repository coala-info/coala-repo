# Taxonomy Profiling and Visualization with Krona CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://training.galaxyproject.org
- **Package**: https://workflowhub.eu/workflows/1483
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1483/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 279
...
- **Main workflow (WorkflowHub):** `taxonomy-profiling-and-visualisation-with-krona.ga` (Main Workflow)
