...
* [1 Overview](#overview)
* [2 Explicit loading of “custom” hg38](#explicit-loading-of-custom-hg38)
* [3 Use the SARS-CoV-2 genome](#use-the-sars-cov-2-genome)
* [4 Configure and run an nginx webserver, with CORS and Byte-Range support](#configure-and-run-an-nginx-webserver-with-cors-and-byte-range-support)
  + [4.1 CORS: cross-origin resource sharing](#cors-cross-origin-resource-sharing)
  + [4.2 Byte-range support](#byte-range-support)
  + [4.3 A sample nginx configuration.](#a-sample-nginx-configuration.)
  + [4.4 Run nginx out of a docker container.](#run-nginx-out-of-a-docker-container.)
...
# 2 Explicit loading of “custom” hg38
...
# 4 Configure and run an nginx webserver, with CORS and Byte-Range support
...
## 4.3 A sample nginx configuration.
...
## 4.4 Run nginx out of a docker container.
