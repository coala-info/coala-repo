...
* [1 AnVILPublish](#anvilpublish)
  + [1.1 Package installation](#package-installation)
* [2 Requirements](#requirements)
  + [2.1 Best practices](#best-practices)
  + [2.2 The `gcloud` SDK](#the-gcloud-sdk)
  + [2.3 `Quarto` software](#quarto-software)
* [3 Creating or updating workspaces](#creating-or-updating-workspaces)
  + [3.1 From package source](#from-package-source)
  + [3.2 From collections of Rmd files](#from-collections-of-rmd-files)
* [4 Updating notebooks or workspace permissions](#updating-notebooks-or-workspace-permissions)
  + [4.1 Updating workspace notebooks from vignettes](#updating-workspace-notebooks-from-vignettes)
  + [4.2 Adding user access credentials to share the notebook](#adding-user-access-credentials-to-share-the-notebook)
* [5 Vignette and .Rmd best practices](#vignette-and-.rmd-best-practices)
  + [5.1 Orientation](#orientation)
  + [5.2 Best practices](#best-practices-1)
  + [5.3 Additional notes on .Rmd conversion](#additional-notes-on-.rmd-conversion)
...
does *NOT* support AnVIL workspaces that use the Azure platform.
...
It is necessary to have the [gcloud SDK](https://cloud.google.com/sdk) available to copy notebook
...
Jupyter (`.ipynb`) notebooks uses [Quarto](https://quarto.org) software. It must be
...
# 3 Creating or updating workspaces
...
## 3.2 From collections of Rmd files

Some *R* resources, e.g., [bookdown](https://bookdown.org/) sites, are not in
...
# 4 Updating notebooks or workspace permissions
...
## 4.1 Updating workspace notebooks from vignettes
...
## 4.2 Adding user access credentials to share the notebook
...
# 5 Vignette and .Rmd best practices
...
5. All code chunks, regardless of annotations such as `eval = FALSE`
...
## 5.3 Additional notes on .Rmd conversion

Current best practice is to use [quarto](https://quarto.org) for conversion of
