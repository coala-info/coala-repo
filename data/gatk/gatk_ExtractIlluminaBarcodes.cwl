...
label: gatk_ExtractIlluminaBarcodes
...
inputs:
  ...
  - id: barcode_file
    ...
    doc: Tab-delimited file of barcode sequences, barcode name and, optionally, 
      ...
      'barcode_sequence_2' (optional), 'barcode_name', and 'library_name'. 
      Required. Cannot be used in conjunction with argument(s) BARCODE
    inputBinding:
      position: 101
      prefix: --BARCODE_FILE
  - id: basecalls_dir
  ...
  - id: distance_mode
    ...
    doc: The distance metric that should be used to compare the barcode-reads 
      and the provided barcodes for finding the best and second-best 
      assignments.
    inputBinding:
      position: 101
  ...
  - id: input_params_file
    type:
      - 'null'
      - File
    doc: The input file that defines parameters for the program. This is the 
      BARCODE_FILE for `ExtractIlluminaBarcodes` or the MULTIPLEX_PARAMS or 
      LIBRARY_PARAMS file for `IlluminaBasecallsToFastq` or 
