...
* genes\_file - an annotations file in GFF format. The chromosome in the first column should match the chromosomes in your LD data.
...
* pathways\_file - the pathways file is a tab-delimited file that, for every gene in a pathway contains a line formatted as described below. The gene names in your pathways file must match the gene names in your GFF.
