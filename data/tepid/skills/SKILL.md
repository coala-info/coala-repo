---
name: tepid
description: TEPID (Transposable Element Polymorphism IDentification) is a bioinformatic pipeline designed to find variation in transposable element content between a sample and a reference genome.
