...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fthegenemyers%2FFASTK%2Fblob%2Fmaster%2FFastxfer.c)
...
[History](/thegenemyers/FASTK/commits/master/Fastxfer.c)

History

243 lines (219 loc) · 7.05 KB
...
[Raw](https://github.com/thegenemyers/FASTK/raw/refs/heads/master/Fastxfer.c)
...
NO\_OVERWRITE = flags['n'];

if (QUIET)

QUERY = NO\_OVERWRITE = 0;

if (argc > 3)

{ if ( ! (stat(argv[argc-1],&B) == 0 && (B.st\_mode & S\_IFMT) == S\_IFDIR))
