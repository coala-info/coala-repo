# Metagenome and metatranscriptome assembly in CWL CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://www.ebi.ac.uk/metagenomics
- **Package**: https://workflowhub.eu/workflows/474
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/474/ro_crate?version=2
- **Conda**: N/A
...
- **Main workflow (WorkflowHub):** `src/workflows/metagenome_pipeline.cwl` (Main Workflow)
- **Project**: HoloFood at MGnify
- **Views**: 5849
