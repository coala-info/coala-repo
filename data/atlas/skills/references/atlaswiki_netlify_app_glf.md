...
`GLF` allows estimating and write marginal genotype likelihoods of the bam files to a GLF file (format described [here](https://bitbucket.org/WegmannLab/atlas/wiki/Common%20Methods%3A%20glf%20format)).
