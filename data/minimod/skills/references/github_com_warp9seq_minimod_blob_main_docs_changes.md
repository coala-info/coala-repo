...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fwarp9seq%2Fminimod%2Fblob%2Fmain%2Fdocs%2Fchanges.md)
...
2. /[docs](/warp9seq/minimod/tree/main/docs)
...
[History](/warp9seq/minimod/commits/main/docs/changes.md)
...
[Raw](https://github.com/warp9seq/minimod/raw/refs/heads/main/docs/changes.md)
...
* For >=v0.5.0, mod\_prob in the output of view subtool will slightly change due to a change on how probability conversion from unsigned 8-bit N to float probability p. Previously, it was p = N/255.0 and now we use p = (N+0.5)/256.0 as the conversion function.
