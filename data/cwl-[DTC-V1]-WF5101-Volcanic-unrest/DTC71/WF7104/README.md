# WF7104 Workflow Files

This directory contains workflow files generated from the spreadsheet description of WF7104 using a [custom tool](https://github.com/Marco-Salvi/dt-geo-converter). These files provide an initial starting point, **manual verification and updates are required** to ensure accuracy.
...
``` log
[WARNING] [Inner step ST710402 has no inputs or outputs; please verify its configuration]
[WARNING] [Inner step ST710403 has no inputs or outputs; please verify its configuration]
[WARNING] [Step ST710403 has no inputs or outputs]
[WARNING] [Step ST710404 has no inputs or outputs]
[WARNING] [Step ST710401 has no inputs or outputs]
[WARNING] [Step ST710402 has no inputs or outputs]
```



For complete details, please refer to the [log file](./workflows/WF7104)
