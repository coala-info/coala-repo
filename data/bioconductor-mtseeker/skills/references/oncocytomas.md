...
Tim Triche, Jr. and Noor Sohail

#### *12 November 2018*

#### Abstract

An example of processing renal oncocytomas and matched normal kidney samples with MTseeker, calling variants and plotting results.
...
The *RONKSreads* and *RONKSvariants* data objects hold aligned reads (as
an MAlignments object) and called variants (as an MVRangesList object)
comparing \_R\_enal \_O\_ncocytomas and \_N\_ormal \_K\_idney \_S\_amples from 11
...
that results in the accumulation of additional mutations (like *TP53* in CRCCs).
...
are useful for these purposes) At present, MTseeker supports the *gmapR* package
...
so we skip this step in the production vignette. (It *is* done in the build!)
...
![mtDNA variants in oncocytomas and normal kidney samples](data:image/png;base64...)
