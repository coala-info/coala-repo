...
* [1 Overview](#overview)
  ...
  + [1.3 Adding / Tracking Resources](#adding-tracking-resources)
  + [1.4 Investigating / Accessing Resources](#investigating-accessing-resources)
  + [1.5 Updating Resource Entries or Local Copy of Remote Data](#updating-resource-entries-or-local-copy-of-remote-data)
  + [1.6 Adding MetaData](#adding-metadata)
  + [1.7 Removing Resources](#removing-resources)
  + [1.8 Exporting and Importing Cache](#exporting-and-importing-cache)
  + [1.9 Creating a Cache from Existing Data](#creating-a-cache-from-existing-data)
  + [1.10 Cleaning or Removing Cache](#cleaning-or-removing-cache)
...
```
bfccache(bfc)
## [1] "/tmp/RtmpA24XLX/file36414c75c0e362"
length(bfc)
## [1] 0
```
...
bfc
## class: BiocFileCache
## bfccache: /tmp/RtmpA24XLX/file36414c75c0e362
## bfccount: 0
## For more information see: bfcinfo() or bfcquery()
```

`bfcinfo()` will list a table of `BiocFileCache` resource files being tracked in
the cache. It returns a [dplyr](https://cran.r-project.org/package%3Ddplyr) object of class `tbl_sqlite`.
...
* `last_modified_time`: For a remote resource, the last\_modified (if available)
...
saved in many different ways, `bfcnew()` allows you to save any *R* data object
...
savepath
##                                                                     BFC1
## "/tmp/RtmpA24XLX/file36414c75c0e362/36414c4d096092_36414c4d096092.RData"
...
## 1 BFC1  NewR… 2025-10-30… 2025-10-30… /tmp… rela… 3641…                 NA <NA>
...
add2
##                                                                   BFC2
## "/tmp/RtmpA24XLX/file36414c75c0e362/36414c62c6d6c6_file36414c31f9ba42"
...
## 1 BFC1  NewR… 2025-10-30… 2025-10-30… /tmp… rela… 3641… <NA>               <NA>
## 2 BFC2  Test… 2025-10-30… 2025-10-30… /tmp… rela… /tmp… <NA>               <NA>
## 3 BFC3  Test… 2025-10-30… 2025-10-30… /tmp… rela… /tmp… <NA>               <NA>
## 4 BFC4  Test… 2025-10-30… 2025-10-30… /tmp… local /tmp… <NA>               <NA>
## 5 BFC5  Test… 2025-10-30… 2025-10-30… /tmp… web   http… <NA>               <NA>
## 6 BFC6  Test… 2025-10-30… 2025-10-30… /tmp… web   http… 2025-10-30         <NA>
## 7 BFC7  Test… 2025-10-30… 2025-10-30… /tmp… web   http… <NA>               <NA>
## # ℹ 1 more variable: expires <dbl>
```
...
original file name (identifier\_originalName) when added to the cache to allow
for multiple versions of the same file name. There is an option to override this
default behavior by using the `fname` argument of `bfcadd` or `bfcnew`. `fname`
takes one of two options: `unique` or `exact`. The `unique` option behaves as
...
## 1.4 Investigating / Accessing Resources
...
##   rid   rname create_time access_time rpath rtype fpath last_modified_time etag
##   <chr> <chr> <chr>       <chr>       <chr> <chr> <chr> <chr>              <chr>
## 1 BFC5  Test… 2025-10-30… 2025-10-30… /tmp… web   http… <NA>               <NA>
## 2 BFC6  Test… 2025-10-30… 2025-10-30… /tmp… web   http… 2025-10-30         <NA>
## # ℹ 1 more variable: expires <dbl>
...
##   rid   rname create_time access_time rpath rtype fpath last_modified_time etag
##   <chr> <chr> <chr>       <chr>       <chr> <chr> <chr> <chr>              <chr>
## 1 BFC6  Test… 2025-10-30… 2025-10-30… /tmp… web   http… 2025-10-30         <NA>
## 2 BFC7  Test… 2025-10-30… 2025-10-30… /tmp… web   http… <NA>               <NA>
## # ℹ 1 more variable: expires <dbl>
class(q1)
...
bfcpath(bfc, "BFC5")
##                                                    BFC5
## "/tmp/RtmpA24XLX/file36414c75c0e362/36414c75439cc9_get"
...
##           "/tmp/RtmpA24XLX/file36414c75c0e362/36414c62c6d6c6_file36414c31f9ba42"
##                                                                             BFC3
##            "/tmp/RtmpA24XLX/file36414c75c0e362/36414c93c244b_file36414c28c0b47a"
##                                                                             BFC4
##                                             "/tmp/RtmpA24XLX/file36414c394c7e7c"
##                                                                             BFC5
##                          "/tmp/RtmpA24XLX/file36414c75c0e362/36414c75439cc9_get"
##                                                                             BFC6
## "/tmp/RtmpA24XLX/file36414c75c0e362/36414c2d20f159_BiocFileCache_2024_stats.tab"
##                                                                             BFC7
##  "/tmp/RtmpA24XLX/file36414c75c0e362/36414c47045fd_BiocFileCache_2024_stats.tab"
bfcrpath(bfc, c("https://httpbin.org/get","Test3_addAsis"))
## adding rname 'https://httpbin.org/get'
##                                                    BFC4
##                    "/tmp/RtmpA24XLX/file36414c394c7e7c"
##                                                    BFC8
## "/tmp/RtmpA24XLX/file36414c75c0e362/36414c1bf6bd2d_get"
```
...
etag and last\_modifed time to the etag and last\_modified time of the remote
...
last\_modified\_time. The etag information is used definitively if it is
available, if it is not available it checks the last\_modified time. If the
resource does not have a last\_modified tag either, it is undetermined. If the
...
## 1.5 Updating Resource Entries or Local Copy of Remote Data
...
fl3
## [1] "/tmp/RtmpA24XLX/file36414c394c7e7c"

bfc[[rid3]]<-fl3
## Warning in `[[<-`(`*tmp*`, rid3, value = "/tmp/RtmpA24XLX/file36414c394c7e7c"):
...
##   rid   rname create_time access_time rpath rtype fpath last_modified_time etag
##   <chr> <chr> <chr>       <chr>       <chr> <chr> <chr>              <dbl> <chr>
## 1 BFC1  Firs… 2025-10-30… 2025-10-30… /tmp… rela… 3641…                 NA <NA>
## # ℹ 1 more variable: expires <dbl>
```
...
##   rid   rpath                                                              fpath
##   <chr> <chr>                                                              <chr>
## 1 BFC6  /tmp/RtmpA24XLX/file36414c75c0e362/36414c2d20f159_BiocFileCache_2… http…
...
##   /tmp/RtmpA24XLX/file36414c75c0e362/36414c93c244b_file36414c28c0b47a
##   /tmp/RtmpA24XLX/file36414c75c0e362/add_or_return_rname.LOCK
##
## [1] FALSE
...
## 1.8 Exporting and Importing Cache
...
## 1.9 Creating a Cache from Existing Data
...
### 1.9.1 Create a BiocFileCache from an Existing data.frame
...
## 1   web  <NA>                    https://httpbin.org/get  httpbin
...
## 1.10 Cleaning or Removing Cache
