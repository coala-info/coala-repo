...
* Knut Reinert,
  ...
  Gianvito Urgese,
  David Weese,
  [“The SeqAn C++ template library for efficient sequence analysis: A resource for programmers”](http://doi.org/10.1016/j.jbiotec.2017.07.017), vol. 261, 2017-11-10.
...
* Evelin Aasna,
  ...
  Marcel Ehrhardt,
  Knut Reinert,
  [“Dream-stellar: parallel and space efficient exact local alignment”](https://link.springer.com/article/10.1186/s12859-026-06389-0), 2026-02-18.
  cite this publication

  ```
  @article{fu_mi_publications3311,
   abstract = {Background:
  ...
  DREAM-Stellar is very practical and fast on very long sequences which makes it a suitable new tool for finding local alignments between genomic sequences under the edit distance model. The software is freely available for Linux and Mac OS X at https://github.com/seqan/dream-stellar},
   author = {Evelin Aasna and Simon G Gottlieb and Marcel Ehrhardt and Knut Reinert},
   journal = {BMC Bioinformatics},
   month = {February},
   publisher = {Springer Nature},
   title = {Dream-stellar: parallel and space efficient exact local alignment},
   url = {http://publications.imp.fu-berlin.de/3311/},
   year = {2026}
  }
  ```
...
* Vitor C. Piro,
  ...
  analysis”](https://academic.oup.com/nargab/article/doi/10.1093/nargab/lqaf094/8204051), vol. 7, iss. 3, 2025-07-17.
  cite this publication

  ```
  @article{fu_mi_publications3142,
...
* Yannek Nowatzky,
  ...
  Thilo Muth,
  Philipp Benner,
  [“FIORA: Local neighborhood-based prediction of compound mass spectra from single fragmentation events”](https://www.nature.com/articles/s41467-025-57422-4), vol. 16, iss. 1, 2025-03-07.
  cite this publication

  ```
  @article{fu_mi_publications3246,
   ...
   author = {Yannek Nowatzky and Francesco Russo and Jan Lisec and Alexander Kister and Knut Reinert and Thilo Muth and Philipp Benner},
   booktitle = {Fiora: Local neighborhood-based prediction of compound mass spectra from single fragmentation events},
   journal = {Nature Communications},
   month = {March},
   number = {1},
   publisher = {Springer Nature, London},
   title = {FIORA: Local neighborhood-based prediction of compound mass spectra from single fragmentation events},
   url = {http://publications.imp.fu-berlin.de/3246/},
   volume = {16},
   year = {2025}
  }
  ```
* Remy Marcel Schwab,
  Simon G Gottlieb,
  Knut Reinert,
  [“TetRex: a novel algorithm for index-accelerated search of highly conserved motifs”](https://academic.oup.com/nargab/article/7/2/lqaf039/8115380), vol. 7, iss. 2, 2025-04-17.
  cite this publication
...
* Simon G Gottlieb,
  Knut Reinert,
  [“SeArcH schemes for Approximate stRing mAtching”](https://academic.oup.com/nargab/article/7/1/lqaf025/8084725), vol. 7, iss. 1, 2025-03-18.
  cite this publication

  ```
  @article{fu_mi_publications3285,
   ...
   author = {Simon G Gottlieb and Knut Reinert},
   journal = {NAR Genomics and Bioinformatics},
   month = {March},
   number = {1},
   publisher = {Oxford University Press},
   title = {SeArcH schemes for Approximate stRing mAtching},
   url = {http://publications.imp.fu-berlin.de/3285/},
   volume = {7},
   year = {2025}
  }
  ```
* Simon G Gottlieb,
  Knut Reinert,
  [“Engineering rank queries on bit vectors and strings”](https://link.springer.com/article/10.1186/s13015-025-00291-9), vol. 20 / 1, iss. 21, 2025-12-11.
  cite this publication

  ```
  @article{fu_mi_publications3312,
