...
description: The `featureBits` utility is a high-performance tool from the UCSC Genome Browser "kent" suite designed to analyze genomic overlaps using bitmap projections.
