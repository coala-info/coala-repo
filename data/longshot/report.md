...
### Tool Description
variant caller (SNVs) for long-read sequencing data 1.0.0

### Metadata
- **Docker Image**: quay.io/biocontainers/longshot:1.0.0--hd4f2111_2
- **Homepage**: https://github.com/pjedge/longshot
- **Package**: https://anaconda.org/channels/bioconda/packages/longshot/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/longshot/overview
- **Total Downloads**: 75.9K
- **Last updated**: 2025-04-22
- **GitHub**: https://github.com/pjedge/longshot
- **Stars**: N/A
### Original Help Text
```text
Longshot: variant caller (SNVs) for long-read sequencing data 1.0.0
...
OPTIONS:
    ...
    -I, --max_cigar_indel <int>                Throw away a read-variant during allelotyping if there is a CIGAR indel
        ...
        --max_reads_estimation <int>           number of reads used for estimating alignment parameters, default value
                                               is 0 which uses all reads [default: 0]
