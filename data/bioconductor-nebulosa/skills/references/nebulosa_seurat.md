...
*Principal Component Analysis* (PCA) first to reduce the dimensions of our
...
*Shared Nearest Neighbor* (SNN) *Graph* using the first 30 principal components
and applying the *Louvain algorithm*.
...
## 5.1 Identifying Naive CD8+ T cells
...
## 5.2 Identifying Naive CD4+ T cells
