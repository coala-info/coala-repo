...
baseCommand:
  - ms2pip
  - get-training-data
label: ms2pip_get-training-data
doc: "Extract feature vectors and target intensities from observed spectra for training.\n\
...
stdout: ms2pip_get-training-data.out
