...
### Metadata
- **Conda**: https://anaconda.org/channels/r/packages/r-statmod/overview
- **R-project (CRAN)**: https://cloud.r-project.org/web/packages/statmod/index.html
- **Home (project)**: https://CRAN.R-project.org/package=statmod
- **Package**: statmod
- **Version**: 1.5.1
