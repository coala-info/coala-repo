# [slow5curl](https://bonsonw.github.io/slow5curl/)
...
* `--skip`:
  Warn and continue if a read\_id was not found
* `--index FILE`:
...
This site is open source. [Improve this page](https://github.com/BonsonW/slow5curl/edit/main/docs/commands.md).