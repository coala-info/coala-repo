...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fmedvedevgroup%2FHowDeSBT%2Fblob%2Fmaster%2Fcmd_bf_operate.h)
...
[History](/medvedevgroup/HowDeSBT/commits/master/cmd_bf_operate.h)
...
[Raw](https://github.com/medvedevgroup/HowDeSBT/raw/refs/heads/master/cmd_bf_operate.h)
...
#ifndef cmd\_bf\_operate\_H

#define cmd\_bf\_operate\_H
...
virtual void short\_description (std::ostream& s);

virtual void usage (std::ostream& s, const std::string& message="");

virtual void debug\_help (std::ostream& s);

virtual void parse (int \_argc, char\*\* \_argv);

virtual int execute (void);

virtual void op\_and (void);

virtual void op\_or (void);

virtual void op\_xor (void);

virtual void op\_eq (void);

virtual void op\_complement (void);

virtual void op\_rrr (void);

virtual void op\_unrrr (void);
