...
* [1 DockerHub](#dockerhub)
  ...
  + [1.2 Method 1: via Docker](#method-1-via-docker)
    - [1.2.1 NOTES](#notes)
  + [1.3 Method 2: via Singularity](#method-2-via-singularity)
  + [1.4 Usage](#usage)
* [2 Session Info](#session-info)

# 1 DockerHub

epicompare is now available via
[DockerHub](https://hub.docker.com/repository/docker/neurogenomicslab/epicompare)
