...
Computation of local false discovery rates.</p>

### Metadata
- **Conda**: https://anaconda.org/channels/r/packages/r-locfdr/overview
- **R-project (CRAN)**: https://cloud.r-project.org/web/packages/locfdr/index.html
- **Home (project)**: https://CRAN.R-project.org/package=locfdr
- **Package**: locfdr
- **Version**: 1.1-8
