...
doc: "Aligns multiple sequences to find conserved regions and rearrangements.\n\n\
  Tool homepage: http://darlinglab.org/mauve/"
inputs:
  - id: seq_filename
    type: File
    doc: Filename of sequences to align (all in a single file)
    inputBinding:
      position: 1
  - id: seq_filenames
    type:
      type: array
      items: File
    doc: Filenames of sequences to align (each in a separate file)
    inputBinding:
      position: 2
  - id: apply_backbone
    type:
