...
baseCommand: perl
label: perl-text-wrap_perl
doc: "The Perl 5 language interpreter\n\nTool homepage: http://metacpan.org/pod/Text::Wrap"
inputs:
  - id: program_file
    type:
      - 'null'
...
hints:
  - class: DockerRequirement
    dockerPull: quay.io/biocontainers/perl-text-wrap:2021.0814--pl5321hdfd78af_0
stdout: perl-text-wrap_perl.out
