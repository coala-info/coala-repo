...
label: picard_ClusterCrosscheckMetrics
doc: "Clusters the results from a CrosscheckFingerprints run according to the LOD
  score. The resulting metric file can be used to assist diagnosing results from CrosscheckFingerprints.
  It clusters the connectivity graph between the different groups. Two groups are
  connected if they have a LOD score greater than the LOD_THRESHOLD.\n\nTool homepage:
