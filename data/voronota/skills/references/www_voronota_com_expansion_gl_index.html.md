# Voronota-GL version 1.29

* [About Voronota-GL expansion](#about-voronota-gl-expansion)
...
* [Building from source code on Linux](#building-from-source-code-on-linux)
  + [Requirements](#requirements)
  + [Using CMake](#using-cmake)
  + [Using C++ compiler directly](#using-c-compiler-directly)
* [Building from source code on Mac OS](#building-from-source-code-on-mac-os)

# About Voronota-GL expansion

Voronota-GL is an expansion of [the core Voronota software](../index.html). Voronota-GL is built on top of [the Voronota-JS expansion](../expansion_js/index.html).
...
The archive contains the Voronota-GL software in the ‘expansion\_gl’ subdirectory. The ‘voronota-gl’ executable can be built from the provided source code.
