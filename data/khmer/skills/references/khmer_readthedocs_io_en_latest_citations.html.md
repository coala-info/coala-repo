...
* [next](release-notes/index.html "Release notes") |
* [previous](contributors.html "Contributors and Acknowledgements") |
...
* Citations
  ...
  + [Graph partitioning and/or compressible graph representation](#graph-partitioning-and-or-compressible-graph-representation)
  + [Digital normalization](#digital-normalization)
  + [Efficient k-mer error trimming](#efficient-k-mer-error-trimming)
  + [K-mer counting](#k-mer-counting)
  + [FASTA and FASTQ reading](#fasta-and-fastq-reading)

#### Previous topic

[Contributors and Acknowledgements](contributors.html "previous chapter")

#### Next topic

[Release notes](release-notes/index.html "next chapter")

### This Page

* [Show Source](_sources/citations.rst.txt)
...
## Software Citation[¶](#software-citation "Permalink to this headline")
...
the [SeqAn library](http://www.seqan.de) for read parsing: the full citation
...
## Graph partitioning and/or compressible graph representation[¶](#graph-partitioning-and-or-compressible-graph-representation "Permalink to this headline")

The **load-graph.py**, **partition-graph.py**,
and **find-knots.py** scripts are part of the compressible graph
...
## Digital normalization[¶](#digital-normalization "Permalink to this headline")

The **normalize-by-median.py** and **count-median.py** scripts
...
## Efficient k-mer error trimming[¶](#efficient-k-mer-error-trimming "Permalink to this headline")
...
The **abundance-dist.py**, **filter-abund.py**, and
**load-into-counting.py** scripts implement the probabilistic k-mer
...
## FASTA and FASTQ reading[¶](#fasta-and-fastq-reading "Permalink to this headline")
...
[Contributors and Acknowledgements](contributors.html "previous chapter (use the left arrow)")

[Release notes](release-notes/index.html "next chapter (use the right arrow)")
