...
* Contributing
* [Edit on GitHub](https://github.com/htseq/htseq/blob/main/doc/contrib.rst)
...
## Source code[](#source-code "Permalink to this heading")

The source code is on [Github](https://github.com/htseq/htseq). To check out the repository, use

```
git clone https://github.com/htseq/htseq.git
```

## Languages[](#languages "Permalink to this heading")

HTSeq is exposed in and mostly written in Python 3.

Several parts of HTSeq are written in [Cython](http://www.cython.org/). In case you don’t know it
...
[SWIG](http://www.swig.org/). [SWIG](http://www.swig.org/), the “Simple Wrapper and Interface Generator” is a very useful
...
## Build process[](#build-process "Permalink to this heading")
...
To build the documentation, [Sphinx](http://www.sphinx-doc.org/) is used. Just go into the `doc` folder
and call:
...
to regenerate the documentation. Official docs are stored on [readthedocs](https://readthedocs.org/).

## Distributing[](#distributing "Permalink to this heading")
...
[Previous](history.html "Version history")
