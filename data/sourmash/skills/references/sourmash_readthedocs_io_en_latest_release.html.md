# Releasing a new version of sourmash[¶](#releasing-a-new-version-of-sourmash "Link to this heading")

These are adapted from the khmer release docs, originally written by
Michael Crusoe.

## A release process overview[¶](#a-release-process-overview "Link to this heading")
...
## Checklist[¶](#checklist "Link to this heading")
...
## Creating the build environment with conda[¶](#creating-the-build-environment-with-conda "Link to this heading")
...
## Writing release notes[¶](#writing-release-notes "Link to this heading")
...
## Testing a release[¶](#testing-a-release "Link to this heading")

0. First things first: check if Read the Docs is building properly for `latest`.
The build for the `latest` branch on [Read the Docs](https://readthedocs.org/projects/sourmash/builds/) should be passing,
and also the [rendered docs](https://sourmash.readthedocs.io/en/latest/) should be up to date.
...
You might want to check [the releases page](https://github.com/sourmash-bio/sourmash/releases) for next version number,
...
## How to make a final release[¶](#how-to-make-a-final-release "Link to this heading")
...
from [the releases page](https://github.com/sourmash-bio/sourmash/releases), or, if you have the
...
## Conda-forge[¶](#conda-forge "Link to this heading")
...
## Bioconda[¶](#bioconda "Link to this heading")
...
## Pyodide[¶](#pyodide "Link to this heading")
...
## Announce it![¶](#announce-it "Link to this heading")
...
## After release[¶](#after-release "Link to this heading")
...
* [Show Source](_sources/release.md.txt)
...
|
[Page source](_sources/release.md.txt)