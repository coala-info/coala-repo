...
inputs:
  ...
  - id: force
    ...
    inputBinding:
      position: 101
      prefix: --force
  - id: full_genome_reference
    type:
      - 'null'
      - File
    doc: Custom full genome reference fasta file (.fa, .fasta, or .fna)
    inputBinding:
      position: 101
      prefix: --full_genome_reference
  ...
  - id: vcf
    ...
    inputBinding:
      position: 101
      prefix: --vcffile
  - id: y_chromosome_reference
    type:
      - 'null'
      - File
    doc: Custom Y chromosome reference fasta file (.fa, .fasta, or .fna)
    inputBinding:
      position: 101
      prefix: --y_chromosome_reference
outputs:
  - id: stdout
    type: stdout
    doc: Standard output
