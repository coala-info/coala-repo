...
### Tool Description
GNU Make is a utility that determines which pieces of a program need to be recompiled, and issues the commands to recompile them.
...
- **Conda**: https://anaconda.org/channels/bioconda/packages/goldrush/overview
- **Total Downloads**: 20.3K
- **Last updated**: 2025-04-22
- **GitHub**: https://github.com/bcgsc/goldrush
- **Stars**: N/A
### Original Help Text
```text
