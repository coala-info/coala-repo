...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2FKChigira%2Fmkdesigner)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E&source=header-repo&source_repo=KChigira%2Fmkdesigner)
...
[Branches](/KChigira/mkdesigner/branches)[Tags](/KChigira/mkdesigner/tags)
...
| --- | --- | --- | --- | --- |
| Latest commit   History[36 Commits](/KChigira/mkdesigner/commits/main/)   36 Commits | | |
| [fig](/KChigira/mkdesigner/tree/main/fig "fig") | | [fig](/KChigira/mkdesigner/tree/main/fig "fig") |  |  |
| [mkdesigner](/KChigira/mkdesigner/tree/main/mkdesigner "mkdesigner") | | [mkdesigner](/KChigira/mkdesigner/tree/main/mkdesigner "mkdesigner") |  |  |
| [test](/KChigira/mkdesigner/tree/main/test "test") | | [test](/KChigira/mkdesigner/tree/main/test "test") |  |  |
| [.gitignore](/KChigira/mkdesigner/blob/main/.gitignore ".gitignore") | | [.gitignore](/KChigira/mkdesigner/blob/main/.gitignore ".gitignore") |  |  |
| [LICENSE](/KChigira/mkdesigner/blob/main/LICENSE "LICENSE") | | [LICENSE](/KChigira/mkdesigner/blob/main/LICENSE "LICENSE") |  |  |
| [MANIFEST.in](/KChigira/mkdesigner/blob/main/MANIFEST.in "MANIFEST.in") | | [MANIFEST.in](/KChigira/mkdesigner/blob/main/MANIFEST.in "MANIFEST.in") |  |  |
| [README.md](/KChigira/mkdesigner/blob/main/README.md "README.md") | | [README.md](/KChigira/mkdesigner/blob/main/README.md "README.md") |  |  |
| [setup.py](/KChigira/mkdesigner/blob/main/setup.py "setup.py") | | [setup.py](/KChigira/mkdesigner/blob/main/setup.py "setup.py") |  |  |
| View all files | | |
...
* Phased genotypes (such as '0|0', '1|1') are now supported.
  2025-04-04 v0.5.2
...
Then, you will get the directory named 'test\_mkvcf/'
...
* 'test\_ready\_for\_mkprimer.vcf' -----Output VCF file
...
Then, you will get the directory named 'test\_mkprimer/'
...
* 'test\_primer\_added.vcf' -----Output VCF file
* 'for\_draw.fai' -----Fasta index file (For drawing the positions of markers)
...
Then, you will get the directory named 'test\_mkselect/'
...
* 'test\_primer\_data.tsv' -----Useful information of primers and its anpllicons

[![test.png](/KChigira/mkdesigner/raw/main/fig/test01.png)](/KChigira/mkdesigner/blob/main/fig/test01.png)
...
[![test_all.png](/KChigira/mkdesigner/raw/main/fig/test02.png)](/KChigira/mkdesigner/blob/main/fig/test02.png)
