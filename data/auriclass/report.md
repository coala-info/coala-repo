...
### Metadata
- **Docker Image**: quay.io/biocontainers/auriclass:0.5.4--pyhdfd78af_0
- **Homepage**: https://rivm-bioinformatics.github.io/auriclass/
- **Package**: https://anaconda.org/channels/bioconda/packages/auriclass/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/auriclass/overview
- **Total Downloads**: 5.5K
- **Last updated**: 2025-04-22
- **GitHub**: https://github.com/RIVM-bioinformatics/auriclass
- **Stars**: N/A
### Original Help Text
```text
usage: auriclass [-h] [-n NAME] [-o OUTPUT_REPORT_PATH] [--fastq] [--fasta]
                 [--no_qc] [--log_file_path LOG_FILE_PATH] [--verbose]
                 [--debug] [--version]
                 ...
                 [-r REFERENCE_SKETCH_PATH] [-c CLADE_CONFIG_PATH]
                 [-k KMER_SIZE] [-s SKETCH_SIZE] [-m MINIMAL_KMER_COVERAGE]
...
QC arguments:
  --expected_genome_size EXPECTED_GENOME_SIZE EXPECTED_GENOME_SIZE
                        Expected genome size range. Defaults 11.4-14.6 Mb are
                        based on 150 NCBI genomes and take mash genome size
                        overestimation into account. (default: [11400000,
                        14900000])
  --non_candida_threshold NON_CANDIDA_THRESHOLD
                        If the minimal distance from a reference sample is
                        above this threshold, the sample might not be a
                        Candida sp. (default: 0.01)
  --high_dist_threshold HIGH_DIST_THRESHOLD
                        If the minimal distance from a reference sample is
                        above this threshold, a warning is emitted. See the
                        docs for more info. (default: 0.003)
