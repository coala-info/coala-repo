...
If you're interested in building your own capability, read the [next chapter](./capability_apis.html).

---

The rest of this page is deprecated!

You can safely continue with the [next chapter](./capability_apis.html).

Capabilities required a lot more explanation, most of which has moved to
the [Managed Effects](./effects.html) chapter, which you should follow,
...
## [Orchestrating capability calls](#orchestrating-capability-calls)
