...
inputs:
  ...
  - id: def_site_selection
    type:
      - 'null'
      - string
    doc: "name,endpoints   create a selection of sites of given name and endpoints\n\
      \                  (site selection endpoints are expressed as in this example:
      10-200,305,310-342)"
    inputBinding:
      position: 102
  ...
  - id: def_species_group
    type:
      - 'null'
      - string
    doc: "group_name,group_member_ranks   create a species group of given name and
      members\n                  (species group members are expressed with their ranks
      as in this example: 3-8,12,19)"
    inputBinding:
      position: 102
