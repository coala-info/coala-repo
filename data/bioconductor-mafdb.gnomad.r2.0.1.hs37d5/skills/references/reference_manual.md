...
MafDb.gnomAD.r2.0.1.hs37d5-package
...
variant set release 2.0.1 of the Genome Aggregation Database (gnomAD). The data are exposed to
...
GScores object containing MAF values from gnomAD downloaded on March 2018 from http://gnomad.broadinstitute.org/downloads. See the inst/extdata/README ﬁle from the source code for more information on how these data have been stored into this annotation package.
...
MafDb.gnomAD.r2.0.1.hs37d5-package, 1
