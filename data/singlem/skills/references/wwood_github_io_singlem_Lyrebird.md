...
* [lyrebird pipe](/singlem/tools/lyrebird_pipe) - the main workflow which generates OTU tables and [vConTACT3-derived](https://bitbucket.org/MAVERICLab/vcontact3/src/master/) taxonomic profiles.
* [lyrebird renew](/singlem/advanced/lyrebird_renew) - Given previously generated results, re-run the pipeline with a new reference sequence/taxonomy database.
* [lyrebird condense](/singlem/advanced/lyrebird_condense) - Given an OTU table, summarise the results into a taxonomic profile.
...
* [Lyrebird (phage profiling)](#lyrebird-(phage-profiling))
* [Lyrebird database versions](#lyrebird-database-versions)
* [v0.3.1](#v0.3.1)
* [v0.3.0](#v0.3.0)
* [FAQ](#faq)
* [How does Lyrebird handle prophages?](#how-does-lyrebird-handle-prophages?)
