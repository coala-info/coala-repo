...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fhasindu2008%2Fslow5tools%2Fblob%2Fmaster%2F.travis.yml)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fblob%2Fshow&source=header-repo&source_repo=hasindu2008%2Fslow5tools)
...
[History](/hasindu2008/slow5tools/commits/master/.travis.yml)
...
[Raw](https://github.com/hasindu2008/slow5tools/raw/refs/heads/master/.travis.yml)
...
# - valgrind --leak-check=full --error-exitcode=1 ./slow5tools f2s test/data/raw/chr22\_meth\_example-subset-multi > /dev/null
...
# - mkdir -p slow5tools-${TRAVIS\_TAG}

# - make && mv slow5tools slow5tools-${TRAVIS\_TAG}/slow5tools\_x86\_64\_linux

# - cp -r README.md LICENSE docs slow5tools-${TRAVIS\_TAG}/

# - tar -zcf slow5tools-${TRAVIS\_TAG}-binaries.tar.gz slow5tools-${TRAVIS\_TAG}

# - rm -rf slow5tools-${TRAVIS\_TAG}
