...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2FHegemanLab%2Fvkmz)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E&source=header-repo&source_repo=HegemanLab%2Fvkmz)
...
[Branches](/HegemanLab/vkmz/branches)[Tags](/HegemanLab/vkmz/tags)
...
| --- | --- | --- | --- | --- |
| Latest commit   History[331 Commits](/HegemanLab/vkmz/commits/master/)   331 Commits | | |
| [test-data](/HegemanLab/vkmz/tree/master/test-data "test-data") | | [test-data](/HegemanLab/vkmz/tree/master/test-data "test-data") |  |  |
| [vkmz](/HegemanLab/vkmz/tree/master/vkmz "vkmz") | | [vkmz](/HegemanLab/vkmz/tree/master/vkmz "vkmz") |  |  |
| [LICENSE](/HegemanLab/vkmz/blob/master/LICENSE "LICENSE") | | [LICENSE](/HegemanLab/vkmz/blob/master/LICENSE "LICENSE") |  |  |
| [README.md](/HegemanLab/vkmz/blob/master/README.md "README.md") | | [README.md](/HegemanLab/vkmz/blob/master/README.md "README.md") |  |  |
| [setup.py](/HegemanLab/vkmz/blob/master/setup.py "setup.py") | | [setup.py](/HegemanLab/vkmz/blob/master/setup.py "setup.py") |  |  |
| View all files | | |
...
*Tabular* mode requires a single tabular file as input and must include the columns "sample\_name", "polarity", "mz", "rt", and "intensity". Each row represents a feature. Polarity refers to voltage polarity. Optionally a "charge" column can exist if software, such as CAMERA, has annotated the charge of features.

* See [test-data/tabular.tabular](/HegemanLab/vkmz/blob/master/test-data/tabular.tabular) for tabular input example
...
* See [test-data/datamatrix.tabular](/HegemanLab/vkmz/blob/master/test-data/datamatrix.tabular), [test-data/sampleMetadata.tabular](/HegemanLab/vkmz/blob/master/test-data/sampleMetadata.tabular), and [test-data/variableMetadata.tabular](/HegemanLab/vkmz/blob/master/test-data/variableMetadata.tabular) for W4M-XCMS data input example
...
* See [test-data/annotation.tabular](/HegemanLab/vkmz/blob/master/test-data/annotation.tabular) for annotated tabular input example
...
[hegemanlab.cfans.umn.edu/](http://hegemanlab.cfans.umn.edu/ "http://hegemanlab.cfans.umn.edu/")
...
[Activity](/HegemanLab/vkmz/activity)

[Custom properties](/HegemanLab/vkmz/custom-properties)

### Stars

[**3**
stars](/HegemanLab/vkmz/stargazers)

### Watchers

[**3**
watching](/HegemanLab/vkmz/watchers)

### Forks

[**1**
fork](/HegemanLab/vkmz/forks)

[Report repository](/contact/report-content?content_url=https%3A%2F%2Fgithub.com%2FHegemanLab%2Fvkmz&report=HegemanLab+%28user%29)

## [Releases 9](/HegemanLab/vkmz/releases)

[1.4.6

Latest

Feb 18, 2020](/HegemanLab/vkmz/releases/tag/1.4.6)

[+ 8 releases](/HegemanLab/vkmz/rele