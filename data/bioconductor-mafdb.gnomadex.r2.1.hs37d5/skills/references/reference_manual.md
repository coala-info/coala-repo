...
set release 2.1 of the Genome Aggregation Database (gnomAD). The data are exposed to the user
...
GScores object containing MAF values from gnomAD exomes downloaded on October 2018 from http://gnomad.broadinstitute.org/downloads. See the inst/extdata/README file from the source code for more information on how these data have been stored into this annotation package.
...
ls("package:MafDb.gnomADex.r2.1.hs37d5")
...
MafDb.gnomADex.r2.1.hs37d5-package, 1
