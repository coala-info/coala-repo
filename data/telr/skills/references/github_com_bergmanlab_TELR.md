...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fbergmanlab%2FTELR)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E&source=header-repo&source_repo=bergmanlab%2FTELR)
...
[Branches](/bergmanlab/TELR/branches)[Tags](/bergmanlab/TELR/tags)
...
| --- | --- | --- | --- | --- |
| Latest commit   History[225 Commits](/bergmanlab/TELR/commits/master/)   225 Commits | | |
| [docs](/bergmanlab/TELR/tree/master/docs "docs") | | [docs](/bergmanlab/TELR/tree/master/docs "docs") |  |  |
| [envs](/bergmanlab/TELR/tree/master/envs "envs") | | [envs](/bergmanlab/TELR/tree/master/envs "envs") |  |  |
| [img](/bergmanlab/TELR/tree/master/img "img") | | [img](/bergmanlab/TELR/tree/master/img "img") |  |  |
| [src/telr](/bergmanlab/TELR/tree/master/src/telr "This path skips through empty directories") | | [src/telr](/bergmanlab/TELR/tree/master/src/telr "This path skips through empty directories") |  |  |
| [test](/bergmanlab/TELR/tree/master/test "test") | | [test](/bergmanlab/TELR/tree/master/test "test") |  |  |
| [.gitignore](/bergmanlab/TELR/blob/master/.gitignore ".gitignore") | | [.gitignore](/bergmanlab/TELR/blob/master/.gitignore ".gitignore") |  |  |
| [LICENSE](/bergmanlab/TELR/blob/master/LICENSE "LICENSE") | | [LICENSE](/bergmanlab/TELR/blob/master/LICENSE "LICENSE") |  |  |
| [README.md](/bergmanlab/TELR/blob/master/README.md "README.md") | | [README.md](/bergmanlab/TELR/blob/master/README.md "README.md") |  |  |
| [citation.cff](/bergmanlab/TELR/blob/master/citation.cff "citation.cff") | | [citation.cff](/bergmanlab/TELR/blob/master/citation.cff "citation.cff") |  |  |
| [setup.py](/bergmanlab/TELR/blob/master/setup.py "setup.py") | | [setup.py](/bergmanlab/TELR/blob/master/setup.py "setup.py") |  |  |
| View all files | | |
...
[![TELR](https://github.com/bergmanlab/TELR/raw/master/img/TELR.png?raw=true)](https://github.com/bergmanlab/TELR/blob/master/img/TELR.png?raw=true)
...
* In stage 1, long reads are aligned to the reference genome using NGMLR (<https://github.com/philres/ngmlr>). The alignment output in BAM format is provided as input for Sniffles (<https://github.com/fritzsedlazeck/Sniffles>) to detect structural variations (SVs). TELR then filter for TE insertion candidates from SVs reported by Sniffles using following criteria: 1) The type of SV is insertion. 2) Insertion sequence is available. 3) The insertion sequences include hits from user provided TE consensus library using RepeatMasker ([http://www.repeatmasker.org}](http://www.repeatmasker.org%7D)).
...
[![](https://github.com/bergmanlab/TELR/raw/master/img/TELR_workflow.png?raw=true)](https://github.com/bergmanlab/TELR/blob/master/img/TELR_workflow.png?raw=true)
...
* [Installation](/bergmanlab/TELR/blob/master/docs/01_Installation.md)
* [Usage](/bergmanlab/TELR/blob/master/docs/02_Usage.md)
* [Output Files](/bergmanlab/TELR/blob/master/docs/03_Output_Files.md)
...
[github.com/bergmanlab/TELR](https://github.com/bergmanlab/TELR "https://github.com/bergmanlab/TELR")
...
[Activity](/bergmanlab/TELR/activity)

[Custom properties](/bergmanlab/TELR/custom-properties)

### Stars

[**35**
stars](/bergmanlab/TELR/stargazers)

### Watchers

[**4**
watching](/bergmanlab/TELR/watchers)

### Forks

[**10**
forks](/bergmanlab/TELR/forks)

[Report repository](/contact/report-content?content_url=https%3A%2F%2Fgithub.com%2Fbergmanlab%2FTELR&report=bergmanlab+%28user%29)

## [Releases 4](/bergmanlab/TELR/releases)

[TELR v1.1

Latest

Apr 26, 2023](/bergmanlab/TELR/releases/tag/v1.1)

[+ 3 releases](/bergmanlab/TELR/releases)

## [Packages 0](/orgs/bergmanlab/packages?repo_name=TELR)
...
## [Contributors](/bergmanlab/TELR/graphs/contributors)
...
* [Python
  100.0%](/bergmanlab/TELR/search?l=python)
