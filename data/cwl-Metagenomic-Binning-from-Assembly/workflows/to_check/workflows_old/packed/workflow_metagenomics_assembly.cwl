{
    "$graph": [
        ...
        {
            "class": "CommandLineTool",
            "label": "Prepare BBMap fasta DB",
            "doc": "Prepares fasta file for BBMap so it does not contain duplicate fasta headers. \nExpects gzipped fasta file(s) or plaintext fasta(s). Not mixed!\nOnly looks at the first part of the header before any whitespace.\n",
            "requirements": [
                {
                    "listing": [
                        {
            ...
            "inputs": [
                {
                    ...
                    "label": "gzip fasta files",
                    "doc": "Gzip Fasta file(s) to be the prepared",
                    "inputBinding": {
                        "position": 2
                    },
                ...
                },
                {
                    ...
                    "label": "gzip fasta files",
                    "doc": "Gzip Fasta file(s) location as string to be prepared",
                    "inputBinding": {
                        "position": 2
                    },
                    "id": "#prepare_fasta_db.cwl/fasta_location"
                },
                {
                    "type": "string",
        ...
        },
        {
            ...
            "hints": [
                {
                    "dockerPull": "docker-registry.wur.nl/m-unlock/docker/busco:5.4.3",
                    "class": "DockerRequirement"
                },
                {
                    "packages": [
        ...
        },
        {
            ...
            "inputs": [
                ...
                {
                    "label": "estimated genome size (for example, 5m or 2.6g)",
                    "type": [
                        "null",
                        "string"
                    ],
        ...
        },
        {
            ...
            "outputs": [
                ...
                },
                {
                    ...
                    "outputBinding": {
                        "glob": "MetaBAT2_bins/$(inputs.identifier)_bin.[0-9]*.fa"
                    },
                    "id": "#metabat2.cwl/bins"
                },
                {
                    "type": "File",
                    "outputBinding": {
                ...
                },
                {
                    ...
                    "outputBinding": {
                        "glob": "MetaBAT2_bins/$(inputs.identifier)_bin.unbinned.fa"
                    },
        ...
        },
        {
            ...
            "requirements": [
                ...
                },
                {
                    ...
                    "listing": [
                        ...
                        {
                            "entryname": "script.sh",
                            "entry": "#!/bin/bash\npython3 /scripts/metagenomics/assembly_bins_readstats.py $@"
                        }
                    ]
                }
            ],
            ...
            "inputs": [
                ...
                },
                {
                    ...
                    "id": "#assembly_bins_readstats.cwl/flagstat"
                },
                {
                    "type": "string",
                    "doc": "Identifier for this dataset used in this workflow",
                ...
                },
                {
                    ...
                    "id": "#assembly_bins_readstats.cwl/idxstats"
                }
            ],
        ...
        },
        {
            ...
            "doc": "Table of all bins and there assembly statistics like size, N50, etc..\n+ table of the bins and their respective assembly contigs names.\n",
            "requirements": [
                {
                    "class": "InlineJavascriptRequirement"
                },
                {
                    ...
                    "listing": [
                        ...
                        {
                            "entryname": "script.sh",
                            "entry": "#!/bin/bash\npython3 /scripts/metagenomics/bins_summary.py $@"
                        }
                    ]
                }
            ],
            ...
            "inputs": [
                {
                    ...
                    "id": "#samtools_flagstat.cwl/bam_file"
                },
                {
                    "type": "string",
                    "doc": "Identifier for this dataset used in this workflow",
                    "label": "identifier used",
                    "id": "#samtools_flagstat.cwl/identifier"
                },
                {
                    "type": [
                        "null",
            ...
            "outputs": [
                {
                    ...
                    "id": "#samtools_flagstat.cwl/flagstat"
                }
            ],
        ...
        },
        {
            ...
            "inputs": [
                ...
                },
                {
                    ...
                    "default": [],
                    "id": "#workflow_illumina_quality.cwl/kraken_database"
                },
                {
                    "type": [
                        "null",
            ...
            "steps": [
                {
                    ...
                    "in": [
                        ...
                        {
                            "source": "#workflow_illumina_quality.cwl/fastq_merge_fwd/output",
                        ...
                        {
                            "source": "#workflow_illumina_quality.cwl/fastq_merge_rev/output",
                ...
                },
                {
                    ...
                    "in": [
                        ...
                        {
                            "source": "#workflow_illumina_quality.cwl/identifier",
                            "id": "#workflow_illumina_quality.cwl/fastq_merge_fwd/identifier"
                        },
                        {
                            "source": "#workflow_illumina_quality.cwl/forward_reads",
                ...
                },
                {
                    ...
                    "in": [
                        {
                            "source": "#workflow_illumina_quality.cwl/identifier",
                            "id": "#workflow_illumina_quality.cwl/fastq_merge_rev/identifier"
                        },
                        {
                ...
                },
                {
                    ...
                    "in": [
                        {
                            "source": "#workflow_illumina_quality.cwl/kraken_database",
                        ...
                        {
                            "source": "#workflow_illumina_quality.cwl/kraken_database",
                            "id": "#workflow_illumina_quality.cwl/illumina_quality_kraken2/kraken_database"
                        },
                        {
                            "default": true,
                        ...
                        {
                            "source": "#workflow_illumina_quality.cwl/identifier",
                            "id": "#workflow_illumina_quality.cwl/illumina_quality_kraken2/tmp_id"
                        }
                    ],
                    "out": [
                ...
                },
                {
                    ...
                    "in": [
                        ...
                        {
                            "source": "#workflow_illumina_quality.cwl/kraken_database",
                            "id": "#workflow_illumina_quality.cwl/illumina_quality_kraken2_krona/kraken_database"
                        }
                    ],
                    "out": [
                ...
                },
                {
                    ...
                    "in": [
                        ...
                        {
                            "valueFrom": "/venv/opt/bbmap-38.98-1/resources/phix174_ill.ref.fa.gz",
                    ...
                    "in": [
                        {
                            ...
                            "linkMerge": "merge_flattened",
                            "pickValue": "all_non_null",
                            "id": "#workflow_illumina_quality.cwl/prepare_bbmap_db/fasta_files"
                        },
                        {
                            "source": "#workflow_illumina_quality.cwl/filter_references",
                            "id": "#workflow_illumina_quality.cwl/prepare_bbmap_db/filter_references"
                        },
                        {
                            "valueFrom": "BBMap_filter-reference_prepared.fa.gz",
                            "id": "#workflow_illumina_quality.cwl/prepare_bbmap_db/output_file_name"
                        }
                    ],
                    "out": [
                        "#workflow_illumina_quality.cwl/prepare_bbmap_db/fasta_db"
                    ],
                    "id": "#workflow_illumina_quality.cwl/prepare_bbmap_db"
                },
                {
                    ...
                    "in": [
                        ...
                        {
                            "source": "#workflow_illumina_quality.cwl/prepare_bbmap_db/fasta_db",
                ...
                },
                {
                    ...
                    "in": [
                        ...
                        },
                        {
                            ...
                            "id": "#workflow_illumina_quality.cwl/reports_files_to_folder/step"
                        }
                    ],
                    "out": [
            ...
            "https://schema.org/codeRepository": "https://gitlab.com/m-unlock/cwl",
            "https://schema.org/dateCreated": "2020-00-00",
            "https://schema.org/dateModified": "2022-07-00",
            "https://schema.org/license": "https://spdx.org/licenses/Apache-2.0",
            "https://schema.org/copyrightHolder": "UNLOCK - Unlocking Microbial Potential"
        },
        {
            ...
            "steps": [
                ...
                },
                {
                    ...
                    "in": [
                        ...
                        {
                            "source": "#main/identifier",
                            "id": "#main/illumina_kraken2/tmp_id"
                        }
                    ],
                    "out": [
                ...
                },
                {
                    ...
                    "in": [
                        ...
                        {
                            "source": "#main/kraken_database",
                            "id": "#main/kraken2_compress/kraken_database"
                        },
                        {
                            "source": "#main/threads",
                ...
                },
                {
                    ...
                    "in": [
                        ...
                        {
                            "source": "#main/kraken_database",
                            "id": "#main/kraken2_krona/kraken_database"
                        }
                    ],
                    "out": [
                        "#main/kraken2_krona/krona_html"
                ...
                },
                {
                    ...
                    "in": [
                        ...
                        {
                            "source": "#main/identifier",
                            "id": "#main/nanopore_kraken2/tmp_id"
                        }
                    ],
                    "out": [
                        "#main/nanopore_kraken2/standard_report",
                ...
                },
                {
                    ...
                    "in": [
                        ...
                        {
                            "source": "#main/kraken_database",
                            "id": "#main/workflow_quality_illumina/kraken_database"
                        },
                        {
                            "source": "#main/memory",
                ...
                },
                {
                    ...
                    "in": [
                        ...
                        {
                            "source": "#main/kraken_database",
                            "id": "#main/workflow_quality_nanopore/kraken_database"
                        },
                        {
                            "source": "#main/nanopore_reads",
                            "id": "#main/workflow_quality_nanopore/nanopore_reads"
                        },
                        {
                            "default": 1,
            ...
            "outputs": [
                {
                    ...
                    "outputSource": "#workflow_metagenomics_binning.cwl/metabat2/bins",
                ...
                },
                {
                    ...
                    "type": "Directory",
                    "outputSource": "#workflow_metagenomics_binning.cwl/metabat_files_to_folder/results",
            ...
            "steps": [
                {
                    ...
                    "in": [
                        {
                            "source": "#workflow_metagenomics_binning.cwl/metabat2/bins",
                    ...
                    "in": [
                        {
                            ...
                            "id": "#workflow_metagenomics_binning.cwl/assembly_read_counts/bam_file"
                        },
                        {
                            "source": "#workflow_metagenomics_binning.cwl/identifier",
                            "id": "#workflow_metagenomics_binning.cwl/assembly_read_counts/identifier"
                        },
                        {
                            "source": "#workflow_metagenomics_binning.cwl/threads",
                            "id": "#workflow_metagenomics_binning.cwl/assembly_read_counts/threads"
                        }
                    ],
                    "out": [
                        "#workflow_metagenomics_binning.cwl/assembly_read_counts/flagstat"
                    ],
                    "id": "#workflow_metagenomics_binning.cwl/assembly_read_counts"
                },
                {
                    ...
                    "in": [
                        {
                            "source": "#workflow_metagenomics_binning.cwl/bins_summary/bin_contigs",
                            "id": "#workflow_metagenomics_binning.cwl/bin_readstats/binContigs"
                        },
                        {
                            "source": "#workflow_metagenomics_binning.cwl/assembly_read_counts/flagstat",
                            "id": "#workflow_metagenomics_binning.cwl/bin_readstats/flagstat"
                        },
                        {
                            "source": "#workflow_metagenomics_binning.cwl/identifier",
                        ...
                        {
                            "source": "#workflow_metagenomics_binning.cwl/contig_read_counts/contigReadCounts",
                            "id": "#workflow_metagenomics_binning.cwl/bin_readstats/idxstats"
                        }
                    ],
                    "out": [
                ...
                },
                {
                    ...
                    "in": [
                        ...
                        {
                            "source": "#workflow_metagenomics_binning.cwl/busco_files_to_folder/results",
                            "id": "#workflow_metagenomics_binning.cwl/bins_summary/busco_dir"
                        },
                        {
                ...
                },
                {
                    ...
                    "run": "#busco.cwl",
                    "scatter": [
                        "#workflow_metagenomics_binning.cwl/busco/sequence_file"
                    ],
                    ...
                    "in": [
                        ...
                        },
                        {
                            ...
                            "linkMerge": "merge_flattened",
                            "pickValue": "all_non_null",
                            "id": "#workflow_metagenomics_binning.cwl/busco/sequence_file"
                        },
                        {
                            "source": "#workflow_metagenomics_binning.cwl/threads",
                    ...
                    "out": [
                        "#workflow_metagenomics_binning.cwl/busco/short_summaries"
                    ],
                ...
                },
                {
                    ...
                    "in": [
                        ...
                        {
                            "source": "#workflow_metagenomics_binning.cwl/merge_busco_summaries/output",
                            "linkMerge": "merge_flattened",
                            "pickValue": "all_non_null",
                            "id": "#workflow_metagenomics_binning.cwl/busco_files_to_folder/files"
                        },
                        {
                            "source": "#workflow_metagenomics_binning.cwl/step",
                            "id": "#workflow_metagenomics_binning.cwl/busco_files_to_folder/step"
                        }
                    ],
                    "out": [
                ...
                },
                {
                    ...
                    "in": [
                        ...
                        {
                            "source": "#workflow_metagenomics_binning.cwl/step",
                            "id": "#workflow_metagenomics_binning.cwl/checkm_files_to_folder/step"
                        }
                    ],
                    "out": [
                ...
                },
                {
                    ...
                    "in": [
                        {
                            "source": "#workflow_metagenomics_binning.cwl/bam_file",
                            "id": "#workflow_metagenomics_binning.cwl/contig_read_counts/bam_file"
                        },
                        {
                            "source": "#workflow_metagenomics_binning.cwl/identifier",
                            "id": "#workflow_metagenomics_binning.cwl/contig_read_counts/identifier"
                        },
                        {
                            "source": "#workflow_metagenomics_binning.cwl/threads",
                            "id": "#workflow_metagenomics_binning.cwl/contig_read_counts/threads"
                        }
                    ],
                    "out": [
                        "#workflow_metagenomics_binning.cwl/contig_read_counts/contigReadCounts"
                    ],
                    "id": "#workflow_metagenomics_binning.cwl/contig_read_counts"
                },
                {
                ...
                },
                {
                    ...
                    "in": [
                        ...
                        {
                            "source": "#workflow_metagenomics_binning.cwl/step",
                            "id": "#workflow_metagenomics_binning.cwl/gtdbtk_files_to_folder/step"
                        }
                    ],
                    "out": [
                ...
                },
                {
                    ...
                    "in": [
                        {
                            "source": "#workflow_metagenomics_binning.cwl/metabat2/bins",
                            "id": "#workflow_metagenomics_binning.cwl/merge_busco_summaries/bins"
                        },
                        {
                            "source": "#workflow_metagenomics_binning.cwl/busco/short_summaries",
                            "linkMerge": "merge_flattened",
                            "pickValue": "all_non_null",
                            "id": "#workflow_metagenomics_binning.cwl/merge_busco_summaries/input"
                        }
                    ],
                    "out": [
                        "#workflow_metagenomics_binning.cwl/merge_busco_summaries/output"
                    ],
                    "id": "#workflow_metagenomics_binning.cwl/merge_busco_summaries"
                },
                {
                    ...
                    "out": [
                        ...
                        "#workflow_metagenomics_binning.cwl/metabat2/bins",
                ...
                },
                {
                    ...
                    "in": [
                        {
                            "valueFrom": "${\n  var step = inputs.step;\n  return step+\"_MetaBAT2_Binning\";\n}\n",
                            "id": "#workflow_metagenomics_binning.cwl/metabat_files_to_folder/destination"
                        },
                        {
                            "source": [
                                "#workflow_metagenomics_binning.cwl/metabat2/log",
                            ...
                            "linkMerge": "merge_flattened",
                            "id": "#workflow_metagenomics_binning.cwl/metabat_files_to_folder/files"
                        },
                        {
                            "source": [
                                "#workflow_metagenomics_binning.cwl/metabat2/bin_dir"
                            ...
                            "linkMerge": "merge_flattened",
                            "id": "#workflow_metagenomics_binning.cwl/metabat_files_to_folder/folders"
                        },
                        {
                            "source": "#workflow_metagenomics_binning.cwl/step",
                            "id": "#workflow_metagenomics_binning.cwl/metabat_files_to_folder/step"
                        }
                    ],
                    "out": [
                        "#workflow_metagenomics_binning.cwl/metabat_files_to_folder/results"
                    ],
                    "id": "#workflow_metagenomics_binning.cwl/metabat_files_to_folder"
                }
            ],
            ...
            "outputs": [
                {
                    ...
                    "outputSource": [
                        "#workflow_nanopore_quality.cwl/reference_filter_nanopore/fastq",
                        "#workflow_nanopore_quality.cwl/merge_nanopore_fastq/output",
                        "#workflow_nanopore_quality.cwl/nanopore_array_to_file/file"
                    ],
                    "pickValue": "first_non_null",
                    "id": "#workflow_nanopore_quality.cwl/filtered_reads"
                },
                {
                    "type": "Directory",
                    "label": "Filtering reports folder",
                    "doc": "Folder containing all reports of filtering and quality control",
                    "outputSource": "#workflow_nanopore_quality.cwl/reports_files_to_folder/results",
                    "id": "#workflow_nanopore_quality.cwl/reports_folder"
                }
            ],
            "inputs": [
                {
                    ...
                    "label": "Output Destination",
                    "doc": "Optional Output destination used for cwl-prov reporting.",
                    "id": "#workflow_nanopore_quality.cwl/destination"
                },
                {
                    "type": [
                        "null",
                    ...
                    "label": "Contamination reference file",
                    "id": "#workflow_nanopore_quality.cwl/filter_references"
                },
                {
                    "type": "string",
                    "doc": "Identifier for this dataset used in this workflow",
                    "label": "identifier used",
                    "id": "#workflow_nanopore_quality.cwl/identifier"
                },
                {
                    "type": "boolean",
                    "doc": "Keep with reads mapped to the given reference",
                    "label": "Keep mapped reads",
                    "default": false,
                    "id": "#workflow_nanopore_quality.cwl/keep_reference_mapped_reads"
                },
                {
                    "type": [
                        "null",
                    ...
                    "doc": "Kraken2 database location, multiple databases is possible",
                    "default": [],
                    "id": "#workflow_nanopore_quality.cwl/kraken_database"
                },
                {
                    "type": [
                        "null",
                    ...
                    "label": "Maximum memory in MB",
                    "default": 4000,
                    "id": "#workflow_nanopore_quality.cwl/memory"
                },
                {
                    "type": {
                        "type": "array",
                    ...
                    "label": "Nanopore reads",
                    "id": "#workflow_nanopore_quality.cwl/nanopore_reads"
                },
                {
                    "type": [
                        "null",
                    ...
                    "doc": "Step number for order of steps",
                    "default": 1,
                    "id": "#workflow_nanopore_quality.cwl/step"
                },
                {
                    "type": [
                        "null",
                    ...
                    "label": "Number of threads",
                    "default": 2,
                    "id": "#workflow_nanopore_quality.cwl/threads"
                }
            ],
            "steps": [
                {
                    ...
                    "in": [
                        {
                            "source": "#workflow_nanopore_quality.cwl/filter_references",
                            "id": "#workflow_nanopore_quality.cwl/fastqc_nanopore_after/filter_references"
                        },
                        {
                            "source": "#workflow_nanopore_quality.cwl/reference_filter_nanopore/fastq",
                            "id": "#workflow_nanopore_quality.cwl/fastqc_nanopore_after/nanopore_reads"
                        },
                        {
                            "source": "#workflow_nanopore_quality.cwl/threads",
                            "id": "#workflow_nanopore_quality.cwl/fastqc_nanopore_after/threads"
                        }
                    ],
                    "out": [
                        "#workflow_nanopore_quality.cwl/fastqc_nanopore_after/html_files",
                        "#workflow_nanopore_quality.cwl/fastqc_nanopore_after/zip_files"
                    ],
                    "id": "#workflow_nanopore_quality.cwl/fastqc_nanopore_after"
                },
                {
                    "label": "FastQC before",
                    "doc": "Quality assessment and report of reads before filter",
                    "in": [
                        {
                            ...
                            "pickValue": "first_non_null",
                            "id": "#workflow_nanopore_quality.cwl/fastqc_nanopore_before/nanopore_reads"
                        },
                        {
                            "source": "#workflow_nanopore_quality.cwl/threads",
                            "id": "#workflow_nanopore_quality.cwl/fastqc_nanopore_before/threads"
                        }
                    ],
                    "run": "#fastqc.cwl",
                    "out": [
                        "#workflow_nanopore_quality.cwl/fastqc_nanopore_before/html_files",
                        "#workflow_nanopore_quality.cwl/fastqc_nanopore_before/zip_files"
                    ],
                    "id": "#workflow_nanopore_quality.cwl/fastqc_nanopore_before"
                },
                {
                    ...
                    "in": [
                        {
                            "source": "#workflow_nanopore_quality.cwl/identifier",
                            "id": "#workflow_nanopore_quality.cwl/merge_nanopore_fastq/identifier"
                        },
                        {
                            "source": [
                                "#workflow_nanopore_quality.cwl/nanopore_reads"
                            ],
                            "linkMerge": "merge_flattened",
                            "pickValue": "all_non_null",
                            "id": "#workflow_nanopore_quality.cwl/merge_nanopore_fastq/infiles"
                        },
                        {
                            "source": "#workflow_nanopore_quality.cwl/nanopore_reads",
                            "id": "#workflow_nanopore_quality.cwl/merge_nanopore_fastq/nanopore_reads"
                        },
                        {
                            "valueFrom": "$(inputs.identifier)_nanopore_raw.fastq.gz",
                            "id": "#workflow_nanopore_quality.cwl/merge_nanopore_fastq/outname"
                        }
                    ],
                    "out": [
                        "#workflow_nanopore_quality.cwl/merge_nanopore_fastq/output"
                    ],
                    "id": "#workflow_nanopore_quality.cwl/merge_nanopore_fastq"
                },
                {
                    "label": "array to file",
                    "doc": "Converts the file array to a single file object",
                    "when": "$(inputs.nanopore_reads.length === 1)",
                    "run": "#array_to_file.cwl",
                    "in": [
                        {
                            "source": "#workflow_nanopore_quality.cwl/nanopore_reads",
                            "id": "#workflow_nanopore_quality.cwl/nanopore_array_to_file/files"
                        },
                        {
                            "source": "#workflow_nanopore_quality.cwl/nanopore_reads",
                            "id": "#workflow_nanopore_quality.cwl/nanopore_array_to_file/nanopore_reads"
                        }
                    ],
                    "out": [
                        "#workflow_nanopore_quality.cwl/nanopore_array_to_file/file"
                    ],
                    "id": "#workflow_nanopore_quality.cwl/nanopore_array_to_file"
                },
                {
                    "label": "Kraken2",
                    "doc": "Taxonomic classification of FASTQ reads",
                    "when": "$(inputs.kraken_database !== null && inputs.kraken_database.length !== 0)",
                    "run": "#kraken2.cwl",
                    "scatter": "#workflow_nanopore_quality.cwl/nanopore_quality_kraken2/database",
                    "in": [
                        {
                            "source": "#workflow_nanopore_quality.cwl/kraken_database",
                            "id": "#workflow_nanopore_quality.cwl/nanopore_quality_kraken2/database"
                        },
                        {
                            "valueFrom": "$(inputs.tmp_id)_nanopore_unfiltered",
                            "id": "#workflow_nanopore_quality.cwl/nanopore_quality_kraken2/identifier"
                        },
                        {
                            "source": "#workflow_nanopore_quality.cwl/kraken_database",
                            "id": "#workflow_nanopore_quality.cwl/nanopore_quality_kraken2/kraken_database"
                        },
                        {
                            "source": [
                                "#workflow_nanopore_quality.cwl/merge_nanopore_fastq/output",
                            ...
                            "pickValue": "first_non_null",
                            "id": "#workflow_nanopore_quality.cwl/nanopore_quality_kraken2/nanopore_reads"
                        },
                        {
                            "source": "#workflow_nanopore_quality.cwl/threads",
                            "id": "#workflow_nanopore_quality.cwl/nanopore_quality_kraken2/threads"
                        },
                        {
                            "source": "#workflow_nanopore_quality.cwl/identifier",
                            "id": "#workflow_nanopore_quality.cwl/nanopore_quality_kraken2/tmp_id"
                        }
                    ],
                    "out": [
                        "#workflow_nanopore_quality.cwl/nanopore_quality_kraken2/sample_report"
                    ],
                    "id": "#workflow_nanopore_quality.cwl/nanopore_quality_kraken2"
                },
                {
                    "label": "Krona",
                    "doc": "Visualization of Kraken2 classification with Krona",
                    "when": "$(inputs.kraken_database !== null && inputs.kraken_database.length !== 0)",
                    "run": "#krona.cwl",
                    "scatter": "#workflow_nanopore_quality.cwl/nanopore_quality_kraken2_krona/kraken",
                    "in": [
                        {
                            "source": "#workflow_nanopore_quality.cwl/nanopore_quality_kraken2/sample_report",
                            "id": "#workflow_nanopore_quality.cwl/nanopore_quality_kraken2_krona/kraken"
                        },
                        {
                            "source": "#workflow_nanopore_quality.cwl/kraken_database",
                            "id": "#workflow_nanopore_quality.cwl/nanopore_quality_kraken2_krona/kraken_database"
                        }
                    ],
                    "out": [
                        "#workflow_nanopore_quality.cwl/nanopore_quality_kraken2_krona/krona_html"
                    ],
                    "id": "#workflow_nanopore_quality.cwl/nanopore_quality_kraken2_krona"
                },
                {
                    "label": "Prepare references",
                    ...
                    "in": [
                        {
                            ...
                            "linkMerge": "merge_flattened",
                            "pickValue": "all_non_null",
                            "id": "#workflow_nanopore_quality.cwl/prepare_bbmap_db/fasta_files"
                        },
                        {
                            "source": "#workflow_nanopore_quality.cwl/filter_references",
                            "id": "#workflow_nanopore_quality.cwl/prepare_bbmap_db/filter_references"
                        },
                        {
                            "valueFrom": "filter-reference_prepared.fa.gz",
                            "id": "#workflow_nanopore_quality.cwl/prepare_bbmap_db/output_file_name"
                        }
                    ],
                    "out": [
                        "#workflow_nanopore_quality.cwl/prepare_bbmap_db/fasta_db"
                    ],
                    "id": "#workflow_nanopore_quality.cwl/prepare_bbmap_db"
                },
                {
                    ...
                    "in": [
                        {
                            "source": "#workflow_nanopore_quality.cwl/filter_references",
                            "id": "#workflow_nanopore_quality.cwl/reference_filter_nanopore/filter_references"
                        },
                        {
                            "valueFrom": "$(inputs.tmp_id)_nanopore",
                            "id": "#workflow_nanopore_quality.cwl/reference_filter_nanopore/identifier"
                        },
                        {
                            "source": "#workflow_nanopore_quality.cwl/keep_reference_mapped_reads",
                            "id": "#workflow_nanopore_quality.cwl/reference_filter_nanopore/output_mapped"
                        },
                        {
                            "default": "map-ont",
                            "id": "#workflow_nanopore_quality.cwl/reference_filter_nanopore/preset"
                        },
                        {
                            "source": [
                                "#workflow_nanopore_quality.cwl/merge_nanopore_fastq/output",
                            ...
                            "pickValue": "first_non_null",
                            "id": "#workflow_nanopore_quality.cwl/reference_filter_nanopore/reads"
                        },
                        {
                            "source": "#workflow_nanopore_quality.cwl/prepare_bbmap_db/fasta_db",
                            "id": "#workflow_nanopore_quality.cwl/reference_filter_nanopore/reference"
                        },
                        {
                            "source": "#workflow_nanopore_quality.cwl/threads",
                            "id": "#workflow_nanopore_quality.cwl/reference_filter_nanopore/threads"
                        },
                        {
                            "source": "#workflow_nanopore_quality.cwl/identifier",
                            "id": "#workflow_nanopore_quality.cwl/reference_filter_nanopore/tmp_id"
                        }
                    ],
                    "out": [
                        "#workflow_nanopore_quality.cwl/reference_filter_nanopore/fastq",
                        "#workflow_nanopore_quality.cwl/reference_filter_nanopore/log"
                    ],
                    "id": "#workflow_nanopore_quality.cwl/reference_filter_nanopore"
                },
                {
                    "label": "Reports to folder",
                    "doc": "Preparation of fastp output files to a specific output folder",
                    "in": [
                        {
                            ...
                            "id": "#workflow_nanopore_quality.cwl/reports_files_to_folder/destination"
                        },
                        {
                            "source": [
                                "#workflow_nanopore_quality.cwl/fastqc_nanopore_before/html_files",
                            ...
                            "linkMerge": "merge_flattened",
                            "pickValue": "all_non_null",
                            "id": "#workflow_nanopore_quality.cwl/reports_files_to_folder/files"
                        },
                        {
                            "source": "#workflow_nanopore_quality.cwl/step",
                            "id": "#workflow_nanopore_quality.cwl/reports_files_to_folder/step"
                        }
                    ],
                    "run": "#files_to_folder.cwl",
                    "out": [
                        "#workflow_nanopore_quality.cwl/reports_files_to_folder/results"
                    ],
                    "id": "#workflow_nanopore_quality.cwl/reports_files_to_folder"
                }
            ],
            "id": "#workflow_nanopore_quality.cwl",
            "https://schema.org/author": [
                {
                    "class": "https://schema.org/Person",
                    "https://schema.org/identifier": "https://orcid.org/0000-0001-8172-8981",
