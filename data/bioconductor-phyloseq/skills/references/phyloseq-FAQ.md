...
#### Thu Oct 30 01:42:38 2025

# Contents

* [1 - I tried reading my biom file using phyloseq, but it didn’t work. What’s wrong?](#i-tried-reading-my-biom-file-using-phyloseq-but-it-didnt-work.-whats-wrong)
  + [1.1 Good News: HDF5-biom should be supported in next release](#good-news-hdf5-biom-should-be-supported-in-next-release)
  + [1.2 HDF5 (Version 2.0) biom-format: *biomformat*](#hdf5-version-2.0-biom-format-biomformat)
  + [1.3 Not every data component is included in .biom files](#not-every-data-component-is-included-in-.biom-files)
  + [1.4 Other issues related the biom-format](#other-issues-related-the-biom-format)
* [2 - `microbio_me_qiime()` returned an error. What’s wrong?](#microbio_me_qiime-returned-an-error.-whats-wrong)
  + [2.1 The QIIME-DB Server is Permanently Down.](#the-qiime-db-server-is-permanently-down.)
  + [2.2 An interface to Qiita is Planned.](#an-interface-to-qiita-is-planned.)
* [3 - I want a phyloseq graphic that looks like…](#i-want-a-phyloseq-graphic-that-looks-like)
  + [3.1 Modify the ggplot object yourself.](#modify-the-ggplot-object-yourself.)
  + [3.2 psmelt and ggplot2](#psmelt-and-ggplot2)
  + [3.3 Submit a Pull Request (Advanced)](#submit-a-pull-request-advanced)
  + [3.4 Define a ggplot2 extension (Advanced)](#define-a-ggplot2-extension-advanced)
* [4 - There’s a typo in phyloseq documentation, tutorials, or vignettes](#theres-a-typo-in-phyloseq-documentation-tutorials-or-vignettes)
  + [4.1 Fix the typo directly on GitHub](#fix-the-typo-directly-on-github)
  + [4.2 Minimal GIT and GitHub Exercise](#minimal-git-and-github-exercise)
* [5 - I read “Waste Not, Want Not…” but…](#i-read-waste-not-want-not-but)
  + [5.1 I tried to use DESeq2 to normalize my data, but now I don’t know what to do…](#i-tried-to-use-deseq2-to-normalize-my-data-but-now-i-dont-know-what-to-do)
  + [5.2 My libraries/samples had different total number of reads, what do I do?](#my-librariessamples-had-different-total-number-of-reads-what-do-i-do)
  + [5.3 Should I normalize my data before alpha-diversity analysis](#should-i-normalize-my-data-before-alpha-diversity-analysis)
  + [5.4 Negative numbers in my transformed data table?](#negative-numbers-in-my-transformed-data-table)
  + [5.5 I get an error regarding geometric mean](#i-get-an-error-regarding-geometric-mean)
  + [5.6 Pseudocounts are not appropriate for my data, because…](#pseudocounts-are-not-appropriate-for-my-data-because)
  + [5.7 I’m scared that the Negative Binomial doesn’t fit my data well](#im-scared-that-the-negative-binomial-doesnt-fit-my-data-well)
  + [5.8 I don’t know how to test for differential abundance now. How do I do that?](#i-dont-know-how-to-test-for-differential-abundance-now.-how-do-i-do-that)
* [6 - I need help analyzing my data. It has the following study design…](#i-need-help-analyzing-my-data.-it-has-the-following-study-design)
  + [6.1 Please be more specific](#please-be-more-specific)
  + [6.2 Please respect my time (and other package authors)](#please-respect-my-time-and-other-package-authors)
  + [6.3 Pay for Help (not me)](#pay-for-help-not-me)
...
## 1.4 Other issues related the biom-format
...
For example,
[the plot\_ordination() examples tutorial](http://joey711.github.io/phyloseq/plot_ordination-examples.html)
...
# 5 - I read [“Waste Not, Want Not…”](http://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1003531) but…
...
## 5.1 I tried to [use DESeq2](http://joey711.github.io/phyloseq-extensions/DESeq2.html) to normalize my data, but now I don’t know what to do…
...
## 6.2 Please respect my time (and other package authors)
