...
baseCommand: perl
label: perl-threaded_perl
doc: "The Perl 5 language interpreter\n\nTool homepage: http://www.perl.org/"
inputs:
  - id: program_file
    type:
      - 'null'
  ...
  - id: use_module
    ...
    inputBinding:
      position: 103
      prefix: -m
  - id: use_module_import
    type:
      - 'null'
      - type: array
        items: string
    doc: execute 'use module...' with imports before executing program
    inputBinding:
      position: 103
      prefix: -M
outputs:
...
hints:
  - class: DockerRequirement
    dockerPull: quay.io/biocontainers/perl-threaded:5.32.1--hdfd78af_1
stdout: perl-threaded_perl.out
