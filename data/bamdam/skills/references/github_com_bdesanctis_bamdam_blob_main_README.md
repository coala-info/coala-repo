...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fbdesanctis%2Fbamdam%2Fblob%2Fmain%2FREADME.md)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fblob%2Fshow&source=header-repo&source_repo=bdesanctis%2Fbamdam)
...
[History](/bdesanctis/bamdam/commits/main/README.md)

History

390 lines (303 loc) · 28.3 KB
...
[Raw](https://github.com/bdesanctis/bamdam/raw/refs/heads/main/README.md)
...
[![bamdam workflow figure](/bdesanctis/bamdam/raw/main/docs/assets/workflowfigure.jpg "bamdam workflow")](/bdesanctis/bamdam/blob/main/docs/assets/workflowfigure.jpg)
...
Bamdam shrink will also optionally annotate the new bam file with PMD scores as in PMDTools (in the DS:Z field) (--annotate\_pmd), but PMD score annotation will roughly double the amount of time this command takes. PMD scores are from [Skoglund et al. 2014](https://doi.org/10.1073/pnas.131893411).

As with ngsLCA, input bam files must be sorted by read order (samtools sort -n), and read-sorting must be performed after any bam file merging. Merging read-sorted bam files will lose the sort order, even though the resulting bam file will still claim to be read-sorted in its header, leading to a silent ngsLCA error and incorrect bamdam results. To avoid this, please read-sort bam files immedi