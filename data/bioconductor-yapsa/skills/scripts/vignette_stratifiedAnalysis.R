# Code example from 'vignette_stratifiedAnalysis' vignette. See references/ for full tutorial.
...
## ----formatRaw, warning=FALSE, fig.width=8, fig.height=6, fig.cap= cap--------
...
## ----captionSMCdodged, echo=FALSE---------------------------------------------
cap = "SMC results displayed as dodged plot."

## ----SMCdodged, results="hide",warning=FALSE,fig.width=8,fig.height=7,fig.cap=cap----
...
## ----statSMCmutDensity, warning=FALSE, message=FALSE--------------------------
