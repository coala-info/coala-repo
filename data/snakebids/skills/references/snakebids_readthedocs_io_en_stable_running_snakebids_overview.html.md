...
[View this page](https://github.com/khanlab/snakebids/blob/main/docs/running_snakebids/overview.md?plain=true "View this page")

[Edit this page](https://github.com/khanlab/snakebids/edit/main/docs/running_snakebids/overview.md "Edit this page")

Toggle Light / Dark / Auto color theme

Toggle table of contents sidebar

# Running Snakebids[¶](#running-snakebids "Link to this heading")
...
The boilerplate app starts with the validator plugin enabled - without it, validation is not performed. By default, this feature uses the command-line (node.js) version of the [validator](https://www.npmjs.com/package/bids-validator). If this is not found to be installed on the system, the `pybids` version of validation will be performed instead. To opt-out of validation, invoke the `--skip-bids-validation` flag. Details related to using and creating plugins can be found on the [plugins](../bids_app/plugins.html) page.

## Workflow mode[¶](#workflow-mode "Link to this heading")
