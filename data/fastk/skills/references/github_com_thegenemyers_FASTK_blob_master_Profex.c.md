...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fthegenemyers%2FFASTK%2Fblob%2Fmaster%2FProfex.c)
...
[History](/thegenemyers/FASTK/commits/master/Profex.c)

History

240 lines (209 loc) · 6.75 KB
...
[Raw](https://github.com/thegenemyers/FASTK/raw/refs/heads/master/Profex.c)
...
static char \*Usage = "[-1Az] <source\_root>[.prof] [ <read:int>[-(<read:int>|#)] ... ]";

static char \*One\_Schema =

"P 3 prf This is a 1-code fiel for profiles\n"

"O P 1 8 INT\_LIST The profile count vector for the next read\n";
...
{ schema = oneSchemaCreateFromText(One\_Schema);
...
fprintf(stderr,"%s: Id %d is out of range",Prog\_Name,id1);

else

fprintf(stderr,"%s: Range %d-%d is out of range",Prog\_Name,id1,id2);
...
{ plen = Fetch\_Profile(P,(int64) p-1,pmax,profile);
...
Fetch\_Profile(P,(int64) p-1,pmax,profile);
