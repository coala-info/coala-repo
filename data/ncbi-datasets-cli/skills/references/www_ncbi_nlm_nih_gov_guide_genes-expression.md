...
[BioProject (formerly Genome Project)](/bioproject)
...
[ClinVar](/clinvar)
:   A resource to provide a public, tracked record of reported relationships between human variation and observed health status with supporting evidence. Related information in the [NIH Genetic Testing Registry (GTR)](/gtr/), [MedGen](/medgen/), [Gene](/gene), [OMIM](http://www.omim.org), [PubMed](/pubmed/) and other sources is accessible through hyperlinks on the records.

[Consensus CDS (CCDS)](/projects/CCDS/CcdsBrowse.cgi)
...
[Database of Genotypes and Phenotypes (dbGaP)](/gap)
...
[Gene Expression Omnibus (GEO) Database](/geo/)
...
[Gene Expression Omnibus (GEO) Datasets](/gds)
...
[Gene Expression Omnibus (GEO) Profiles](/geoprofiles/)
...
[Genes and Disease](/books/NBK22183/)
...
[Genetic Testing Registry (GTR)](/gtr/)
...
[FTP: Gene](https://ftp.ncbi.nlm.nih.gov/gene/)
...
[FTP: Gene Expression Omnibus (GEO) Profiles and Datasets](https://ftp.ncbi.nlm.nih.gov/pub/geo/)
...
[Database of Genotype and Phenotype (dbGaP) Data Submission Policies](/projects/gap/cgi-bin/about.cgi)
:   Guidelines and requirements for submitting genotype and phenotype association data to dbGaP.

[Gene Expression Omnibus (GEO) Web Deposit](/projects/geo/info/submission.html)
...
[Gene Expression Omnibus (GEO) BLAST](/geo/query/blast.html)
...
[Phenotype-Genotype Integrator (PheGenI)](/gap/PheGenI%20)
...
:   Provides a configurable graphical display of a nucleotide or protein sequence and features that have been annotated on that sequence. In addition to use on NCBI sequence database pages, this viewer is available as an embeddable webpage component. [Detailed documentation](/projects/sviewer/embedded.html) including an API Reference guide is available for developers wishing to embed the viewer in their own pages.

### How To

* [Save text searches and set up automated searches with E-mailed results](/guide/howto/receive-search-results)
* [Submit data to NCBI](/guide/howto/submit-data)
* [Find the function of a gene or gene product](/guide/howto/find-func-gene)
* [Find genes associated with a phenotype or disease](/guide/howto/find-gen-phen)
* [Find expression patterns](/guide/howto/find-exp-pat)
* [Find a homolog for a gene in another organism](/guide/howto/find-homolog-gene)
* [Find published information on a gene or sequence](/guide/howto/find-published-info-gene-sequence)
* [Find transcript sequences for a gene](/guide/howto/find-transcript-gene)
* [Compare your sequence to the RefSeqGene/LRG standard](/guide/howto/compare-to-refseqgene)
* [View genotype frequency data for a gene, disease or short genetic variation](/guide/howto/view-gen-freq)
* [Download a large, custom set of records from NCBI](/guide/howto/dwn-records)
...
* [NCBI Home](/)
* [Resource List (A-Z)](/guide/sitemap/)
* [All Resources](/guide/all/)
* [Chemicals & Bioassays](/guide/chemicals-bioassays/)
* [Data & Software](/guide/data-software/)
* [DNA & RNA](/guide/dna-rna/)
* [Domains & Structures](/guide/domains-structures/)
* [Genes & Expression](/guide/genes-expression/)
* [Genetics & Medicine](/guide/genetics-medicine/)
* [Genomes & Maps](/guide/genomes-maps/)
* [Homology](/guide/homology/)
* [Literature](/guide/literature/)
* [Proteins](/guide/proteins/)
* [Sequence Analysis](/guide/sequence-analysis/)
* [Taxonomy](/guide/taxonomy/)
* [Training & Tutorials](/guide/training-tutorials/)
* [Variation](/guide/variation/)

![](/stat?jsdisabled=true&ncbi_app=guide&ncbi_db=&ncbi_pdid=ResourceListPage&ncbi_phid=CE8BF7619FBD4A9100000000005D0057)
