...
### Tool Description
Build a Ganon database

### Metadata
- **Docker Image**: quay.io/biocontainers/ganon:2.2.0--py312hfc6b275_0
- **Homepage**: https://github.com/pirovc/ganon
- **Package**: https://anaconda.org/channels/bioconda/packages/ganon/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/ganon/overview
- **Total Downloads**: 105.4K
- **Last updated**: 2026-02-11
- **GitHub**: https://github.com/pirovc/ganon
- **Stars**: N/A
### Original Help Text
```text
...
### Tool Description
Update an existing Ganon database.
...
### Tool Description
Reassigns sequences based on EM algorithm.
...
### Tool Description
Report generation from Ganon classification results.
...
usage: ganon report [-h] -i [...] [-e INPUT_EXTENSION] -o OUTPUT_PREFIX [-d [...]] [-x] [-m [...]] [-z [...]]
                    [--skip-genome-size] [-f] [-t] [-r [...]] [-s] [-a] [-y] [-p [...]] [-k [...]] [-c] [-n] [--verbose]
...
### Tool Description
Create a table from Ganon report files.
