...
HsAgilentDesign026652ACCNUM

Map Manufacturer identifiers to Accession Numbers

Description

HsAgilentDesign026652ACCNUM is an R object that contains mappings between a manufacturer’s
...
HsAgilentDesign026652ALIAS2PROBE
...
HsAgilentDesign026652ALIAS is an R object that provides mappings between common gene sym-
...
xx <- as.list(HsAgilentDesign026652ALIAS2PROBE)
if(length(xx) > 0){
...
Welcome to the HsAgilentDesign026652.db annotation Package. The purpose of this package is to
provide detailed information about the HsAgilentDesign026652 platform. This package is updated
biannually.
Objects in this package are accessed using the select() interface. See ?select in the AnnotationDbi
package for details.

HsAgilentDesign026652CHR
...
HsAgilentDesign026652CHR is an R object that provides mappings between a manufacturer iden-
...
HsAgilentDesign026652CHRLENGTHS

A named vector for the length of each of the chromosomes

Description

HsAgilentDesign026652CHRLENGTHS provides the length measured in base pairs for each of the
chromosomes.
...
## Bimap interface:
tt <- HsAgilentDesign026652CHRLENGTHS
...
HsAgilentDesign026652CHRLOC is an R object that maps manufacturer identifiers to the starting
...
HsAgilentDesign026652ENSEMBL is an R object that contains mappings between manufacturer
...
# Convert to a list
xx <- as.list(HsAgilentDesign026652ENSEMBL2PROBE)
if(length(xx) > 0){
...
HsAgilentDesign026652ENTREZID is an R object that provides mappings between manufacturer
...
HsAgilentDesign026652ENZYME is an R object that provides mappings between manufacturer
identifiers and EC numbers. HsAgilentDesign026652ENZYME2PROBE is an R object that maps
Enzyme Commission (EC) numbers to manufacturer identifiers.

Details

When the HsAgilentDesign026652ENZYME maping viewed as a list, each manufacturer identifier
...
vector will contain an NA.
For the HsAgilentDesign026652ENZYME2PROBE, each EC number maps to a named vector con-
...
bers. In HsAgilentDesign026652ENZYME2PROBE, EC is dropped from the Enzyme Commission
numbers.
...
# Now convert HsAgilentDesign026652ENZYME2PROBE to a list to see inside
xx <- as.list(HsAgilentDesign026652ENZYME2PROBE)
if(length(xx) > 0){

# Get the probe identifiers for the first five enzyme

HsAgilentDesign026652GENENAME
...
HsAgilentDesign026652GENENAME is an R object that maps manufacturer identifiers to the cor-
...
## Bimap interface:
x <- HsAgilentDesign026652GENENAME
...
HsAgilentDesign026652GO is an R object that provides mappings between manufacturer identifiers
and the GO identifiers that they are directly associated with. This mapping and its reverse mapping
(HsAgilentDesign026652GO2PROBE) do NOT associate the child terms from the GO ontology
with the gene. Only the directly evidenced terms are represented here.

HsAgilentDesign026652GO2ALLPROBES is an R object that provides mappings between a given
...
than HsAgilentDesign026652GO2PROBE.

Details

If HsAgilentDesign026652GO is cast as a list, each manufacturer identifier is mapped to a list
...
If HsAgilentDesign026652GO2ALLPROBES or HsAgilentDesign026652GO2PROBE is cast as a
...
• HsAgilentDesign026652GO2ALLPROBES
• AnnotationDb-class for use of the select() interface.
...
# For the reverse map:
# Convert to a list
xx <- as.list(HsAgilentDesign026652GO2PROBE)
if(length(xx) > 0){
...
# Convert HsAgilentDesign026652GO2ALLPROBES to a list
xx <- as.list(HsAgilentDesign026652GO2ALLPROBES)
if(length(xx) > 0){
...
HsAgilentDesign026652MAP is an R object that provides mappings between manufacturer identi-
...
HsAgilentDesign026652MAPCOUNTS

13

HsAgilentDesign026652MAPCOUNTS

Number of mapped keys for the maps in package HsAgilentDe-
sign026652.db
...
HsAgilentDesign026652MAPCOUNTS provides the "map count" (i.e. the count of mapped keys)
for each map in package HsAgilentDesign026652.db.
...
HsAgilentDesign026652OMIM is an R object that provides mappings between manufacturer iden-
...
The Organism information for HsAgilentDesign026652

Description

HsAgilentDesign026652ORGANISM is an R object that contains a single item: a character string
that names the organism for which HsAgilentDesign026652 was built. HsAgilentDesign026652ORGPKG
...
Although the package name is suggestive of the organism for which it was built, HsAgilentDe-
sign026652ORGANISM provides a simple way to programmatically extract the organism name.
HsAgilentDesign026652ORGPKG provides a simple way to programmatically extract the name of
the parent organism package. The parent organism package is a strict dependency for chip pack-
...
## Bimap interface:
HsAgilentDesign026652ORGANISM
HsAgilentDesign026652ORGPKG

HsAgilentDesign026652PATH
...
HsAgilentDesign026652PATH maps probe identifiers to the identifiers used by KEGG for pathways
in which the genes represented by the probe identifiers are involved

HsAgilentDesign026652PATH2PROBE is an R object that provides mappings between KEGG
...
# Now convert the HsAgilentDesign026652PATH2PROBE object to a list

16

HsAgilentDesign026652PMID

xx <- as.list(HsAgilentDesign026652PATH2PROBE)
if(length(xx) > 0){
...
HsAgilentDesign026652PFAM

Maps between Manufacturer Identifiers and PFAM Identifiers

Description

HsAgilentDesign026652PFAM is an R object that provides mappings between manufacturer iden-
...
HsAgilentDesign026652PMID is an R object that provides mappings between manufacturer iden-
tifiers and PubMed identifiers. HsAgilentDesign026652PMID2PROBE is an R object that provides
mappings between PubMed identifiers and manufacturer identifiers.

Details

When HsAgilentDesign026652PMID is viewed as a list each manufacturer identifier is mapped
...
When HsAgilentDesign026652PMID2PROBE is viewed as a list each PubMed identifier is mapped
...
# Now convert the reverse map object HsAgilentDesign026652PMID2PROBE to a list
xx <- as.list(HsAgilentDesign026652PMID2PROBE)
if(length(xx) > 0){
...
HsAgilentDesign026652REFSEQ

HsAgilentDesign026652PROSITE is an R object that provides mappings between manufacturer
...
HsAgilentDesign026652REFSEQ is an R object that provides mappings between manufacturer
...
HsAgilentDesign026652SYMBOL is an R object that provides mappings between manufacturer
...
HsAgilentDesign026652UNIGENE is an R object that provides mappings between manufacturer
...
## Bimap interface:
x <- HsAgilentDesign026652UNIGENE
...
HsAgilentDesign026652UNIPROT is an R object that contains mappings between the manufacturer
...
## Bimap interface:
x <- HsAgilentDesign026652UNIPROT
...
HsAgilentDesign026652_dbconn()
HsAgilentDesign026652_dbfile()
HsAgilentDesign026652_dbschema(file="", show.indices=FALSE)
HsAgilentDesign026652_dbInfo()
...
HsAgilentDesign026652_dbconn returns a connection object to the package annotation DB. IM-
PORTANT: Don’t call dbDisconnect on the connection object returned by HsAgilentDesign026652_dbconn
or you will break all the AnnDbObj objects defined in this package!
HsAgilentDesign026652_dbfile returns the path (character string) to the package annotation DB
(this is an SQLite file).
HsAgilentDesign026652_dbschema prints the schema definition of the package annotation DB.
HsAgilentDesign026652_dbInfo prints other information about the package annotation DB.

Value

HsAgilentDesign026652_dbconn: a DBIConnection object representing an open connection to
the package annotation DB.
HsAgilentDesign026652_dbfile: a character string with the path to the package annotation DB.
HsAgilentDesign026652_dbschema: none (invisible NULL).
HsAgilentDesign026652_dbInfo: none (invisible NULL).
...
dbGetQuery(HsAgilentDesign026652_dbconn(), "SELECT COUNT(*) FROM probes")
...
HsAgilentDesign026652.db, 2
HsAgilentDesign026652_dbconn, 22
HsAgilentDesign026652ACCNUM, 1
HsAgilentDesign026652ALIAS2PROBE,

2

HsAgilentDesign026652CHR, 3
HsAgilentDesign026652CHRLENGTHS, 4
HsAgilentDesign026652CHRLOC, 4
HsAgilentDesign026652ENSEMBL, 5
HsAgilentDesign026652ENTREZID, 6
HsAgilentDesign026652ENZYME, 7
HsAgilentDesign026652GENENAME, 9
HsAgilentDesign026652GO, 10
HsAgilentDesign026652MAP, 12
HsAgilentDesign026652MAPCOUNTS, 13
HsAgilentDesign026652OMIM, 13
HsAgilentDesign026652ORGANISM, 14
HsAgilentDesign026652PATH, 15
HsAgilentDesign026652PFAM, 16
HsAgilentDesign026652PMID, 16
HsAgilentDesign026652PROSITE, 17
HsAgilentDesign026652REFSEQ, 18
HsAgilentDesign026652SYMBOL, 19
HsAgilentDesign026652UNIGENE, 20
HsAgilentDesign026652UNIPROT, 21
...
HsAgilentDesign026652ACCNUM, 1
HsAgilentDesign026652ALIAS2PROBE, 2
HsAgilentDesign026652CHR, 3
HsAgilentDesign026652CHRLENGTHS, 4
HsAgilentDesign026652CHRLOC, 4
HsAgilentDesign026652CHRLOCEND

(HsAgilentDesign026652CHRLOC),
4

HsAgilentDesign026652ENSEMBL, 5
HsAgilentDesign026652ENSEMBL2PROBE
...
HsAgilentDesign026652ENTREZID, 6
HsAgilentDesign026652ENZYME, 7
HsAgilentDesign026652ENZYME2PROBE
...
HsAgilentDesign026652GENENAME, 9
HsAgilentDesign026652GO, 10
HsAgilentDesign026652GO2ALLPROBES, 11
HsAgilentDesign026652GO2ALLPROBES

(HsAgilentDesign026652GO), 10

HsAgilentDesign026652GO2PROBE

(HsAgilentDesign026652GO), 10

HsAgilentDesign026652LOCUSID
...
HsAgilentDesign026652PATH, 15
HsAgilentDesign026652PATH2PROBE

(HsAgilentDesign026652PATH), 15

HsAgilentDesign026652PFAM, 16
HsAgilentDesign026652PMID, 16
HsAgilentDesign026652PMID2PROBE
...
HsAgilentDesign026652UNIGENE, 20
HsAgilentDesign026652UNIPROT, 21
HsAgilentDesign026652UNIPROT2PROBE
