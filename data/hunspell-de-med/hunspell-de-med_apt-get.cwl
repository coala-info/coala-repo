...
baseCommand: hunspell-de-med_apt-get
label: hunspell-de-med_apt-get
doc: "German medical dictionary for Hunspell. (Note: The provided text contains system
  error messages regarding container image retrieval and does not include usage instructions
...
stdout: hunspell-de-med_apt-get.out
