...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fquantaosun%2FAmbertools-OpenMM-MD%2Fblob%2Fmain%2Fprot_lig_openmm_10ns.py)
...
[History](/quantaosun/Ambertools-OpenMM-MD/commits/main/prot_lig_openmm_10ns.py)

History

172 lines (130 loc) · 6.26 KB
...
[Raw](https://github.com/quantaosun/Ambertools-OpenMM-MD/raw/refs/heads/main/prot_lig_openmm_10ns.py)
...
prmtop = AmberPrmtopFile('SYS\_gaff2.prmtop')

inpcrd = AmberInpcrdFile('SYS\_gaff2.crd')
...
dcdReporter = DCDReporter('prot\_lig\_prod.dcd', 10000)
...
dataReporter = StateDataReporter('prot\_lig\_prod.log', 1000, totalSteps=productionSteps,
...
PDBFile.writeFile(topology, positions, open('prod\_lig\_1.pdb', 'w'))
