...
* `types` contains the type of the column. Type should be expressed as a
  ...
  + `date` for generic date format - note that functions that
    ...
    may fail
  + One of the accepted date/datetime formats by *[lubridate](https://CRAN.R-project.org/package%3Dlubridate)*,
...
* `tag`: a specific tag expressed as a string - see Section [2.2](#tags)
...
in combination with VISPA2 pipeline (Giulio Spinozzi
Andrea Calabria, 2017).
If you don’t know what it is, we strongly
recommend you to take a look at these links:

* Article: [VISPA2: Article](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5702242/)
...
(see Section [4.4](#metadata)) or a string (the path to the association file
...
As we mentioned in Section [4.3](#notation), annotation columns are optional
...
do that via the `filter_for` argument as explained in Section [4.4](#metadata)).
...
| chr | integration\_locus | strand | seqCount | CompleteAmplificationID | SubjectID | ProjectID |
| --- | --- | --- | --- | --- | --- | --- |
...
3. **Changing the `value_cols` value**
   ...
   “original name\_function applied”.
...
In this way we know that the group “MNC\_BM-1” comes from table 1 and has 54 ISs,
while “MNC\_BM-2” comes from the second input table and has 114 ISs.
...
*[eulerr](https://CRAN.R-project.org/package%3Deulerr)* to work. The argument `euler` indicates if the function
...
#>  BiocParallel    1.44.0   2026-01-29 [2] Bioconductor 3.22 (R 4.5.2)
#>  BiocStyle     * 2.38.0   2026-01-29 [2] Bioconductor 3.22 (R 4.5.2)
...
#>  doFuture        1.2.0    2026-01-15 [2] CRAN (R 4.5.2)
...
#>  ISAnalytics   * 1.20.1   2026-01-29 [1] Bioconductor 3.22 (R 4.5.2)
...
#>  mnormt          2.1.2    2026-01-27 [2] CRAN (R 4.5.2)
...
#>  polylabelr      1.0.0    2026-01-19 [2] CRAN (R 4.5.2)
...
#>  reactable       0.4.5    2025-12-01 [2] CRAN (R 4.5.2)
...
#>
#>  [1] /tmp/Rtmpap6YAq/Rinst1e287d317c3f33
...
This vignette was generated using *[BiocStyle](https://bioconductor.org/packages/3.22/BiocStyle)* (Oleś, 2026)
with *[knitr](https://CRAN.R-project.org/package%3Dknitr)* (Xie, 2025) and *[rmarkdown](https://CRAN.R-project.org/package%3Drmarkdown)* (Allaire, Xie, Dervieux, McPherson, Luraschi, Ushey, Atkins, Wickham, Cheng, Chang, and Iannone, 2025) running behind the scenes.
...
[[2]](#cite-giuliospinozzivispa2)
S. B. Giulio Spinozzi
Andrea Calabria.
“VISPA2: a scalable pipeline for high-throughput identification and annotation of vector integration sites”.
In: *BMC Bioinformatics* (Nov. 25, 2017).
DOI: [10.1186/s12859-017-1937-9](https://doi.org/10.1186/s12859-017-1937-9).
