...
hgu95av2ACCNUM is an R object that contains mappings between a manufacturer’s identifiers and
...
hgu95av2ALIAS is an R object that provides mappings between common gene symbol identifiers
...
Welcome to the hgu95av2.db annotation Package. The purpose of this package is to provide detailed
information about the hgu95av2 platform. This package is updated biannually.
...
hgu95av2CHR is an R object that provides mappings between a manufacturer identifier and the
...
hgu95av2CHRLOC is an R object that maps manufacturer identifiers to the starting position of the
...
hgu95av2ENSEMBL is an R object that contains mappings between manufacturer identifiers and
...
hgu95av2ENTREZID is an R object that provides mappings between manufacturer identifiers and
...
hgu95av2ENZYME is an R object that provides mappings between manufacturer identifiers and
EC numbers. hgu95av2ENZYME2PROBE is an R object that maps Enzyme Commission (EC)
numbers to manufacturer identifiers.

Details

When the hgu95av2ENZYME maping viewed as a list, each manufacturer identifier maps to a
...
For the hgu95av2ENZYME2PROBE, each EC number maps to a named vector containing all of
...
# Now convert hgu95av2ENZYME2PROBE to a list to see inside

hgu95av2GENENAME

9

x <- hgu95av2ENZYME2PROBE
mapped_probes <- mappedkeys(x)
## convert to a list
xx <- as.list(x[mapped_probes][1:3])
if(length(xx) > 0){
...
hgu95av2GENENAME is an R object that maps manufacturer identifiers to the corresponding gene
name.
...
hgu95av2GO is an R object that provides mappings between manufacturer identifiers and the GO
identifiers that they are directly associated with. This mapping and its reverse mapping (hgu95av2GO2PROBE)
...
hgu95av2GO2ALLPROBES is an R object that provides mappings between a given GO iden-
...
If hgu95av2GO is cast as a list, each manufacturer identifier is mapped to a list of lists. The names
on the outer list are GO identifiers. Each inner list consists of three named elements: GOID, Ontol-
ogy, and Evidence.
...
If hgu95av2GO2ALLPROBES or hgu95av2GO2PROBE is cast as a list, each GO term maps to a
...
x <- hgu95av2GO2ALLPROBES
mapped_genes <- mappedkeys(x)
# Convert hgu95av2GO2ALLPROBES to a list
xx <- as.list(x[mapped_genes][1:300])
...
hgu95av2MAP is an R object that provides mappings between manufacturer identifiers and cyto-
band locations.
...
Number of mapped keys for the maps in package hgu95av2.db

Description

DEPRECATED. Counts in the MAPCOUNT table are out of sync and should not be used.

hgu95av2MAPCOUNTS provides the "map count" (i.e. the count of mapped keys) for each map in
package hgu95av2.db.
...
hgu95av2OMIM is an R object that provides mappings between manufacturer identifiers and OMIM
identifiers.
...
The Organism information for hgu95av2

Description

hgu95av2ORGANISM is an R object that contains a single item: a character string that names
the organism for which hgu95av2 was built. hgu95av2ORGPKG is an R object that contains a
...
provides a simple way to programmatically extract the organism name. hgu95av2ORGPKG pro-
...
hgu95av2PATH maps probe identifiers to the identifiers used by KEGG for pathways in which the
genes represented by the probe identifiers are involved

hgu95av2PATH2PROBE is an R object that provides mappings between KEGG identifiers and man-
...
x <- hgu95av2PATH
mapped_probes <- mappedkeys(x)
# Now convert the hgu95av2PATH2PROBE object to a list
xx <- as.list(x[mapped_probes][1:300])
if(length(xx) > 0){
...
hgu95av2PFAM is an R object that provides mappings between manufacturer identifiers and PFAM
identifiers.
...
hgu95av2PMID is an R object that provides mappings between manufacturer identifiers and PubMed
identifiers. hgu95av2PMID2PROBE is an R object that provides mappings between PubMed iden-
tifiers and manufacturer identifiers.

Details

When hgu95av2PMID is viewed as a list each manufacturer identifier is mapped to a named vector
...
When hgu95av2PMID2PROBE is viewed as a list each PubMed identifier is mapped to a named
...
hgu95av2PROSITE is an R object that provides mappings between manufacturer identifiers and
PROSITE identifiers.
...
hgu95av2REFSEQ is an R object that provides mappings between manufacturer identifiers and
RefSeq identifiers.
...
hgu95av2SYMBOL is an R object that provides mappings between manufacturer identifiers and
gene abbreviations.
...
hgu95av2UNIPROT is an R object that contains mappings between the manufacturer identifiers and
...
hgu95av2_dbconn returns a connection object to the package annotation DB. IMPORTANT: Don’t
call dbDisconnect on the connection object returned by hgu95av2_dbconn or you will break all
the AnnDbObj objects defined in this package!

hgu95av2_dbfile returns the path (character string) to the package annotation DB (this is an
SQLite file).

hgu95av2_dbschema prints the schema definition of the package annotation DB.

hgu95av2_dbInfo prints other information about the package annotation DB.

Value

hgu95av2_dbconn: a DBIConnection object representing an open connection to the package anno-
tation DB.

hgu95av2_dbfile: a character string with the path to the package annotation DB.

hgu95av2_dbschema: none (invisible NULL).

hgu95av2_dbInfo: none (invisible NULL).
...
hgu95av2_dbconn, 21
hgu95av2ACCNUM, 1
hgu95av2ALIAS2PROBE, 2
hgu95av2CHR, 3
hgu95av2CHRLENGTHS, 4
hgu95av2CHRLOC, 4
hgu95av2ENSEMBL, 5
hgu95av2ENTREZID, 6
hgu95av2ENZYME, 7
...
hgu95av2 (hgu95av2.db), 2
hgu95av2.db, 2
hgu95av2_dbconn, 21
hgu95av2_dbfile (hgu95av2_dbconn), 21

23

hgu95av2_dbInfo (hgu95av2_dbconn), 21
hgu95av2_dbschema (hgu95av2_dbconn), 21
hgu95av2ACCNUM, 1
hgu95av2ALIAS2PROBE, 2
hgu95av2CHR, 3
hgu95av2CHRLENGTHS, 4
hgu95av2CHRLOC, 4
hgu95av2CHRLOCEND (hgu95av2CHRLOC), 4
hgu95av2ENSEMBL, 5
...
hgu95av2ENTREZID, 6
hgu95av2ENZYME, 7
hgu95av2ENZYME2PROBE (hgu95av2ENZYME), 7
hgu95av2GENENAME, 9
hgu95av2GO, 10
hgu95av2GO2ALLPROBES, 11
hgu95av2GO2ALLPROBES (hgu95av2GO), 10
hgu95av2GO2PROBE (hgu95av2GO), 10
hgu95av2LOCUSID (hgu95av2ENTREZID), 6
hgu95av2MAP, 12
hgu95av2MAPCOUNTS, 13
hgu95av2OMIM, 13
hgu95av2ORGANISM, 14
hgu95av2ORGPKG (hgu95av2ORGANISM), 14
hgu95av2PATH, 15
hgu95av2PATH2PROBE (hgu95av2PATH), 15
hgu95av2PFAM, 16
hgu95av2PMID, 16
hgu95av2PMID2PROBE (hgu95av2PMID), 16
hgu95av2PROSITE, 17
hgu95av2REFSEQ, 18
hgu95av2SYMBOL, 19
hgu95av2UNIPROT, 20
hgu95av2UNIPROT2PROBE
