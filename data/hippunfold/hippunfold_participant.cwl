...
label: hippunfold_participant
doc: "Performs hippocampal unfolding analysis.\n\nTool homepage: https://github.com/khanlab/hippunfold"
inputs:
  - id: bids_dir
    type: Directory
  ...
  - id: filter_dsegsubfields
    type:
      ...
      - type: array
        items: string
    doc: Filters for input components for dsegsubfields images. Each filter can 
      be specified as a ENTITY=VALUE pair to select an value directly. To use 
      regex filtering, ENTITY:match=REGEX or ENTITY:search=REGEX can be used for
  ...
  - id: filter_dsegtissue
    type:
      ...
      - type: array
        items: string
    doc: Filters for input components for dsegtissue images. Each filter can be 
  ...
  - id: filter_hippb500
    type:
      ...
      - type: array
        items: string
    doc: Filters for input components for hippb500 images. Each filter can be 
      specified as a ENTITY=VALUE pair to select an value directly. To use regex
      filtering, ENTITY:match=REGEX or ENTITY:search=REGEX can be used for 
      re.match() or re.search() respectively. Regex can also be used to select 
      multiple values, e.g. 'session:match=01|02'. ENTITY:required and 
  ...
  - id: filter_t1w
    type:
      ...
      - type: array
        items: string
    doc: Filters for input components for T1w images. Each filter can be 
      specified as a ENTITY=VALUE pair to select an value directly. To use regex
      filtering, ENTITY:match=REGEX or ENTITY:search=REGEX can be used for 
      re.match() or re.search() respectively. Regex can also be used to select 
      multiple values, e.g. 'session:match=01|02'. ENTITY:required and 
  ...
  - id: filter_t2w
    type:
      ...
      - type: array
        items: string
    doc: Filters for input components for T2w images. Each filter can be 
      specified as a ENTITY=VALUE pair to select an value directly. To use regex
      filtering, ENTITY:match=REGEX or ENTITY:search=REGEX can be used for 
      re.match() or re.search() respectively. Regex can also be used to select 
      multiple values, e.g. 'session:match=01|02'. ENTITY:required and 
  ...
  - id: path_dsegsubfields
    type:
      - 'null'
      - Directory
    doc: 'Override BIDS by specifying absolute paths for dsegsubfields images, e.g.:
  ...
  - id: path_dsegtissue
    type:
      - 'null'
      - Directory
    doc: 'Override BIDS by specifying absolute paths for dsegtissue images, e.g.:
      /path/to/my_data/{subject}/t1.nii.gz'
    inputBinding:
      position: 104
  ...
  - id: path_hippb500
    type:
      - 'null'
      - Directory
    doc: 'Override BIDS by specifying absolute paths for hippb500 images, e.g.: /path/to/my_data/{subject}/t1.nii.gz'
    inputBinding:
      position: 104
  ...
  - id: path_t1w
    type:
      - 'null'
      - Directory
    doc: 'Override BIDS by specifying absolute paths for T1w images, e.g.: /path/to/my_data/{subject}/t1.nii.gz'
    inputBinding:
      position: 104
      prefix: --path-T1w
  - id: path_t2w
    type:
      - 'null'
      - Directory
    doc: 'Override BIDS by specifying absolute paths for T2w images, e.g.: /path/to/my_data/{subject}/t1.nii.gz'
    inputBinding:
      position: 104
      prefix: --path-T2w
  - id: pybidsdb_dir
  ...
  - id: use_template_seg
    ...
    inputBinding:
      position: 104
      prefix: --use_template_seg
  - id: wildcards_dsegsubfields
    type:
      - 'null'
      - type: array
        items: string
    doc: Entities to be used as wildcards for dsegsubfields images.
    default:
      - subject
      - session
      - hemi
  ...
  - id: wildcards_dsegtissue
    type:
      ...
      - type: array
        items: string
    doc: Entities to be used as wildcards for dsegtissue images.
    default:
      - subject
      - session
      - hemi
  ...
  - id: wildcards_hippb500
    type:
      ...
      - type: array
        items: string
    doc: Entities to be used as wildcards for hippb500 images.
    default:
      - subject
      - session
    inputBinding:
  ...
  - id: wildcards_t1w
    type:
      ...
      - type: array
        items: string
    doc: Entities to be used as wildcards for T1w images.
    default:
      - subject
      - session
      - acquisition
  ...
  - id: wildcards_t2w
    type:
      ...
      - type: array
        items: string
    doc: Entities to be used as wildcards for T2w images.
    default:
      - subject
      - session
      - acquisition
...
stdout: hippunfold_participant.out
