# Assembly with Flye - upgraded CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://training.galaxyproject.org
- **Package**: https://workflowhub.eu/workflows/1595
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1595/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 268
...
- **Main workflow (WorkflowHub):** `galaxy-workflow-assembly-with-flye.ga` (Main Workflow)
