...
label: sgcocaller_autophase
doc: "sgcocaller is a tool for phasing and analyzing single-cell DNA sequencing data.\n\
  \nTool homepage: https://gitlab.svi.edu.au/biocellgen-public/sgcocaller"
inputs:
  - id: subcommand
    type: string
    doc: The subcommand to run (autophase, phase, swphase, sxo, xo)
    inputBinding:
      position: 1
  - id: bam_file
    type: File
  ...
  - id: snp_phase_file
    type: File
    doc: the SNP phase file
    inputBinding:
      position: 4
  - id: phase_output_prefix
    type: string
    doc: the phase output prefix
    inputBinding:
      position: 5
...
stdout: sgcocaller_autophase.out
