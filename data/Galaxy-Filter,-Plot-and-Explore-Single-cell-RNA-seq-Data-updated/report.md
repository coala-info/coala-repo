# Filter, Plot and Explore Single-cell RNA-seq Data updated CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://training.galaxyproject.org
- **Package**: https://workflowhub.eu/workflows/1496
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1496/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 275
...
- **Main workflow (WorkflowHub):** `filter--plot-and-explore-single-cell-rna-seq-data-updated.ga` (Main Workflow)
