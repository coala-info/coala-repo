...
Lots of plots, various labeling, axis and color scaling functions. The author/maintainer died in September 2023.</p>

### Metadata
- **Conda**: https://anaconda.org/channels/r/packages/r-plotrix/overview
- **R-project (CRAN)**: https://cloud.r-project.org/web/packages/plotrix/index.html
- **Home (project)**: https://CRAN.R-project.org/package=plotrix
- **Package**: plotrix
- **Version**: 3.8-14
...
- **Docker Image**: quay.io/biocontainers/r-plotrix:3.6_4--r3.3.1_0
- **Skill**: generated
