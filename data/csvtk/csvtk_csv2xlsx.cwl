...
baseCommand:
  - csvtk
  - csv2xlsx
label: csvtk_csv2xlsx
doc: "convert CSV/TSV files to XLSX file. Multiple CSV/TSV files are saved as separated
...
inputs:
  ...
  - id: format_numbers
    type:
      - 'null'
      - boolean
    doc: save numbers in number format, instead of text
    inputBinding:
      position: 101
      prefix: --format-numbers
  - id: ignore_empty_row
    type:
      - 'null'
      - boolean
