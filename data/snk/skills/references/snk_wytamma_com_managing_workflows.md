...
[Skip to content](#using-snk-to-manage-workflows)
...
* [ ]
  ...
  Table of contents
  + [Installing workflows](#installing-workflows)

    - [Local install](#local-install)
    - [Isolated workflow environments](#isolated-workflow-environments)
    - [Other install options](#other-install-options)
  + [Listing workflows](#listing-workflows)
  + [Uninstall workflows](#uninstall-workflows)
  + [Editing workflow CLI configuration](#editing-workflow-cli-configuration)
  + [Ejecting workflows](#ejecting-workflows)
