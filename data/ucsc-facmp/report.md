...
### Tool Description
Compare two FASTA files to see if they are identical.
...
FATAL:   Unable to handle docker://quay.io/biocontainers/ucsc-facmp:482--h0b57e2e_0 uri: while building SIF from layers: conveyor failed to get: invalid character '}' after top-level value
```
