...
* [3 Quick start](#quick-start)
  + [3.1 Plot the most basic volcano plot](#plot-the-most-basic-volcano-plot)
* [4 Advanced features](#advanced-features)
  + [4.1 Modify cut-offs for log2FC and P value; specify title; adjust point and label size](#modify-cut-offs-for-log2fc-and-p-value-specify-title-adjust-point-and-label-size)
  + [4.2 Adjust colour and alpha for point shading](#adjust-colour-and-alpha-for-point-shading)
  + [4.3 Adjust shape of plotted points](#adjust-shape-of-plotted-points)
  + [4.4 Adjust cut-off lines and add extra threshold lines](#adjust-cut-off-lines-and-add-extra-threshold-lines)
  + [4.5 Adjust legend position, size, and text](#adjust-legend-position-size-and-text)
  + [4.6 Fit more labels by adding connectors](#fit-more-labels-by-adding-connectors)
  + [4.7 Only label key variables](#only-label-key-variables)
  + [4.8 Draw labels in boxes](#draw-labels-in-boxes)
  + [4.9 Italicise labels and flip volcano on it’s side](#italicise-labels-and-flip-volcano-on-its-side)
  + [4.10 Over-ride colouring scheme with custom key-value pairs](#over-ride-colouring-scheme-with-custom-key-value-pairs)
  + [4.11 Over-ride colour and/or shape scheme with custom key-value pairs](#over-ride-colour-andor-shape-scheme-with-custom-key-value-pairs)
  + [4.12 Encircle / highlight certain variables](#encircle-highlight-certain-variables)
  + [4.13 Highlighting key variables via custom point sizes](#highlighting-key-variables-via-custom-point-sizes)
  + [4.14 Change to continuous colour scheme](#change-to-continuous-colour-scheme)
  + [4.15 Custom axis tick marks](#custom-axis-tick-marks)
...
![Plot the most basic volcano plot.](data:image/png;base64...)
...
![Modify cut-offs for log2FC and P value; specify title; adjust point and label size.](data:image/png;base64...)
...
![Adjust colour and alpha for point shading.](data:image/png;base64...)
...
![Adjust shape of plotted points.](data:image/png;base64...)
...
![Adjust cut-off lines and add extra threshold lines.](data:image/png;base64...)
...
![Adjust legend position, size, and text.](data:image/png;base64...)
...
![Fit more labels by adding connectors.](data:image/png;base64...)
...
![Draw labels in boxes.](data:image/png;base64...)
...
To flip the volcano on its side, we just use *EnhancedVolcano(…) + coord\_flip()*.
...
![Italicise labels and flip volcano on it's side.](data:image/png;base64...)
...
![Over-ride colouring scheme with custom key-value pairs.](data:image/png;base64...)
...
![Over-ride colour and/or shape scheme with custom key-value pairs.](data:image/png;base64...)

Over-ride colour and/or shape scheme with custom key-value pairs.

## 4.12 Encircle / highlight certain variables
...
![Shade certain variables.](data:image/png;base64...)
...
![Highlighting key variabvles via custom point sizes.](data:image/png;base64...)

Highlighting key variabvles via custom point sizes.

## 4.14 Change to continuous colour scheme
...
![Custom axis tick marks](data:image/png;base64...)
...
##  [1] pasilla_1.38.0              DEXSeq_1.56.0
##  [3] RColorBrewer_1.1-3          BiocParallel_1.44.0
##  [5] gridExtra_2.3               DESeq2_1.50.2
##  [7] org.Hs.eg.db_3.22.0         AnnotationDbi_1.72.0
##  [9] magrittr_2.0.4              airway_1.30.0
...
## [21] EnhancedVolcano_1.28.2      ggrepel_0.9.6
## [23] ggplot2_4.0.1               knitr_1.50
##
## loaded via a namespace (and not attached):
##  [1] tidyselect_1.2.1    dplyr_1.1.4         farver_2.1.2
##  [4] blob_1.2.4          filelock_1.0.3      Biostrings_2.78.0
##  [7] S7_0.2.1            bitops_1.0-9        fastmap_1.2.0
## [10] BiocFileCache_3.0.0 XML_3.99-0.20       digest_0.6.39
## [13] lifecycle_1.0.4     statmod_1.5.1       survival_3.8-3
## [16] KEGGREST_1.50.0     RSQLite_2.4.5       genefilter_1.92.0
## [19] compiler_4.5.2      progress_1.2.3      rlang_1.1.6
## [22] sass_0.4.10         tools_4.5.2         yaml_2.3.11
## [25] prettyunits_1.2.0   S4Arrays_1.10.1     labeling_0.4.3
## [28] bit_4.6.0           curl_7.0.0          DelayedArray_0.36.0
## [31] abind_1.4-8         hwriter_1.3.2.1     withr_3.0.2
## [34] xtable_1.8-4        scales_1.4.0        MASS_7.3-65
## [37] isoband_0.2.7       dichromat_2.0-0.1   biomaRt_2.66.0
...
## [52] jsonlite_2.0.0      geneplotter_1.88.0  hms_1.1.4
## [55] bit64_4.6.0-1       locfit_1.5-9.12     jquerylib_0.1.4
## [58] annotate_1.88.0     glue_1.8.0          codetools_0.2-20
...
## [73] Rsamtools_2.26.0    memoise_2.0.1       bslib_0.9.0
## [76] Rcpp_1.1.0          SparseArray_1.10.6  xfun_0.54
## [79] pkgconfig_2.0.3
```
