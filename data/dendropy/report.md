...
Source Options:
  ...
  -i, --input-format, --source-format FORMAT
                        ...
                        known).
  -b, --burnin BURNIN   Number of trees to skip from the beginning of *each*
  ...
  -v, --ultrametricity-precision, --edge-weight-epsilon, --branch-length-epsilon ULTRAMETRICITY_PRECISION
                        Precision to use when validating ultrametricity
                        (default: 1e-05; specify '0' to disable validation).
  --taxon-name-filepath, --taxon-names-filepath FILEPATH
                        ...
                        these issues.
  --tip-ages, --tip-ages-filepath FILEPATH
...
Output Options:
  -o, --output-tree-filepath, --output FILEPATH
                        Path to output file (if not specified, will print to
                        standard output).
  -F, --output-tree-format {nexus,newick,phylip,nexml}
  ...
  -c, --additional-comments ADDITIONAL_COMMENTS
...
Parallel Processing Options:
  ...
  -m, --multiprocessing NUM-PROCESSES
