...
inputs:
  ...
  - id: bidirectional_promoter_sizes
    ...
    doc: "Bidirectional-promoter sizes for ChIP region\n                        annotation
      Comma-separated two values or a single\n                        value can be
      given. If a single value is given, it\n                        will be segmented
  ...
  - id: gene_group_names
    ...
    doc: "The names of the gene groups in --gn-groups. The gene\n                \
      ...
      \                        names given, the groups are represented as 'Group 1,Group2,...Group
      n'."
    inputBinding:
      position: 102
  ...
  - id: wig_file
    type:
      - 'null'
      - File
    doc: "WIG file for either wig profiling or genome background\n               \
