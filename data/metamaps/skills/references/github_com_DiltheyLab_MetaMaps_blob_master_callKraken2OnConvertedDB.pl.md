...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2FDiltheyLab%2FMetaMaps%2Fblob%2Fmaster%2FcallKraken2OnConvertedDB.pl)
...
[History](/DiltheyLab/MetaMaps/commits/master/callKraken2OnConvertedDB.pl)

History

73 lines (52 loc) · 1.25 KB
...
[Raw](https://github.com/DiltheyLab/MetaMaps/raw/refs/heads/master/callKraken2OnConvertedDB.pl)
...
my $kraken2\_binPrefix = SimulationsKraken::getKraken2BinPrefix();
...
#Util::read\_taxonIDs\_and\_contigs($database, \%taxonID\_2\_contigs, \%contigLength);
...
$outputDir = abs\_path($outputDir);

my %taxonID\_original\_2\_contigs;

my %contigLength;

Util::read\_taxonIDs\_and\_contigs($database, \%taxonID\_original\_2\_contigs, \%contigLength);
