...
* [Workflows](../workflows.html)
* ChIP-seq
* [Edit on GitHub](https://github.com/vanheeringen-lab/seq2science/blob/master/docs/content/workflows/chip_seq.md)

---

# ChIP-seq[](#chip-seq "Link to this heading")
...
##### Broad peaks[](#broad-peaks "Link to this heading")
...
### Control (input) column[](#control-input-column "Link to this heading")
