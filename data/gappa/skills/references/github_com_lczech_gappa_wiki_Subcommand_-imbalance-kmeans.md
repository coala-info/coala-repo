...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Flczech%2Fgappa%2Fwiki%2FSubcommand%3A-imbalance-kmeans)
...
·
[11 revisions](/lczech/gappa/wiki/Subcommand%3A-imbalance-kmeans/_history)
...
Imbalance k-means has almost the same usage as [Phylogenetic k-means](../wiki/Subcommand%3A-phylogenetic-kmeans). See there for details. The difference is in the distance measure being used, which is a simple Euclidean distance of the edge imbalances of the samples, instead of using the more involved Phylogenetic KR distance between samples.
...
* Loading
  ...
  + [Options](/lczech/gappa/wiki/Subcommand%3A-imbalance-kmeans#options)
  + [Description](/lczech/gappa/wiki/Subcommand%3A-imbalance-kmeans#description)
  + [Citation](/lczech/gappa/wiki/Subcommand%3A-imbalance-kmeans#citation)
* Loading
