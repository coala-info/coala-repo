...
*sort* is one of the core subprograms of *SeqFu*, that allows sorting a FASTA/FASTQ file by sequence size.
...
![Screenshot of "seqfu sort"](/seqfu2/img/screenshot-sort.svg "SeqFu sort")
