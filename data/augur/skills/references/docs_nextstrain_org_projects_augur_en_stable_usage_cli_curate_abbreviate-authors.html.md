...
* [Augur subcommands](../cli.html)
* [augur curate](index.html)
* [View page source](../../../_sources/usage/cli/curate/abbreviate-authors.rst.txt)

---

# abbreviate-authors[](#abbreviate-authors "Link to this heading")
...
`--authors-field`
:   The field containing list of authors.
...
`--abbr-authors-field`
:   The field for the generated abbreviated authors. If not provided, the original authors field will be modified.
...
[Previous](apply-record-annotations.html "apply-record-annotations")
[Next](parse-genbank-location.html "parse-genbank-location")
