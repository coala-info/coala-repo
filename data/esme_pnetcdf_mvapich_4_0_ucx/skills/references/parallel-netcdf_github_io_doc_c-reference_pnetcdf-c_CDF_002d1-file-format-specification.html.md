Next: [CDF-2 file format specification](CDF_002d2-file-format-specification.html#CDF_002d2-file-format-specification), Previous: [Combined Index](Combined-Index.html#Combined-Index), Up: [Top](index.html#Top)   [[Index](Combined-Index.html#Combined-Index "Index")]

---

## Appendix E CDF-1 file format specification
...
See [[ESDS-RFC-011v2.0]](https://cdn.earthdata.nasa.gov/conduit/upload/496/ESDS-RFC-011v2.00.pdf)

The difference between CDF-1 and CDF-2 is only in the VERSION byte (\x01 vs. \x02) and the OFFSET entity, a 64-bit instead of a 32-bit offset from the beginning of the file. See [CDF-2 file format specification](CDF_002d2-file-format-specification.html#CDF_002d2-file-format-specification) for the detailed specifications of both CDF-1 and CDF-2.
...
Readers are referred to [[this URL]](http://www.unidata.ucar.edu/software/netcdf/old_docs/really_old/guide_15.html) for the original specification (copied below).

### The Old Format (used by NetCDF library through version 3.5.1)
...
`var_array` above, and sum the `vsize` fields of "record"
...
storing the results in a `product` array for each variable. For example:
...
‘`C`’, ‘`D`’, ‘`F`’, ‘`\x01`’. Following are seven 32-bit
