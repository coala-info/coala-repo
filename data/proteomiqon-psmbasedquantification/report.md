...
### Tool Description
A tool for PSM-based quantification in proteomics.
...
FATAL:   Unable to handle docker://quay.io/biocontainers/proteomiqon-psmbasedquantification:0.0.9--hdfd78af_0 uri: while building SIF from layers: conveyor failed to get: invalid character '}' after top-level value
```
...
## proteomiqon-psmbasedquantification_proteomiqon

### Tool Description
A tool for PSM-based quantification (Note: The provided help text contains only system error logs and no usage information).
