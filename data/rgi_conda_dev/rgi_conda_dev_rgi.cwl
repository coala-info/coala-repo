...
inputs:
  - id: alignment_tool
    type:
      - 'null'
      - string
    doc: choose between BLAST and DIAMOND. Options are BLAST or DIAMOND (default
      = BLAST)
    inputBinding:
      position: 101
  ...
  - id: clean
    ...
    doc: This removes temporary files in the results directory after run. 
      Options are NO or YES (default=YES for remove)
    inputBinding:
      position: 101
      prefix: --clean
  - id: data
    type:
      - 'null'
      - string
    doc: Specify a data-type, i.e. wgs, chromosome, plasmid, etc. (default = NA)
    inputBinding:
      position: 101
      prefix: --data
  - id: data_version
  ...
  - id: input_type
    type:
      - 'null'
      - string
    doc: 'must be one of contig, orf, protein, read (default: contig)'
    inputBinding:
      position: 101
      prefix: --input_type
  - id: loose_criteria
  ...
  - id: num_threads
    type:
      - 'null'
      - int
    doc: Number of threads (CPUs) to use in the BLAST search (default=32)
    inputBinding:
      position: 101
      prefix: --num_threads
  - id: software_version
  ...
  - id: verbose
    type:
      - 'null'
      - string
    doc: log progress to file. Options are OFF or ON (default = OFF for no 
      logging)
    inputBinding:
      position: 101
      prefix: --verbose
