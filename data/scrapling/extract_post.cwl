...
baseCommand:
  ...
  - post
label: extract_post
doc: Perform a POST request and save the content to a file. The output file path
  can be an HTML file, a Markdown file of the HTML content, or the text content 
  itself.
inputs:
  - id: url
    type: string
    doc: URL to perform the POST request on
    inputBinding:
      position: 1
  - id: output_file
    type: string
  ...
  - id: data
    type:
      - 'null'
      - string
    doc: 'Form data to include in the request body (as string, ex: "param1=value1&param2=value2")'
    inputBinding:
      position: 103
      prefix: --data
  - id: json
    type:
      - 'null'
      - string
    doc: JSON data to include in the request body (as string)
    inputBinding:
      position: 103
      prefix: --json
  - id: headers
