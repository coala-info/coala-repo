...
baseCommand:
  - fastqtk
  - trim-3
label: fastqtk_trim-3
doc: "It trims N nucleotides from 3' end of the reads from a FASTQ file. N is a non-zero
  positive integer.\n\nTool homepage: https://github.com/ndaniel/fastqtk"
inputs:
  - id: n
    type: int
    doc: Number of nucleotides to trim from the 3' end
    inputBinding:
      position: 1
  - id: input_fq
    type: File
