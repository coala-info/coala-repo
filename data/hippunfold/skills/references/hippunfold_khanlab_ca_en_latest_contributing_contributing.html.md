...
* Contributing to Hippunfold
  ...
  + [Running code format quality checking and fixing:](#running-code-format-quality-checking-and-fixing)
  + [Dry-run testing your workflow:](#dry-run-testing-your-workflow)
  + [Wet-run testing your workflow:](#wet-run-testing-your-workflow)
  + [Instructions for Compute Canada](#instructions-for-compute-canada)
    - [Setting up a dev environment on graham:](#setting-up-a-dev-environment-on-graham)
    - [Running hippunfold jobs on graham:](#running-hippunfold-jobs-on-graham)
    - [Running hippunfold jobs on the CBS server](#running-hippunfold-jobs-on-the-cbs-server)
  + [Deep learning nnU-net model files](#deep-learning-nnu-net-model-files)
    - [For HippUnfold versions earlier than 1.3.0 (< 1.3.0):](#for-hippunfold-versions-earlier-than-1-3-0-1-3-0)
    - [NEW: For HippUnfold versions 1.3.0 and later (>= 1.3.0):](#new-for-hippunfold-versions-1-3-0-and-later-1-3-0)
  + [Overriding Singularity cache directories](#overriding-singularity-cache-directories)

[HippUnfold Documentation](../index.html)

* Contributing to Hippunfold
* [View page source](../_sources/contributing/contributing.md.txt)

---

# Contributing to Hippunfold[](#contributing-to-hippunfold "Permalink to this heading")
...
HippUnfold also has a number of dependencies outside of python, including popular neuroimaging tools like `wb_command`, `ANTs`, `c3d`, and others listed in https://github.com/khanlab/hippunfold\_deps. Thus we strongly recommend running HippUnfold with the `--use-singularity` flag, which will pull this container automatically and use it when required, unless you are comfortable using all of these tools yourself.
...
## Set-up your development environment:[](#set-up-your-development-environment "Permalink to this heading")
...
## Running code format quality checking and fixing:[](#running-code-format-quality-checking-and-fixing "Permalink to this heading")
...
## Dry-run testing your workflow:[](#dry-run-testing-your-workflow "Permalink to this heading")
...
## Wet-run testing your workflow:[](#wet-run-testing-your-workflow "Permalink to this heading")
...
## Instructions for Compute Canada[](#instructions-for-compute-canada "Permalink to this heading")

This section provides an example of how to set up a `pip installed` copy
of HippUnfold on Compute Canada’s `graham` cluster.

### Setting up a dev environment on graham:[](#setting-up-a-dev-environment-on-graham "Permalink to this heading")
...
4. To avoid having to download trained models (see section [below](#deep-learning-nnu-net-model-files)), you can set an environment variable in your bash profile (~/.bash\_profile) with the location of the
...
### Running hippunfold jobs on graham:[](#running-hippunfold-jobs-on-graham "Permalink to this heading")
...
### Running hippunfold jobs on the CBS server[](#running-hippunfold-jobs-on-the-cbs-server "Permalink to this heading")
...
## Deep learning nnU-net model files[](#deep-learning-nnu-net-model-files "Permalink to this heading")
...
### For HippUnfold versions earlier than 1.3.0 (< 1.3.0):[](#for-hippunfold-versions-earlier-than-1-3-0-1-3-0 "Permalink to this heading")
...
### NEW: For HippUnfold versions 1.3.0 and later (>= 1.3.0):[](#new-for-hippunfold-versions-1-3-0-and-later-1-3-0 "Permalink to this heading")
...
## Overriding Singularity cache directories[](#overriding-singularity-cache-directories "Permalink to this heading")
...
If you are running `hippunfold` with the `--use-singularity` option, hippunfold will download the required singularity containers for rules that require it. These containers are placed in the `.snakemake` folder in your hippunfold output directory, but this can be overriden with the Snakemake option: `--singulari