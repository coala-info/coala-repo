Next: [CDF-5 file format specification](CDF_002d5-file-format-specification.html#CDF_002d5-file-format-specification), Previous: [CDF-1 file format specification](CDF_002d1-file-format-specification.html#CDF_002d1-file-format-specification), Up: [Top](index.html#Top)   [[Index](Combined-Index.html#Combined-Index "Index")]
...
|  |  |  | //For other constraints, see ["Note on names"](#NOTENAMES) below. |
...
|  |  |  | //record. See ["Note on vsize"](#NOTEVSIZE), below. |
...
|  |  |  | //uses variable's fill value. See ["Note on padding"](#NOTEPADDING) below |
|  |  |  | //for a special case. |
| NON\_NEG | = | <non-negative INT> |  |
...
| BYTE | = | <8-bit byte> | //See ["Note on byte data"](#NOTEBYTE) below. |
| CHAR | = | <8-bit byte> | //See ["Note on char data"](#NOTECHAR) below. |
...
|  |  |  | //["Note on fill values"](#NOTEFILL) below. |
...
**Note on streaming data:**The largest possible record count, *2^32 - 1*, is reserved to indicate an indeterminate number of records.
