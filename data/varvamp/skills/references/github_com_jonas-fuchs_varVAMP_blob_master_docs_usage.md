...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fjonas-fuchs%2FvarVAMP%2Fblob%2Fmaster%2Fdocs%2Fusage.md)
...
2. /[docs](/jonas-fuchs/varVAMP/tree/master/docs)
...
[History](/jonas-fuchs/varVAMP/commits/master/docs/usage.md)

History

145 lines (112 loc) · 6.37 KB
...
[Raw](https://github.com/jonas-fuchs/varVAMP/raw/refs/heads/master/docs/usage.md)
...
optional arguments:
  ...
  -th 1, --threads 1            number of threads for BLAST search and deltaG calculations
...
optional arguments:
  ...
  -d -3, --deltaG -3            minimum free energy (kcal/mol/K) cutoff at the lowest primer melting temperature
```
...
#### [Previous: Data preparation](/jonas-fuchs/varVAMP/blob/master/docs/preparing_the_data.md)  [Next: Output](/jonas-fuchs/varVAMP/blob/master/docs/output.md)
