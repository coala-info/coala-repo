...
baseCommand:
  - extract
  - delete
label: extract_delete
doc: Perform a DELETE request and save the content to a file. The output file 
  path can be an HTML file, a Markdown file of the HTML content, or the text 
  content itself. Use file extensions (.html/.md/.txt) respectively.
inputs:
  - id: url
    type: string
    doc: URL to perform the DELETE request on
    inputBinding:
      position: 1
  - id: output_file
    type: string
  ...
  - id: headers
    type:
      ...
      - type: array
        items: string
    doc: 'HTTP headers in format "Key: Value"'
    inputBinding:
      position: 103
      prefix: --headers
  - id: cookies
  ...
  - id: params
    type:
      ...
      - type: array
        items: string
    doc: Query parameters in format "key=value"
    inputBinding:
      position: 103
      prefix: --params
  - id: follow_redirects
