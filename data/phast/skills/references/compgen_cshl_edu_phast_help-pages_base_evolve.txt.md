PROGRAM: base\_evolve
USAGE: base\_evolve [file.hmm] tree1.mod [tree2.mod tree3.mod ...] > alignment
DESCRIPTION:
...
EXAMPLES:
base\_evolve --nsites 500 mytree.mod > simulated.fa
base\_evolve --nsites 500 simple-gene.hmm tree1.mod tree2.mod \
tree3.mod --features simulated2.gff --catmap simple-gene.cm \
> simulated2.fa
OPTIONS:
--nsites, -n
Generate an alignment with  columns. Default is 1000.
...
drawing columns from . A single element is embedded in
