...
inputs:
  ...
  - id: fdr
    type:
      - 'null'
      - float
    doc: FDR cutoff for filtering matches [0.0, 1.0]
    default: 0.05
    inputBinding:
      position: 104
      prefix: --fdr
  ...
  - id: flanking_seq_len
    type:
      - 'null'
      - int
    doc: Length of protospacer flanking sequence to extract for possible PAMs 
      scanning
    default: 10
    inputBinding:
      position: 104
  ...
  - id: fmt
    ...
    doc: "0: short (only matches)\n                                  1: long (matches
      and hits)\n                                  2: long with nucleotide alignment"
    default: 1
    inputBinding:
      position: 104
      prefix: --fmt
  ...
  - id: perform_nucl_aln
    type:
      - 'null'
      - int
    doc: '0: perform only 6-frame translated search, 1:perform additional nucl-nucl
      alignment to the hits reported in 6-frame translated search, and update the
      E-value'
    default: 1
    inputBinding:
      position: 104
      prefix: --perform-nucl-aln
  - id: qid
    type:
      - 'null'
      - float
    doc: Reduce diversity of output MSAs using min.seq. identity with query 
      sequences [0.0,1.0]
    default: 0.0
    inputBinding:
      position: 104
  ...
  - id: rank_min_seq_ids
    ...
    doc: "Comma-separated sequence identity thresholds to restrict ranks to:\nspecies,
      genus, family, order, class, phylum, kingdom, superkingdom"
    default: 0.86,0.84,0.82,0.80,0.78,0.76,0.74,0.72
    inputBinding:
      position: 104
  ...
  - id: report_pam
    type:
      - 'null'
      - int
    doc: Report protospacer adjacent motifs up and downstream of hits
    default: 1
    inputBinding:
      position: 104
      prefix: --report-pam
  - id: rescore_mode
    ...
    inputBinding:
      position: 104
      prefix: --rescore-mode
  - id: restrict_ranks_mode
    type:
      - 'null'
      - int
    doc: '0: disabled, 1: restrict taxonomic rank on target prediction by sequence
      identity'
    default: 1
    inputBinding:
      position: 104
      prefix: --restrict-ranks-mode
  - id: reverse_frames
    type:
      - 'null'
      - string
  ...
  - id: seed_sub_mat
    ...
    default: nucl:nucleotide.out,aa:VTML80.out
    inputBinding:
      position: 104
      prefix: --seed-sub-mat
  - id: sens_steps
  ...
  - id: sub_mat
    ...
    default: nucl:nucleotide.out,aa:VTML40.out
    inputBinding:
      position: 104
      prefix: --sub-mat
  - id: tax_fdr
    type:
      - 'null'
      - float
    doc: FDR cutoff for taxonomy report [0.0, 1.0]
    default: 0.02
    inputBinding:
      position: 104
      prefix: --tax-fdr
