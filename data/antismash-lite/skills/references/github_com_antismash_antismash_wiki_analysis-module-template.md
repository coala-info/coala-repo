...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fantismash%2Fantismash%2Fwiki%2Fanalysis-module-template)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fwiki%2Fshow&source=header-repo&source_repo=antismash%2Fantismash)
...
[antismash](/antismash)
/
**[antismash](/antismash/antismash)**
Public

* [Notifications](/login?return_to=%2Fantismash%2Fantismash) You must be signed in to change notification settings
* [Fork
  76](/login?return_to=%2Fantismash%2Fantismash)
* [Star
   248](/login?return_to=%2Fantismash%2Fantismash)

* [Code](/antismash/antismash)
* [Issues
  20](/antismash/antismash/issues)
* [Pull requests
  9](/antismash/antismash/pulls)
* [Discussions](/antismash/antismash/discussions)
* [Actions](/antismash/antismash/actions)
* [Projects](/antismash/antismash/projects)
* [Wiki](/antismash/antismash/wiki)
* [Security
  0](/antismash/antismash/security)
* [Insights](/antismash/antismash/pulse)

Additional navigation options

* [Code](/antismash/antismash)
* [Issues](/antismash/antismash/issues)
* [Pull requests](/antismash/antismash/pulls)
* [Discussions](/antismash/antismash/discussions)
* [Actions](/antismash/antismash/actions)
* [Projects](/antismash/antismash/projects)
* [Wiki](/antismash/antismash/wiki)
* [Security](/antismash/antismash/security)
* [Insights](/antismash/antismash/pulse)
...
SJShaw edited this page Nov 4, 2025
·
[6 revisions](/antismash/antismash/wiki/Analysis-module-template/_history)

The following is a minimal skeleton of an analysis module, with inline comments used to add extra information for new developers.

Create a directory within `antismash/modules/` with the name of your analysis module (e.g. `antismash/modules/newmodule`, then create `__init__.py` with the following template and fill it in or adjust it to suit. Once there it will automatically be included in available analysis modules.

If a module needs to prepare databases or stores training state, it should also add a `prepare_data` function similar to the [hmm\_detection](https://github.com/antismash/antismash/blob/master/antismash/detection/hmm_detection/__init__.py) or [lanthipeptide](https://github.com/antismash/antismash/blob/master/antismash/modules/lanthipeptides/__init__.py) modules. Similarly, if the module has HTML output, then any of the modules with an `html_output.py` will be useful examples (e.g. [lanthipeptide](https://github.com/antismash/antismash/blob/master/antismash/modules/lanthipeptides/html_output.py) again).
