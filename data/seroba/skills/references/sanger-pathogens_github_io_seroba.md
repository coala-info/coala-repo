...
[View on GitHub](https://github.com/sanger-pathogens/seroba)
...
In the folder ‘prefix’ you will find a pred.tsv including your predicted serotype as well as a file called detailed\_serogroup\_info.txt including information about SNP, genes, and alleles that are found in your reads. After the use of “seroba summary” a tsv file called summary.tsv is created that consists of three columns (sample Id , serotype, comments). Serotypes that do not match any reference are marked as “untypable”(v0.1.3).

**detailed\_serogroup\_info example:**
...
* Case 2:
  + Low alignment identity in the ‘detailed\_serogroup\_info’ file. This can
...
[seroba](https://github.com/sanger-pathogens/seroba) is maintained by [sanger-pathogens](https://github.com/sanger-pathogens).
