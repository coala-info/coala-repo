# Code example from 'MIGSA' vignette. See references/ for full tutorial.

### R code from vignette source 'MIGSA.Rnw'
### Encoding: UTF-8

###################################################
### code chunk number 1: MIGSA.Rnw:133-137 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 2: MIGSA.Rnw:183-199
###################################################
library(GSEABase);
...
###################################################
### code chunk number 3: MIGSA.Rnw:212-222 (eval = FALSE)
###################################################
## ## Not run:
## 
...
###################################################
### code chunk number 9: MIGSA.Rnw:495-517
###################################################
...
###################################################
### code chunk number 15: MIGSA.Rnw:736-756
###################################################
## As last chunk of code was not executed, we load that data:
library(MIGSA);
library(MIGSAdata);
...
###################################################
### code chunk number 17: MIGSA.Rnw:777-781
###################################################
...
###################################################
### code chunk number 20: MIGSA.Rnw:804-809
###################################################
# it is the same code as below, but saving the pdf to correctly load it in tex
...
###################################################
### code chunk number 23: MIGSA.Rnw:847-851
###################################################
# it is the same code as below, but saving the pdf to correctly load it in tex
...
###################################################
### code chunk number 25: MIGSA.Rnw:862-866
###################################################
# it is the same code as below, but saving the pdf to correctly load it in tex
...
###################################################
### code chunk number 27: MIGSA.Rnw:875-879
###################################################
# it is the same code as below, but saving the pdf to correctly load it in tex
...
###################################################
### code chunk number 30: MIGSA.Rnw:901-905
###################################################
# it is the same code as below, but saving the pdf to correctly load it in tex
