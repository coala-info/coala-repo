...
baseCommand:
  - tooldistillator.py
  - polypolish
label: tooldistillator_polypolish
doc: "Extract information from output(s) of polypolish (contig.fasta)\n\nTool homepage:
...
inputs:
  ...
  - id: analysis_software_version
    type:
      - 'null'
      - string
    doc: polypolish version number for polypolish
    inputBinding:
      position: 102
  ...
  - id: hid
    type:
      - 'null'
      - string
    doc: Historic ID to polypolish contigs file from Galaxy for polypolish
    inputBinding:
      position: 102
      prefix: --hid
