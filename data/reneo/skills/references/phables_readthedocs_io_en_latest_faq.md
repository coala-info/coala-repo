...
* FAQ
  + [General FAQs](#general-faqs)
    - [Q1: Where can I get help with issues?](#q1-where-can-i-get-help-with-issues)
    - [Q2: Can I use the assembly graph from any assembler?](#q2-can-i-use-the-assembly-graph-from-any-assembler)
    - [Q4: What can I do after running Phables?](#q4-what-can-i-do-after-running-phables)
    - [Q5: How can I find out which contigs were included in the resolved phages?](#q5-how-can-i-find-out-which-contigs-were-included-in-the-resolved-phages)
    - [Q6: Can I run Phables on mixed-microbial communities?](#q6-can-i-run-phables-on-mixed-microbial-communities)
    - [Q7: Can Phables identify prophages?](#q7-can-phables-identify-prophages)
  + [Gurobi FAQs](#gurobi-faqs)
    - [Q1: Gurobi installation conflicts and grbgetkey fails to run](#q1-gurobi-installation-conflicts-and-grbgetkey-fails-to-run)
    - [Q2: Model too large for size-limited license](#q2-model-too-large-for-size-limited-license)
    - [Q3: HostID mismatch](#q3-hostid-mismatch)
    - [Q4: License not valid for Gurobi version x](#q4-license-not-valid-for-gurobi-version-x)
    - [Q5: How can I get a Gurobi license for a cluster?](#q5-how-can-i-get-a-gurobi-license-for-a-cluster)
...
* RUNNING
* FAQ
* [Edit on GitHub](https://github.com/Vini2/phables/edit/master/docs/faq.md)
...
| --- | --- | --- | --- | --- | --- |
| phage\_comp\_0\_cycle\_1 | case3 | 644 | 45659 | 34.86059703453864 | ['49-', '5524+', '24979-', '5556+', '55+', '5540-', '67+', '4490+', '5554-'] |
| phage\_comp\_0\_cycle\_2 | case3 | 625 | 43427 | 35.03810993160937 | ['49-', '5522+', '24979-', '5558+', '55+', '65+', '67+', '4490+', '5498-'] |
| ... |  |  |  |  |  |
