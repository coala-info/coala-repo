...
### Tool Description
Stress test the system's CPU, memory, I/O, and other subsystems.
...
### Original Help Text
```text
stress-ng, version 0.12.04 (gcc 9.3, x86_64 Linux 6.8.0-100-generic)
...
-y N, --yield N            start N workers doing sched_yield() calls
      ...
      --zlib-stream-bytes Sspecify the number of bytes to deflate until the current stream will be closed
