...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fbioforensics%2FlusSTR)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E&source=header-repo&source_repo=bioforensics%2FlusSTR)
...
/
**[lusSTR](/bioforensics/lusSTR)**
Public

* [Notifications](/login?return_to=%2Fbioforensics%2FlusSTR) You must be signed in to change notification settings
* [Fork
  0](/login?return_to=%2Fbioforensics%2FlusSTR)
* [Star
   6](/login?return_to=%2Fbioforensics%2FlusSTR)

* [Code](/bioforensics/lusSTR)
* [Issues
  1](/bioforensics/lusSTR/issues)
* [Pull requests
  2](/bioforensics/lusSTR/pulls)
* [Actions](/bioforensics/lusSTR/actions)
* [Projects](/bioforensics/lusSTR/projects)
* [Security
  0](/bioforensics/lusSTR/security)
* [Insights](/bioforensics/lusSTR/pulse)

Additional navigation options

* [Code](/bioforensics/lusSTR)
* [Issues](/bioforensics/lusSTR/issues)
* [Pull requests](/bioforensics/lusSTR/pulls)
* [Actions](/bioforensics/lusSTR/actions)
* [Projects](/bioforensics/lusSTR/projects)
* [Security](/bioforensics/lusSTR/security)
* [Insights](/bioforensics/lusSTR/pulse)
...
[Branches](/bioforensics/lusSTR/branches)[Tags](/bioforensics/lusSTR/tags)
...
| --- | --- | --- | --- | --- |
| Latest commit   History[91 Commits](/bioforensics/lusSTR/commits/master/)   91 Commits | | |
| [.github/workflows](/bioforensics/lusSTR/tree/master/.github/workflows "This path skips through empty directories") | | [.github/workflows](/bioforensics/lusSTR/tree/master/.github/workflows "This path skips through empty directories") |  |  |
| [lusSTR](/bioforensics/lusSTR/tree/master/lusSTR "lusSTR") | | [lusSTR](/bioforensics/lusSTR/tree/master/lusSTR "lusSTR") |  |  |
| [.coveragerc](/bioforensics/lusSTR/blob/master/.coveragerc ".coveragerc") | | [.coveragerc](/bioforensics/lusSTR/blob/master/.coveragerc ".coveragerc") |  |  |
| [.gitattributes](/bioforensics/lusSTR/blob/master/.gitattributes ".gitattributes") | | [.gitattributes](/bioforensics/lusSTR/blob/master/.gitattributes ".gitattributes") |  |  |
| [.gitignore](/bioforensics/lusSTR/blob/master/.gitignore ".gitignore") | | [.gitignore](/bioforensics/lusSTR/blob/master/.gitignore ".gitignore") |  |  |
| [LICENSE.txt](/bioforensics/lusSTR/blob/master/LICENSE.txt "LICENSE.txt") | | [LICENSE.txt](/bioforensics/lusSTR/blob/master/LICENSE.txt "LICENSE.txt") |  |  |
| [MANIFEST.in](/bioforensics/lusSTR/blob/master/MANIFEST.in "MANIFEST.in") | | [MANIFEST.in](/bioforensics/lusSTR/blob/master/MANIFEST.in "MANIFEST.in") |  |  |
| [Makefile](/bioforensics/lusSTR/blob/master/Makefile "Makefile") | | [Makefile](/bioforensics/lusSTR/blob/master/Makefile "Makefile") |  |  |
| [README.md](/bioforensics/lusSTR/blob/master/README.md "README.md") | | [README.md](/bioforensics/lusSTR/blob/master/README.md "README.md") |  |  |
| [pytest.ini](/bioforensics/lusSTR/blob/master/pytest.ini "pytest.ini") | | [pytest.ini](/bioforensics/lusSTR/blob/master/pytest.ini "pytest.ini") |  |  |
| [setup.cfg](/bioforensics/lusSTR/blob/master/setup.cfg "setup.cfg") | | [setup.cfg](/bioforensics/lusSTR/blob/master/setup.cfg "setup.cfg") |  |  |
| [setup.py](/bioforensics/lusSTR/blob/master/setup.py "setup.py") | | [setup.py](/bioforensics/lusSTR/blob/master/setup.py "setup.py") |  |  |
| [versioneer.py](/bioforensics/lusSTR/blob/master/versioneer.py "versioneer.py") | | [versioneer.py](/bioforensics/lusSTR/blob/master/versioneer.py "versioneer.py") |  |  |
| View all files | | |
...
**analysis\_software**: `uas` (`uas/straitrazor/genemarker`); indicates the analysis software used prior to lusSTR
**sex**: `False` (True/False); include sex-chromosome STRs (invoke `--sex` flag)
**samp\_input**: `/path/to/input/directory/or/samples` input directory or sample; if not provided, will be current working directory (indicate using `--input path/to/dir` )
...
**output\_type**: `strmix` (strmix/efm/mpsproto) (indicate using the `--software` flag)
**profile\_type**: `evidence` (evidence/reference) (invoke `--reference` flag if creating a reference output file)
**data\_type**: `ngs` (ce/ngs/lusplus) (indicate using the `--str-type`)
**info**: `True` (True/False); create allele information file (invoke `--noinfo` flag to not create the allele information file)
**separate**: `False` (True/False); for EFM/MPSproto only, if True will create individual files for samples; if False, will create one file with all samples (