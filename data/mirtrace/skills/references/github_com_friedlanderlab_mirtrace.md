...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Ffriedlanderlab%2Fmirtrace)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E&source=header-repo&source_repo=friedlanderlab%2Fmirtrace)
...
# friedlanderlab/mirtrace

master

[Branches](/friedlanderlab/mirtrace/branches)[Tags](/friedlanderlab/mirtrace/tags)
...
| --- | --- | --- | --- | --- |
| Latest commit   History[42 Commits](/friedlanderlab/mirtrace/commits/master/)   42 Commits | | |
| [images](/friedlanderlab/mirtrace/tree/master/images "images") | | [images](/friedlanderlab/mirtrace/tree/master/images "images") |  |  |
| [release-bundle-includes](/friedlanderlab/mirtrace/tree/master/release-bundle-includes "release-bundle-includes") | | [release-bundle-includes](/friedlanderlab/mirtrace/tree/master/release-bundle-includes "release-bundle-includes") |  |  |
| [src](/friedlanderlab/mirtrace/tree/master/src "src") | | [src](/friedlanderlab/mirtrace/tree/master/src "src") |  |  |
| [.classpath](/friedlanderlab/mirtrace/blob/master/.classpath ".classpath") | | [.classpath](/friedlanderlab/mirtrace/blob/master/.classpath ".classpath") |  |  |
| [.gitignore](/friedlanderlab/mirtrace/blob/master/.gitignore ".gitignore") | | [.gitignore](/friedlanderlab/mirtrace/blob/master/.gitignore ".gitignore") |  |  |
| [.project](/friedlanderlab/mirtrace/blob/master/.project ".project") | | [.project](/friedlanderlab/mirtrace/blob/master/.project ".project") |  |  |
| [CHANGELOG](/friedlanderlab/mirtrace/blob/master/CHANGELOG "CHANGELOG") | | [CHANGELOG](/friedlanderlab/mirtrace/blob/master/CHANGELOG "CHANGELOG") |  |  |
| [README.md](/friedlanderlab/mirtrace/blob/master/README.md "README.md") | | [README.md](/friedlanderlab/mirtrace/blob/master/README.md "README.md") |  |  |
| [mirtrace](/friedlanderlab/mirtrace/blob/master/mirtrace "mirtrace") | | [mirtrace](/friedlanderlab/mirtrace/blob/master/mirtrace "mirtrace") |  |  |
| [pom.xml](/friedlanderlab/mirtrace/blob/master/pom.xml "pom.xml") | | [pom.xml](/friedlanderlab/mirtrace/blob/master/pom.xml "pom.xml") |  |  |
| View all files | | |
...
[![miRTrace logo](/friedlanderlab/mirtrace/raw/master/images/logo.png)](/friedlanderlab/mirtrace/blob/master/images/logo.png)
...
[![Video tutorial](/friedlanderlab/mirtrace/raw/master/images/tutorial_snap.png)](https://friedlanderlab.org/html/mirtrace-video-tutorial.mp4)

## Clades identified by miRTrace

[![](/friedlanderlab/mirtrace/raw/master/images/species_tree.png)](/friedlanderlab/mirtrace/blob/master/images/species_tree.png)

Above is the species tree of the 14 clades with unscaled branches.

## License

See [release-bundle-includes/LICENCE](/friedlanderlab/mirtrace/blob/master/release-bundle-includes/LICENCE)

## Manual

The [miRTrace manual](/friedlanderlab/mirtrace/blob/master/release-bundle-includes/doc/manual/mirtrace_manual.pdf).
