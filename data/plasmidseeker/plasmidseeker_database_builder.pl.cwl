...
inputs:
  - id: blacklist_fasta
    type:
      - 'null'
      - File
    doc: Optional blacklist FASTA file (e.g., human or bacterial genome) to 
      filter out common k-mers
    inputBinding:
      position: 101
      prefix: -b
  - id: input_fasta
    ...
    inputBinding:
      position: 101
      prefix: -i
  - id: database_dir_path
    type: string
    doc: Output or path parameter `database_dir_path`
    inputBinding:
      position: 102
      prefix: --database-dir
outputs:
