...
baseCommand: perl
label: perl-unicode-normalize_perl
doc: "The Perl 5 language interpreter\n\nTool homepage: http://metacpan.org/pod/Unicode::Normalize"
inputs:
  - id: program_file
    type:
      - 'null'
...
hints:
  - class: DockerRequirement
    dockerPull: quay.io/biocontainers/perl-unicode-normalize:1.26--pl5321h9948957_7
stdout: perl-unicode-normalize_perl.out
