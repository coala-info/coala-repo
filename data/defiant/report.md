...
### Metadata
- **Docker Image**: quay.io/biocontainers/defiant:1.1.4--h7b50bb2_6
- **Homepage**: https://github.com/hhg7/defiant
- **Package**: https://anaconda.org/channels/bioconda/packages/defiant/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/defiant/overview
- **Total Downloads**: 6.7K
- **Last updated**: 2025-04-22
- **GitHub**: https://github.com/hhg7/defiant
- **Stars**: N/A
### Original Help Text
```text
...
Differential methylation: Easy, Fast, Identification and ANnoTation
 ...
 by David E. Condon, University of Pennsylvania, 2015-2019.


"--help" isn't a recognized option.
Help for DEFIANT
...
[1m-heatmap[0m	Make heatmap.  Requires R be available from command line, and that `library(gplots)` will work.
...
[1m-r[0m	Minimum nucleotide range, which accepts a non-negative integer.  Default range is 1 nucleotide.
...
[1m-v[0m	Print a p-value & FDR-adjusted p-value for each DMR. This option accepts the same arguments that the '-FDR' option does.

[1m-version[0m	Print Defiant's version.

[1m-x[0m	This option accepts a string which will become the x-axis in figures.  "-x" activates "-f" option and requires an R installation.
...
[1mExample[0m:	chr1.762	chr1	762	R	100	17.64	82.36
...
[1mInput Type 5[0m	Bismark bismark2bedGraph format:
<chromosome> <position> <strand> <count methylated> <count unmethylated> <C-context> <trinucleotide context>//Bismark coverage2cytosine format (https://rawgit.com/FelixKrueger/Bismark/master/Docs/Bismark_User_Guide.html)
...
[1mExample[0m:	chr1	762	763	0.223684	17	76
Column1:	chromosome, which is a string
...
[1mExample[0m:	X	762	763	10.96	1918	762	763	180,60,0	0	0
Column1:	chromosome, which is a string.
...
[1mInput Type 11[0m	 BSSeeker https://github.com/BSSeeker/BSseeker2
[1mExample[0m:	chr1	C	3001631	CG	CG	1.0	5	5
Column1:	chromosome, which is a string.
