# Galaxy Amber Protein MD Setup tutorial CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://mmb.irbbarcelona.org/biobb/
- **Package**: https://workflowhub.eu/workflows/297
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/297/ro_crate?version=3
- **Conda**: N/A
...
- **Main workflow (WorkflowHub):** `biobb_wf_amber_md_setup.ga` (Main Workflow)
...
- **Discussion / source**: https://biobb.usegalaxy.es/u/gbayarri/w/amber-protein-md-setup
- **Discussion / source**: https://biobb-wf-amber-md-setup.readthedocs.io/en/latest/mdsetup_tutorial.html
