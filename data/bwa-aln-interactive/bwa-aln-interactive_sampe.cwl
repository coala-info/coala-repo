...
baseCommand:
  - bwa
  - sampe
label: bwa-aln-interactive_sampe
doc: "Generate alignments in the SAM format given single-end alignments for paired-end
...
inputs:
  ...
  - id: sai_file1
    type: File
    doc: Alignment file for the first read
    inputBinding:
      position: 2
  - id: sai_file2
    type: File
    doc: Alignment file for the second read
    inputBinding:
      position: 3
  - id: fastq_file1
    type: File
