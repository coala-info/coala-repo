# MGnify's amplicon pipeline v5.0 - ITS CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://training.galaxyproject.org
- **Package**: https://workflowhub.eu/workflows/1856
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1856/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 218
...
- **Main workflow (WorkflowHub):** `mgnify-amplicon-pipeline-v5-its.ga` (Main Workflow)
