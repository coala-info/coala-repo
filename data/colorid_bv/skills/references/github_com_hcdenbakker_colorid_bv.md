...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fhcdenbakker%2Fcolorid_bv)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E&source=header-repo&source_repo=hcdenbakker%2Fcolorid_bv)
...
# hcdenbakker/colorid\_bv

master

[Branches](/hcdenbakker/colorid_bv/branches)[Tags](/hcdenbakker/colorid_bv/tags)
...
| --- | --- | --- | --- | --- |
| Latest commit   History[31 Commits](/hcdenbakker/colorid_bv/commits/master/)   31 Commits | | |
| [refs](/hcdenbakker/colorid_bv/tree/master/refs "refs") | | [refs](/hcdenbakker/colorid_bv/tree/master/refs "refs") |  |  |
| [scripts](/hcdenbakker/colorid_bv/tree/master/scripts "scripts") | | [scripts](/hcdenbakker/colorid_bv/tree/master/scripts "scripts") |  |  |
| [src](/hcdenbakker/colorid_bv/tree/master/src "src") | | [src](/hcdenbakker/colorid_bv/tree/master/src "src") |  |  |
| [Cargo.toml](/hcdenbakker/colorid_bv/blob/master/Cargo.toml "Cargo.toml") | | [Cargo.toml](/hcdenbakker/colorid_bv/blob/master/Cargo.toml "Cargo.toml") |  |  |
| [README.md](/hcdenbakker/colorid_bv/blob/master/README.md "README.md") | | [README.md](/hcdenbakker/colorid_bv/blob/master/README.md "README.md") |  |  |
| [ref\_file\_example.txt](/hcdenbakker/colorid_bv/blob/master/ref_file_example.txt "ref_file_example.txt") | | [ref\_file\_example.txt](/hcdenbakker/colorid_bv/blob/master/ref_file_example.txt "ref_file_example.txt") |  |  |
| View all files | | |
...
## Classifying reads with read\_id

This subcommand uses a simple majority-rule algorithm to classify reads, and the results can be used with the read\_filter subcommand to either create a read file for a specific taxon, or filter a specific taxon from a read file.
...
OPTIONS:
    ...
    -d, --down_sample <down_sample>    down-sample k-mers used for read classification, default 1;