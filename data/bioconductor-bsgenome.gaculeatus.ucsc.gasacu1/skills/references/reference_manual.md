...
Full genome sequences for Gasterosteus aculeatus (UCSC version
gasAcu1)

Description

Full genome sequences for Gasterosteus aculeatus (Stickleback) as provided by UCSC (gasAcu1,
Feb. 2006) and stored in Biostrings objects.

Note

This BSgenome data package was made from the following source data files:

chromFa.tar.gz from http://hgdownload.cse.ucsc.edu/goldenPath/gasAcu1/bigZips/
...
txdb <- makeTranscriptDbFromUCSC("gasAcu1", "refGene")
gn <- sort(genes(txdb))
...
BSgenome, 1
BSgenome.Gaculeatus.UCSC.gasAcu1, 1
BSgenome.Gaculeatus.UCSC.gasAcu1-package
