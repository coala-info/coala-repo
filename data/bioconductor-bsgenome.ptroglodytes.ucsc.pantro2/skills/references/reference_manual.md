...
chromFa.tar.gz from http://hgdownload.cse.ucsc.edu/goldenPath/panTro2/bigZips/
...
txdb <- makeTranscriptDbFromUCSC("panTro2", "refGene")
gn <- sort(genes(txdb))
...
BSgenome.Ptroglodytes.UCSC.panTro2-package
