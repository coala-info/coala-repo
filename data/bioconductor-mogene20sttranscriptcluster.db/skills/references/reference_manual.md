...
mogene20sttranscriptclusterACCNUM is an R object that contains mappings between a manufac-
...
## Bimap interface:
x <- mogene20sttranscriptclusterACCNUM
...
mogene20sttranscriptclusterALIAS2PROBE
...
mogene20sttranscriptclusterALIAS is an R object that provides mappings between common gene
...
xx <- as.list(mogene20sttranscriptclusterALIAS2PROBE)
if(length(xx) > 0){
...
Welcome to the mogene20sttranscriptcluster.db annotation Package. The purpose of this package
is to provide detailed information about the mogene20sttranscriptcluster platform. This package is
updated biannually.
Objects in this package are accessed using the select() interface. See ?select in the AnnotationDbi
package for details.

mogene20sttranscriptclusterCHR
...
mogene20sttranscriptclusterCHR is an R object that provides mappings between a manufacturer
...
## Bimap interface:
x <- mogene20sttranscriptclusterCHR
...
mogene20sttranscriptclusterCHRLOC
...
mogene20sttranscriptclusterCHRLENGTHS

A named vector for the length of each of the chromosomes

Description

mogene20sttranscriptclusterCHRLENGTHS provides the length measured in base pairs for each of
the chromosomes.
...
## Bimap interface:
tt <- mogene20sttranscriptclusterCHRLENGTHS
...
mogene20sttranscriptclusterCHRLOC is an R object that maps manufacturer identifiers to the start-
...
mogene20sttranscriptclusterENSEMBL
...
## Bimap interface:
x <- mogene20sttranscriptclusterCHRLOC
...
mogene20sttranscriptclusterENSEMBL is an R object that contains mappings between manufac-
...
mogene20sttranscriptclusterENTREZID
...
x <- mogene20sttranscriptclusterENSEMBL2PROBE
mapped_genes <- mappedkeys(x)
# Convert to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
mogene20sttranscriptclusterENTREZID is an R object that provides mappings between manufac-
turer identifiers and Entrez Gene identifiers.

mogene20sttranscriptclusterENZYME
...
mogene20sttranscriptclusterENZYME is an R object that provides mappings between manufacturer
identifiers and EC numbers. mogene20sttranscriptclusterENZYME2PROBE is an R object that
...
When the mogene20sttranscriptclusterENZYME maping viewed as a list, each manufacturer identi-
...
For the mogene20sttranscriptclusterENZYME2PROBE, each EC number maps to a named vector
...
bers. In mogene20sttranscriptclusterENZYME2PROBE, EC is dropped from the Enzyme Commis-
sion numbers.
...
## Bimap interface:
x <- mogene20sttranscriptclusterENZYME
...
mogene20sttranscriptclusterGENENAME
...
# Now convert mogene20sttranscriptclusterENZYME2PROBE to a list to see inside
x <- mogene20sttranscriptclusterENZYME2PROBE
mapped_probes <- mappedkeys(x)
## convert to a list
xx <- as.list(x[mapped_probes][1:3])
if(length(xx) > 0){
...
mogene20sttranscriptclusterGENENAME is an R object that maps manufacturer identifiers to the
...
## Bimap interface:
x <- mogene20sttranscriptclusterGENENAME
# Get the probe identifiers that are mapped to a gene name
mapped_probes <- mappedkeys(x)

10

mogene20sttranscriptclusterGO
...
mogene20sttranscriptclusterGO is an R object that provides mappings between manufacturer iden-
tifiers and the GO identifiers that they are directly associated with. This mapping and its reverse
mapping (mogene20sttranscriptclusterGO2PROBE) do NOT associate the child terms from the GO
ontology with the gene. Only the directly evidenced terms are represented here.

mogene20sttranscriptclusterGO2ALLPROBES is an R object that provides mappings between a
...
than mogene20sttranscriptclusterGO2PROBE.

Details

If mogene20sttranscriptclusterGO is cast as a list, each manufacturer identifier is mapped to a list
...
If mogene20sttranscriptclusterGO2ALLPROBES or mogene20sttranscriptclusterGO2PROBE is cast
...
• mogene20sttranscriptclusterGO2ALLPROBES
• AnnotationDb-class for use of the select() interface.
...
# For the reverse map:
x <- mogene20sttranscriptclusterGO2PROBE
mapped_genes <- mappedkeys(x)
# Convert to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
mogene20sttranscriptclusterMGI

x <- mogene20sttranscriptclusterGO2ALLPROBES
mapped_genes <- mappedkeys(x)
# Convert mogene20sttranscriptclusterGO2ALLPROBES to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
mogene20sttranscriptclusterMAPCOUNTS

Number of mapped keys
gene20sttranscriptcluster.db
...
mogene20sttranscriptclusterMAPCOUNTS provides the "map count" (i.e.
keys) for each map in package mogene20sttranscriptcluster.db.
...
mogene20sttranscriptclusterMGI is an R object that contains mappings between manufacturer iden-
...
mogene20sttranscriptclusterORGANISM
...
## Bimap interface:
x <- mogene20sttranscriptclusterMGI
...
x <- mogene20sttranscriptclusterMGI2PROBE
mapped_genes <- mappedkeys(x)
# Convert to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
The Organism information for mogene20sttranscriptcluster

Description

mogene20sttranscriptclusterORGANISM is an R object that contains a single item: a character
string that names the organism for which mogene20sttranscriptcluster was built. mogene20sttranscriptclusterORGPKG
...
Although the package name is suggestive of the organism for which it was built, mogene20sttranscriptclusterORGANISM
provides a simple way to programmatically extract the organism name. mogene20sttranscriptclusterORGPKG
...
mogene20sttranscriptclusterPATH
...
## Bimap interface:
mogene20sttranscriptclusterORGANISM
mogene20sttranscriptclusterORGPKG
...
mogene20sttranscriptclusterPATH maps probe identifiers to the identifiers used by KEGG for path-
ways in which the genes represented by the probe identifiers are involved

mogene20sttranscriptclusterPATH2PROBE is an R object that provides mappings between KEGG
...
mogene20sttranscriptclusterPFAM
...
## Bimap interface:
x <- mogene20sttranscriptclusterPATH
...
x <- mogene20sttranscriptclusterPATH
mapped_probes <- mappedkeys(x)
# Now convert the mogene20sttranscriptclusterPATH2PROBE object to a list
xx <- as.list(x[mapped_probes][1:300])
if(length(xx) > 0){
...
mogene20sttranscriptclusterPFAM is an R object that provides mappings between manufacturer
...
mogene20sttranscriptclusterPMID

Maps between Manufacturer Identifiers and PubMed Identifiers

Description

mogene20sttranscriptclusterPMID is an R object that provides mappings between manufacturer
identifiers and PubMed identifiers. mogene20sttranscriptclusterPMID2PROBE is an R object that
...
When mogene20sttranscriptclusterPMID is viewed as a list each manufacturer identifier is mapped
...
When mogene20sttranscriptclusterPMID2PROBE is viewed as a list each PubMed identifier is
...
## Bimap interface:
x <- mogene20sttranscriptclusterPMID
...
x <- mogene20sttranscriptclusterPMID2PROBE
mapped_probes <- mappedkeys(x)
# Now convert the reverse map object mogene20sttranscriptclusterPMID2PROBE to a list
xx <- as.list(x[mapped_probes][1:300])

mogene20sttranscriptclusterPROSITE
...
mogene20sttranscriptclusterPROSITE is an R object that provides mappings between manufacturer
...
mogene20sttranscriptclusterREFSEQ

Map between Manufacturer Identifiers and RefSeq Identifiers

Description

mogene20sttranscriptclusterREFSEQ is an R object that provides mappings between manufacturer
...
mogene20sttranscriptclusterSYMBOL
...
## Bimap interface:
x <- mogene20sttranscriptclusterREFSEQ
...
mogene20sttranscriptclusterSYMBOL is an R object that provides mappings between manufacturer
identifiers and gene abbreviations.

mogene20sttranscriptclusterUNIPROT
...
mogene20sttranscriptclusterUNIPROT is an R object that contains mappings between the manufac-
...
mogene20sttranscriptcluster_dbconn
...
## Bimap interface:
x <- mogene20sttranscriptclusterUNIPROT
...
mogene20sttranscriptcluster_dbconn()
mogene20sttranscriptcluster_dbfile()
mogene20sttranscriptcluster_dbschema(file="", show.indices=FALSE)
...
mogene20sttranscriptcluster_dbconn returns a connection object to the package annotation
DB. IMPORTANT: Don’t call dbDisconnect on the connection object returned by mogene20sttranscriptcluster_dbconn
or you will break all the AnnDbObj objects defined in this package!
mogene20sttranscriptcluster_dbfile returns the path (character string) to the package anno-
...
mogene20sttranscriptcluster_dbschema prints the schema definition of the package annotation
DB.
mogene20sttranscriptcluster_dbInfo prints other information about the package annotation
DB.

Value

mogene20sttranscriptcluster_dbconn: a DBIConnection object representing an open connec-
tion to the package annotation DB.
mogene20sttranscriptcluster_dbfile: a character string with the path to the package annota-
tion DB.
mogene20sttranscriptcluster_dbschema: none (invisible NULL).
mogene20sttranscriptcluster_dbInfo: none (invisible NULL).
...
dbGetQuery(mogene20sttranscriptcluster_dbconn(), "SELECT COUNT(*) FROM probes")
...
mogene20sttranscriptcluster.db, 2
mogene20sttranscriptcluster_dbconn,
...
mogene20sttranscriptclusterCHR, 3
mogene20sttranscriptclusterCHRLENGTHS,
...
mogene20sttranscriptclusterGO, 10
mogene20sttranscriptclusterMAPCOUNTS,

12

mogene20sttranscriptclusterMGI, 12
mogene20sttranscriptclusterORGANISM,
...
mogene20sttranscriptcluster.db, 2
mogene20sttranscriptcluster_dbconn, 20
mogene20sttranscriptcluster_dbfile
...
mogene20sttranscriptclusterACCNUM, 1
mogene20sttranscriptclusterALIAS2PROBE,
...
mogene20sttranscriptclusterCHRLOC, 4
mogene20sttranscriptclusterCHRLOCEND

(mogene20sttranscriptclusterCHRLOC),
4

mogene20sttranscriptclusterENSEMBL, 5
mogene20sttranscriptclusterENSEMBL2PROBE

(mogene20sttranscriptclusterENSEMBL),
5

mogene20sttranscriptclusterENTREZID, 6

INDEX

23

mogene20sttranscriptclusterENZYME, 7
mogene20sttranscriptclusterENZYME2PROBE

(mogene20sttranscriptclusterENZYME),
7

mogene20sttranscriptclusterGENENAME, 9
mogene20sttranscriptclusterGO, 10
mogene20sttranscriptclusterGO2ALLPROBES,
...
mogene20sttranscriptclusterGO2PROBE

(mogene20sttranscriptclusterGO),
10

mogene20sttranscriptclusterLOCUSID
...
mogene20sttranscriptclusterMGI, 12
mogene20sttranscriptclusterMGI2PROBE
...
mogene20sttranscriptclusterPATH, 14
mogene20sttranscriptclusterPATH2PROBE

(mogene20sttranscriptclusterPATH),
14

mogene20sttranscriptclusterPFAM, 15
mogene20sttranscriptclusterPMID, 15
mogene20sttranscriptclusterPMID2PROBE

(mogene20sttranscriptclusterPMID),
15

mogene20sttranscriptclusterPROSITE, 17
mogene20sttranscriptclusterREFSEQ, 17
mogene20sttranscriptclusterSYMBOL, 18
mogene20sttranscriptclusterUNIPROT, 19
mogene20sttranscriptclusterUNIPROT2PROBE
