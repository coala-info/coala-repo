...
FATAL:   Unable to handle docker://quay.io/biocontainers/rappas:1.22--hdfd78af_0 uri: while building SIF from layers: conveyor failed to get: invalid character '}' after top-level value
```
