...
`pp-sketchlib `\_\_ to rapidly calculate
...
the old API (``--assign-query``, ``--refine-fit`` etc) see `v2.2.0 `\_\_.
For older versions which used mash, see `v1.2.0 `\_\_.
.. toctree::
:maxdepth: 1
:caption: Contents:
self
...
qc.rst
model\_fitting.rst
model\_distribution.rst
query\_assignment.rst
visualisation.rst
mst.rst
subclustering.rst
gpu.rst
