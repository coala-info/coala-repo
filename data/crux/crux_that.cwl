...
doc: "crux supports the following primary commands:\n\n  bullseye                \
  ...
  \                           then exit.\n  psm-convert              Reads in a file
  containing peptide-spectrum matches\n                           (PSMs) in one of
  the variety of supported formats\n                           and outputs the same
  PSMs in a different format\n  subtract-index           This command takes two peptide
  indices, created by\n                           the tide-index command, and subtracts
  the second\n                           index from the first. The result is an output
  index\n                           that contains peptides that appear in the first\n\
  \                           index but not the second.\n  xlink-assign-ions     \
  \   Given a spectrum and a pair of cross-linked\n                           peptides,
  assign theoretical ion type labels to\n                           peaks in the observed
