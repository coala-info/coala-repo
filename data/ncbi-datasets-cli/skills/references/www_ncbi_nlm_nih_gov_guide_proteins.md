...
[Conserved Domain Database (CDD)](/cdd)
...
[Protein Family Models](/protfam)
:   Protein Family Models is a collection of models representing homologous proteins with a common function. It includes conserved domain architecture, hidden Markov models and BlastRules. A subset of these models are used by the Prokaryotic Genome Annotation Pipeline ([PGAP](https://www.ncbi.nlm.nih.gov/genome/annotation_prok/)) to assign names and other attributes to predicted proteins.

[Reference Sequence (RefSeq)](/RefSeq/)
...
[FTP: BLAST Databases](https://ftp.ncbi.nlm.nih.gov/blast/db/)
...
[FTP: CDD](https://ftp.ncbi.nlm.nih.gov/pub/mmdb/cdd/)
...
[FTP: FASTA BLAST Databases](https://ftp.ncbi.nlm.nih.gov/blast/db/FASTA)
...
[FTP: GenPept](https://ftp.ncbi.nlm.nih.gov/ncbi-asn1/protein_fasta/)
...
[FTP: RefSeq](https://ftp.ncbi.nlm.nih.gov/refseq/release/)
...
[Batch Entrez](/sites/batchentrez)
...
[COBALT](/tools/cobalt/re_cobalt.cgi)
...
[Cn3D](/Structure/CN3D/cn3d.shtml)
...
[Conserved Domain Search Service (CD Search)](/Structure/cdd/wrpsb.cgi)
...
[ProSplign](/sutils/static/prosplign/prosplign.html)
...
* [Retrieve all sequences for an organism or taxon](/guide/howto/retrieve-seq-org)
* [Find the function of a gene or gene product](/guide/howto/find-func-gene)
* [View the 3D structure of a protein](/guide/howto/view-3d-struct-prot)
* [Find a curated version of a sequence record (NCBI Reference Sequence)](/guide/howto/find-curated-sequence)
...
* [Align two or more 3D structures to a given structure](/guide/howto/align-2-struct)
* [Download a large, custom set of records from NCBI](/guide/howto/dwn-records)
* [View a mutation site in a 3D structure](/guide/howto/view-mut-3d)
...
![](/stat?jsdisabled=true&ncbi_app=guide&ncbi_db=&ncbi_pdid=ResourceListPage&ncbi_phid=CE8E8B9D9FBD34E10000000000B200A2)
