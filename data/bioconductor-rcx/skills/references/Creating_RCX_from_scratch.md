...
* [1 The Cytoscape Exchange (CX) Format](#the-cytoscape-exchange-cx-format)
* [2 Starting with nodes and edges](#starting-with-nodes-and-edges)
* [3 Adding attributes to the network](#adding-attributes-to-the-network)
  + [3.1 Node Attributes](#node-attributes)
  + [3.2 Network Attributes](#network-attributes)
* [4 Put the nodes into position](#put-the-nodes-into-position)
* [5 Create visual layout](#create-visual-layout)
  + [5.1 Visual properties of the network](#visual-properties-of-the-network)
  + [5.2 Visual properties of nodes](#visual-properties-of-nodes)
  + [5.3 Visual properties of edges](#visual-properties-of-edges)
  + [5.4 Create a visual property aspect](#create-a-visual-property-aspect)
* [6 Table column](#table-column)
* [7 Visualize the final network](#visualize-the-final-network)
* [8 Meta-data](#meta-data)
* [9 Create RCX at once](#create-rcx-at-once)
* [10 Save the network](#save-the-network)
* [11 Session info](#session-info)

# 1 The Cytoscape Exchange (CX) Format
...
# 2 Starting with nodes and edges
...
edges <- createEdges(
    source = c(
        ...
        72, 73, 74, 75, 76, 78, 79, 80, 81, 82, 84, 85, 87, 88, 90, 91, 92,
        93, 94, 95, 14, 15, 18, 23, 25, 30, 36, 38, 42, 45, 46, 50, 51, 52,
        59, 61, 62, 70, 72, 73, 74, 75, 76, 78, 79, 80, 81, 82
    ),
    target = c(
        0, 1, 1, 1, 1, 1, 1, 0, 8, 8, 8, 0, 12, 12, 12, 12, 0, 17, 17, 17, 17,
        17, 17, 0, 24, 24, 24, 24, 24, 24, 0, 31, 31, 31, 31, 31, 0, 37, 37,
        37, 37, 37, 0, 43, 43, 43, 0, 47, 47, 47, 47, 47, 47, 0, 54, 54, 54,
        54, 54, 0, 60, 60, 60, 60, 0, 65, 65, 65, 65, 65, 0, 71, 71, 71, 71,
        71, 77, 77, 77, 77, 77, 83, 83, 86, 86, 89, 89, 89, 0, 93, 93, 9, 9,
        9, 44, 13, 44, 44, 9, 44, 9, 13, 9, 13, 13, 44, 44, 44, 44, 77, 77,
        77, 77, 77, 83, 86, 89, 44, 44
    ),
    interaction = c(
        "aspectOf", "propertyOf", "propertyOf", "propertyOf", "propertyOf",
        "propertyOf", "propertyOf", "aspectOf", "propertyOf", "propertyOf",
        "propertyOf", "aspectOf", "propertyOf", "propertyOf", "propertyOf",
        "propertyOf", "aspectOf", "propertyOf", "propertyOf", "propertyOf",
        "propertyOf", "propertyOf", "propertyOf", "aspectOf", "propertyOf",
        "propertyOf", "propertyOf", "propertyOf", "propertyOf", "propertyOf",
        "aspectOf", "propertyOf", "propertyOf", "propertyOf", "propertyOf",
        "propertyOf", "aspectOf", "propertyOf", "propertyOf", "propertyOf",
        "propertyOf", "propertyOf", "aspectOf", "propertyOf", "propertyOf",
        "propertyOf", "aspectOf", "propertyOf", "propertyOf", "propertyOf",
        "propertyOf", "propertyOf", "propertyOf", "aspectOf", "propertyOf",
        "propertyOf", "propertyOf", "propertyOf", "propertyOf", "aspectOf",
        "propertyOf", "propertyOf", "propertyOf", "propertyOf", "aspectOf",
        "propertyOf", "propertyOf", "propertyOf", "propertyOf", "propertyOf",
        "aspectOf", "propertyOf", "propertyOf", "propertyOf", "propertyOf",
        "propertyOf", "propertyOf", "propertyOf", "propertyOf", "propertyOf",
        "propertyOf", "propertyOf", "propertyOf", "propertyOf", "propertyOf",
        "propertyOf", "propertyOf", "propertyOf", "aspectOf", "propertyOf",
        "propertyOf", "references", "references", "references", "references",
        "references", "references", "references", "references", "references",
        "references", "references", "references", "references", "references",
        "references", "references", "references", "references", "contains",
...
Force directed layout for RCX network with only nodes and edges

# 3 Adding attributes to the network
...
nodeAttributesRequired <- createNodeAttributes(
    propertyOf = nodesRequired, name = rep("required", length(nodesRequired)),
    value = rep(TRUE, length(nodesRequired))
)

nodeAttributesAuto <- createNodeAttributes(
    propertyOf = nodesAuto, name = rep("auto", length(nodesAuto)),
...
Network attributes shown on the NDEx platform
...
RCX network with a cartesian layout for nodes

# 5 Create visual layout
...
## 5.1 Visual properties of the network
...
## 5.2 Visual properties of nodes
...
## 5.3 Visual properties of edges
...
## 5.4 Create a visual property aspect
...
![Cytoscape](data:image/png;base64...) ![NDExEdit](data:image/png;base64...)
