...
org.Cf.egACCNUM is an R object that contains mappings between Entrez Gene identifiers and
...
org.Cf.egALIAS is an R object that provides mappings between common gene symbol identifiers
...
Welcome to the org.Cf.eg.db annotation Package. This is an organism specific package. The pur-
pose is to provide detailed information about the species abbreviated in the second part of the
package name org.Cf.eg.db. This package is updated biannually.
...
org.Cf.egCHR is an R object that provides mappings between entrez gene identifiers and the chro-
...
org.Cf.egCHRLENGTHS provides the length measured in base pairs for each of the chromosomes.
...
org.Cf.egCHRLOC is an R object that maps entrez gene identifiers to the starting position of the
...
ftp://hgdownload.cse.ucsc.edu/goldenPath/canFam6/database With a date stamp from the source
of: UTC-Sep26
...
org.Cf.egENSEMBL is an R object that contains mappings between Entrez Gene identifiers and
...
# Convert to a list
xx <- as.list(org.Cf.egENSEMBL2EG)
if(length(xx) > 0){
...
org.Cf.egENSEMBLPROT Map Ensembl protein acession numbers with Entrez Gene identifiers
...
org.Cf.egENSEMBLTRANS

org.Cf.egENSEMBLTRANS Map Ensembl transcript acession numbers with Entrez Gene identi-
...
# Convert to a list
xx <- as.list(org.Cf.egENSEMBLTRANS2EG)
if(length(xx) > 0){
...
org.Cf.egENZYME is an R object that provides mappings between entrez gene identifiers and EC
numbers.
...
numbers. In org.Cf.egENZYME2EG, EC is dropped from the Enzyme Commission numbers.
...
org.Cf.egGENENAME is an R object that maps entrez gene identifiers to the corresponding gene
name.
...
org.Cf.egGENETYPE is an R object that provides mappings between entrez gene identifiers and
gene types.
...
org.Cf.egGO is an R object that provides mappings between entrez gene identifiers and the GO
...
org.Cf.egGO2ALLEGS is an R object that provides mappings between a given GO identifier and
all of the Entrez Gene identifiers annotated at that GO term OR TO ONE OF IT’S CHILD NODES
in the GO ontology. Thus, this mapping is much larger and more inclusive than org.Cf.egGO2EG.

Details

If org.Cf.egGO is cast as a list, each Entrez Gene identifier is mapped to a list of lists. The names on
...
If org.Cf.egGO2ALLEGS or org.Cf.egGO2EG is cast as a list, each GO term maps to a named vec-
...
# For org.Cf.egGO2ALLEGS
xx <- as.list(org.Cf.egGO2ALLEGS)
if(length(xx) > 0){
...
Number of mapped keys for the maps in package org.Cf.eg.db

Description

org.Cf.egMAPCOUNTS provides the "map count" (i.e. the count of mapped keys) for each map in
...
The Organism for org.Cf.eg

Description

org.Cf.egORGANISM is an R object that contains a single item: a character string that names the
organism for which org.Cf.eg was built.

Details

Although the package name is suggestive of the organism for which it was built, org.Cf.egORGANISM
...
isms. org.Cf.egPATH maps entrez gene identifiers to the identifiers used by KEGG for pathways
...
org.Cf.egPMID is an R object that provides mappings between entrez gene identifiers and PubMed
identifiers.
...
org.Cf.egREFSEQ is an R object that provides mappings between entrez gene identifiers and Ref-
Seq identifiers.
...
org.Cf.egSYMBOL is an R object that provides mappings between entrez gene identifiers and gene
abbreviations.
...
org.Cf.egUNIPROT is an R object that contains mappings between Entrez Gene identifiers and
...
org.Cf.eg_dbconn()
org.Cf.eg_dbfile()
org.Cf.eg_dbschema(file="", show.indices=FALSE)
org.Cf.eg_dbInfo()
...
org.Cf.eg_dbconn returns a connection object to the package annotation DB. IMPORTANT: Don’t
call dbDisconnect on the connection object returned by org.Cf.eg_dbconn or you will break all
the AnnDbObj objects defined in this package!
org.Cf.eg_dbfile returns the path (character string) to the package annotation DB (this is an
SQLite file).
org.Cf.eg_dbschema prints the schema definition of the package annotation DB.
org.Cf.eg_dbInfo prints other information about the package annotation DB.
...
org.Cf.eg_dbconn: a DBIConnection object representing an open connection to the package an-
notation DB.
org.Cf.eg_dbfile: a character string with the path to the package annotation DB.
org.Cf.eg_dbschema: none (invisible NULL).
org.Cf.eg_dbInfo: none (invisible NULL).
...
dbGetQuery(org.Cf.eg_dbconn(), "SELECT COUNT(*) FROM genes")
...
org.Cf.egALIAS2EG, 2
org.Cf.egCHR, 3
org.Cf.egCHRLENGTHS, 4
org.Cf.egCHRLOC, 5
org.Cf.egENSEMBL, 6
org.Cf.egENSEMBLPROT, 7
org.Cf.egENSEMBLTRANS, 8
org.Cf.egENZYME, 9
org.Cf.egGENENAME, 10
org.Cf.egGENETYPE, 11
org.Cf.egGO, 12
org.Cf.egMAPCOUNTS, 14
org.Cf.egORGANISM, 15
org.Cf.egPATH, 15
org.Cf.egPMID, 16
org.Cf.egREFSEQ, 18
org.Cf.egSYMBOL, 19
...
org.Cf.eg (org.Cf.eg.db), 3
org.Cf.eg.db, 3
org.Cf.eg_dbconn, 21
org.Cf.eg_dbfile (org.Cf.eg_dbconn), 21

23

org.Cf.eg_dbInfo (org.Cf.eg_dbconn), 21
org.Cf.eg_dbschema (org.Cf.eg_dbconn),

21
org.Cf.egACCNUM, 1
org.Cf.egACCNUM2EG (org.Cf.egACCNUM), 1
org.Cf.egALIAS2EG, 2
org.Cf.egCHR, 3
org.Cf.egCHRLENGTHS, 4
org.Cf.egCHRLOC, 5
org.Cf.egCHRLOCEND (org.Cf.egCHRLOC), 5
org.Cf.egENSEMBL, 6
org.Cf.egENSEMBL2EG (org.Cf.egENSEMBL),

6

org.Cf.egENSEMBLPROT, 7
org.Cf.egENSEMBLPROT2EG

(org.Cf.egENSEMBLPROT), 7

org.Cf.egENSEMBLTRANS, 8
org.Cf.egENSEMBLTRANS2EG

(org.Cf.egENSEMBLTRANS), 8

org.Cf.egENZYME, 9
org.Cf.egENZYME2EG (org.Cf.egENZYME), 9
org.Cf.egGENENAME, 10
org.Cf.egGENETYPE, 11
org.Cf.egGO, 12
org.Cf.egGO2ALLEGS, 13
org.Cf.egGO2ALLEGS (org.Cf.egGO), 12
org.Cf.egGO2EG (org.Cf.egGO), 12
org.Cf.egMAPCOUNTS, 14
org.Cf.egORGANISM, 15
org.Cf.egPATH, 15
org.Cf.egPATH2EG (org.Cf.egPATH), 15
org.Cf.egPMID, 16
org.Cf.egPMID2EG (org.Cf.egPMID), 16
org.Cf.egREFSEQ, 18
org.Cf.egREFSEQ2EG (org.Cf.egREFSEQ), 18
org.Cf.egSYMBOL, 19
org.Cf.egSYMBOL2EG (org.Cf.egSYMBOL), 19
org.Cf.egUNIPROT, 20
