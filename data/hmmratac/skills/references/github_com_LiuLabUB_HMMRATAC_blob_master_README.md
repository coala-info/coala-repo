...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2FLiuLabUB%2FHMMRATAC%2Fblob%2Fmaster%2FREADME.md)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fblob%2Fshow&source=header-repo&source_repo=LiuLabUB%2FHMMRATAC)
...
[History](/LiuLabUB/HMMRATAC/commits/master/README.md)

History

52 lines (31 loc) · 2.71 KB
...
[Raw](https://github.com/LiuLabUB/HMMRATAC/raw/refs/heads/master/README.md)
...
For details on HOW to run HMMRATAC, see HMMRATAC\_Guide.md, which contains a thorough runthrough of all parameters, output files and input
...
processed by HMMRATAC (see [HMMRATAC\_Guide.md](/LiuLabUB/HMMRATAC/blob/master/HMMRATAC_Guide.md#commandline-options) on `--trim` option).
