...
inputs:
  ...
  - id: target_contact_density
    ...
    doc: "Average contact density to be reached before the simulation is halted.\n\
      ...
      \                                    Assuming chr1 is exactly 250 Mbp long,
      MoDLE will schedule simulation instances to yield\n                        \
      \                 a total of 150 000 contacts for chr1: 2 * (250e6 / 100e3)
      * (3e6 / 100e3) = 150e3."
    inputBinding:
      position: 101
