...
baseCommand:
  - snap-aligner
  - paired
label: snap-aligner_paired
doc: "Align paired-end reads using SNAP.\n\nTool homepage: http://snap.cs.berkeley.edu/"
inputs:
  - id: index_dir
    type: Directory
  ...
  - id: dont_map_index
    ...
    inputBinding:
      position: 103
      prefix: -map-
  - id: dont_perform_hamming_distance_scoring
    type:
      - 'null'
      - boolean
    doc: Do not perform Hamming distance scoring
    inputBinding:
      position: 103
      prefix: -eh-
  ...
  - id: enable_gatk_haplotypecaller_mode
    ...
    inputBinding:
      position: 103
      prefix: -hc
  - id: explore_overly_popular_seeds
    type:
      - 'null'
      - boolean
  ...
  - id: extra_search_depth
    ...
    inputBinding:
      position: 103
      prefix: -D
  - id: filter_options_general
    type:
      - 'null'
      - string
    doc: An alternate (and fully general) way to specify filter options
    inputBinding:
      position: 103
      prefix: -E
  - id: filter_output
  ...
  - id: include_secondary_supplementary
    ...
    inputBinding:
      position: 103
      prefix: -sa
  - id: infer_inter_read_spacing
    type:
      - 'null'
      - boolean
    doc: Infer inter-read spacing by periodically looking at the observed 
      distances
    inputBinding:
      position: 103
      prefix: -ins
  - id: keep_unpaired_reads
    type:
      - 'null'
      - boolean
    doc: Keep unpaired-looking reads in SAM/BAM input
    inputBinding:
      position: 103
      prefix: -ku
  - id: kill_if_too_slow
  ...
  - id: max_edit_distance
    ...
    inputBinding:
      position: 103
      prefix: -d
  - id: max_hits_intersecting_aligner
    type:
      - 'null'
      - int
  ...
  - id: max_secondary_alignments
    ...
    inputBinding:
      position: 103
      prefix: -omax
  - id: max_seeds_fallback_single_end
    type:
      - 'null'
      - int
    ...
    inputBinding:
      position: 103
      prefix: -N
  - id: min_affine_gap_score_improvement_single_end
    type:
      - 'null'
      - int
    ...
    inputBinding:
      position: 103
      prefix: -eg
  - id: min_edit_distance_reconsider_single_end
    type:
      - 'null'
      - int
    ...
    inputBinding:
      position: 103
      prefix: -en
  - id: min_max_spacing_paired_ends
    type:
      - 'null'
      - string
  ...
  - id: min_seed_matches
    ...
    inputBinding:
      position: 103
      prefix: -ms
  - id: min_total_edit_distance_skip_single_end
    type:
      - 'null'
      - int
  ...
  - id: no_banded_affine_gap
    ...
    inputBinding:
      position: 103
      prefix: -nb
  - id: no_edit_distance_scoring_before_affine
    type:
      - 'null'
      - boolean
  ...
  - id: output_multiple_alignments
    ...
    inputBinding:
      position: 103
      prefix: -om
  - id: perform_hamming_distance_scoring
    type:
      - 'null'
      - boolean
    doc: Perform Hamming distance scoring to try and map reads that cannot be 
      mapped by both the paired-end and the single-end aligner
    inputBinding:
      position: 103
      prefix: -eh
  - id: prefetch_index
  ...
  - id: read_group_line
    ...
    inputBinding:
      position: 103
      prefix: -R
  - id: require_both_mates_filter
    type:
      - 'null'
      - boolean
    doc: Additional option to -F to require both mates to satisfy filter
    inputBinding:
      position: 103
      prefix: -F b
  - id: run_speed_file
  ...
  - id: seed_coverage
    type:
      - 'null'
      - float
    doc: Seed coverage (readSize/seedSize). Exclusive with -n.
    inputBinding:
      position: 103
      prefix: -sc
  ...
  - id: write_buffer_size_mb
    ...
    inputBinding:
      position: 103
      prefix: -wbs
  - id: write_internal_score_tag
    type:
      - 'null'
      - string
    doc: Write SNAP's internal score for an alignment into the output
    inputBinding:
      position: 103
      prefix: -is
outputs:
