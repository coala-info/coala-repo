...
description: B::Hooks::EndOfScope provides a reliable way to execute code at the moment the Perl compiler finishes processing the surrounding lexical scope.
