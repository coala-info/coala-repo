...
baseCommand:
  - msstitch
  - seqmatch
label: msstitch_seqmatch
doc: "Performs sequence matching against a database.\n\nTool homepage: https://github.com/lehtiolab/msstitch"
inputs:
  - id: dbfile
    type: File
  ...
  - id: input_file
    ...
    inputBinding:
      position: 101
      prefix: -i
  - id: match_column_name
    type: string
    doc: Column header field name for the column where matching accessions will 
      be in
    inputBinding:
      position: 101
      prefix: --matchcolname
