...
### Tool Description
A program for summarizing expression probe data from cel files. Can use either a cdf file or pgf/clf files for defining probesets.

### Metadata
- **Docker Image**: quay.io/biocontainers/apt-probeset-summarize:2.10.0--h9948957_6
- **Homepage**: https://downloads.thermofisher.com
- **Package**: https://anaconda.org/channels/bioconda/packages/apt-probeset-summarize/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/apt-probeset-summarize/overview
...
Standard Methods:
 'dabg'                 pm-only,dabg
 'gc-dabg-median'       gc-correction,pm-only,dabg.usepercentile=true.percentile=0.50
 'gc-sst-rma-sketch'    gc-correction,scale-intensities,rma-bg,quant-norm.sketch=-1.usepm=true.bioc=true,pm-only,med-polish
 'gc-sstgl-rma-sketch'  gc-correction,scale-intensities.gain_lock_pct=0.75,rma-bg,quant-norm.sketch=-1.usepm=true.bioc=true,pm-only,med-polish
...
version: 1.20.0 svn://svn.affymetrix.com/apt/projects/apt/branches/APT_1_20_0_BRANCH/sdk/release@58265
```
