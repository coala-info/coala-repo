...
Hs6UG171ACCNUM is an R object that contains mappings between a manufacturer’s identifiers
...
Hs6UG171ALIAS is an R object that provides mappings between common gene symbol identifiers
...
xx <- as.list(Hs6UG171ALIAS2PROBE)
if(length(xx) > 0){
...
Welcome to the Hs6UG171.db annotation Package. The purpose of this package is to provide
detailed information about the Hs6UG171 platform. This package is updated biannually.
...
Hs6UG171CHR is an R object that provides mappings between a manufacturer identifier and the
...
Hs6UG171CHRLENGTHS provides the length measured in base pairs for each of the chromo-
somes.
...
Hs6UG171CHRLOC is an R object that maps manufacturer identifiers to the starting position of
...
Hs6UG171ENSEMBL is an R object that contains mappings between manufacturer identifiers and
...
# Convert to a list
xx <- as.list(Hs6UG171ENSEMBL2PROBE)
if(length(xx) > 0){
...
Hs6UG171ENTREZID is an R object that provides mappings between manufacturer identifiers and
...
Hs6UG171ENZYME is an R object that provides mappings between manufacturer identifiers and
EC numbers. Hs6UG171ENZYME2PROBE is an R object that maps Enzyme Commission (EC)
numbers to manufacturer identifiers.

Details

When the Hs6UG171ENZYME maping viewed as a list, each manufacturer identifier maps to a
...
For the Hs6UG171ENZYME2PROBE, each EC number maps to a named vector containing all of
...
bers. In Hs6UG171ENZYME2PROBE, EC is dropped from the Enzyme Commission numbers.
...
# Now convert Hs6UG171ENZYME2PROBE to a list to see inside
xx <- as.list(Hs6UG171ENZYME2PROBE)
if(length(xx) > 0){
...
Hs6UG171GENENAME is an R object that maps manufacturer identifiers to the corresponding
gene name.
...
Hs6UG171GO is an R object that provides mappings between manufacturer identifiers and the GO
identifiers that they are directly associated with. This mapping and its reverse mapping (Hs6UG171GO2PROBE)
...
Hs6UG171GO2ALLPROBES is an R object that provides mappings between a given GO iden-
...
If Hs6UG171GO is cast as a list, each manufacturer identifier is mapped to a list of lists. The
...
If Hs6UG171GO2ALLPROBES or Hs6UG171GO2PROBE is cast as a list, each GO term maps to
...
# Convert Hs6UG171GO2ALLPROBES to a list
xx <- as.list(Hs6UG171GO2ALLPROBES)
if(length(xx) > 0){
...
Hs6UG171MAP is an R object that provides mappings between manufacturer identifiers and cyto-
band locations.
...
Number of mapped keys for the maps in package Hs6UG171.db

Description

DEPRECATED. Counts in the MAPCOUNT table are out of sync and should not be used.

Hs6UG171MAPCOUNTS provides the "map count" (i.e. the count of mapped keys) for each map
in package Hs6UG171.db.
...
Hs6UG171OMIM is an R object that provides mappings between manufacturer identifiers and
OMIM identifiers.
...
The Organism information for Hs6UG171

Description

Hs6UG171ORGANISM is an R object that contains a single item: a character string that names
the organism for which Hs6UG171 was built. Hs6UG171ORGPKG is an R object that contains
a chararcter vector with the name of the organism package that a chip package depends on for its
gene-centric annotation.

Details

Although the package name is suggestive of the organism for which it was built, Hs6UG171ORGANISM
provides a simple way to programmatically extract the organism name. Hs6UG171ORGPKG pro-
...
Hs6UG171PATH maps probe identifiers to the identifiers used by KEGG for pathways in which the
genes represented by the probe identifiers are involved

Hs6UG171PATH2PROBE is an R object that provides mappings between KEGG identifiers and
...
# Now convert the Hs6UG171PATH2PROBE object to a list
xx <- as.list(Hs6UG171PATH2PROBE)
if(length(xx) > 0){
...
Hs6UG171PFAM is an R object that provides mappings between manufacturer identifiers and
PFAM identifiers.
...
Hs6UG171PMID is an R object that provides mappings between manufacturer identifiers and
PubMed identifiers. Hs6UG171PMID2PROBE is an R object that provides mappings between
PubMed identifiers and manufacturer identifiers.

Details

When Hs6UG171PMID is viewed as a list each manufacturer identifier is mapped to a named vec-
...
When Hs6UG171PMID2PROBE is viewed as a list each PubMed identifier is mapped to a named
...
# Now convert the reverse map object Hs6UG171PMID2PROBE to a list
xx <- as.list(Hs6UG171PMID2PROBE)
if(length(xx) > 0){
...
Hs6UG171PROSITE is an R object that provides mappings between manufacturer identifiers and
PROSITE identifiers.
...
Hs6UG171REFSEQ is an R object that provides mappings between manufacturer identifiers and
RefSeq identifiers.
...
Hs6UG171SYMBOL is an R object that provides mappings between manufacturer identifiers and
gene abbreviations.
...
Hs6UG171UNIGENE is an R object that provides mappings between manufacturer identifiers and
UniGene identifiers.
...
Hs6UG171UNIPROT is an R object that contains mappings between the manufacturer identifiers
...
Hs6UG171_dbconn()
Hs6UG171_dbfile()
Hs6UG171_dbschema(file="", show.indices=FALSE)
Hs6UG171_dbInfo()
...
Hs6UG171_dbconn returns a connection object to the package annotation DB. IMPORTANT: Don’t
call dbDisconnect on the connection object returned by Hs6UG171_dbconn or you will break all
the AnnDbObj objects defined in this package!
Hs6UG171_dbfile returns the path (character string) to the package annotation DB (this is an
SQLite file).
Hs6UG171_dbschema prints the schema definition of the package annotation DB.
Hs6UG171_dbInfo prints other information about the package annotation DB.

Value

Hs6UG171_dbconn: a DBIConnection object representing an open connection to the package anno-
tation DB.
Hs6UG171_dbfile: a character string with the path to the package annotation DB.
Hs6UG171_dbschema: none (invisible NULL).
Hs6UG171_dbInfo: none (invisible NULL).
...
dbGetQuery(Hs6UG171_dbconn(), "SELECT COUNT(*) FROM probes")
...
Hs6UG171_dbconn, 21
Hs6UG171ACCNUM, 1
Hs6UG171ALIAS2PROBE, 2
Hs6UG171CHR, 3
Hs6UG171CHRLENGTHS, 4
Hs6UG171CHRLOC, 4
Hs6UG171ENSEMBL, 5
Hs6UG171ENTREZID, 6
Hs6UG171ENZYME, 7
...
Hs6UG171 (Hs6UG171.db), 2
Hs6UG171.db, 2
Hs6UG171_dbconn, 21

Hs6UG171_dbfile (Hs6UG171_dbconn), 21
Hs6UG171_dbInfo (Hs6UG171_dbconn), 21
Hs6UG171_dbschema (Hs6UG171_dbconn), 21
Hs6UG171ACCNUM, 1
Hs6UG171ALIAS2PROBE, 2
Hs6UG171CHR, 3
Hs6UG171CHRLENGTHS, 4
Hs6UG171CHRLOC, 4
Hs6UG171CHRLOCEND (Hs6UG171CHRLOC), 4
Hs6UG171ENSEMBL, 5
Hs6UG171ENSEMBL2PROBE

(Hs6UG171ENSEMBL), 5

Hs6UG171ENTREZID, 6
Hs6UG171ENZYME, 7
Hs6UG171ENZYME2PROBE (Hs6UG171ENZYME), 7
Hs6UG171GENENAME, 9
Hs6UG171GO, 10
Hs6UG171GO2ALLPROBES, 11
Hs6UG171GO2ALLPROBES (Hs6UG171GO), 10
Hs6UG171GO2PROBE (Hs6UG171GO), 10
Hs6UG171LOCUSID (Hs6UG171ENTREZID), 6
Hs6UG171MAP, 12
Hs6UG171MAPCOUNTS, 13
Hs6UG171OMIM, 13
Hs6UG171ORGANISM, 14
Hs6UG171ORGPKG (Hs6UG171ORGANISM), 14
Hs6UG171PATH, 15
Hs6UG171PATH2PROBE (Hs6UG171PATH), 15
Hs6UG171PFAM, 16
Hs6UG171PMID, 16
Hs6UG171PMID2PROBE (Hs6UG171PMID), 16
Hs6UG171PROSITE, 17
Hs6UG171REFSEQ, 18
Hs6UG171SYMBOL, 19
Hs6UG171UNIGENE, 20
Hs6UG171UNIPROT, 21
Hs6UG171UNIPROT2PROBE
