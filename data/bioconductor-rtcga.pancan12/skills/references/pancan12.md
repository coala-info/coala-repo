...
From clinical data we are going to extract following variables: - X\_cohort (cancer type) - X\_EVENT (0/1) - X\_TIME\_TO\_EVENT (in days) - X\_PANCAN\_UNC\_RNAseq\_PANCAN\_K16 (cancer’s subtypes)
