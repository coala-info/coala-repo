...
[View this page](_sources/step_by_step.md.txt "View this page")

Toggle Light / Dark / Auto color theme

Toggle table of contents sidebar

# Mouse Embryo (Step by Step)[¶](#mouse-embryo-step-by-step "Link to this heading")

This tutorial guides you through running `gsMap` step by step, with user-defined parameters and resources, granting greater flexibility and control over the analysis. This mode is suited for users who require detailed customization of their pipeline. For a faster, one-command execution, please see the [Quick Mode](quick_mode.html) tutorial.

## Preparation[¶](#preparation "Link to this heading")

Please ensure you have [installed](install.html) the `gsMap`. This tutorial guides you through using gsMap in a step-by-step manner.
...
## Running `gsMap`[¶](#running-gsmap "Link to this heading")

### 1. find latent representations (optional)[¶](#find-latent-representations-optional "Link to this heading")
...
### 2. generate gene specificity scores[¶](#generate-gene-specificity-scores "Link to this heading")
...
### 3. generate ldscore[¶](#generate-ldscore "Link to this heading")
...
### 4. spatial ldsc[¶](#spatial-ldsc "Link to this heading")
...
### 5. cauchy combination (optional)[¶](#cauchy-combination-optional "Link to this heading")
...
### 6. report generation (optional)[¶](#report-generation-optional "Link to this heading")
...
Mouse Embryo (Quick Mode)](quick_mode.html)
...
* Mouse Embryo (Step by Step)
  ...
  + [Running `gsMap`](#running-gsmap)
    - [1. find latent representations (optional)](#find-latent-representations-optional)
    - [2. generate gene specificity scores](#generate-gene-specificity-scores)
    - [3. generate ldscore](#generate-ldscore)
    - [4. spatial ldsc](#spatial-ldsc)
    - [5. cauchy combination (optional)](#cauchy-combination-optional)
    - [6. report generation (optional)](#report-generation-optional)