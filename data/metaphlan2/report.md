...
### Metadata
- **Docker Image**: quay.io/biocontainers/metaphlan2:2.96.1--py_0
- **Homepage**: https://bitbucket.org/biobakery/metaphlan2
- **Package**: https://anaconda.org/channels/bioconda/packages/metaphlan2/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/metaphlan2/overview
- **Total Downloads**: 195.4K
...
usage: metaphlan2.py --input_type
                     ...
                     [-s sam_output_file] [--legacy-output]
...
Mapping arguments:
  ...
  --bowtie2db METAPHLAN_BOWTIE2_DB
                        Folder containing the MetaPhlAn database. Used if --input_type is fastq, fasta, multifasta, or multifastq [default /usr/local/bin/metaphlan_databases]
  -x INDEX, --index INDEX
...
## metaphlan2_merge_metaphlan_tables.py
...
### Original Help Text
```text
usage: merge_metaphlan_tables.py [-h] [-o output.txt]
                                 input.txt [input.txt ...]
