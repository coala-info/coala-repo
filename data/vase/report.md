...
### Metadata
- **Docker Image**: quay.io/biocontainers/vase:0.5.1--pyh086e186_0
- **Homepage**: https://github.com/david-a-parry/vase
- **Package**: https://anaconda.org/channels/bioconda/packages/vase/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/vase/overview
- **Total Downloads**: 3.9K
- **Last updated**: 2025-04-22
- **GitHub**: https://github.com/david-a-parry/vase
- **Stars**: N/A
### Original Help Text
```text
usage: vase -i VCF [-o OUTPUT] [-r REPORT_PREFIX]
            ...
            [-c [CSQ ...]] [--snpeff] [--impact IMPACT [IMPACT ...]]
            ...
            [--prioritise_cadd] [--cases SAMPLE_ID [SAMPLE_ID ...]]
            ...
            [--debug] [--no_warnings] [--silent] [--version] [-h]
...
Annotation File Arguments:
  ...
  --splice_ai_min_delta DELTA, -splice_ai_min_delta DELTA
                        ...
                        If used in conjunction with --csq or --impact
  ...
  --splice_ai_max_delta DELTA, -splice_ai_max_delta DELTA
                        ...
                        all SpliceAI delta scores are equal to or below
                        this threshold.
  ...
  --prioritise_cadd     If using --cadd_phred or --cadd_raw cutoffs,
                        filter variants below threshold even if they meet
                        SpliceAI delta cutoffs. Default behaviour is to
                        retain variants if they meet --splice_ai_min_delta
                        irrespective of CADD cutoffs.
...
Variant Filtering Arguments:
  ...
  --snpeff              Use SnpEff annotations instead of VEP for
                        filtering.
