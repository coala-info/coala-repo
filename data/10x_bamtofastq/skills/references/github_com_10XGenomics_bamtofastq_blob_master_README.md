...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2F10XGenomics%2Fbamtofastq%2Fblob%2Fmaster%2FREADME.md)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fblob%2Fshow&source=header-repo&source_repo=10XGenomics%2Fbamtofastq)
...
[History](/10XGenomics/bamtofastq/commits/master/README.md)

History

101 lines (69 loc) · 5.08 KB
...
[Raw](https://github.com/10XGenomics/bamtofastq/raw/refs/heads/master/README.md)
...
3. When changes are in the `master` branch, go to the [releases](https://github.com/10XGenomics/bamtofastq/releases) page and click on ["Draft a new release"](https://github.com/10XGenomics/bamtofastq/releases/new).
...
Once the release is created there is an automated workflow for [publishing binaries](https://github.com/10XGenomics/bamtofastq/blob/master/.github/workflows/release.yaml) for Linux and macOS on new releases.
