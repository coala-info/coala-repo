...
SEA looks for motifs that are enriched in your sequences relative
to a control set of sequences.

By default SEA creates the control
...
The more sequences that you can give SEA the
more subtle the motifs it can find.
For ChIP-seq we recommend using sequences of length 100bp 