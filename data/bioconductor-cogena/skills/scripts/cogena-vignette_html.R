# Code example from 'cogena-vignette_html' vignette. See references/ for full tutorial.
...
## ----heatmapPEI_B, fig.width=11, fig.height=7, fig.cap="KEGG pathway enrichment circle visualization"----
