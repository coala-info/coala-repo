# plink2 CWL Generation Report

## plink2

### Tool Description
A whole-genome association analysis toolset, designed to handle large datasets and perform a wide range of genetic analyses including association testing, population structure analysis, and data management.

### Metadata
- **Docker Image**: quay.io/biocontainers/plink2:2.0.0a.6.9--h9948957_0
- **Homepage**: https://www.cog-genomics.org/plink2
- **Package**: https://anaconda.org/channels/bioconda/packages/plink2/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/plink2/overview
- **Total Downloads**: 76.0K
  ...
  --glm ['zs'] ['omit-ref'] [{sex | no-x-sex}] ['log10'] ['pheno-ids']
    ...
    * To add covariates which are not constant across all variants, add the
    ...
    The main report supports the following column sets:
      ...
      omitted: Omitted allele.  This will be added to the default column set in
               the future.
