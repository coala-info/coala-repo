...
* [previous](typing.html "Calling Haplotypes with MicroHapulator") |
* [mhpl8r](index.html) »
* User Manual

# User Manual[¶](#user-manual "Permalink to this heading")
...
> A brief overview of MicroHapulator's core haplotype calling procedure is provided [here](typing.html), and those needing a bit more background can find a primer on forensic DNA typing [here](primer.html).
> Consult your system administrator if you need assistance [installing MicroHapulator](install.html) on your machine.
...
## End-to-end Workflow Execution[¶](#end-to-end-workflow-execution "Permalink to this heading")
...
* MH marker reference sequences in FASTA format (see [the config docs](config.html))
* MH marker definitions (SNP offsets) in TSV format (see [the config docs](config.html))
...
For a detailed description of these options, run `mhpl8r pipe --help` in the terminal or consult the [CLI docs](cli.html) for the `mhpl8r pipe` command.

## Stepwise Workflow Execution[¶](#stepwise-workflow-execution "Permalink to this heading")
...
Be sure to read [the config docs](config.html) and prepare the three configuration files before beginning the workflow.

### Preprocessing: read merging[¶](#preprocessing-read-merging "Permalink to this heading")
...
### Preprocessing: read alignment[¶](#preprocessing-read-alignment "Permalink to this heading")
...
### Quality control[¶](#quality-control "Permalink to this heading")
...
The following commands can be used to plot histograms of interlocus and heterozygote balance.
...
### Analysis and interpretation[¶](#analysis-and-interpretation "Permalink to this heading")
...
## Appendix: Simulated Data[¶](#appendix-simulated-data "Permalink to this heading")
...
* User Manual
  + [Overview](#overview)
  + [End-to-end Workflow Execution](#end-to-end-workflow-execution)
  + [Stepwise Workflow Execution](#stepwise-workflow-execution)
    - [Preprocessing: read merging](#preprocessing-read-merging)
    - [Preprocessing: read alignment](#preprocessing-read-alignment)
    - [Haplotype calling](#haplotype-calling)
    - [Quality control](#quality-control)
    - [Analysis and interpretation](#analysis-and-interpretation)
  + [Appendix: Simulated Data](#appendix-simulated-data)

#### Previous topic

[Calling Haplotypes with MicroHapulator](typing.html "previous chapter")

#### Next topic

[Configuration](config.html "next chapter")

### This Page

* [Show Source](_sources/manual.md.txt)
