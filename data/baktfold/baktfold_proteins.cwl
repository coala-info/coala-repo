...
baseCommand:
  - baktfold
  - proteins
label: baktfold_proteins
doc: "baktfold proteins-predict then comapare all in one - GPU recommended\n\nTool
...
inputs:
  ...
  - id: input_file
    type: File
    doc: Path to input file in amino acid FASTA format
    inputBinding:
      position: 101
      prefix: --input
  - id: keep_tmp_files
