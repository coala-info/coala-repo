...
label: gatk_CalculateAverageCombinedAnnotations
doc: Divides annotations that were summed across samples by genomicsDB by the 
  number of samples with het or hom var calls. This is an approximation of 
  taking the average of these annotations.
inputs:
  - id: output
    type: string
    ...
    inputBinding:
      position: 101
      prefix: --output
  - id: summed_annotation_to_divide
    type:
      type: array
      items: string
