...
If you want to explore the available products and their layers, you should consult `[vignette("product-info")](articles/product-info.html)`. Please check the manual for complete documentation of the package.

### Downloading a subset

The example below demonstrates how to subset a specific layer for a specific product. The subset is constrained by the `region`, `timerange` and `verticalrange` arguments. The subset is downloaded to memory represented as a [`stars`](https://r-spatial.github.io/stars/) object.
...
![Example plots of downloaded subsets](reference/figures/README-download-subset-1.png)

You can also use the request code from the Copernicus Marine Service website to download a subset. For more details see `[vignette("translate")](articles/translate.html)`

In addition it is also possible to subset data with `stars_proxy` objects, using either `[cms_zarr_proxy()](reference/cms_zarr_proxy.html)` or `[cms_native_proxy()](reference/cms_native_proxy.html)`. This is explained in more detail in `[vignette("proxy")](articles/proxy.html)`.
...
Web Map Tile Services (WMTS) allow to quickly plot pre-rendered images onto a map. This may not be useful when you need the data for analyses but is handy for quick visualisations, inspection or presentation of data. In R it is very easy to add WMTS layers to an interactive map using [leaflet](https://rstudio.github.io/leaflet/). This page is rendered statically and resulting in a non-interactive map.
...
![Static example image of a leaflet map](reference/figures/README-leaflet-1.png)
...
* [CopernicusClimate](https://github.com/pepijn-devries/CopernicusClimate) Dedicated to climate change datasets

## Resources

* [E.U. Copernicus Marine Service Information](https://data.marine.copernicus.eu)
* [Global Ocean Physics Analysis and Forecast - GLOBAL\_ANALYSISFORECAST\_PHY\_001\_024 (2016-10-14); DOI:10.48670/moi-00016](https://doi.org/10.48670/moi-00016)
...
* [View on CRAN](https://cloud.r-project.org/package%3DCopernicusMarine)
* [Browse source code](https://github.com/pepijn-devries/CopernicusMarine/)
* [Report a bug](https://github.com/pepijn-devries/CopernicusMarine/issues)
...
* [Citing CopernicusMarine](authors.html#citation)

## Developers

* Pepijn de Vries
   Author, maintainer, data contributor
...
* [![version](https://www.r-pkg.org/badges/version/CopernicusMarine)](https://CRAN.R-project.org/package%3DCopernicusMarine)
