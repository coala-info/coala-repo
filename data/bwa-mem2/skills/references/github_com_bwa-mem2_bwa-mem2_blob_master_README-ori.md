...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fbwa-mem2%2Fbwa-mem2%2Fblob%2Fmaster%2FREADME-ori.md)
...
[History](/bwa-mem2/bwa-mem2/commits/master/README-ori.md)
...
[Raw](https://github.com/bwa-mem2/bwa-mem2/raw/refs/heads/master/README-ori.md)
...
## IMPORTANT: 1.'bwa-mem2 index' requires ~48GB of space for full human genome plus index. 2. We recommend to run the code in AVX512 mode to get maximum performance. 3. The command-line of bwa-mem2 is exactly same as bwa-mem.
...
* Mapping: 'bwa-mem2 mem' can be run with appropriate paramters
  e.g. bwa-mem2 mem -t 1 <read1.fq> [<read2.fq>] > <out.sam>
