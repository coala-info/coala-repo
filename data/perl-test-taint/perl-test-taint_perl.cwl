...
baseCommand: perl
label: perl-test-taint_perl
doc: "The Perl 5 language interpreter\n\nTool homepage: https://metacpan.org/pod/Test::Taint"
inputs:
  - id: program_file
    type:
      - 'null'
...
hints:
  - class: DockerRequirement
    dockerPull: quay.io/biocontainers/perl-test-taint:1.08--pl5321h7b50bb2_1
stdout: perl-test-taint_perl.out
