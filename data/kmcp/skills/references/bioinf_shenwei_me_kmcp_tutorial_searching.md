...
[Skip to content](#sequence-and-genome-searching)
...
* [x]
  ...
  + [ ]
    ...
    - [Sequence search](#sequence-search)
      ...
      * [Step 1. Building databases](#step-1-building-databases)
      * [Step 2. Searching](#step-2-searching)
    - [Genome similarity estimation](#genome-similarity-estimation)

      * [Step 1. Building databases](#step-1-building-databases_1)
      * [Step 2. Searching](#step-2-searching_1)
* [ ]
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| S0R0/1 | 150 | 130 | 3.1777e-06 | 2 | GCF\_002872255.1 | 5 | 10 | 2583551 | 21 | 87 | 0.6692 | 0.0003 | 0.0003 | 0 |
| S0R0/1 | 150 | 130 | 1.1936e-03 | 2 | GCF\_001434585.1 | 6 | 10 | 2221511 | 21 | 74 | 0.5692 | 0.0003 | 0.0003 | 0 |
| S0R0/2 | 150 | 130 | 6.2145e-07 | 4 | GCF\_002872255.1 | 5 | 10 | 2583551 | 21 | 90 | 0.6923 | 0.0004 | 0.0004 | 1 |
| S0R0/2 | 150 | 130 | 3.1777e-06 | 4 | GCF\_001434585.1 | 6 | 10 | 2221511 | 21 | 87 | 0.6692 | 0.0004 | 0.0004 | 1 |
| S0R0/2 | 150 | 130 | 2.4002e-05 | 4 | GCF\_001438655.1 | 5 | 10 | 2038820 | 21 | 83 | 0.6385 | 0.0004 | 0.0004 | 1 |
...
| --- | --- | --- | --- |
| S0R0/1 | 3.1777e-06 | 0.6692 | GCF\_002872255.1 |
| S0R0/1 | 1.1936e-03 | 0.5692 | GCF\_001434585.1 |
| S0R0/2 | 6.2145e-07 | 0.6923 | GCF\_002872255.1 |
| S0R0/2 | 3.1777e-06 | 0.6692 | GCF\_001434585.1 |
| S0R0/2 | 2.4002e-05 | 0.6385 | GCF\_001438655.1 |
...
| #query | qLen | qKmers | FPR | hits | target | chunkIdx | chunks | tLen | kSize | mKmers | qCov | tCov | jacc | queryIdx |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| genome1 | 9488952 | 18737 | 0.0000e+00 | 2 | GCF\_000742135.1 | 0 | 1 | 5545784 | 31 | 8037 | 0.4289 | 0.7365 | 0.3719 | 0 |
| genome1 | 9488952 | 18737 | 3.1964e-183 | 2 | GCF\_000392875.1 | 0 | 1 | 2881400 | 31 | 3985 | 0.2127 | 0.7062 | 0.1954 | 0 |
...
| query | jacc | target |
| --- | --- | --- |
| genome1 | 0.3719 | NZ\_KN046818.1 Klebsiella pneumoniae strain ATCC 13883 scaffold1, whole genome shotgun sequence |
| genome1 | 0.1954 | NZ\_KB944588.1 Enterococcus faecalis ATCC 19433 acAqW-supercont1.1, whole genome shotgun sequence |
...
| query | jacc | target |
| --- | --- | --- |
| genome1 | 0.3712 | NZ\_KN046818.1 Klebsiella pneumoniae strain ATCC 13883 scaffold1, whole genome shotgun sequence |
| genome1 | 0.1974 | NZ\_KB944588.1 Enterococcus faecalis ATCC 19433 acAqW-supercont1.1, whole genome shotgun sequence |
