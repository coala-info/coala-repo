# Code example from 'simulations_vignette' vignette. See references/ for full tutorial.
...
## ----fig.width=11, fig.height=5.5, eval=FALSE---------------------------------
...
## ----fig.width=12, fig.height=16, eval=FALSE----------------------------------
...
## ----fig.width=12, fig.height=12, eval=FALSE----------------------------------
