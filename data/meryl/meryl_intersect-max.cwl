...
inputs:
  - id: command
    ...
    doc: The meryl command to execute (e.g., statistics, histogram, print, 
      count, less-than N, union, intersect, etc.)
    inputBinding:
      position: 1
  - id: N
    type:
    ...
    doc: Threshold value for comparison commands (e.g., less-than N, 
      greater-than N, equal-to N, not-equal-to N)
    inputBinding:
      position: 2
  - id: X
    type:
      - 'null'
      - string
    doc: Value for arithmetic operations (e.g., increase X, decrease X, multiply
      X, divide X, modulo X)
    inputBinding:
      position: 3
  - id: input_files
