...
#### Modified: 5 Dec 2017. Compiled: 30 Oct 2025

# Contents

* [0.0.1 Combat](#combat)
* [0.0.2 statTargetGUI](#stattargetgui)
* [0.0.3 Running Signal Correction (the shiftCor function) from the GUI](#running-signal-correction-the-shiftcor-function-from-the-gui)
* [0.1 References](#references)
...
### 0.0.3 Running Signal Correction (the shiftCor function) from the GUI
...
2. Order: The concent can be replaced by covariates if the mod.covariates (See shiftCor\_dQC function) is TRUE.
