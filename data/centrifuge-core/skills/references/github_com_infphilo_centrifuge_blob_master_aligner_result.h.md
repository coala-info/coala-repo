...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Finfphilo%2Fcentrifuge%2Fblob%2Fmaster%2Faligner_result.h)
...
[History](/infphilo/centrifuge/commits/master/aligner_result.h)
...
[Raw](https://github.com/infphilo/centrifuge/raw/refs/heads/master/aligner_result.h)
...
#ifndef ALIGNER\_RESULT\_H\_

#define ALIGNER\_RESULT\_H\_
...
typedef int64\_t TAlScore;

#define VALID\_AL\_SCORE(x) ((x).score\_ > MIN\_I64)

#define VALID\_SCORE(x) ((x) > MIN\_I64)

#define INVALIDATE\_SCORE(x) ((x) = MIN\_I64)
...
return VALID\_AL\_SCORE(\*this) && VALID\_AL\_SCORE(o) && score\_ == o.score\_;
...
if(!VALID\_AL\_SCORE(o)) {

if(!VALID\_AL\_SCORE(\*this)) {
...
TAlScore score() const { return score\_; }
