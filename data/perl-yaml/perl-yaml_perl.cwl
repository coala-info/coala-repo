...
baseCommand: perl
label: perl-yaml_perl
doc: "The Perl 5 language interpreter\n\nTool homepage: https://github.com/ingydotnet/yaml-pm"
inputs:
  - id: program_file
    type:
      - 'null'
...
hints:
  - class: DockerRequirement
    dockerPull: quay.io/biocontainers/perl-yaml:1.30--pl5321hdfd78af_0
stdout: perl-yaml_perl.out
