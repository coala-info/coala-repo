...
phyloP --subtree human-mouse\_lemur neutral.mod alignment.fa > report.txt
Here human-mouse\_lemur denote the most recent common ancestor of human
and mouse\_lemur, which is the node that defines the primate clade in
this phylogeny. The tree\_doctor program with the --name-ancestors
...
in primates.
phyloP --wig-scores --method LRT --subtree human-mouse\_lemur \
