...
### Tool Description
The provided text does not contain help information or usage instructions for spydrpick; it contains container runtime error logs.
...
FATAL:   Unable to handle docker://quay.io/biocontainers/spydrpick:1.2.0--h78a066a_0 uri: while building SIF from layers: conveyor failed to get: invalid character '}' after top-level value
```
