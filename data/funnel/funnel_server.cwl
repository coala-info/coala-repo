...
baseCommand:
  ...
  - server
label: funnel_server
doc: "Funnel server commands.\n\nTool homepage: https://ohsu-comp-bio.github.io/funnel/"
inputs:
  - id: command
    type:
      - 'null'
      - string
    doc: Command to run (e.g., 'run')
    inputBinding:
      position: 1
  ...
  - id: awsbatch_job_definition
    ...
    inputBinding:
      position: 102
      prefix: --AWSBatch.JobDefinition
  - id: awsbatch_job_queue
    type:
      - 'null'
      - string
    doc: AWS Batch job queue name or ARN
    inputBinding:
      position: 102
      prefix: --AWSBatch.JobQueue
  - id: awsbatch_max_retries
    type:
      - 'null'
      - int
    doc: Maximum number of times that a request will be retried for failures
    inputBinding:
      position: 102
      prefix: --AWSBatch.MaxRetries
  - id: awsbatch_region
    type:
      - 'null'
      - string
    doc: AWS region of Batch resources
    inputBinding:
      position: 102
      prefix: --AWSBatch.Region
  - id: boltdb_path
    type:
      - 'null'
      - string
  ...
  - id: grid_engine_template
    type:
      - 'null'
      - File
    doc: Path to submit template file
    inputBinding:
      position: 102
      prefix: --GridEngine.Template
  - id: htcondor_template
    type:
      - 'null'
      - File
    doc: Path to submit template file
  ...
  - id: scheduler_node_dead_timeout
    type:
      - 'null'
      - string
  ...
  - id: scheduler_node_init_timeout
    type:
      - 'null'
      - string
  ...
  - id: scheduler_node_ping_timeout
    type:
      - 'null'
      - string
  ...
  - id: scheduler_schedule_chunk
    type:
      - 'null'
      - int
    doc: How many tasks to schedule in one iteration
    inputBinding:
      position: 102
      prefix: --Scheduler.ScheduleChunk
  - id: scheduler_schedule_rate
    type:
      - 'null'
      - string
  ...
  - id: slurm_template
    ...
    inputBinding:
      position: 102
      prefix: --Slurm.Template
  - id: swift_chunk_size_bytes
    type:
      - 'null'
      - int
