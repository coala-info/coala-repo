...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2FAstrobioMike%2FGToTree%2Fwiki%2FThings-to-consider)
...
Mike Lee edited this page May 13, 2025
·
[26 revisions](/AstrobioMike/GToTree/wiki/Things-to-consider/_history)
...
This is generally way too many to practically make a phylogenomic tree out of. But if we limit to the search to [NCBI representative genomes](https://www.ncbi.nlm.nih.gov/refseq/about/prokaryotes/#representative_genomes) only, it cuts them down to 83:
...
While there are 80 representative ones they've deemed as [species clusters](https://gtdb.ecogenomic.org/faq#gtdb_species_clusters):
...
The above cuts the number of reference genomes to include *drastic