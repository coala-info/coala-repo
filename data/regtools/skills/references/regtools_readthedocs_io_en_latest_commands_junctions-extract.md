...
* Search
* [Previous](../cis-ase-identify/)
* [Next](../junctions-annotate/)

* [Overview of junctions extract command](#overview-of-junctions-extract-command)
  + [Usage](#usage)
  + [Input](#input)
  + [Options](#options)
  + [Output](#output)
...
| Input | Description |
| --- | --- |
| indexed\_alignments.bam | Aligned RNAseq BAM/CRAM which has been indexed for example with `samtools index`. We have tested this command with alignments from TopHat. |
