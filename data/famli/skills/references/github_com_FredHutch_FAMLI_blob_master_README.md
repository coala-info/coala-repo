...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2FFredHutch%2FFAMLI%2Fblob%2Fmaster%2FREADME.md)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fblob%2Fshow&source=header-repo&source_repo=FredHutch%2FFAMLI)
...
[History](/FredHutch/FAMLI/commits/master/README.md)

History

287 lines (219 loc) · 13.1 KB
...
[Raw](https://github.com/FredHutch/FAMLI/raw/refs/heads/master/README.md)
...
[![Docker Repository on Quay](https://camo.githubusercontent.com/28c478f8a722bc638119ddacb0abeb599951173c88513f88e73ef9dcb4947c47/68747470733a2f2f717561792e696f2f7265706f7369746f72792f66686372632d6d6963726f62696f6d652f66616d6c692f737461747573 "Docker Repository on Quay")](https://quay.io/repository/fhcrc-microbiome/famli)
...
* For reference A and reference B that both have some aligning query reads, if **there is *uneven* depth for reference A**
...
* If **read #1 aligns equally-well to reference A and reference C**, but **there is *2x more* read depth for reference A as
...
> For all query *i*,
> if Lij < scale \* Lmaxi,
> then Bitscoreij is set to zero.

By default the scale here is set to 0.9 (or 90% of the maximum likelihood for query *i*).

This process (recalculate Wij, calculate the TOTj for each refrence *j*, and then calculate a
Lij using the new Wij and TOTj) is **repeated iteratively until no more alignments
