...
* [Workflows](../workflows.html)
  ...
  + RNA-seq
    - [Workflow overview (simplified)](#workflow-overview-simplified)
      ...
      * [Gene quantification methods](#gene-quantification-methods)
    ...
    - [Best practices](#best-practices)
      * [Genome assembly and gene annotation](#genome-assembly-and-gene-annotation)
      * [Aligners: STAR vs HISAT2](#aligners-star-vs-hisat2)
      * [Quantifier: counts vs quantification](#quantifier-counts-vs-quantification)
      * [Genome/Aligner/Quantifier](#genome-aligner-quantifier)
...
* [Workflows](../workflows.html)
* RNA-seq
* [Edit on GitHub](https://github.com/vanheeringen-lab/seq2science/blob/master/docs/content/workflows/rna_seq.md)

---

# RNA-seq[](#rna-seq "Link to this heading")
...
An example quality control report can be [viewed here](https://vanheeringen-lab.github.io/seq2science/_static/rna_seq_multiqc.html).
...
### Strandedness[](#strandedness "Link to this heading")
...
### Gene quantification methods[](#gene-quantification-methods "Link to this heading")
...
#### Gene counts (with HTSeq/featureCounts)[](#gene-counts-with-htseq-featurecounts "Link to this heading")
...
#### Gene abundances (with Salmon)[](#gene-abundances-with-salmon "Link to this heading")
...
### Differential gene expression analysis[](#differential-gene-expression-analysis "Link to this heading")
...
### Differential transcript usage[](#differential-transcript-usage "Link to this heading")
...
### Differential exon usage[](#differential-exon-usage "Link to this heading")
...
### Genome assembly and gene annotation[](#genome-assembly-and-gene-annotation "Link to this heading")
...
Installing the desired genome and gene annotation in the {genomes\_dir} will cause seq2science to use these files.

If the genome/annotation is missing from the {genomes\_dir}, seq2science will attempt to download the named assembly from Ensembl, UCSC and the NCBI (in that order).

### Aligners: STAR vs HISAT2[](#aligners-star-vs-hisat2 "Link to this heading")

Both aligners have been found to perform well.
Selection should be dependent on familiarity and configuration options.

### Quantifier: counts vs quantification[](#quantifier-counts-vs-quantification "Link to this heading")
...
### Genome/Aligner/Quantifier[](#genome-aligner-quantifier "Link to this heading")

The most significant choice to 