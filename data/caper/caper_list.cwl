...
inputs:
  ...
  - id: format
    type:
      - 'null'
      - string
    doc: Comma-separated list of items to be shown for "list" subcommand. Any 
      key name in workflow JSON from Cromwell server's response is allowed. 
  ...
  - id: hide_result_before
    type:
      - 'null'
      - string
    doc: Hide workflows submitted before this date/time. Use the same (or 
      shorter) date/time format shown in "caper list". e.g. 2019-06-13, 
      2019-06-13T10:07
    inputBinding:
      position: 102
