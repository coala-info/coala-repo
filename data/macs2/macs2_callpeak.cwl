...
doc: "Model-based Analysis of ChIP-Seq (MACS2) for identifying transcript factor binding
...
inputs:
  ...
  - id: trackline
    type:
      - 'null'
      - boolean
    doc: Tells MACS to include trackline with bedGraph files. Requires -B to be 
      set.
    inputBinding:
      position: 101
      prefix: --trackline
