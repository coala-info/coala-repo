...
label: clusterfunk_the
doc: "A tool for phylogenetic tree manipulation and annotation. It provides various
  subcommands to process, prune, graft, and annotate trees.\n\nTool homepage: https://github.com/cov-ert/clusterfunk"
inputs:
  - id: subcommand
    type: string
    doc: 'The subcommand to execute. Valid choices: phylotype, phylotype_dat_tree,
