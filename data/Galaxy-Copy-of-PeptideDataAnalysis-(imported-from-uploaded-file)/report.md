# Copy of PeptideDataAnalysis (imported from uploaded file) CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://training.galaxyproject.org
- **Package**: https://workflowhub.eu/workflows/1389
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1389/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 281
...
- **Main workflow (WorkflowHub):** `peptidedataanalysis.ga` (Main Workflow)
