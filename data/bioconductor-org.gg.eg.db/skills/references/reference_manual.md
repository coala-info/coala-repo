...
org.Gg.egACCNUM is an R object that contains mappings between Entrez Gene identifiers and
...
org.Gg.egALIAS is an R object that provides mappings between common gene symbol identifiers
...
Welcome to the org.Gg.eg.db annotation Package. This is an organism specific package. The pur-
pose is to provide detailed information about the species abbreviated in the second part of the
package name org.Gg.eg.db. This package is updated biannually.
...
org.Gg.egCHR is an R object that provides mappings between entrez gene identifiers and the chro-
...
org.Gg.egCHRLENGTHS provides the length measured in base pairs for each of the chromosomes.
...
org.Gg.egCHRLOC is an R object that maps entrez gene identifiers to the starting position of the
...
Mappings were based on data provided by: UCSC Genome Bioinformatics (Gallus gallus) ftp://hgdownload.cse.ucsc.edu/goldenPath/galGal6/database
...
org.Gg.egENSEMBL is an R object that contains mappings between Entrez Gene identifiers and
...
# Convert to a list
xx <- as.list(org.Gg.egENSEMBL2EG)
if(length(xx) > 0){
...
org.Gg.egENSEMBLPROT Map Ensembl protein acession numbers with Entrez Gene identifiers
...
# Convert to a list
xx <- as.list(org.Gg.egENSEMBLPROT2EG)
if(length(xx) > 0){
...
org.Gg.egENSEMBLTRANS

org.Gg.egENSEMBLTRANS Map Ensembl transcript acession numbers with Entrez Gene identi-
...
# Convert to a list
xx <- as.list(org.Gg.egENSEMBLTRANS2EG)
if(length(xx) > 0){
...
org.Gg.egENZYME is an R object that provides mappings between entrez gene identifiers and EC
numbers.
...
numbers. In org.Gg.egENZYME2EG, EC is dropped from the Enzyme Commission numbers.
...
org.Gg.egGENENAME is an R object that maps entrez gene identifiers to the corresponding gene
name.
...
org.Gg.egGENETYPE is an R object that provides mappings between entrez gene identifiers and
gene types.
...
org.Gg.egGO is an R object that provides mappings between entrez gene identifiers and the GO
...
org.Gg.egGO2ALLEGS is an R object that provides mappings between a given GO identifier and
all of the Entrez Gene identifiers annotated at that GO term OR TO ONE OF IT’S CHILD NODES
in the GO ontology. Thus, this mapping is much larger and more inclusive than org.Gg.egGO2EG.

Details

If org.Gg.egGO is cast as a list, each Entrez Gene identifier is mapped to a list of lists. The names on
...
If org.Gg.egGO2ALLEGS or org.Gg.egGO2EG is cast as a list, each GO term maps to a named
...
Number of mapped keys for the maps in package org.Gg.eg.db

Description

org.Gg.egMAPCOUNTS provides the "map count" (i.e. the count of mapped keys) for each map in
...
## Check the "map count" of all the maps in package org.Gg.eg.db
checkMAPCOUNTS("org.Gg.eg.db")

org.Gg.egORGANISM

The Organism for org.Gg.eg

Description

org.Gg.egORGANISM is an R object that contains a single item: a character string that names the
organism for which org.Gg.eg was built.

Details

Although the package name is suggestive of the organism for which it was built, org.Gg.egORGANISM
...
isms. org.Gg.egPATH maps entrez gene identifiers to the identifiers used by KEGG for pathways
...
org.Gg.egPFAM is an R object that provides mappings between manufacturer identifiers and PFAM
identifiers.
...
org.Gg.egPMID is an R object that provides mappings between entrez gene identifiers and PubMed
identifiers.
...
org.Gg.egPROSITE is an R object that provides mappings between manufacturer identifiers and
PROSITE identifiers.
...
org.Gg.egREFSEQ is an R object that provides mappings between entrez gene identifiers and Ref-
Seq identifiers.
...
org.Gg.egSYMBOL is an R object that provides mappings between entrez gene identifiers and gene
abbreviations.
...
org.Gg.egUNIPROT is an R object that contains mappings between Entrez Gene identifiers and
...
org.Gg.eg_dbconn()
org.Gg.eg_dbfile()
org.Gg.eg_dbschema(file="", show.indices=FALSE)
org.Gg.eg_dbInfo()
...
org.Gg.eg_dbconn returns a connection object to the package annotation DB. IMPORTANT: Don’t
call dbDisconnect on the connection object returned by org.Gg.eg_dbconn or you will break all
the AnnDbObj objects defined in this package!
org.Gg.eg_dbfile returns the path (character string) to the package annotation DB (this is an
SQLite file).
org.Gg.eg_dbschema prints the schema definition of the package annotation DB.
org.Gg.eg_dbInfo prints other information about the package annotation DB.

Value

org.Gg.eg_dbconn: a DBIConnection object representing an open connection to the package an-
notation DB.
org.Gg.eg_dbfile: a character string with the path to the package annotation DB.
org.Gg.eg_dbschema: none (invisible NULL).
org.Gg.eg_dbInfo: none (invisible NULL).
...
dbGetQuery(org.Gg.eg_dbconn(), "SELECT COUNT(*) FROM genes")
...
org.Gg.egALIAS2EG, 2
org.Gg.egCHR, 3
org.Gg.egCHRLENGTHS, 4
org.Gg.egCHRLOC, 5
org.Gg.egENSEMBL, 6
org.Gg.egENSEMBLPROT, 7
org.Gg.egENSEMBLTRANS, 8
org.Gg.egENZYME, 9
org.Gg.egGENENAME, 10
org.Gg.egGENETYPE, 11
org.Gg.egGO, 12
org.Gg.egMAPCOUNTS, 14
org.Gg.egORGANISM, 15
org.Gg.egPATH, 15
org.Gg.egPFAM, 16
org.Gg.egPMID, 17
org.Gg.egPROSITE, 18
...
org.Gg.eg (org.Gg.eg.db), 3
org.Gg.eg.db, 3

org.Gg.eg_dbconn, 21
org.Gg.eg_dbfile (org.Gg.eg_dbconn), 21
org.Gg.eg_dbInfo (org.Gg.eg_dbconn), 21
org.Gg.eg_dbschema (org.Gg.eg_dbconn),

21
org.Gg.egACCNUM, 1
org.Gg.egACCNUM2EG (org.Gg.egACCNUM), 1
org.Gg.egALIAS2EG, 2
org.Gg.egCHR, 3
org.Gg.egCHRLENGTHS, 4
org.Gg.egCHRLOC, 5
org.Gg.egCHRLOCEND (org.Gg.egCHRLOC), 5
org.Gg.egENSEMBL, 6
org.Gg.egENSEMBL2EG (org.Gg.egENSEMBL),

6

org.Gg.egENSEMBLPROT, 7
org.Gg.egENSEMBLPROT2EG

(org.Gg.egENSEMBLPROT), 7

org.Gg.egENSEMBLTRANS, 8
org.Gg.egENSEMBLTRANS2EG

(org.Gg.egENSEMBLTRANS), 8

org.Gg.egENZYME, 9
org.Gg.egENZYME2EG (org.Gg.egENZYME), 9
org.Gg.egGENENAME, 10
org.Gg.egGENETYPE, 11
org.Gg.egGO, 12
org.Gg.egGO2ALLEGS, 13
org.Gg.egGO2ALLEGS (org.Gg.egGO), 12
org.Gg.egGO2EG (org.Gg.egGO), 12
org.Gg.egMAPCOUNTS, 14
org.Gg.egORGANISM, 15
org.Gg.egPATH, 15
org.Gg.egPATH2EG (org.Gg.egPATH), 15
org.Gg.egPFAM, 16
org.Gg.egPMID, 17
org.Gg.egPMID2EG (org.Gg.egPMID), 17
org.Gg.egPROSITE, 18
org.Gg.egREFSEQ, 18
org.Gg.egREFSEQ2EG (org.Gg.egREFSEQ), 18
org.Gg.egSYMBOL, 20
org.Gg.egSYMBOL2EG (org.Gg.egSYMBOL), 20
org.Gg.egUNIPROT, 21
