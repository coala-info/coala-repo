...
* [next](history.html "Release History") |
* [previous](quick-start.html "Quick start") |
* [bedtools v2.31.0](../index.html) »

# General usage[¶](#general-usage "Permalink to this headline")

## Supported file formats[¶](#supported-file-formats "Permalink to this headline")

### BED format[¶](#bed-format "Permalink to this headline")
...
### BEDPE format[¶](#bedpe-format "Permalink to this headline")
...
### GFF format[¶](#gff-format "Permalink to this headline")
...
### *Genome* file format[¶](#genome-file-format "Permalink to this headline")
...
### SAM/BAM format[¶](#sam-bam-format "Permalink to this headline")
...
### VCF format[¶](#vcf-format "Permalink to this headline")
...
* General usage
  + [Supported file formats](#supported-file-formats)
    ...
    - [*Genome* file format](#genome-file-format)
    - [SAM/BAM format](#sam-bam-format)
    - [VCF format](#vcf-format)

#### Previous topic

[Quick start](quick-start.html "previous chapter")

#### Next topic

[Release History](history.ht