...
[Skip to content](#before-you-start)
...
[mdu-phl/tbtamr](https://github.com/mdu-phl/tbtamr "Go to repository")
...
* [ ]
  ...
  + [Before you start](#before-you-start)
    ...
    - [Is your vcf file correctly formatted?](#is-your-vcf-file-correctly-formatted)
    - [Have you installed tbtAMR to run the way you want to run?](#have-you-installed-tbtamr-to-run-the-way-you-want-to-run)

      * [A note on lineage calling.](#a-note-on-lineage-calling)
  + [Generating genomic DST using default criteria (tbtAMR defaults)](#generating-genomic-dst-using-default-criteria-tbtamr-defaults)

    - [VCF input](#vcf-input)
    - [paired-end reads input](#paired-end-reads-input)
    - [Add phylogenetic lineage to outputs](#add-phylogenetic-lineage-to-outputs)
  + [Generating genomic DST using custom criteria](#generating-genomic-dst-using-custom-criteria)
  + [Use tbtAMR to generate annotated VCF file (no DST)](#use-tbtamr-to-generate-annotated-vcf-file-no-dst)
  + [Search your catalogue for variant information](#search-your-catalogue-for-variant-information)
  + [Output files](#output-files)
* [Customisation](../customisation/)
* [Cascade reporting](../cascade_reporting/)
...
By default, `tbtAMR` does not call lineage for *M. tuberculosis*, you can do this if you like by following the installation instructions [here](https://github.com/MDU-PHL/tbtamr/wiki/Installation#tbtamr-and-lineage-calling) and using the `--call_lineage` flag.
