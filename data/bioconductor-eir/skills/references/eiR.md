...
Note: the most recent version of this tutorial can be found [here](https://htmlpreview.github.io/?https://github.com/girke-lab/eiR/blob/master/vignettes/eiR.html) and a short overview slide show [here](http://faculty.ucr.edu/~tgirke/HTML_Presentations/Manuals/Workshop_Dec_5_8_2014/Rcheminfo/Cheminfo.pdf).
...
employed to allow sub-linear time nearest neighbor lookups (Dong, Wang, Charikar, et al. [2008](#ref-Dong2008-ib); Dong, Wang, Josephson, et al. [2008](#ref-Dong2008-kn))
...
as well (Jarvis and Patrick [1973](#ref-Jarvis1973-lp)). For details on the whole process see (Cao, Jiang, and Girke [2010](#ref-Cao2010-ir)).
...
(Dimitris K. Agrafiotis, Dmitrii N. Rassokhin, Victor S. Lobanov [2001](#ref-Dimitris_K_Agrafiotis_Dmitrii_N_Rassokhin_Victor_S_Lobanov2001-eq)).
...
## 8  650046 650056  0.2800481        252
## 9  650046 650076  0.2740260        271
## 10 650046 650039  0.2739234        238
```
...
```
## average embedding performance: 0.469766224842216
```
...
```
## average indexing performance: 0.822977720115215
```

```
## [1] 0.8756405 0.9416555 0.5192304 0.6708904 0.9603344 0.7718041 0.9485619 0.9464427 0.7722396
```
...
[1] ChemmineOB\_1.48.0 RSQLite\_2.4.3 eiR\_1.50.0 DBI\_1.2.3 ChemmineR\_3.62.0
[6] BiocStyle\_2.38.0

loaded via a namespace (and not attached):
[1] sass\_0.4.10 generics\_0.1.4 bitops\_1.0-9 digest\_0.6.37
[5] magrittr\_2.0.4 evaluate\_1.0.5 grid\_4.5.1 RColorBrewer\_1.1-3
[9] bookdown\_0.45 blob\_1.2.4 fastmap\_1.2.0 jsonlite\_2.0.0
[13] snowfall\_1.84-6.3 tinytex\_0.57 gridExtra\_2.3 BiocManager\_1.30.26
[17] scales\_1.4.0 codetools\_0.2-20 jquerylib\_0.1.4 cli\_3.6.5
[21] rlang\_1.1.6 RcppAnnoy\_0.0.22 bit64\_4.6.0-1 base64enc\_0.1-3
[25] cachem\_1.1.0 yaml\_2.3.10 tools\_4.5.1 parallel\_4.5.1
[29] memoise\_2.0.1 dplyr\_1.1.4 ggplot2\_4.0.0 DT\_0.34.0
[33] vctrs\_0.6.5 R6\_2.6.1 png\_0.1-8 magick\_2.9.0
[37] lifecycle\_1.0.4 rsvg\_2.7.0 bit\_4.6.0 htmlwidgets\_1.6.4
[41] pkgconfig\_2.0.3 pillar\_1.11.1 bslib\_0.9.0 gtable\_0.3.6
[45] glue\_1.8.0 Rcpp\_1.1.0 xfun\_0.53 tibble\_3.3.0
[49] tidyselect\_1.2.1 knitr\_1.50 dichromat\_2.0-0.1 farver\_2.1.2
[53] rjson\_0.2.23 htmltools\_0.5.8.1 snow\_0.4-4 rmarkdown\_2.30
[57] compiler\_4.5.1 S7\_0.2.0 RCurl\_1.98-1.17
...
Cao, Y, T Jiang, and T Girke. 2010. “Accelerated Similarity Searching and Clustering of Large Compound Sets by Geometric Embedding and Locality Sensitive Hashing.” *Bioinformatics* 26 (7): 953–59. <https://doi.org/10.1093/bioinformatics/btq067>.

Dimitris K. Agrafiotis, Dmitrii N. Rassokhin, Victor S. Lobanov. 2001. “Multidimensional Scaling and Visualization of Large Molecular Similarity Tables.” In *Journal of Computational Chemistry*. <http://citeseerx.ist.psu.edu/viewdoc/summary?doi=10.1.1.84.2995>.

Dong, Wei, Zhe Wang, Moses Charikar, and Kai Li. 2008. “Efficiently Matching Sets of Features with Random Histograms.” In *Proceedings of the 16th ACM International Conference on Multimedia*, 179–88. MM ’08. New York, NY, USA: ACM. <https://doi.org/10.1145/1459359.1459384>.

Dong, Wei, Zhe Wang, William Josephson, Moses Charikar, and Kai Li. 2008. “Modeling LSH for Performance Tuning.” In *Proceedings of the 17th ACM Conference on Information and Knowledge Management*, 669–78. ACM. <https://doi.org/10.1145/1458082.1458172>.

Jarvis, RA, and EA Patrick. 1973. “Clustering Using a Similarity Measure Based on Shared Near Neighbors.” *IEEE Trans. Comput.* 22 (11): 1025–34.