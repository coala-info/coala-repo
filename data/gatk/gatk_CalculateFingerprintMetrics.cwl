...
label: gatk_CalculateFingerprintMetrics
...
inputs:
  ...
  - id: calculate_by
    type:
      - 'null'
      - string
    doc: Specificies which data-type should be used as the basic unit. 
      Fingerprints from readgroups can be "rolled-up" to the LIBRARY, SAMPLE, or
      FILE level before being used. Fingerprints from VCF can be be examined by 
      SAMPLE or FILE.
    inputBinding:
      position: 101
      prefix: --CALCULATE_BY
