...
# Graph type[#](#graph-type "Direct link to this section")
...
# Heatmap scale[#](#heatmap-scale "Direct link to this section")
...
![ ](../../img/heatmap-scale.png)

# Windowing function[#](#windowing-function "Direct link to this section")
...
# Overlaying tracks[#](#overlaying-tracks "Direct link to this section")
...
Quantitative data tracks can also be [combined using arithmetic operators](../../tools/combine_tracks/) via *Tools > Combine Data Tracks*.