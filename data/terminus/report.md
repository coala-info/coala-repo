...
### Tool Description
The provided text does not contain help information or usage instructions for the tool 'terminus'. It appears to be a log of a failed container build process.
...
FATAL:   Unable to handle docker://quay.io/biocontainers/terminus:v0.1.0--h2db0a6b_0 uri: while building SIF from layers: conveyor failed to get: invalid character '}' after top-level value
```
