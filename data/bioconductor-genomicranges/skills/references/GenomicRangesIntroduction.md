...
* [2 *GRanges*: Genomic Ranges](#granges-genomic-ranges)
  + [2.1 Splitting and combining *GRanges* objects](#splitting-and-combining-granges-objects)
  + [2.2 Subsetting *GRanges* objects](#subsetting-granges-objects)
  + [2.3 Basic interval operations for *GRanges* objects](#basic-interval-operations-for-granges-objects)
  + [2.4 Interval set operations for *GRanges* objects](#interval-set-operations-for-granges-objects)
* [3 *GRangesList*: Groups of Genomic Ranges](#grangeslist-groups-of-genomic-ranges)
  + [3.1 Basic *GRangesList* accessors](#basic-grangeslist-accessors)
  + [3.2 Combining *GRangesList* objects](#combining-grangeslist-objects)
  + [3.3 Basic interval operations for *GRangesList* objects](#basic-interval-operations-for-grangeslist-objects)
  + [3.4 Subsetting *GRangesList* objects](#subsetting-grangeslist-objects)
  + [3.5 Looping over *GRangesList* objects](#looping-over-grangeslist-objects)
* [4 Interval overlaps involving *GRanges* and *GRangesList* objects](#interval-overlaps-involving-granges-and-grangeslist-objects)
* [5 Finding the nearest genomic position in *GRanges* objects](#finding-the-nearest-genomic-position-in-granges-objects)
* [6 Session Information](#session-information)

# 1 Introduction

The *[GenomicRanges](https://bioconductor.org/packages/3.22/GenomicRanges)* package serves as the foundation for
representing genomic locations within the Bioconductor project.
In the Bioconductor package hierarchy, it builds upon the
*[IRanges](https://bioconductor.org/packages/3.22/IRanges)* (infrastructure) package and provides
support for the *[BSgenome](https://bioconductor.org/packages/3.22/BSgenome)* (infrastructure),
*[Rsamtools](https://bioconductor.org/packages/3.22/Rsamtools)* (I/O), *[ShortRead](https://bioconductor.org/packages/3.22/ShortRead)* (I/O & QA),
*[rtracklayer](https://bioconductor.org/packages/3.22/rtracklayer)* (I/O), *[GenomicFeatures](https://bioconductor.org/packages/3.22/GenomicFeatures)*
(infrastructure), *[GenomicAlignments](https://bioconductor.org/packages/3.22/GenomicAlignments)* (sequence reads),
*[VariantAnnotation](https://bioconductor.org/packages/3.22/VariantAnnotation)* (called variants), and many other
...
The *[GenomicRanges](https://bioconductor.org/packages/3.22/GenomicRanges)* package is available at
...
The *[GenomicRanges](https://bioconductor.org/packages/3.22/GenomicRanges)* help page `?"intra-range-methods"`
...
See the *[GenomicRanges](https://bioconductor.org/packages/3.22/GenomicRanges)* help page
...
*GRangesList* objects. To this end, the *[GenomicRanges](https://bioconductor.org/packages/3.22/GenomicRanges)*
...
The *[GenomicRanges](https://bioconductor.org/packages/3.22/GenomicRanges)* package provides multiple functions to
...
*[TxDb.Hsapiens.UCSC.hg38.knownGene](https://bioconductor.org/packages/3.22/TxDb.Hsapiens.UCSC.hg38.knownGene)* extracted using the `genes`
method from the *[GenomicFeatures](https://bioconductor.org/packages/3.22/GenomicFeatures)* package.
...
```
##  [1] 5098 4437 4437 4956   97   97   NA   NA   NA   NA
```
...
```
##  [1]   NA 4437 4437 4437   97   97   NA   NA   NA   NA
```
...
```
##  [1] 5098   NA   NA 4956 5098   NA   NA   NA   NA   NA
```
...
```
## IntegerList of length 10
## [[1]] 5098 814 4999 2256 5294 2315 435 800 2804 2314
## [[2]] 4437 514 2573 1164 444 524 1165 1166 1208 5232
## [[3]] 4437 514 2573 1164 444 524 1165 1166 1208 5232
## [[4]] 4956 4437 514 2573 1164 444 524 1165 1166 1208
## [[5]] 97 814 1924 131 5394 916 2316 1576 2317 4083
## [[6]] 97 1924 131 5394 916 2316 1576 2317 4083 4974
## [[7]] <NA>
## [[8]] <NA>
## [[9]] <NA>
## [[10]] <NA>
...
## [25] yaml_2.3.11                 crayon_1.5.3
## [27] jquerylib_0.1.4             BiocParallel_1.44.0
## [29] cachem_1.1.0                DelayedArray_0.36.0
## [31] abind_1.4-8                 digest_0.6.39
## [33] restfulr_0.0.16             bookdown_0.46
## [35] fastmap_1.2.0               grid_4.5.2
## [37] cli_3.6.5                   SparseArray_1.10.6
## [39] S4Arrays_1.10.1             XML_3.99-0.20
## [41] bit64_4.6.0-1               rmarkdown_2.30
## [43] XVector_0.50.0              httr_1.4.7
## [45] matrixStats_1.5.0           bit_4.6.0
## [47] png_0.1-8                   memoise_2.0.1
## [49] evaluate_1.0.5              knitr_1.50
## [51] BiocIO_1.20.0               rtracklayer_1.70.0
## [53] rlang_1.1.6                 DBI_1.2.3
