...
baseCommand:
  ...
  - cut
label: csvtk_cut
doc: "select and arrange fields\n\nTool homepage: https://github.com/shenwei356/csvtk"
inputs:
  - id: allow_missing_col
    type:
      - 'null'
      - boolean
    doc: allow missing column
    inputBinding:
      position: 101
      prefix: --allow-missing-col
  - id: blank_missing_col
    type:
      - 'null'
      - boolean
    doc: blank missing column, only for using column fields
    inputBinding:
      position: 101
      prefix: --blank-missing-col
  - id: comment_char
    type:
      - 'null'
      - string
  ...
  - id: fields
    type:
      - 'null'
      - string
    doc: select only these fields. type "csvtk cut -h" for examples
    inputBinding:
      position: 101
      prefix: --fields
  - id: fuzzy_fields
  ...
  - id: uniq_column
    type:
      - 'null'
      - boolean
    doc: deduplicate columns matched by multiple fuzzy column names
    inputBinding:
      position: 101
      prefix: --uniq-column
outputs:
