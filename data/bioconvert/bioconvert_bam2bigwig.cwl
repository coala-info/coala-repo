...
baseCommand: bioconvert bam2bigwig
label: bioconvert_bam2bigwig
doc: "Convert file from ('BAM',) to ('BIGWIG',) format. See bioconvert.readthedocs.io
...
inputs:
  ...
  - id: chrom_sizes
    type:
      - 'null'
      - File
    doc: 'a two-column file/URL: <chromosome name> <size in bases>. Used by the ucsc
      method only'
    inputBinding:
      position: 102
      prefix: --chrom-sizes
