...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2FRoth-Lab%2FPhyClone)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E&source=header-repo&source_repo=Roth-Lab%2FPhyClone)
...
[Branches](/Roth-Lab/PhyClone/branches)[Tags](/Roth-Lab/PhyClone/tags)
...
| --- | --- | --- | --- | --- |
| Latest commit   History[877 Commits](/Roth-Lab/PhyClone/commits/main/)   877 Commits | | |
| [.github/workflows](/Roth-Lab/PhyClone/tree/main/.github/workflows "This path skips through empty directories") | | [.github/workflows](/Roth-Lab/PhyClone/tree/main/.github/workflows "This path skips through empty directories") |  |  |
| [examples/data](/Roth-Lab/PhyClone/tree/main/examples/data "This path skips through empty directories") | | [examples/data](/Roth-Lab/PhyClone/tree/main/examples/data "This path skips through empty directories") |  |  |
| [phyclone](/Roth-Lab/PhyClone/tree/main/phyclone "phyclone") | | [phyclone](/Roth-Lab/PhyClone/tree/main/phyclone "phyclone") |  |  |
| [.gitignore](/Roth-Lab/PhyClone/blob/main/.gitignore ".gitignore") | | [.gitignore](/Roth-Lab/PhyClone/blob/main/.gitignore ".gitignore") |  |  |
| [LICENSE.md](/Roth-Lab/PhyClone/blob/main/LICENSE.md "LICENSE.md") | | [LICENSE.md](/Roth-Lab/PhyClone/blob/main/LICENSE.md "LICENSE.md") |  |  |
| [MANIFEST.in](/Roth-Lab/PhyClone/blob/main/MANIFEST.in "MANIFEST.in") | | [MANIFEST.in](/Roth-Lab/PhyClone/blob/main/MANIFEST.in "MANIFEST.in") |  |  |
| [PhyClone\_apptainer.def](/Roth-Lab/PhyClone/blob/main/PhyClone_apptainer.def "PhyClone_apptainer.def") | | [PhyClone\_apptainer.def](/Roth-Lab/PhyClone/blob/main/PhyClone_apptainer.def "PhyClone_apptainer.def") |  |  |
| [README.md](/Roth-Lab/PhyClone/blob/main/README.md "README.md") | | [README.md](/Roth-Lab/PhyClone/blob/main/README.md "README.md") |  |  |
| [environment.yaml](/Roth-Lab/PhyClone/blob/main/environment.yaml "environment.yaml") | | [environment.yaml](/Roth-Lab/PhyClone/blob/main/environment.yaml "environment.yaml") |  |  |
| [pyproject.toml](/Roth-Lab/PhyClone/blob/main/pyproject.toml "pyproject.toml") | | [pyproject.toml](/Roth-Lab/PhyClone/blob/main/pyproject.toml "pyproject.toml") |  |  |
| View all files | | |
...
There is an example file in [examples/data/mixing.tsv](/Roth-Lab/PhyClone/blob/main/examples/data/mixing.tsv)
...
There is an example file in [examples/data/mixing\_clusters.tsv](/Roth-Lab/PhyClone/blob/main/examples/data/mixing_clusters.tsv)
...
Second, the output trace from the sampling `run` can be summarised as either a point-estimate tree ([MAP](#map-point-estimate-tree) or [Consensus](#cons