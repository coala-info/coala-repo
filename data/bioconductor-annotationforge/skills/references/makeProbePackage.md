...
* [1 Overview](#overview)
  + [1.1 For Affymetrix genechips](#for-affymetrix-genechips)
  + [1.2 For other chiptypes](#subsec.otherarraytypes)
...
First, let us load the *[AnnotationForge](https://bioconductor.org/packages/3.22/AnnotationForge)* package.
...
subdirectory of the *[AnnotationForge](https://bioconductor.org/packages/3.22/AnnotationForge)* package.
...
```
## Importing the data.
## Creating package in /tmp/RtmptvKrUY/hgu95av2probe
## Writing the data.
...
([1999](#ref-Rfoundation1999)). The input parameters of an import function are A prototype
for such a directory is provided within the package
*[AnnotationForge](https://bioconductor.org/packages/3.22/AnnotationForge)*. To facilitate the automated production of large
...
R Foundation. 1999. “Writing R Extensions.” <http://www.r-project.org>.