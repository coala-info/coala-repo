...
label: varfish-cli_projects
doc: "Varfish CLI tool for managing projects and data.\n\nTool homepage: https://github.com/bihealth/varfish-cli"
inputs:
  - id: api_token
    type: string
    doc: API token for authentication with the Varfish server.
    inputBinding:
      position: 101
      prefix: --api-token
  - id: server_url
...
stdout: varfish-cli_projects.out
