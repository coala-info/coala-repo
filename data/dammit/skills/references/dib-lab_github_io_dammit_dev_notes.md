...
[Skip to content](#for-dammit-developers)
...
* [x]
  ...
  + [ ]
    ...
    Table of contents
    - [Setting up your local computer for dammit development](#setting-up-your-local-computer-for-dammit-development)
    - [To-do for dammit](#to-do-for-dammit)

      * [Versioning](#versioning)
    - [Notes on dammit](#notes-on-dammit)

      * [Architecture:](#architecture)

        + [Take a look at code and tests in the dammit directory:](#take-a-look-at-code-and-tests-in-the-dammit-directory)
        + [config.json](#configjson)
        + [parallel.py](#parallelpy)
        + [ui.py](#uipy)
      * [TESTS!](#tests)
...
* `make-ci-test`, not long and not huge and not requires\_datbases
