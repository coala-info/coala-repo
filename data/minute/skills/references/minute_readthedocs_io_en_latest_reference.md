...
* Reference
  + [Use of minute command-line interface](#use-of-minute-command-line-interface)
  + [General options](#general-options)
  + [minute commands](#minute-commands)
    - [init](#init)
      * [Positional](#positional)
      * [Named](#named)
    - [download](#download)
    - [run](#run)
      * [Alternative target rules](#alternative-target-rules)
