...
[Skip to content](#how-to-train-instanovo-models)
...
* [x]
  ...
  + [Using Custom Datasets](../using_custom_datasets/)
  + [ ]
    ...
    - [Training InstaNovo (Transformer)](#training-instanovo-transformer)
    - [Training InstaNovo+ (Diffusion)](#training-instanovo-diffusion)
* [ ]
...
Before you can start training, you need to have your data in a format that InstaNovo can understand. The easiest way to do this is to use the `SpectrumDataFrame`. See the [how-to guide on using custom datasets](../using_custom_datasets/) for more details.

## Training InstaNovo (Transformer)

The InstaNovo transformer model is the base model that performs the initial *de novo* sequencing.
