...
[Skip to content](#post-filtering-reads)
...
* [x]
  ...
  + [ ]
    ...
    Table of contents
    - [Post-filtering reads](#post-filtering-reads)
    - [Usage](#usage)
    - [Scoring reads](#scoring-reads)
    - [Usage](#usage_1)
    - [Output](#output)

      * [Specifying the NCBI Taxonomy dump](#specifying-the-ncbi-taxonomy-dump)
      * [Specifying the lineage format](#specifying-the-lineage-format)
* [Releases](../release_notes/)
