...
### Metadata
- **Conda**: https://anaconda.org/channels/r/packages/r-minpack.lm/overview
- **R-project (CRAN)**: https://cloud.r-project.org/web/packages/minpack.lm/index.html
- **Home (project)**: https://CRAN.R-project.org/package=minpack.lm
- **Package**: minpack.lm
- **Version**: 1.2-4
