...
[Skip to content](#how-to-make-predictions-with-instanovo)
...
* [x]
  ...
  + [ ]
    ...
    - [Advanced Prediction Scenarios](#advanced-prediction-scenarios)

      * [Running only InstaNovo (Transformer)](#running-only-instanovo-transformer)
      * [Running only InstaNovo+ (Diffusion)](#running-only-instanovo-diffusion)
      * [Two-step prediction](#two-step-prediction)
...
* `--denovo`: Use this flag for *de novo* prediction on unannotated data.
