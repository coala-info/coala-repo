...
![The 'Fields >>' button.](data:image/png;base64...)

The ‘Fields >>’ button.

![Build your query with the drop-down menus.](data:image/png;base64...)
...
![Click the 'Search' button.](data:image/png;base64...)
...
![Copy the link to the tsv file.](data:image/png;base64...)
