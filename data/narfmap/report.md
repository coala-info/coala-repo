...
### Metadata
- **Docker Image**: quay.io/biocontainers/narfmap:1.4.2--h43eeafb_3
- **Homepage**: https://github.com/Emiller88/NARFMAP
- **Package**: https://anaconda.org/channels/bioconda/packages/narfmap/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/narfmap/overview
- **Total Downloads**: 3.2K
- **Last updated**: 2025-04-22
- **GitHub**: https://github.com/Emiller88/NARFMAP
- **Stars**: N/A
### Original Help Text
```text
...
Command line options:
  ...
  --mmap-reference arg (=0)                       memory-map reference data 
                                                  ...
                                                  to be aligned
  --num-threads arg (=20)                         Worker threads for 
...
std::exception::what: option '--h' is ambiguous and matches '--help', '--help-defaults', '--ht-anchor-bin-bits', '--ht-cost-coeff-seed-freq', '--ht-cost-coeff-seed-len', '--ht-cost-penalty', '--ht-cost-penalty-incr', '--ht-crc-extended', '--ht-crc-primary', '--ht-decoys', '--ht-dump-int-params', '--ht-ext-rec-cost', '--ht-ext-table-alloc', '--ht-mask-bed', '--ht-max-dec-factor', '--ht-max-ext-incr', '--ht-max-ext-seed-len', '--ht-max-multi-base-seeds', '--ht-max-seed-freq', '--ht-max-seed-freq-len', '--ht-max-table-chunks', '--ht-mem-limit', '--ht-methylated', '--ht-min-repair-prob', '--ht-num-threads', '--ht-override-size-check', '--ht-pri-max-seed-freq', '--ht-rand-hit-extend', '--ht-rand-hit-hifreq', '--ht-ref-seed-interval', '--ht-reference', '--ht-repair-strategy', '--ht-seed-len', '--ht-size', '--ht-sj-size', '--ht-soft-seed-freq-cap', '--ht-target-seed-freq', '--ht-test-only', '--ht-uncompress', and '--ht-write-hash-bin'
```
