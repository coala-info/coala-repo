# Code example from 'bioassayR' vignette. See references/ for full tutorial.
...
## ----eval=TRUE, warning=FALSE, tidy=FALSE---------------------------------------------------------
...
## ----eval=TRUE, warning=FALSE, echo=FALSE, message=FALSE------------------------------------------
...
## ----eval=FALSE, warning=FALSE, tidy=FALSE, message=FALSE-----------------------------------------
# library(cellHTS2)
# library(bioassayR)
# 
...
## ----eval=FALSE, warning=FALSE, tidy=FALSE--------------------------------------------------------
...
## ----eval=FALSE, warning=FALSE, echo=FALSE--------------------------------------------------------
# # delete temporary database
# unlink(myDatabaseFilename)
