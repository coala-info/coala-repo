---
name: ratatosk
description: Ratatosk is a specialized tool for hybrid error correction that significantly reduces the raw error rate of long reads (such as ONT R9.4 or R10).
