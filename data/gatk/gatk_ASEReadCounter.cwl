...
baseCommand:
  - gatk
  - ASEReadCounter
label: gatk_ASEReadCounter
doc: Counts filtered reads at het sites for allele specific expression estimate
inputs:
  - id: input
    type:
      type: array
  ...
  - id: count_overlap_reads_handling
    type:
      - 'null'
      - string
    ...
    inputBinding:
      position: 101
      prefix: --count-overlap-reads-handling
  ...
  - id: min_depth_of_non_filtered_base
    type:
      - 'null'
      - int
    ...
    inputBinding:
      position: 101
      prefix: --min-depth-of-non-filtered-base
