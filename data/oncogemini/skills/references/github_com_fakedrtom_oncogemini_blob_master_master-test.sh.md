...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Ffakedrtom%2Foncogemini%2Fblob%2Fmaster%2Fmaster-test.sh)
...
[History](/fakedrtom/oncogemini/commits/master/master-test.sh)
...
[Raw](https://github.com/fakedrtom/oncogemini/raw/refs/heads/master/master-test.sh)
...
SCRIPT\_PATH=$(which oncogemini 2> /dev/null)

if [ $? -eq 1 ]

then

SCRIPT\_PATH=$(dirname "$(readlink -f "$0")")

export PATH=$PATH:"${SCRIPT\_PATH}/../../bin"

fi

echo "Using oncogemini found at: $SCRIPT\_PATH" 1>&2
