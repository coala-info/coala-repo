...
(CRISPRbe), and CRISPR knockdown (CRISPRkd) (see Kampmann ([2018](#ref-crispracrisprireview)) for a review of CRISPR modalities).
...
site (blunt-ended dsDNA break) is located 4nt upstream of the pam\_site
...
## 4.3 Designing spacer sequences
...
## 4.4 Sequence features characterization
...
(Langmead et al. [2009](#ref-langmead2009bowtie)) via the `crisprBowtie` package to map spacer sequences
...
* **n0\_c, n1\_c, n2\_c, n3\_c**: specify number of alignments in a coding region,
  with 0, 1, 2 and 3 mismatches, respectively.
* **n0\_p, n1\_p, n2\_p, n3\_p**: specify number of alignments in a promoter region
...
### 4.5.1 Iterative spacer alignments
...
### 4.5.2 Faster alignment by removing repeat elements
...
## 4.12 Filtering and ranking gRNAs
...
(Gilbert et al. [2013](#ref-crispri)). The dSpCas9-KRAB fused protein is a commonly-used construct to
...
(see Kampmann ([2018](#ref-crispracrisprireview)) for a review). For optimal activation, gRNAs are
...
TSS for optimal activation; see (Sanson et al. [2018](#ref-sanson2018optimized)) for more information.
...
# 6 CRISPR base editing with BE4max
...
IQSEC3 using the cytidine base editor BE4max (Koblan et al. [2018](#ref-koblan2018improving)).
...
in `maxVariantScore`. For instance, for spacer\_1, the higher score
...
# 7 CRISPR knockdown with Cas13d
...
nucleases by designing gRNAs targeting IQSEC3 using the CasRx (RfxCas13d) nuclease (Konermann et al. [2018](#ref-cas13d)).
...
# 8 Design for optical pooled screening (OPS)

Optical pooled screening (OPS) combines image-based sequencing
(in situ sequencing) of gRNAs and optical phenotyping on the
same physical wells (Feldman et al. [2019](#ref-ops)). In such experiments, gRNA spacer
...
# 9 Design of gRNA pairs with the PairedGuideSet object
...
# 10 Miscellaneous design use cases

## 10.1 Design with custom sequences
...
## 10.2 Off-target search in custom sequences
...
## 10.3 Adding non-targeting controls (NTCs)
...
The function `addNtcs` can be used to add a named vector of ntcs to a targeting `GuideSet` object as follows:
...
One can see that additional sequence names (ntc\_1 and ntc\_2) were added to the set of human chromosomes to allow NTCs to be represented in the `GuideSet` object, with strand set to `*`, and `pam_site` set to 0.
...
##  [1] Rbowtie_1.50.0                    BSgenome.Hsapiens.UCSC.hg38_1.4.5
##  [3] BSgenome_1.78.0                   rtracklayer_1.70.0
##  [5] BiocIO_1.20.0                     Biostrings_2.78.0
##  [7] XVector_0.50.0                    GenomicRanges_1.62.0
##  [9] GenomeInfoDb_1.46.0               Seqinfo_1.0.0
## [11] IRanges_2.44.0                    S4Vectors_0.48.0
## [13] BiocGenerics_0.56.0               generics_0.1.4
## [15] crisprDesign_1.12.0               crisprBase_1.14.0
## [17] BiocStyle_2.38.0
##
...
## [55] withr_3.0.2                 Biobase_2.70.0
## [57] KEGGREST_1.50.0             evaluate_1.0.5
## [59] crisprScoreData_1.13.0      archive_1.1.12
## [61] BiocFileCache_3.0.0         ExperimentHub_3.0.0
## [63] pillar_1.11.1               BiocManager_1.30.26
## [65] filelock_1.0.3              MatrixGenerics_1.22.0
## [67] crisprScore_1.14.0          vroom_1.6.6
## [69] RCurl_1.98-1.17             BiocVersion_3.22.0
## [71] hms_1.1.4                   glue_1.8.0
## [73] tools_4.5.1                 AnnotationHub_4.0.0
## [75] crisprBwa_1.14.0            GenomicAlignments_1.46.0
## [77] XML_3.99-0.19               grid_4.5.1
## [79] AnnotationDbi_1.72.0        basilisk_1.22.0
## [81] restfulr_0.0.16             cli_3.6.5
## [83] rappdirs_0.3.3              S4Arrays_1.10.0
## [85] dplyr_1.1.4                 Rbwa_1.14.0
## [87] crisprBowtie_1.14.0         sass_0.4.10
