...
FATAL:   Unable to handle docker://quay.io/biocontainers/pyfastx:2.3.0--py312h4711d71_1 uri: while building SIF from layers: conveyor failed to get: invalid character '}' after top-level value
```
