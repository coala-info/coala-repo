...
outputs:
  ...
  genes:
    type: File
    outputSource: prodigal/genes
  proteins:
    type: File
    outputSource: prodigal/proteins
  gff:
    type: File
    outputSource: prodigal/gff
  interpro:
    type: File
    outputSource: interproscan/json
  kofam:
    type: File
    outputSource: kofamscan/kofamscan
