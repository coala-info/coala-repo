...
* Developing
  + [Developer’s Installation](#developer-s-installation)
  + [Adding a new subcommand](#adding-a-new-subcommand)
  + [Executing Test Cases](#executing-test-cases)
  + [Using Pre-Commit](#using-pre-commit)
  + [Writing Documentation](#writing-documentation)
  + [Adding C++ and Cython scripts](#adding-c-and-cython-scripts)
...
# Developing[](#developing "Link to this heading")

Documentation is inspired from [WhatsHap](https://whatshap.readthedocs.io/en/latest/)

## Developer’s Installation[](#developer-s-installation "Link to this heading")
...
If the new script adds external dependencies, then add the dependencies to `requirements.txt`.

## Executing Test Cases[](#executing-test-cases "Link to this heading")
...
1. write test cases for the new code
2. run `tox` after fixing formatting and syntax with `ruff`
3. create the pull request, if the tox check passes with your local python version

## Using Pre-Commit[](#using-pre-commit "Link to this heading")
...
## Adding C++ and Cython scripts[](#adding-c-and-cython-scripts "Link to this heading")
