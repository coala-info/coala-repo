...
baseCommand:
  - anvi-profile
label: anvio-minimal_anvi-profile
doc: "The provided text does not contain help information for the tool. It appears
  to be an error log from a container runtime (Singularity/Apptainer) indicating a
  failure to build the image due to insufficient disk space ('no space left on device').\n
...
stdout: anvio-minimal_anvi-profile.out
