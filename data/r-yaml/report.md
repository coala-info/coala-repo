...
Implements the 'libyaml' 'YAML' 1.

### Metadata
- **Conda**: https://anaconda.org/channels/r/packages/r-yaml/overview
- **R-project (CRAN)**: https://cloud.r-project.org/web/packages/yaml/index.html
- **Home (project)**: https://github.com/vubiostat/r-yaml/
- **Package**: yaml
- **Version**: 2.3.12
...
- **GitHub**: https://github.com/vubiostat/r-yaml
- **Stars**: N/A
