...
[Skip to content](#winnow-calibrated-confidence-and-fdr-control-for-de-novo-sequencing)
...
* [Blog](../introducing-the-next-generation-of-instanovo-models/)
...
* [x]
  ...
  + [Introducing InstaNovo-P](../introducing-instanovo-p-a-de-novo-sequencing-model-for-phosphoproteomics/)
  + [ ]
    ...
    Table of contents
    - [What is Winnow and how does it work?](#what-is-winnow-and-how-does-it-work)

      * [Input and inference](#input-and-inference)
      * [Feature computation](#feature-computation)
      * [Score calibration](#score-calibration)
      * [FDR estimation](#fdr-estimation)
    - [Built for flexibility and trust](#built-for-flexibility-and-trust)

      * [Flexible calibration modes](#flexible-calibration-modes)
      * [Model-agnostic architecture](#model-agnostic-architecture)
      * [Non-parametric, label-free FDR control](#non-parametric-label-free-fdr-control)
    - [Winnow + InstaNovo](#winnow-instanovo)
    - [What this means](#what-this-means)
    - [How to try Winnow](#how-to-try-winnow)
* [ ]
...
*Originally published at [instanovo.ai](https://instanovo.ai/calibrated-confidence-and-fdr-control-for-de-novo-sequencing/) on November 4 2025.*
...
![experiment-wide-metrics](https://instanovo.ai/wp-content/uploads/2025/11/experiment-wide-metrics-1024x759.png)

![spectrum-specific-metrics](https://instanovo.ai/wp-content/uploads/2025/11/spectrum-specific-metrics-1024x759.png)
...
![SHAP-features](https://instanovo.ai/wp-content/uploads/2025/11/Fig-SHAP-feature-1024x695.png)
...
![precision-recall-labelled-data](https://instanovo.ai/wp-content/uploads/2025/11/precision-recall-labelled-data-1-1024x911.png)

![precision-recall-search-data](https://instanovo.ai/wp-content/uploads/2025/11/precision-recall-search-data-2-1024x911.png)

![calibration-curves-labelled-data](https://instanovo.ai/wp-content/uploads/2025/11/calibration-curves-labelled-data-1024x911.png)

![calibration-curves-search-data](https://instanovo.ai/wp-content/uploads/2025/11/calibration-curves-search-data-1024x911.png)

![fdr-accuracy-labelled-data](https://instanovo.ai/wp-content/uploads/2025/11/fdr-accuracy-labelled-data-1-1024x911.png)

![fdr-accuracy-search-data](https://instanovo.ai/wp-content/uploads/2025/11/fdr-accuracy-search-data-1-1024x911.png)
...
Beyond improving individual model performance, Winnow lays the foundation for a **shared calibration layer** across DNS tools, standardising confidence scales, simplifying model comparison, and enhancing interoperability throughout proteomics work