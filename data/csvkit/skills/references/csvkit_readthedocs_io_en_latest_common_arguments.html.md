...
[View this page](_sources/common_arguments.rst.txt "View this page")

# Arguments common to all tools[¶](#arguments-common-to-all-tools "Link to this heading")
...
See the documentation of [csvclean](scripts/csvclean.html) for a description of the default formatting options.

See also

For a list of possible values for the `--encoding` option, see the [Python documentation](https://docs.python.org/3/library/codecs.html#standard-encodings).
