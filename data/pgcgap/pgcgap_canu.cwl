...
inputs:
  - id: aas_path
    type: Directory
    doc: Amino acids of all strains as fasta file paths, ( Default 
  ...
  - id: bsnum
    type: int
    doc: '[Required by "CoreTree", "Pan", "OrthoF", "STREE", and "VAR"] Replicates
      for bootstrap of IQ-TREE. ( Default 500 )'
    default: 500
    inputBinding:
      position: 101
      prefix: --bsnum
  ...
  - id: cds_path
    type: Directory
    doc: CDs of all strains as fasta file paths, ( Default 
  ...
  - id: fastboot
    type: int
    doc: '[Required by "CoreTree", "Pan", "OrthoF", "STREE", and "VAR"] Replicates
      for ultrafast bootstrap of IQ-TREE. ( must >= 1000, Default 1000 )'
    default: 1000
    inputBinding:
      position: 101
      prefix: --fastboot
  - id: fasttree
    type:
      - 'null'
      - boolean
    doc: '[Can be used with "CoreTree", "Pan" and "OrthoF"] Use FastTree to construct
      phylogenetic tree quickly instead of IQ-TREE.'
    inputBinding:
      position: 101
      prefix: --fasttree
  - id: filein
  ...
  - id: filter_length
    ...
    doc: Sequences shorter than the 'filter_length' will be deleted from the 
      assembled genomes [Required by "All", "Assemble" and "Assess"]. ( Default 
      200 )
    inputBinding:
      position: 101
  ...
  - id: genome_size
    ...
    doc: An estimate of the size of the genome. Common suffixes are allowed, for
      example, 3.7m or 2.8g. Needed by PacBio data and Oxford data ( Default 
      Unset )
    inputBinding:
      position: 101
      prefix: --genomeSize
  ...
  - id: gff_path
    type: Directory
    doc: Gff files of all strains as paths ( Default "./Results/Annotations/GFF"
      )
    inputBinding:
      position: 101
      prefix: --GffPath
  ...
  - id: long
    type: string
    doc: FASTQ or FASTA file of long reads. Needed by hybrid assembly ( Default 
      Unset )
    inputBinding:
      position: 101
      prefix: --long
  ...
  - id: reads_path
    type: Directory
    doc: Reads of all strains as file paths ( Default ./Reads/Illumina )
    inputBinding:
      position: 101
      prefix: --ReadsPath
  ...
  - id: scaf_path
    type: Directory
    doc: Path for contigs/scaffolds ( Default "Results/Assembles/Scaf/Illumina" 
      )
    inputBinding:
      position: 101
      prefix: --scafPath
  - id: scaf_suffix
    type: string
    doc: The suffix of scaffolds or genome files [Required by "All", "Assess", 
      "Annotate", "MASH", "ANI" and "AntiRes"]. This is an important parameter 
      that must be set ( Default .filtered.fas )
    inputBinding:
      position: 101
      prefix: --Scaf_suffix
  - id: sep
