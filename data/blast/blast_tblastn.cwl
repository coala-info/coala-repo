...
inputs:
  ...
  - id: task
    type:
      - 'null'
      - string
    doc: Task to execute (tblastn, tblastn-fast)
    inputBinding:
      position: 101
      prefix: -task
  - id: db
  ...
  - id: max_hsps
    type:
      - 'null'
      - int
    doc: Set maximum number of HSPs per subject sequence
    inputBinding:
      position: 101
      prefix: -max_hsps
  - id: culling_limit
    type:
      - 'null'
      - int
    doc: Delete hit if enveloped by at least this many higher-scoring hits
    inputBinding:
      position: 101
