# SciWIn Client Demo CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://github.com/fairagro/m4.4_sciwin_client
- **Package**: https://workflowhub.eu/workflows/1808
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1808/ro_crate?version=1
- **Source repository (git):** https://github.com/fairagro/m4.4_sciwin_client
- **Conda**: N/A
- **Total Downloads**: 300
- **Last updated**: 2025-07-24
- **GitHub**: https://github.com/fairagro/m4.4_sciwin_client
- **Stars**: N/A
- **Version**: 1
- **License**: MIT
- **Workflow type**: Common Workflow Language
- **Main workflow (WorkflowHub):** `workflows/demo/demo.cwl` (Main Workflow)
- **Project**: FAIRagro M4.4
- **Views**: 906
- **Creators**: Jens Krumsieck
- **Discussion / source**: https://github.com/fairagro/m4.4_sciwin_client_demo/issues
