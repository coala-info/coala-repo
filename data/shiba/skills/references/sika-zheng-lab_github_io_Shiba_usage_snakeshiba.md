...
[Skip to content](#snakeshiba-usage)
...
# SnakeShiba Usage[¶](#snakeshiba-usage "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 3 4 5 6 ``` | ``` snakemake -s snakeshiba.smk \ --configfile config.yaml \ --cores 4 \ --use-singularity \ --singularity-args "--bind $HOME:$HOME" \ --rerun-incomplete ``` |

Please check the [Quick Start](../../quickstart/diff_splicing_bulk/#1-prepare-inputs_1) to learn how to prepare the `config.yaml`.

![SnakeShiba rulegraph](https://github.com/Sika-Zheng-Lab/Shiba/blob/mkdocs/img/SnakeShiba_rulegraph.svg?raw=true)
