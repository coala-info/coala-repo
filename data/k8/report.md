...
### Tool Description
V8 JavaScript engine command-line tool

### Metadata
- **Docker Image**: quay.io/biocontainers/k8:1.2--he8db53b_6
- **Homepage**: https://github.com/attractivechaos/k8
- **Package**: https://anaconda.org/channels/bioconda/packages/k8/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/k8/overview
- **Total Downloads**: 947.5K
...
Options:
  ...
  --harmony-shadow-realm (enable "harmony ShadowRealm" (in progress))
        type: bool  default: --noharmony-shadow-realm
  --harmony-struct (enable "harmony structs and shared structs" (in progress))
        type: bool  default: --noharmony-struct
  --harmony-intl-number-format-v3 (enable "Intl.NumberFormat v3" (in progress))
        type: bool  default: --noharmony-intl-number-format-v3
  --harmony-array-grouping (enable "harmony array grouping")
        type: bool  default: --noharmony-array-grouping
  ...
  --use-full-record-write-builtin (Force use of full version of RecordWrite builtin.)
        type: bool  default: --use-full-record-write-builtin
  ...
  --maglev-break-on-entry (insert an int3 on maglev entries)
        type: bool  default: --nomaglev-break-on-entry
  --print-maglev-graph (print maglev graph)
        type: bool  default: --noprint-maglev-graph
  --print-maglev-code (print maglev code)
        type: bool  default: --noprint-maglev-code
  --trace-maglev-regalloc (trace maglev register allocation)
        type: bool  default: --notrace-maglev-regalloc
  ...
  --verify-simplified-lowering (verify graph generated by simplified lowering)
        type: bool  default: --noverify-simplified-lowering
  ...
  --interrupt-budget-for-maglev (interrupt budget which should be used for the profiler counter)
        type: int  default: --interrupt-budget-for-maglev=40960
  ...
  --concurrent-sparkplug (compile Sparkplug code in a background thread)
        type: bool  default: --noconcurrent-sparkplug
  ...
  --concurrent-osr (enable concurrent OSR)
        type: bool  default: --noconcurrent-osr
  ...
  --experimental-wasm-extended-const (enable prototype extended constant expressions for wasm)
        type: bool  default: --noexperimental-wasm-extended-const
  ...
  --wasm-type-canonicalization (apply isorecursive canonicalization on wasm types)
        type: bool  default: --nowasm-type-canonicalization
  ...
  --wasm-loop-peeling (enable loop peeling for wasm functions)
        type: bool  default: --nowasm-loop-peeling
  ...
  --max-old-space-size (max size of the old space (in Mbytes))
        type: size_t  default: --max-old-space-size=16384
  ...
  --separate-gc-phases (yound and full garbage collection phases are not overlapping)
        type: bool  default: --noseparate-gc-phases
  ...
  --write-protect-code-memory (write protect code memory)
        type: bool  default: --write-protect-code-memory
  ...
  --compact-maps (Perform compaction on maps on full collections.)
        type: bool  default: --nocompact-maps
  --use-map-space (Use separate space for maps.)
        type: bool  default: --use-map-space
  ...
  --expose-statistics (expose statistics extension)
        type: bool  default: --noexpose-statistics
  ...
  --minor-mc-sweeping (perform sweeping in young generation mark compact GCs)
        type: bool  default: --nominor-mc-sweeping
  ...
  --multi-mapped-mock-allocator (Use a multi-mapped mock ArrayBuffer allocator for testing.)
        type: bool  default: --nomulti-mapped-mock-allocator
