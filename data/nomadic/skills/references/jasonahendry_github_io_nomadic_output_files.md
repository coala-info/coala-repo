...
* [ ]
  ...
  + [Output files](#output-files)
    ...
    - [summary.read\_mapping.csv](#summaryread_mappingcsv)
    - [summary.region\_coverage.csv](#summaryregion_coveragecsv)
    - [summary.variants.csv](#summaryvariantscsv)
* [FAQ](../faq/)
...
For more information about read mapping, please see [Understanding the Dashboard](../understand/#read-mapping-statistics).
...
For more information about region coverage, please see [Understanding the Dashboard](../understand/#region-coverage-statistics).
...
For more information about variant calling, please see [Understanding the Dashboard](../understand/#preliminary-variant-calling).
