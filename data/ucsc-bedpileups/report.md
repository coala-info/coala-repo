# ucsc-bedpileups CWL Generation Report
...
- **Package**: https://anaconda.org/channels/bioconda/packages/ucsc-bedpileups/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/ucsc-bedpileups/overview
