...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fmacs3-project%2FMACS%2Fwiki%2FBuild-Signal-Track)
...
Tao Liu (τν) edited this page Aug 16, 2016
·
[5 revisions](/macs3-project/MACS/wiki/Build-Signal-Track/_history)
...
|  |
| --- |
| Table of Contents       - [Install](#user-content-Install) - [Run MACS2 main program](#user-content-Run_MACS2_main_program) - [Run MACS2 bdgcmp to generate fold-enrichment and logLR track](#user-content-Run_MACS2_bdgcmp_to_generate_foldenrichment_and_logLR_track) - [Fix the bedGraph and convert them to bigWig files.](#user-content-Fix_the_bedGraph_and_convert_them_to_bigWig_files) - [Calculate correlation between replicates.](#user-content-Calculate_correlation_between_replicates) - [Run MACS2 combining replicates.](#user-content-Run_MACS2_combining_replicates) |

### Install

Currently, MACS2 is on PyPI: <https://pypi.python.org/pypi/MACS2/>. Installation or upgrade can be done by pip or easy\_install command. The current version is 2.1.1.20160309.

Please notice that MACS2 requires [Python2.7](http://www.python.org) and [numpy](http://numpy.scipy.org/).
...
* Loading
  ...
  + [Table of Contents](/macs3-project/MACS/wiki/Build-Signal-Track#table-of-contents)
  + [Install](/macs3-project/MACS/wiki/Build-Signal-Track#install)
  + [Run MACS2 main program](/macs3-project/MACS/wiki/Build-Signal-Track#run-macs2-main-program)
  + [Run MACS2 bdgcmp to generate fold-enrichment and logLR track](/macs3-project/MACS/wiki/Build-Signal-Track#run-macs2-bdgcmp-to-generate-fold-enrichment-and-loglr-track)
  + [Fix the bedGraph and convert them to bigWig files.](/macs3-project/MACS/wiki/Build-Signal-Track#fix-the-bedgraph-and-convert-them-to-bigwig-files)
  + [Calculate correlation between replicates.](/macs3-project/MACS/wiki/Build-Signal-Track#calculate-correlation-between-replicates)
  + [Run MACS2 combining replicates.](/macs3-project/MACS/wiki/Build-Signal-Track#run-macs2-combining-replicates)
* Loading
