...
Annotation package for UCSC human phastCons scores from 100 ver-
tebrate species

Description

This annotation package stores phastCons conservation scores from UCSC for the human genome
(hg19), calculated from genome-wide multiple alignments with other 99 vertebrate species. The
...
phastCons100way.UCSC.hg19 GSCores object containing phastCons conservation scores from UCSC for the human genome (hg19) calculated from 100 vertebrate species and downloaded on March 2018 from http://genome.ucsc.edu.
...
ls("package:phastCons100way.UCSC.hg19")
...
phastCons100way.UCSC.hg19-package, 1
