...
baseCommand:
  - tooldistillator.py
  - multiqc
label: tooldistillator_multiqc
doc: "Extract information from output(s) of multiqc (output.html)\n\nTool homepage:
...
inputs:
  ...
  - id: analysis_software_version
    type:
      - 'null'
      - string
    doc: multiqc version for multiqc
    inputBinding:
      position: 102
  ...
  - id: hid
    type:
      - 'null'
      - string
    doc: historic ID for multiqc file from galaxy for multiqc
    inputBinding:
      position: 102
      prefix: --hid
