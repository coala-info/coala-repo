...
label: gatk_ExampleMultiFeatureWalker
doc: Example of a MultiFeatureWalker subclass.
inputs:
  - id: feature
    type:
      type: array
...
stdout: gatk_ExampleMultiFeatureWalker.out
