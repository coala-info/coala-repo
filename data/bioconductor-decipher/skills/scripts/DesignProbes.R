# Code example from 'DesignProbes' vignette. See references/ for full tutorial.
...
###################################################
### code chunk number 4: expr1 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 5: expr2 (eval = FALSE)
###################################################
## require(RSQLite)
...
###################################################
### code chunk number 6: expr3 (eval = FALSE)
###################################################
