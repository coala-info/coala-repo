# WF5401 Workflow Files

This directory contains workflow files generated from the spreadsheet description of WF5401 using a [custom tool](https://github.com/Marco-Salvi/dt-geo-converter). These files provide an initial starting point, **manual verification and updates are required** to ensure accuracy.
...
``` log
[WARNING] [Failed to add edge SS5402 -> DT5403 in subgraph ST540103 : edge would create a cycle]
[WARNING] [Failed to add edge DT5403 -> ST540103 : edge would create a cycle]
[WARNING] [Inner step ST540103 has no inputs or outputs; please verify its configuration]
[WARNING] [Step ST540205 has no inputs or outputs]
```



For complete details, please refer to the [log file](./workflows/WF5401)
