...
**Modified**: 2026-01-12 13:53:43.015202
**Compiled**: Thu Jan 29 17:59:00 2026
...
[ChEBI](https://www.ebi.ac.uk/chebi). The *[CompoundDb](https://bioconductor.org/packages/3.22/CompoundDb)* package
...
sequentially and manually filled with annotation data [2.4](#sec:fill).
...
section *`CompDb` from custom input* [2.2](#sec:custom) below or the help page of
...
these could be downloaded from HMDB with the *hmdb\_all\_spectra.zip* file.
...
*[Spectra](https://bioconductor.org/packages/3.22/Spectra)* package with all spectra metadata available as *spectra
variables*.
...
```
## Creating package in /tmp/RtmpG57vyS/CompDb.Hsapiens.HMDB.4.0
```
...
including MGF or MSP files using e.g. the *[MsBackendMgf](https://bioconductor.org/packages/3.22/MsBackendMgf)* or
*[MsBackendMsp](https://bioconductor.org/packages/3.22/MsBackendMsp)* packages.
...
spectrum. Feedback on how to reduce the redundancy in the ms\_compound table is
highly appreciated.

## 2.4 `CompDb` by sequentially filling with data
...
be extracted for example from *[xcms](https://bioconductor.org/packages/3.22/xcms)* result objects or other
sources. Below we load some fragment spectra for caffeine from an MGF file
distributed with this package. We use the *[MsBackendMgf](https://bioconductor.org/packages/3.22/MsBackendMgf)*
...
experiments in which certain compounds stored in the `CompDb`’s *ms\_compound*
table were measured.
...
We next need to *link* entries in this table with rows in the *ms\_compound*
...
We next write both tables to the database, replacing the existing *ms\_compound*
...
we show the first 6 rows returned by joining the *ms\_compound* and *experiment*
tables.
...
## 1           1  C10H10O3           exp_b      2023-06-12
## 2           2  C10H10O3           exp_a      2022-11-24
## 3           3  C10H10O3           exp_c      2023-09-21
## 4           4  C10H10O3           exp_d      2024-12-07
## 5           5  C10H10O3           exp_c      2023-09-21
...
## 1             exp_b      2023-06-12                  VV    C10H10O3   178.063
## 2             exp_a      2022-11-24                  AA    C10H10O3   178.063
## 3             exp_c      2023-09-21                  AA    C10H10O3   178.063
## 4             exp_d      2024-12-07                  AA    C10H10O3   178.063
## 5             exp_c      2023-09-21                  AA    C10H10O3   178.063
## ...             ...             ...                 ...         ...       ...
## 66            exp_d      2024-12-07                  AA    C16H16O8   336.084
## 67            exp_a      2022-11-24                  AA    C16H16O8   336.084
## 68            exp_a      2022-11-24                  AA    C16H16O8   336.084
...
```
##  [1] "exp_b" "exp_a" "exp_c" "exp_d" "exp_c" "exp_c" "exp_c" "exp_a" "exp_d"
## [10] "exp_a" "exp_a" "exp_d" "exp_d" "exp_b" "exp_d" "exp_d" "exp_c" "exp_d"
## [19] "exp_a" "exp_d" "exp_c" "exp_c" "exp_c" "exp_d" "exp_b" "exp_c" "exp_c"
## [28] "exp_b" "exp_b" "exp_a" "exp_c" "exp_a" "exp_a" "exp_a" "exp_a" "exp_c"
## [37] "exp_a" "exp_d" "exp_c" "exp_b" "exp_c" "exp_a" "exp_c" "exp_b" "exp_b"
## [46] "exp_b" "exp_a" "exp_c" "exp_a" "exp_a" "exp_d" "exp_d" "exp_c" "exp_b"
## [55] "exp_d" "exp_c" "exp_d" "exp_b" "exp_a" "exp_c" "exp_b" "exp_a" "exp_d"
## [64] "exp_b" "exp_b" "exp_d" "exp_a" "exp_a" "exp_d" "exp_a"
```
...
##  [1] MsBackendMgf_1.18.0     RSQLite_2.4.5           Spectra_1.20.1
##  [4] BiocParallel_1.44.0     CompoundDb_1.14.2       S4Vectors_0.48.0
...
## [46] base64enc_0.1-3        utf8_1.2.6             dichromat_2.0-0.1
## [49] ChemmineR_3.62.0       scales_1.4.0           bit64_4.6.0-1
## [52] rmarkdown_2.30         bit_4.6.0              otel_0.2.0
## [55] gridExtra_2.3          png_0.1-8              memoise_2.0.1
## [58] evaluate_1.0.5         knitr_1.51             GenomicRanges_1.62.1
## [61] IRanges_2.44.0         rlang_1.1.7            Rcpp_1.1.1
## [64] glue_1.8.0             DBI_1.2.3              xml2_1.5.2
## [67] BiocManager_1.30.27    jsonlite_2.0.0         R6_2.6.1
## [70] fs_1.6.6               ProtGenerics_1.42.0    MsCoreUtils_1.22.1
```