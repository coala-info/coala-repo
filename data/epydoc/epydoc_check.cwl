...
baseCommand: epydoc
label: epydoc_check
doc: "epydoc is a tool for generating documentation from Python docstrings.\n\nTool
...
inputs:
  - id: action
    type:
      - 'null'
      - string
    doc: Action to perform (e.g., --html, --check)
    inputBinding:
      position: 1
  - id: names
    type:
      type: array
      items: string
    doc: Modules, packages, or classes to document
    inputBinding:
      position: 2
  - id: check
    type:
