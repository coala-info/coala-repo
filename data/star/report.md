...
### Metadata
- **Docker Image**: quay.io/biocontainers/star:2.7.0b--0
- **Homepage**: https://github.com/alexdobin/STAR
- **Package**: https://anaconda.org/channels/bioconda/packages/star/overview
- **Validation**: PASS
...
readStrand                  Unstranded
    string: library strandedness type
                            Unstranded  ... unstranded library
                            Forward     ... 1st read strand same as RNA (i.e. 2nd cDNA synthesis strand)
                            Reverse     ... 1st read opposite to RNA (i.e. 1st cDNA synthesis strand)
...
### solo (single cell) parameters
soloType                    None
    string(s): type of single-cell RNA-seq
                            Droplet   ... one cell barcode and one UMI barcode in read2, e.g. Drop-seq and 10X Chromium
...
soloCBwhitelist             -
    string: file with whitelist of cell barcodes
