...
ragene21sttranscriptclusterACCNUM is an R object that contains mappings between a manufac-
...
## Bimap interface:
x <- ragene21sttranscriptclusterACCNUM
...
ragene21sttranscriptclusterALIAS2PROBE
...
ragene21sttranscriptclusterALIAS is an R object that provides mappings between common gene
...
xx <- as.list(ragene21sttranscriptclusterALIAS2PROBE)
if(length(xx) > 0){
...
Welcome to the ragene21sttranscriptcluster.db annotation Package. The purpose of this package
is to provide detailed information about the ragene21sttranscriptcluster platform. This package is
updated biannually.
Objects in this package are accessed using the select() interface. See ?select in the AnnotationDbi
package for details.

ragene21sttranscriptclusterCHR
...
## use of select().
ls("package:ragene21sttranscriptcluster.db")
...
ragene21sttranscriptclusterCHR is an R object that provides mappings between a manufacturer
...
## Bimap interface:
x <- ragene21sttranscriptclusterCHR
...
ragene21sttranscriptclusterCHRLOC
...
ragene21sttranscriptclusterCHRLENGTHS

A named vector for the length of each of the chromosomes

Description

ragene21sttranscriptclusterCHRLENGTHS provides the length measured in base pairs for each of
the chromosomes.
...
## Bimap interface:
tt <- ragene21sttranscriptclusterCHRLENGTHS
...
ragene21sttranscriptclusterCHRLOC is an R object that maps manufacturer identifiers to the start-
...
ragene21sttranscriptclusterENSEMBL
...
## Bimap interface:
x <- ragene21sttranscriptclusterCHRLOC
...
ragene21sttranscriptclusterENSEMBL is an R object that contains mappings between manufacturer
...
ragene21sttranscriptclusterENTREZID
...
## Bimap interface:
x <- ragene21sttranscriptclusterENSEMBL
...
x <- ragene21sttranscriptclusterENSEMBL2PROBE
mapped_genes <- mappedkeys(x)
# Convert to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
ragene21sttranscriptclusterENTREZID is an R object that provides mappings between manufac-
turer identifiers and Entrez Gene identifiers.

ragene21sttranscriptclusterENZYME
...
## Bimap interface:
x <- ragene21sttranscriptclusterENTREZID
...
ragene21sttranscriptclusterENZYME is an R object that provides mappings between manufacturer
identifiers and EC numbers. ragene21sttranscriptclusterENZYME2PROBE is an R object that maps
...
When the ragene21sttranscriptclusterENZYME maping viewed as a list, each manufacturer identi-
...
For the ragene21sttranscriptclusterENZYME2PROBE, each EC number maps to a named vector
...
numbers. In ragene21sttranscriptclusterENZYME2PROBE, EC is dropped from the Enzyme Com-
mission numbers.
...
## Bimap interface:
x <- ragene21sttranscriptclusterENZYME
...
ragene21sttranscriptclusterGENENAME
...
# Now convert ragene21sttranscriptclusterENZYME2PROBE to a list to see inside
x <- ragene21sttranscriptclusterENZYME2PROBE
mapped_probes <- mappedkeys(x)
## convert to a list
xx <- as.list(x[mapped_probes][1:3])
if(length(xx) > 0){
...
ragene21sttranscriptclusterGENENAME is an R object that maps manufacturer identifiers to the
...
## Bimap interface:
x <- ragene21sttranscriptclusterGENENAME
# Get the probe identifiers that are mapped to a gene name
mapped_probes <- mappedkeys(x)

10

ragene21sttranscriptclusterGO
...
ragene21sttranscriptclusterGO is an R object that provides mappings between manufacturer iden-
tifiers and the GO identifiers that they are directly associated with. This mapping and its reverse
mapping (ragene21sttranscriptclusterGO2PROBE) do NOT associate the child terms from the GO
ontology with the gene. Only the directly evidenced terms are represented here.

ragene21sttranscriptclusterGO2ALLPROBES is an R object that provides mappings between a
...
than ragene21sttranscriptclusterGO2PROBE.

Details

If ragene21sttranscriptclusterGO is cast as a list, each manufacturer identifier is mapped to a list
...
If ragene21sttranscriptclusterGO2ALLPROBES or ragene21sttranscriptclusterGO2PROBE is cast
...
• ragene21sttranscriptclusterGO2ALLPROBES
• AnnotationDb-class for use of the select() interface.
...
## Bimap interface:
x <- ragene21sttranscriptclusterGO
...
# For the reverse map:
x <- ragene21sttranscriptclusterGO2PROBE
mapped_genes <- mappedkeys(x)
# Convert to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
ragene21sttranscriptclusterORGANISM

x <- ragene21sttranscriptclusterGO2ALLPROBES
mapped_genes <- mappedkeys(x)
# Convert ragene21sttranscriptclusterGO2ALLPROBES to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
ragene21sttranscriptclusterMAPCOUNTS
...
ragene21sttranscriptclusterMAPCOUNTS provides the "map count" (i.e. the count of mapped keys)
for each map in package ragene21sttranscriptcluster.db.
...
The Organism information for ragene21sttranscriptcluster

Description

ragene21sttranscriptclusterORGANISM is an R object that contains a single item: a character string
that names the organism for which ragene21sttranscriptcluster was built. ragene21sttranscriptclusterORGPKG
...
ragene21sttranscriptclusterPATH

13

Details

Although the package name is suggestive of the organism for which it was built, ragene21sttranscriptclusterORGANISM
provides a simple way to programmatically extract the organism name. ragene21sttranscriptclusterORGPKG
...
## Bimap interface:
ragene21sttranscriptclusterORGANISM
ragene21sttranscriptclusterORGPKG
...
ragene21sttranscriptclusterPATH maps probe identifiers to the identifiers used by KEGG for path-
ways in which the genes represented by the probe identifiers are involved

ragene21sttranscriptclusterPATH2PROBE is an R object that provides mappings between KEGG
...
ragene21sttranscriptclusterPFAM
...
## Bimap interface:
x <- ragene21sttranscriptclusterPATH
...
x <- ragene21sttranscriptclusterPATH
mapped_probes <- mappedkeys(x)
# Now convert the ragene21sttranscriptclusterPATH2PROBE object to a list
xx <- as.list(x[mapped_probes][1:300])
if(length(xx) > 0){
...
ragene21sttranscriptclusterPFAM is an R object that provides mappings between manufacturer
...
ragene21sttranscriptclusterPMID
...
ragene21sttranscriptclusterPMID is an R object that provides mappings between manufacturer iden-
tifiers and PubMed identifiers. ragene21sttranscriptclusterPMID2PROBE is an R object that pro-
vides mappings between PubMed identifiers and manufacturer identifiers.

Details

When ragene21sttranscriptclusterPMID is viewed as a list each manufacturer identifier is mapped
...
When ragene21sttranscriptclusterPMID2PROBE is viewed as a list each PubMed identifier is mapped
...
## Bimap interface:
x <- ragene21sttranscriptclusterPMID
...
ragene21sttranscriptclusterREFSEQ
...
x <- ragene21sttranscriptclusterPMID2PROBE
mapped_probes <- mappedkeys(x)
# Now convert the reverse map object ragene21sttranscriptclusterPMID2PROBE to a list
xx <- as.list(x[mapped_probes][1:300])
if(length(xx) > 0){
...
ragene21sttranscriptclusterPROSITE

Maps between Manufacturer Identifiers and PROSITE Identifiers

Description

ragene21sttranscriptclusterPROSITE is an R object that provides mappings between manufacturer
...
ragene21sttranscriptclusterREFSEQ is an R object that provides mappings between manufacturer
...
## Bimap interface:
x <- ragene21sttranscriptclusterREFSEQ
...
ragene21sttranscriptclusterSYMBOL
...
ragene21sttranscriptclusterSYMBOL is an R object that provides mappings between manufacturer
...
ragene21sttranscriptclusterUNIPROT
...
ragene21sttranscriptclusterUNIPROT is an R object that contains mappings between the manufac-
...
## Bimap interface:
x <- ragene21sttranscriptclusterUNIPROT
...
ragene21sttranscriptcluster_dbconn
...
ragene21sttranscriptcluster_dbconn()
ragene21sttranscriptcluster_dbfile()
ragene21sttranscriptcluster_dbschema(file="", show.indices=FALSE)
...
ragene21sttranscriptcluster_dbconn returns a connection object to the package annotation
DB. IMPORTANT: Don’t call dbDisconnect on the connection object returned by ragene21sttranscriptcluster_dbconn
or you will break all the AnnDbObj objects defined in this package!
ragene21sttranscriptcluster_dbfile returns the path (character string) to the package anno-
tation DB (this is an SQLite file).
ragene21sttranscriptcluster_dbschema prints the schema definition of the package annotation
DB.
ragene21sttranscriptcluster_dbInfo prints other information about the package annotation
DB.

Value

ragene21sttranscriptcluster_dbconn: a DBIConnection object representing an open connec-
tion to the package annotation DB.
ragene21sttranscriptcluster_dbfile: a character string with the path to the package annota-
tion DB.
ragene21sttranscriptcluster_dbschema: none (invisible NULL).
ragene21sttranscriptcluster_dbInfo: none (invisible NULL).
...
dbGetQuery(ragene21sttranscriptcluster_dbconn(), "SELECT COUNT(*) FROM probes")
...
ragene21sttranscriptcluster.db, 2
ragene21sttranscriptcluster_dbconn,
...
ragene21sttranscriptclusterCHR, 3
ragene21sttranscriptclusterCHRLENGTHS,
...
ragene21sttranscriptclusterGO, 10
ragene21sttranscriptclusterMAPCOUNTS,
...
ragene21sttranscriptcluster.db, 2
ragene21sttranscriptcluster_dbconn, 19
ragene21sttranscriptcluster_dbfile
...
ragene21sttranscriptclusterACCNUM, 1
ragene21sttranscriptclusterALIAS2PROBE,
...
ragene21sttranscriptclusterCHRLOC, 4
ragene21sttranscriptclusterCHRLOCEND

(ragene21sttranscriptclusterCHRLOC),
4

ragene21sttranscriptclusterENSEMBL, 5
ragene21sttranscriptclusterENSEMBL2PROBE

(ragene21sttranscriptclusterENSEMBL),
5

ragene21sttranscriptclusterENTREZID, 6
ragene21sttranscriptclusterENZYME, 7

22

INDEX

ragene21sttranscriptclusterENZYME2PROBE

(ragene21sttranscriptclusterENZYME),
7

ragene21sttranscriptclusterGENENAME, 9
ragene21sttranscriptclusterGO, 10
ragene21sttranscriptclusterGO2ALLPROBES,
...
ragene21sttranscriptclusterGO2PROBE

(ragene21sttranscriptclusterGO),
10

ragene21sttranscriptclusterLOCUSID
...
ragene21sttranscriptclusterPATH, 13
ragene21sttranscriptclusterPATH2PROBE

(ragene21sttranscriptclusterPATH),
13

ragene21sttranscriptclusterPFAM, 14
ragene21sttranscriptclusterPMID, 15
ragene21sttranscriptclusterPMID2PROBE

(ragene21sttranscriptclusterPMID),
15

ragene21sttranscriptclusterPROSITE, 16
ragene21sttranscriptclusterREFSEQ, 16
ragene21sttranscriptclusterSYMBOL, 18
ragene21sttranscriptclusterUNIPROT, 19
ragene21sttranscriptclusterUNIPROT2PROBE
