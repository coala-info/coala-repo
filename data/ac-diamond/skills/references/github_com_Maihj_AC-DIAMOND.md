...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2FMaihj%2FAC-DIAMOND)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E&source=header-repo&source_repo=Maihj%2FAC-DIAMOND)
...
[Maihj](/Maihj)
/
**[AC-DIAMOND](/Maihj/AC-DIAMOND)**
Public

* [Notifications](/login?return_to=%2FMaihj%2FAC-DIAMOND) You must be signed in to change notification settings
* [Fork
  3](/login?return_to=%2FMaihj%2FAC-DIAMOND)
* [Star
   16](/login?return_to=%2FMaihj%2FAC-DIAMOND)

* [Code](/Maihj/AC-DIAMOND)
* [Issues
  0](/Maihj/AC-DIAMOND/issues)
* [Pull requests
  0](/Maihj/AC-DIAMOND/pulls)
* [Actions](/Maihj/AC-DIAMOND/actions)
* [Projects](/Maihj/AC-DIAMOND/projects)
* [Security
  0](/Maihj/AC-DIAMOND/security)
* [Insights](/Maihj/AC-DIAMOND/pulse)

Additional navigation options

* [Code](/Maihj/AC-DIAMOND)
* [Issues](/Maihj/AC-DIAMOND/issues)
* [Pull requests](/Maihj/AC-DIAMOND/pulls)
* [Actions](/Maihj/AC-DIAMOND/actions)
* [Projects](/Maihj/AC-DIAMOND/projects)
* [Security](/Maihj/AC-DIAMOND/security)
* [Insights](/Maihj/AC-DIAMOND/pulse)
...
[Branches](/Maihj/AC-DIAMOND/branches)[Tags](/Maihj/AC-DIAMOND/tags)
...
| --- | --- | --- | --- | --- |
| Latest commit   History[20 Commits](/Maihj/AC-DIAMOND/commits/master/)   20 Commits | | |
| [.github/workflows](/Maihj/AC-DIAMOND/tree/master/.github/workflows "This path skips through empty directories") | | [.github/workflows](/Maihj/AC-DIAMOND/tree/master/.github/workflows "This path skips through empty directories") |  |  |
| [bin](/Maihj/AC-DIAMOND/tree/master/bin "bin") | | [bin](/Maihj/AC-DIAMOND/tree/master/bin "bin") |  |  |
| [scripts](/Maihj/AC-DIAMOND/tree/master/scripts "scripts") | | [scripts](/Maihj/AC-DIAMOND/tree/master/scripts "scripts") |  |  |
| [src](/Maihj/AC-DIAMOND/tree/master/src "src") | | [src](/Maihj/AC-DIAMOND/tree/master/src "src") |  |  |
| [test\_data](/Maihj/AC-DIAMOND/tree/master/test_data "test_data") | | [test\_data](/Maihj/AC-DIAMOND/tree/master/test_data "test_data") |  |  |
| [.gitignore](/Maihj/AC-DIAMOND/blob/master/.gitignore ".gitignore") | | [.gitignore](/Maihj/AC-DIAMOND/blob/master/.gitignore ".gitignore") |  |  |
| [CMakeLists.txt](/Maihj/AC-DIAMOND/blob/master/CMakeLists.txt "CMakeLists.txt") | | [CMakeLists.txt](/Maihj/AC-DIAMOND/blob/master/CMakeLists.txt "CMakeLists.txt") |  |  |
| [LICENSE](/Maihj/AC-DIAMOND/blob/master/LICENSE "LICENSE") | | [LICENSE](/Maihj/AC-DIAMOND/blob/master/LICENSE "LICENSE") |  |  |
| [README.rst](/Maihj/AC-DIAMOND/blob/master/README.rst "README.rst") | | [README.rst](/Maihj/AC-DIAMOND/blob/master/README.rst "README.rst") |  |  |
| View all files | | |
...
The sensitive-1 mode is in fact a pipeline, which first uses the fast mode to find alignments for most queries, and then uses the sensitive-2 mode to find alignments for the remaining queries. To run AC-DIAMOND with sensitive-1 mode, we can use the script "sensitive1\_search.sh", which is in the scripts/ folder:

> ./sensitive1\_search.sh > acd.result.m8

The alignment results, which are already in blast output format, will be put in the file "acd.result.m8". To run the script successfully, the following files should also be in the same directory as "sensitive1\_search.sh":
...
[Activity](/Maihj/AC-DIAMOND/activity)

### Stars

[**16**
stars](/Maihj/AC-DIAMOND/stargazers)

### Watchers

[**5**
watching](/Maihj/AC-DIAMOND/watchers)

### Forks

[**3**
forks](/Maihj/AC-DIAMOND/forks)

[Report repository](/contact/report-content?content_url=https%3A%2F%2Fgithub.com%2FMaihj%2FAC-DIAMOND&report=Maihj+%28user%29)

## [Releases 1](/Maihj/AC-DIAMOND/releases)

[pr8

Latest

Oct 11, 2023](/Maihj/AC-DIAMOND/releases/tag/pr8)

## [Packages 0](/users/Maihj/packages?repo_name=AC-DIAMOND)
...
## [Contributors](/Maihj/AC-DIAMOND/graphs/contributors)
