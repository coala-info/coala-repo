...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Ffulcrumgenomics%2Fbwa-aln-interactive%2Ftree%2Fmain%2Fbwakit)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Ffiles%2Fdisambiguate&source=header-repo&source_repo=fulcrumgenomics%2Fbwa-aln-interactive)
...
[History](/fulcrumgenomics/bwa-aln-interactive/commits/main/bwakit)
...
| --- | --- | --- | --- | --- |
| parent directory [..](/fulcrumgenomics/bwa-aln-interactive/tree/main) | | |
| [README.md](/fulcrumgenomics/bwa-aln-interactive/blob/main/bwakit/README.md "README.md") | | [README.md](/fulcrumgenomics/bwa-aln-interactive/blob/main/bwakit/README.md "README.md") |  |  |
| [bwa-postalt.js](/fulcrumgenomics/bwa-aln-interactive/blob/main/bwakit/bwa-postalt.js "bwa-postalt.js") | | [bwa-postalt.js](/fulcrumgenomics/bwa-aln-interactive/blob/main/bwakit/bwa-postalt.js "bwa-postalt.js") |  |  |
| [run-HLA](/fulcrumgenomics/bwa-aln-interactive/blob/main/bwakit/run-HLA "run-HLA") | | [run-HLA](/fulcrumgenomics/bwa-aln-interactive/blob/main/bwakit/run-HLA "run-HLA") |  |  |
| [run-bwamem](/fulcrumgenomics/bwa-aln-interactive/blob/main/bwakit/run-bwamem "run-bwamem") | | [run-bwamem](/fulcrumgenomics/bwa-aln-interactive/blob/main/bwakit/run-bwamem "run-bwamem") |  |  |
| [run-gen-ref](/fulcrumgenomics/bwa-aln-interactive/blob/main/bwakit/run-gen-ref "run-gen-ref") | | [run-gen-ref](/fulcrumgenomics/bwa-aln-interactive/blob/main/bwakit/run-gen-ref "run-gen-ref") |  |  |
| [typeHLA-selctg.js](/fulcrumgenomics/bwa-aln-interactive/blob/main/bwakit/typeHLA-selctg.js "typeHLA-selctg.js") | | [typeHLA-selctg.js](/fulcrumgenomics/bwa-aln-interactive/blob/main/bwakit/typeHLA-selctg.js "typeHLA-selctg.js") |  |  |
| [typeHLA.js](/fulcrumgenomics/bwa-aln-interactive/blob/main/bwakit/typeHLA.js "typeHLA.js") | | [typeHLA.js](/fulcrumgenomics/bwa-aln-interactive/blob/main/bwakit/typeHLA.js "typeHLA.js") |  |  |
| [typeHLA.sh](/fulcrumgenomics/bwa-aln-interactive/blob/main/bwakit/typeHLA.sh "typeHLA.sh") | | [typeHLA.sh](/fulcrumgenomics/bwa-aln-interactive/blob/main/bwakit/typeHLA.sh "typeHLA.sh") |  |  |
| View all files | | |
...
[trimadap](https://github.com/lh3/seqtk/blob/master/trimadap.c)), marks duplicates (via [samblaster](https://github.com/GregoryFaust/samblaster)) and sorts the final
alignment (via [samtools](http://www.htslib.org)).
...
Bwakit can be [downloaded here](https://sourceforge.net/projects/bio-bwa/files/bwakit). It is only available to x86\_64-linux. The
scripts in the package are available in the [bwa/bwakit](https://github.com/lh3/bwa/tree/master/bwakit) directory.
