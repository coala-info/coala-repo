...
baseCommand: csvstat
label: csvkit_csvstat
doc: Print descriptive statistics for each column in a CSV file.
inputs:
  - id: file
    type:
      - 'null'
  ...
  - id: csv
    type:
      - 'null'
      - boolean
    doc: Output results as a CSV table, rather than plain text.
    inputBinding:
      position: 102
      prefix: --csv
  - id: json
    type:
      - 'null'
      - boolean
    doc: Output results as JSON text, rather than plain text.
    inputBinding:
      position: 102
      prefix: --json
  - id: indent
    type:
      - 'null'
      - int
    doc: Indent the output JSON this many spaces. Disabled by default.
    inputBinding:
      position: 102
      prefix: --indent
  - id: names
  ...
  - id: columns
    ...
    doc: A comma-separated list of column indices, names or ranges to be 
      examined, e.g. "1,id,3-5". Defaults to all columns.
    inputBinding:
      position: 102
      prefix: --columns
  - id: type
  ...
  - id: nulls
    type:
      - 'null'
      - boolean
    doc: Only output whether columns contains nulls.
    inputBinding:
      position: 102
      prefix: --nulls
  - id: non_nulls
    type:
      - 'null'
      - boolean
    doc: Only output counts of non-null values.
    inputBinding:
      position: 102
      prefix: --non-nulls
  - id: unique
    type:
      - 'null'
      - boolean
    doc: Only output counts of unique values.
    inputBinding:
      position: 102
      prefix: --unique
  - id: min
    type:
      - 'null'
      - boolean
    doc: Only output smallest values.
    inputBinding:
      position: 102
      prefix: --min
  - id: max
    type:
      - 'null'
      - boolean
    doc: Only output largest values.
    inputBinding:
      position: 102
      prefix: --max
  - id: sum
  ...
  - id: stdev
    type:
      - 'null'
      - boolean
    doc: Only output standard deviations.
    inputBinding:
      position: 102
      prefix: --stdev
  - id: len
    type:
      - 'null'
      - boolean
    doc: Only output the length of the longest values.
    inputBinding:
      position: 102
      prefix: --len
  - id: max_precision
    type:
      - 'null'
      - boolean
    doc: Only output the most decimal places.
    inputBinding:
      position: 102
  ...
  - id: freq
    type:
      - 'null'
      - boolean
    doc: Only output lists of frequent values.
    inputBinding:
      position: 102
      prefix: --freq
  - id: freq_count
    type:
      - 'null'
      - int
    doc: The maximum number of frequent values to display.
    inputBinding:
      position: 102
      prefix: --freq-count
  - id: count
    type:
      - 'null'
      - boolean
    doc: Only output total row count.
    inputBinding:
      position: 102
      prefix: --count
  - id: decimal_format
    type:
      - 'null'
      - string
    doc: '%-format specification for printing decimal numbers. Defaults to locale-specific
      formatting with "%.3f".'
    inputBinding:
      position: 102
      prefix: --decimal-format
  - id: no_grouping_separator
    type:
      - 'null'
      - boolean
    doc: Do not use grouping separators in decimal numbers.
    inputBinding:
      position: 102
      prefix: --no-grouping-separator
  - id: snifflimit
    type:
      - 'null'
      - int
