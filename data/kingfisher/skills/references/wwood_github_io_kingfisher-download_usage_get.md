...
[![Kingfisher logo](/kingfisher-download/kingfisher.png)](/kingfisher-download/)

## [Kingfisher](/kingfisher-download/)

S

* [Kingfisher get](/kingfisher-download/usage/get)
* [Kingfisher extract](/kingfisher-download/usage/extract)
* [Kingfisher annotate](/kingfisher-download/usage/annotate)
...
**-r**, **--run-identifiers** *RUN\_IDENTIFIERS* [*RUN\_IDENTIFIERS* ...]

Run number(s) to download/extract e.g. ERR1739691

**--run-identifiers-list** *RUN\_IDENTIFIERS\_LIST*
...
**--download-threads** *DOWNLOAD\_THREADS*
...
PROJECT\_ID' [default: value of `gcloud config get-value project`
command]

**--gcp-user-key-file** *GCP\_USER\_KEY\_FILE*
...
**--prefetch-max-size** *PREFETCH\_MAX\_SIZE*
...
**-t**, **--extraction-threads** *EXTRACTION\_THREADS*
...
* [FURTHER DOWNLOAD OPTIONS](#further-download-options)
* [FURTHER EXTRACTION OPTIONS](#further-extraction-options)
