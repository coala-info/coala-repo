...
FATAL:   Unable to handle docker://quay.io/biocontainers/ucsc-tdbquery:482--h0b57e2e_0 uri: while building SIF from layers: conveyor failed to get: invalid character '}' after top-level value
```
...
### Tool Description
The provided text does not contain help information for the tool; it is a fatal error log from a container runtime (Apptainer/Singularity) failing to fetch the image.
