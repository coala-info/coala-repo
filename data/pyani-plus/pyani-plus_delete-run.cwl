...
baseCommand:
  - pyani-plus
  - delete-run
label: pyani-plus_delete-run
doc: "Delete any single run from the given pyANI-plus SQLite3 database.\n\nTool homepage:
...
inputs:
  ...
  - id: force
    type:
      - 'null'
      - boolean
    doc: Delete without confirmation
    inputBinding:
      position: 101
      prefix: --force
  - id: log
...
stdout: pyani-plus_delete-run.out
