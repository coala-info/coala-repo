...
huex10sttranscriptclusterACCNUM

Map Manufacturer identifiers to Accession Numbers

Description

huex10sttranscriptclusterACCNUM is an R object that contains mappings between a manufacturer’s
...
## Bimap interface:
x <- huex10sttranscriptclusterACCNUM
...
huex10sttranscriptclusterALIAS2PROBE
...
huex10sttranscriptclusterALIAS is an R object that provides mappings between common gene sym-
...
xx <- as.list(huex10sttranscriptclusterALIAS2PROBE)
if(length(xx) > 0){
...
Welcome to the huex10sttranscriptcluster.db annotation Package. The purpose of this package is to
provide detailed information about the huex10sttranscriptcluster platform. This package is updated
biannually.
Objects in this package are accessed using the select() interface. See ?select in the AnnotationDbi
package for details.

huex10sttranscriptclusterCHR
...
huex10sttranscriptclusterCHR is an R object that provides mappings between a manufacturer iden-
...
## Bimap interface:
x <- huex10sttranscriptclusterCHR
...
huex10sttranscriptclusterCHRLOC
...
huex10sttranscriptclusterCHRLENGTHS

A named vector for the length of each of the chromosomes

Description

huex10sttranscriptclusterCHRLENGTHS provides the length measured in base pairs for each of the
chromosomes.
...
## Bimap interface:
tt <- huex10sttranscriptclusterCHRLENGTHS
...
huex10sttranscriptclusterCHRLOC is an R object that maps manufacturer identifiers to the starting
...
huex10sttranscriptclusterENSEMBL
...
## Bimap interface:
x <- huex10sttranscriptclusterCHRLOC
...
huex10sttranscriptclusterENSEMBL is an R object that contains mappings between manufacturer
...
huex10sttranscriptclusterENTREZID
...
## Bimap interface:
x <- huex10sttranscriptclusterENSEMBL
...
x <- huex10sttranscriptclusterENSEMBL2PROBE
mapped_genes <- mappedkeys(x)
# Convert to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
huex10sttranscriptclusterENTREZID is an R object that provides mappings between manufacturer
identifiers and Entrez Gene identifiers.

huex10sttranscriptclusterENZYME
...
## Bimap interface:
x <- huex10sttranscriptclusterENTREZID
...
huex10sttranscriptclusterENZYME is an R object that provides mappings between manufacturer
identifiers and EC numbers. huex10sttranscriptclusterENZYME2PROBE is an R object that maps
...
When the huex10sttranscriptclusterENZYME maping viewed as a list, each manufacturer identifier
...
vector will contain an NA.
For the huex10sttranscriptclusterENZYME2PROBE, each EC number maps to a named vector con-
taining all of the manufacturer identifiers that correspond to the gene that produces that enzyme. The
...
bers. In huex10sttranscriptclusterENZYME2PROBE, EC is dropped from the Enzyme Commission
numbers.
...
## Bimap interface:
x <- huex10sttranscriptclusterENZYME
...
huex10sttranscriptclusterGENENAME
...
# Now convert huex10sttranscriptclusterENZYME2PROBE to a list to see inside
x <- huex10sttranscriptclusterENZYME2PROBE
mapped_probes <- mappedkeys(x)
## convert to a list
xx <- as.list(x[mapped_probes][1:3])
if(length(xx) > 0){
...
huex10sttranscriptclusterGENENAME is an R object that maps manufacturer identifiers to the cor-
...
## Bimap interface:
x <- huex10sttranscriptclusterGENENAME
# Get the probe identifiers that are mapped to a gene name
mapped_probes <- mappedkeys(x)

10

huex10sttranscriptclusterGO
...
huex10sttranscriptclusterGO is an R object that provides mappings between manufacturer identi-
fiers and the GO identifiers that they are directly associated with. This mapping and its reverse
mapping (huex10sttranscriptclusterGO2PROBE) do NOT associate the child terms from the GO
ontology with the gene. Only the directly evidenced terms are represented here.

huex10sttranscriptclusterGO2ALLPROBES is an R object that provides mappings between a given
...
than huex10sttranscriptclusterGO2PROBE.

Details

If huex10sttranscriptclusterGO is cast as a list, each manufacturer identifier is mapped to a list
...
If huex10sttranscriptclusterGO2ALLPROBES or huex10sttranscriptclusterGO2PROBE is cast as a
...
• huex10sttranscriptclusterGO2ALLPROBES
• AnnotationDb-class for use of the select() interface.
...
# For the reverse map:
x <- huex10sttranscriptclusterGO2PROBE
mapped_genes <- mappedkeys(x)
# Convert to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
huex10sttranscriptclusterMAP

x <- huex10sttranscriptclusterGO2ALLPROBES
mapped_genes <- mappedkeys(x)
# Convert huex10sttranscriptclusterGO2ALLPROBES to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
huex10sttranscriptclusterMAP is an R object that provides mappings between manufacturer identi-
...
huex10sttranscriptclusterMAPCOUNTS
...
## Bimap interface:
x <- huex10sttranscriptclusterMAP
...
huex10sttranscriptclusterMAPCOUNTS provides the "map count" (i.e. the count of mapped keys)
for each map in package huex10sttranscriptcluster.db.
...
huex10sttranscriptclusterOMIM is an R object that provides mappings between manufacturer iden-
...
huex10sttranscriptclusterORGANISM
...
## Bimap interface:
x <- huex10sttranscriptclusterOMIM
...
The Organism information for huex10sttranscriptcluster

Description

huex10sttranscriptclusterORGANISM is an R object that contains a single item: a character string
that names the organism for which huex10sttranscriptcluster was built. huex10sttranscriptclusterORGPKG
...
huex10sttranscriptclusterPATH

15

Details

Although the package name is suggestive of the organism for which it was built, huex10sttranscriptclusterORGANISM
provides a simple way to programmatically extract the organism name. huex10sttranscriptclusterORGPKG
...
## Bimap interface:
huex10sttranscriptclusterORGANISM
huex10sttranscriptclusterORGPKG
...
huex10sttranscriptclusterPATH maps probe identifiers to the identifiers used by KEGG for pathways
in which the genes represented by the probe identifiers are involved

huex10sttranscriptclusterPATH2PROBE is an R object that provides mappings between KEGG
...
## Bimap interface:
x <- huex10sttranscriptclusterPATH
...
x <- huex10sttranscriptclusterPATH
mapped_probes <- mappedkeys(x)
# Now convert the huex10sttranscriptclusterPATH2PROBE object to a list
xx <- as.list(x[mapped_probes][1:300])
if(length(xx) > 0){
...
huex10sttranscriptclusterPFAM is an R object that provides mappings between manufacturer iden-
...
huex10sttranscriptclusterPMID is an R object that provides mappings between manufacturer iden-
tifiers and PubMed identifiers. huex10sttranscriptclusterPMID2PROBE is an R object that provides
mappings between PubMed identifiers and manufacturer identifiers.

Details

When huex10sttranscriptclusterPMID is viewed as a list each manufacturer identifier is mapped
...
When huex10sttranscriptclusterPMID2PROBE is viewed as a list each PubMed identifier is mapped
...
## Bimap interface:
x <- huex10sttranscriptclusterPMID
...
huex10sttranscriptclusterREFSEQ
...
x <- huex10sttranscriptclusterPMID2PROBE
mapped_probes <- mappedkeys(x)
# Now convert the reverse map object huex10sttranscriptclusterPMID2PROBE to a list
xx <- as.list(x[mapped_probes][1:300])
if(length(xx) > 0){
...
huex10sttranscriptclusterPROSITE

Maps between Manufacturer Identifiers and PROSITE Identifiers

Description

huex10sttranscriptclusterPROSITE is an R object that provides mappings between manufacturer
...
huex10sttranscriptclusterREFSEQ is an R object that provides mappings between manufacturer
...
## Bimap interface:
x <- huex10sttranscriptclusterREFSEQ
...
huex10sttranscriptclusterSYMBOL
...
huex10sttranscriptclusterSYMBOL is an R object that provides mappings between manufacturer
...
huex10sttranscriptclusterUNIPROT
...
huex10sttranscriptclusterUNIPROT is an R object that contains mappings between the manufacturer
...
## Bimap interface:
x <- huex10sttranscriptclusterUNIPROT
...
huex10sttranscriptcluster_dbconn
...
huex10sttranscriptcluster_dbconn()
huex10sttranscriptcluster_dbfile()
huex10sttranscriptcluster_dbschema(file="", show.indices=FALSE)
huex10sttranscriptcluster_dbInfo()
...
huex10sttranscriptcluster_dbconn returns a connection object to the package annotation DB.
IMPORTANT: Don’t call dbDisconnect on the connection object returned by huex10sttranscriptcluster_dbconn
or you will break all the AnnDbObj objects defined in this package!
huex10sttranscriptcluster_dbfile returns the path (character string) to the package annota-
tion DB (this is an SQLite file).
huex10sttranscriptcluster_dbschema prints the schema definition of the package annotation
DB.
huex10sttranscriptcluster_dbInfo prints other information about the package annotation DB.

Value

huex10sttranscriptcluster_dbconn: a DBIConnection object representing an open connection
to the package annotation DB.
huex10sttranscriptcluster_dbfile: a character string with the path to the package annotation
DB.
huex10sttranscriptcluster_dbschema: none (invisible NULL).
huex10sttranscriptcluster_dbInfo: none (invisible NULL).
...
dbGetQuery(huex10sttranscriptcluster_dbconn(), "SELECT COUNT(*) FROM probes")
...
huex10sttranscriptcluster.db, 2
huex10sttranscriptcluster_dbconn,

21

huex10sttranscriptclusterACCNUM, 1
huex10sttranscriptclusterALIAS2PROBE,

2

huex10sttranscriptclusterCHR, 3
huex10sttranscriptclusterCHRLENGTHS,

4

huex10sttranscriptclusterCHRLOC, 4
huex10sttranscriptclusterENSEMBL,
...
huex10sttranscriptclusterENZYME, 7
huex10sttranscriptclusterGENENAME,

9

huex10sttranscriptclusterGO, 10
huex10sttranscriptclusterMAP, 12
huex10sttranscriptclusterMAPCOUNTS,

13

huex10sttranscriptclusterOMIM, 13
huex10sttranscriptclusterORGANISM,

14

huex10sttranscriptclusterPATH, 15
huex10sttranscriptclusterPFAM, 16
huex10sttranscriptclusterPMID, 17
huex10sttranscriptclusterPROSITE,
...
huex10sttranscriptcluster.db, 2
huex10sttranscriptcluster_dbconn, 21
huex10sttranscriptcluster_dbfile
...
huex10sttranscriptclusterCHR, 3
huex10sttranscriptclusterCHRLENGTHS, 4
huex10sttranscriptclusterCHRLOC, 4
huex10sttranscriptclusterCHRLOCEND

(huex10sttranscriptclusterCHRLOC),
4

huex10sttranscriptclusterENSEMBL, 5
huex10sttranscriptclusterENSEMBL2PROBE

(huex10sttranscriptclusterENSEMBL),
5

huex10sttranscriptclusterENTREZID, 6
huex10sttranscriptclusterENZYME, 7
huex10sttranscriptclusterENZYME2PROBE

(huex10sttranscriptclusterENZYME),
7

huex10sttranscriptclusterGENENAME, 9
huex10sttranscriptclusterGO, 10
huex10sttranscriptclusterGO2ALLPROBES,
...
huex10sttranscriptclusterGO2PROBE

(huex10sttranscriptclusterGO),
10

huex10sttranscriptclusterLOCUSID

(huex10sttranscriptclusterENTREZID),
6

huex10sttranscriptclusterMAP, 12
huex10sttranscriptclusterMAPCOUNTS, 13
huex10sttranscriptclusterOMIM, 13
huex10sttranscriptclusterORGANISM, 14
huex10sttranscriptclusterORGPKG
...
huex10sttranscriptclusterPATH, 15
huex10sttranscriptclusterPATH2PROBE
...
huex10sttranscriptclusterPFAM, 16
huex10sttranscriptclusterPMID, 17
huex10sttranscriptclusterPMID2PROBE

(huex10sttranscriptclusterPMID),
17

huex10sttranscriptclusterPROSITE, 18
huex10sttranscriptclusterREFSEQ, 18
huex10sttranscriptclusterSYMBOL, 20
huex10sttranscriptclusterUNIPROT, 21
huex10sttranscriptclusterUNIPROT2PROBE
