...
## Nightly (unreleased)[#](#nightly-unreleased "Link to this heading")

## Release 2.9.0 (released March 13, 2026)[#](#release-2-9-0-released-march-13-2026 "Link to this heading")
...
## Release 2.8.0 (released December 13, 2024)[#](#release-2-8-0-released-december-13-2024 "Link to this heading")
...
## Release 2.7.1 (released October 29, 2024)[#](#release-2-7-1-released-october-29-2024 "Link to this heading")

### Features:[#](#id3 "Link to this heading")

* Implement barcode correction algorithms.
* Add `smooth_length` to `ex.export_coverage`.

### Bugs fixed:[#](#id4 "Link to this heading")

* Fix #335: GTF parsing error when textual attributes contain semicolons.
* Fix #347: Add file name sanity check in various places.

## Release 2.7.0 (released August 27, 2024)[#](#release-2-7-0-released-august-27-2024 "Link to this heading")

### Features:[#](#id5 "Link to this heading")
...
### Other Changes:[#](#id6 "Link to this heading")
...
## Release 2.6.4 (released May 28, 2024)[#](#release-2-6-4-released-may-28-2024 "Link to this heading")

### Features:[#](#id7 "Link to this heading")
...
## Release 2.6.3 (released May 15, 2024)[#](#release-2-6-3-released-may-15-2024 "Link to this heading")

### Bugs fixed:[#](#id8 "Link to this heading")

* Fixed external sorter issues in version 2.6.2.

## Release 2.6.2 (released May 9, 2024)[#](#release-2-6-2-released-may-9-2024 "Link to this heading")

### Features:[#](#id9 "Link to this heading")

* Add the argument `exclude_chroms` to `metrics.tsse` to exclude certains chromosomes
  from TSSe calculation. The default is “chrM”.

## Release 2.6.1 (released May 2, 2024)[#](#release-2-6-1-released-may-2-2024 "Link to this heading")

### Features:[#](#id10 "Link to this heading")
...
## Release 2.6.0 (released March 9, 2024)[#](#release-2-6-0-released-march-9-2024 "Link to this heading")
...
### Bugs fixed:[#](#id13 "Link to this heading")
...
## Release 2.5.3 (released Jan 16, 2024)[#](#release-2-5-3-released-jan-16-2024 "Link to this heading")

### Features:[#](#id14 "Link to this heading")
...
## Release 2.5.2 (released Jan 4, 2024)[#](#release-2-5-2-released-jan-4-2024 "Link to this heading")

### Features:[#](#id16 "Link to this heading")

* Support anndata v0.10.
* Make it easier to build custom genome objects.
* Allow customized “gene\_id” and “gene\_name” keys in `pp.make_gene_matrix`.
...
## Release 2.5.1 (released Oct 23, 2023)[#](#release-2-5-1-released-oct-23-2023 "Link to this heading")

### Function renaming:[#](#function-renaming "Link to this heading")
...
### Bugs fixed:[#](#id19 "Link to this heading")

* Fix a bug in `pp.import_data` that causes the function to occasionally fail on small chunk sizes.

## Release 2.5.0 (released Oct 10, 2023)[#](#release-2-5-0-released-oct-10-2023 "Link to this heading")

### Breaking changes:[#](#id20 "Link to this heading")
...
### Features:[#](#id21 "Link to this heading")
...
### Bugs fixed:[#](#id22 "Link to this heading")

* #165: Fix reproducibility issues in various functions.

## Release 2.4.0 (released Sep 12, 2023)[#](#release-2-4-0-released-sep-12-2023 "Link to this heading")
...
### Bugs fixed:[#](#id24 "Link to this heading")

* #145, #148, and others.

## Release 2.3.1 (released Jun 21, 2023)[#](#release-2-3-1-released-jun-21-2023 "Link to this heading")

### Features:[#](#id25 "Link to this heading")
...
## Release 2.3.0 (released Apr 14, 2023)[#](#release-2-3-0-released-apr-14-2023 "Link to this heading")

### Breaking changes:[#](#id27 "Link to this heading")
...
### Features:[#](#id28 "Link to this heading")
...
## Release 2.2.0 (released Dec 2, 2022)[#](#release-2-2-0-released-dec-2-2022 "Link to this heading")
...
### Features:[#](#id31 "Link to this heading")

* Support in-memory AnnData and flexible conversions between backed and in-memory AnnData.

## Release 2.1.3 (released Nov 2, 2022)[#](#release-2-1-3-released-nov-2-2022 "Link to this heading")

### Features:[#](#id32 "Link to this heading")

* Add a low-memory mode in `pp.import_data` for parsing large unsorted fragment files.

### Bugs fixed:[#](#id33 "Link to this heading")

* Minor bug fixes and performance improvements.
* Fix 10X bam file parsing in `pp.make_fragment_file`.

## Release 2.1.2 (released Oct 1, 2022)[#](#release-2-1-2-released-oct-1-2022 "Link to this heading")

### Bugs fixed:[#](#id34 "Link to this heading")

* Minor bug fixes and performance improvements.

## Release 2.1.1 (released Sep 28, 2022)[#](#release-2-1-1-released-sep-28-2022 "Link to this heading")

### Features:[#](#id35 "Link to this heading")

* Add “tl.motif\_enrichment” to perform motif enrichment analysis.

### Bugs fixed:[#](#id36 "Link to this heading")

* Fix bugs in “ex.export\_bigwig”. NOTE: prior to this version, this function does not work as expected. Please update and rerun if you have used this function in 2.1.0.

## Release 2.1.0 (released Sep 17, 2022)[#](#release-2-1-0-released-sep-17-2022 "Link to this heading")

### Breaking changes:[#](#id37 "Link to this heading")

* “pp.make\_tile\_matrix” has been renamed to “pp.add\_tile\_matrix”.
...
* Rename each occurrence of “group\_by” to “gro