...
* User guide
  + [Create scATAC-seq fragments file](#create-scatac-seq-fragments-file)
    - [Fragment file format](#fragment-file-format)
    - [How the fragment file is generated](#how-the-fragment-file-is-generated)
    - [Additional arguments for the fragments function](#additional-arguments-for-the-fragments-function)
      * [Number of processors: `--nproc`](#number-of-processors-nproc)
      * [Minimum mapping quality: `--min_mapq`](#minimum-mapping-quality-min-mapq)
      * [Cell barcode tag: `--barcodetag`](#cell-barcode-tag-barcodetag)
      * [Cell barcode regex: `--barcode_regex`](#cell-barcode-regex-barcode-regex)
      * [Choosing chromosomes to include: `--use_chrom`](#choosing-chromosomes-to-include-use-chrom)
      * [Set the maximum distance between Tn5 integration sites: `--max_distance`](#set-the-maximum-distance-between-tn5-integration-sites-max-distance)
      * [Set the maximum number of fragments to hold in memory before collapsing: `--chunksize`](#set-the-maximum-number-of-fragments-to-hold-in-memory-before-collapsing-chunksize)
      * [Change the Tn5 shift applied: `--shift_plus` and `--shift_minus`](#change-the-tn5-shift-applied-shift-plus-and-shift-minus)
      * [Change PCR duplicate removal strategy: `--collapse_within`](#change-pcr-duplicate-removal-strategy-collapse-within)
  + [Filter cell barcodes from BAM file](#filter-cell-barcodes-from-bam-file)
  + [Add read tags to BAM file](#add-read-tags-to-bam-file)
  + [Convert read tag to read group](#convert-read-tag-to-read-group)
  + [Copy/move read tag to another read tag](#copy-move-read-tag-to-another-read-tag)
  + [Copy cell barcode to/from read names/tags](#copy-cell-barcode-to-from-read-names-tags)
  + [Add cell barcodes to FASTQ read names](#add-cell-barcodes-to-fastq-read-names)
    - [Additional arguments for the barcode function](#additional-arguments-for-the-barcode-function)
      * [Bases: `--bases`](#bases-bases)
      * [Barcode read file: `--barcode_fastq`](#barcode-read-file-barcode-fastq)
      * [Read 1 and read 2: `--read1` and `--read2`](#read-1-and-read-2-read1-and-read2)
    - [Example](#example)
...
* User guide
* [View page source](_sources/basic_usage.rst.txt)

---

# User guide[](#user-guide "Link to this heading")

## Create scATAC-seq fragments file[](#create-scatac-seq-fragments-file "Link to this heading")
...
### Fragment file format[](#fragment-file-format "Link to this heading")
...
of times the fragment was sequenced. See the [10x Genomics](https://support.10xgenomics.com/single-cell-atac/software/pipelines/latest/output/fragments)
...
block-gzip compressed ([bgzip](https://www.htslib.org/doc/bgzip.html)),
and indexed using [tabix](https://www.htslib.org/doc/tabix.html).
...
### How the fragment file is generated[](#how-the-fragment-file-is-generated "Link to this heading")
...
### Additional arguments for the fragments function[](#additional-arguments-for-the-fragments-function "Link to this heading")

#### Number of processors: `--nproc`[](#number-of-processors-nproc "Link to this heading")
...
#### Minimum mapping quality: `--min_mapq`[](#minimum-mapping-quality-min-mapq "Link to this heading")

The minimum allowed mapping quality (MAPQ) can be set using `--min_mapq`.
Depending on the aligner used, the MAPQ value can mean different [things](https://sequencing.qcfail.com/articles/mapq-values-are-really-useful-but-their-implementation-is-a-mess/).
...
#### Cell barcode tag: `--barcodetag`[](#cell-barcode-tag-barcodetag "Link to this heading")
...
#### Cell barcode regex: `--barcode_regex`[](#cell-barcode-regex-barcode-regex "Link to this heading")
...
#### Choosing chromosomes to include: `--use_chrom`[](#choosing-chromosomes-to-include-use-chrom "Link to this heading")
...
#### Set the maximum distance between Tn5 integration sites: `--max_distance`[](#set-the-maximum-distance-between-tn5-integration-sites-max-distance "Link to this heading")
...
#### Set the maximum number of fragments to hold in memory before collapsing: `--chunksize`[](#set-the-maximum-number-of-fragments-to-hold-in-memory-before-collapsing-chunksize "Link to this heading")
...
#### Change the Tn5 shift applied: `--shift_plus` and `--shift_minus`[](#change-the-tn5-shift-applied-shift-plus-and-shift-minus "Link to this heading")
...
#### Change PCR duplicate removal strategy: `--collapse_within`[](#change-pcr-duplicate-removal-strategy-collapse-within "Link to this heading")
...
## Filter cell barcodes from BAM file[](#filter-cell-barcodes-from-bam-file "Link to this heading")
