...
inputs:
  - id: input
    ...
    doc: VCF or BCF input files (File format is determined by file extension), 
      or a file having a '.list' suffix containing the path to the files, one 
      per line.
    inputBinding:
      position: 101
      prefix: --INPUT
  - id: output
    type: string
    doc: The merged VCF or BCF file. File format is determined by file 
      extension.
    inputBinding:
      position: 101
      prefix: --OUTPUT
  ...
  - id: sequence_dictionary
    type:
      - 'null'
      - File
    doc: The index sequence dictionary to use instead of the sequence dictionary
      in the input files
    inputBinding:
      position: 101
