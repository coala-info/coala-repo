...
baseCommand:
  - bioconvert
  - stockholm2clustal
label: bioconvert_stockholm2clustal
doc: "Convert file from '(STOCKHOLM,)' to '(CLUSTAL,)' format. See bioconvert.readthedocs.io
...
stdout: bioconvert_stockholm2clustal.out
