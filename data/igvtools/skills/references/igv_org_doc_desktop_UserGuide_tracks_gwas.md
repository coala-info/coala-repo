...
## Manhattan plot[#](#manhattan-plot "Direct link to this section")
...
associated with that point. You can see the pop-up for the topmost data point in this image. Note that the point's vertical position is associated with its *P* value.

![](../../img/igv_gwas_popup.jpg)

## Plot attributes[#](#plot-attributes "Direct link to this section")
