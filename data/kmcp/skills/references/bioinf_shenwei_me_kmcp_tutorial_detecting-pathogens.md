...
[Skip to content](#detecting-specific-pathogens-in-sequencing-data)
...
* [x]
  ...
  + [ ]
    ...
    Table of contents
    - [Data](#data)
    - [Preprocessing reference genomes](#preprocessing-reference-genomes)
    - [Creating a KMCP database](#creating-a-kmcp-database)
    - [Searching reads against the KMCP database](#searching-reads-against-the-kmcp-database)
    - [Profiling](#profiling)
