...
baseCommand: perl
label: perl-pdf-table_perl
doc: "The Perl 5 language interpreter\n\nTool homepage: http://metacpan.org/pod/PDF::Table"
inputs:
  - id: program_file
    type:
      - 'null'
...
hints:
  - class: DockerRequirement
    dockerPull: quay.io/biocontainers/perl-pdf-table:1.007--pl5321hdfd78af_0
stdout: perl-pdf-table_perl.out
