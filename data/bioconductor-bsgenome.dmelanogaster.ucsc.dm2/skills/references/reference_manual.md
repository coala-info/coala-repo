...
chromFa.zip from http://hgdownload.cse.ucsc.edu/goldenPath/dm2/bigZips/
...
txdb <- makeTranscriptDbFromUCSC("dm2", "refGene")
gn <- sort(genes(txdb))
...
BSgenome.Dmelanogaster.UCSC.dm2, 1
...
BSgenome, 1
BSgenome.Dmelanogaster.UCSC.dm2, 1
BSgenome.Dmelanogaster.UCSC.dm2-package
