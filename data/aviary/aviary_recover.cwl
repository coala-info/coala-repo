...
baseCommand: aviary recover
label: aviary_recover
doc: "The aviary binning pipeline\n\nTool homepage: https://github.com/rhysnewell/aviary/"
inputs:
  - id: assembly
    type:
      - 'null'
  ...
  - id: pe2
    ...
    inputBinding:
      position: 101
      prefix: --pe-2
  - id: perform_strain_analysis
    type:
      - 'null'
      - boolean
    doc: Specify whether to use Lorikeet on recovered MAGs get strain diversity 
      metrics
    inputBinding:
      position: 101
      prefix: --perform-strain-analysis
  - id: pplacer_threads
    type:
      - 'null'
      - int
