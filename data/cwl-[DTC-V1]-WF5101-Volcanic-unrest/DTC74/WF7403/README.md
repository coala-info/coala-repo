...
This directory contains workflow files generated from the spreadsheet description of WF7403 using a [custom tool](https://github.com/Marco-Salvi/dt-geo-converter). These files provide an initial starting point, **manual verification and updates are required** to ensure accuracy.
...
``` log
[WARNING] [Inner step ST740102 has no inputs or outputs; please verify its configuration]
[WARNING] [Inner step ST740302 has no inputs or outputs; please verify its configuration]
[WARNING] [Inner step ST740302 has no inputs or outputs; please verify its configuration]
[WARNING] [Inner step ST740302 has no inputs or outputs; please verify its configuration]
[WARNING] [Step ST740102 has no inputs or outputs]
[WARNING] [Step ST740301 has no inputs or outputs]
[WARNING] [Step ST740302 has no inputs or outputs]
[WARNING] [Step ST740101 has no inputs or outputs]
```



For complete details, please refer to the [log file](./workflows/WF7403)
