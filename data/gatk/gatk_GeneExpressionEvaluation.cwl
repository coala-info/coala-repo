...
label: gatk_GeneExpressionEvaluation
doc: This tool evaluates gene expression from RNA-seq reads aligned to genome. 
  Features to evaluate expression over are defined in an input annotation file 
  in gff3 fomat. Output is a tsv listing sense and antisense expression for all 
  grouping features.
inputs:
  - id: gff_file
    type: File
    doc: Gff3 file containing feature annotations
    inputBinding:
      position: 101
      prefix: --gff-file
  - id: input
  ...
  - id: feature_label_key
    type:
      - 'null'
      - string
    doc: Whether to label features by ID or Name
    inputBinding:
      position: 101
      prefix: --feature-label-key
  - id: gatk_config_file
    type:
      - 'null'
      - string
  ...
  - id: multi_map_method
    type:
      - 'null'
      - string
    doc: How to distribute weight of reads with multiple alignments
    inputBinding:
      position: 101
      prefix: --multi-map-method
  - id: multi_overlap_method
    type:
      - 'null'
      - string
    doc: How to distribute weight of alignments which overlap multiple features
    inputBinding:
      position: 101
      prefix: --multi-overlap-method
  - id: overlap_type
    type:
      - 'null'
      - type: array
  ...
  - id: read_strands
    type:
      - 'null'
      - string
    doc: Which strands (forward or reverse) each read is expected to be on
    inputBinding:
      position: 101
      prefix: --read-strands
  ...
  - id: unspliced
    type:
      - 'null'
      - boolean
    doc: Whether the rna is unspliced.
    inputBinding:
      position: 101
      prefix: --unspliced
  - id: use_jdk_deflater
