...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Faweimann%2Ftraitar%2Fblob%2Fmaster%2Fsetup.py)
...
[History](/aweimann/traitar/commits/master/setup.py)
...
[Raw](https://github.com/aweimann/traitar/raw/refs/heads/master/setup.py)
...
long\_description = open('README.rst', 'r').read()
...
scripts = ['bin/traitar', 'bin/merge\_preds', 'bin/heatmap', 'bin/domtblout2gene\_generic', 'bin/predict', 'bin/hmmer2filtered\_best', 'bin/hmm2gff'],

zip\_safe=False,

install\_requires = ["pandas >= 0.13.1", "matplotlib >= 1.3.1", "numpy >= 1.6", "scipy >= 0.13.3"])
