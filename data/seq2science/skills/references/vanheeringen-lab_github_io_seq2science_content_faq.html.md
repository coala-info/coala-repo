...
* Frequently Asked Questions (FAQ)
  + [One of the rules failed and the log turns red!](#one-of-the-rules-failed-and-the-log-turns-red)
  + [The pipeline starts creating conda environments and crashes (CreateCondaEnvironmentException)](#the-pipeline-starts-creating-conda-environments-and-crashes-createcondaenvironmentexception)
  + [Encountered problems while solving (nothing provides … needed by seq2science)](#encountered-problems-while-solving-nothing-provides-needed-by-seq2science)
  + [What if I change the configuration or samples file after running seq2science?](#what-if-i-change-the-configuration-or-samples-file-after-running-seq2science)
  + [Failed to call external services.](#failed-to-call-external-services)
  + [Unknown provider](#unknown-provider)
  + [Storage exhausted / No Space Left on Device](#storage-exhausted-no-space-left-on-device)
  + [I want to run the pipeline until a certain rule, but not farther](#i-want-to-run-the-pipeline-until-a-certain-rule-but-not-farther)
  + [My run is stuck on ‘Select jobs to execute…’ What should I do?](#my-run-is-stuck-on-select-jobs-to-execute-what-should-i-do)
  + [ChIP-seq: MACS2: Too few paired peaks so I can not build the model!](#chip-seq-macs2-too-few-paired-peaks-so-i-can-not-build-the-model)
  + [RNA-seq: this gene should be expressed!](#rna-seq-this-gene-should-be-expressed)
  + [scRNA-seq: Kallisto|Bustools: [~warn] no reads pseudoaligned](#scrna-seq-kallisto-bustools-warn-no-reads-pseudoaligned)
  + [scRNA-seq: Kallisto|Bustools: what(): std::bad\_alloc](#scrna-seq-kallisto-bustools-what-std-bad-alloc)
  + [UCSC trackhub displays no data](#ucsc-trackhub-displays-no-data)
  + [ATAC-seq: bwa-mem2: Runs are aborted due to a segmentation fault.](#atac-seq-bwa-mem2-runs-are-aborted-due-to-a-segmentation-fault)
* [Contributing to seq2science](../CONTRIBUTING.html)

[seq2science](../index.html)

* Frequently Asked Questions (FAQ)
* [Edit on GitHub](https://github.com/vanheeringen-lab/seq2science/blob/master/docs/content/faq.md)

---

# Frequently Asked Questions (FAQ)[](#frequently-asked-questions-faq "Link to this heading")

## One of the rules failed and the log turns red![](#one-of-the-rules-failed-and-the-log-turns-red "Link to this heading")
...
## The pipeline starts creating conda environments and crashes (CreateCondaEnvironmentException)[](#the-pipeline-starts-creating-conda-environments-and-crashes-createcondaenvironmentexception "Link to this heading")
...
## Encountered problems while solving (nothing provides … needed by seq2science)[](#encountered-problems-while-solving-nothing-provides-needed-by-seq2science "Link to this heading")
...
## What if I change the configuration or samples file after running seq2science?[](#what-if-i-change-the-configuration-or-samples-file-after-running-seq2science "Link to this heading")
...
## Failed to call external services.[](#failed-to-call-external-services "Link to this heading")
...
## Unknown provider[](#unknown-provider "Link to this heading")
...
## Storage exhausted / No Space Left on Device[](#storage-exhausted-no-space-left-on-device "Link to this heading")
...
## I want to run the pipeline until a certain rule, but not farther[](#i-want-to-run-the-pipeline-until-a-certain-rule-but-not-farther "Link to this heading")
...
## My run is stuck on ‘Select jobs to execute…’ What should I do?[](#my-run-is-stuck-on-select-jobs-to-execute-what-should-i-do "Link to this heading")
...
## ChIP-seq: MACS2: Too few paired peaks so I can not build the model![](#chip-seq-macs2-too-few-paired-peaks-so-i-can-not-build-the-model "Link to this heading")
...
## RNA-seq: this gene should be expressed![](#rna-seq-this-gene-should-be-expressed "Link to this heading")
...
## scRNA-seq: Kallisto|Bustools: [~warn] no reads pseudoaligned[](#scrna-seq-kallisto-bustools-warn-no-reads-pseudoaligned "Link to this heading")
...
## scRNA-seq: Kallisto|Bustools: what(): std::bad\_alloc[](#scrna-seq-kallisto-bustools-what-std-bad-alloc "Link to this heading")
...
## UCSC trackhub displays no data[](#ucsc-trackhub-displays-no-data "Link to this heading")
...
## ATAC-seq: bwa-mem2: Runs are aborted due to a segmentation fault.[](#atac-seq-bwa-mem2-runs-are-aborted-due-to-a-segmentation-fault "Link to this heading")

If you get an error while running the rules bwa-mem2/samtools\_presort, yet the log bwa-mem2\_align and samtools\_presort log files show no errors, this may be due to segmentation faults that sometimes occur when running bwa-mem2. This can be circumvented by using the aligner bwa-mem instead.

[Previous](seq2science_profiles.html "Seq2science profiles")
[Next](../CONTRIBUTING.html "Contributing to seq2science")
