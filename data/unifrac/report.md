...
### Tool Description
Compute UniFrac distances between samples based on phylogenetic relationships.
...
### Tool Description
Calculates Faith's Phylogenetic Diversity (PD) for each sample in a BIOM table using a provided phylogeny.
