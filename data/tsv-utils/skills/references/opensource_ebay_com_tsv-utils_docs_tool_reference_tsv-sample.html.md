...
* **Shuffling** (*default*): All lines are read into memory and output in random order. All orderings are equally likely.
...
* Wikipedia: https://en.wikipedia.org/wiki/Reservoir\_sampling
