...
mogene11sttranscriptclusterACCNUM

Map Manufacturer identifiers to Accession Numbers

Description

mogene11sttranscriptclusterACCNUM is an R object that contains mappings between a manufac-
...
## Bimap interface:
x <- mogene11sttranscriptclusterACCNUM
...
mogene11sttranscriptclusterALIAS2PROBE
...
mogene11sttranscriptclusterALIAS is an R object that provides mappings between common gene
...
xx <- as.list(mogene11sttranscriptclusterALIAS2PROBE)
if(length(xx) > 0){
...
Welcome to the mogene11sttranscriptcluster.db annotation Package. The purpose of this package
is to provide detailed information about the mogene11sttranscriptcluster platform. This package is
updated biannually.
Objects in this package are accessed using the select() interface. See ?select in the AnnotationDbi
package for details.

mogene11sttranscriptclusterCHR
...
## use of select().
ls("package:mogene11sttranscriptcluster.db")
...
mogene11sttranscriptclusterCHR is an R object that provides mappings between a manufacturer
...
## Bimap interface:
x <- mogene11sttranscriptclusterCHR
...
mogene11sttranscriptclusterCHRLOC
...
mogene11sttranscriptclusterCHRLENGTHS

A named vector for the length of each of the chromosomes

Description

mogene11sttranscriptclusterCHRLENGTHS provides the length measured in base pairs for each of
the chromosomes.
...
## Bimap interface:
tt <- mogene11sttranscriptclusterCHRLENGTHS
...
mogene11sttranscriptclusterCHRLOC is an R object that maps manufacturer identifiers to the start-
...
mogene11sttranscriptclusterENSEMBL
...
## Bimap interface:
x <- mogene11sttranscriptclusterCHRLOC
...
mogene11sttranscriptclusterENSEMBL is an R object that contains mappings between manufac-
...
mogene11sttranscriptclusterENTREZID
...
## Bimap interface:
x <- mogene11sttranscriptclusterENSEMBL
...
x <- mogene11sttranscriptclusterENSEMBL2PROBE
mapped_genes <- mappedkeys(x)
# Convert to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
mogene11sttranscriptclusterENTREZID is an R object that provides mappings between manufac-
turer identifiers and Entrez Gene identifiers.

mogene11sttranscriptclusterENZYME
...
## Bimap interface:
x <- mogene11sttranscriptclusterENTREZID
...
mogene11sttranscriptclusterENZYME is an R object that provides mappings between manufacturer
identifiers and EC numbers. mogene11sttranscriptclusterENZYME2PROBE is an R object that
...
When the mogene11sttranscriptclusterENZYME maping viewed as a list, each manufacturer identi-
...
For the mogene11sttranscriptclusterENZYME2PROBE, each EC number maps to a named vector
...
bers. In mogene11sttranscriptclusterENZYME2PROBE, EC is dropped from the Enzyme Commis-
sion numbers.
...
## Bimap interface:
x <- mogene11sttranscriptclusterENZYME
...
mogene11sttranscriptclusterGENENAME
...
# Now convert mogene11sttranscriptclusterENZYME2PROBE to a list to see inside
x <- mogene11sttranscriptclusterENZYME2PROBE
mapped_probes <- mappedkeys(x)
## convert to a list
xx <- as.list(x[mapped_probes][1:3])
if(length(xx) > 0){
...
mogene11sttranscriptclusterGENENAME is an R object that maps manufacturer identifiers to the
...
## Bimap interface:
x <- mogene11sttranscriptclusterGENENAME
# Get the probe identifiers that are mapped to a gene name
mapped_probes <- mappedkeys(x)

10

mogene11sttranscriptclusterGO
...
mogene11sttranscriptclusterGO is an R object that provides mappings between manufacturer iden-
tifiers and the GO identifiers that they are directly associated with. This mapping and its reverse
mapping (mogene11sttranscriptclusterGO2PROBE) do NOT associate the child terms from the GO
ontology with the gene. Only the directly evidenced terms are represented here.

mogene11sttranscriptclusterGO2ALLPROBES is an R object that provides mappings between a
...
than mogene11sttranscriptclusterGO2PROBE.

Details

If mogene11sttranscriptclusterGO is cast as a list, each manufacturer identifier is mapped to a list
...
If mogene11sttranscriptclusterGO2ALLPROBES or mogene11sttranscriptclusterGO2PROBE is cast
...
• mogene11sttranscriptclusterGO2ALLPROBES
• AnnotationDb-class for use of the select() interface.
...
## Bimap interface:
x <- mogene11sttranscriptclusterGO
...
# For the reverse map:
x <- mogene11sttranscriptclusterGO2PROBE
mapped_genes <- mappedkeys(x)
# Convert to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
mogene11sttranscriptclusterMGI

x <- mogene11sttranscriptclusterGO2ALLPROBES
mapped_genes <- mappedkeys(x)
# Convert mogene11sttranscriptclusterGO2ALLPROBES to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
mogene11sttranscriptclusterMAPCOUNTS

Number of mapped keys
gene11sttranscriptcluster.db
...
mogene11sttranscriptclusterMAPCOUNTS provides the "map count" (i.e.
keys) for each map in package mogene11sttranscriptcluster.db.
...
mogene11sttranscriptclusterMGI is an R object that contains mappings between manufacturer iden-
tifiers and Jackson Laboratory MGI gene accession numbers.
...
mogene11sttranscriptclusterORGANISM
...
## Bimap interface:
x <- mogene11sttranscriptclusterMGI
...
x <- mogene11sttranscriptclusterMGI2PROBE
mapped_genes <- mappedkeys(x)
# Convert to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
The Organism information for mogene11sttranscriptcluster

Description

mogene11sttranscriptclusterORGANISM is an R object that contains a single item: a character
string that names the organism for which mogene11sttranscriptcluster was built. mogene11sttranscriptclusterORGPKG
...
Although the package name is suggestive of the organism for which it was built, mogene11sttranscriptclusterORGANISM
provides a simple way to programmatically extract the organism name. mogene11sttranscriptclusterORGPKG
...
mogene11sttranscriptclusterPATH
...
## Bimap interface:
mogene11sttranscriptclusterORGANISM
mogene11sttranscriptclusterORGPKG
...
mogene11sttranscriptclusterPATH maps probe identifiers to the identifiers used by KEGG for path-
ways in which the genes represented by the probe identifiers are involved

mogene11sttranscriptclusterPATH2PROBE is an R object that provides mappings between KEGG
...
mogene11sttranscriptclusterPFAM
...
## Bimap interface:
x <- mogene11sttranscriptclusterPATH
...
x <- mogene11sttranscriptclusterPATH
mapped_probes <- mappedkeys(x)
# Now convert the mogene11sttranscriptclusterPATH2PROBE object to a list
xx <- as.list(x[mapped_probes][1:300])
if(length(xx) > 0){
...
mogene11sttranscriptclusterPFAM is an R object that provides mappings between manufacturer
...
mogene11sttranscriptclusterPMID

Maps between Manufacturer Identifiers and PubMed Identifiers

Description

mogene11sttranscriptclusterPMID is an R object that provides mappings between manufacturer
identifiers and PubMed identifiers. mogene11sttranscriptclusterPMID2PROBE is an R object that
...
When mogene11sttranscriptclusterPMID is viewed as a list each manufacturer identifier is mapped
...
When mogene11sttranscriptclusterPMID2PROBE is viewed as a list each PubMed identifier is
...
## Bimap interface:
x <- mogene11sttranscriptclusterPMID
...
x <- mogene11sttranscriptclusterPMID2PROBE
mapped_probes <- mappedkeys(x)
# Now convert the reverse map object mogene11sttranscriptclusterPMID2PROBE to a list
xx <- as.list(x[mapped_probes][1:300])

mogene11sttranscriptclusterPROSITE
...
mogene11sttranscriptclusterPROSITE is an R object that provides mappings between manufacturer
...
mogene11sttranscriptclusterREFSEQ

Map between Manufacturer Identifiers and RefSeq Identifiers

Description

mogene11sttranscriptclusterREFSEQ is an R object that provides mappings between manufacturer
...
mogene11sttranscriptclusterSYMBOL
...
## Bimap interface:
x <- mogene11sttranscriptclusterREFSEQ
...
mogene11sttranscriptclusterSYMBOL is an R object that provides mappings between manufacturer
identifiers and gene abbreviations.

mogene11sttranscriptclusterUNIPROT
...
## Bimap interface:
x <- mogene11sttranscriptclusterSYMBOL
...
mogene11sttranscriptclusterUNIPROT is an R object that contains mappings between the manufac-
...
mogene11sttranscriptcluster_dbconn
...
## Bimap interface:
x <- mogene11sttranscriptclusterUNIPROT
...
mogene11sttranscriptcluster_dbconn()
mogene11sttranscriptcluster_dbfile()
mogene11sttranscriptcluster_dbschema(file="", show.indices=FALSE)
...
mogene11sttranscriptcluster_dbconn returns a connection object to the package annotation
DB. IMPORTANT: Don’t call dbDisconnect on the connection object returned by mogene11sttranscriptcluster_dbconn
or you will break all the AnnDbObj objects defined in this package!
mogene11sttranscriptcluster_dbfile returns the path (character string) to the package anno-
...
mogene11sttranscriptcluster_dbschema prints the schema definition of the package annotation
DB.
mogene11sttranscriptcluster_dbInfo prints other information about the package annotation
DB.

Value

mogene11sttranscriptcluster_dbconn: a DBIConnection object representing an open connec-
tion to the package annotation DB.
mogene11sttranscriptcluster_dbfile: a character string with the path to the package annota-
tion DB.
mogene11sttranscriptcluster_dbschema: none (invisible NULL).
mogene11sttranscriptcluster_dbInfo: none (invisible NULL).
...
dbGetQuery(mogene11sttranscriptcluster_dbconn(), "SELECT COUNT(*) FROM probes")
...
mogene11sttranscriptcluster.db, 2
mogene11sttranscriptcluster_dbconn,
...
mogene11sttranscriptclusterCHR, 3
mogene11sttranscriptclusterCHRLENGTHS,
...
mogene11sttranscriptclusterGO, 10
mogene11sttranscriptclusterMAPCOUNTS,

12

mogene11sttranscriptclusterMGI, 12
mogene11sttranscriptclusterORGANISM,
...
mogene11sttranscriptcluster

(mogene11sttranscriptcluster.db),
2

mogene11sttranscriptcluster.db, 2
mogene11sttranscriptcluster_dbconn, 20
mogene11sttranscriptcluster_dbfile
...
mogene11sttranscriptclusterACCNUM, 1
mogene11sttranscriptclusterALIAS2PROBE,
...
mogene11sttranscriptclusterCHRLOC, 4
mogene11sttranscriptclusterCHRLOCEND

(mogene11sttranscriptclusterCHRLOC),
4

mogene11sttranscriptclusterENSEMBL, 5
mogene11sttranscriptclusterENSEMBL2PROBE

(mogene11sttranscriptclusterENSEMBL),
5

mogene11sttranscriptclusterENTREZID, 6

INDEX

23

mogene11sttranscriptclusterENZYME, 7
mogene11sttranscriptclusterENZYME2PROBE

(mogene11sttranscriptclusterENZYME),
7

mogene11sttranscriptclusterGENENAME, 9
mogene11sttranscriptclusterGO, 10
mogene11sttranscriptclusterGO2ALLPROBES,
...
mogene11sttranscriptclusterGO2PROBE

(mogene11sttranscriptclusterGO),
10

mogene11sttranscriptclusterLOCUSID
...
mogene11sttranscriptclusterMGI, 12
mogene11sttranscriptclusterMGI2PROBE
...
mogene11sttranscriptclusterPATH, 14
mogene11sttranscriptclusterPATH2PROBE

(mogene11sttranscriptclusterPATH),
14

mogene11sttranscriptclusterPFAM, 15
mogene11sttranscriptclusterPMID, 15
mogene11sttranscriptclusterPMID2PROBE

(mogene11sttranscriptclusterPMID),
15

mogene11sttranscriptclusterPROSITE, 17
mogene11sttranscriptclusterREFSEQ, 17
mogene11sttranscriptclusterSYMBOL, 18
mogene11sttranscriptclusterUNIPROT, 19
mogene11sttranscriptclusterUNIPROT2PROBE
