# Code example from 'LRBase.Xtr.eg.db' vignette. See references/ for full tutorial.

### R code from vignette source 'LRBase.Xtr.eg.db.Rnw'
### Encoding: UTF-8
...
###################################################
### code chunk number 2: LRBase.Xtr.eg.db.Rnw:45-49
###################################################
...
###################################################
### code chunk number 3: LRBase.Xtr.eg.db.Rnw:55-60
###################################################
if(interactive()){
...
###################################################
### code chunk number 4: LRBase.Xtr.eg.db.Rnw:67-74
###################################################
if(interactive()){
...
###################################################
### code chunk number 5: LRBase.Xtr.eg.db.Rnw:80-89
###################################################
if(interactive()){
...
###################################################
### code chunk number 6: LRBase.Xtr.eg.db.Rnw:106-114
###################################################
if(interactive()){
