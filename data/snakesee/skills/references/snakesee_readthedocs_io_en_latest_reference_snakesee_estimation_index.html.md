...
[Skip to content](#snakesee.estimation)
...
* [Classes](#snakesee.estimation-classes)
  ...
  + [HistoricalDataLoader](#snakesee.estimation.HistoricalDataLoader)
    ...
    - [Functions](#snakesee.estimation.HistoricalDataLoader-functions)
      ...
      * [\_\_init\_\_](#snakesee.estimation.HistoricalDataLoader.__init__)
      * [load\_from\_events](#snakesee.estimation.HistoricalDataLoader.load_from_events)
      * [load\_from\_metadata](#snakesee.estimation.HistoricalDataLoader.load_from_metadata)
  + [PendingRuleInferrer](#snakesee.estimation.PendingRuleInferrer)

    - [Functions](#snakesee.estimation.PendingRuleInferrer-functions)

      * [infer](#snakesee.estimation.PendingRuleInferrer.infer)
  + [RuleMatchingEngine](#snakesee.estimation.RuleMatchingEngine)

    - [Functions](#snakesee.estimation.RuleMatchingEngine-functions)

      * [\_\_init\_\_](#snakesee.estimation.RuleMatchingEngine.__init__)
      * [find\_best\_match](#snakesee.estimation.RuleMatchingEngine.find_best_match)
      * [find\_by\_code\_hash](#snakesee.estimation.RuleMatchingEngine.find_by_code_hash)
      * [find\_similar](#snakesee.estimation.RuleMatchingEngine.find_similar)
  + [TimeEstimator](#snakesee.estimation.TimeEstimator)

    - [Attributes](#snakesee.estimation.TimeEstimator-attributes)

      * [rule\_stats](#snakesee.estimation.TimeEstimator.rule_stats)
      * [thread\_stats](#snakesee.estimation.TimeEstimator.thread_stats)
      * [wildcard\_stats](#snakesee.estimation.TimeEstimator.wildcard_stats)
    - [Functions](#snakesee.estimation.TimeEstimator-functions)

      * [\_\_init\_\_](#snakesee.estimation.TimeEstimator.__init__)
      * [estimate\_remaining](#snakesee.estimation.TimeEstimator.estimate_remaining)
      * [get\_estimate\_for\_job](#snakesee.estimation.TimeEstimator.get_estimate_for_job)
      * [global\_mean\_duration](#snakesee.estimation.TimeEstimator.global_mean_duration)
      * [load\_from\_events](#snakesee.estimation.TimeEstimator.load_from_events)
      * [load\_from\_metadata](#snakesee.estimation.TimeEstimator.load_from_metadata)
...
## Classes[¶](#snakesee.estimation-classes "Permanent link")

### HistoricalDataLoader [¶](#snakesee.estimation.HistoricalDataLoader "Permanent link")
...
#### Functions[¶](#snakesee.estimation.HistoricalDataLoader-functions "Permanent link")

##### \_\_init\_\_ [¶](#snakesee.estimation.HistoricalDataLoader.__init__ "Permanent link")
...
##### load\_from\_events [¶](#snakesee.estimation.HistoricalDataLoader.load_from_events "Permanent link")
