...
inputs:
  ...
  interpro:
    ...
    inputBinding:
      prefix: -path
    default: /unlock/infrastructure/binaries/interproscan/interproscan-5.53-87.0

baseCommand: ["java", "-Xmx5g", "-jar", "/unlock/infrastructure/binaries/sapp/SAPP-2.0.jar", "-interpro"]
