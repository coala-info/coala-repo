...
inputs:
  ...
  - id: repeated
    type:
      - 'null'
      - boolean
    doc: split for further printing duplicate k-mers
    inputBinding:
      position: 101
      prefix: --repeated
  - id: threads
  ...
  - id: unique
    type:
      - 'null'
      - boolean
    doc: split for further removing duplicate k-mers
    inputBinding:
      position: 101
      prefix: --unique
  - id: verbose
