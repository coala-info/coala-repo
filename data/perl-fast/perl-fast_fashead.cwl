...
baseCommand: fashead
label: perl-fast_fashead
doc: "Print the first few sequence records of a multifasta file.\n\nTool homepage:
...
inputs:
  ...
  - id: join
    type:
      - 'null'
      - string
    doc: Use [string] to append filenames in descriptions. Use "\t" to indicate a
      tab-character.
    inputBinding:
      position: 102
      prefix: --join
