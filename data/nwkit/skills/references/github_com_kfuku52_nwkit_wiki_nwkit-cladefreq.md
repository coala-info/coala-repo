...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fkfuku52%2Fnwkit%2Fwiki%2Fnwkit-cladefreq)
...
·
[2 revisions](/kfuku52/nwkit/wiki/nwkit-cladefreq/_history)

## Overview

`nwkit cladefreq` summarizes how often each internal clade appears in a collection of rooted trees.

The output is a tab-separated table with the clade leaf set, clade size, weighted count, and frequency.
...
```
nwkit cladefreq -i trees.nwk -o cladefreq.tsv
```

The input may contain multiple Newick trees in one file, one after another.
...
### Example output (`cladefreq.tsv`)

| leaf\_set | num\_leaves | weight\_sum | frequency |
| --- | --- | --- | --- |
| A,B | 2 | 2.0 | 66.66666666666666 |
| C,D | 2 | 2.0 | 66.66666666666666 |
| A,C | 2 | 1.0 | 33.33333333333333 |
| B,D | 2 | 1.0 | 33.33333333333333 |
...
The weight table must contain a `weight` column and may optionally contain a 1-based `tree_id` column.

## Comparing to a reference topology
...
When a reference tree is provided, `in_reference` and `reference_support` columns are added to the output.

## Other options

* `--support_scale percent|proportion`: report clade frequencies as percentages or proportions
...
* Loading
  ...
  + [Overview](/kfuku52/nwkit/wiki/nwkit-cladefreq#overview)
  + [Basic example](/kfuku52/nwkit/wiki/nwkit-cladefreq#basic-example)
  + [Command](/kfuku52/nwkit/wiki/nwkit-cladefreq#command)
  + [Example input (trees.nwk)](/kfuku52/nwkit/wiki/nwkit-cladefreq#example-input-treesnwk)
  + [Example output (cladefreq.tsv)](/kfuku52/nwkit/wiki/nwkit-cladefreq#example-output-cladefreqtsv)
  + [Weighted frequencies](/kfuku52/nwkit/wiki/nwkit-cladefreq#weighted-frequencies)
  + [Command](/kfuku52/nwkit/wiki/nwkit-cladefreq#command-1)
  + [Comparing to a reference topology](/kfuku52/nwkit/wiki/nwkit-cladefreq#comparing-to-a-reference-topology)
  + [Command](/kfuku52/nwkit/wiki/nwkit-cladefreq#command-2)
  + [Other options](/kfuku52/nwkit/wiki/nwkit-cladefreq#other-options)
* Loading
