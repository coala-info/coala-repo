...
`R` is an open-source statistical environment which can be easily modified to enhance its functionality via packages. *[iSEEpathways](https://bioconductor.org/packages/3.22/iSEEpathways)* is a `R` package available via the [Bioconductor](http://bioconductor.org) repository for packages. `R` can be installed on any operating system from [CRAN](https://cran.r-project.org/) after which you can install *[iSEEpathways](https://bioconductor.org/packages/3.22/iSEEpathways)* by using the following commands in your `R` session:
...
*[iSEEpathways](https://bioconductor.org/packages/3.22/iSEEpathways)* is based on many other packages and in particular in those that have implemented the infrastructure needed for dealing with omics data and interactive visualisation.
...
We hope that *[iSEEpathways](https://bioconductor.org/packages/3.22/iSEEpathways)* will be useful for your research. Please use the following information to cite the package and the overall approach. Thank you!
...
#>
#>   Rue-Albrecht K, Soneson C (2025). _iSEEpathways: iSEE extension for panels related to pathway analysis_.
#>   doi:10.18129/B9.bioc.iSEEpathways <https://doi.org/10.18129/B9.bioc.iSEEpathways>, R package version
#>   1.8.0, <https://bioconductor.org/packages/iSEEpathways>.
#>
...
```
#> [1] "2025-10-30 00:40:27 EDT"
```

Wallclock time spent generating the vignette.

```
#> Time difference of 6.687 secs
```
