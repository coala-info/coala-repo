...
baseCommand:
  - gatk
  - FlowFeatureMapper
label: gatk_FlowFeatureMapper
doc: Mapping features (flow space processing)
inputs:
  - id: input
    type:
      type: array
  ...
  - id: copy_attr
    type:
      ...
      - type: array
        items: string
    doc: attributes to copy from bam. format <name>,<type>,<desc>.
    inputBinding:
      position: 101
      prefix: --copy-attr
  - id: copy_attr_prefix
    type:
      - 'null'
      - string
    doc: prefix to add to attributes to copy from bam
    inputBinding:
      position: 101
      prefix: --copy-attr-prefix
  ...
  - id: exclude_nan_scores
    type:
      - 'null'
      - boolean
    doc: exclude nan scores
    inputBinding:
      position: 101
      prefix: --exclude-nan-scores
  - id: gatk_config_file
    type:
      - 'null'
      - string
  ...
  - id: mapping_feature
    type:
      - 'null'
      - string
    doc: Kind of feaure being mapped
    inputBinding:
      position: 101
  ...
  - id: max_score
    type:
      - 'null'
      - float
    doc: threshold of score delta to for emitting (will be emitted if lower)
    inputBinding:
      position: 101
      prefix: --max-score
  ...
  - id: min_score
    type:
      - 'null'
      - float
    doc: minimal threshold of score delta to for emitting (will be emitted if 
      higher)
    inputBinding:
      position: 101
      prefix: --min-score
  ...
  - id: snv_identical_bases
    type:
      - 'null'
      - int
    doc: number of bases that need to be identical before the snv
    inputBinding:
      position: 101
      prefix: --snv-identical-bases
  - id: snv_identical_bases_after
    type:
      - 'null'
      - int
    doc: number of bases that need to be identical after the snv. 0 means same 
      as number of bases before
    inputBinding:
      position: 101
      prefix: --snv-identical-bases-after
  - id: tmp_dir
    type:
      - 'null'
      - Directory
  ...
  - id: floor_blocks
    type:
      - 'null'
      - boolean
    doc: Output the band lower bound for each GQ block regardless of the data it
      represents
    inputBinding:
      position: 101
      prefix: --floor-blocks
  ...
  - id: gvcf_gq_bands
    type:
      ...
      - type: array
        items: int
    doc: Exclusive upper bounds for reference confidence GQ bands
    inputBinding:
      position: 101
      prefix: --gvcf-gq-bands
  - id: include_qc_failed_reads
    type:
      - 'null'
      - boolean
    ...
    inputBinding:
      position: 101
      prefix: --include-qc-failed-reads
