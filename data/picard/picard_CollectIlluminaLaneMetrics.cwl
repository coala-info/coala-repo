...
inputs:
  ...
  - id: file_extension
    ...
    doc: Append the given file extension to all metric file names (ex. 
      OUTPUT.illumina_lane_metrics.EXT). None if null
    inputBinding:
      position: 101
  ...
  - id: read_structure
    ...
    doc: A description of the logical structure of clusters in an Illumina Run. 
      It should consist of integer/character pairs describing the number of 
      cycles and the type of those cycles (B for Sample Barcode, M for molecular
      barcode, T for Template, and S for skip).
    inputBinding:
      position: 101
