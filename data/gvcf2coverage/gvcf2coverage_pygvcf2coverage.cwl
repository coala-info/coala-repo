...
label: gvcf2coverage_pygvcf2coverage
doc: "A tool to convert gVCF files to coverage information. (Note: The provided help
  text contains only container runtime error messages and does not list specific command-line
...
stdout: gvcf2coverage_pygvcf2coverage.out
