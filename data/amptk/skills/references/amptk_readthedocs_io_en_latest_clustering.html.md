...
* AMPtk Clustering
  + [UPARSE clustering](#uparse-clustering)
  + [DADA2 denoising](#dada2-denoising)
  + [UNOISE2 denoising](#unoise2-denoising)
  + [UNOISE3 denoising](#unoise3-denoising)
...
* AMPtk Clustering
* [Edit on GitHub](https://github.com/nextgenusfs/amptk/blob/master/docs/clustering.rst)

---

# AMPtk Clustering[¶](#amptk-clustering "Link to this heading")
...
## UPARSE clustering[¶](#uparse-clustering "Link to this heading")
...
## DADA2 denoising[¶](#dada2-denoising "Link to this heading")
...
## UNOISE2 denoising[¶](#unoise2-denoising "Link to this heading")
...
## UNOISE3 denoising[¶](#unoise3-denoising "Link to this heading")
...
[Previous](pre-processing.html "AMPtk Pre-Processing")
[Next](filtering.html "AMPtk OTU Table Filtering")
