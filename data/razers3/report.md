# razers3 CWL Generation Report

## razers3

### Tool Description
RazerS 3 is a versatile full-sensitive read mapper based on k-mer counting and seeding filters. It supports single and paired-end mapping, shared-memory parallelism, and optimally parametrizes the filter based on a user-defined minimal sensitivity. See https://www.seqan.de/apps/razers3 for more information.

### Metadata
- **Docker Image**: quay.io/biocontainers/razers3:3.5.12--h7f3286b_0
- **Homepage**: https://www.seqan.de/apps/razers3.html
- **Package**: https://anaconda.org/channels/bioconda/packages/razers3/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/razers3/overview
...
DESCRIPTION
    ...
    a user-defined minimal sensitivity. See https://www.seqan.de/apps/razers3
    ...
    (c) Copyright 2009-2026 by David Weese.
...
VERSION
    Last update: 
    razers3 version: 3.5.12 [tarball]
    SeqAn version: 2.5.2
```
