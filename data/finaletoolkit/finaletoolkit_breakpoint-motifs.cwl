...
baseCommand: finaletoolkit-breakpoint-motifs
label: finaletoolkit_breakpoint-motifs
doc: "Measures frequency of k-mer breakpoint motifs.\n\nTool homepage: https://github.com/epifluidlab/FinaleToolkit"
inputs:
  - id: input_file
    type: File
  ...
  - id: no_both_strands
    type:
      - 'null'
      - boolean
    doc: Set flag to only consider one strand for breakpoint-motifs.
    inputBinding:
      position: 103
