...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fthegenemyers%2FFASTK%2Fblob%2Fmaster%2FFastcat.c)
...
[History](/thegenemyers/FASTK/commits/master/Fastcat.c)

History

631 lines (542 loc) · 20.4 KB
...
[Raw](https://github.com/thegenemyers/FASTK/raw/refs/heads/master/Fastcat.c)
...
int DO\_HIST, DO\_TABLE, DO\_PROF;
...
if (DO\_HIST + DO\_TABLE + DO\_PROF == 0)
...
int has\_hist, has\_table, has\_prof;

narg = argc-2;

argv += 2;

has\_hist = has\_table = has\_prof = 0;
...
Prog\_Name,narg-has\_hist);

exit (1);

}

if (DO\_TABLE && has\_table != narg)
...
Prog\_Name,narg-has\_table);

exit (1);

}

if (DO\_PROF && has\_prof != narg)
...
// determine the length of the longest source name (path