...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fgenouest%2Fogs-tools)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E&source=header-repo&source_repo=genouest%2Fogs-tools)
...
[Branches](/genouest/ogs-tools/branches)[Tags](/genouest/ogs-tools/tags)
...
| --- | --- | --- | --- | --- |
| Latest commit   History[85 Commits](/genouest/ogs-tools/commits/master/)   85 Commits | | |
| [.github/workflows](/genouest/ogs-tools/tree/master/.github/workflows "This path skips through empty directories") | | [.github/workflows](/genouest/ogs-tools/tree/master/.github/workflows "This path skips through empty directories") |  |  |
| [gff2embl](/genouest/ogs-tools/tree/master/gff2embl "gff2embl") | | [gff2embl](/genouest/ogs-tools/tree/master/gff2embl "gff2embl") |  |  |
| [ogs\_check](/genouest/ogs-tools/tree/master/ogs_check "ogs_check") | | [ogs\_check](/genouest/ogs-tools/tree/master/ogs_check "ogs_check") |  |  |
| [ogs\_merge](/genouest/ogs-tools/tree/master/ogs_merge "ogs_merge") | | [ogs\_merge](/genouest/ogs-tools/tree/master/ogs_merge "ogs_merge") |  |  |
| [ogswriters](/genouest/ogs-tools/tree/master/ogswriters "ogswriters") | | [ogswriters](/genouest/ogs-tools/tree/master/ogswriters "ogswriters") |  |  |
| [.gitignore](/genouest/ogs-tools/blob/master/.gitignore ".gitignore") | | [.gitignore](/genouest/ogs-tools/blob/master/.gitignore ".gitignore") |  |  |
| [LICENSE](/genouest/ogs-tools/blob/master/LICENSE "LICENSE") | | [LICENSE](/genouest/ogs-tools/blob/master/LICENSE "LICENSE") |  |  |
| [README.md](/genouest/ogs-tools/blob/master/README.md "README.md") | | [README.md](/genouest/ogs-tools/blob/master/README.md "README.md") |  |  |
| [requirements.txt](/genouest/ogs-tools/blob/master/requirements.txt "requirements.txt") | | [requirements.txt](/genouest/ogs-tools/blob/master/requirements.txt "requirements.txt") |  |  |
| [setup.cfg](/genouest/ogs-tools/blob/master/setup.cfg "setup.cfg") | | [setup.cfg](/genouest/ogs-tools/blob/master/setup.cfg "setup.cfg") |  |  |
| [setup.py](/genouest/ogs-tools/blob/master/setup.py "setup.py") | | [setup.py](/genouest/ogs-tools/blob/master/setup.py "setup.py") |  |  |
| View all files | | |
...
[![Build](https://camo.githubusercontent.com/e7f5ae358eadbf3519bec02e394a0d7f9da079e384ce48f1b99838be72bbe62e/68747470733a2f2f7472617669732d63692e6f72672f61627265746175642f6f67732d746f6f6c732e7376673f6272616e63683d6d6173746572)](https://travis-ci.org/abretaud/ogs-tools)
...
* id\_regex: `FOOBAR([0-9]{6})(\.[0-9]+)?`
* id\_syntax: `FOOBAR{id}`
...
In case of multiple consecutive merges, this version suffix will be incremented if the script detects any new change from apollo (e.g. `FOOBAR0001