# Workflow 2: Data Cleaning And Chimera Removal [Galaxy Training: 16S Microbial Analysis With Mothur] CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://training.galaxyproject.org
- **Package**: https://workflowhub.eu/workflows/1400
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1400/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 256
...
- **Main workflow (WorkflowHub):** `workflow2-data-cleaning.ga` (Main Workflow)
