# ucsc-maftopsl CWL Generation Report
...
- **Package**: https://anaconda.org/channels/bioconda/packages/ucsc-maftopsl/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/ucsc-maftopsl/overview
