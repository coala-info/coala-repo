...
| --- | --- | --- |
| chr22 reads subset (BLOW5 format) |  | [PGXXSX240041\_reads\_chr22.blow5](https://slow5.bioinf.science/hg2_prom2_5khz_chr22) (``) |
| ~19M reads complete PromethION dataset (BLOW5 format) | [ERR12997168](https://www.ebi.ac.uk/ena/browser/view/ERR12997168) | [PGXXSX240041\_reads.blow5](https://slow5.bioinf.science/hg2_prom2_5khz) (`b9e0f4fc49ffe4d1e39dc9c09eccdeac`), [PGXXSX240041\_reads.blow5.idx](https://slow5.bioinf.science/hg2_prom2_5khz_idx) (`18ac205e53552bcb561ea5b3a55cd9b7`) \* |
...
| Description | ENA run Data access | Direct download link (md5sum) |
| --- | --- | --- |
| ~20K reads subsubset (BLOW5 format) |  | [PGXXXX230339\_reads\_20k.blow5](https://slow5.bioinf.science/hg2_prom_5khz_subsubsample) (`d4bb9a40eb89647c2bb74b724d63cef4`) |
| ~500K reads subset (BLOW5 format) |  | [PGXXXX230339\_reads\_500k.blow5](https://slow5.bioinf.science/hg2_prom_5khz_subsample) (`4cfe7a3ab4fbb45f87fd4ddc3c0b6eca`) |
| chr22 reads subset (BLOW5 format) |  | [PGXXXX230339\_reads\_chr22.blow5](https://slow5.bioinf.science/hg2_prom_5khz_chr22) (``) |
| ~12M reads complete PromethION dataset (BLOW5 format) | [ERR12997167](https://www.ebi.ac.uk/ena/browser/view/ERR12997167) | [PGXXXX230339\_reads.blow5](https://slow5.bioinf.science/hg2_prom_5khz) (`2dab2e0c042b0fb5f9f3794c7c916420`), [PGXXXX230339\_reads.blow5.idx](https://slow5.bioinf.science/hg2_prom_5khz_idx) (`84a1b5317f0e92f73143070481df8fe3`) \* |
...
| Description | ENA run Data access | Direct download link (md5sum) |
| --- | --- | --- |
| ~20K reads subsubset (BLOW5 format) |  | [PNXRXX240011\_reads\_20k.blow5](https://slow5.bioinf.science/uhr_prom_subsubsample) (``) |
| ~500K reads subset (BLOW5 format) |  | [PNXRXX240011\_reads\_500k.blow5](https://slow5.bioinf.science/uhr_prom_subsample) (``) |
| ~15M reads complete PromethION dataset (BLOW5 format) | [ERR12997170](https://www.ebi.ac.uk/ena/browser/view/ERR12997170) | [PNXRXX240011\_reads.blow5](https://slow5.bioinf.science/uhr_prom) (`671be5b88f2b54a9e22ced351493b7a9`), [PNXRXX240011\_reads.blow5.idx](https://slow5.bioinf.science/uhr_prom_idx) (`e3ea326d300a22008e2821ce10d17649`) \* |
...
| --- | --- | --- |
| ~20K reads subsubset (BLOW5 format) |  | [hg2\_prom\_lsk114\_subsubsample.tar](https://slow5.bioinf.science/hg2_prom_subsub) (`4d338e1cffd6dbf562cc55d9fcca040c`) |
| ~500K reads subset (BLOW5 format) | [SRR23215365](https://trace.ncbi.nlm.nih.gov/Traces/?view=run_browser&acc=SRR23215365&display=data-access) | [hg2\_subsample\_slow5.tar](https://slow5.bioinf.science/hg2_prom_sub_slow5) (`65386e1da1d82b892677ad5614e8d84d`) |
| chr22 reads subset (BLOW5 format) |  | [PGXX22394\_reads\_chr22.blow5](https://slow5.bioinf.science/hg2_prom_chr22_slow5) (``) |
| ~15M reads complete PromethION dataset (BLOW5 format) | [SRR23215366](https://trace.ncbi.nlm.nih.gov/Traces/?view=run_browser&acc=SRR23215366&display=data-access)/[ERR11777845](https://www.ebi.ac.uk/ena/browser/view/ERR11777845) | [PGXX22394\_reads.blow5](https://slow5.bioinf.science/hg2_prom_slow5) (`3498b595ac7c79a3d2dce47454095610`), [PGXX22394\_reads.blow5.idx](https://slow5.bioinf.science/hg2_prom_slow5_idx) (`1e11735c10cf63edc4a7114f010cc472`)\* |
...
| Description | ENA run Data access | Direct download link (md5sum) |
| --- | --- | --- |
| chr22 reads subset (BLOW5 format) |  | [PGXXHX230142\_reads\_chr22.blow5](https://slow5.bioinf.science/na12878_prom2_chr22_slow5) |
| ~11M reads complete PromethION dataset (BLOW5 format) | [ERR11777844](https://www.ebi.ac.uk/ena/browser/view/ERR11777844) | [PGXXHX230142\_reads.blow5](https://slow5.bioinf.science/na12878_prom2_slow5) (`24266f6dabb8d679f7f520be6aa22694`), [PGXXHX230142\_reads.blow5.idx](https://slow5.bioinf.science/na12878_prom2_slow5_idx) (`a5659f829b9410616391427b2526b853`) \* |

\*This dataset is hosted in the [gtgseq AWS bucket](https://aws.amazon.com/marketplace/pp/prodview-rve772jpfevtw) granted by the AWS open data sponsorship programme, for which the documentation available under the [gtgseq GitHub repository](https://github.com/GenTechGp/gtgseq).

### More R10.4.1 4kHz datasets

* human methylated and non-methylated (WGA) DNA datasets from zymo dna methylation standards (D5013) are available on ENA under [PRJEB64592](https://www.ebi.ac.uk/ena/browser/view/PRJEB64592). The BLOW5 files are in PGXX22562\_methylated.tar.gz and PGXX22563\_nonmethylated.tar.gz.
...
| --- | --- | --- |
| ~20K reads subsubset | - | [NA12878\_prom\_subsubsample.tar.gz](https://slow5.bioinf.science/na12878_prom_subsub) (`f64074151d25d6e35c73f668d4146032`) |
| ~500K reads subset | [SRR22186403](https://trace.ncbi.nlm.nih.gov/Traces/?view=run_browser&acc=SRR22186403&display=data-access) | [subsample\_slow5.tar](https://slow5.bioinf.science/na12878_prom_sub_slow5) (`6cdbe02c3844960bb13cf94b9c3173bb`) |
| ~9M reads complete PromethION dataset | [SRR22186402](https://trace.ncbi.nlm.nih.gov/Traces/?view=run_browser&acc=SRR22186402&display=data-access) | [na12878\_prom\_merged.blow5](https://slow5.bioinf.science/na12878_prom_slow5) (`7e1a5900aff10e2cf1b97b8d3c6ecd1e`), [na12878\_prom\_merged.blow5.idx](https://slow5.bioinf.science/na12878_prom_slow5_idx) (`a78919e8ac8639788942dbc3f1a2451a`) |
...
* tar files with \_reads at the end (e.g., GBXM047265\_reads.tar) are FAST5 data
...
4. All [nanopore-wgs-consortium](https://github.com/nanopore-wgs-consortium/NA12878) datasets:
   ...
   * BLOW5 files for the direct-RNA dataset available from [SRR23513624](https://trace.ncbi.nlm.nih.gov/Traces/?view=run_browser&acc=SRR23513624&display=data-access). filename: `na12878_directRNA_blow5.tar` (md5sum: `282e305f2b6a72d28980a8d5c803d54e`. Also available for direct download from [na12878\_rna\_merged.blow5](https://slow5.bioinf.science/na12878_rna) (md5sum: `36bc164e9d885838245073f6cd2ecd79`), [na12878\_rna\_merged.blow5.idx](https://slow5.bioinf.science/na12878_rna_idx) (md5sum: `82f96208ac2f42574abe0cf5a3954602`)
