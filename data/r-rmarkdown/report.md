...
Convert R Markdown documents into a variety of formats.</p>

### Metadata
- **Conda**: https://anaconda.org/channels/r/packages/r-rmarkdown/overview
- **R-project (CRAN)**: https://cloud.r-project.org/web/packages/rmarkdown/index.html
- **Home (project)**: https://github.com/rstudio/rmarkdown, https://pkgs.rstudio.com/rmarkdown/
- **Package**: rmarkdown
- **Version**: 2.30
...
- **Docker Image**: quay.io/biocontainers/r-rmarkdown:0.9.5--r3.3.2_0
- **Skill**: generated
- **Total Downloads**: 473.5K
