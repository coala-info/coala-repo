...
baseCommand:
  - clusterfunk
  - at
label: clusterfunk_at
doc: "A tool for annotating and manipulating phylogenetic trees. Note: The provided
  help text indicates 'at' is an invalid subcommand choice.\n\nTool homepage: https://github.com/cov-ert/clusterfunk"
inputs:
  - id: subcommand
    type: string
