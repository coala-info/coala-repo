...
# Chapter 4 Read tasks

|  |  |
| --- | --- |
| [assessSoftClipping](/assesssoftclipping#assessSoftClipping) | Assessing level of soft clipping in BAM file |
| [BAMDiagnostics](/bamdiagnostics#BAMDiagnostics) | Estimating depth and read property frequencies |
| [downsample](/downsample#downsample) | Downsampling a BAM file |
| [filterBAM](/filterbam#filterBAM) | Writing reads that pass filters to BAM file |
| [mergeOverlappingReads](/mergeoverlappingreads#mergeOverlappingReads) | Merging paired-end reads in BAM file |
| [mergeRG](/mergerg#mergeRG) | Merging read groups in a BAM file |
| [PMDS](/pmds#PMDS) | Filtering for ancient reads using PMDS |
| [qualityTransformation](/qualitytransformation#qualityTransformation) | Printing Quality Transformation |