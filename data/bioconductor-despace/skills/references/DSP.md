...
* [3 Data](#data)
  ...
  + [3.3 Clustering](#clustering)
    - [3.3.1 Manual annotation](#manual-annotation)
    - [3.3.2 Spatially resolved (multi-sample) clustering](#spatially-resolved-multi-sample-clustering)
* [4 DSP testing](#dsp-testing)
  + [4.1 Gene-level test](#gene-level-test)
  + [4.2 Individual cluster test](#individual-cluster-test)
    - [4.2.1 Visualization](#visualization)
  + [4.3 Smooth splines to model time](#smooth-splines-to-model-time)
    - [4.3.1 Visualization](#visualization-1)
...
By leveraging pre-annotated spatial clusters as summarized spatial information, *DESpace* models gene expression with a negative binomial (NB), via *edgeR* (Robinson, McCarthy, and Smyth [2010](#ref-edgeR)), with spatial clusters as covariates. SV genes are then identified by testing the significance of spatial clusters. For detailed guidance on detecting SVGs with *DESpace*, refer to [*SVGs vignettes*](https://www.bioconductor.org/packages/release/bioc/vignettes/DESpace/inst/doc/DESpace.html).

For multi-sample, multi-condition datasets, again we fit a NB model via *edgeR* (Robinson, McCarthy, and Smyth [2010](#ref-edgeR)), but this time we use spatial clusters, conditions and their interactions as covariates.
...
As an example dataset, we consider a multi-sample, multi-group spatially resolved transcriptomics data - the Stereo-seq dataset of taxolotl telencephalon brain regeneration stages (Wei et al. [2022](#ref-ARTISTA)). The dataset includes axolotl brain tissues collected at various days post-injury (DPI): 2 (3 sections), 5 (3 sections), 10 (3 sections), 15 (4 sections), 20 (3 sections), 30 (1 section) and 60 (1 section), after the removal of a reproducible portion of dorsal pallium in left telencephalic hemisphere of axolotl. The original dataset is available for download via [*STOmicsDB*](https://db.cngb.org/stomics/artista/download/), and the processed dataset (including spatial clusters) can be accessed via [*muSpaData*](https://github.com/peicai/muSpaData) ExperimentHub package.
...
Among others, BayesSpace (Zhao et al. [2021](#ref-BayesSpace)) and Banksy (Singhal et al. [2024](#ref-Banksy)) allow jointly clustering multiple samples.
...
#### 4.2.1.1 Abundance trend

One way is to plot the overall abundance of LOC108699649[nr] for each cluster-sample combination.
...
#### 4.3.1.1 Predicted trend

To explore predicted counts based on estimated coefficients, we calculate and visualize the fitted values for NEFM.
The expression of NEFM in cluster 2 first increase and then decrease, while in the remaining regions, the expression slightly increase over time.
...
#### 4.3.1.2 Spatial expression

Visualize the expression of the top gene, NEFM, across samples.
...
## [31] ggplot2_4.0.1               DESpace_2.2.2
## [33] BiocStyle_2.38.0
##
...
##  [10] spatstat.explore_3.6-0 terra_1.8-86           tinytex_0.58
##  [13] htmltools_0.5.8.1      S4Arrays_1.10.1        curl_7.0.0
##  [16] SparseArray_1.10.4     sass_0.4.10            KernSmooth_2.23-26
...
##  [28] digest_0.6.39          ggnewscale_0.5.2       AnnotationDbi_1.72.0
##  [31] tensor_1.5.1           RSQLite_2.4.5          beachmat_2.26.0
##  [34] labeling_0.4.3         filelock_1.0.3         timechange_0.3.0
...
##  [46] BiocParallel_1.44.0    DBI_1.2.3              ggforce_0.5.0
##  [49] MASS_7.3-65            rappdirs_0.3.3         DelayedArray_0.36.0
##  [52] rjson_0.2.23           classInt_0.4-11        tools_4.5.2
##  [55] units_1.0-0            goftest_1.2-3          glue_1.8.0
##  [58] nlme_3.1-168           grid_4.5.2             sf_1.0-23
##  [61] gtable_0.3.6           spatstat.data_3.1-9    tzdb_0.5.0
##  [64] class_7.3-23           hms_1.1.4              data.table_1.17.8
##  [67] XVector_0.50.0         spatstat.geom_3.6-1    BiocVersion_3.22.0
##  [70] pillar_1.11.1          tweenr_2.0.3           lattice_0.22-7
##  [73] bit_4.6.0              deldir_2.0-4           tidyselect_1.2.1
##  [76] locfit_1.5-9.12        Biostrings_2.78.0      scuttle_1.20.0
##  [79] knitr_1.50             bookdown_0.45          xfun_0.54
##  [82] statmod_1.5.1          fftwtools_0.9-11       stringi_1.8.7
##  [85] yaml_2.3.11            evaluate_1.0.5         codetools_0.2-20
##  [88] BiocManager_1.30.27    cli_3.6.5              jquerylib_0.1.4
##  [91] dichromat_2.0-0.1      Rcpp_1.1.0             spatstat.random_3.4-3
##  [94] png_0.1-8              spatstat.univar_3.1-5  parallel_4.5.2
##  [97] assertthat_0.2.1       blob_1.2.4             scales_1.4.0
