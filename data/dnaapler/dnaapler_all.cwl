...
inputs:
  ...
  - id: database
    type:
      - 'null'
      - string
    doc: "Lets you choose a subset of databases rather than all 4. Must be one of:
  ...
  - id: ignore
    type:
      - 'null'
      - string
    doc: Text file listing contigs (one per row) that are to be ignored OR comma
      separated list of contig names to ignore OR '-' to read from stdin
    inputBinding:
      position: 101
      prefix: --ignore
  - id: input_file
