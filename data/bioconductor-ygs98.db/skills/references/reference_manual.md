...
Welcome to the ygs98.db annotation Package. The purpose of this package is to provide detailed
information about the ygs98 platform. This package is updated biannually.
...
ygs98CHR is an R object that provides mappings between a manufacturer identifier and the chro-
...
ygs98CHRLENGTHS provides the length measured in base pairs for each of the chromosomes.
...
ygs98CHRLOC is an R object that maps manufacturer identifiers to the starting position of the
...
ygs98DESCRIPTION maps yeast ORF identifiers to descriptive information about genes corre-
...
ygs98ENSEMBL is an R object that contains mappings between Entrez Gene identifiers and En-
...
ygs98ENZYME is an R object that provides mappings between manufacturer identifiers and EC
numbers.
...
numbers. In ygs98ENZYME2PROBE, EC is dropped from the Enzyme Commission numbers.
...
ygs98ENZYME2PROBE is an R object that maps Enzyme Commission (EC) numbers to manufac-
turer identifiers.
...
ygs98GENENAME is an R object that maps manufacturer identifiers to the corresponding gene
name.
...
ygs98GO is an R object that provides mappings between manufacturer identifiers and the GO iden-
...
ygs98GO2ALLPROBES is an R object that provides mappings between a given GO identifier and
...
This object ygs98GO2ALLPROBES maps between a given GO identifier and all manufactuerer
...
ygs98GO2PROBE is an R object that provides mappings between GO identifiers and manufacturer
identifiers.
...
Number of mapped keys for the maps in package ygs98.db

Description

DEPRECATED. Counts in the MAPCOUNT table are out of sync and should not be used.

ygs98MAPCOUNTS provides the "map count" (i.e.
package ygs98.db.
...
ygs98ORF is an R object that provides mappings between manufacturer and ORF identifiers.
...
The Organism information for ygs98

Description

ygs98ORGANISM is an R object that contains a single item: a character string that names the
organism for which ygs98 was built. ygs98ORGPKG is an R object that contains a chararcter
vector with the name of the organism package that a chip package depends on for its gene-centric
annotation.

Details

Although the package name is suggestive of the organism for which it was built, ygs98ORGANISM
provides a simple way to programmatically extract the organism name. ygs98ORGPKG provides a
...
isms. ygs98PATH maps probe identifiers to the identifiers used by KEGG for pathways in which
...
ygs98PATH2PROBE is an R object that provides mappings between KEGG identifiers and manu-
...
ygs98PMID is an R object that provides mappings between manufacturer identifiers and PubMed
identifiers.
...
ygs98PMID2PROBE is an R object that provides mappings between PubMed identifiers and man-
...
ygs98_dbconn returns a connection object to the package annotation DB. IMPORTANT: Don’t
call dbDisconnect on the connection object returned by ygs98_dbconn or you will break all the
AnnDbObj objects defined in this package!

ygs98_dbfile returns the path (character string) to the package annotation DB (this is an SQLite
file).

ygs98_dbschema prints the schema definition of the package annotation DB.

ygs98_dbInfo prints other information about the package annotation DB.

Value

ygs98_dbconn: a DBIConnection object representing an open connection to the package annotation
DB.

ygs98_dbfile: a character string with the path to the package annotation DB.

ygs98_dbschema: none (invisible NULL).

ygs98_dbInfo: none (invisible NULL).
...
ygs98ALIAS, 1
ygs98ALIAS2PROBE (ygs98ALIAS), 1
ygs98CHR, 2
ygs98CHRLENGTHS, 3
ygs98CHRLOC, 4
ygs98CHRLOCEND (ygs98CHRLOC), 4
ygs98DESCRIPTION, 5
ygs98ENSEMBL, 6
ygs98ENSEMBL2PROBE (ygs98ENSEMBL), 6
ygs98ENZYME, 7
ygs98ENZYME2PROBE, 8
ygs98GENENAME, 9
ygs98GO, 10
ygs98GO2ALLPROBES, 11
ygs98GO2PROBE, 13
ygs98MAPCOUNTS, 14
ygs98ORF, 14
ygs98ORGANISM, 15
ygs98ORGPKG (ygs98ORGANISM), 15
ygs98PATH, 16
ygs98PATH2PROBE, 17
ygs98PMID, 18
ygs98PMID2PROBE, 19
...
ygs98.db, 2
ygs98_dbconn, 20
ygs98_dbfile (ygs98_dbconn), 20
ygs98_dbInfo (ygs98_dbconn), 20
ygs98_dbschema (ygs98_dbconn), 20
