# Code example from 'graphite' vignette. See references/ for full tutorial.
...
###################################################
### code chunk number 16: spia2
###################################################
unlink("keggExSPIA.RData")


###################################################
### code chunk number 17: tg1
###################################################
library(topologyGSA)
data(examples)
...
###################################################
### code chunk number 22: para2 (eval = FALSE)
###################################################
