...
[Skip to content](#list-available-and-compatible-blast-and-diamond-tools-of-a-galaxy-server)
...
* [x]
  ...
  + [ ]
    ...
    Table of contents
    - [List available and compatible BLAST+ and DIAMOND tools of a Galaxy server](#list-available-and-compatible-blast-and-diamond-tools-of-a-galaxy-server)
    - [List available tools and sequence databases of a Galaxy server](#list-available-tools-and-sequence-databases-of-a-galaxy-server)
    - [Perform search requests](#perform-search-requests)
...
You can find all possible subcommands and parameters in the [CLI reference](../cli/).
