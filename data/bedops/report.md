...
### Tool Description
Sorts BED files. The sorted BED file is sent to standard output. Sorting is required for many BEDOPS utilities to ensure high performance.
...
INFO:    Fetching OCI image...
INFO:    Extracting OCI image...
FATAL:   Unable to handle docker://quay.io/biocontainers/bedops:2.4.42--hd6d6fdc_1 uri: while building SIF from layers: packer failed to pack: while unpacking rootfs: while unpacking layer sha256:cf543e2ec7e485a72e2c0d49b202d481d757646bb44885f51d20a835043f8545: unpack entry: usr/local/bin/bedmap: unpack to regular file: short write: write /scratch/21813747/build-temp-3694974071/rootfs/usr/local/bin/bedmap: no space left on device
```

## bedops_bedmap

### Tool Description
The bedmap utility retrieves and processes genomic features from a map file that overlap with features in a reference file. It is part of the BEDOPS suite.
...
INFO:    Fetching OCI image...
INFO:    Extracting OCI image...
FATAL:   Unable to handle docker://quay.io/biocontainers/bedops:2.4.42--hd6d6fdc_1 uri: while building SIF from layers: packer failed to pack: while unpacking rootfs: while unpacking layer sha256:cf543e2ec7e485a72e2c0d49b202d481d757646bb44885f51d20a835043f8545: unpack entry: usr/local/bin/bedmap: unpack to regular file: short write: write /scratch/21813747/build-temp-4029669898/rootfs/usr/local/bin/bedmap: no space left on device
```

## bedops_closest-features

### Tool Description
For every element in <input-file>, find the closest elements in <query-file>. By default, this tool finds the closest features to the left and right of the input feature.
...
INFO:    Fetching OCI image...
INFO:    Extracting OCI image...
FATAL:   Unable to handle docker://quay.io/biocontainers/bedops:2.4.42--hd6d6fdc_1 uri: while building SIF from layers: packer failed to pack: while unpacking rootfs: while unpacking layer sha256:cf543e2ec7e485a72e2c0d49b202d481d757646bb44885f51d20a835043f8545: unpack entry: usr/local/bin/bedmap: unpack to regular file: short write: write /scratch/21813747/build-temp-4227223842/rootfs/usr/local/bin/bedmap: no space left on device
```
...
### Tool Description
Concatenate multiple starch files into a single starch file. Note: The provided input text appears to be a system error log rather than help text; arguments are derived from standard tool documentation.
...
INFO:    Fetching OCI image...
INFO:    Extracting OCI image...
FATAL:   Unable to handle docker://quay.io/biocontainers/bedops:2.4.42--hd6d6fdc_1 uri: while building SIF from layers: packer failed to pack: while unpacking rootfs: while unpacking layer sha256:cf543e2ec7e485a72e2c0d49b202d481d757646bb44885f51d20a835043f8545: unpack entry: usr/local/bin/bedmap: unpack to regular file: short write: write /scratch/21813747/build-temp-2503813936/rootfs/usr/local/bin/bedmap: no space left on device
```
