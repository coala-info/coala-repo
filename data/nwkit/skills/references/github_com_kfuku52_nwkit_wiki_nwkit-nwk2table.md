...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fkfuku52%2Fnwkit%2Fwiki%2Fnwkit-nwk2table)
...
·
[3 revisions](/kfuku52/nwkit/wiki/nwkit-nwk2table/_history)

## Overview

`nwkit nwk2table` converts a Newick tree into a tab-separated parent-child table.

The core columns are `branch_id`, `parent`, `name`, `dist`, and `support`.
...
```
nwkit nwk2table -i tree.nwk -o tree.tsv --format 0
```
...
### Example output (`tree.tsv`)

| branch\_id | parent | name | dist | support |
| --- | --- | --- | --- | --- |
| 0 | -1 |  |  |  |
| 1 | 0 |  | 3.0 | 80.0 |
| 2 | 0 | C | 4.0 |  |
...
The row with `parent = -1` is the root. In this example, branch `1` is the internal branch subtending `A` and `B`, so its `support` value is `80.0`.

## Adding sister and age columns

### Command

```
nwkit nwk2table -i tree.nwk -o tree.tsv \
  --sister yes \
  --age yes
```

`--age yes` requires an ultrametric tree.

## Notes

* `parent = -1` indicates the root row
* `support` is blank when the tree does not define a meaningful internal support value
...
* Loading
  ...
  + [Overview](/kfuku52/nwkit/wiki/nwkit-nwk2table#overview)
  + [Basic example](/kfuku52/nwkit/wiki/nwkit-nwk2table#basic-example)
  + [Command](/kfuku52/nwkit/wiki/nwkit-nwk2table#command)
  + [Example input (tree.nwk)](/kfuku52/nwkit/wiki/nwkit-nwk2table#example-input-treenwk)
  + [Example output (tree.tsv)](/kfuku52/nwkit/wiki/nwkit-nwk2table#example-output-treetsv)
  + [Adding sister and age columns](/kfuku52/nwkit/wiki/nwkit-nwk2table#adding-sister-and-age-columns)
  + [Command](/kfuku52/nwkit/wiki/nwkit-nwk2table#command-1)
  + [Notes](/kfuku52/nwkit/wiki/nwkit-nwk2table#notes)
* Loading
