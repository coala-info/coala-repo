...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fandersen-lab%2FBarcodeForge%2Fblob%2Fmain%2Fpyproject.toml)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fblob%2Fshow&source=header-repo&source_repo=andersen-lab%2FBarcodeForge)
...
[History](/andersen-lab/BarcodeForge/commits/main/pyproject.toml)
...
[Raw](https://github.com/andersen-lab/BarcodeForge/raw/refs/heads/main/pyproject.toml)
...
"toml", # Added to parse pyproject.toml in tests
...
[tool.barcodeforge.conda\_dependencies]

# These packages are required and need to be installed separately using Conda.

# For example: conda install -c bioconda usher ucsc-fatovcf

packages = [

"usher", # (from bioconda channel)

"ucsc-fatovcf", # (from bioconda channel)
