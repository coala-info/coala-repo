# MuSiC-Deconvolution: Data generation | sc | matrix + ESet CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://training.galaxyproject.org
- **Package**: https://workflowhub.eu/workflows/1548
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1548/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 262
...
- **Main workflow (WorkflowHub):** `sc-matrix.ga` (Main Workflow)
