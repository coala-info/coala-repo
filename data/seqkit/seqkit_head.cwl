...
inputs:
  ...
  - id: length
    type:
      - 'null'
      - string
    doc: print leading FASTA/Q records whose total sequence length >= L 
      (supports K/M/G suffix). This flag overrides -n/--number
    inputBinding:
      position: 101
      prefix: --length
  - id: line_width
  ...
  - id: number
    type:
      - 'null'
      - int
    doc: print the first N FASTA/Q records
    inputBinding:
      position: 101
      prefix: --number
  - id: quiet
