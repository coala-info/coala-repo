...
mogene21sttranscriptclusterACCNUM

Map Manufacturer identifiers to Accession Numbers

Description

mogene21sttranscriptclusterACCNUM is an R object that contains mappings between a manufac-
...
## Bimap interface:
x <- mogene21sttranscriptclusterACCNUM
...
mogene21sttranscriptclusterALIAS2PROBE
...
mogene21sttranscriptclusterALIAS is an R object that provides mappings between common gene
...
xx <- as.list(mogene21sttranscriptclusterALIAS2PROBE)
if(length(xx) > 0){
...
Welcome to the mogene21sttranscriptcluster.db annotation Package. The purpose of this package
is to provide detailed information about the mogene21sttranscriptcluster platform. This package is
updated biannually.
Objects in this package are accessed using the select() interface. See ?select in the AnnotationDbi
package for details.

mogene21sttranscriptclusterCHR
...
## use of select().
ls("package:mogene21sttranscriptcluster.db")
...
mogene21sttranscriptclusterCHR is an R object that provides mappings between a manufacturer
...
## Bimap interface:
x <- mogene21sttranscriptclusterCHR
...
mogene21sttranscriptclusterCHRLOC
...
mogene21sttranscriptclusterCHRLENGTHS

A named vector for the length of each of the chromosomes

Description

mogene21sttranscriptclusterCHRLENGTHS provides the length measured in base pairs for each of
the chromosomes.
...
## Bimap interface:
tt <- mogene21sttranscriptclusterCHRLENGTHS
...
mogene21sttranscriptclusterCHRLOC is an R object that maps manufacturer identifiers to the start-
...
mogene21sttranscriptclusterENSEMBL
...
## Bimap interface:
x <- mogene21sttranscriptclusterCHRLOC
...
mogene21sttranscriptclusterENSEMBL is an R object that contains mappings between manufac-
...
mogene21sttranscriptclusterENTREZID
...
x <- mogene21sttranscriptclusterENSEMBL2PROBE
mapped_genes <- mappedkeys(x)
# Convert to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
mogene21sttranscriptclusterENTREZID is an R object that provides mappings between manufac-
turer identifiers and Entrez Gene identifiers.

mogene21sttranscriptclusterENZYME
...
## Bimap interface:
x <- mogene21sttranscriptclusterENTREZID
...
mogene21sttranscriptclusterENZYME is an R object that provides mappings between manufacturer
identifiers and EC numbers. mogene21sttranscriptclusterENZYME2PROBE is an R object that
...
When the mogene21sttranscriptclusterENZYME maping viewed as a list, each manufacturer identi-
...
For the mogene21sttranscriptclusterENZYME2PROBE, each EC number maps to a named vector
...
bers. In mogene21sttranscriptclusterENZYME2PROBE, EC is dropped from the Enzyme Commis-
sion numbers.
...
## Bimap interface:
x <- mogene21sttranscriptclusterENZYME
...
mogene21sttranscriptclusterGENENAME
...
# Now convert mogene21sttranscriptclusterENZYME2PROBE to a list to see inside
x <- mogene21sttranscriptclusterENZYME2PROBE
mapped_probes <- mappedkeys(x)
## convert to a list
xx <- as.list(x[mapped_probes][1:3])
if(length(xx) > 0){
...
mogene21sttranscriptclusterGENENAME is an R object that maps manufacturer identifiers to the
...
## Bimap interface:
x <- mogene21sttranscriptclusterGENENAME
# Get the probe identifiers that are mapped to a gene name
mapped_probes <- mappedkeys(x)

10

mogene21sttranscriptclusterGO
...
mogene21sttranscriptclusterGO is an R object that provides mappings between manufacturer iden-
tifiers and the GO identifiers that they are directly associated with. This mapping and its reverse
mapping (mogene21sttranscriptclusterGO2PROBE) do NOT associate the child terms from the GO
ontology with the gene. Only the directly evidenced terms are represented here.

mogene21sttranscriptclusterGO2ALLPROBES is an R object that provides mappings between a
...
than mogene21sttranscriptclusterGO2PROBE.

Details

If mogene21sttranscriptclusterGO is cast as a list, each manufacturer identifier is mapped to a list
...
If mogene21sttranscriptclusterGO2ALLPROBES or mogene21sttranscriptclusterGO2PROBE is cast
...
• mogene21sttranscriptclusterGO2ALLPROBES
• AnnotationDb-class for use of the select() interface.
...
## Bimap interface:
x <- mogene21sttranscriptclusterGO
...
# For the reverse map:
x <- mogene21sttranscriptclusterGO2PROBE
mapped_genes <- mappedkeys(x)
# Convert to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
mogene21sttranscriptclusterMGI

x <- mogene21sttranscriptclusterGO2ALLPROBES
mapped_genes <- mappedkeys(x)
# Convert mogene21sttranscriptclusterGO2ALLPROBES to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
mogene21sttranscriptclusterMAPCOUNTS

Number of mapped keys
gene21sttranscriptcluster.db
...
mogene21sttranscriptclusterMAPCOUNTS provides the "map count" (i.e.
keys) for each map in package mogene21sttranscriptcluster.db.
...
mogene21sttranscriptclusterMGI is an R object that contains mappings between manufacturer iden-
...
mogene21sttranscriptclusterORGANISM
...
## Bimap interface:
x <- mogene21sttranscriptclusterMGI
...
x <- mogene21sttranscriptclusterMGI2PROBE
mapped_genes <- mappedkeys(x)
# Convert to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
The Organism information for mogene21sttranscriptcluster

Description

mogene21sttranscriptclusterORGANISM is an R object that contains a single item: a character
string that names the organism for which mogene21sttranscriptcluster was built. mogene21sttranscriptclusterORGPKG
...
Although the package name is suggestive of the organism for which it was built, mogene21sttranscriptclusterORGANISM
provides a simple way to programmatically extract the organism name. mogene21sttranscriptclusterORGPKG
...
mogene21sttranscriptclusterPATH
...
## Bimap interface:
mogene21sttranscriptclusterORGANISM
mogene21sttranscriptclusterORGPKG
...
mogene21sttranscriptclusterPATH maps probe identifiers to the identifiers used by KEGG for path-
ways in which the genes represented by the probe identifiers are involved

mogene21sttranscriptclusterPATH2PROBE is an R object that provides mappings between KEGG
...
mogene21sttranscriptclusterPFAM
...
## Bimap interface:
x <- mogene21sttranscriptclusterPATH
...
x <- mogene21sttranscriptclusterPATH
mapped_probes <- mappedkeys(x)
# Now convert the mogene21sttranscriptclusterPATH2PROBE object to a list
xx <- as.list(x[mapped_probes][1:300])
if(length(xx) > 0){
...
mogene21sttranscriptclusterPFAM is an R object that provides mappings between manufacturer
...
mogene21sttranscriptclusterPMID

Maps between Manufacturer Identifiers and PubMed Identifiers

Description

mogene21sttranscriptclusterPMID is an R object that provides mappings between manufacturer
identifiers and PubMed identifiers. mogene21sttranscriptclusterPMID2PROBE is an R object that
...
When mogene21sttranscriptclusterPMID is viewed as a list each manufacturer identifier is mapped
...
When mogene21sttranscriptclusterPMID2PROBE is viewed as a list each PubMed identifier is
...
## Bimap interface:
x <- mogene21sttranscriptclusterPMID
...
x <- mogene21sttranscriptclusterPMID2PROBE
mapped_probes <- mappedkeys(x)
# Now convert the reverse map object mogene21sttranscriptclusterPMID2PROBE to a list
xx <- as.list(x[mapped_probes][1:300])

mogene21sttranscriptclusterPROSITE
...
mogene21sttranscriptclusterPROSITE is an R object that provides mappings between manufacturer
...
mogene21sttranscriptclusterREFSEQ

Map between Manufacturer Identifiers and RefSeq Identifiers

Description

mogene21sttranscriptclusterREFSEQ is an R object that provides mappings between manufacturer
...
mogene21sttranscriptclusterSYMBOL
...
## Bimap interface:
x <- mogene21sttranscriptclusterREFSEQ
...
mogene21sttranscriptclusterSYMBOL is an R object that provides mappings between manufacturer
identifiers and gene abbreviations.

mogene21sttranscriptclusterUNIPROT
...
mogene21sttranscriptclusterUNIPROT is an R object that contains mappings between the manufac-
...
## Bimap interface:
x <- mogene21sttranscriptclusterUNIPROT
...
mogene21sttranscriptcluster_dbconn returns a connection object to the package annotation
DB. IMPORTANT: Don’t call dbDisconnect on the connection object returned by mogene21sttranscriptcluster_dbconn
or you will break all the AnnDbObj objects defined in this package!
mogene21sttranscriptcluster_dbfile returns the path (character string) to the package anno-
...
mogene21sttranscriptcluster_dbschema prints the schema definition of the package annotation
DB.
mogene21sttranscriptcluster_dbInfo prints other information about the package annotation
DB.

Value

mogene21sttranscriptcluster_dbconn: a DBIConnection object representing an open connec-
tion to the package annotation DB.
mogene21sttranscriptcluster_dbfile: a character string with the path to the package annota-
tion DB.
mogene21sttranscriptcluster_dbschema: none (invisible NULL).
mogene21sttranscriptcluster_dbInfo: none (invisible NULL).
...
mogene21sttranscriptcluster.db, 2
mogene21sttranscriptcluster_dbconn,
...
mogene21sttranscriptclusterCHR, 3
mogene21sttranscriptclusterCHRLENGTHS,
...
mogene21sttranscriptclusterGO, 10
mogene21sttranscriptclusterMAPCOUNTS,

12

mogene21sttranscriptclusterMGI, 12
mogene21sttranscriptclusterORGANISM,
...
mogene21sttranscriptcluster.db, 2
mogene21sttranscriptcluster_dbconn, 20
mogene21sttranscriptcluster_dbfile
...
mogene21sttranscriptclusterACCNUM, 1
mogene21sttranscriptclusterALIAS2PROBE,
...
mogene21sttranscriptclusterCHRLOC, 4
mogene21sttranscriptclusterCHRLOCEND

(mogene21sttranscriptclusterCHRLOC),
4

mogene21sttranscriptclusterENSEMBL, 5
mogene21sttranscriptclusterENSEMBL2PROBE

(mogene21sttranscriptclusterENSEMBL),
5

mogene21sttranscriptclusterENTREZID, 6

INDEX

23

mogene21sttranscriptclusterENZYME, 7
mogene21sttranscriptclusterENZYME2PROBE

(mogene21sttranscriptclusterENZYME),
7

mogene21sttranscriptclusterGENENAME, 9
mogene21sttranscriptclusterGO, 10
mogene21sttranscriptclusterGO2ALLPROBES,
...
mogene21sttranscriptclusterGO2PROBE

(mogene21sttranscriptclusterGO),
10

mogene21sttranscriptclusterLOCUSID
...
mogene21sttranscriptclusterMGI, 12
mogene21sttranscriptclusterMGI2PROBE
...
mogene21sttranscriptclusterPATH, 14
mogene21sttranscriptclusterPATH2PROBE

(mogene21sttranscriptclusterPATH),
14

mogene21sttranscriptclusterPFAM, 15
mogene21sttranscriptclusterPMID, 15
mogene21sttranscriptclusterPMID2PROBE

(mogene21sttranscriptclusterPMID),
15

mogene21sttranscriptclusterPROSITE, 17
mogene21sttranscriptclusterREFSEQ, 17
mogene21sttranscriptclusterSYMBOL, 18
mogene21sttranscriptclusterUNIPROT, 19
mogene21sttranscriptclusterUNIPROT2PROBE
