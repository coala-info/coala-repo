# Trim and filter reads - fastp - upgraded CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://training.galaxyproject.org
- **Package**: https://workflowhub.eu/workflows/1589
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1589/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 282
...
- **Main workflow (WorkflowHub):** `galaxy-workflow-trim-and-filter-reads.ga` (Main Workflow)
