...
Full genome sequences for Drosophila melanogaster (Fly) as provided by UCSC (dm3, Apr. 2006)
and stored in Biostrings objects. The sequences are the same as in BSgenome.Dmelanogaster.UCSC.dm3,
...
AGAPS masks: all the chr*_gap.txt.gz files from ftp://hgdownload.cse.ucsc.edu/goldenPath/dm3/database/
...
See ?BSgenome.Dmelanogaster.UCSC.dm3 in the BSgenome.Dmelanogaster.UCSC.dm3 pack-
...
• BSgenome.Dmelanogaster.UCSC.dm3 in the BSgenome.Dmelanogaster.UCSC.dm3 pack-
...
# same as BSgenome.Dmelanogaster.UCSC.dm3$chr2L
...
BSgenome, 2
BSgenome.Dmelanogaster.UCSC.dm3, 1, 2
BSgenome.Dmelanogaster.UCSC.dm3.masked,

1

BSgenome.Dmelanogaster.UCSC.dm3.masked-package
