# Racon polish with long reads, x4 - upgraded CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://training.galaxyproject.org
- **Package**: https://workflowhub.eu/workflows/1599
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1599/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 294
...
- **Main workflow (WorkflowHub):** `galaxy-workflow-racon-polish-with-long-reads-x4.ga` (Main Workflow)
