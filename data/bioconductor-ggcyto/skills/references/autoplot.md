...
![](data:image/png;base64...) ## `flowFrame` For the `flowFrame`, it can display one-dimensional plots for all channels by not supplying the `x` argument.
...
##       5 (1-1,1-4) arrange text[GRID.text.3677]
```
