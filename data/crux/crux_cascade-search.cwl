...
inputs:
  ...
  - id: database_series
    type: string
    doc: A comma-separated list of databases, each generated by tide-index. 
      Cascade-search will search the given spectra against these databases in 
      the given order.
    inputBinding:
      position: 2
  ...
  - id: pm_min_scan_frag_peaks
    ...
    doc: Minimum fragment peaks an MS/MS scan must contain to be used in 
      measurement error estimation. Default = 40.
    inputBinding:
      position: 103
  ...
  - id: q_value_threshold
    type:
      - 'null'
      - float
    doc: The q-value threshold used by cascade search. Each spectrum identified 
      in one search with q-value less than this threshold will be excluded from 
      all subsequent searches. Note that the threshold is not applied to the 
      final database in the cascade.
    inputBinding:
      position: 103
...
stdout: crux_cascade-search.out
