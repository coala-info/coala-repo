# Code example from 'atsnp-vignette' vignette. See references/ for full tutorial.
...
## ----eval=TRUE, echo=TRUE, fig.align="center", fig.height=5, fig.width=5, warning=TRUE, dpi=300, include=TRUE, results="markup"----
