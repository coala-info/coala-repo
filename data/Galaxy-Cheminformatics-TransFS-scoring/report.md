# Cheminformatics - TransFS scoring CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://github.com/galaxyproject/SARS-CoV-2
- **Package**: https://workflowhub.eu/workflows/16
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/16/ro_crate?version=1
- **Conda**: N/A
...
- **Main workflow (WorkflowHub):** `Cheminformatics-4-TransFS_scoring.ga` (Main Workflow)
- **Project**: GalaxyProject SARS-CoV-2
- **Views**: 8066
