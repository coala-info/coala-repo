...
### Metadata
- **Docker Image**: quay.io/biocontainers/vcf2maf:1.6.22--hdfd78af_2
- **Homepage**: https://github.com/mskcc/vcf2maf
- **Package**: https://anaconda.org/channels/bioconda/packages/vcf2maf/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/vcf2maf/overview
- **Total Downloads**: 71.5K
- **Last updated**: 2025-12-05
- **GitHub**: https://github.com/mskcc/vcf2maf
- **Stars**: N/A
### Original Help Text
```text
Usage:
...
Options:
    ...
    --ref-fasta=FASTA
            ...
            [~/.vep/homo_sapiens/112_GRCh37/Homo_sapiens.GRCh37.dna.toplevel
            .fa.gz]
    ...
    --cache-version=N
            Version of offline cache to use with VEP (e.g. 75, 91, 112)
...
### Tool Description
Converts MAF files to a VEP-annotated MAF.
