# cadd.v1.6.hg19 AnnotationHub Resource Metadata
...
cadd.v1.6.hg19 3.18.1

# 1 Retrieval of cadd.v1.6.hg19 pathogenicity scores through AnnotationHub resources

The `cadd.v1.6.hg19` package provides metadata for the
*[AnnotationHub](https://bioconductor.org/packages/3.18/AnnotationHub)* resources associated with human CADD
...
## *46*, 310-315. doi:10.1038/ng.2892 <https://doi.org/10.1038/ng.2892>.
```
...
```
## Creating package in ./cadd.v1.6.hg19
```
...
## [25] knitr_1.45                    S4Arrays_1.2.0
## [27] bit_4.0.5                     curl_5.1.0
## [29] DelayedArray_0.28.0           abind_1.4-5
## [31] HDF5Array_1.30.0              withr_2.5.2
