...
baseCommand: make
label: nullarbor_make
doc: "GNU Make is a utility that determines which pieces of a large program need to
  be recompiled, and issues commands to recompile them.\n\nTool homepage: https://github.com/tseemann/nullarbor"
inputs:
  - id: targets
    type:
      - 'null'
