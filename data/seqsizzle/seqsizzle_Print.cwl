...
inputs:
  ...
  - id: adapter_3p
    type:
      - 'null'
      - boolean
    doc: "Start with 10x 3' kit adaptors: - Patrial Read1: CTACACGACGCTCTTCCGATCT
      (and reverse complement) - Partial TSO: CCCATGTACTCTGCGTTGATACCA (and reverse
      complement) - Poly(>10)A/T"
    inputBinding:
      position: 103
      prefix: --adapter-3p
  - id: adapter_5p
    type:
      - 'null'
      - boolean
    doc: "Start with 10x 5' kit adaptors - Patrial Read1: CTACACGACGCTCTTCCGATCT (and
      reverse complement) - Patrial Read2: AGATCGGAAGAGCACACGTCTGAA (and reverse complement)
      - TSO: TTTCTTATATGGG (and reverse complement) - Poly(>10)A/T"
    inputBinding:
      position: 103
      prefix: --adapter-5p
