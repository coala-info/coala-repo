...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fanne-gcd%2FMTG-Link%2Fblob%2Fmaster%2FqualitativeEvaluation.py)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fblob%2Fshow&source=header-repo&source_repo=anne-gcd%2FMTG-Link)
...
[History](/anne-gcd/MTG-Link/commits/master/qualitativeEvaluation.py)
...
[Raw](https://github.com/anne-gcd/MTG-Link/raw/refs/heads/master/qualitativeEvaluation.py)
...
# Call to script 'stats\_alignment.py'.

scriptPath = sys.path[0]

stats\_alignment\_command = os.path.join(scriptPath, "stats\_alignment.py")

command = [stats\_alignment\_command, "-qry", str(queryFile), "-ref", str(referenceFile), "-ext", str(extSize), "-p", prefix, "-out", outputDir]
...
# Remove the raw file obtained from `stats\_alignment.py`.
