...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fjodyphelan%2FNTM-Profiler%2Fblob%2Fmain%2FREADME.md)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fblob%2Fshow&source=header-repo&source_repo=jodyphelan%2FNTM-Profiler)
...
[History](/jodyphelan/NTM-Profiler/commits/main/README.md)

History

186 lines (121 loc) · 8.11 KB
...
[Raw](https://github.com/jodyphelan/NTM-Profiler/raw/refs/heads/main/README.md)
...
The reference genome and gff giles should be named **genome.fasta** and **genome.gff** respectively. The **variables.json** file should at least contain the snpEff\_database used by `ntm-profiler` to annotate mutations.
...
* If you are planning to use `ntm-profiler` on bam files, it is impor