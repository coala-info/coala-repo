...
baseCommand: xyalign
label: xyalign_characterize_sex_chroms
...
inputs:
  ...
  - id: read_group_id
    ...
    default: --read_group_id xyalign
    inputBinding:
      position: 101
      prefix: --read_group_id
  - id: ref
    type: File
    doc: Path to reference sequence (including file name).
    inputBinding:
      position: 101
      prefix: --ref
  - id: reference_mask
...
outputs:
  - id: output_dir
    type: Directory
    doc: Output directory. XYalign will create a directory structure within this
      directory
    outputBinding:
