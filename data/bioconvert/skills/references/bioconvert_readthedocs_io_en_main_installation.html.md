...
* 1. Installation
  + [1.1. conda / bioconda /mamba installation](#conda-bioconda-mamba-installation)
  + [1.2. Docker](#docker)
  + [1.3. Singularity/Apptainer](#singularity-apptainer)
  + [1.4. Conda channels](#conda-channels)
...
# 1. Installation[](#installation "Link to this heading")
...
One solution is to create a dedicated environment using **conda**. In particular, we use [bioconda](https://bioconda.github.io) to install those dependencies.

## 1.1. conda / bioconda /mamba installation[](#conda-bioconda-mamba-installation "Link to this heading")
...
Indeed, **BioConvert** is available on the [bioconda](https://bioconda.github.io) channel (see [Conda channels](#conda-channels) section for details).
...
## 1.2. Docker[](#docker "Link to this heading")
...
## 1.3. Singularity/Apptainer[](#singularity-apptainer "Link to this heading")
...
## 1.4. Conda channels[](#conda-channels "Link to this heading")
...
[Previous](index.html "Bioconvert")
[Next](user_guide.html "2. User Guide")
