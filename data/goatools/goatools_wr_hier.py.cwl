...
baseCommand: goatools_wr_hier.py
label: goatools_wr_hier.py
doc: "Write a hierarchy of Gene Ontology (GO) terms. (Note: The provided text contains
...
stdout: goatools_wr_hier.py.out
