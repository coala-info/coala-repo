...
doc: "Merge alignment data from a SAM or BAM with data in an unmapped BAM file. Produces
...
inputs:
  ...
  - id: aligned_bam
    type:
      ...
      - type: array
        items: File
    doc: SAM or BAM file(s) with alignment data. Cannot be used in conjunction 
      with READ1_ALIGNED_BAM or READ2_ALIGNED_BAM
    inputBinding:
      position: 101
      prefix: --ALIGNED_BAM
  ...
  - id: primary_alignment_strategy
    ...
    doc: 'Strategy for selecting primary alignment when the aligner has provided more
      than one alignment for a pair or fragment. Possible values: {BestMapq, EarliestFragment,
      BestEndMapq, MostDistant}'
    default: BestMapq
    inputBinding:
      position: 101
  ...
  - id: read1_aligned_bam
    ...
    doc: SAM or BAM file(s) with alignment data from the first read of a pair. 
      Cannot be used with ALIGNED_BAM.
    inputBinding:
      position: 101
  ...
  - id: unmap_contaminant_reads
    type:
      - 'null'
      - boolean
    doc: Detect reads originating from foreign organisms and unmap + label those
      reads accordingly.
    default: false
    inputBinding:
      position: 101
