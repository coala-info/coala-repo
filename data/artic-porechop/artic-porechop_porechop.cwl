...
inputs:
  ...
  - id: extended_labels
    type:
      - 'null'
      - boolean
    doc: Reads will have an extended label added to their header with the 
  ...
  - id: require_two_barcodes
    type:
      - 'null'
      - boolean
    doc: Reads will only be put in barcode bins if they have a strong match for 
