...
FATAL:   Unable to handle docker://quay.io/biocontainers/pyscenic:0.12.1--pyhdfd78af_1 uri: while building SIF from layers: conveyor failed to get: invalid character '}' after top-level value
```
