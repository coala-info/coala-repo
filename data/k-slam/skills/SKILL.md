---
name: k-slam
description: k-SLAM (k-mer based Smith-Waterman Local Alignment for Metagenomics) is a high-performance tool designed to bridge the gap between fast k-mer classifiers and sensitive sequence aligners.
