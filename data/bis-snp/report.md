...
Based on The Genome Analysis Toolkit (GATK) v3.8-1-0-gf15c1c3ef (prebuild GATK package could be download here: https://github.com/broadgsa/gatk-protected/releases)
...
### Metadata
- **Docker Image**: quay.io/biocontainers/bis-snp:1.0.1--hdfd78af_3
- **Homepage**: http://people.csail.mit.edu/dnaase/bissnp2011/
- **Package**: https://anaconda.org/channels/bioconda/packages/bis-snp/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/bis-snp/overview
...
-------------------------------------------------------------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------------------------------------------------------------
usage: java -jar BisSNP-1.0.1.jar -T <analysis_type> [-I <input_file>] [--showFullBamList] [-rbs <read_buffer_size>] [-rf 
