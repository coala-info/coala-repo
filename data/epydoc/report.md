...
### Tool Description
epydoc is a tool for automatically generating API documentation for Python modules.

### Metadata
- **Docker Image**: quay.io/biocontainers/epydoc:3.0.1--py27_0
- **Homepage**: https://github.com/nltk/epydoc
- **Package**: Not found
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/epydoc/overview
- **Total Downloads**: 6.3K
- **Last updated**: 2025-04-22
- **GitHub**: https://github.com/nltk/epydoc
- **Stars**: N/A
### Original Help Text
```text
...
Options:
  ...
  Generation Options:
    ...
    --redundant-details
                        Include values in the details lists even if all info
  ...
  Output Options:
    ...
    -u URL, --url=URL   The documented project's URL (for the navigation bar).
    ...
    --src-code-tab-width=SRC_CODE_TAB_WIDTH
                        When generating HTML output, sets the number of spaces
...
### Tool Description
Write and format documentation for Python modules
...
### Tool Description
epydoc is a tool for generating documentation from Python docstrings.
