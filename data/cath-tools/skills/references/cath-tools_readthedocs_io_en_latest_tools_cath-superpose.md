...
* [cath-superpose](./)
  + [Introduction](#introduction)
    ...
    - [Alignment refining](#alignment-refining)
  + [Multiple Superpositions](#multiple-superpositions)
  + [Usage](#usage)
  + [Feedback](#feedback)
...
***Left**: A standard superposition of [1fi2A00](http://www.cathdb.info/version/latest/domain/1fi2A00)/[1j58A01](http://www.cathdb.info/version/latest/domain/1j58A01) is disrupted by divergent regions;
...
The format is like: `D[5inwB02]251-348:B,408-416A:B`. Put  in quotes to prevent the square brackets confusing your shell ("No match").
