...
```
## Error in `waterfall()`:
## ! unused arguments (brcaMAF, mainRecurCutoff = 0.06)
```
...
```
## Error in `waterfall()`:
## ! unused arguments (brcaMAF, plotGenes = c("PIK3CA", "TP53", "USH2A", "MLL3", "BRCA1"))
```
...
```
## Error in `waterfall()`:
## ! unused arguments (brcaMAF, clinDat = clinical, clinVarCol = c(lumA = "blue4", lumB = "deepskyblue", her2 = "hotpink2", basal = "firebrick2", normal = "green4", `20-30` = "#ddd1e7", `31-50` = "#bba3d0", `51-60` = "#9975b9", `61+` = "#7647a2"), plotGenes = c("PIK3CA", "TP53", "USH2A", "MLL3", "BRCA1"), clinLegCol = 2, clinVarOrder = c("lumA", "lumB", "her2", "basal", "normal", "20-30", "31-50", "51-60", "61+"))
```
...
### 1.3.2 genCov (sequence coverage graphic)
...
### 1.3.3 TvTi (transition/transversion graphic)
...
### 1.3.4 cnSpec (copy altered cohort graphic)
...
### 1.3.5 cnView (copy altered single sample graphic)
...
### 1.3.6 covBars (sequencing coverage cohort)
...
### 1.3.7 cnFreq (proportional copy number alterations)
...
### 1.3.8 ideoView (ideogram graphic)
...
### 1.3.9 lohSpec (Loss of Heterozygosity Spectrum)
...
### 1.3.10 lohView (Loss of Heterozygosity View)
...
### 1.3.11 compIdent (snp identity graphic)
...
### 1.3.12 geneViz (Transcript Represenation)
...
## [67] ggplot2_4.0.1               scales_1.4.0
## [69] gtools_3.9.5                glue_1.8.0
## [71] tools_4.5.2                 data.table_1.18.0
## [73] GenomicAlignments_1.46.0    XML_3.99-0.20
## [75] grid_4.5.2                  restfulr_0.0.16
## [77] cli_3.6.5                   rappdirs_0.3.3
## [79] S4Arrays_1.10.1             viridisLite_0.4.2
## [81] dplyr_1.1.4                 gtable_0.3.6
## [83] sass_0.4.10                 digest_0.6.39
## [85] SparseArray_1.10.8          rjson_0.2.23
