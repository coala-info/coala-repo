...
inputs:
  ...
  - id: auto_threads
    type:
      - 'null'
      - string
    doc: Use physical/logical cores when using `-T0`.
    default: physical
    inputBinding:
      position: 102
      prefix: --auto-threads
  - id: check
    type:
      - 'null'
      - boolean
    doc: Add XXH64 integrity checksums during compression.
    inputBinding:
      position: 102
      prefix: --check
  - id: compression_level
    type:
      - 'null'
      - int
    doc: Desired compression level, where `#` is a number between 1 and 19
    default: 3
    inputBinding:
      position: 102
      prefix: -#
  ...
  - id: force
    ...
    doc: Disable input and output checks. Allows overwriting existing files, 
      receiving input from the console, printing output to STDOUT, etc.
    inputBinding:
      position: 102
      prefix: --force
  - id: format
  ...
  - id: keep
    type:
      - 'null'
      - boolean
    doc: Preserve INPUT file(s). [Default]
    inputBinding:
      position: 102
      prefix: --keep
  - id: list
  ...
  - id: no_progress
    type:
      - 'null'
      - boolean
    doc: Forcibly hide the progress counter.
    inputBinding:
      position: 102
      prefix: --no-progress
  - id: patch_from
  ...
  - id: progress
    type:
      - 'null'
      - boolean
    doc: Forcibly show the progress counter.
    inputBinding:
      position: 102
      prefix: --progress
  - id: quiet
