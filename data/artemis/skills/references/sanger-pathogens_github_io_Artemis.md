...
Where **<program name>** is one of art, act, bamview or dnaplotter and **<your data folder>** represents the path of a folder that contains the data files that you wish to use in the Artemis applications. Memory allocation can be changed by passing the -mx and -ms arguments in the ARTEMIS\_JVM\_FLAGS variable above, for example: -mx1g for a maximum 1Gb memory allocation.
