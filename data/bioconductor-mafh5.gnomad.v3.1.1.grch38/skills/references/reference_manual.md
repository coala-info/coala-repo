...
MafH5.gnomAD.v3.1.1.GRCh38-package
...
variant set version 3.1.1 of the Genome Aggregation Database (gnomAD). The data are exposed to
the user in the form of a GScores object, named after the package and loaded into main memory only
...
perform faster if it is installed in a local HDD rather than in network drive (e.g., through NFS
access).
...
GScores object containing MAF values from gnomAD genomes downloaded on April 2021 from http://gnomad.broadinstitute.org/downloads. See the extdata/README ﬁle for more information on how these data have been stored into this annotation package.
...
ls("package:MafH5.gnomAD.v3.1.1.GRCh38")
...
MafH5.gnomAD.v3.1.1.GRCh38, 1
MafH5.gnomAD.v3.1.1.GRCh38

(MafH5.gnomAD.v3.1.1.GRCh38-package),
1

MafH5.gnomAD.v3.1.1.GRCh38-package, 1
