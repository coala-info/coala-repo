...
inputs:
  ...
  - id: custom
    type:
      - 'null'
      - File
    doc: Association custom analysis table
    inputBinding:
      position: 101
      prefix: --custom
  - id: data_file
  ...
  - id: tabulate
    type:
      - 'null'
      - boolean
    doc: Output results in tabular format
    inputBinding:
      position: 101
      prefix: --tabulate
  - id: three
  ...
  - id: trait
    type:
      ...
      - type: array
        items: string
    doc: Simulation trait to simulate
    inputBinding:
      position: 101
      prefix: --trait
  - id: trim
