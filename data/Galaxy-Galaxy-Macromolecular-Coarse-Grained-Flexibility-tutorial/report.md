# Galaxy Macromolecular Coarse-Grained Flexibility tutorial CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://mmb.irbbarcelona.org/biobb/
- **Package**: https://workflowhub.eu/workflows/557
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/557/ro_crate?version=1
- **Conda**: N/A
...
- **Main workflow (WorkflowHub):** `biobb_wf_flexserv.ga` (Main Workflow)
...
- **Discussion / source**: https://biobb.usegalaxy.es/u/gbayarri/w/protein-structure-flexibility
- **Discussion / source**: https://biobb-wf-flexserv.readthedocs.io/en/latest/tutorial.html
