...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Flehner-lab%2FMoCHI%2Fblob%2Fmaster%2Fdocs%2FINSTALLATION.md)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fblob%2Fshow&source=header-repo&source_repo=lehner-lab%2FMoCHI)
...
2. /[docs](/lehner-lab/MoCHI/tree/master/docs)
...
[History](/lehner-lab/MoCHI/commits/master/docs/INSTALLATION.md)

History

89 lines (67 loc) · 3.87 KB
...
[Raw](https://github.com/lehner-lab/MoCHI/raw/refs/heads/master/docs/INSTALLATION.md)
...
[![](/lehner-lab/MoCHI/raw/master/Mochi.png)](/lehner-lab/MoCHI/blob/master/Mochi.png)
...
**IMPORTANT:** If in doubt, respond with "yes" to the following question during installation: "Do you wish the installer to initialize Miniforge3 by running conda init?". In this case Conda will modify your shell scripts (*~/.bashrc* or *~/.bash\_profile*) to initialize Miniforge3 on startup. Ensure that any future modifications to your *$PATH* variable in your shell scripts occur **before** this code to initialize Miniforge3.
...
This [this yaml file](/lehner-lab/MoCHI/blob/master/pymochi.yaml) can be used to create a dedicated Conda environment with all necessary dependencies (as explained below).
