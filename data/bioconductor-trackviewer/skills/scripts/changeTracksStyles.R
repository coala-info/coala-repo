# Code example from 'changeTracksStyles' vignette. See references/ for full tutorial.
...
## ----viewTracksAnnotation,fig.cap='show called peaks in track', fig.width=8, fig.height=2.4----
cpsf160_cp <- cpsf160
