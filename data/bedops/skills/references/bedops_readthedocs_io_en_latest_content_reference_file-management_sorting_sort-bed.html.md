...
* ←
  [6.3.1. Sorting](../sorting.html "Previous document")
* [6.3.2. Compression](../compression.html "Next document")
  →

* [Home](../../../../index.html)
* [6. Reference](../../../reference.html)
* [6.3. File management](../../file-management.html)
* [6.3.1. Sorting](../sorting.html)

# 6.3.1.1. sort-bed[¶](#sort-bed "Permalink to this headline")
...
## 6.3.1.1.1. Migrating older BED and Starch files[¶](#migrating-older-bed-and-starch-files "Permalink to this headline")
...
## 6.3.1.1.2. Inputs and outputs[¶](#inputs-and-outputs "Permalink to this headline")

### 6.3.1.1.2.1. Input[¶](#input "Permalink to this headline")

The `sort-bed` utility requires one or more three-column BED file(s). Support for common headers (such as [UCSC BED track headers](http://genome.ucsc.edu/FAQ/FAQformat.html#format1)) is included, although headers will be stripped from the output.

### 6.3.1.1.2.2. Output[¶](#output "Permalink to this headline")

The `sort-bed` utility sends sorted BED data to standard output, which can be redirected to a file or piped to other utilities, including core BEDOPS utilities like [bedops](../../set-operations/bedops.html#bedops) and [bedmap](../../statistics/bedmap.html#bedmap). Sort order is defined by a lexicographical sort on chromosome name, a numerical sort on start coordinates, a numerical sort on stop coordinates where there are start matches, and finally a lexicographical sort on the remainder of the BED element (if additional columns are present). Additional options may be specified to print only unique or duplicate elements, or check the sort order of input.

## 6.3.1.1.3. Usage[¶](#usage "Permalink to this headline")
...
* 6.3.1.1. sort-bed
  + [6.3.1.1.1. Migrating older BED and Starch files](#migrating-older-bed-and-starch-files)
  + [6.3.1.1.2. Inputs and outputs](#inputs-and-outputs)
    - [6.3.1.1.2.1. Input](#input)
    - [6.3.1.1.2.2. Output](#output)
  + [6.3.1.1.3. Usage](#usage)
