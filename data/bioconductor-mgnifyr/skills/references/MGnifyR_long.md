...
type. For example, “sample\_xxx” columns correspond to metadata gleaned from
...
“sample\_soil\_PH”, entries for other rows will be filled with `NA`. `MGnifyR`
...
into a single *[TreeSummarizedExperiment](https://bioconductor.org/packages/3.22/TreeSummarizedExperiment)* (`TreeSE`)
...
*[phyloseq](https://bioconductor.org/packages/3.22/phyloseq)* object, `TreeSE` is more scalable and capable
...
*[SummarizedExperiment](https://bioconductor.org/packages/3.22/SummarizedExperiment)*-based
...
*[MultiAssayExperiment](https://bioconductor.org/packages/3.22/MultiAssayExperiment)* (`MAE`) which
