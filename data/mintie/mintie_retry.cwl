...
inputs:
  ...
  - id: test_arg
    type:
      - 'null'
      - string
    doc: An optional test argument for the 'retry' command.
    inputBinding:
      position: 6
  - id: archive_path
    type:
      - 'null'
      - File
    doc: Path to the archive file for archiving.
    inputBinding:
      position: 107
      prefix: --archive
  - id: autoarchive
    type:
      - 'null'
      - boolean
    doc: Enable automatic archiving.
    inputBinding:
      position: 107
      prefix: --autoarchive
  - id: autoarchive_dir
    type:
      - 'null'
      - Directory
    doc: Clean up all internal files after run into given archive directory.
    inputBinding:
      position: 107
      prefix: --autoarchive
  - id: branches
