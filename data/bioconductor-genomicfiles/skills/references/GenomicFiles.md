...
Valerie Obenchain, Michael Love, Martin Morgan and Sonali Kumari1

1Vignette translation from Sweave to Rmarkdown / HTML

#### Last modified: October 2014; Compiled: October 30 , 2025

# Contents

* [1 Introduction](#introduction)
* [2 Quick Start](#quick-start)
* [3 Overview of classes and functions](#overview-of-classes-and-functions)
  + [3.1 `GenomicFiles` class](#genomicfiles-class)
  + [3.2 Functions](#functions)
* [4 Queries across files: `reduceByRange` and `reduceRanges`](#queries-across-files-reducebyrange-and-reduceranges)
  + [4.1 Pileup summaries](#pileup-summaries)
  + [4.2 Basepair-level \(t\)-test with case / control groups](#basepair-level-t-test-with-case-control-groups)
* [5 Queries within files: reduceByFile and reduceFiles](#queries-within-files-reducebyfile-and-reducefiles)
  + [5.1 Counting read junctions](#counting-read-junctions)
  + [5.2 Coverage 1: reduceByFile](#coverage-1-reducebyfile)
  + [5.3 Coverage 2: `reduceFiles`](#coverage-2-reducefiles)
  + [5.4 Coverage 3: `reduceFiles` with chunking](#coverage-3-reducefiles-with-chunking)
* [6 Chunking](#chunking)
  + [6.1 Ranges in a file](#ranges-in-a-file)
  + [6.2 Records in a file](#records-in-a-file)
* [7 `sessionInfo()`](#sessioninfo)

# 1 Introduction

This vignette illustrates how to use the *[GenomicFiles](https://bioconductor.org/packages/3.22/GenomicFiles)* package for
...
in *[GenomicRanges](https://bioconductor.org/packages/3.22/GenomicRanges)*, *[GenomicAlignments](https://bioconductor.org/packages/3.22/GenomicAlignments)*,
*[Rsamtools](https://bioconductor.org/packages/3.22/Rsamtools)* and *[rtracklayer](https://bioconductor.org/packages/3.22/rtracklayer)* for an introduction to
these classes.
...
![Mechanics of `reduceByRange` and `reduceRanges`](data:image/png;base64...)

Figure 1: Mechanics of `reduceByRange` and `reduceRanges`
...
![Mechanics of `reduceByFile` and `reduceFiles`](data:image/png;base64...)
...
The `bam2R` function from the *[deepSNV](https://bioconductor.org/packages/3.22/deepSNV)* package is used to compute
...
*[deepSNV](https://bioconductor.org/packages/3.22/deepSNV)* must be loaded on each worker so the function can be
found.
...
level (`bplapply`) and one at the MAP level (`reduceByYield(..., parallel=TRUE`). This example takes the conservative approach and runs
...
##  [1] GenomicAlignments_1.46.0           RNAseqData.HNRNPC.bam.chr14_0.47.0
##  [3] GenomicFiles_1.46.0                SummarizedExperiment_1.40.0
##  [5] Biobase_2.70.0                     rtracklayer_1.70.0
##  [7] Rsamtools_2.26.0                   Biostrings_2.78.0
##  [9] XVector_0.50.0                     MatrixGenerics_1.22.0
## [11] matrixStats_1.5.0                  GenomicRanges_1.62.0
## [13] Seqinfo_1.0.0                      IRanges_2.44.0
## [15] S4Vectors_0.48.0                   BiocParallel_1.44.0
...
## [13] blob_1.2.4               BiocBaseUtils_1.12.0     Matrix_1.7-4
## [16] BSgenome_1.78.0          cigarillo_1.0.0          lifecycle_1.0.4
## [19] compiler_4.5.1           codetools_0.2-20         GenomeInfoDb_1.46.0
## [22] htmltools_0.5.8.1        sass_0.4.10              RCurl_1.98-1.17
...
## [34] VariantAnnotation_1.56.0 fastmap_1.2.0            grid_4.5.1
## [37] cli_3.6.5                SparseArray_1.10.0       S4Arrays_1.10.0
## [40] GenomicFeatures_1.62.0   XML_3.99-0.19            UCSC.utils_1.6.0
## [43] bit64_4.6.0-1            rmarkdown_2.30           httr_1.4.7
## [46] bit_4.6.0                png_0.1-8                memoise_2.0.1
## [49] evaluate_1.0.5           knitr_1.50               BiocIO_1.20.0
## [52] rlang_1.1.6              DBI_1.2.3                BiocManager_1.30.26
