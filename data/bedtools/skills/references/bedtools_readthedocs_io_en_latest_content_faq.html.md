...
* [next](related-tools.html "Related software") |
* [previous](tips-and-tricks.html "Tips and Tricks") |
* [bedtools v2.31.0](../index.html) »

# FAQ[¶](#faq "Permalink to this headline")

## Installation issues[¶](#installation-issues "Permalink to this headline")

### Why am I getting all of these zlib errors?[¶](#why-am-i-getting-all-of-these-zlib-errors "Permalink to this headline")
...
### Compiling with a specific zlib library[¶](#compiling-with-a-specific-zlib-library "Permalink to this headline")
...
## General questions[¶](#general-questions "Permalink to this headline")

### How do I know what version of bedtools I am using?[¶](#how-do-i-know-what-version-of-bedtools-i-am-using "Permalink to this headline")
...
### How do I bring up the help/usage menu?[¶](#how-do-i-bring-up-the-help-usage-menu "Permalink to this headline")
...
## Issues with output[¶](#issues-with-output "Permalink to this headline")

### I *know* there are overlaps, but none are reported. What might be wrong?[¶](#i-know-there-are-overlaps-but-none-are-reported-what-might-be-wrong "Permalink to this headline")
...
## Installation issues[¶](#installation-issues-1 "Permalink to this headline")

### Bedtools compilation fails with errors related to zlib. How do I fix this?[¶](#bedtools-compilation-fails-with-errors-related-to-zlib-how-do-i-fix-this "Permalink to this headline")
...
* FAQ
  + [Installation issues](#installation-issues)
    - [Why am I getting all of these zlib errors?](#why-am-i-getting-all-of-these-zlib-errors)
    - [Compiling with a specific zlib library](#compiling-with-a-specific-zlib-library)
  + [General questions](#general-questions)
    - [How do I know what version of bedtools I am using?](#how-do-i-know-what-version-of-bedtools-i-am-using)
    - [How do I bring up the help/usage menu?](#how-do-i-bring-up-the-help-usage-menu)
  + [Issues with output](#issues-with-output)
    - [I *know* there are overlaps, but none are reported. What might be wrong?](#i-know-there-are-overlaps-but-none-are-reported-what-might-be-wrong)
  + [Installation issues](#installation-issues-1)
    - [Bedtools compilation fails with errors related to zlib. How do I fix this?](#bedtools-compilation-fails-with-errors-related-to-zlib-how-do-i-fix-this)

#### Previous topic

[Tips and Tricks](tips-and-tricks.html "previous chapter")

#### Next topic

[Related software](related-tools.html "next chapter")

### This Page

* [Show Source](../_sources/content/faq.rst.txt)
