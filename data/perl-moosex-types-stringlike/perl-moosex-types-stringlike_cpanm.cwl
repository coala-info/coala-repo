...
baseCommand: cpanm
label: perl-moosex-types-stringlike_cpanm
...
inputs:
  - id: module
    type:
      type: array
      items: string
    doc: CPAN Module name, distribution path, URL, or local file/directory
    inputBinding:
      position: 1
  - id: auto_cleanup
    type:
...
stdout: perl-moosex-types-stringlike_cpanm.out
