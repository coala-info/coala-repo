...
baseCommand: perl
label: perl-sub-identify_perl
doc: "The Perl 5 language interpreter\n\nTool homepage: http://metacpan.org/pod/Sub::Identify"
inputs:
  - id: program_file
    type:
      - 'null'
...
hints:
  - class: DockerRequirement
    dockerPull: quay.io/biocontainers/perl-sub-identify:0.14--pl5321hec16e2b_2
stdout: perl-sub-identify_perl.out
