# From Fastqs to VCFs and BAMs CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://training.galaxyproject.org
- **Package**: https://workflowhub.eu/workflows/1573
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1573/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 267
...
- **Main workflow (WorkflowHub):** `galaxy-workflow-from-fastqs-to-vcfs-and-bams.ga` (Main Workflow)
