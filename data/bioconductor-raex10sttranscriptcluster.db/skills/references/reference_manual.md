...
raex10sttranscriptclusterACCNUM

Map Manufacturer identifiers to Accession Numbers

Description

raex10sttranscriptclusterACCNUM is an R object that contains mappings between a manufacturer’s
...
## Bimap interface:
x <- raex10sttranscriptclusterACCNUM
...
raex10sttranscriptclusterALIAS2PROBE
...
raex10sttranscriptclusterALIAS is an R object that provides mappings between common gene sym-
...
xx <- as.list(raex10sttranscriptclusterALIAS2PROBE)
if(length(xx) > 0){
...
Welcome to the raex10sttranscriptcluster.db annotation Package. The purpose of this package is to
provide detailed information about the raex10sttranscriptcluster platform. This package is updated
biannually.
Objects in this package are accessed using the select() interface. See ?select in the AnnotationDbi
package for details.

raex10sttranscriptclusterCHR
...
## Objects in this package can be accessed using the select() interface
## from the AnnotationDbi package. See ?select for details.
columns(raex10sttranscriptcluster.db)

## Bimap interface:
## The 'old style' of interacting with these objects is manipulation as
## bimaps. While this approach is still available we strongly encourage the
## use of select().
ls("package:raex10sttranscriptcluster.db")
...
raex10sttranscriptclusterCHR is an R object that provides mappings between a manufacturer iden-
...
## Bimap interface:
x <- raex10sttranscriptclusterCHR
...
raex10sttranscriptclusterCHRLOC
...
raex10sttranscriptclusterCHRLENGTHS

A named vector for the length of each of the chromosomes

Description

raex10sttranscriptclusterCHRLENGTHS provides the length measured in base pairs for each of the
chromosomes.
...
## Bimap interface:
tt <- raex10sttranscriptclusterCHRLENGTHS
...
raex10sttranscriptclusterCHRLOC is an R object that maps manufacturer identifiers to the starting
...
raex10sttranscriptclusterENSEMBL
...
## Bimap interface:
x <- raex10sttranscriptclusterCHRLOC
...
raex10sttranscriptclusterENSEMBL is an R object that contains mappings between manufacturer
...
raex10sttranscriptclusterENTREZID
...
## Bimap interface:
x <- raex10sttranscriptclusterENSEMBL
...
x <- raex10sttranscriptclusterENSEMBL2PROBE
mapped_genes <- mappedkeys(x)
# Convert to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
raex10sttranscriptclusterENTREZID is an R object that provides mappings between manufacturer
identifiers and Entrez Gene identifiers.

raex10sttranscriptclusterENZYME
...
## Bimap interface:
x <- raex10sttranscriptclusterENTREZID
...
raex10sttranscriptclusterENZYME is an R object that provides mappings between manufacturer
identifiers and EC numbers. raex10sttranscriptclusterENZYME2PROBE is an R object that maps
...
When the raex10sttranscriptclusterENZYME maping viewed as a list, each manufacturer identifier
...
vector will contain an NA.
For the raex10sttranscriptclusterENZYME2PROBE, each EC number maps to a named vector con-
...
bers. In raex10sttranscriptclusterENZYME2PROBE, EC is dropped from the Enzyme Commission
numbers.
...
## Bimap interface:
x <- raex10sttranscriptclusterENZYME
...
raex10sttranscriptclusterGENENAME
...
# Now convert raex10sttranscriptclusterENZYME2PROBE to a list to see inside
x <- raex10sttranscriptclusterENZYME2PROBE
mapped_probes <- mappedkeys(x)
## convert to a list
xx <- as.list(x[mapped_probes][1:3])
if(length(xx) > 0){
...
raex10sttranscriptclusterGENENAME is an R object that maps manufacturer identifiers to the cor-
...
## Bimap interface:
x <- raex10sttranscriptclusterGENENAME
# Get the probe identifiers that are mapped to a gene name
mapped_probes <- mappedkeys(x)

10

raex10sttranscriptclusterGO
...
raex10sttranscriptclusterGO is an R object that provides mappings between manufacturer identifiers
and the GO identifiers that they are directly associated with. This mapping and its reverse mapping
(raex10sttranscriptclusterGO2PROBE) do NOT associate the child terms from the GO ontology
with the gene. Only the directly evidenced terms are represented here.

raex10sttranscriptclusterGO2ALLPROBES is an R object that provides mappings between a given
...
than raex10sttranscriptclusterGO2PROBE.

Details

If raex10sttranscriptclusterGO is cast as a list, each manufacturer identifier is mapped to a list
...
If raex10sttranscriptclusterGO2ALLPROBES or raex10sttranscriptclusterGO2PROBE is cast as a
...
• raex10sttranscriptclusterGO2ALLPROBES
• AnnotationDb-class for use of the select() interface.
...
# For the reverse map:
x <- raex10sttranscriptclusterGO2PROBE
mapped_genes <- mappedkeys(x)
# Convert to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
raex10sttranscriptclusterORGANISM

x <- raex10sttranscriptclusterGO2ALLPROBES
mapped_genes <- mappedkeys(x)
# Convert raex10sttranscriptclusterGO2ALLPROBES to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
raex10sttranscriptclusterMAPCOUNTS
...
raex10sttranscriptclusterMAPCOUNTS provides the "map count" (i.e. the count of mapped keys)
for each map in package raex10sttranscriptcluster.db.
...
The Organism information for raex10sttranscriptcluster

Description

raex10sttranscriptclusterORGANISM is an R object that contains a single item: a character string
that names the organism for which raex10sttranscriptcluster was built. raex10sttranscriptclusterORGPKG
...
raex10sttranscriptclusterPATH

13

Details

Although the package name is suggestive of the organism for which it was built, raex10sttranscriptclusterORGANISM
provides a simple way to programmatically extract the organism name. raex10sttranscriptclusterORGPKG
...
## Bimap interface:
raex10sttranscriptclusterORGANISM
raex10sttranscriptclusterORGPKG
...
raex10sttranscriptclusterPATH maps probe identifiers to the identifiers used by KEGG for pathways
in which the genes represented by the probe identifiers are involved

raex10sttranscriptclusterPATH2PROBE is an R object that provides mappings between KEGG iden-
...
## Bimap interface:
x <- raex10sttranscriptclusterPATH
...
x <- raex10sttranscriptclusterPATH
mapped_probes <- mappedkeys(x)
# Now convert the raex10sttranscriptclusterPATH2PROBE object to a list
xx <- as.list(x[mapped_probes][1:300])
if(length(xx) > 0){
...
raex10sttranscriptclusterPFAM is an R object that provides mappings between manufacturer iden-
...
raex10sttranscriptclusterPMID is an R object that provides mappings between manufacturer identi-
fiers and PubMed identifiers. raex10sttranscriptclusterPMID2PROBE is an R object that provides
mappings between PubMed identifiers and manufacturer identifiers.

Details

When raex10sttranscriptclusterPMID is viewed as a list each manufacturer identifier is mapped
...
When raex10sttranscriptclusterPMID2PROBE is viewed as a list each PubMed identifier is mapped
...
## Bimap interface:
x <- raex10sttranscriptclusterPMID
...
raex10sttranscriptclusterREFSEQ
...
x <- raex10sttranscriptclusterPMID2PROBE
mapped_probes <- mappedkeys(x)
# Now convert the reverse map object raex10sttranscriptclusterPMID2PROBE to a list
xx <- as.list(x[mapped_probes][1:300])
if(length(xx) > 0){
...
raex10sttranscriptclusterPROSITE

Maps between Manufacturer Identifiers and PROSITE Identifiers

Description

raex10sttranscriptclusterPROSITE is an R object that provides mappings between manufacturer
...
raex10sttranscriptclusterREFSEQ is an R object that provides mappings between manufacturer
...
## Bimap interface:
x <- raex10sttranscriptclusterREFSEQ
...
raex10sttranscriptclusterSYMBOL
...
raex10sttranscriptclusterSYMBOL is an R object that provides mappings between manufacturer
...
## Bimap interface:
x <- raex10sttranscriptclusterSYMBOL
...
raex10sttranscriptclusterUNIPROT
...
raex10sttranscriptclusterUNIPROT is an R object that contains mappings between the manufacturer
...
## Bimap interface:
x <- raex10sttranscriptclusterUNIPROT
...
raex10sttranscriptcluster_dbconn
...
raex10sttranscriptcluster_dbconn()
raex10sttranscriptcluster_dbfile()
raex10sttranscriptcluster_dbschema(file="", show.indices=FALSE)
raex10sttranscriptcluster_dbInfo()
...
raex10sttranscriptcluster_dbconn returns a connection object to the package annotation DB.
IMPORTANT: Don’t call dbDisconnect on the connection object returned by raex10sttranscriptcluster_dbconn
or you will break all the AnnDbObj objects defined in this package!
raex10sttranscriptcluster_dbfile returns the path (character string) to the package annota-
tion DB (this is an SQLite file).
raex10sttranscriptcluster_dbschema prints the schema definition of the package annotation
DB.
raex10sttranscriptcluster_dbInfo prints other information about the package annotation DB.

Value

raex10sttranscriptcluster_dbconn: a DBIConnection object representing an open connection
to the package annotation DB.
raex10sttranscriptcluster_dbfile: a character string with the path to the package annotation
DB.
raex10sttranscriptcluster_dbschema: none (invisible NULL).
raex10sttranscriptcluster_dbInfo: none (invisible NULL).
...
dbGetQuery(raex10sttranscriptcluster_dbconn(), "SELECT COUNT(*) FROM probes")

raex10sttranscriptcluster_dbschema()
...
raex10sttranscriptcluster.db, 2
raex10sttranscriptcluster_dbconn,

19

raex10sttranscriptclusterACCNUM, 1
raex10sttranscriptclusterALIAS2PROBE,

2

raex10sttranscriptclusterCHR, 3
raex10sttranscriptclusterCHRLENGTHS,

4

raex10sttranscriptclusterCHRLOC, 4
raex10sttranscriptclusterENSEMBL,
...
raex10sttranscriptclusterENZYME, 7
raex10sttranscriptclusterGENENAME,

9

raex10sttranscriptclusterGO, 10
raex10sttranscriptclusterMAPCOUNTS,
...
raex10sttranscriptclusterPATH, 13
raex10sttranscriptclusterPFAM, 14
raex10sttranscriptclusterPMID, 15
raex10sttranscriptclusterPROSITE,
...
raex10sttranscriptcluster

(raex10sttranscriptcluster.db),
2

raex10sttranscriptcluster.db, 2
raex10sttranscriptcluster_dbconn, 19
raex10sttranscriptcluster_dbfile
...
raex10sttranscriptclusterCHR, 3
raex10sttranscriptclusterCHRLENGTHS, 4
raex10sttranscriptclusterCHRLOC, 4
raex10sttranscriptclusterCHRLOCEND

(raex10sttranscriptclusterCHRLOC),
4

raex10sttranscriptclusterENSEMBL, 5
raex10sttranscriptclusterENSEMBL2PROBE

(raex10sttranscriptclusterENSEMBL),
5

raex10sttranscriptclusterENTREZID, 6
raex10sttranscriptclusterENZYME, 7
raex10sttranscriptclusterENZYME2PROBE

(raex10sttranscriptclusterENZYME),
7

raex10sttranscriptclusterGENENAME, 9
raex10sttranscriptclusterGO, 10
raex10sttranscriptclusterGO2ALLPROBES,
...
raex10sttranscriptclusterGO2PROBE

(raex10sttranscriptclusterGO),
10

raex10sttranscriptclusterLOCUSID

(raex10sttranscriptclusterENTREZID),
6

raex10sttranscriptclusterMAPCOUNTS, 12
raex10sttranscriptclusterORGANISM, 12
raex10sttranscriptclusterORGPKG
...
raex10sttranscriptclusterPATH, 13
raex10sttranscriptclusterPATH2PROBE
...
raex10sttranscriptclusterPFAM, 14
raex10sttranscriptclusterPMID, 15
raex10sttranscriptclusterPMID2PROBE

(raex10sttranscriptclusterPMID),
15

raex10sttranscriptclusterPROSITE, 16
raex10sttranscriptclusterREFSEQ, 16
raex10sttranscriptclusterSYMBOL, 18
raex10sttranscriptclusterUNIPROT, 19
raex10sttranscriptclusterUNIPROT2PROBE
