...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fjean-pierreBoth%2Fgraphembed%2Fblob%2Fmaster%2FREADME.md)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fblob%2Fshow&source=header-repo&source_repo=jean-pierreBoth%2Fgraphembed)
...
[History](/jean-pierreBoth/graphembed/commits/master/README.md)

History

180 lines (105 loc) · 9.22 KB
...
[Raw](https://github.com/jean-pierreBoth/graphembed/raw/refs/heads/master/README.md)
...
Embedding and link prediction evaluation for the above data sets are given in file [resultats.md](/jean-pierreBoth/graphembed/blob/master/resultats.md)
A more global analysis of the embedding with the nodesketch module is done for the orkut graph in file [orkut.md](/jean-pierreBoth/graphembed/blob/master/orkut.md)
...
* The munmun\_twitter\_social graph shows that treating a directed graph as an undirected graph give significantly different results in terms of link prediction AUC.

## Generalized Svd

An implementation of Generalized Svd comes as a by-product in module [gsvd](/jean-pierreBoth/graphembed/blob/master/src/atp/gsvd.rs).
...
* For example compilation is done by :
  *cargo build --release --features="openblas-system"* to use a dynamic link with openblas.
  The choice of one feature is mandatory to provide required line