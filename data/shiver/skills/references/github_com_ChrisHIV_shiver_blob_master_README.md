...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2FChrisHIV%2Fshiver%2Fblob%2Fmaster%2FREADME.md)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fblob%2Fshow&source=header-repo&source_repo=ChrisHIV%2Fshiver)
...
[History](/ChrisHIV/shiver/commits/master/README.md)

History

61 lines (49 loc) · 5.75 KB
...
[Raw](https://github.com/ChrisHIV/shiver/raw/refs/heads/master/README.md)
...
[![](/ChrisHIV/shiver/raw/master/docs/AssemblyPipelineDiagram_ForPaper.png)](/ChrisHIV/shiver/blob/master/docs/AssemblyPipelineDiagram_ForPaper.png)
...
If you use shiver, please cite the paper for shiver and the papers of shiver's dependencies: details [here](/ChrisHIV/shiver/blob/master/docs/CitationDetails.bib).
...
Installation instructions for all of these are [here](/ChrisHIV/shiver/blob/master/docs/InstallationNotes.sh).
...
The shiver manual is [here](/ChrisHIV/shiver/blob/master/docs/ShiverManual.pdf).

shiver is freely available under the GNU General Public License version 3, described [here](/ChrisHIV/shiver/blob/master/LICENSE).
...
NB the conda installation of shiver does not include [data/example\_input](/ChrisHIV/shiver/blob/master/data/example_input), that's only found here.
...
* change options and parameters in the [config file](/ChrisHIV/shiver/blob/master/bin/config.sh) as desired
...
* read the [manual](/ChrisHIV/shiver/blob/master/docs/ShiverManual.pdf)
