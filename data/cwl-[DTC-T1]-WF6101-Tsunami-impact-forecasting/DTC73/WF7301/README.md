# WF7301 Workflow Files

This directory contains workflow files generated from the spreadsheet description of WF7301 using a [custom tool](https://github.com/Marco-Salvi/dt-geo-converter). These files provide an initial starting point, **manual verification and updates are required** to ensure accuracy.
...
``` log
[WARNING] [Inner step ST730101 has no inputs or outputs; please verify its configuration]
[WARNING] [Inner step ST730101 has no inputs or outputs; please verify its configuration]
[WARNING] [Inner step ST730101 has no inputs or outputs; please verify its configuration]
[WARNING] [Inner step ST730101 has no inputs or outputs; please verify its configuration]
[WARNING] [Inner step ST730101 has no inputs or outputs; please verify its configuration]
...
[WARNING] [Inner step ST730101 has no inputs or outputs; please verify its configuration]
[WARNING] [Inner step ST730101 has no inputs or outputs; please verify its configuration]
[WARNING] [Step ST730109 has no inputs or outputs]
[WARNING] [Step ST730104 has no inputs or outputs]
[WARNING] [Step ST730105 has no inputs or outputs]
[WARNING] [Step ST730102 has no inputs or outputs]
[WARNING] [Step ST730106 has no inputs or outputs]
[WARNING] [Step ST730107 has no inputs or outputs]
[WARNING] [Step ST730108 has no inputs or outputs]
[WARNING] [Step ST730101 has no inputs or outputs]
[WARNING] [Step ST730103 has no inputs or outputs]
```



For complete details, please refer to the [log file](./workflows/WF7301)
