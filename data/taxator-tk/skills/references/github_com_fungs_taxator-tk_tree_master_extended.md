...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Ffungs%2Ftaxator-tk%2Ftree%2Fmaster%2Fextended)
...
[History](/fungs/taxator-tk/commits/master/extended)
...
| [bin](/fungs/taxator-tk/tree/master/extended/bin "bin") | | [bin](/fungs/taxator-tk/tree/master/extended/bin "bin") |  |  |
| [lib](/fungs/taxator-tk/tree/master/extended/lib "lib") | | [lib](/fungs/taxator-tk/tree/master/extended/lib "lib") |  |  |
| [.gitignore](/fungs/taxator-tk/blob/master/extended/.gitignore ".gitignore") | | [.gitignore](/fungs/taxator-tk/blob/master/extended/.gitignore ".gitignore") |  |  |
| [DEPENDENCIES.md](/fungs/taxator-tk/blob/master/extended/DEPENDENCIES.md "DEPENDENCIES.md") | | [DEPENDENCIES.md](/fungs/taxator-tk/blob/master/extended/DEPENDENCIES.md "DEPENDENCIES.md") |  |  |
| [README.md](/fungs/taxator-tk/blob/master/extended/README.md "README.md") | | [README.md](/fungs/taxator-tk/blob/master/extended/README.md "README.md") |  |  |
| [binning-blast-protein.bash](/fungs/taxator-tk/blob/master/extended/binning-blast-protein.bash "binning-blast-protein.bash") | | [binning-blast-protein.bash](/fungs/taxator-tk/blob/master/extended/binning-blast-protein.bash "binning-blast-protein.bash") |  |  |
| [binning-blast.bash](/fungs/taxator-tk/blob/master/extended/binning-blast.bash "binning-blast.bash") | | [binning-blast.bash](/fungs/taxator-tk/blob/master/extended/binning-blast.bash "binning-blast.bash") |  |  |
| [binning-last.bash](/fungs/taxator-tk/blob/master/extended/binning-last.bash "binning-last.bash") | | [binning-last.bash](/fungs/taxator-tk/blob/master/extended/binning-last.bash "binning-last.bash") |  |  |
| [index-blast-protein.bash](/fungs/taxator-tk/blob/master/extended/index-blast-protein.bash "index-blast-protein.bash") | | [index-blast-protein.bash](/fungs/taxator-tk/blob/master/extended/index-blast-protein.bash "index-blast-protein.bash") |  |  |
| [index-blast.bash](/fungs/taxator-tk/blob/master/extended/index-blast.bash "index-blast.bash") | | [index-blast.bash](/fungs/taxator-tk/blob/master/extended/index-blast.bash "index-blast.bash") |  |  |
| [index-last.bash](/fungs/taxator-tk/blob/master/extended/index-last.bash "index-last.bash") | | [index-last.bash](/fungs/taxator-tk/blob/master/extended/index-last.bash "index-last.bash") |  |  |
| [show-versions.bash](/fungs/taxator-tk/blob/master/extended/show-versions.bash "show-versions.bash") | | [show-versions.bash](/fungs/taxator-tk/blob/master/extended/show-versions.bash "show-versions.bash") |  |  |
| View all files | | |
