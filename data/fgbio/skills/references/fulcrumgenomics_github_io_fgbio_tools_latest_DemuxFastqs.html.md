...
* Sample\_ID: The sample identifier unique to the sample in the sample sheet.
* Sample\_Name: The sample name.
* Library\_ID: The library Identifier. The combination sample name and library identifier should be unique
...
* Sample\_Barcode: The sample barcode bases unique to each sample. The name of the column containing the sample barcode
...
| column-for-sample-barcode | c | String | The column name in the sample sheet or metadata CSV for the sample barcode. | Optional | 1 | Sample\_Barcode |
