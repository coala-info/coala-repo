...
chromFa.zip from http://hgdownload.cse.ucsc.edu/goldenPath/hg17/bigZips/
...
txdb <- makeTranscriptDbFromUCSC("hg17", "knownGene")
gn <- sort(genes(txdb))
...
BSgenome, 1
BSgenome.Hsapiens.UCSC.hg17, 1
BSgenome.Hsapiens.UCSC.hg17-package
...
Hsapiens (BSgenome.Hsapiens.UCSC.hg17),
