...
## 4.2 2. Create the `QFeatures` object
...
Coordinate\_1\_based, DataProvider, Maintainer, RDataClass,
...
2. We will contact the Bioconductor team
   (hubs@bioconductor.org) to upload
