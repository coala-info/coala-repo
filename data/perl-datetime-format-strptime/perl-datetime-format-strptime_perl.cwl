...
baseCommand: perl
label: perl-datetime-format-strptime_perl
doc: "Run a Perl script or execute Perl code.\n\nTool homepage: https://metacpan.org/dist/DateTime-Format-Strptime"
inputs:
  - id: program_file
    type:
      - 'null'
  ...
  - id: program_arguments
    type:
      ...
      - type: array
        items: string
    doc: Arguments to pass to the Perl script.
    inputBinding:
      position: 2
...
stdout: perl-datetime-format-strptime_perl.out
