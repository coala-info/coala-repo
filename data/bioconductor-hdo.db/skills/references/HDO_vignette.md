...
NY 10461, USA. Einstein Pathology Single-cell & Bioinformatics
laboratory, Bronx, NY 10461, USA. Montefiore Einstein Comprehensive
Cancer Center, Albert Einstein College of Medicine, Bronx, NY 10461,
USA.
...
information is [missing](https://github.com/YuLab-SMU/DOSE/issues/57). So we
...
The annotation data comes from <https://github.com/DiseaseOntology/HumanDiseaseOntology/tree/main/src/ontology>,
...
You can use `help` function to get their documents:
`help(DOOFFSPRING)`
...
In HDO.db, `HDOTERM` represet the whole DO terms and their
...
HDOGENE describes the association between DO ids and gene ids based
on alliancegenome. get genes of “DOID:0001816”
...
HDOGENE describes the association between gene ids and ncg ids based
on NCG. get disease of gene id 60.
...
The HDO.db support the `select()`, `keys()`,
...
Please go to <https://yulab-smu.top/biomedical-knowledge-mining-book/dose-enrichment.html>
for the vignette.
...
#> [13] Biostrings_2.72.1       htmltools_0.5.8.1       sass_0.4.9
#> [16] KEGGREST_1.44.1         rmarkdown_2.27          evaluate_0.24.0
#> [19] jquerylib_0.1.4         fastmap_1.2.0           GenomeInfoDb_1.40.1
#> [22] yaml_2.3.9              lifecycle_1.0.4         memoise_2.0.1
#> [25] compiler_4.4.1          RSQLite_2.3.7           blob_1.2.4
#> [28] pkgconfig_2.0.3         XVector_0.44.0          rstudioapi_0.16.0
#> [31] digest_0.6.36           R6_2.5.1                GenomeInfoDbData_1.2.12
#> [34] bslib_0.7.0             tools_4.4.1             bit64_4.0.5
#> [37] zlibbioc_1.50.0         cachem_1.1.0
```