...
Functions to Accompany J. Fox and S. Weisberg, 
  An R Companion to Applied Regression, Third Edition, Sage, 2019.</p>

### Metadata
- **Conda**: https://anaconda.org/channels/r/packages/r-car/overview
- **R-project (CRAN)**: https://cloud.r-project.org/web/packages/car/index.html
- **Package**: car
- **Version**: 3.1-5
...
- **Maintainer**: Brad Price <brad.price at mail.wvu.edu>
- **Skill**: generated
- **Total Downloads**: 177.2K
