...
Ordination methods, diversity analysis and other
  functions for community and vegetation ecologists.</p>

### Metadata
- **Conda**: https://anaconda.org/channels/r/packages/r-vegan/overview
- **R-project (CRAN)**: https://cloud.r-project.org/web/packages/vegan/index.html
- **Home (project)**: https://github.com/vegandevs/vegan
- **Package**: vegan
- **Version**: 2.7-2
...
- **Docker Image**: quay.io/biocontainers/r-vegan:2.4-3
- **Skill**: generated
- **Total Downloads**: 638
