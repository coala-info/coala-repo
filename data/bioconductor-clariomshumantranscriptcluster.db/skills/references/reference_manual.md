...
clariomshumantranscriptclusterACCNUM

Map Manufacturer identifiers to Accession Numbers

Description

clariomshumantranscriptclusterACCNUM is an R object that contains mappings between a manu-
...
## Bimap interface:
x <- clariomshumantranscriptclusterACCNUM
...
clariomshumantranscriptclusterALIAS2PROBE
...
clariomshumantranscriptclusterALIAS is an R object that provides mappings between common
...
xx <- as.list(clariomshumantranscriptclusterALIAS2PROBE)
if(length(xx) > 0){
...
Welcome to the clariomshumantranscriptcluster.db annotation Package. The purpose of this pack-
age is to provide detailed information about the clariomshumantranscriptcluster platform. This
...
clariomshumantranscriptclusterCHR
...
## use of select().
ls("package:clariomshumantranscriptcluster.db")
...
clariomshumantranscriptclusterCHR is an R object that provides mappings between a manufacturer
...
## Bimap interface:
x <- clariomshumantranscriptclusterCHR
...
clariomshumantranscriptclusterCHRLOC
...
clariomshumantranscriptclusterCHRLENGTHS

A named vector for the length of each of the chromosomes

Description

clariomshumantranscriptclusterCHRLENGTHS provides the length measured in base pairs for each
of the chromosomes.
...
## Bimap interface:
tt <- clariomshumantranscriptclusterCHRLENGTHS
...
clariomshumantranscriptclusterCHRLOC is an R object that maps manufacturer identifiers to the
...
clariomshumantranscriptclusterENSEMBL
...
## Bimap interface:
x <- clariomshumantranscriptclusterCHRLOC
...
clariomshumantranscriptclusterENSEMBL is an R object that contains mappings between manu-
...
clariomshumantranscriptclusterENTREZID
...
## Bimap interface:
x <- clariomshumantranscriptclusterENSEMBL
...
x <- clariomshumantranscriptclusterENSEMBL2PROBE
mapped_genes <- mappedkeys(x)
# Convert to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
clariomshumantranscriptclusterENTREZID is an R object that provides mappings between manu-
facturer identifiers and Entrez Gene identifiers.

clariomshumantranscriptclusterENZYME
...
## Bimap interface:
x <- clariomshumantranscriptclusterENTREZID
...
clariomshumantranscriptclusterENZYME is an R object that provides mappings between manufac-
turer identifiers and EC numbers. clariomshumantranscriptclusterENZYME2PROBE is an R object
...
When the clariomshumantranscriptclusterENZYME maping viewed as a list, each manufacturer
...
For the clariomshumantranscriptclusterENZYME2PROBE, each EC number maps to a named vec-
...
numbers. In clariomshumantranscriptclusterENZYME2PROBE, EC is dropped from the Enzyme
Commission numbers.
...
## Bimap interface:
x <- clariomshumantranscriptclusterENZYME
...
clariomshumantranscriptclusterGENENAME
...
# Now convert clariomshumantranscriptclusterENZYME2PROBE to a list to see inside
x <- clariomshumantranscriptclusterENZYME2PROBE
mapped_probes <- mappedkeys(x)
## convert to a list
xx <- as.list(x[mapped_probes][1:3])
if(length(xx) > 0){
...
clariomshumantranscriptclusterGENENAME is an R object that maps manufacturer identifiers to
...
## Bimap interface:
x <- clariomshumantranscriptclusterGENENAME
# Get the probe identifiers that are mapped to a gene name
mapped_probes <- mappedkeys(x)

10

clariomshumantranscriptclusterGO
...
clariomshumantranscriptclusterGO is an R object that provides mappings between manufacturer
identifiers and the GO identifiers that they are directly associated with. This mapping and its reverse
mapping (clariomshumantranscriptclusterGO2PROBE) do NOT associate the child terms from the
GO ontology with the gene. Only the directly evidenced terms are represented here.

clariomshumantranscriptclusterGO2ALLPROBES is an R object that provides mappings between
...
than clariomshumantranscriptclusterGO2PROBE.

Details

If clariomshumantranscriptclusterGO is cast as a list, each manufacturer identifier is mapped to a
...
If clariomshumantranscriptclusterGO2ALLPROBES or clariomshumantranscriptclusterGO2PROBE
...
• clariomshumantranscriptclusterGO2ALLPROBES
• AnnotationDb-class for use of the select() interface.
...
## Bimap interface:
x <- clariomshumantranscriptclusterGO
...
# For the reverse map:
x <- clariomshumantranscriptclusterGO2PROBE
mapped_genes <- mappedkeys(x)
# Convert to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
clariomshumantranscriptclusterMAP

x <- clariomshumantranscriptclusterGO2ALLPROBES
mapped_genes <- mappedkeys(x)
# Convert clariomshumantranscriptclusterGO2ALLPROBES to a list
xx <- as.list(x[mapped_genes][1:300])
if(length(xx) > 0){
...
clariomshumantranscriptclusterMAP is an R object that provides mappings between manufacturer
...
clariomshumantranscriptclusterMAPCOUNTS
...
## Bimap interface:
x <- clariomshumantranscriptclusterMAP
...
Number of mapped keys for the maps in package clariomshumantran-
scriptcluster.db
...
clariomshumantranscriptclusterMAPCOUNTS provides the "map count" (i.e. the count of mapped
keys) for each map in package clariomshumantranscriptcluster.db.
...
clariomshumantranscriptclusterOMIM
...
clariomshumantranscriptclusterOMIM is an R object that provides mappings between manufacturer
...
## Bimap interface:
x <- clariomshumantranscriptclusterOMIM
...
The Organism information for clariomshumantranscriptcluster

Description

clariomshumantranscriptclusterORGANISM is an R object that contains a single item: a character
string that names the organism for which clariomshumantranscriptcluster was built. clariomshu-
...
clariomshumantranscriptclusterPATH

15

Details

Although the package name is suggestive of the organism for which it was built, clariomshu-
mantranscriptclusterORGANISM provides a simple way to programmatically extract the organism
name. clariomshumantranscriptclusterORGPKG provides a simple way to programmatically ex-
...
## Bimap interface:
clariomshumantranscriptclusterORGANISM
clariomshumantranscriptclusterORGPKG
...
clariomshumantranscriptclusterPATH maps probe identifiers to the identifiers used by KEGG for
pathways in which the genes represented by the probe identifiers are involved

clariomshumantranscriptclusterPATH2PROBE is an R object that provides mappings between KEGG
...
clariomshumantranscriptclusterPFAM
...
## Bimap interface:
x <- clariomshumantranscriptclusterPATH
...
x <- clariomshumantranscriptclusterPATH
mapped_probes <- mappedkeys(x)
# Now convert the clariomshumantranscriptclusterPATH2PROBE object to a list
xx <- as.list(x[mapped_probes][1:300])
if(length(xx) > 0){
...
clariomshumantranscriptclusterPFAM is an R object that provides mappings between manufacturer
...
clariomshumantranscriptclusterPMID
...
clariomshumantranscriptclusterPMID is an R object that provides mappings between manufacturer
identifiers and PubMed identifiers. clariomshumantranscriptclusterPMID2PROBE is an R object
that provides mappings between PubMed identifiers and manufacturer identifiers.

Details

When clariomshumantranscriptclusterPMID is viewed as a list each manufacturer identifier is mapped
...
When clariomshumantranscriptclusterPMID2PROBE is viewed as a list each PubMed identifier is
...
## Bimap interface:
x <- clariomshumantranscriptclusterPMID
...
clariomshumantranscriptclusterREFSEQ
...
x <- clariomshumantranscriptclusterPMID2PROBE
mapped_probes <- mappedkeys(x)
# Now convert the reverse map object clariomshumantranscriptclusterPMID2PROBE to a list
xx <- as.list(x[mapped_probes][1:300])
if(length(xx) > 0){
...
clariomshumantranscriptclusterPROSITE

Maps between Manufacturer Identifiers and PROSITE Identifiers

Description

clariomshumantranscriptclusterPROSITE is an R object that provides mappings between manufac-
...
clariomshumantranscriptclusterREFSEQ is an R object that provides mappings between manufac-
...
## Bimap interface:
x <- clariomshumantranscriptclusterREFSEQ
...
clariomshumantranscriptclusterSYMBOL
...
clariomshumantranscriptclusterSYMBOL is an R object that provides mappings between manufac-
...
## Bimap interface:
x <- clariomshumantranscriptclusterSYMBOL
...
clariomshumantranscriptclusterUNIPROT
...
clariomshumantranscriptclusterUNIPROT is an R object that contains mappings between the man-
...
## Bimap interface:
x <- clariomshumantranscriptclusterUNIPROT
...
clariomshumantranscriptcluster_dbconn returns a connection object to the package annota-
tion DB. IMPORTANT: Don’t call dbDisconnect on the connection object returned by clariomshumantranscriptcluster_dbconn
or you will break all the AnnDbObj objects defined in this package!
clariomshumantranscriptcluster_dbfile returns the path (character string) to the package an-
notation DB (this is an SQLite file).
clariomshumantranscriptcluster_dbschema prints the schema definition of the package anno-
tation DB.
clariomshumantranscriptcluster_dbInfo prints other information about the package annota-
tion DB.

Value

clariomshumantranscriptcluster_dbconn: a DBIConnection object representing an open con-
nection to the package annotation DB.
clariomshumantranscriptcluster_dbfile: a character string with the path to the package an-
notation DB.
clariomshumantranscriptcluster_dbschema: none (invisible NULL).
clariomshumantranscriptcluster_dbInfo: none (invisible NULL).
...
cat, 22
checkMAPCOUNTS, 13
clariomshumantranscriptcluster
...
clariomshumantranscriptclusterCHR, 3
clariomshumantranscriptclusterCHRLENGTHS,
...
clariomshumantranscriptclusterCHRLOCEND
...
clariomshumantranscriptclusterENSEMBL2PROBE
...
clariomshumantranscriptclusterENZYME2PROBE
...
clariomshumantranscriptclusterGO, 10
clariomshumantranscriptclusterGO2ALLPROBES,
...
clariomshumantranscriptclusterGO2PROBE

(clariomshumantranscriptclusterGO),
10

clariomshumantranscriptclusterLOCUSID

(clariomshumantranscriptclusterENTREZID),
6

clariomshumantranscriptclusterMAP, 12
clariomshumantranscriptclusterMAPCOUNTS,

13

clariomshumantranscriptclusterOMIM, 13
clariomshumantranscriptclusterORGANISM,
...
clariomshumantranscriptclusterPATH, 15
clariomshumantranscriptclusterPATH2PROBE

(clariomshumantranscriptclusterPATH),
15

clariomshumantranscriptclusterPFAM, 16
clariomshumantranscriptclusterPMID, 17
clariomshumantranscriptclusterPMID2PROBE
...
clariomshumantranscriptclusterUNIPROT2PROBE
