...
baseCommand:
  - phykit
  - pairwise_identity
label: phykit_pairwise_identity
doc: Calculate the average pairwise identity among sequences. Pairwise identity 
  is defined as the number of identical columns (including gaps) between two 
  aligned sequences divided by the number of columns in the alignment.
inputs:
  - id: alignment
    type: File
    doc: alignment file
  ...
  - id: plot
    type:
      - 'null'
      - boolean
    doc: optional argument to save a clustered pairwise-identity heatmap
    inputBinding:
      position: 102
      prefix: --plot
  - id: plot_output
