...
### Tool Description
RNAprot: Protein-RNA binding site prediction
...
FATAL:   Unable to handle docker://quay.io/biocontainers/rnaprot:0.5--pyhdfd78af_1 uri: while building SIF from layers: conveyor failed to get: invalid character '}' after top-level value
```
