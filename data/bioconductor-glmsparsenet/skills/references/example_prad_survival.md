...
* [4 Fit models](#fit-models)
* [5 Results of Cross Validation](#results-of-cross-validation)
  + [5.1 Coefficients of selected model from Cross-Validation](#coefficients-of-selected-model-from-cross-validation)
  + [5.2 Survival curves and Log rank test](#survival-curves-and-log-rank-test)
