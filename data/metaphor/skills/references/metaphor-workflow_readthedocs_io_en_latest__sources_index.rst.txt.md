...
====================================
Metaphor -- Metagenomic Pipeline for Short Reads -- is a `Snakemake `\_-based workflow for
...
assembled contigs, using the `NCBI COG `\_ database.
...
.. \* :ref:`modindex`
.. \* :ref:`search`
All code is licensed under MIT for The University of Melbourne. This documentatiom is licensed as Public Domain under `CC0 `\_.