# GSC (Genotype Sparse Compression) CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://github.com/luo-xiaolong/GSC.git
- **Package**: https://workflowhub.eu/workflows/885
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/885/ro_crate?version=1
- **Source repository (git):** https://github.com/luo-xiaolong/GSC.git
- **Conda**: N/A
- **Total Downloads**: 764
- **Last updated**: 2024-05-17
- **GitHub**: https://github.com/luo-xiaolong/GSC.git
- **Stars**: N/A
- **Version**: 1
- **License**: MIT
- **Workflow type**: Common Workflow Language
- **Main workflow (WorkflowHub):** `README.md` (Main Workflow)
- **Project**: Genome Data Compression Team
- **Views**: 3162
