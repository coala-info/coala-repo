...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fzqfang%2Fhaplomap%2Ftree%2Fmaster%2Fhaplomap)
...
[History](/zqfang/haplomap/commits/master/haplomap)
...
| [include](/zqfang/haplomap/tree/master/haplomap/include "include") | | [include](/zqfang/haplomap/tree/master/haplomap/include "include") |  |  |
| [src](/zqfang/haplomap/tree/master/haplomap/src "src") | | [src](/zqfang/haplomap/tree/master/haplomap/src "src") |  |  |
| [CHANGELOG.md](/zqfang/haplomap/blob/master/haplomap/CHANGELOG.md "CHANGELOG.md") | | [CHANGELOG.md](/zqfang/haplomap/blob/master/haplomap/CHANGELOG.md "CHANGELOG.md") |  |  |
| [CMakeLists.txt](/zqfang/haplomap/blob/master/haplomap/CMakeLists.txt "CMakeLists.txt") | | [CMakeLists.txt](/zqfang/haplomap/blob/master/haplomap/CMakeLists.txt "CMakeLists.txt") |  |  |
| [README.md](/zqfang/haplomap/blob/master/haplomap/README.md "README.md") | | [README.md](/zqfang/haplomap/blob/master/haplomap/README.md "README.md") |  |  |
| [main.cpp](/zqfang/haplomap/blob/master/haplomap/main.cpp "main.cpp") | | [main.cpp](/zqfang/haplomap/blob/master/haplomap/main.cpp "main.cpp") |  |  |
| View all files | | |
...
[![Haplomap](https://github.com/zqfang/haplomap/workflows/Haplomap/badge.svg)](https://github.com/zqfang/haplomap/workflows/Haplomap/badge.svg)

[![HBCGM](/zqfang/haplomap/raw/master/docs/HBCGM.png)](/zqfang/haplomap/blob/master/docs/HBCGM.png)

## Usage

### 0. Variant calling

See [variant calling](/zqfang/haplomap/blob/master/workflows/README.md) in the workflow folder using GATK, BCFtools, svtools.
...
3. To see all supported annotation, see [constants.cpp](/zqfang/haplomap/blob/master/haplomap/src/constants.cpp)
...
* 1. generate strain level gene annotation database (only run once), see here:
     [scripts/gene\_annotation](/zqfang/haplomap/blob/master/scripts/gene_annotation/README.md)
  + this step generates 3 files for next step.
    - AA\_by\_strains\_chr\*.pkl
    - mm10\_kgXref.txt
    - mm10\_knownGene.txt
* 2. run `annotateSNPs.py` for each case (test\_strains.txt) to get strain specific SNP annotation.
...
* Gene Annotation (-g):
  + format: " <SNP\_{chr}\_{postion}> <gene\_name> < consequence> "
