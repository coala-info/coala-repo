...
* [x]
  ...
  + [ ]
    ...
    - [Benchmarking InstaNovo-P](#benchmarking-instanovo-p)
    - [InstaNovo-P performance varies with phosphorylation types](#instanovo-p-performance-varies-with-phosphorylation-types)
    - [InstaNovo-P enhances localization confidence and captures biological pathways](#instanovo-p-enhances-localization-confidence-and-captures-biological-pathways)
    - [InstaNovo-P provides value to phosphoproteomics experiments](#instanovo-p-provides-value-to-phosphoproteomics-experiments)
  + [Winnow: calibrated confidence and FDR control for de novo sequencing](../calibrated-confidence-and-fdr-control-for-de-novo-sequencing/)
* [ ]
...
*Originally published at [instanovo.ai](https://instanovo.ai/introducing-instanovo-p-a-de-novo-sequencing-model-for-phosphoproteomics/) on May 22 2025.*
