...
baseCommand: perl
label: perl-image-info_perl
doc: "The Perl 5 language interpreter\n\nTool homepage: https://metacpan.org/pod/Image::Info"
inputs:
  - id: program_file
    type:
      - 'null'
  ...
  - id: module_no
    type:
      ...
      - type: array
        items: string
    doc: execute 'use/no module...' before executing program
    inputBinding:
      position: 103
      prefix: -M
  - id: no_sitecustomize
...
hints:
  - class: DockerRequirement
    dockerPull: quay.io/biocontainers/perl-image-info:1.45--pl5321hdfd78af_0
stdout: perl-image-info_perl.out
