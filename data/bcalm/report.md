...
### Tool Description
De Bruijn graph construction tool for genomic data

### Metadata
- **Docker Image**: quay.io/biocontainers/bcalm:2.2.3--h43eeafb_6
- **Homepage**: https://github.com/GATB/bcalm
- **Package**: https://anaconda.org/channels/bioconda/packages/bcalm/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/bcalm/overview
