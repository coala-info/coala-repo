...
description: ExpansionHunter Denovo (EHdn) is a specialized toolset designed to identify large STR expansions that cannot be fully spanned by short reads (typically 100-200bp).
