# MAPseq to ampvis2 CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://training.galaxyproject.org
- **Package**: https://workflowhub.eu/workflows/1855
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1855/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 220
...
- **Main workflow (WorkflowHub):** `mapseq-to-ampvis2.ga` (Main Workflow)
