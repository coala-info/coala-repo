...
* [Augur subcommands](../cli.html)
* [augur curate](index.html)
* [View page source](../../../_sources/usage/cli/curate/apply-record-annotations.rst.txt)

---

# apply-record-annotations[](#apply-record-annotations "Link to this heading")
...
`--annotations`
:   Manually curated annotations TSV file. The TSV should not have a header and should have exactly three columns: id to match existing metadata, field name, and field value. If there are multiple annotations for the same id and field, then the last value is used. Lines starting with ‘#’ are treated as comments. Any ‘#’ after the field value are treated as comments.

`--id-field`
:   The ID field in the metadata to use to merge with the annotations.
...
[Previous](apply-geolocation-rules.html "apply-geolocation-rules")
[Next](abbreviate-authors.html "abbreviate-authors")
...
,
[![](https://raw.githubusercontent.com/nextstrain/nextstrain.org/HEAD/static-site/static/team/ivan-aksamentov.jp