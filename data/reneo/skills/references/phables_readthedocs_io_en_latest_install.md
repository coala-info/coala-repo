...
* Install
  + [Option 1: Installing Phables using conda (recommended)](#option-1-installing-phables-using-conda-recommended)
  + [Option 2: Installing Phables using pip](#option-2-installing-phables-using-pip)
  + [Setting up Gurobi](#setting-up-gurobi)
  + [Test the installation](#test-the-installation)
  + [Setup the databases](#setup-the-databases)
  + [Run on the test data](#run-on-the-test-data)
...
* RUNNING
* Install
* [Edit on GitHub](https://github.com/Vini2/phables/edit/master/docs/install.md)

---

# Setting up Phables

Phables is available on bioconda at <https://anaconda.org/bioconda/phables> and on PyPI at <https://pypi.org/project/phables/>. Feel free to pick your package manager, but we recommend that you use [`conda`](https://docs.conda.io/en/latest/).

### Option 1: Installing Phables using conda (recommended)

You can install Phables from bioconda at <https://anaconda.org/bioconda/phables>. Make sure you have [`conda`](https://docs.conda.io/en/latest/) installed.
...
You can install Phables from PyPI at <https://pypi.org/project/phables/>. Make sure you have [`pip`](https://pip.pypa.io/en/stable/) and [`mamba`](https://mamba.readthedocs.io/en/latest/index.html) installed.
...
The MFD implementation uses the linear programming solver [Gurobi](https://www.gurobi.com/). We chose Gurobi over open source solvers as Gurobi is fast and can solve large models (check the performance comparison at <https://www.gurobi.com/resources/open-source-linear-and-mixed-integer-programming-software-and-solvers/>).
