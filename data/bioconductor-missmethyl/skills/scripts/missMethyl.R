# Code example from 'missMethyl' vignette. See references/ for full tutorial.
...
## ----filter-replicate-probes_Mval, eval=FALSE---------------------------------
# ### This code is not run within this vignette
# 
...
## ----filter-replicate-probes_M, eval=FALSE------------------------------------
# ### This code is not run within this vignette
# 
# # For EPIC_V2, please run these lines to remove replicate and non-cg probes:
# # remove non-cg probes
