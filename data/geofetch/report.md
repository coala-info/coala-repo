...
- **Conda**: https://anaconda.org/channels/bioconda/packages/geofetch/overview
- **Total Downloads**: 37.9K
- **Last updated**: 2026-01-24
- **GitHub**: https://github.com/pepkit/geofetch
- **Stars**: N/A
### Original Help Text
```text
version: 0.12.10
...
options:
  ...
  -i, --input INPUT     required: a GEO (GSE) accession, or a file with a list
                        of GSE numbers
  -n, --name NAME       Specify a project name. Defaults to GSE number
  -m, --metadata-root METADATA_ROOT
                        Specify a parent folder location to store metadata.
                        The project name will be added as a subfolder
                        [Default: $SRAMETA:]
  -u, --metadata-folder METADATA_FOLDER
  ...
  -k, --skip SKIP       Skip some accessions. [Default: no skip].
