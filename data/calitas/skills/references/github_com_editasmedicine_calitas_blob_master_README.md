...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Feditasmedicine%2Fcalitas%2Fblob%2Fmaster%2FREADME.md)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fblob%2Fshow&source=header-repo&source_repo=editasmedicine%2Fcalitas)
...
[History](/editasmedicine/calitas/commits/master/README.md)

History

141 lines (104 loc) · 8.63 KB
...
[Raw](https://github.com/editasmedicine/calitas/raw/refs/heads/master/README.md)
...
Binary releases of CALITAS are available from the [releases](/editasmedicine/calitas/blob/master/releases) page on GitHub. The downloadable JAR files contain CALITAS and all dependencies, and need only a [Java RunTime version 8 or higher](https://openjdk.java.net/install/) installed. Once downloaded CALITAS can be run as follows to produce usage information:
...
| `padded_target` | Target sequence, including PAM, with padding for mismatches and bulges