...
[Skip to content](#pip-simple-install)
...
* [ ]
  ...
  Table of contents
  + [pip (simple install)](#pip-simple-install)
  + [Bioconda (recommended)](#bioconda-recommended)
  + [Custom](#custom)

    - [tbtAMR + annotation](#tbtamr-annotation)
    - [tbtamr + lineage calling](#tbtamr-lineage-calling)
* [Usage](../usage/)
