...
# Marker-based classification features[#](#marker-based-classification-features "Permalink to this heading")
...
## geNomad’s marker dataset[#](#genomad-s-marker-dataset "Permalink to this heading")
...
![_images/ternary.png](_images/ternary.png)
...
## Classification features[#](#classification-features "Permalink to this heading")
...
Some notes on the classification features
...
* Marker-based classification features
  + [geNomad’s marker dataset](#genomad-s-marker-dataset)
