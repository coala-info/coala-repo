# Code example from 'differential' vignette. See references/ for full tutorial.
...
## ----plotPbExprs-custom, fig.width = 8, fig.height = 2------------------------
