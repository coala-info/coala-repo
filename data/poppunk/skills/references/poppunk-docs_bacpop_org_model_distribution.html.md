...
[View this page](_sources/model_distribution.rst.txt "View this page")
...
fitted model to our other [databases](https://poppunk.net/pages/databases.html).

## Database contents[¶](#database-contents "Link to this heading")
...
If you used a [lineage](model_fitting.html#lineage-fit) you will also need:
...
script after model fitting. See the [Scripts](scripts.html) page for more information.

## Picking references[¶](#picking-references "Link to this heading")
...
7. For any samples which are no longer in the same connected component, find a minimum path
...
31 strains are represented by \(128 - 97 = 31\) references, exactly one reference
...
* Distributing PopPUNK models
  ...
  + [Picking references](#picking-references)