...
Download current source releases:
 ...
 [samtools-1.23.1](https://github.com/samtools/samtools/releases/download/1.23.1/samtools-1.23.1.tar.bz2)

 [bcftools-1.23.1](https://github.com/samtools/bcftools/releases/download/1.23.1/bcftools-1.23.1.tar.bz2)

 [htslib-1.23.1](https://github.com/samtools/htslib/releases/download/1.23.1/htslib-1.23.1.tar.bz2)
...
New releases are announced on the [samtools mailing lists](../support#mailing-lists) and by [@htslib](https://twitter.com/htslib)
on Twitter.
