...
doc: |
    ...
    Direct install (https://github.com/nanoporetech/medaka):
    Use the Conda environment to prevent dependencies issues (bcftools, bgzip, minimap2, samtools, tabix).
    Install Anaconda if failling this.
