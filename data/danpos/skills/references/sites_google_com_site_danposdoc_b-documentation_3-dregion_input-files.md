...
NOTE: when input data is in .wig format, DANPOS will not do reads shifting, fragment extending, and occupancy calculation, because it suppose the data is already protein occupancy calculated from raw reads, but DANPOS may do normalization and smoothing before defining protein binding regions.
