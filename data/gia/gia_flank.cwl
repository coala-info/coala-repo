...
baseCommand:
  ...
  - flank
label: gia_flank
doc: "Flanks the intervals of a BED file\n\nThis will crefate two new flanking intervals
  for each interval in the input file, one on the left and one on the right side.\n\
...
inputs:
  ...
  - id: stranded
    ...
    doc: "Follow strand specificity when applying growth\n          \n          i.e.
      if the strand is negative, apply growth to the right side of the interval when
      the left side is requested (and vice versa)"
    inputBinding:
      position: 101
      prefix: --stranded
outputs:
