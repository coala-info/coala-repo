...
### Tool Description
Generate an anvi'o contigs database from a FASTA file. This tool parses a FASTA file and creates a database that stores essential information about your contigs, such as k-mer frequencies and functional/taxonomic annotations.
...
INFO:    Fetching OCI image...
INFO:    Extracting OCI image...
FATAL:   Unable to handle docker://quay.io/biocontainers/anvio-minimal:9--pyhdfd78af_0 uri: while building SIF from layers: packer failed to pack: while unpacking rootfs: while unpacking layer sha256:53882c191fa6790c0131c6e3b1598df44efa6e873bcda8a4895baec6a0076f9d: unpack entry: usr/local/lib/libLLVM.so.20.1: unpack to regular file: short write: write /tmp/build-temp-4111012223/rootfs/usr/local/lib/libLLVM.so.20.1: no space left on device
```
