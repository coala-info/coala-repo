...
label: liftofftools_liftoff
doc: "liftofftools: error: argument subcommand: invalid choice: 'liftoff' (choose
  from 'clusters', 'variants', 'synteny', 'all')\n\nTool homepage: https://github.com/agshumate/LiftoffTools"
inputs:
  - id: subcommand
    type: string
  ...
  - id: target_annotation
    type: string
    doc: Target annotation (GFF/GTF or DB)
    inputBinding:
      position: 102
      prefix: -t
  - id: target_genome
...
stdout: liftofftools_liftoff.out
