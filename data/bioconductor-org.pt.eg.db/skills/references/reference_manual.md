...
org.Pt.egACCNUM is an R object that contains mappings between Entrez Gene identifiers and
...
org.Pt.egALIAS is an R object that provides mappings between common gene symbol identifiers
...
Welcome to the org.Pt.eg.db annotation Package. This is an organism specific package. The purpose
is to provide detailed information about the species abbreviated in the second part of the package
name org.Pt.eg.db. This package is updated biannually.
...
org.Pt.egCHR is an R object that provides mappings between entrez gene identifiers and the chro-
...
org.Pt.egCHRLENGTHS provides the length measured in base pairs for each of the chromosomes.
...
org.Pt.egCHRLOC is an R object that maps entrez gene identifiers to the starting position of the
...
Mappings were based on data provided by: UCSC Genome Bioinformatics (Pan troglodytes) ftp://hgdownload.cse.ucsc.edu/goldenPath/panTro6/database
...
org.Pt.egENSEMBL is an R object that contains mappings between Entrez Gene identifiers and
...
# Convert to a list
xx <- as.list(org.Pt.egENSEMBL2EG)
if(length(xx) > 0){
...
org.Pt.egENSEMBLPROT Map Ensembl protein acession numbers with Entrez Gene identifiers
...
# Convert to a list
xx <- as.list(org.Pt.egENSEMBLPROT2EG)
if(length(xx) > 0){
...
org.Pt.egENSEMBLTRANS

org.Pt.egENSEMBLTRANS Map Ensembl transcript acession numbers with Entrez Gene identi-
...
# Convert to a list
xx <- as.list(org.Pt.egENSEMBLTRANS2EG)
if(length(xx) > 0){
...
org.Pt.egENZYME is an R object that provides mappings between entrez gene identifiers and EC
numbers.
...
numbers. In org.Pt.egENZYME2EG, EC is dropped from the Enzyme Commission numbers.
...
org.Pt.egGENENAME is an R object that maps entrez gene identifiers to the corresponding gene
name.
...
org.Pt.egGO is an R object that provides mappings between entrez gene identifiers and the GO
...
org.Pt.egGO2ALLEGS is an R object that provides mappings between a given GO identifier and all
of the Entrez Gene identifiers annotated at that GO term OR TO ONE OF IT’S CHILD NODES in
the GO ontology. Thus, this mapping is much larger and more inclusive than org.Pt.egGO2EG.

Details

If org.Pt.egGO is cast as a list, each Entrez Gene identifier is mapped to a list of lists. The names on
...
If org.Pt.egGO2ALLEGS or org.Pt.egGO2EG is cast as a list, each GO term maps to a named vector
of entrez gene identifiers and evidence codes. A GO identifier may be mapped to the same entrez
gene identifier more than once but the evidence code can be different. Mappings between Gene
Ontology identifiers and Gene Ontology terms and other information are available in a separate
...
# For org.Pt.egGO2ALLEGS
xx <- as.list(org.Pt.egGO2ALLEGS)
if(length(xx) > 0){
...
Number of mapped keys for the maps in package org.Pt.eg.db

Description

org.Pt.egMAPCOUNTS provides the "map count" (i.e. the count of mapped keys) for each map in
package org.Pt.eg.db.
...
## Bimap interface:
org.Pt.egMAPCOUNTS
mapnames <- names(org.Pt.egMAPCOUNTS)
org.Pt.egMAPCOUNTS[mapnames[1]]
x <- get(mapnames[1])
sum(!is.na(as.list(x)))
count.mappedkeys(x)
...
## Check the "map count" of all the maps in package org.Pt.eg.db
checkMAPCOUNTS("org.Pt.eg.db")

org.Pt.egORGANISM

The Organism for org.Pt.eg

Description

org.Pt.egORGANISM is an R object that contains a single item: a character string that names the
organism for which org.Pt.eg was built.

Details

Although the package name is suggestive of the organism for which it was built, org.Pt.egORGANISM
...
isms. org.Pt.egPATH maps entrez gene identifiers to the identifiers used by KEGG for pathways
...
org.Pt.egPMID is an R object that provides mappings between entrez gene identifiers and PubMed
identifiers.
...
org.Pt.egREFSEQ is an R object that provides mappings between entrez gene identifiers and RefSeq
identifiers.
...
org.Pt.egSYMBOL is an R object that provides mappings between entrez gene identifiers and gene
abbreviations.
...
org.Pt.egUNIPROT is an R object that contains mappings between Entrez Gene identifiers and
...
org.Pt.eg_dbconn()
org.Pt.eg_dbfile()
org.Pt.eg_dbschema(file="", show.indices=FALSE)
org.Pt.eg_dbInfo()
...
org.Pt.eg_dbconn returns a connection object to the package annotation DB. IMPORTANT: Don’t
call dbDisconnect on the connection object returned by org.Pt.eg_dbconn or you will break all
the AnnDbObj objects defined in this package!
org.Pt.eg_dbfile returns the path (character string) to the package annotation DB (this is an
SQLite file).
org.Pt.eg_dbschema prints the schema definition of the package annotation DB.
org.Pt.eg_dbInfo prints other information about the package annotation DB.

Value

org.Pt.eg_dbconn: a DBIConnection object representing an open connection to the package an-
notation DB.
org.Pt.eg_dbfile: a character string with the path to the package annotation DB.
org.Pt.eg_dbschema: none (invisible NULL).
org.Pt.eg_dbInfo: none (invisible NULL).
...
dbGetQuery(org.Pt.eg_dbconn(), "SELECT COUNT(*) FROM genes")
...
org.Pt.egALIAS2EG, 2
org.Pt.egCHR, 3
org.Pt.egCHRLENGTHS, 4
org.Pt.egCHRLOC, 5
org.Pt.egENSEMBL, 6
org.Pt.egENSEMBLPROT, 7
org.Pt.egENSEMBLTRANS, 8
org.Pt.egENZYME, 9
org.Pt.egGENENAME, 10
org.Pt.egGO, 11
org.Pt.egMAPCOUNTS, 13
org.Pt.egORGANISM, 14
org.Pt.egPATH, 15
org.Pt.egPMID, 16
org.Pt.egREFSEQ, 17
org.Pt.egSYMBOL, 18
...
org.Pt.eg (org.Pt.eg.db), 3
org.Pt.eg.db, 3
org.Pt.eg_dbconn, 20
org.Pt.eg_dbfile (org.Pt.eg_dbconn), 20
org.Pt.eg_dbInfo (org.Pt.eg_dbconn), 20

22

org.Pt.eg_dbschema (org.Pt.eg_dbconn),

20
org.Pt.egACCNUM, 1
org.Pt.egACCNUM2EG (org.Pt.egACCNUM), 1
org.Pt.egALIAS2EG, 2
org.Pt.egCHR, 3
org.Pt.egCHRLENGTHS, 4
org.Pt.egCHRLOC, 5
org.Pt.egCHRLOCEND (org.Pt.egCHRLOC), 5
org.Pt.egENSEMBL, 6
org.Pt.egENSEMBL2EG (org.Pt.egENSEMBL),

6

org.Pt.egENSEMBLPROT, 7
org.Pt.egENSEMBLPROT2EG

(org.Pt.egENSEMBLPROT), 7

org.Pt.egENSEMBLTRANS, 8
org.Pt.egENSEMBLTRANS2EG

(org.Pt.egENSEMBLTRANS), 8

org.Pt.egENZYME, 9
org.Pt.egENZYME2EG (org.Pt.egENZYME), 9
org.Pt.egGENENAME, 10
org.Pt.egGO, 11
org.Pt.egGO2ALLEGS, 12
org.Pt.egGO2ALLEGS (org.Pt.egGO), 11
org.Pt.egGO2EG (org.Pt.egGO), 11
org.Pt.egMAPCOUNTS, 13
org.Pt.egORGANISM, 14
org.Pt.egPATH, 15
org.Pt.egPATH2EG (org.Pt.egPATH), 15
org.Pt.egPMID, 16
org.Pt.egPMID2EG (org.Pt.egPMID), 16
org.Pt.egREFSEQ, 17
org.Pt.egREFSEQ2EG (org.Pt.egREFSEQ), 17
org.Pt.egSYMBOL, 18
org.Pt.egSYMBOL2EG (org.Pt.egSYMBOL), 18
org.Pt.egUNIPROT, 19
