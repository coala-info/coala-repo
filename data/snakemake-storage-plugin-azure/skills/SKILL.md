...
description: The `snakemake-storage-plugin-azure` is a specialized extension for Snakemake that allows the workflow management system to treat Azure Blob Storage as a native file system.
