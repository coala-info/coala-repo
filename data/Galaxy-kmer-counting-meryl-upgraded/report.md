# kmer counting - meryl - upgraded CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://training.galaxyproject.org
- **Package**: https://workflowhub.eu/workflows/1608
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1608/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 256
...
- **Main workflow (WorkflowHub):** `galaxy-workflow-kmer-counting.ga` (Main Workflow)
