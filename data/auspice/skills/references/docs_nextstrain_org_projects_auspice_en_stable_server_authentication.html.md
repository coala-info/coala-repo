...
* [Auspice](../index.html)
* [View page source](../_sources/server/authentication.rst.txt)
...
## Using the Server to Verify Cookies[](#using-the-server-to-verify-cookies "Link to this heading")

![auth-cartoon](../_images/authentication.svg)

auth-cartoon[](#id1 "Link to this image")
...
[Previous](api.html "Server API")
[Next](../releases/index.html "Releases")
