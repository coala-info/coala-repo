...
inputs:
  ...
  - id: gene_where
    type:
      - 'null'
      - string
    doc: SQL clause to limit variants to genes. a reasonable alternative could 
      be "gene != ''"
    inputBinding:
      position: 102
      prefix: --gene-where
  ...
  - id: pattern_only
    type:
      - 'null'
      - boolean
    doc: find compound hets by inheritance pattern, without regard to affection
    inputBinding:
      position: 102
      prefix: --pattern-only
outputs:
