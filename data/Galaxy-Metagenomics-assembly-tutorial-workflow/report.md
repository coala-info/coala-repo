# Metagenomics assembly tutorial workflow CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://training.galaxyproject.org
- **Package**: https://workflowhub.eu/workflows/1634
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1634/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 278
...
- **Main workflow (WorkflowHub):** `metagenomics-assembly-tutorial-workflow.ga` (Main Workflow)
