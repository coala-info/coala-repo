...
baseCommand:
  ...
  - Pileup
label: gatk_Pileup
doc: Prints read alignments in samtools pileup format. The output comprises one 
  line per genomic position, listing the chromosome name, coordinate, reference 
  base, read bases, and read qualities.
inputs:
  - id: input
    type:
      type: array
  ...
  - id: output
    type: string
    doc: An output file created to be created by the walker.
    inputBinding:
      position: 101
      prefix: --output
