...
### Metadata
- **Docker Image**: quay.io/biocontainers/aragorn:1.2.41--h7b50bb2_5
- **Homepage**: http://www.ansikte.se/ARAGORN/
- **Package**: https://anaconda.org/channels/bioconda/packages/aragorn/overview
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/aragorn/overview
