...
Fast aggregation of large data (e.g. 100GB in RAM), fast ordered joins, fast add/modify/delete of columns by group using no copies at all, list columns, friendly and fast character-separated-value read/write. Offers a natural and flexible syntax, for faster development.</p>

### Metadata
- **Conda**: https://anaconda.org/channels/r/packages/r-data.table/overview
- **R-project (CRAN)**: https://cloud.r-project.org/web/packages/data.table/index.html
- **Home (project)**: https://r-datatable.com, https://Rdatatable.gitlab.io/data.table, https://github.com/Rdatatable/data.table
- **Package**: data.table
- **Version**: 1.18.2.1
