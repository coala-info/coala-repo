...
* Making Custom Databases
* [Edit on cmmr/EsViritu](https://github.com/cmmr/EsViritu/blob/main/docs/custom-database.md)
...
2. `virus_pathogen_database.fna`
3. a minimap2 index (.mmi) with short-read settings.
4. `virus_pathogen_database.mmi`
5. via: `minimap2 -x sr -d virus_pathogen_database.mmi virus_pathogen_database.fna`
6. A metadata TSV produced by `esv_create_taxonomy` (and optionally combined with `esv_combine_tax`).
7. `virus_pathogen_database.all_metadata.tsv`
...
[Previous](../interpretting-outputs/ "Interpretting Outputs")
[Next](../notable-changes/ "Notable Changes in v1")
