...
label: snakemake-minimal_7.25.0-pyhdfd78af_0-test_dot
doc: "Snakemake is a workflow management system that aims to reduce the complexity
  of creating workflows by providing a fast and flexible Python-based workflow description
...
stdout: snakemake-minimal_7.25.0-pyhdfd78af_0-test_dot.out
