# Galaxy ABC MD Setup tutorial CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://mmb.irbbarcelona.org/biobb/
- **Package**: https://workflowhub.eu/workflows/299
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/299/ro_crate?version=3
- **Conda**: N/A
...
- **Main workflow (WorkflowHub):** `biobb_wf_amber_abc_md_setup.ga` (Main Workflow)
...
- **Discussion / source**: https://biobb.usegalaxy.es/u/gbayarri/w/abcix-md-setup
- **Discussion / source**: https://biobb-wf-amber-md-setup.readthedocs.io/en/latest/abcsetup_tutorial.html
