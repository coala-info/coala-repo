...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fohlab%2FSMEG%2Fblob%2Fmaster%2Fcreate_clusters.R)
...
[History](/ohlab/SMEG/commits/master/create_clusters.R)
...
[Raw](https://github.com/ohlab/SMEG/raw/refs/heads/master/create_clusters.R)
...
clus\_num <- paste("^",r,"$",sep = '')

otherClusters <- out[- grep(clus\_num, out$clusters),]

otherClusters2 <- as.character(out[- grep(clus\_num, out$clusters),1])
