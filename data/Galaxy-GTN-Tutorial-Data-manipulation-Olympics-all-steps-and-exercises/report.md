# GTN Tutorial: Data manipulation Olympics - all steps and exercises CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://training.galaxyproject.org
- **Package**: https://workflowhub.eu/workflows/1601
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1601/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 269
...
- **Main workflow (WorkflowHub):** `data-manipulation-olympics-with-exercises.ga` (Main Workflow)
