...
inputs:
  ...
  - id: custom
    type:
      - 'null'
      - File
    doc: Association custom parameter file
    inputBinding:
      position: 101
      prefix: --custom
  - id: data_file
  ...
  - id: max_step
    type:
      - 'null'
      - int
    doc: Positions maxStep calculation
    inputBinding:
      position: 101
      prefix: --maxStep
  - id: megabytes
  ...
  - id: min_step
    type:
      - 'null'
      - int
    doc: Positions minStep calculation
    inputBinding:
      position: 101
      prefix: --minStep
  - id: minutes
  ...
  - id: model
    type:
      - 'null'
      - File
    doc: General model parameter file
    inputBinding:
      position: 101
      prefix: --model
  - id: no_couple_bits
  ...
  - id: start
    type:
      - 'null'
      - int
    doc: Positions start calculation
    inputBinding:
      position: 101
      prefix: --start
  - id: steps
  ...
  - id: stop
    type:
      - 'null'
      - int
    doc: Positions stop calculation
    inputBinding:
      position: 101
      prefix: --stop
  - id: swap
