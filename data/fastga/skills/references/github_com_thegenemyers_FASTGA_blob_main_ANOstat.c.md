...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fthegenemyers%2FFASTGA%2Fblob%2Fmain%2FANOstat.c)
...
[History](/thegenemyers/FASTGA/commits/main/ANOstat.c)

History

476 lines (420 loc) · 12.1 KB
...
[Raw](https://github.com/thegenemyers/FASTGA/raw/refs/heads/main/ANOstat.c)
...
static int nice\_round(int num, int nbins, int \*mod)
...
{ Print\_Number(totreg/1000000,0,stdout);
...
{ Print\_Number(totreg/1000,0,stdout);
...
Print\_Number(totreg,0,stdout);

printf("bp and cover ");

if (totcov >= 1000000)

{ Print\_Number(totcov/1000000,0,stdout);
...
{ Print\_Number(totcov/1000,0,stdout);
