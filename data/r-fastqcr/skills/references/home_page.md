...
* QC Reports
  + [Multi-QC Reports](qc-reports/fastqcr-multi-qc-report.html)
  + [One-Sample Report (+Interpretation)](qc-reports/sample-qc-report-interpretation.html)
  + [One-Sample Report (no interpretation)](qc-reports/sample-qc-report-without-interpretation.html)
...
* fastqcr can be installed from [CRAN](https://cran.r-project.org/package%3Dfastqcr) as follow:
...
An example of report is available at: <a href= “<https://rpkgs.datanovia.com/fastqcr/qc-reports/fastqcr-multi-qc-report.html>”, target = “\_blank”> fastqcr multi-qc report
...
An example of report is available at: <a href= “<https://rpkgs.datanovia.com/fastqcr/qc-reports/sample-qc-report-interpretation.html>”, target = “\_blank”> One sample QC report with interpretation
...
An example of report is available at: <a href= “<https://rpkgs.datanovia.com/fastqcr/qc-reports/sample-qc-report-without-interpretation.html>”, target = “\_blank”> One sample QC report without interpretation
...
* [View on CRAN](https://cloud.r-project.org/package%3Dfastqcr)
* [Browse source code](https://github.com/kassambara/fastqcr/)
* [Report a bug](https://github.com/kassambara/fastqcr/issues)
...
* [Citing fastqcr](authors.html#citation)
...
* [![CRAN_Status_Badge](https://www.r-pkg.org/badges/version/fastqcr)](https://cran.r-project.org/package%3Dfastqcr)
* [![Downloads](https://cranlogs.r-pkg.org/badges/fastqcr)](https://cran.r-project.org/package%3Dfastqcr)
