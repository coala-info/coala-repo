# MGnify's amplicon pipeline v5.0 - Quality control PE CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://training.galaxyproject.org
- **Package**: https://workflowhub.eu/workflows/1854
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1854/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 243
...
- **Main workflow (WorkflowHub):** `mgnify-amplicon-pipeline-v5-quality-control-paired-end.ga` (Main Workflow)
