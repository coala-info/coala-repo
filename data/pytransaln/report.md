...
### Tool Description
Translation-guided alignment of protein-coding DNA sequences
...
FATAL:   Unable to handle docker://quay.io/biocontainers/pytransaln:0.2.2--pyh7e72e81_0 uri: while building SIF from layers: conveyor failed to get: invalid character '}' after top-level value
```
