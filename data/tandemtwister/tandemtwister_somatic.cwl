...
baseCommand:
  - tandemtwister
  - somatic
label: tandemtwister_somatic
doc: "Somatic expansion profiling using long-read alignments.\n\nTool homepage: https://github.com/Lionward/tandemtwister"
inputs:
  - id: bamIsTagged
    type:
      - 'null'
  ...
  - id: tandem_run_threshold
    type:
      - 'null'
      - string
    doc: 'Maximum bases for merging tandem-repeat runs (default: 2 × motif size)'
    inputBinding:
      position: 101
