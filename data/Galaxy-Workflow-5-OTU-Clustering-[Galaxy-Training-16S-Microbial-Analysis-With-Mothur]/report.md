# Workflow 5: OTU Clustering [Galaxy Training: 16S Microbial Analysis With Mothur] CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://training.galaxyproject.org
- **Package**: https://workflowhub.eu/workflows/1404
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1404/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 259
...
- **Main workflow (WorkflowHub):** `workflow5-otu-clustering.ga` (Main Workflow)
