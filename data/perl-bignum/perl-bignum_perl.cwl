...
baseCommand: perl
label: perl-bignum_perl
doc: "The Perl 5 language interpreter\n\nTool homepage: http://metacpan.org/pod/bignum"
inputs:
  - id: program_file
    type:
      - 'null'
...
hints:
  - class: DockerRequirement
    dockerPull: quay.io/biocontainers/perl-bignum:0.67--pl5321hdfd78af_0
stdout: perl-bignum_perl.out
