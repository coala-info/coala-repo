# [DTC-T1] WF6101: Tsunami impact forecasting CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://dtgeo.eu/
- **Package**: https://workflowhub.eu/workflows/1231
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1231/ro_crate?version=3
- **Conda**: N/A
...
- **Main workflow (WorkflowHub):** `DTC61/WF6101/WF6101.cwl` (Main Workflow)
- **Project**: WP6 - Tsunamis
- **Views**: 2755
