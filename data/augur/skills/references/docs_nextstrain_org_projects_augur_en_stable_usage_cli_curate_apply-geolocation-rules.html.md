...
* [Augur subcommands](../cli.html)
* [augur curate](index.html)
* [View page source](../../../_sources/usage/cli/curate/apply-geolocation-rules.rst.txt)

---

# apply-geolocation-rules[](#apply-geolocation-rules "Link to this heading")
