...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fsnake-flu%2Fclusterfunk%2Fblob%2Fmaster%2FREADME.md)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fblob%2Fshow&source=header-repo&source_repo=snake-flu%2Fclusterfunk)
...
[History](/snake-flu/clusterfunk/commits/master/README.md)
...
[Raw](https://github.com/snake-flu/clusterfunk/raw/refs/heads/master/README.md)
...
Annotate the tips of a tree using fields from a CSV file. It will use 'sequence\_name' column in the CSV to match the tips of the tree and then add the data from the columns specified by `--trait-columns` to each tip using the NEXUS metacomment format.
