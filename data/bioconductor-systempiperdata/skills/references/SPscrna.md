...
![Toplogy graph of scRNA-Seq workflow.](data:image/jpeg;base64...)
...
As shown on the figure above, A is the ratio of percent mt *vs.* N count. Normally, no matter
...
B is N genes per cell *vs.* N counts per cell. Normally, if as the N counts increases,
...
## 3.8 Find highly variable genes
...
## 3.14 Visualize clusters with UMAP/tSNE
