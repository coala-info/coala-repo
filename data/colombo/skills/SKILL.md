---
name: colombo
description: COLOMBO is a specialized bioinformatics framework designed to detect genomic islands—regions of a genome acquired via horizontal gene transfer.
