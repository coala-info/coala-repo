---
name: hsdecipher
description: HSDecipher is a specialized bioinformatics pipeline designed for the downstream analysis of gene duplicates that exhibit high sequence similarity.
