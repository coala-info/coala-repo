...
* Visualization
  + [Freeview (volumes and surfaces)](#freeview-volumes-and-surfaces)
    - [The example below will act as a guide to avoid common mistakes:](#the-example-below-will-act-as-a-guide-to-avoid-common-mistakes)
    - [Other visualization tips and tricks:](#other-visualization-tips-and-tricks)
  + [HippUnfold Toolbox](#hippunfold-toolbox)
  + [ITK-SNAP (volumes)](#itk-snap-volumes)
  + [Connectome Workbench (surfaces)](#connectome-workbench-surfaces)
...
* Visualization
* [View page source](../_sources/outputs/visualization.md.txt)

---

# Visualization[](#visualization "Permalink to this heading")

## Freeview (volumes and surfaces)[](#freeview-volumes-and-surfaces "Permalink to this heading")
...
### The example below will act as a guide to avoid common mistakes:[](#the-example-below-will-act-as-a-guide-to-avoid-common-mistakes "Permalink to this heading")
...
### Other visualization tips and tricks:[](#other-visualization-tips-and-tricks "Permalink to this heading")
...
## HippUnfold Toolbox[](#hippunfold-toolbox "Permalink to this heading")
...
## ITK-SNAP (volumes)[](#itk-snap-volumes "Permalink to this heading")
...
## Connectome Workbench (surfaces)[](#connectome-workbench-surfaces "Permalink to this heading")
...
[Previous](output_files.html "Output Files")
[Next](QC.html "Quality Control")
