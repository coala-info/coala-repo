# The first sourmash tutorial - making signatures, comparing, and searching[¶](#the-first-sourmash-tutorial-making-signatures-comparing-and-searching "Link to this heading")
...
You’ll need to [install sourmash](tutorial-install.html) first!

## Generate a signature for Illumina reads[¶](#generate-a-signature-for-illumina-reads "Link to this heading")
...
## Compare reads to assemblies[¶](#compare-reads-to-assemblies "Link to this heading")
...
## Make and search a database quickly.[¶](#make-and-search-a-database-quickly "Link to this heading")
...
## Compare many signatures and build a tree.[¶](#compare-many-signatures-and-build-a-tree "Link to this heading")
...
## What’s in my metagenome?[¶](#what-s-in-my-metagenome "Link to this heading")
...
from the
[Shakya et al. 2013 mock metagenome paper.](https://pubmed.ncbi.nlm.nih.gov/23387867/)
...
and `gather`; see `sourmash index`, above, [the LCA tutorial](tutorials-lca.html), or
[our notebook on working with private collections of signatures](sourmash-collections.html).
...
* [Show Source](_sources/tutorial-basic.md.txt)
...
|
[Page source](_sources/tutorial-basic.md.txt)