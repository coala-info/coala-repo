# ProteinID SG PS Tutorial WF datasetCollection CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://training.galaxyproject.org
- **Package**: https://workflowhub.eu/workflows/1399
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1399/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 263
...
- **Main workflow (WorkflowHub):** `wf-proteinid-sg-ps-multiplefiles.ga` (Main Workflow)
