...
## 2.2 Calling the function for automatic quality control
...
# 4 Case study: B cells from elderly individuals
...
## 4.1 File description and quality control summary
...
## 4.2 Comparison of the number of events among the FCS files of the dataset
