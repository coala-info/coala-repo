...
inputs:
  - id: cols
    type:
      - 'null'
      - boolean
    doc: only print number of columns (or using "csvtk ncol"
    inputBinding:
      position: 101
      prefix: --cols
  - id: comment_char
  ...
  - id: no_files
    type:
      - 'null'
      - boolean
    doc: do not print file names (only affect --cols and --rows)
    inputBinding:
      position: 101
      prefix: --no-files
  - id: no_header_row
  ...
  - id: rows
    type:
      - 'null'
      - boolean
    doc: only print number of rows (or using "csvtk nrow")
    inputBinding:
      position: 101
      prefix: --rows
  - id: show_row_number
