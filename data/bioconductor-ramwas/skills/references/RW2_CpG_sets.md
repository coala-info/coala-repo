...
* [1 CpG sets](#cpg-sets)
* [2 Downloadable CpG sets](#downloadable-cpg-sets)
* [3 Constructing a custom CpG set](#constructing-a-custom-cpg-set)
  + [3.1 Constructing a CpG set for a reference genome](#constructing-a-cpg-set-for-a-reference-genome)
  + [3.2 *In silico* alignment experiment](#in-silico-alignment-experiment)
...
## 3.2 *In silico* alignment experiment
