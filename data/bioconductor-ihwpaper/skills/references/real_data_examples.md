...
* [0.1 Panel b)](#panel-b)
* [1 Proteomics Example](#proteomics-example)
  + [1.1 panel c)](#panel-c)
  + [1.2 Panel d)](#panel-d)
* [2 hQTL Example](#hqtl-example)
  + [2.1 Load in data](#load-in-data)
  + [2.2 Panel e)](#panel-e)
  + [2.3 Panel f)](#panel-f)
* [3 Put all panels together for main fig!](#put-all-panels-together-for-main-fig)
* [4 Put all panels together for suppl fig.](#put-all-panels-together-for-suppl-fig.)
...
# 3 Put all panels together for main fig!
...
# 4 Put all panels together for suppl fig.
