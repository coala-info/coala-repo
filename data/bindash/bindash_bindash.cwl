...
baseCommand: bindash
label: bindash_bindash
doc: "B-bit One-Permutation Rolling MinHash with Optimal/Faster Densification for
  Genome Search and Comparisons. Or Binwise Densified MinHash.\n\nTool homepage: https://github.com/zhaoxiaofei/bindash"
inputs:
  - id: command
    type: string
