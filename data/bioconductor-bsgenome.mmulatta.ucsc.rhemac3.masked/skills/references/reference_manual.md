...
and stored in Biostrings objects. The sequences are the same as in BSgenome.Mmulatta.UCSC.rheMac3,
...
AGAPS masks: gap.txt.gz from http://hgdownload.soe.ucsc.edu/goldenPath/rheMac2/database/
RM and TRF masks: rheMac3.fa.out.gz and rheMac3.trf.bed.gz
from http://hgdownload.soe.ucsc.edu/goldenPath/rheMac3/bigZips/

See ?BSgenome.Mmulatta.UCSC.rheMac3 in the BSgenome.Mmulatta.UCSC.rheMac3 package
...
• BSgenome.Mmulatta.UCSC.rheMac3 in the BSgenome.Mmulatta.UCSC.rheMac3 package
...
BSgenome, 2
BSgenome.Mmulatta.UCSC.rheMac3, 1, 2
BSgenome.Mmulatta.UCSC.rheMac3.masked,

1

BSgenome.Mmulatta.UCSC.rheMac3.masked-package
