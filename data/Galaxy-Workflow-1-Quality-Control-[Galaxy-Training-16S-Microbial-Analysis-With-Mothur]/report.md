# Workflow 1: Quality Control [Galaxy Training: 16S Microbial Analysis With Mothur] CWL Workflow Report

### Metadata
- **Docker Image**: N/A
- **Homepage**: https://training.galaxyproject.org
- **Package**: https://workflowhub.eu/workflows/1422
- **Validation**: N/A

- **RO-Crate download**: https://workflowhub.eu/workflows/1422/ro_crate?version=1
- **Conda**: N/A
- **Total Downloads**: 252
...
- **Main workflow (WorkflowHub):** `workflow1-quality-control.ga` (Main Workflow)
