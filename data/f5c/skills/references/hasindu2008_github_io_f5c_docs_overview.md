* Overview
* [Overview](/f5c/docs/overview)
* Installation
* [Quick Start](/f5c/docs/quick-start)
* [Building](/f5c/docs/building)
* [Docker/Conda](/f5c/docs/misc-install)
* Usage
* [Commands and options](/f5c/docs/commands)
* [Examples](/f5c/docs/example-usage)
* [Output](/f5c/docs/output)
* [Performance guidelines](/f5c/docs/f5c-perf-hints)
* [Profiles](/f5c/docs/profiles)
* Troubleshooting
* [General](/f5c/docs/general-troubleshoot)
* [CUDA](/f5c/docs/cuda-troubleshoot)
* Miscellaneous
* [F5C GPU performance](/f5c/docs/f5c-gpu-perf)
* [Portable binary](/f5c/docs/portable-binary)
* [R10 training](/f5c/docs/r10train)
* [HIP for AMD GPUs](/f5c/docs/hip)
* Archived
* [F5C CPU performance](/f5c/docs/f5c-cpu-perf)
* [HDF5 performance](/f5c/docs/hdf5-performance)

[f5c](/f5c/ "Ultra-fast methylation calling and event alignment tool for nanopore sequencing data (supports CUDA acceleration)")

* [Docs](/f5c/docs/overview)

# Overview

* 2026-01-29 05:35:18 +0000
...
*Supplementary*: [nanopore\_signal\_alignment\_supplementary\_material.pdf](https://hasindu2008.github.io/f5c/nanopore_signal_alignment_supplementary_material.pdf)
...
© f5c ,
Powered by [Jekyll](http://jekyllrb.com/ "Jekyll is a simple, blog-aware, static site generator.") & [TeXt Theme](https://github.com/kitian616/jekyll-TeXt-theme "TeXt is a super customizable Jekyll theme.").