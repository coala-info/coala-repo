...
When zoomed in sufficiently, the reference genome ***Sequence*** track appears. The sequence is represented by
...
### Flipping the strand[#](#flipping-the-strand "Direct link to this section")
...
### Sequence translation[#](#sequence-translation "Direct link to this section")
...
* Right-click on ***Sequence*** track to select ***Show translation*** from the pop-up menu and to select a
  ***Translation Table***.
...
by toggling ***Show Translation*** in the track popup menu.