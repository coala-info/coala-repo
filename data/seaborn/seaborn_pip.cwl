...
baseCommand: pip
label: seaborn_pip
doc: "A package installer for Python. Commands are used to manage packages and their
  dependencies.\n\nTool homepage: https://github.com/mwaskom/seaborn"
inputs:
  - id: command
    type: string
    doc: The command to execute (e.g., install, uninstall, list)
    inputBinding:
      position: 1
  - id: cache_dir
    type:
