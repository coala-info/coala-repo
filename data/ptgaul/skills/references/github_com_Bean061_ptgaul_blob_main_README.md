...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2FBean061%2Fptgaul%2Fblob%2Fmain%2FREADME.md)
...
[History](/Bean061/ptgaul/commits/main/README.md)

History

139 lines (109 loc) · 6.49 KB
...
[Raw](https://github.com/Bean061/ptgaul/raw/refs/heads/main/README.md)
...
* Fixed the combine\_gfa.py, which can be run automatically.
...
[![](/Bean061/ptgaul/raw/main/ptGAUL_image.png)](/Bean061/ptgaul/blob/main/ptGAUL_image.png)
...
### If you run 1.0.4 version, the command in the ptGAUL\_version directory. Otherwise, combine\_gfa.py will not be able to run automatically.
...
files illumina\_\* are the fq.gz file of illumina reads. Change the output path directory "/PATH/msbwt".
...
Once you finished msbwt run. $N means thread number. $assembled\_cp is assembled plastome from ptGAUL. Change the output path of "/PATH/fmlrc/corrected.fasta"
