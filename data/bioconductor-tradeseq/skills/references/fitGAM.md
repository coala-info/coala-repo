...
* [Load data](#load-data)
* [Choosing K: a deeper dive into the output from **evaluateK**](#choosing-k-a-deeper-dive-into-the-output-from-evaluatek)
* [Fit additive models](#fit-additive-models)
  + [Adding covariates to the model](#adding-covariates-to-the-model)
  + [Parallel computing](#parallel-computing)
  + [Fitting only a subset of genes](#fitting-only-a-subset-of-genes)
  + [Zero inflation](#zero-inflation)
  + [Convergence issues on small or zero-inflated datasets](#convergence-issues-on-small-or-zero-inflated-datasets)
  + [tradeSeq list output](#tradeseq-list-output)
* [Session](#session)
...
For some datasets it can be useful to add covariates to the model, e.g. batch effects. This can be done by creating a design matrix using the `model.matrix` function, and providing it as input to `fitGAM` using the `U` argument. Below, we incorporate artificial batch effects from the model, as if the data were derived from two different batches.
...
If large datasets are being analyzed, `fitGAM` may be running for quite some time. We have implemented support for parallelization using `BiocParallel`, which can be activated by setting `parallel=TRUE`. Parallelization options can be provided through the `BPPARAM` argument, as shown below.
...
##  [3] slingshot_2.18.0            TrajectoryUtils_1.18.0
##  [5] princurve_2.1.6             SingleCellExperiment_1.32.0
##  [7] SummarizedExperiment_1.40.0 Biobase_2.70.0
##  [9] GenomicRanges_1.62.0        Seqinfo_1.0.0
## [11] IRanges_2.44.0              S4Vectors_0.48.0
## [13] BiocGenerics_0.56.0         generics_0.1.4
## [15] MatrixGenerics_1.22.0       matrixStats_1.5.0
## [17] RColorBrewer_1.1-3          tradeSeq_1.24.0
## [19] knitr_1.50
##
...
## [10] pkgconfig_2.0.3     Matrix_1.7-4        S7_0.2.0
## [13] lifecycle_1.0.4     compiler_4.5.1      farver_2.1.2
## [16] statmod_1.5.1       codetools_0.2-20    htmltools_0.5.8.1
## [19] sass_0.4.10         yaml_2.3.10         crayon_1.5.3
## [22] pillar_1.11.1       jquerylib_0.1.4     BiocParallel_1.44.0
...
## [34] labeling_0.4.3      splines_4.5.1       fastmap_1.2.0
## [37] grid_4.5.1          cli_3.6.5           SparseArray_1.10.0
## [40] magrittr_2.0.4      S4Arrays_1.10.0     dichromat_2.0-0.1
## [43] withr_3.0.2         edgeR_4.8.0         scales_1.4.0
## [46] rmarkdown_2.30      XVector_0.50.0      igraph_2.2.1
## [49] gridExtra_2.3       pbapply_1.7-4       evaluate_1.0.5
## [52] viridisLite_0.4.2   rlang_1.1.6         Rcpp_1.1.0
