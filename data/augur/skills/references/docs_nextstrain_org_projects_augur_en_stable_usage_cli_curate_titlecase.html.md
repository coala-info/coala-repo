...
* [Augur subcommands](../cli.html)
* [augur curate](index.html)
* [View page source](../../../_sources/usage/cli/curate/titlecase.rst.txt)

---

# titlecase[](#titlecase "Link to this heading")
...
`--titlecase-fields`
:   List of fields to convert to titlecase.

## OPTIONAL[](#augur-make_parser-optional "Link to this heading")

`--articles`
:   List of articles that should not be converted to titlecase.

`--abbreviations`
:   List of abbreviations that should not be converted to titlecase, keeps uppercase.
...
[Previous](format-dates.html "format-dates")
[Next](apply-geolocation-rules.html "apply-geolocation-rules")
