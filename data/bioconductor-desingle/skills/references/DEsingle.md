...
* `foldChange`: total\_mean\_1/total\_mean\_2.
* `norm_total_mean_1`, `norm_total_mean_2`: Mean of normalized read counts of group 1 and group 2.
* `norm_foldChange`: norm\_total\_mean\_1/norm\_total\_mean\_2.
...
* `FDR_LR2`: Adjusted P value of pvalue\_LR2 using Benjamini & Hochberg’s method (Used to determine the type of a DE gene).
* `FDR_LR3`: Adjusted P value of pvalue\_LR3 using Benjamini & Hochberg’s method (Used to determine the type of a DE gene).
...
#>  [4] rlang_1.1.6         xfun_0.53           miscTools_0.6-28
#>  [7] generics_0.1.4      jsonlite_2.0.0      zoo_1.8-14
#> [10] gamlss.data_6.0-7   htmltools_0.5.8.1   sass_0.4.10
#> [13] stats4_4.5.1        rmarkdown_2.30      grid_4.5.1
#> [16] evaluate_1.0.5      jquerylib_0.1.4     MASS_7.3-65
#> [19] fastmap_1.2.0       mvtnorm_1.3-3       numDeriv_2016.8-1.1
#> [22] yaml_2.3.10         lifecycle_1.0.4     compiler_4.5.1
#> [25] codetools_0.2-20    sandwich_3.1-1      pscl_1.5.9
#> [28] gamlss_5.5-0        bbmle_1.0.25.1      VGAM_1.1-13
#> [31] BiocParallel_1.44.0 lattice_0.22-7      digest_0.6.37
#> [34] R6_2.6.1            parallel_4.5.1      splines_4.5.1
#> [37] bslib_0.9.0         Matrix_1.7-4        tools_4.5.1
#> [40] bdsmatrix_1.3-7     gamlss.dist_6.1-1   maxLik_1.5-2.1
#> [43] survival_3.8-3      cachem_1.1.0
```