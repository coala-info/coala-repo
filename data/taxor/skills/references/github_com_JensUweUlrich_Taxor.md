...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2FJensUweUlrich%2FTaxor)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E&source=header-repo&source_repo=JensUweUlrich%2FTaxor)
...
[Branches](/JensUweUlrich/Taxor/branches)[Tags](/JensUweUlrich/Taxor/tags)
...
| --- | --- | --- | --- | --- |
| Latest commit   History[108 Commits](/JensUweUlrich/Taxor/commits/main/)   108 Commits | | |
| [img](/JensUweUlrich/Taxor/tree/main/img "img") | | [img](/JensUweUlrich/Taxor/tree/main/img "img") |  |  |
| [src](/JensUweUlrich/Taxor/tree/main/src "src") | | [src](/JensUweUlrich/Taxor/tree/main/src "src") |  |  |
| [.gitignore](/JensUweUlrich/Taxor/blob/main/.gitignore ".gitignore") | | [.gitignore](/JensUweUlrich/Taxor/blob/main/.gitignore ".gitignore") |  |  |
| [Dockerfile](/JensUweUlrich/Taxor/blob/main/Dockerfile "Dockerfile") | | [Dockerfile](/JensUweUlrich/Taxor/blob/main/Dockerfile "Dockerfile") |  |  |
| [LICENSE.md](/JensUweUlrich/Taxor/blob/main/LICENSE.md "LICENSE.md") | | [LICENSE.md](/JensUweUlrich/Taxor/blob/main/LICENSE.md "LICENSE.md") |  |  |
| [README.md](/JensUweUlrich/Taxor/blob/main/README.md "README.md") | | [README.md](/JensUweUlrich/Taxor/blob/main/README.md "README.md") |  |  |
| View all files | | |
...
[![Taxonomic classification with XOR filters](/JensUweUlrich/Taxor/raw/main/img/Logo.png)](/JensUweUlrich/Taxor/blob/main/img/Logo.png)

# Taxor: Fast and space-efficient taxonomic classification of long reads with hierarchical interleaved XOR filters

## Citation

Ulrich, J. U., & Renard, B. Y. (2024). Fast and space-efficient taxonomic classification of long reads with hierarchical interleaved XOR filters. Genome Research, gr-278623. doi: [10.1101/gr.278623.123](https://doi.org/10.1101/gr.278623.123)
...
The easiest way is to install Taxor via [Conda](https://bioconda.github.io/recipes/taxor/README.html#package-taxor).
...
**input-sequence-dir**
Path to the directory containing fasta files (compressed) of organisms listed in the tab-separated file explained above. The file stem of the fasta files needs to match the last directory path string of the FTP path in column 3 of the input file (e.g. GCF\_000002495.2\_MG8)
...
**syncmer-size**
Size of the substrings used for selecting a k-mer for pseudo-mapping. The syncmer-size also 