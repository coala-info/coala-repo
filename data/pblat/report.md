# pblat CWL Generation Report

## pblat

### Tool Description
BLAT with parallel supports v. 36x2 fast sequence search command line tool

### Metadata
- **Docker Image**: quay.io/biocontainers/pblat:2.5.1--h41f7678_4
- **Homepage**: https://github.com/icebert/pblat
- **Package**: Not found
- **Validation**: PASS

- **Conda**: https://anaconda.org/channels/bioconda/packages/pblat/overview
- **Total Downloads**: 25.8K
- **Last updated**: 2025-04-22
- **GitHub**: https://github.com/icebert/pblat
- **Stars**: N/A
### Original Help Text
```text
