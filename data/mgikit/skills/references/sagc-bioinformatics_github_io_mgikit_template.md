...
# Guides: Instructions for template detection
...
* **`-s or --sample-sheet`**: the path to the sample sheet file.
  ...
  This is the same format as above, but only sample\_id and i7 are required. i5 is required for dual indexes data.
