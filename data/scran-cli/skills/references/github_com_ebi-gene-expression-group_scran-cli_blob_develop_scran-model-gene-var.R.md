...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Febi-gene-expression-group%2Fscran-cli%2Fblob%2Fdevelop%2Fscran-model-gene-var.R)
...
[History](/ebi-gene-expression-group/scran-cli/commits/develop/scran-model-gene-var.R)
...
[Raw](https://github.com/ebi-gene-expression-group/scran-cli/raw/refs/heads/develop/scran-model-gene-var.R)
...
opt = wsc\_parse\_args(option\_list, mandatory = c("input\_sce\_object", "output\_geneVar\_table"))
...
var\_table <- modelGeneVar(sce, block=opt$block, assay.type=opt$assay\_type, design=opt$design,

subset.row=opt$subset\_row, subset.fit=opt$subset\_fit, equiweight=opt$equiweight, method=opt$method,
...
write.table(var\_table, opt$output\_geneVar\_table, sep="\t")
