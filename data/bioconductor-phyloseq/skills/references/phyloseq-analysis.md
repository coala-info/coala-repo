...
* [2 Summary](#summary)
* [3 About this vignette](#about-this-vignette)
* [4 Data](#data)
  + [4.1 Interface with the microbio.me/qiime server](#interface-with-the-microbio.meqiime-server)
  + [4.2 Included Data](#included-data)
* [5 Simple exploratory graphics](#simple-exploratory-graphics)
  + [5.1 Easy Richness Estimates](#easy-richness-estimates)
  + [5.2 Exploratory tree plots](#exploratory-tree-plots)
  + [5.3 Exploratory bar plots](#exploratory-bar-plots)
* [6 Exploratory analysis and graphics](#exploratory-analysis-and-graphics)
  + [6.1 Exploratory Heat Map](#exploratory-heat-map)
  + [6.2 Microbiome Network Representation](#microbiome-network-representation)
  + [6.3 Ordination Methods](#ordination-methods)
  + [6.4 Distance Methods](#distance-methods)
  + [6.5 Hierarchical Clustering](#hierarchical-clustering)
* [7 Multiple Testing and Differential Abundance](#multiple-testing-and-differential-abundance)
...
See the [microbio\_me\_qiime tutorial](http://joey711.github.io/phyloseq/download-microbio.me.html) for more details and examples downloading and importing into phyloseq/R directly from this public database.
...
For further details, see the [plot\_richness tutorial](http://joey711.github.io/phyloseq/plot_richness-examples.html)
...
For further details, see the [plot\_tree tutorial](http://joey711.github.io/phyloseq/plot_tree-examples.html)
...
For further details, see the [plot\_bar tutorial](http://joey711.github.io/phyloseq/plot_bar-examples.html)
...
![](data:image/png;base64...)
An example exploratory barplot using base `R graphics and the`taxa\_sums and `nsamples functions.
...
For further details, see the [plot\_heatmap tutorial](http://joey711.github.io/phyloseq/plot_heatmap-examples.html)
...
For further details, see the [plot\_network tutorial](http://joey711.github.io/phyloseq/plot_network-examples.html)
...
## ... New best solution
## ... Procrustes: rmse 1.001556e-05  max resid 3.65319e-05
## ... Similar to previous best
## Run 2 stress 0.1809282
## Run 3 stress 0.1432774
## ... New best solution
## ... Procrustes: rmse 1.139832e-06  max resid 3.416906e-06
## ... Similar to previous best
## Run 4 stress 0.1856304
## Run 5 stress 0.1432774
## ... Procrustes: rmse 1.426981e-05  max resid 5.151784e-05
## ... Similar to previous best
## Run 6 stress 0.1432774
## ... Procrustes: rmse 1.816087e-06  max resid 6.886791e-06
## ... Similar to previous best
## Run 7 stress 0.1432625
## ... New best solution
## ... Procrustes: rmse 0.00347943  max resid 0.01258087
## Run 8 stress 0.1809282
## Run 9 stress 0.1432774
## ... Procrustes: rmse 0.003488513  max resid 0.01261258
## Run 10 stress 0.1856304
## Run 11 stress 0.1432774
## ... Procrustes: rmse 0.003466104  max resid 0.01253402
## Run 12 stress 0.1432625
## ... Procrustes: rmse 3.175058e-06  max resid 1.023361e-05
## ... Similar to previous best
## Run 13 stress 0.1809282
## Run 14 stress 0.1432774
## ... Procrustes: rmse 0.003428175  max resid 0.0124036
## Run 15 stress 0.1432774
## ... Procrustes: rmse 0.003494226  max resid 0.01263132
## Run 16 stress 0.1432625
## ... New best solution
## ... Procrustes: rmse 2.491642e-06  max resid 9.394496e-06
## ... Similar to previous best
## Run 17 stress 0.1432625
## ... Procrustes: rmse 3.341333e-06  max resid 1.174861e-05
## ... Similar to previous best
## Run 18 stress 0.1856304
## Run 19 stress 0.167021
## Run 20 stress 0.1432774
## ... Procrustes: rmse 0.003465378  max resid 0.01253281
...
Here is a quick example illustrating the use of Double Principal Coordinate Analysis (DPCoA~\cite{Pavoine2004523), using the using the `ordinate()` function in phyloseq, as well as the “biplot” option for `plot\_ordination(). For a description that includes an applied example using the “enterotype” dataset and comparison with UniFrac/PCoA, see Fukuyama et al~\cite{fukuyama2012com.
