...
* [Home](.)
* Commands
  + [Index of commands](commands/commands/)
  + [cis-splice-effects identify](commands/cis-splice-effects-identify/)
  + [cis-splice-effects associate](commands/cis-splice-effects-associate/)
  + [cis-ase identify](commands/cis-ase-identify/)
  + [junctions extract](commands/junctions-extract/)
  + [junctions annotate](commands/junctions-annotate/)
  + [variants annotate](commands/variants-annotate/)
...
For information about the individual RegTools commands, please see [the Commands page](commands/commands/)
...
We have a mailing list located at: regtools@googlegroups.com and the forum is [here](https://groups.google.com/forum/#!forum/regtools). Another options is to use our [GitHub issues](https://github.com/griffithlab/regtools/issues) page to contact the project about potential bugs.
