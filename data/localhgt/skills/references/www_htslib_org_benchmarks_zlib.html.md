...
### Reading (htslib’s test\_view -B in.bam)
...
### Re-writing (BAM->BAM; test\_view -b -@4 in.bam | wc -c)
...
Both Intel and CloudFlare Zlib’s can be used with LD\_PRELOAD or
LD\_LIBRARY\_PATH without needing to recompile samtools/htslib, provided
