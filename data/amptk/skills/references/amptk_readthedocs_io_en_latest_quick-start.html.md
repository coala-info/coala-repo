...
* AMPtk Quick Start
  + [Pre-Processing Reads](#pre-processing-reads)
  + [Clustering Data](#clustering-data)
  + [Filtering Data](#filtering-data)
  + [Post clustering LULU](#post-clustering-lulu)
...
* AMPtk Quick Start
* [Edit on GitHub](https://github.com/nextgenusfs/amptk/blob/master/docs/quick-start.rst)

---

# AMPtk Quick Start[¶](#amptk-quick-start "Link to this heading")
...
information see the ReadLayout information.
...
## Pre-Processing Reads[¶](#pre-processing-reads "Link to this heading")
...
## Clustering Data[¶](#clustering-data "Link to this heading")
...
## Filtering Data[¶](#filtering-data "Link to this heading")
...
## Post clustering LULU[¶](#post-clustering-lulu "Link to this heading")
...
## Assign Taxonomy[¶](#assign-taxonomy "Link to this heading")
...
We then also have a BIOM file complete with any metadata and taxonomy (`miseq.biom`). This file could be taken to some of the [downstream processing software](downstream.html#downstream).

[Previous](overview.html "AMPtk Overview")
[Next](file-formats.html "AMPtk file formats")
