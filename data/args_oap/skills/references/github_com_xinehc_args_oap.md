...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fxinehc%2Fargs_oap)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E&source=header-repo&source_repo=xinehc%2Fargs_oap)
...
[Branches](/xinehc/args_oap/branches)[Tags](/xinehc/args_oap/tags)
...
| --- | --- | --- | --- | --- |
| Latest commit   History[135 Commits](/xinehc/args_oap/commits/main/)   135 Commits | | |
| [src/args\_oap](/xinehc/args_oap/tree/main/src/args_oap "This path skips through empty directories") | | [src/args\_oap](/xinehc/args_oap/tree/main/src/args_oap "This path skips through empty directories") |  |  |
| [CHANGELOG.md](/xinehc/args_oap/blob/main/CHANGELOG.md "CHANGELOG.md") | | [CHANGELOG.md](/xinehc/args_oap/blob/main/CHANGELOG.md "CHANGELOG.md") |  |  |
| [LICENSE](/xinehc/args_oap/blob/main/LICENSE "LICENSE") | | [LICENSE](/xinehc/args_oap/blob/main/LICENSE "LICENSE") |  |  |
| [MANIFEST.in](/xinehc/args_oap/blob/main/MANIFEST.in "MANIFEST.in") | | [MANIFEST.in](/xinehc/args_oap/blob/main/MANIFEST.in "MANIFEST.in") |  |  |
| [README.md](/xinehc/args_oap/blob/main/README.md "README.md") | | [README.md](/xinehc/args_oap/blob/main/README.md "README.md") |  |  |
| [setup.cfg](/xinehc/args_oap/blob/main/setup.cfg "setup.cfg") | | [setup.cfg](/xinehc/args_oap/blob/main/setup.cfg "setup.cfg") |  |  |
| [setup.py](/xinehc/args_oap/blob/main/setup.py "setup.py") | | [setup.py](/xinehc/args_oap/blob/main/setup.py "setup.py") |  |  |
| View all files | | |
...
This repository was created by Xiaole Yin (*xiaole99*) and is currently maintained by Xi Chen (*xinhec*). The goal is to make args\_oap faster, and easier to run.

If you have any questions, please create an [issue](https://github.com/xinehc/args_oap/issues/new/choose), or contact Xiaole Yin ([yinlele99@gmail.com](/xinehc/args_oap/blob/main/yinlele99%40gmail.com)).

More about the SARG database: <https://smile.hku.hk/ARGs/Indexing>, and the change logs: [CHANGELOG.md](https://github.com/xinehc/args_oap/blob/main/CHANGELOG.md).
...
| beta\_lactam | 0.0 | 0.14920548807040623 |
...
To run args\_oap with customized database:
...
Go to <http://smile.hku.hk/SARGs> and using the module ARG\_OAP.

1. Using **ARG\_OAP** -> **Upload Files** module to upload the extracted fasta file and meta\_data\_online.txt file generated in stage one into Galaxy
2. Click **ARG\_OAP** and **Ublast\_stagetwo**, select your uploaded files
...
This tools only provide the required scripts 