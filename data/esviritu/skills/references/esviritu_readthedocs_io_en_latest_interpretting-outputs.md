...
* Interpretting Outputs
  + [Undocumented recombinants](#undocumented-recombinants)
  + [Abundance metric](#abundance-metric)
  + [Read ANI as guide to interpreting results](#read-ani-as-guide-to-interpreting-results)
  + [Example report screenshot](#example-report-screenshot)
...
* Interpretting Outputs
* [Edit on cmmr/EsViritu](https://github.com/cmmr/EsViritu/blob/main/docs/interpretting-outputs.md)
...
[Previous](../data-directory/ "Data Directory")
[Next](../custom-database/ "Making Custom Databases")
