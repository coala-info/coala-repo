...
* Output files
  + [ganon build/build-custom/update](#ganon-buildbuild-customupdate)
  + [ganon classify](#ganon-classify)
  + [ganon report](#ganon-report)
  + [ganon table](#ganon-table)
...
# Output files[:)](#output-files "Permanent link")

## ganon build/build-custom/update[:)](#ganon-buildbuild-customupdate "Permanent link")
...
## ganon table[:)](#ganon-table "Permanent link")

* {output\_file}: a tab-separated file with counts/percentages of taxa for multiple samples
...
[Previous](../table/ "Table (ganon table)")
