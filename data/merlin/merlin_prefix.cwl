...
inputs:
  ...
  - id: bits
    type:
      - 'null'
      - int
    doc: 'Limits: number of bits for calculations'
    inputBinding:
      position: 101
      prefix: --bits
  - id: cfreq
  ...
  - id: deviates
    type:
      - 'null'
      - boolean
    doc: 'NPL Linkage: calculate deviates'
    inputBinding:
      position: 101
      prefix: --deviates
  - id: distance
  ...
  - id: filter
    type:
      - 'null'
      - boolean
    doc: 'Association: filter markers'
    inputBinding:
      position: 101
      prefix: --filter
  - id: founders
  ...
  - id: grid
    type:
      - 'null'
      - boolean
    doc: 'Positions: use grid for positions'
    inputBinding:
      position: 101
      prefix: --grid
  - id: horizontal
  ...
  - id: select
    type:
      - 'null'
      - boolean
    doc: 'IBD States: select IBD states'
    inputBinding:
      position: 101
      prefix: --select
  - id: simulate
  ...
  - id: singlepoint
    type:
      - 'null'
      - boolean
    doc: 'Recombination: single point recombination'
    inputBinding:
      position: 101
      prefix: --singlepoint
  - id: small_swap
  ...
  - id: steps
    type:
      - 'null'
      - boolean
    doc: 'Positions: use steps for positions'
    inputBinding:
      position: 101
      prefix: --steps
  - id: stop
