...
[Skip to content](#using-snk-cli-to-build-self-contained-tools)
...
* [ ]
  ...
  + [Adding the workflow](#adding-the-workflow)
  + [Add additional commands to the workflow](#add-additional-commands-to-the-workflow)
