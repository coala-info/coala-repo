...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fhealthdisparities%2Fpastrami)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E&source=header-repo&source_repo=healthdisparities%2Fpastrami)
...
[Branches](/healthdisparities/pastrami/branches)[Tags](/healthdisparities/pastrami/tags)
...
| --- | --- | --- | --- | --- |
| Latest commit   History[50 Commits](/healthdisparities/pastrami/commits/master/)   50 Commits | | |
| [map\_data](/healthdisparities/pastrami/tree/master/map_data "map_data") | | [map\_data](/healthdisparities/pastrami/tree/master/map_data "map_data") |  |  |
| [simulation](/healthdisparities/pastrami/tree/master/simulation "simulation") | | [simulation](/healthdisparities/pastrami/tree/master/simulation "simulation") |  |  |
| [README.md](/healthdisparities/pastrami/blob/master/README.md "README.md") | | [README.md](/healthdisparities/pastrami/blob/master/README.md "README.md") |  |  |
| [outsourcedOptimizer.R](/healthdisparities/pastrami/blob/master/outsourcedOptimizer.R "outsourcedOptimizer.R") | | [outsourcedOptimizer.R](/healthdisparities/pastrami/blob/master/outsourcedOptimizer.R "outsourcedOptimizer.R") |  |  |
| [pastrami.py](/healthdisparities/pastrami/blob/master/pastrami.py "pastrami.py") | | [pastrami.py](/healthdisparities/pastrami/blob/master/pastrami.py "pastrami.py") |  |  |
| View all files | | |
...
Output options:
  --out-prefix out-prefix                      Output prefix (default: pastrami) for cre