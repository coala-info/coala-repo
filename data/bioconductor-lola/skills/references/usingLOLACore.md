...
* [0.1 Loading full-scale example data](#loading-full-scale-example-data)
* [0.2 Running the enrichment](#running-the-enrichment)
* [0.3 Exploring results](#exploring-results)
* [0.4 Mystery set identity](#mystery-set-identity)
...
## 0.1 Loading full-scale example data
