...
FATAL:   Unable to handle docker://quay.io/biocontainers/hisat2:2.2.2--h503566f_0 uri: while building SIF from layers: unable to create new build: failed to create build parent dir: mkdir /tmp/build-temp-1304870481: no space left on device
```
