...
:   You provide **two** sets of sequences and MEME-ChIP reports motifs that
    ...
    MEME motifs use the classic MEME objective function with a [position-specific prior](../doc/psp-format.html)
    created from the primary and control sequences using using [psp-gen](../doc/psp-gen.html).
