...
baseCommand: perl
label: perl-url-encode_perl
doc: "The Perl 5 language interpreter\n\nTool homepage: http://metacpan.org/pod/URL-Encode"
inputs:
  - id: program_file
    type:
      - 'null'
...
hints:
  - class: DockerRequirement
    dockerPull: quay.io/biocontainers/perl-url-encode:0.03--pl5321h9ee0642_1
stdout: perl-url-encode_perl.out
