...
baseCommand: perl
label: perl-digest-md5_perl
doc: "The Perl 5 language interpreter\n\nTool homepage: http://metacpan.org/pod/Digest-MD5"
inputs:
  - id: program_file
    type:
      - 'null'
...
hints:
  - class: DockerRequirement
    dockerPull: quay.io/biocontainers/perl-digest-md5:2.58--pl5321hec16e2b_1
stdout: perl-digest-md5_perl.out
